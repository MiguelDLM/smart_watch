...
public class UserReportThreadPool {
    ...
    static {
        ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(2, 8, 60, TimeUnit.SECONDS, new LinkedBlockingQueue(100), new ThreadFactory() {
    ...
    public static void postDelayed(@NonNull final Runnable runnable, int i) {
        if (i == 0) {
            ...
            sHandler.postDelayed(new Runnable() {
                public void run() {
                    UserReportThreadPool.post(runnable);
                }
            }, (long) i);
        }
    }
