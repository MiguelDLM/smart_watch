...
public class UtItemBean extends BaseBean {
    ...
    public boolean equals(UtItemBean utItemBean) {
        if (hashCode() == utItemBean.hashCode()) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return Objects.hash(new Object[]{this.reqId, this.pid, this.page, Integer.valueOf(this.eventId), Integer.valueOf(this.eventStatus), this.arg1, this.arg2, this.arg3, this.args, this.sessionId});
    }
