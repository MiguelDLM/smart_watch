...
public class TanxBaseUt implements NotConfused {
    public static void biddingResult(List<ITanxAd> list) {
        ...
        if (list != null && list.size() > 0) {
            ...
            for (ITanxAd next : list) {
                ...
                if (next != null) {
                    if (next.getAdSlot() != null) {
                        str2 = next.getAdSlot().getPid();
                    } else {
                        str2 = "";
                    }
                    biddingBean.setPid(str2);
                    str3 = next.getRequestId();
                    if (next.getBidInfo() != null) {
                        biddingBean.setReqId(next.getRequestId());
                        biddingBean.setCreative_id(next.getBidInfo().getCreativeId());
                        biddingBean.setTemplate_id(next.getBidInfo().getTemplateId());
                        biddingBean.setSessionId(next.getBidInfo().getSessionId());
                    }
                    if (next.getBiddingInfo() != null) {
                        if (next.getBiddingInfo().isBidResult()) {
                            i++;
                        } else {
                            i2++;
                        }
                        ...
                        biddingBean.setPrice(next.getBiddingInfo().getAdPrice() + "");
                    }
                }
    ...
    public static Map<String, Object> buildArgs(String str) {
        return buildArgs(str, (String) null, (String) null, (String) null);
    }
    ...
    public static void send(String str, int i, String str2, String str3, int i2, String str4, Map<String, Object> map, String str5) {
        track(str, str2, str3, i, i2, str4, (String) null, (String) null, map, str5);
    }
    ...
    public static void shake(String str, BidInfo bidInfo, HashMap<String, Object> hashMap) {
        ...
        String str4 = "";
        if (bidInfo != null) {
            String str5 = bidInfo.getId() + str4;
            String creativeId = bidInfo.getCreativeId();
            String str6 = bidInfo.getOpenType() + str4;
        ...
        send(str7, adUtConstants.eventId, "", str3, str7, (String) null, str, hashMap2, str2);
    }
    ...
    public static void utClick(AdClickInfo adClickInfo, boolean z, String str, String str2, String str3) {
        if (adClickInfo != null) {
            ...
            buildArgs.put("adType", adClickInfo.getAdType() + "");
            ...
            buildArgs.put("openType", adClickInfo.getOpenType() + "");
            ...
            if (z) {
                ...
                String str4 = adUtConstants.arg1;
                send(str4, adUtConstants.eventId, pid, reqId, str4, obj, "", buildArgs, sessionId);
                return;
            }
            buildArgs.put("dpUrl", str2 + "");
            buildArgs.put("h5Url", str3 + "");
            AdUtConstants adUtConstants2 = AdUtConstants.LANDING_H5;
            String str5 = adUtConstants2.arg1;
            send(str5, adUtConstants2.eventId, pid, reqId, str5, obj, "", buildArgs, sessionId);
        }
    }
    ...
    public static void utErrorCode(ITanxAd iTanxAd, UtErrorCode utErrorCode) {
        ...
        if (utErrorCode != null) {
            ...
            Map<String, Object> buildArgs = buildArgs(str3, str2, str7, str4);
            AdUtConstants adUtConstants = AdUtConstants.SDK_ERROR_CODE;
            send(adUtConstants.arg1, adUtConstants.eventId, str3, str2, utErrorCode.getIntCode(), utErrorCode.getMsg(), buildArgs, str);
        }
    }
    ...
    public static void send(String str, int i, String str2, String str3, String str4, Map<String, Object> map, String str5) {
        track(str, str2, str3, i, 0, str4, (String) null, (String) null, map, str5);
    }
    ...
    public static void send(String str, int i, int i2, String str2, Map<String, Object> map, String str3) {
        track(str, "", "", i, i2, str2, (String) null, (String) null, map, str3);
    }
    ...
    public static void utError(int i, String str, String str2, String str3, String str4, String str5, String str6, String str7) {
        ...
        if (hashMap.get("msg") == null || !hashMap.get("msg").toString().contains("Unable to resolve host")) {
            ...
            send(str10, adUtConstants.eventId, str4, str5, i, str10, str6, str7, (Map<String, Object>) hashMap, "");
        }
    }
}
