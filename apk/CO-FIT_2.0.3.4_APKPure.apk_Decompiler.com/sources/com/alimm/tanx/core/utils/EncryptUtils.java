...
public class EncryptUtils implements NotConfused {
    ...
    public static String decrypt(String str, boolean z) {
        ...
        try {
            ...
            if (z) {
                TanxBaseUt.utError(UtErrorCode.CRASH_ERROR.getIntCode(), TAG, LogUtils.getStackTraceMessage(e), str3);
            }
            e.printStackTrace();
        }
        LogUtils.d(TAG, str3);
    ...
    public static String encrypt(String str, boolean z) {
        ...
        try {
            ...
            str2 = "";
            if (z) {
                TanxBaseUt.utError(UtErrorCode.CRASH_ERROR.getIntCode(), TAG, LogUtils.getStackTraceMessage(e), str2);
            }
            e.printStackTrace();
        }
        str = str2;
