...
public class BidInfo extends BaseBean implements IBidInfo {
    ...
    public String getAdvLogo() {
        CreativeItem creativeItem2 = this.creativeItem;
        if (creativeItem2 != null) {
            return creativeItem2.getAdvLogo();
        }
        return null;
    }
    ...
    public String getCreativeMd5() {
        CreativeItem creativeItem2 = this.creativeItem;
        if (creativeItem2 != null) {
            return creativeItem2.getImageMd5();
        }
        return null;
    }
    ...
    public String getCreativeName() {
        CreativeItem creativeItem2 = this.creativeItem;
        if (creativeItem2 == null || TextUtils.isEmpty(creativeItem2.getImageUrl())) {
            return "";
        }
        return MD5Utils.getMD5String(this.creativeItem.getImageUrl());
    }

    public String getCreativePath() {
        CreativeItem creativeItem2 = this.creativeItem;
        if (creativeItem2 != null) {
            return creativeItem2.getImageUrl();
        }
        return null;
    }
    ...
    public void setClickThroughUrl(String str) {
        ...
        tanxc_do tanxc_do = this.clickBean;
        if (tanxc_do != null) {
            tanxc_do.tanxc_do(str);
        }
    }

    public void setClickTrackUrl(List<String> list) {
        this.clickTrackUrl = list;
        tanxc_if tanxc_if = this.monitorBean;
        if (tanxc_if != null) {
            tanxc_if.tanxc_if(list);
        }
    }
    ...
    public void setCreativeItem(CreativeItem creativeItem2) {
        this.creativeItem = creativeItem2;
    }
