...
public class RewardWebViewUtil extends tanxc_if {
    ...
    public void tanxc_do(LinearLayout linearLayout, BidInfo bidInfo, TanxAdSlot tanxAdSlot, tanxc_new tanxc_new, RewardInterface rewardInterface) {
        LogUtils.d("RewardWebViewUtil", "init");
        super.tanxc_do(linearLayout, true, bidInfo, tanxAdSlot, rewardInterface, new JsBridgeUtil.AdInterface() {
            public void adClose() {
    ...
    public void tanxc_do(WebView webView) {
        ...
        super.tanxc_do(true);
        this.tanxc_new.register("WebAd.getPlayerInfo", new JsHandler() {
                ...
                try {
                    ...
                    if (!(RewardWebViewUtil.this.tanxc_do == null || RewardWebViewUtil.this.tanxc_do.tanxc_if == null)) {
                        ...
                        if (RewardWebViewUtil.this.tanxc_do.tanxc_for() != null) {
                            RewardWebViewUtil.this.tanxc_do.tanxc_for().onAdClicked((TanxAdView) null, RewardWebViewUtil.this.tanxc_do.tanxc_if);
                        }
                    }
                    callback.call(true, (AbstractMap) null);
                } catch (Exception e) {
        ...
        this.tanxc_new.register("WebAd.setPlayer", new JsHandler() {
            public void handler(AbstractMap<String, Object> abstractMap, Callback callback) {
                try {
        ...
        this.tanxc_new.register("WebAd.notifyCountDown", new JsHandler() {
            public void handler(AbstractMap<String, Object> abstractMap, Callback callback) {
        ...
        this.tanxc_new.register("WebAd.notifyError", new JsHandler() {
            public void handler(AbstractMap<String, Object> abstractMap, Callback callback) {
                ...
                RewardInterface tanxc_do2 = RewardWebViewUtil.this.tanxc_if;
                if (num == null) {
                    i = -1;
                } else {
                    i = num.intValue();
