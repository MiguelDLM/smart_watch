...
public abstract class tanxc_do {
    ...
    public tanxc_do(@NonNull com.alimm.tanx.core.ad.ad.template.rendering.splash.tanxc_do tanxc_do2, @NonNull Context context, @NonNull ViewGroup viewGroup, @NonNull ITanxAd iTanxAd) {
        if (iTanxAd != null && iTanxAd.getBidInfo() != null) {
            ...
            this.tanxc_try = tanxc_do2;
            this.tanxc_if.getViewTreeObserver().addOnWindowFocusChangeListener(new ViewTreeObserver.OnWindowFocusChangeListener() {
    ...
    private void tanxc_void() {
        if (this.tanxc_byte == null) {
            this.tanxc_byte = new CountDownComponent((TextView) this.tanxc_if.findViewById(R.id.splash_ad_txt_count_down), 5, new CountDownComponent.OnFinishListener() {
    ...
    public void tanxc_case() {
        this.tanxc_goto.setOnClickListener(new View.OnClickListener() {
