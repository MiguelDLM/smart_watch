...
import com.alimm.tanx.core.ad.ad.template.rendering.splash.tanxc_do.tanxc_for;
import com.alimm.tanx.core.ad.ad.template.rendering.splash.tanxc_do.tanxc_if;
...
public abstract class tanxc_do extends Handler {
    ...
    public tanxc_do(@NonNull IRenderCallback iRenderCallback, @NonNull Context context, @NonNull TanxSplashAdView tanxSplashAdView, @NonNull ITanxAd iTanxAd, boolean z) {
        if (iTanxAd != null && iTanxAd.getBidInfo() != null) {
            ...
            if (bidInfo == null || !bidInfo.getInteractType2Shake()) {
                this.tanxc_goto = new tanxc_if(this, context, tanxSplashAdView, iTanxAd);
            } else {
                this.tanxc_goto = new tanxc_for(this, context, tanxSplashAdView, iTanxAd);
            }
    ...
    public void tanxc_break() {
        com.alimm.tanx.core.ad.ad.template.rendering.splash.tanxc_do.tanxc_do tanxc_do2 = this.tanxc_goto;
        if (tanxc_do2 != null) {
            tanxc_do2.tanxc_this();
        }
    }
    ...
    public void tanxc_do(ITanxSplashInteractionListener iTanxSplashInteractionListener) {
        ...
        com.alimm.tanx.core.ad.ad.template.rendering.splash.tanxc_do.tanxc_do tanxc_do2 = this.tanxc_goto;
        if (tanxc_do2 != null && (tanxc_do2 instanceof tanxc_if)) {
            ((tanxc_if) tanxc_do2).tanxc_do(iTanxSplashInteractionListener);
        }
    }

    private void tanxc_do(View view, int i) {
        if (view != null) {
