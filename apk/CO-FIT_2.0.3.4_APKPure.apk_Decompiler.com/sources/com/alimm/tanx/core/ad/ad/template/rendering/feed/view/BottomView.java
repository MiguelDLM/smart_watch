...
public class BottomView extends FrameLayout implements NotConfused {
    ...
    private void initClick() {
        this.llClose.setOnClickListener(new View.OnClickListener() {
    ...
    private void initView() {
        ...
        if (iTanxFeedAd2 != null && (bidInfo = iTanxFeedAd2.getBidInfo()) != null && (creativeItem = bidInfo.getCreativeItem()) != null && creativeItem.getAdvName() != null) {
    ...
    public void setTanxFeedAd(ITanxFeedAd iTanxFeedAd2) {
    ...
    public void setViewStyle(MediaRenderingMode mediaRenderingMode) {
        ...
        if (TanxCoreSdk.getConfig().getSettingConfig().isCustomTextSizeDpSwitch()) {
            this.tvAdName.setTextSize(1, (float) mediaRenderingMode.getAdvSize2Int());
            this.tvAd.setTextSize(1, (float) mediaRenderingMode.getAdSize2Int());
            return;
        }
        TextView textView = this.tvAdName;
        textView.setTextSize(0, (float) DimenUtil.dp2px(textView.getContext(), (float) mediaRenderingMode.getAdvSize2Int()));
        TextView textView2 = this.tvAd;
        textView2.setTextSize(0, (float) DimenUtil.dp2px(textView2.getContext(), (float) mediaRenderingMode.getAdSize2Int()));
    }

    public BottomView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        super(context, attributeSet);
        View inflate = LayoutInflater.from(context).inflate(R.layout.layout_ad_bottom, this, true);
