...
public class FeedBackDialog extends tanxc_do implements View.OnClickListener, NotConfused {
    ...
    public FeedBackDialog(@NonNull Context context, int i, ITanxAd iTanxAd2) {
        super(context, i);
    ...
    private void submit(FeedBackItemBean feedBackItemBean) {
        ...
        if (feedBackItemBean != null && (iTanxAd2 = this.iTanxAd) != null && iTanxAd2.getBidInfo() != null && this.iTanxAd.getBidInfo().getEventTrack() != null) {
            InteractionUpload.getInstance().uploadInteraction((List<? extends ITrackItem>) this.iTanxAd.getBidInfo().getEventTrack(), feedBackItemBean.getInteractType(), feedBackItemBean.getInteractDesc());
        }
    }
