...
public class tanxc_if extends tanxc_do {
    ...
    public tanxc_if(@NonNull tanxc_do tanxc_do, @NonNull Context context, @NonNull ViewGroup viewGroup, @NonNull ITanxAd iTanxAd) {
    ...
    public void tanxc_byte() {
        ...
        if (this.tanxc_for != null && this.tanxc_case) {
            ...
            this.tanxc_goto.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
