...
public class JsBridgeUtil implements NotConfused {
    ...
    /* access modifiers changed from: private */
    public BaseWebInterface baseWebInterface;
    /* access modifiers changed from: private */
    ...
    public void track(AbstractMap<String, Object> abstractMap, Callback callback) {
        ...
        try {
            ...
            if (utItemH5Bean != null) {
                JsBridgeBean jsBridgeBean2 = this.jsBridgeBean;
                if (jsBridgeBean2 != null) {
                    utItemH5Bean.pid = jsBridgeBean2.getPid();
    ...
    public void initJsBridge(TanxJsBridge tanxJsBridge, JsBridgeBean jsBridgeBean2, BaseWebInterface baseWebInterface2, AdInterface adInterface2) {
        if (tanxJsBridge == null) {
            LogUtils.d(TAG, "jsBridge注册失败，tanxJsBridge为空");
            return;
        }
        this.jsBridgeBean = jsBridgeBean2;
        this.baseWebInterface = baseWebInterface2;
        this.adInterface = adInterface2;
        tanxJsBridge.register("Core.getSdkInfo", new JsHandler() {
        ...
        tanxJsBridge.register("WebAd.notifyWebDidMount", new JsHandler() {
            public void handler(AbstractMap<String, Object> abstractMap, Callback callback) {
        ...
        tanxJsBridge.register("WebAd.track", new JsHandler() {
            public void handler(AbstractMap<String, Object> abstractMap, Callback callback) {
                JsBridgeUtil.this.track(abstractMap, callback);
            }
        });
        tanxJsBridge.register("WebAd.getAd", new JsHandler() {
            public void handler(AbstractMap<String, Object> abstractMap, Callback callback) {
        ...
        tanxJsBridge.register("Core.getNetType", new JsHandler() {
            public void handler(AbstractMap<String, Object> abstractMap, Callback callback) {
        ...
        tanxJsBridge.register("WebAd.notifyClose", new JsHandler() {
            public void handler(AbstractMap<String, Object> abstractMap, Callback callback) {
        ...
        tanxJsBridge.register("WebAd.notifyAdSkip", new JsHandler() {
            public void handler(AbstractMap<String, Object> abstractMap, Callback callback) {
        ...
        tanxJsBridge.register("WebAd.notifyError", new JsHandler() {
            public void handler(AbstractMap<String, Object> abstractMap, Callback callback) {
                int i;
                ...
                BaseWebInterface access$000 = JsBridgeUtil.this.baseWebInterface;
                if (num == null) {
                    i = -1;
                } else {
                    i = num.intValue();
                }
                access$000.webError(i, str);
                callback.call(true, (AbstractMap) null);
            }
        });
        tanxJsBridge.register("WebAd.submitFeedback", new JsHandler() {
            public void handler(AbstractMap<String, Object> abstractMap, Callback callback) {
                try {
                    ...
                    if (JsBridgeUtil.this.jsBridgeBean != null) {
                        InteractionUpload.getInstance().uploadInteraction((List<? extends ITrackItem>) JsBridgeUtil.this.jsBridgeBean.getEventTrack(), str, str2);
                    }
                    callback.call(true, (AbstractMap) null);
                } catch (Exception e) {
                    LogUtils.e(JsBridgeUtil.TAG, e);
    ...
    public void setShowWebBar(TanxJsBridge tanxJsBridge, final boolean z) {
        if (tanxJsBridge == null) {
            ...
            tanxJsBridge.register("WebAd.isShowWebBar", new JsHandler() {
                public void handler(AbstractMap<String, Object> abstractMap, Callback callback) {
