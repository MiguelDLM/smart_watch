...
public class WebCacheManager {
    ...
    private void initWebViewCache(Context context) {
        ...
        builder.setCachePath(new File(context.getCacheDir(), "cache_path_name")).setDynamicCachePath(new File(context.getCacheDir(), "dynamic_webview_cache")).setCacheSize(52428800).setConnectTimeoutSecond(20).setReadTimeoutSecond(20);
