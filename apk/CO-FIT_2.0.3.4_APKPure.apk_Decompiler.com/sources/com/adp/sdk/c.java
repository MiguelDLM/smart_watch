...
public class c {
    ...
    private LogProducerConfig f712a;
    ...
    public void c(Context context, String str) {
        c a2 = a();
        AlyLogDTO a3 = a2.a(context, "0", (String) null, (String) null);
    ...
    public synchronized void a(Context context, String str) {
        try {
            if (!d) {
                ...
                this.f712a = logProducerConfig;
                logProducerConfig.setConnectTimeoutSec(20);
                this.f712a.setSendTimeoutSec(20);
                this.f712a.setPersistent(1);
                LogProducerConfig logProducerConfig2 = this.f712a;
                logProducerConfig2.setPersistentFilePath(context.getFilesDir() + File.separator + str + "adplog.dat");
                this.f712a.setPersistentForceFlush(1);
                this.f712a.setPersistentMaxFileCount(10);
                this.f712a.setPersistentMaxFileSize(O0xOxO.f22618xXxxox0I);
                this.f712a.setPersistentMaxLogCount(65536);
                this.b = new LogProducerClient(this.f712a, new a(this));
                d = true;
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void a(Context context, String str, String str2, String str3, SourceVO sourceVO) {
        if (ADP.isErrorLogs && !a(str2)) {
            ...
            a(a2, context);
            new d(context).a("splasherrorlogs", "");
        }
    }
