...
public class ADP {
    ...
    /* access modifiers changed from: private */
    public static InitCallback adpinitCallback = null;
    /* access modifiers changed from: private */
    public static String appname = "adp";
    ...
    /* access modifiers changed from: private */
    public static String jingdong = "";
    /* access modifiers changed from: private */
    public static String klevinid = "";
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public static final Handler uiHandler = new Handler(new b());
    ...
    public static class a extends Thread {
        ...
        final /* synthetic */ Application f625a;
        ...
        public void run() {
            ...
            try {
                if (com.adp.sdk.utils.b.a("com.huawei.hms.ads.identifier.AdvertisingIdClient") && com.adp.sdk.utils.b.a("com.huawei.hms.ads.identifier.AdvertisingIdClient", "getAdvertisingIdInfo") && (advertisingIdInfo = AdvertisingIdClient.getAdvertisingIdInfo(this.f625a)) != null) {
                ...
                if (!ADP.isEmpty(ADP.ksid)) {
                    ...
                    if (aDPConfig3 != null) {
                        if (aDPConfig3.isEnablePersonalRecommend()) {
                            ...
                            z = false;
                            ADP.initksBoolean = KsAdSDK.init(context, new SdkConfig.Builder().appId(ADP.ksid).nightThemeStyleAssetsFileName(SdkConfig.DEF_NIGHT_THEME_STYLE_FILE_NAME).showNotification(true).debug(false).customController(e.a().a(z, ADP.adpConfig)).build());
                            KsAdSDK.start();
                        } else {
                            if (ADP.DEBUGLOG) {
    ...
    public static class c implements AdInfoListener {
        ...
        public void error(String str, String str2) {
            ...
            a2.b((Context) application, str2 + "");
            boolean unused = ADP.isRun = false;
            InitCallback initCallback = this.f626a;
            ...
            a3.b((Context) application2, "sdk init error init ad error:" + str2);
        }
        ...
        public void onAdLoadOk(String str, String str2, String str3, String str4) {
            ...
            String unused5 = ADP.jingdong = a.b.getJingdong();
            String unused6 = ADP.klevinid = a.b.getKlevin();
            InitCallback unused7 = ADP.adpinitCallback = this.f626a;
            ...
            if (adInfo != null) {
                ...
                ADP.isErrorLogs = a.b.isOpenLogs();
            }
        }
    }
    ...
    public static void initialize(ADPConfig aDPConfig, String str, Application application, InitCallback initCallback) {
        ...
        if (!isInitSuccess() && !isRun) {
            isRun = true;
            a.a().a(str, application, new c(initCallback, application));
        }
    }
}
