...
public class ChangeBounds extends Transition {
    ...
    public static class ClipListener extends AnimatorListenerAdapter implements Transition.TransitionListener {
        ...
        public void onTransitionResume(@NonNull Transition transition) {
            ...
            this.mView.setTag(i, (Object) null);
    ...
    static {
        ...
        POSITION_PROPERTY = new Property<View, PointF>(cls, RequestParameters.POSITION) {
            public PointF get(View view) {
                return null;
            }
    ...
    public Animator createAnimator(@NonNull ViewGroup viewGroup, @Nullable TransitionValues transitionValues, @Nullable TransitionValues transitionValues2) {
        ...
        if (!this.mResizeClip) {
            ...
            if (i == 2) {
                if (i14 == i16 && i15 == i17) {
                    animator = ObjectAnimatorUtils.ofPointF(view, POSITION_PROPERTY, getPathMotion().getPath((float) i6, (float) i8, (float) i7, (float) i9));
                } else {
                    ViewBounds viewBounds = new ViewBounds(view);
                    ObjectAnimator ofPointF = ObjectAnimatorUtils.ofPointF(viewBounds, TOP_LEFT_PROPERTY, getPathMotion().getPath((float) i6, (float) i8, (float) i7, (float) i9));
                    ObjectAnimator ofPointF2 = ObjectAnimatorUtils.ofPointF(viewBounds, BOTTOM_RIGHT_PROPERTY, getPathMotion().getPath((float) i10, (float) i12, (float) i11, (float) i13));
                ...
                animator = ObjectAnimatorUtils.ofPointF(view, BOTTOM_RIGHT_ONLY_PROPERTY, getPathMotion().getPath((float) i10, (float) i12, (float) i11, (float) i13));
            } else {
                animator = ObjectAnimatorUtils.ofPointF(view, TOP_LEFT_ONLY_PROPERTY, getPathMotion().getPath((float) i6, (float) i8, (float) i7, (float) i9));
            }
        } else {
            view = view3;
            int i18 = i13;
            ...
            if (i6 == i7 && i8 == i9) {
                ...
                i3 = i10;
                i2 = i8;
                objectAnimator = ObjectAnimatorUtils.ofPointF(view, POSITION_PROPERTY, getPathMotion().getPath((float) i6, (float) i8, (float) i7, (float) i9));
            }
            if (rect4 == null) {
                z = true;
            } else {
            ...
            if (!rect7.equals(rect)) {
                ...
                int i22 = i7;
                boolean z3 = z2;
                ClipListener clipListener = new ClipListener(view, rect7, z, rect8, z3, i6, i2, i20, i12, i22, i21, i19, i18);
