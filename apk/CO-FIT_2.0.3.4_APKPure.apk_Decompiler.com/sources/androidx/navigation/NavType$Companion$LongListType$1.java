...
public final class NavType$Companion$LongListType$1 extends CollectionNavType<List<? extends Long>> {
    ...
    public void put(Bundle bundle, String str, List<Long> list) {
        IIX0o.x0xO0oo(bundle, "bundle");
        IIX0o.x0xO0oo(str, "key");
        bundle.putLongArray(str, list != null ? CollectionsKt___CollectionsKt.oo00Io(list) : null);
    }
    ...
    public boolean valueEquals(java.util.List<java.lang.Long> r4, java.util.List<java.lang.Long> r5) {
        /*
            r3 = this;
            r0 = 0
            r1 = 0
    ...
    public List<Long> parseValue(String str) {
        ...
        return oI0IIXIo.OOXIXo(NavType.LongType.parseValue(str));
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public java.util.List<java.lang.Long> parseValue(java.lang.String r2, java.util.List<java.lang.Long> r3) {
        /*
            r1 = this;
