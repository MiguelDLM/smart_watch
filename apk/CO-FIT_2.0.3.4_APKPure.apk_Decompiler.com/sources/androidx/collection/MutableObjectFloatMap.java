...
public final class MutableObjectFloatMap<K> extends ObjectFloatMap<K> {
    ...
    public final float getOrPut(K k, @OOXIXo oIX0oI<Float> oix0oi) {
    ...
    public final void plusAssign(@OOXIXo ObjectFloatMap<K> objectFloatMap) {
        IIX0o.x0xO0oo(objectFloatMap, TypedValues.TransitionType.S_FROM);
    ...
    public final void putAll(@OOXIXo ObjectFloatMap<K> objectFloatMap) {
        ObjectFloatMap<K> objectFloatMap2 = objectFloatMap;
        IIX0o.x0xO0oo(objectFloatMap2, TypedValues.TransitionType.S_FROM);
        Object[] objArr = objectFloatMap2.keys;
        float[] fArr = objectFloatMap2.values;
        long[] jArr = objectFloatMap2.metadata;
    ...
    public final void removeIf(@OOXIXo x0xO0oo<? super K, ? super Float, Boolean> x0xo0oo) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (x0xo0oo.invoke(this.keys[i4], Float.valueOf(this.values[i4])).booleanValue()) {
                                removeValueAt(i4);
                            }
                        }
                        j >>= 8;
    ...
    public /* synthetic */ MutableObjectFloatMap(int i, int i2, IIXOooo iIXOooo) {
        this((i2 & 1) != 0 ? 6 : i);
    }
