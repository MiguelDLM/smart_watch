...
public final class FloatListKt {
    ...
    public static final MutableFloatList mutableFloatListOf() {
        return new MutableFloatList(0, 1, (IIXOooo) null);
    }
    ...
    @OOXIXo
    public static final FloatList floatListOf(@OOXIXo float... fArr) {
    ...
    @OOXIXo
    public static final MutableFloatList mutableFloatListOf(@OOXIXo float... fArr) {
        IIX0o.x0xO0oo(fArr, "elements");
        MutableFloatList mutableFloatList = new MutableFloatList(fArr.length);
        mutableFloatList.plusAssign(fArr);
        return mutableFloatList;
