...
public final class MutableFloatIntMap extends FloatIntMap {
    ...
    public final int getOrPut(float f, @OOXIXo oIX0oI<Integer> oix0oi) {
    ...
    public final void plusAssign(@OOXIXo FloatIntMap floatIntMap) {
        IIX0o.x0xO0oo(floatIntMap, TypedValues.TransitionType.S_FROM);
        putAll(floatIntMap);
    }
    ...
    public final void putAll(@OOXIXo FloatIntMap floatIntMap) {
        FloatIntMap floatIntMap2 = floatIntMap;
        IIX0o.x0xO0oo(floatIntMap2, TypedValues.TransitionType.S_FROM);
        float[] fArr = floatIntMap2.keys;
        int[] iArr = floatIntMap2.values;
        long[] jArr = floatIntMap2.metadata;
    ...
    public final void removeIf(@OOXIXo x0xO0oo<? super Float, ? super Integer, Boolean> x0xo0oo) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (x0xo0oo.invoke(Float.valueOf(this.keys[i4]), Integer.valueOf(this.values[i4])).booleanValue()) {
                                removeValueAt(i4);
                            }
                        }
                        j >>= 8;
    ...
    public /* synthetic */ MutableFloatIntMap(int i, int i2, IIXOooo iIXOooo) {
        this((i2 & 1) != 0 ? 6 : i);
    }
