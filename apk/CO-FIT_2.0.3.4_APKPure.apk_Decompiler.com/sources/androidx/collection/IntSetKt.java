...
public final class IntSetKt {
    ...
    public static final MutableIntSet mutableIntSetOf() {
        return new MutableIntSet(0, 1, (IIXOooo) null);
    }
    ...
    @OOXIXo
    public static final IntSet intSetOf(@OOXIXo int... iArr) {
    ...
    @OOXIXo
    public static final MutableIntSet mutableIntSetOf(@OOXIXo int... iArr) {
        IIX0o.x0xO0oo(iArr, "elements");
        MutableIntSet mutableIntSet = new MutableIntSet(iArr.length);
        mutableIntSet.plusAssign(iArr);
        return mutableIntSet;
