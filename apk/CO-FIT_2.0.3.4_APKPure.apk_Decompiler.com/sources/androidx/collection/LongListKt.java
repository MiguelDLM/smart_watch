...
public final class LongListKt {
    ...
    public static final MutableLongList mutableLongListOf() {
        return new MutableLongList(0, 1, (IIXOooo) null);
    }
    ...
    @OOXIXo
    public static final LongList longListOf(@OOXIXo long... jArr) {
    ...
    @OOXIXo
    public static final MutableLongList mutableLongListOf(@OOXIXo long... jArr) {
        IIX0o.x0xO0oo(jArr, "elements");
        MutableLongList mutableLongList = new MutableLongList(jArr.length);
        mutableLongList.plusAssign(jArr);
        return mutableLongList;
