...
public final class MutableIntFloatMap extends IntFloatMap {
    ...
    public final float getOrPut(int i, @OOXIXo oIX0oI<Float> oix0oi) {
        IIX0o.x0xO0oo(oix0oi, "defaultValue");
        int findKeyIndex = findKeyIndex(i);
        if (findKeyIndex >= 0) {
            return this.values[findKeyIndex];
        }
        float floatValue = oix0oi.invoke().floatValue();
        put(i, floatValue);
        return floatValue;
    }
    ...
    public final void plusAssign(@OOXIXo IntFloatMap intFloatMap) {
        IIX0o.x0xO0oo(intFloatMap, TypedValues.TransitionType.S_FROM);
        putAll(intFloatMap);
    }
    ...
    public final void putAll(@OOXIXo IntFloatMap intFloatMap) {
        IntFloatMap intFloatMap2 = intFloatMap;
        IIX0o.x0xO0oo(intFloatMap2, TypedValues.TransitionType.S_FROM);
        int[] iArr = intFloatMap2.keys;
        float[] fArr = intFloatMap2.values;
        long[] jArr = intFloatMap2.metadata;
    ...
    public final void removeIf(@OOXIXo x0xO0oo<? super Integer, ? super Float, Boolean> x0xo0oo) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (x0xo0oo.invoke(Integer.valueOf(this.keys[i4]), Float.valueOf(this.values[i4])).booleanValue()) {
                                removeValueAt(i4);
                            }
                        }
                        j >>= 8;
    ...
    public /* synthetic */ MutableIntFloatMap(int i, int i2, IIXOooo iIXOooo) {
        this((i2 & 1) != 0 ? 6 : i);
    }
