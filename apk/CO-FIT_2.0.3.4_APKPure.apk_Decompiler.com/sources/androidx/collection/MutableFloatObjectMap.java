...
public final class MutableFloatObjectMap<V> extends FloatObjectMap<V> {
    ...
    public final V getOrPut(float f, @OOXIXo oIX0oI<? extends V> oix0oi) {
    ...
    public final void plusAssign(@OOXIXo FloatObjectMap<V> floatObjectMap) {
        IIX0o.x0xO0oo(floatObjectMap, TypedValues.TransitionType.S_FROM);
    ...
    public final void putAll(@OOXIXo FloatObjectMap<V> floatObjectMap) {
        FloatObjectMap<V> floatObjectMap2 = floatObjectMap;
        IIX0o.x0xO0oo(floatObjectMap2, TypedValues.TransitionType.S_FROM);
        float[] fArr = floatObjectMap2.keys;
        Object[] objArr = floatObjectMap2.values;
        long[] jArr = floatObjectMap2.metadata;
    ...
    public final void removeIf(@OOXIXo x0xO0oo<? super Float, ? super V, Boolean> x0xo0oo) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (x0xo0oo.invoke(Float.valueOf(this.keys[i4]), this.values[i4]).booleanValue()) {
                                removeValueAt(i4);
                            }
                        }
                        j >>= 8;
    ...
    public /* synthetic */ MutableFloatObjectMap(int i, int i2, IIXOooo iIXOooo) {
        this((i2 & 1) != 0 ? 6 : i);
    }

    public final void minusAssign(@OOXIXo float[] fArr) {
        IIX0o.x0xO0oo(fArr, "keys");
    ...
    public final void minusAssign(@OOXIXo FloatSet floatSet) {
        IIX0o.x0xO0oo(floatSet, "keys");
