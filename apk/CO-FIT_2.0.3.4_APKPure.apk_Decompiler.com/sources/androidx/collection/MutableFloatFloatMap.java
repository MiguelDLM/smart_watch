...
public final class MutableFloatFloatMap extends FloatFloatMap {
    ...
    public final float getOrPut(float f, @OOXIXo oIX0oI<Float> oix0oi) {
    ...
    public final void plusAssign(@OOXIXo FloatFloatMap floatFloatMap) {
        IIX0o.x0xO0oo(floatFloatMap, TypedValues.TransitionType.S_FROM);
    ...
    public final void putAll(@OOXIXo FloatFloatMap floatFloatMap) {
        FloatFloatMap floatFloatMap2 = floatFloatMap;
        IIX0o.x0xO0oo(floatFloatMap2, TypedValues.TransitionType.S_FROM);
        float[] fArr = floatFloatMap2.keys;
        float[] fArr2 = floatFloatMap2.values;
        long[] jArr = floatFloatMap2.metadata;
    ...
    public final void removeIf(@OOXIXo x0xO0oo<? super Float, ? super Float, Boolean> x0xo0oo) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (x0xo0oo.invoke(Float.valueOf(this.keys[i4]), Float.valueOf(this.values[i4])).booleanValue()) {
                                removeValueAt(i4);
                            }
                        }
                        j >>= 8;
