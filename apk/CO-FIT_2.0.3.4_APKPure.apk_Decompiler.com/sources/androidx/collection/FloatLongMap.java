...
public abstract class FloatLongMap {
    ...
    public /* synthetic */ FloatLongMap(IIXOooo iIXOooo) {
        this();
    }
    ...
    public final boolean all(@OOXIXo x0xO0oo<? super Float, ? super Long, Boolean> x0xo0oo) {
        x0xO0oo<? super Float, ? super Long, Boolean> x0xo0oo2 = x0xo0oo;
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (!x0xo0oo2.invoke(Float.valueOf(fArr[i4]), Long.valueOf(jArr[i4])).booleanValue()) {
                            return false;
                        }
                    }
                    j >>= 8;
    ...
    public final void forEach(@OOXIXo x0xO0oo<? super Float, ? super Long, oXIO0o0XI> x0xo0oo) {
        x0xO0oo<? super Float, ? super Long, oXIO0o0XI> x0xo0oo2 = x0xo0oo;
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            x0xo0oo2.invoke(Float.valueOf(fArr[i4]), Long.valueOf(jArr[i4]));
                        }
                        j >>= 8;
                    }
                    if (i2 != 8) {
    ...
    public final long getOrElse(float f, @OOXIXo oIX0oI<Long> oix0oi) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i5 = 0; i5 < i4; i5++) {
                        if ((255 & j) < 128) {
                            int i6 = (i2 << 3) + i5;
                            i3 += Float.floatToIntBits(fArr[i6]) ^ oIX0oI.oIX0oI(jArr[i6]);
                        }
                        j >>= 8;
                    }
                    if (i4 != 8) {
    ...
    public final boolean any(@OOXIXo x0xO0oo<? super Float, ? super Long, Boolean> x0xo0oo) {
        x0xO0oo<? super Float, ? super Long, Boolean> x0xo0oo2 = x0xo0oo;
        IIX0o.x0xO0oo(x0xo0oo2, "predicate");
        float[] fArr = this.keys;
        long[] jArr = this.values;
    ...
    public final int count(@OOXIXo x0xO0oo<? super Float, ? super Long, Boolean> x0xo0oo) {
        x0xO0oo<? super Float, ? super Long, Boolean> x0xo0oo2 = x0xo0oo;
        IIX0o.x0xO0oo(x0xo0oo2, "predicate");
        float[] fArr = this.keys;
        long[] jArr = this.values;
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i5 = 0; i5 < i4; i5++) {
                        if ((255 & j) < 128) {
                            int i6 = (i2 << 3) + i5;
                            if (x0xo0oo2.invoke(Float.valueOf(fArr[i6]), Long.valueOf(jArr[i6])).booleanValue()) {
                                i3++;
                            }
                        }
                        j >>= 8;
    ...
    public static /* synthetic */ String joinToString$default(FloatLongMap floatLongMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, x0xO0oo x0xo0oo, int i2, Object obj) {
        long[] jArr;
        long[] jArr2;
        FloatLongMap floatLongMap2 = floatLongMap;
        ...
        if (obj == null) {
            ...
            float[] fArr = floatLongMap2.keys;
            long[] jArr3 = floatLongMap2.values;
            long[] jArr4 = floatLongMap2.metadata;
                    ...
                    if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                        ...
                        while (i8 < i7) {
                            if ((j & 255) < 128) {
                                ...
                                jArr2 = jArr4;
                                sb.append((CharSequence) x0xo0oo2.invoke(Float.valueOf(f), Long.valueOf(j2)));
                                i5++;
                            } else {
                                jArr2 = jArr4;
                            }
    ...
    @xoIox
    @OOXIXo
    public final String joinToString(@OOXIXo CharSequence charSequence, @OOXIXo CharSequence charSequence2, @OOXIXo CharSequence charSequence3, int i, @OOXIXo CharSequence charSequence4, @OOXIXo x0xO0oo<? super Float, ? super Long, ? extends CharSequence> x0xo0oo) {
        CharSequence charSequence5 = charSequence;
        CharSequence charSequence6 = charSequence2;
        CharSequence charSequence7 = charSequence3;
        CharSequence charSequence8 = charSequence4;
        x0xO0oo<? super Float, ? super Long, ? extends CharSequence> x0xo0oo2 = x0xo0oo;
        IIX0o.x0xO0oo(charSequence5, "separator");
        IIX0o.x0xO0oo(charSequence6, RequestParameters.PREFIX);
    ...
    @xoIox
    @OOXIXo
    public final String joinToString(@OOXIXo CharSequence charSequence, @OOXIXo CharSequence charSequence2, @OOXIXo CharSequence charSequence3, int i, @OOXIXo x0xO0oo<? super Float, ? super Long, ? extends CharSequence> x0xo0oo) {
    ...
    @xoIox
    @OOXIXo
    public final String joinToString(@OOXIXo CharSequence charSequence, @OOXIXo CharSequence charSequence2, @OOXIXo CharSequence charSequence3, @OOXIXo x0xO0oo<? super Float, ? super Long, ? extends CharSequence> x0xo0oo) {
        CharSequence charSequence4 = charSequence;
        CharSequence charSequence5 = charSequence2;
        CharSequence charSequence6 = charSequence3;
        x0xO0oo<? super Float, ? super Long, ? extends CharSequence> x0xo0oo2 = x0xo0oo;
    ...
    @xoIox
    @OOXIXo
    public final String joinToString(@OOXIXo CharSequence charSequence, @OOXIXo CharSequence charSequence2, @OOXIXo x0xO0oo<? super Float, ? super Long, ? extends CharSequence> x0xo0oo) {
    ...
    @xoIox
    @OOXIXo
    public final String joinToString(@OOXIXo CharSequence charSequence, @OOXIXo x0xO0oo<? super Float, ? super Long, ? extends CharSequence> x0xo0oo) {
    ...
    @xoIox
    @OOXIXo
    public final String joinToString(@OOXIXo x0xO0oo<? super Float, ? super Long, ? extends CharSequence> x0xo0oo) {
        x0xO0oo<? super Float, ? super Long, ? extends CharSequence> x0xo0oo2 = x0xo0oo;
        IIX0o.x0xO0oo(x0xo0oo2, "transform");
        StringBuilder sb = new StringBuilder();
        sb.append("");
