...
public final class ObjectFloatMapKt {
    ...
    public static final <K> ObjectFloatMap<K> emptyObjectFloatMap() {
        ...
        IIX0o.x0XOIxOo(mutableObjectFloatMap, "null cannot be cast to non-null type androidx.collection.ObjectFloatMap<K of androidx.collection.ObjectFloatMapKt.emptyObjectFloatMap>");
        return mutableObjectFloatMap;
    }

    @OOXIXo
    public static final <K> MutableObjectFloatMap<K> mutableObjectFloatMapOf() {
        return new MutableObjectFloatMap<>(0, 1, (IIXOooo) null);
    }

    @OOXIXo
    public static final <K> ObjectFloatMap<K> objectFloatMap() {
        MutableObjectFloatMap<Object> mutableObjectFloatMap = EmptyObjectFloatMap;
        IIX0o.x0XOIxOo(mutableObjectFloatMap, "null cannot be cast to non-null type androidx.collection.ObjectFloatMap<K of androidx.collection.ObjectFloatMapKt.objectFloatMap>");
        return mutableObjectFloatMap;
    }

    @OOXIXo
    public static final <K> ObjectFloatMap<K> objectFloatMapOf(K k, float f) {
        MutableObjectFloatMap mutableObjectFloatMap = new MutableObjectFloatMap(0, 1, (IIXOooo) null);
    ...
    public static final <K> MutableObjectFloatMap<K> mutableObjectFloatMapOf(K k, float f) {
        MutableObjectFloatMap<K> mutableObjectFloatMap = new MutableObjectFloatMap<>(0, 1, (IIXOooo) null);
        mutableObjectFloatMap.set(k, f);
        return mutableObjectFloatMap;
    }
