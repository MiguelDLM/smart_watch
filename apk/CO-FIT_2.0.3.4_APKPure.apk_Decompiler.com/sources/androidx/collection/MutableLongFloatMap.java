...
public final class MutableLongFloatMap extends LongFloatMap {
    ...
    public final float getOrPut(long j, @OOXIXo oIX0oI<Float> oix0oi) {
    ...
    public final void plusAssign(@OOXIXo LongFloatMap longFloatMap) {
        IIX0o.x0xO0oo(longFloatMap, TypedValues.TransitionType.S_FROM);
        putAll(longFloatMap);
    }
    ...
    public final void putAll(@OOXIXo LongFloatMap longFloatMap) {
        LongFloatMap longFloatMap2 = longFloatMap;
        IIX0o.x0xO0oo(longFloatMap2, TypedValues.TransitionType.S_FROM);
        long[] jArr = longFloatMap2.keys;
        float[] fArr = longFloatMap2.values;
        long[] jArr2 = longFloatMap2.metadata;
    ...
    public final void removeIf(@OOXIXo x0xO0oo<? super Long, ? super Float, Boolean> x0xo0oo) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (x0xo0oo.invoke(Long.valueOf(this.keys[i4]), Float.valueOf(this.values[i4])).booleanValue()) {
                                removeValueAt(i4);
                            }
                        }
                        j >>= 8;
