...
public final class MutableLongObjectMap<V> extends LongObjectMap<V> {
    ...
    public final V getOrPut(long j, @OOXIXo oIX0oI<? extends V> oix0oi) {
    ...
    public final void plusAssign(@OOXIXo LongObjectMap<V> longObjectMap) {
        IIX0o.x0xO0oo(longObjectMap, TypedValues.TransitionType.S_FROM);
    ...
    public final void putAll(@OOXIXo LongObjectMap<V> longObjectMap) {
        LongObjectMap<V> longObjectMap2 = longObjectMap;
        IIX0o.x0xO0oo(longObjectMap2, TypedValues.TransitionType.S_FROM);
        long[] jArr = longObjectMap2.keys;
        Object[] objArr = longObjectMap2.values;
        long[] jArr2 = longObjectMap2.metadata;
    ...
    public final void removeIf(@OOXIXo x0xO0oo<? super Long, ? super V, Boolean> x0xo0oo) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (x0xo0oo.invoke(Long.valueOf(this.keys[i4]), this.values[i4]).booleanValue()) {
                                removeValueAt(i4);
                            }
                        }
                        j >>= 8;
    ...
    public /* synthetic */ MutableLongObjectMap(int i, int i2, IIXOooo iIXOooo) {
        this((i2 & 1) != 0 ? 6 : i);
    }

    public final void minusAssign(@OOXIXo long[] jArr) {
        IIX0o.x0xO0oo(jArr, "keys");
    ...
    public final void minusAssign(@OOXIXo LongSet longSet) {
        IIX0o.x0xO0oo(longSet, "keys");
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:8:0x0068, code lost:
        if (((r6 & ((~r6) << 6)) & -9187201950435737472L) == 0) goto L_0x007e;
     */
    ...
    public final boolean remove(long r18, V r20) {
        ...
        L_0x006b:
            ...
            r1 = r1[r10]
            r6 = r20
            boolean r1 = kotlin.jvm.internal.IIX0o.Oxx0IOOO(r1, r6)
