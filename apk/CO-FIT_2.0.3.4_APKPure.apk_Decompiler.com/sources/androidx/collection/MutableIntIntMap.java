...
public final class MutableIntIntMap extends IntIntMap {
    ...
    public final int getOrPut(int i, @OOXIXo oIX0oI<Integer> oix0oi) {
        IIX0o.x0xO0oo(oix0oi, "defaultValue");
        int findKeyIndex = findKeyIndex(i);
        if (findKeyIndex >= 0) {
            return this.values[findKeyIndex];
        }
        int intValue = oix0oi.invoke().intValue();
        put(i, intValue);
        return intValue;
    }
    ...
    public final void plusAssign(@OOXIXo IntIntMap intIntMap) {
        IIX0o.x0xO0oo(intIntMap, TypedValues.TransitionType.S_FROM);
        putAll(intIntMap);
    }
    ...
    public final void putAll(@OOXIXo IntIntMap intIntMap) {
        IntIntMap intIntMap2 = intIntMap;
        IIX0o.x0xO0oo(intIntMap2, TypedValues.TransitionType.S_FROM);
        int[] iArr = intIntMap2.keys;
        int[] iArr2 = intIntMap2.values;
        long[] jArr = intIntMap2.metadata;
    ...
    public final void removeIf(@OOXIXo x0xO0oo<? super Integer, ? super Integer, Boolean> x0xo0oo) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (x0xo0oo.invoke(Integer.valueOf(this.keys[i4]), Integer.valueOf(this.values[i4])).booleanValue()) {
                                removeValueAt(i4);
                            }
                        }
                        j >>= 8;
    ...
    public /* synthetic */ MutableIntIntMap(int i, int i2, IIXOooo iIXOooo) {
        this((i2 & 1) != 0 ? 6 : i);
    }
