...
public final class MutableLongIntMap extends LongIntMap {
    ...
    public final int getOrPut(long j, @OOXIXo oIX0oI<Integer> oix0oi) {
    ...
    public final void plusAssign(@OOXIXo LongIntMap longIntMap) {
        IIX0o.x0xO0oo(longIntMap, TypedValues.TransitionType.S_FROM);
        putAll(longIntMap);
    }
    ...
    public final void putAll(@OOXIXo LongIntMap longIntMap) {
        LongIntMap longIntMap2 = longIntMap;
        IIX0o.x0xO0oo(longIntMap2, TypedValues.TransitionType.S_FROM);
        long[] jArr = longIntMap2.keys;
        int[] iArr = longIntMap2.values;
        long[] jArr2 = longIntMap2.metadata;
    ...
    public final void removeIf(@OOXIXo x0xO0oo<? super Long, ? super Integer, Boolean> x0xo0oo) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (x0xo0oo.invoke(Long.valueOf(this.keys[i4]), Integer.valueOf(this.values[i4])).booleanValue()) {
                                removeValueAt(i4);
                            }
                        }
                        j >>= 8;
    ...
    public /* synthetic */ MutableLongIntMap(int i, int i2, IIXOooo iIXOooo) {
        this((i2 & 1) != 0 ? 6 : i);
    }
