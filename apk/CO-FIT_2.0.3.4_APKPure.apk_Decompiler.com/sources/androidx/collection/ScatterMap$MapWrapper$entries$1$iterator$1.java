...
public final class ScatterMap$MapWrapper$entries$1$iterator$1 extends RestrictedSuspendLambda implements x0xO0oo<oO<? super Map.Entry<? extends K, ? extends V>>, I0Io<? super oXIO0o0XI>, Object> {
    int I$0;
    int I$1;
    int I$2;
    int I$3;
    ...
    public final Object invoke(@OOXIXo oO<? super Map.Entry<? extends K, ? extends V>> oOVar, @oOoXoXO I0Io<? super oXIO0o0XI> i0Io) {
        return ((ScatterMap$MapWrapper$entries$1$iterator$1) create(oOVar, i0Io)).invokeSuspend(oXIO0o0XI.f19155oIX0oI);
    }
}
