...
public abstract class LongFloatMap {
    ...
    public /* synthetic */ LongFloatMap(IIXOooo iIXOooo) {
        this();
    }
    ...
    public final boolean all(@OOXIXo x0xO0oo<? super Long, ? super Float, Boolean> x0xo0oo) {
        x0xO0oo<? super Long, ? super Float, Boolean> x0xo0oo2 = x0xo0oo;
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (!x0xo0oo2.invoke(Long.valueOf(jArr[i4]), Float.valueOf(fArr[i4])).booleanValue()) {
                            return false;
                        }
                    }
                    j >>= 8;
    ...
    public final void forEach(@OOXIXo x0xO0oo<? super Long, ? super Float, oXIO0o0XI> x0xo0oo) {
        x0xO0oo<? super Long, ? super Float, oXIO0o0XI> x0xo0oo2 = x0xo0oo;
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            x0xo0oo2.invoke(Long.valueOf(jArr[i4]), Float.valueOf(fArr[i4]));
                        }
                        j >>= 8;
                    }
                    if (i2 != 8) {
    ...
    public final float getOrElse(long j, @OOXIXo oIX0oI<Float> oix0oi) {
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i5 = 0; i5 < i4; i5++) {
                        if ((255 & j) < 128) {
                            int i6 = (i2 << 3) + i5;
                            long j2 = jArr[i6];
                            i3 += Float.floatToIntBits(fArr[i6]) ^ oIX0oI.oIX0oI(j2);
                        }
                        j >>= 8;
                    }
                    if (i4 != 8) {
    ...
    public final boolean any(@OOXIXo x0xO0oo<? super Long, ? super Float, Boolean> x0xo0oo) {
        x0xO0oo<? super Long, ? super Float, Boolean> x0xo0oo2 = x0xo0oo;
        IIX0o.x0xO0oo(x0xo0oo2, "predicate");
        long[] jArr = this.keys;
        float[] fArr = this.values;
    ...
    public final int count(@OOXIXo x0xO0oo<? super Long, ? super Float, Boolean> x0xo0oo) {
        x0xO0oo<? super Long, ? super Float, Boolean> x0xo0oo2 = x0xo0oo;
        IIX0o.x0xO0oo(x0xo0oo2, "predicate");
        long[] jArr = this.keys;
        float[] fArr = this.values;
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i5 = 0; i5 < i4; i5++) {
                        if ((255 & j) < 128) {
                            int i6 = (i2 << 3) + i5;
                            if (x0xo0oo2.invoke(Long.valueOf(jArr[i6]), Float.valueOf(fArr[i6])).booleanValue()) {
                                i3++;
                            }
                        }
                        j >>= 8;
    ...
    public static /* synthetic */ String joinToString$default(LongFloatMap longFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, x0xO0oo x0xo0oo, int i2, Object obj) {
        long[] jArr;
        long[] jArr2;
        LongFloatMap longFloatMap2 = longFloatMap;
        ...
        if (obj == null) {
            ...
            long[] jArr3 = longFloatMap2.keys;
            float[] fArr = longFloatMap2.values;
            long[] jArr4 = longFloatMap2.metadata;
    ...
    @xoIox
    @OOXIXo
    public final String joinToString(@OOXIXo CharSequence charSequence, @OOXIXo CharSequence charSequence2, @OOXIXo CharSequence charSequence3, int i, @OOXIXo CharSequence charSequence4, @OOXIXo x0xO0oo<? super Long, ? super Float, ? extends CharSequence> x0xo0oo) {
        CharSequence charSequence5 = charSequence;
        CharSequence charSequence6 = charSequence2;
        CharSequence charSequence7 = charSequence3;
        CharSequence charSequence8 = charSequence4;
        x0xO0oo<? super Long, ? super Float, ? extends CharSequence> x0xo0oo2 = x0xo0oo;
        IIX0o.x0xO0oo(charSequence5, "separator");
        IIX0o.x0xO0oo(charSequence6, RequestParameters.PREFIX);
        IIX0o.x0xO0oo(charSequence7, "postfix");
        IIX0o.x0xO0oo(charSequence8, "truncated");
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    while (i6 < i5) {
                        if ((j & 255) < 128) {
                            ...
                            sb.append((CharSequence) x0xo0oo2.invoke(Long.valueOf(j2), Float.valueOf(f)));
                            i3++;
                        }
                        j >>= 8;
                        i6++;
    ...
    @xoIox
    @OOXIXo
    public final String joinToString(@OOXIXo CharSequence charSequence, @OOXIXo CharSequence charSequence2, @OOXIXo CharSequence charSequence3, int i, @OOXIXo x0xO0oo<? super Long, ? super Float, ? extends CharSequence> x0xo0oo) {
    ...
    @xoIox
    @OOXIXo
    public final String joinToString(@OOXIXo CharSequence charSequence, @OOXIXo CharSequence charSequence2, @OOXIXo CharSequence charSequence3, @OOXIXo x0xO0oo<? super Long, ? super Float, ? extends CharSequence> x0xo0oo) {
        CharSequence charSequence4 = charSequence;
        CharSequence charSequence5 = charSequence2;
        CharSequence charSequence6 = charSequence3;
        x0xO0oo<? super Long, ? super Float, ? extends CharSequence> x0xo0oo2 = x0xo0oo;
    ...
    @xoIox
    @OOXIXo
    public final String joinToString(@OOXIXo CharSequence charSequence, @OOXIXo CharSequence charSequence2, @OOXIXo x0xO0oo<? super Long, ? super Float, ? extends CharSequence> x0xo0oo) {
    ...
    @xoIox
    @OOXIXo
    public final String joinToString(@OOXIXo CharSequence charSequence, @OOXIXo x0xO0oo<? super Long, ? super Float, ? extends CharSequence> x0xo0oo) {
    ...
    @xoIox
    @OOXIXo
    public final String joinToString(@OOXIXo x0xO0oo<? super Long, ? super Float, ? extends CharSequence> x0xo0oo) {
        x0xO0oo<? super Long, ? super Float, ? extends CharSequence> x0xo0oo2 = x0xo0oo;
        IIX0o.x0xO0oo(x0xo0oo2, "transform");
        StringBuilder sb = new StringBuilder();
        sb.append("");
