...
public final class MutableLongLongMap extends LongLongMap {
    ...
    public final long getOrPut(long j, @OOXIXo oIX0oI<Long> oix0oi) {
    ...
    public final void plusAssign(@OOXIXo LongLongMap longLongMap) {
        IIX0o.x0xO0oo(longLongMap, TypedValues.TransitionType.S_FROM);
        putAll(longLongMap);
    }
    ...
    public final void putAll(@OOXIXo LongLongMap longLongMap) {
        LongLongMap longLongMap2 = longLongMap;
        IIX0o.x0xO0oo(longLongMap2, TypedValues.TransitionType.S_FROM);
        long[] jArr = longLongMap2.keys;
        long[] jArr2 = longLongMap2.values;
        long[] jArr3 = longLongMap2.metadata;
    ...
    public final void removeIf(@OOXIXo x0xO0oo<? super Long, ? super Long, Boolean> x0xo0oo) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (x0xo0oo.invoke(Long.valueOf(this.keys[i4]), Long.valueOf(this.values[i4])).booleanValue()) {
                                removeValueAt(i4);
                            }
                        }
                        j >>= 8;
    ...
    public /* synthetic */ MutableLongLongMap(int i, int i2, IIXOooo iIXOooo) {
        this((i2 & 1) != 0 ? 6 : i);
    }
