...
public final class MutableFloatLongMap extends FloatLongMap {
    ...
    public final long getOrPut(float f, @OOXIXo oIX0oI<Long> oix0oi) {
    ...
    public final void plusAssign(@OOXIXo FloatLongMap floatLongMap) {
        IIX0o.x0xO0oo(floatLongMap, TypedValues.TransitionType.S_FROM);
        putAll(floatLongMap);
    }
    ...
    public final void putAll(@OOXIXo FloatLongMap floatLongMap) {
        FloatLongMap floatLongMap2 = floatLongMap;
        IIX0o.x0xO0oo(floatLongMap2, TypedValues.TransitionType.S_FROM);
        float[] fArr = floatLongMap2.keys;
        long[] jArr = floatLongMap2.values;
        long[] jArr2 = floatLongMap2.metadata;
    ...
    public final void removeIf(@OOXIXo x0xO0oo<? super Float, ? super Long, Boolean> x0xo0oo) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (x0xo0oo.invoke(Float.valueOf(this.keys[i4]), Long.valueOf(this.values[i4])).booleanValue()) {
                                removeValueAt(i4);
                            }
                        }
                        j >>= 8;
    ...
    public /* synthetic */ MutableFloatLongMap(int i, int i2, IIXOooo iIXOooo) {
        this((i2 & 1) != 0 ? 6 : i);
    }
