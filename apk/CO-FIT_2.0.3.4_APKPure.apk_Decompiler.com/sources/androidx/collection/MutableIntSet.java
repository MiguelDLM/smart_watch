...
public final class MutableIntSet extends IntSet {
    ...
    private final int findAbsoluteInsertIndex(int i) {
        ...
        while (true) {
            ...
            for (long j4 = (~j3) & (j3 - ScatterMapKt.BitmaskLsb) & -9187201950435737472L; j4 != 0; j4 &= j4 - 1) {
                ...
                if (this.elements[numberOfTrailingZeros] == i3) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:8:0x005f, code lost:
        if (((r4 & ((~r4) << 6)) & -9187201950435737472L) == 0) goto L_0x0068;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:8:0x0064, code lost:
        if (((r7 & ((~r7) << 6)) & -9187201950435737472L) == 0) goto L_0x0070;
     */
    ...
    public /* synthetic */ MutableIntSet(int i, int i2, IIXOooo iIXOooo) {
        this((i2 & 1) != 0 ? 6 : i);
    }
    ...
    public final boolean addAll(@OOXIXo IntSet intSet) {
        IIX0o.x0xO0oo(intSet, "elements");
        int i = this._size;
        plusAssign(intSet);
        return i != this._size;
    }

    public final boolean removeAll(@OOXIXo IntSet intSet) {
        IIX0o.x0xO0oo(intSet, "elements");
        int i = this._size;
        minusAssign(intSet);
        return i != this._size;
    ...
    public final void plusAssign(@OOXIXo IntSet intSet) {
        IIX0o.x0xO0oo(intSet, "elements");
