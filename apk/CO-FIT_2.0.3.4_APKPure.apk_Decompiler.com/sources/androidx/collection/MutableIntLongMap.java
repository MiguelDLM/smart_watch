...
public final class MutableIntLongMap extends IntLongMap {
    ...
    public final long getOrPut(int i, @OOXIXo oIX0oI<Long> oix0oi) {
    ...
    public final void plusAssign(@OOXIXo IntLongMap intLongMap) {
        IIX0o.x0xO0oo(intLongMap, TypedValues.TransitionType.S_FROM);
        putAll(intLongMap);
    }
    ...
    public final void putAll(@OOXIXo IntLongMap intLongMap) {
        IntLongMap intLongMap2 = intLongMap;
        IIX0o.x0xO0oo(intLongMap2, TypedValues.TransitionType.S_FROM);
        int[] iArr = intLongMap2.keys;
        long[] jArr = intLongMap2.values;
        long[] jArr2 = intLongMap2.metadata;
    ...
    public final void removeIf(@OOXIXo x0xO0oo<? super Integer, ? super Long, Boolean> x0xo0oo) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (x0xo0oo.invoke(Integer.valueOf(this.keys[i4]), Long.valueOf(this.values[i4])).booleanValue()) {
                                removeValueAt(i4);
                            }
                        }
                        j >>= 8;
    ...
    public /* synthetic */ MutableIntLongMap(int i, int i2, IIXOooo iIXOooo) {
        this((i2 & 1) != 0 ? 6 : i);
    }
