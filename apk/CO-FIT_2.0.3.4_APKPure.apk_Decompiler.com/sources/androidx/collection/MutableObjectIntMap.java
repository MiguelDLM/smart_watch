...
public final class MutableObjectIntMap<K> extends ObjectIntMap<K> {
    ...
    public final int getOrPut(K k, @OOXIXo oIX0oI<Integer> oix0oi) {
    ...
    public final void plusAssign(@OOXIXo ObjectIntMap<K> objectIntMap) {
        IIX0o.x0xO0oo(objectIntMap, TypedValues.TransitionType.S_FROM);
        putAll(objectIntMap);
    }
    ...
    public final void putAll(@OOXIXo ObjectIntMap<K> objectIntMap) {
        ObjectIntMap<K> objectIntMap2 = objectIntMap;
        IIX0o.x0xO0oo(objectIntMap2, TypedValues.TransitionType.S_FROM);
    ...
    public final void removeIf(@OOXIXo x0xO0oo<? super K, ? super Integer, Boolean> x0xo0oo) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (x0xo0oo.invoke(this.keys[i4], Integer.valueOf(this.values[i4])).booleanValue()) {
                                removeValueAt(i4);
                            }
                        }
                        j >>= 8;
