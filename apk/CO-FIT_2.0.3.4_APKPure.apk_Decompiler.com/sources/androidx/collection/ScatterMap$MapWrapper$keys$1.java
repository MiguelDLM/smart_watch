...
public final class ScatterMap$MapWrapper$keys$1 implements Set<K>, oIX0oI {
    ...
    public Iterator<K> iterator() {
        return IXxxXO.oIX0oI(new ScatterMap$MapWrapper$keys$1$iterator$1(this.this$0, (I0Io<? super ScatterMap$MapWrapper$keys$1$iterator$1>) null));
    }
