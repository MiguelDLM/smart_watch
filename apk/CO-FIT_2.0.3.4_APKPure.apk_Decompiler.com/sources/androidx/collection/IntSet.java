...
public abstract class IntSet {
    ...
    public /* synthetic */ IntSet(IIXOooo iIXOooo) {
        this();
    }
    ...
    public final boolean all(@OOXIXo oOoXoXO<? super Integer, Boolean> oooxoxo) {
        oOoXoXO<? super Integer, Boolean> oooxoxo2 = oooxoxo;
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128 && !oooxoxo2.invoke(Integer.valueOf(iArr[(i << 3) + i3])).booleanValue()) {
                        return false;
                    }
                    j >>= 8;
                }
    ...
    public final void forEach(@OOXIXo oOoXoXO<? super Integer, oXIO0o0XI> oooxoxo) {
    ...
    public final boolean any(@OOXIXo oOoXoXO<? super Integer, Boolean> oooxoxo) {
        oOoXoXO<? super Integer, Boolean> oooxoxo2 = oooxoxo;
        IIX0o.x0xO0oo(oooxoxo2, "predicate");
        int[] iArr = this.elements;
        long[] jArr = this.metadata;
    ...
    @IntRange(from = 0)
    public final int count(@OOXIXo oOoXoXO<? super Integer, Boolean> oooxoxo) {
        oOoXoXO<? super Integer, Boolean> oooxoxo2 = oooxoxo;
        IIX0o.x0xO0oo(oooxoxo2, "predicate");
        int[] iArr = this.elements;
        long[] jArr = this.metadata;
        ...
        if (length >= 0) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    int i4 = 8 - ((~(i2 - length)) >>> 31);
                    for (int i5 = 0; i5 < i4; i5++) {
                        if ((255 & j) < 128 && oooxoxo2.invoke(Integer.valueOf(iArr[(i2 << 3) + i5])).booleanValue()) {
                            i3++;
                        }
                        j >>= 8;
                    }
    ...
    public static /* synthetic */ String joinToString$default(IntSet intSet, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, oOoXoXO oooxoxo, int i2, Object obj) {
                    ...
                    if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                        ...
                        for (int i8 = 0; i8 < i7; i8++) {
                            if ((j & 255) < 128) {
                                ...
                                sb.append((CharSequence) oooxoxo2.invoke(Integer.valueOf(i9)));
                                i5++;
                                i6 = 8;
                            }
                            j >>= i6;
    ...
    public final int first(@OOXIXo oOoXoXO<? super Integer, Boolean> oooxoxo) {
        oOoXoXO<? super Integer, Boolean> oooxoxo2 = oooxoxo;
        IIX0o.x0xO0oo(oooxoxo2, "predicate");
        int[] iArr = this.elements;
        long[] jArr = this.metadata;
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = iArr[(i << 3) + i3];
                            if (oooxoxo2.invoke(Integer.valueOf(i4)).booleanValue()) {
                                return i4;
                            }
                        }
                        j >>= 8;
    ...
    @xoIox
    @OOXIXo
    public final String joinToString(@OOXIXo CharSequence charSequence, @OOXIXo CharSequence charSequence2, @OOXIXo CharSequence charSequence3, int i, @OOXIXo CharSequence charSequence4, @OOXIXo oOoXoXO<? super Integer, ? extends CharSequence> oooxoxo) {
        CharSequence charSequence5 = charSequence;
        CharSequence charSequence6 = charSequence2;
        CharSequence charSequence7 = charSequence3;
        CharSequence charSequence8 = charSequence4;
        oOoXoXO<? super Integer, ? extends CharSequence> oooxoxo2 = oooxoxo;
        IIX0o.x0xO0oo(charSequence5, "separator");
        IIX0o.x0xO0oo(charSequence6, RequestParameters.PREFIX);
        IIX0o.x0xO0oo(charSequence7, "postfix");
        IIX0o.x0xO0oo(charSequence8, "truncated");
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    while (i5 < i4) {
                        if ((j & 255) < 128) {
                            ...
                            sb.append((CharSequence) oooxoxo2.invoke(Integer.valueOf(i6)));
                            i3++;
                        } else {
                            int i7 = i;
                        }
    ...
    @xoIox
    @OOXIXo
    public final String joinToString(@OOXIXo CharSequence charSequence, @OOXIXo CharSequence charSequence2, @OOXIXo CharSequence charSequence3, int i, @OOXIXo oOoXoXO<? super Integer, ? extends CharSequence> oooxoxo) {
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i6 = 0; i6 < i5; i6++) {
                        if ((j & 255) < 128) {
                            ...
                            sb.append((CharSequence) oooxoxo2.invoke(Integer.valueOf(i7)));
                            i3++;
                            i4 = 8;
                        } else {
                            int i8 = i;
    ...
    @xoIox
    @OOXIXo
    public final String joinToString(@OOXIXo CharSequence charSequence, @OOXIXo CharSequence charSequence2, @OOXIXo CharSequence charSequence3, @OOXIXo oOoXoXO<? super Integer, ? extends CharSequence> oooxoxo) {
        CharSequence charSequence4 = charSequence;
        CharSequence charSequence5 = charSequence2;
        CharSequence charSequence6 = charSequence3;
        oOoXoXO<? super Integer, ? extends CharSequence> oooxoxo2 = oooxoxo;
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i4 = 0; i4 < i3; i4++) {
                        if ((j & 255) < 128) {
                            ...
                            sb.append((CharSequence) oooxoxo2.invoke(Integer.valueOf(i5)));
                            i2++;
                        }
                        j >>= 8;
                    }
    ...
    @xoIox
    @OOXIXo
    public final String joinToString(@OOXIXo CharSequence charSequence, @OOXIXo CharSequence charSequence2, @OOXIXo oOoXoXO<? super Integer, ? extends CharSequence> oooxoxo) {
    ...
    @xoIox
    @OOXIXo
    public final String joinToString(@OOXIXo CharSequence charSequence, @OOXIXo oOoXoXO<? super Integer, ? extends CharSequence> oooxoxo) {
    ...
    @xoIox
    @OOXIXo
    public final String joinToString(@OOXIXo oOoXoXO<? super Integer, ? extends CharSequence> oooxoxo) {
        oOoXoXO<? super Integer, ? extends CharSequence> oooxoxo2 = oooxoxo;
        IIX0o.x0xO0oo(oooxoxo2, "transform");
        StringBuilder sb = new StringBuilder();
        sb.append("");
