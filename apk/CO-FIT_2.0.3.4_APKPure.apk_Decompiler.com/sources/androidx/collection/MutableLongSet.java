...
public final class MutableLongSet extends LongSet {
    ...
    public /* synthetic */ MutableLongSet(int i, int i2, IIXOooo iIXOooo) {
        this((i2 & 1) != 0 ? 6 : i);
    }
    ...
    public final boolean addAll(@OOXIXo LongSet longSet) {
        IIX0o.x0xO0oo(longSet, "elements");
        int i = this._size;
        plusAssign(longSet);
        return i != this._size;
    }

    public final boolean removeAll(@OOXIXo LongSet longSet) {
        IIX0o.x0xO0oo(longSet, "elements");
        int i = this._size;
        minusAssign(longSet);
        return i != this._size;
    ...
    public final void plusAssign(@OOXIXo LongSet longSet) {
        IIX0o.x0xO0oo(longSet, "elements");
