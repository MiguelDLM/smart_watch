...
public final class MutableFloatSet extends FloatSet {
    ...
    public final void plusAssign(@OOXIXo float[] fArr) {
        IIX0o.x0xO0oo(fArr, "elements");
        for (float plusAssign : fArr) {
            plusAssign(plusAssign);
        }
    }

    public final boolean addAll(@OOXIXo FloatSet floatSet) {
        IIX0o.x0xO0oo(floatSet, "elements");
        int i = this._size;
        plusAssign(floatSet);
        return i != this._size;
    }

    public final boolean removeAll(@OOXIXo FloatSet floatSet) {
        IIX0o.x0xO0oo(floatSet, "elements");
        int i = this._size;
    ...
    public final void plusAssign(@OOXIXo FloatSet floatSet) {
        IIX0o.x0xO0oo(floatSet, "elements");
