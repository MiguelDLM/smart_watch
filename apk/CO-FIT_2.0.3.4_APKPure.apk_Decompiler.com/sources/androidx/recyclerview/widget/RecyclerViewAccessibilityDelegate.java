...
public class RecyclerViewAccessibilityDelegate extends AccessibilityDelegateCompat {
    ...
    public static class ItemDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(@SuppressLint({"InvalidNullabilityOverride"}) @NonNull View view, @SuppressLint({"InvalidNullabilityOverride"}) @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
        ...
        public boolean performAccessibilityAction(@SuppressLint({"InvalidNullabilityOverride"}) @NonNull View view, int i, @SuppressLint({"InvalidNullabilityOverride"}) @Nullable Bundle bundle) {
            if (this.mRecyclerViewDelegate.shouldIgnore() || this.mRecyclerViewDelegate.mRecyclerView.getLayoutManager() == null) {
    ...
    public void onInitializeAccessibilityEvent(@SuppressLint({"InvalidNullabilityOverride"}) @NonNull View view, @SuppressLint({"InvalidNullabilityOverride"}) @NonNull AccessibilityEvent accessibilityEvent) {
        super.onInitializeAccessibilityEvent(view, accessibilityEvent);
