...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                iArr5[0] = 0;
                iArr5[1] = 0;
                recyclerView5.dispatchNestedScroll(i, i2, consumeFlingInHorizontalStretch, consumeFlingInVerticalStretch, (int[]) null, 1, iArr5);
    ...
    public static abstract class ViewHolder {
        ...
        public String toString() {
            ...
            if (!isRecyclable()) {
                sb.append(" not recyclable(" + this.mIsRecyclableCount + oIX0oI.I0Io.f17331I0Io);
            }
    ...
    private int consumeFlingInStretch(int i, EdgeEffect edgeEffect, EdgeEffect edgeEffect2, int i2) {
        if (i > 0 && edgeEffect != null && EdgeEffectCompat.getDistance(edgeEffect) != 0.0f) {
            int round = Math.round((((float) (-i2)) / 4.0f) * EdgeEffectCompat.onPullDistance(edgeEffect, (((float) (-i)) * 4.0f) / ((float) i2), 0.5f));
            if (round != i) {
                edgeEffect.finish();
            }
            return i - round;
            ...
            float f = (float) i2;
            int round2 = Math.round((f / 4.0f) * EdgeEffectCompat.onPullDistance(edgeEffect2, (((float) i) * 4.0f) / f, 0.5f));
            if (round2 != i) {
                edgeEffect2.finish();
            }
            return i - round2;
