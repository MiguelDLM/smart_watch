...
public class DiffUtil {
    ...
    private static Snake forward(Range range, Callback callback, CenteredArray centeredArray, CenteredArray centeredArray2, int i) {
        ...
        while (i7 <= i) {
            ...
            while (i2 < range.oldListEnd && i8 < range.newListEnd && callback.areItemsTheSame(i2, i8)) {
                i2++;
                i8++;
            }
            centeredArray.set(i7, i2);
            if (!z || (i5 = oldSize - i7) < i6 + 1 || i5 > i - 1 || centeredArray2.get(i5) > i2) {
                i7 += 2;
            } else {
                Snake snake = new Snake();
                snake.startX = i3;
