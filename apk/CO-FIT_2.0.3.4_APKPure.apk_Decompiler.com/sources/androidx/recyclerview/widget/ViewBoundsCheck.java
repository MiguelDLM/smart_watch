...
class ViewBoundsCheck {
    ...
    public static class BoundFlags {
        ...
        public boolean boundsMatch() {
            ...
            if ((i3 & SubBinId.Bbpro.SECURE_BOOT_LOADER_IMAGE) != 0 && (i3 & (compare(this.mChildEnd, this.mRvStart) << 8)) == 0) {
                return false;
            }
            int i4 = this.mBoundFlags;
            if ((i4 & xxXXXxIxo.f34123II0xO0) == 0 || (i4 & (compare(this.mChildEnd, this.mRvEnd) << 12)) != 0) {
                return true;
            }
            return false;
        }
