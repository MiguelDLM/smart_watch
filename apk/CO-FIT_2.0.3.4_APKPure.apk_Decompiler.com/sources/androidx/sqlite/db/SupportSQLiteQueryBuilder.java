...
public final class SupportSQLiteQueryBuilder {
    ...
    public static final class Companion {
        ...
        @x0XOIxOo
        @OOXIXo
        public final SupportSQLiteQueryBuilder builder(@OOXIXo String str) {
            IIX0o.x0xO0oo(str, "tableName");
            return new SupportSQLiteQueryBuilder(str, (IIXOooo) null);
        }
    ...
    @OOXIXo
    public final SupportSQLiteQueryBuilder limit(@OOXIXo String str) {
        IIX0o.x0xO0oo(str, "limit");
