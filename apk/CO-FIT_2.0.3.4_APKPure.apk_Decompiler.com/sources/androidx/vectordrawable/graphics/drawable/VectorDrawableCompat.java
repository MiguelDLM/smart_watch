...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:15:0x0022 A[Catch:{ XmlPullParserException -> 0x0020, IOException -> 0x001e }] */
    /* JADX WARNING: Removed duplicated region for block: B:9:0x0019 A[Catch:{ XmlPullParserException -> 0x0020, IOException -> 0x001e }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static androidx.vectordrawable.graphics.drawable.VectorDrawableCompat createWithoutDelegate(@androidx.annotation.NonNull android.content.res.Resources r6, @androidx.annotation.DrawableRes int r7, @androidx.annotation.Nullable android.content.res.Resources.Theme r8) {
        /*
            java.lang.String r0 = "parser error"
            java.lang.String r1 = "VectorDrawableCompat"
            android.content.res.XmlResourceParser r7 = r6.getXml(r7)     // Catch:{ XmlPullParserException -> 0x0020, IOException -> 0x001e }
            android.util.AttributeSet r2 = android.util.Xml.asAttributeSet(r7)     // Catch:{ XmlPullParserException -> 0x0020, IOException -> 0x001e }
        L_0x000c:
            int r3 = r7.next()     // Catch:{ XmlPullParserException -> 0x0020, IOException -> 0x001e }
            r4 = 2
        ...
        L_0x0017:
            ...
            androidx.vectordrawable.graphics.drawable.VectorDrawableCompat r6 = createFromXmlInner(r6, r7, r2, r8)     // Catch:{ XmlPullParserException -> 0x0020, IOException -> 0x001e }
            return r6
        L_0x001e:
            r6 = move-exception
            goto L_0x002a
        L_0x0020:
            ...
            goto L_0x002e
        L_0x0022:
            org.xmlpull.v1.XmlPullParserException r6 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ XmlPullParserException -> 0x0020, IOException -> 0x001e }
            java.lang.String r7 = "No start tag found"
            r6.<init>(r7)     // Catch:{ XmlPullParserException -> 0x0020, IOException -> 0x001e }
            throw r6     // Catch:{ XmlPullParserException -> 0x0020, IOException -> 0x001e }
        L_0x002a:
    ...
    private void printGroupTree(VGroup vGroup, int i) {
        ...
        Log.v(LOGTAG, sb + "current group is :" + vGroup.getGroupName() + " rotation is " + vGroup.mRotate);
    ...
    public static abstract class VPath extends VObject {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (PathParser.PathDataNode pathDataNode : pathDataNodeArr) {
                ...
                sb.append(":");
                for (float append : pathDataNode.getParams()) {
                    sb.append(append);
                    sb.append(",");
                }
            }
        ...
        public void printVPath(int i) {
            ...
            Log.v(VectorDrawableCompat.LOGTAG, sb + "current path is :" + this.mPathName + " pathData is " + nodesToString(this.mNodes));
        }
