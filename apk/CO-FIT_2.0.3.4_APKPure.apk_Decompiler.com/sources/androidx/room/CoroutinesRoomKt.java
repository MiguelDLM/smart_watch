...
public final class CoroutinesRoomKt {
    ...
    public static final CoroutineDispatcher getQueryDispatcher(@OOXIXo RoomDatabase roomDatabase) {
    ...
    @OOXIXo
    public static final CoroutineDispatcher getTransactionDispatcher(@OOXIXo RoomDatabase roomDatabase) {
        Map<String, Object> backingFieldMap = roomDatabase.getBackingFieldMap();
