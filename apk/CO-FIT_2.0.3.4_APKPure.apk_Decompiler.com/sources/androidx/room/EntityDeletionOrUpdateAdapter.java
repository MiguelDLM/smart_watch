...
public abstract class EntityDeletionOrUpdateAdapter<T> extends SharedSQLiteStatement {
    ...
    public EntityDeletionOrUpdateAdapter(@OOXIXo RoomDatabase roomDatabase) {
        super(roomDatabase);
    ...
    public final int handleMultiple(@OOXIXo Iterable<? extends T> iterable) {
    ...
    public final int handleMultiple(@OOXIXo T[] tArr) {
