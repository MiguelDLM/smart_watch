    ...
    private int[][] parseSpans(String str, boolean z) {
        try {
                ...
                if (this.mColumns != 1) {
                    for (int i = 0; i < split.length; i++) {
                        ...
                        if (isSubGridByColRow()) {
                            iArr2[i][1] = Integer.parseInt(split3[1]);
                            iArr2[i][2] = Integer.parseInt(split3[0]);
                        } else {
            ...
            for (int i4 = 0; i4 < split.length; i4++) {
                ...
                iArr2[i4][0] = Integer.parseInt(split4[0]);
                int[] iArr3 = iArr2[i4];
                iArr3[1] = 1;
                iArr3[2] = 1;
                if (this.mColumns == 1) {
                ...
                if (this.mRows == 1) {
                    iArr2[i4][2] = Integer.parseInt(split4[1]);
                    i3 += iArr2[i4][2];
                    if (z) {
                        i3--;
                    }
