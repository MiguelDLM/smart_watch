        ...
        try {
            switch (AnonymousClass1.$SwitchMap$androidx$constraintlayout$widget$ConstraintAttribute$AttributeType[constraintAttribute.getType().ordinal()]) {
                ...
                case 3:
                    ...
                    method.invoke(view3, new Object[]{colorDrawable});
                    return;
                case 4:
                    try {
                        try {
                            cls.getMethod(str, new Class[]{Integer.TYPE}).invoke(view, new Object[]{Integer.valueOf(clamp((int) (((float) Math.pow((double) fArr[2], 0.45454545454545453d)) * 255.0f)) | (clamp((int) (fArr[3] * 255.0f)) << 24) | (clamp((int) (((float) Math.pow((double) fArr[0], 0.45454545454545453d)) * 255.0f)) << 16) | (clamp((int) (((float) Math.pow((double) fArr[1], 0.45454545454545453d)) * 255.0f)) << 8))});
                            return;
                        } catch (NoSuchMethodException e) {
                            e = e;
                            Log.e(TAG, "No method " + str + " on View \"" + Debug.getName(view) + "\"", e);
                        } catch (IllegalAccessException e2) {
                            e = e2;
                            Log.e(TAG, "Cannot access method " + str + " on View \"" + Debug.getName(view) + "\"", e);
                        } catch (InvocationTargetException e3) {
                            e = e3;
                            Log.e(TAG, "Cannot invoke method " + str + " on View \"" + Debug.getName(view) + "\"", e);
                        }
