    ...
    public void onDraw(@NonNull Canvas canvas) {
        ...
        if (isInEditMode()) {
            ...
            while (i < length) {
                ...
                float f = (float) (bottom - top);
                int i2 = top;
                int i3 = bottom2;
                Paint paint2 = paint;
                canvas.drawRect((float) (view.getLeft() - left), 0.0f, (float) (view.getRight() - left), f, paint2);
                canvas.drawRect(0.0f, (float) top2, (float) (right - left), (float) i3, paint2);
                i++;
                top = i2;
            }
        }
