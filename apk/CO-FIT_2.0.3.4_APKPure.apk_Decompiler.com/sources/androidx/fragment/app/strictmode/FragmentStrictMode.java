...
import OXOo.OOXIXo;
import OXOo.oOoXoXO;
import X0o0xo.II0xO0;
import X0o0xo.oIX0oI;
import XO0OX.XO;
...
public final class FragmentStrictMode {
    ...
    public static final class Policy {
        ...
        @XO
        @OOXIXo
        public static final Policy LAX = new Policy(Xo0.OOXIXo(), (OnViolationListener) null, o0.O0xOxO());
        @OOXIXo
        ...
        public Policy(@OOXIXo Set<? extends Flag> set, @oOoXoXO OnViolationListener onViolationListener, @OOXIXo Map<String, ? extends Set<Class<? extends Violation>>> map) {
            IIX0o.x0xO0oo(set, bn.f.y);
            IIX0o.x0xO0oo(map, "allowedViolations");
            this.flags = set;
        ...
        public static final class Builder {
            ...
            @OOXIXo
            public final Builder allowViolation(@OOXIXo Class<? extends Fragment> cls, @OOXIXo Class<? extends Violation> cls2) {
                IIX0o.x0xO0oo(cls, "fragmentClass");
                IIX0o.x0xO0oo(cls2, "violationClass");
                String name = cls.getName();
                IIX0o.oO(name, "fragmentClassString");
            ...
            @SuppressLint({"BuilderSetStyle"})
            @OOXIXo
            public final Builder penaltyListener(@OOXIXo OnViolationListener onViolationListener) {
                IIX0o.x0xO0oo(onViolationListener, "listener");
                this.listener = onViolationListener;
                return this;
            }
            ...
            @SuppressLint({"BuilderSetStyle"})
            @OOXIXo
            public final Builder allowViolation(@OOXIXo String str, @OOXIXo Class<? extends Violation> cls) {
                IIX0o.x0xO0oo(str, "fragmentClass");
                IIX0o.x0xO0oo(cls, "violationClass");
    ...
    private final void handlePolicyViolation(Policy policy, Violation violation) {
        ...
        if (policy.getListener$fragment_release() != null) {
            runOnHostThread(fragment, new oIX0oI(policy, violation));
        }
        if (policy.getFlags$fragment_release().contains(Flag.PENALTY_DEATH)) {
            runOnHostThread(fragment, new II0xO0(name, violation));
        }
    }
    ...
    public static final void onFragmentReuse(@OOXIXo Fragment fragment, @OOXIXo String str) {
    ...
    @x0XOIxOo
    @RestrictTo({RestrictTo.Scope.LIBRARY})
    public static final void onSetTargetFragmentUsage(@OOXIXo Fragment fragment, @OOXIXo Fragment fragment2, int i) {
        IIX0o.x0xO0oo(fragment, "violatingFragment");
        IIX0o.x0xO0oo(fragment2, "targetFragment");
    ...
    @x0XOIxOo
    @RestrictTo({RestrictTo.Scope.LIBRARY})
    public static final void onWrongFragmentContainer(@OOXIXo Fragment fragment, @OOXIXo ViewGroup viewGroup) {
        IIX0o.x0xO0oo(fragment, "fragment");
