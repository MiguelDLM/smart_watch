...
abstract class SpecialEffectsController {
    ...
    public static class Operation {
        ...
        public final void mergeWith(@NonNull State state, @NonNull LifecycleImpact lifecycleImpact) {
            ...
            if (i != 1) {
                if (i == 2) {
                    ...
                    if (FragmentManager.isLoggingEnabled(2)) {
                        Log.v(FragmentManager.TAG, "SpecialEffectsController: For fragment " + this.mFragment + " mFinalState = " + this.mFinalState + oIX0oI.f22028oxoX + state + ". ");
                    }
                    this.mFinalState = state;
                }
        ...
        public String toString() {
            return "Operation " + "{" + Integer.toHexString(System.identityHashCode(this)) + "} " + "{" + "mFinalState = " + this.mFinalState + "} " + "{" + "mLifecycleImpact = " + this.mLifecycleImpact + "} " + "{" + "mFragment = " + this.mFragment + ooOOo0oXI.f22054oOoXoXO;
        }
