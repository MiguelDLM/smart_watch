        ...
        if (j >= 0) {
            ...
            do {
                ...
                if (randomAccessFile.readInt() == reverseBytes) {
                    ...
                    centralDirectory.size = ((long) Integer.reverseBytes(randomAccessFile.readInt())) & BleWatchFaceId.WATCHFACE_ID_INVALID;
                    centralDirectory.offset = ((long) Integer.reverseBytes(randomAccessFile.readInt())) & BleWatchFaceId.WATCHFACE_ID_INVALID;
