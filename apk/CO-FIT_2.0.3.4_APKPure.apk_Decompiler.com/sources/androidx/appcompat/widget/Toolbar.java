...
public class Toolbar extends ViewGroup implements MenuHost {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            ...
            if (z && this.mBackInvokedDispatcher == null) {
                if (this.mBackInvokedCallback == null) {
                    this.mBackInvokedCallback = Api33Impl.newOnBackInvokedCallback(new XOxIOxOx(this));
                }
    ...
    public Toolbar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mMenuHostHelper = new MenuHostHelper(new OI0(this));
