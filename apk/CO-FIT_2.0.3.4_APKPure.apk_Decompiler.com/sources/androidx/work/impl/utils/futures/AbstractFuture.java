...
import androidx.concurrent.futures.oIX0oI;
...
public abstract class AbstractFuture<V> implements ListenableFuture<V> {
    ...
    public static final class SafeAtomicHelper extends AtomicHelper {
        ...
        public boolean casListeners(AbstractFuture<?> abstractFuture, Listener listener, Listener listener2) {
            return oIX0oI.oIX0oI(this.listenersUpdater, abstractFuture, listener, listener2);
        }

        public boolean casValue(AbstractFuture<?> abstractFuture, Object obj, Object obj2) {
            return oIX0oI.oIX0oI(this.valueUpdater, abstractFuture, obj, obj2);
        }

        public boolean casWaiters(AbstractFuture<?> abstractFuture, Waiter waiter, Waiter waiter2) {
            return oIX0oI.oIX0oI(this.waitersUpdater, abstractFuture, waiter, waiter2);
        }
    ...
    static {
        /*
            ...
            log = r2
            androidx.work.impl.utils.futures.AbstractFuture$SafeAtomicHelper r2 = new androidx.work.impl.utils.futures.AbstractFuture$SafeAtomicHelper     // Catch:{ all -> 0x0049 }
            java.lang.Class<java.lang.Thread> r3 = java.lang.Thread.class
            java.lang.String r4 = "thread"
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r4 = java.util.concurrent.atomic.AtomicReferenceFieldUpdater.newUpdater(r0, r3, r4)     // Catch:{ all -> 0x0049 }
            java.lang.String r3 = "next"
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r5 = java.util.concurrent.atomic.AtomicReferenceFieldUpdater.newUpdater(r0, r0, r3)     // Catch:{ all -> 0x0049 }
            java.lang.String r3 = "waiters"
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r6 = java.util.concurrent.atomic.AtomicReferenceFieldUpdater.newUpdater(r1, r0, r3)     // Catch:{ all -> 0x0049 }
            ...
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r7 = java.util.concurrent.atomic.AtomicReferenceFieldUpdater.newUpdater(r1, r0, r3)     // Catch:{ all -> 0x0049 }
            java.lang.Class<java.lang.Object> r0 = java.lang.Object.class
            java.lang.String r3 = "value"
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r8 = java.util.concurrent.atomic.AtomicReferenceFieldUpdater.newUpdater(r1, r0, r3)     // Catch:{ all -> 0x0049 }
            r3 = r2
