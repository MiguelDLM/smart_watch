...
public final class StatusRunnable$forWorkQuerySpec$1 extends Lambda implements oOoXoXO<WorkDatabase, List<? extends WorkInfo>> {
    ...
    public final List<WorkInfo> invoke(WorkDatabase workDatabase) {
        ...
        List<WorkInfo> apply = WorkSpec.WORK_INFO_MAPPER.apply(workDatabase.rawWorkInfoDao().getWorkInfoPojos(RawQueries.toRawQuery(this.$querySpec)));
