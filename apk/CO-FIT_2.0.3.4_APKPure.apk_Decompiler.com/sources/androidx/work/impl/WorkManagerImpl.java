...
public class WorkManagerImpl extends WorkManager {
    ...
    public WorkManagerImpl(@NonNull Context context, @NonNull Configuration configuration, @NonNull TaskExecutor taskExecutor, @NonNull WorkDatabase workDatabase, @NonNull List<Scheduler> list, @NonNull Processor processor, @NonNull Trackers trackers) {
        ...
        if (Build.VERSION.SDK_INT < 24 || !Api24Impl.isDeviceProtectedStorage(applicationContext)) {
            ...
            xII createWorkManagerScope = WorkManagerImplExtKt.createWorkManagerScope(taskExecutor);
    ...
    public ListenableFuture<Long> getLastCancelAllTimeMillis() {
        ...
        return ListenableFutureKt.executeAsync(serialTaskExecutor, "getLastCancelAllTimeMillis", new OOXIXo(preferenceUtils));
    }
    ...
    @NonNull
    public X0o0xo<WorkInfo> getWorkInfoByIdFlow(@NonNull UUID uuid) {
    ...
    @NonNull
    public X0o0xo<List<WorkInfo>> getWorkInfosByTagFlow(@NonNull String str) {
    ...
    @NonNull
    public X0o0xo<List<WorkInfo>> getWorkInfosFlow(@NonNull WorkQuery workQuery) {
    ...
    @NonNull
    public X0o0xo<List<WorkInfo>> getWorkInfosForUniqueWorkFlow(@NonNull String str) {
    ...
    public void rescheduleEligibleWork() {
        TracerKt.traced(getConfiguration().getTracer(), "ReschedulingWork", new oOoXoXO(this));
    }
