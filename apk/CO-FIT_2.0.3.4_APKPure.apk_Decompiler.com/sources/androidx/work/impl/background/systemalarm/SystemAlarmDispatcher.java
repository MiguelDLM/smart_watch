...
public class SystemAlarmDispatcher implements ExecutionListener {
            ...
            this.mWorkManager.getWorkTaskExecutor().executeOnTaskThread(new Runnable() {
                public void run() {
                    ...
                    if (intent != null) {
                        ...
                        PowerManager.WakeLock newWakeLock = WakeLocks.newWakeLock(context, action + " (" + intExtra + oIX0oI.I0Io.f17331I0Io);
                        try {
    ...
    public boolean add(@NonNull Intent intent, int i) {
        Logger logger = Logger.get();
        String str = TAG;
        logger.debug(str, "Adding command " + intent + " (" + i + oIX0oI.I0Io.f17331I0Io);
        assertMainThread();
        String action = intent.getAction();
