...
public final class JobSchedulerExtKt {
    ...
    @RequiresApi(23)
    @OOXIXo
    public static final String createErrorMessage(@OOXIXo Context context, @OOXIXo WorkDatabase workDatabase, @OOXIXo Configuration configuration) {
        int i;
        int i2;
        String str;
    ...
    @RequiresApi(21)
    @OXOo.oOoXoXO
    public static final List<JobInfo> getSafePendingJobs(@OOXIXo JobScheduler jobScheduler) {
    ...
    @RequiresApi(21)
    @OOXIXo
    public static final JobScheduler getWmJobScheduler(@OOXIXo Context context) {
