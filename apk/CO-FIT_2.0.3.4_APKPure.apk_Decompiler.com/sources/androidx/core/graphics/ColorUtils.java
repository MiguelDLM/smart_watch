...
public final class ColorUtils {
    ...
    public static class Api26Impl {
        ...
        public static Color compositeColors(Color color, Color color2) {
            ...
            throw new IllegalArgumentException("Color models must match (" + color.getModel() + " vs. " + color2.getModel() + oIX0oI.I0Io.f17331I0Io);
        }
    }
    ...
    public static int XYZToColor(@FloatRange(from = 0.0d, to = 95.047d) double d, @FloatRange(from = 0.0d, to = 100.0d) double d2, @FloatRange(from = 0.0d, to = 108.883d) double d3) {
        ...
        double d5;
        double d6;
        double d7 = (((3.2406d * d) + (-1.5372d * d2)) + (-0.4986d * d3)) / XYZ_WHITE_REFERENCE_Y;
        double d8 = (((-0.9689d * d) + (1.8758d * d2)) + (0.0415d * d3)) / XYZ_WHITE_REFERENCE_Y;
        double d9 = (((0.0557d * d) + (-0.204d * d2)) + (1.057d * d3)) / XYZ_WHITE_REFERENCE_Y;
        if (d7 > 0.0031308d) {
    ...
    public static void XYZToLAB(@FloatRange(from = 0.0d, to = 95.047d) double d, @FloatRange(from = 0.0d, to = 100.0d) double d2, @FloatRange(from = 0.0d, to = 108.883d) double d3, @NonNull double[] dArr) {
        if (dArr.length == 3) {
            ...
            dArr[0] = Math.max(OOXIXo.f29376XO, (116.0d * pivotXyzComponent2) - 16.0d);
    ...
    public static void colorToM3HCT(@ColorInt int i, @Size(3) @NonNull float[] fArr) {
