    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context, @NonNull Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it.hasNext()) {
                    addPerson(Person.fromAndroidPerson(xoIox.oIX0oI(it.next())));
                }
            }
            int i = Build.VERSION.SDK_INT;
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (i >= 24) {
                ...
                for (Message androidMessage : this.mMessages) {
                    Api24Impl.addMessage(x0XOIxOo.oIX0oI(messagingStyle), androidMessage.toAndroidMessage());
                }
                if (Build.VERSION.SDK_INT >= 26) {
                    for (Message androidMessage2 : this.mHistoricMessages) {
                        Api26Impl.addHistoricMessage(x0XOIxOo.oIX0oI(messagingStyle), androidMessage2.toAndroidMessage());
                    }
                }
                if (this.mIsGroupConversation.booleanValue() || Build.VERSION.SDK_INT >= 28) {
                    Api24Impl.setConversationTitle(x0XOIxOo.oIX0oI(messagingStyle), this.mConversationTitle);
                }
                if (Build.VERSION.SDK_INT >= 28) {
                    Api28Impl.setGroupConversation(x0XOIxOo.oIX0oI(messagingStyle), this.mIsGroupConversation.booleanValue());
                }
