...
public final class TextViewKt$addTextChangedListener$2 extends Lambda implements Oxx0xo<CharSequence, Integer, Integer, Integer, oXIO0o0XI> {
    ...
    public final void invoke(@oOoXoXO CharSequence charSequence, int i, int i2, int i3) {
    }
