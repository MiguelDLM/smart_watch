    ...
    public static class Impl30 extends Impl {
        ...
        public void addOnControllableInsetsChangedListener(@NonNull OnControllableInsetsChangedListener onControllableInsetsChangedListener) {
            if (!this.mListeners.containsKey(onControllableInsetsChangedListener)) {
                Ix00oIoI ix00oIoI = new Ix00oIoI(this, onControllableInsetsChangedListener);
                this.mListeners.put(onControllableInsetsChangedListener, ix00oIoI);
                this.mInsetsController.addOnControllableInsetsChangedListener(ix00oIoI);
            }
        }
