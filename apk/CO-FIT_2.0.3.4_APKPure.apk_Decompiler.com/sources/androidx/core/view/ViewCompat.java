...
public class ViewCompat {
    ...
    private static final OnReceiveContentViewBehavior NO_OP_ON_RECEIVE_CONTENT_VIEW_BEHAVIOR = new xI();
    @Deprecated
    ...
    public static class Api28Impl {
        ...
        public static void addOnUnhandledKeyEventListener(@NonNull View view, @NonNull OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
            ...
            oo0xXOI0I oo0xxoi0i = new oo0xXOI0I(onUnhandledKeyEventListenerCompat);
            simpleArrayMap.put(onUnhandledKeyEventListenerCompat, oo0xxoi0i);
            view.addOnUnhandledKeyEventListener(oo0xxoi0i);
        }
