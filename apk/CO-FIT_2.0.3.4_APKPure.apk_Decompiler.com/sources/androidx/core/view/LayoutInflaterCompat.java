...
public final class LayoutInflaterCompat {
    ...
    public static class Factory2Wrapper implements LayoutInflater.Factory2 {
        ...
        public String toString() {
            return getClass().getName() + "{" + this.mDelegateFactory + ooOOo0oXI.f22054oOoXoXO;
        }
    ...
    private static void forceSetFactory2(LayoutInflater layoutInflater, LayoutInflater.Factory2 factory2) {
        ...
        if (!sCheckedField) {
            try {
                ...
                Log.e("LayoutInflaterCompatHC", "forceSetFactory2 Could not find field 'mFactory2' on class " + cls.getName() + "; inflation may have unexpected results.", e);
            }
            sCheckedField = true;
        }
