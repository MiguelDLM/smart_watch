...
public class WindowInsetsCompat {
    ...
    public static final class TypeImpl30 {
        ...
        public static int toPlatformType(int i) {
            ...
            for (int i3 = 1; i3 <= 256; i3 <<= 1) {
                if ((i & i3) != 0) {
                    if (i3 == 1) {
                        oIX0oI2 = WindowInsets.Type.statusBars();
                    } else if (i3 == 2) {
                        oIX0oI2 = WindowInsets.Type.navigationBars();
                    } else if (i3 == 4) {
                        oIX0oI2 = WindowInsets.Type.captionBar();
                    } else if (i3 == 8) {
                        oIX0oI2 = WindowInsets.Type.ime();
                    } else if (i3 == 16) {
                        oIX0oI2 = WindowInsets.Type.systemGestures();
                    } else if (i3 == 32) {
                        oIX0oI2 = WindowInsets.Type.mandatorySystemGestures();
                    } else if (i3 == 64) {
                        oIX0oI2 = WindowInsets.Type.tappableElement();
                    } else if (i3 == 128) {
                        oIX0oI2 = WindowInsets.Type.displayCutout();
                    }
                    i2 |= oIX0oI2;
                }
            }
    ...
    public static class BuilderImpl29 extends BuilderImpl {
        ...
        public BuilderImpl29() {
            this.mPlatBuilder = OOXIxO0.oIX0oI();
        }
        ...
        public BuilderImpl29(@NonNull WindowInsetsCompat windowInsetsCompat) {
            ...
            if (windowInsets != null) {
                builder = XI0oooXX.oIX0oI(windowInsets);
            } else {
                builder = OOXIxO0.oIX0oI();
            }
