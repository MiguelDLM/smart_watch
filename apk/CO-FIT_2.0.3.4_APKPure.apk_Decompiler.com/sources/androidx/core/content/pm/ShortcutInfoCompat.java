...
public class ShortcutInfoCompat {
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context, @NonNull ShortcutInfo shortcutInfo) {
            ...
            Intent[] oIX0oI2 = shortcutInfo.getIntents();
            shortcutInfoCompat.mIntents = (Intent[]) Arrays.copyOf(oIX0oI2, oIX0oI2.length);
    ...
    public static List<ShortcutInfoCompat> fromShortcuts(@NonNull Context context, @NonNull List<ShortcutInfo> list) {
        ...
        for (ShortcutInfo oIX0oI2 : list) {
            arrayList.add(new Builder(context, XO.oIX0oI(oIX0oI2)).build());
        }
        return arrayList;
    }
    ...
    public ShortcutInfo toShortcutInfo() {
        oOoXoXO.oIX0oI();
        ShortcutInfo.Builder oIX0oI2 = OOXIXo.oIX0oI(this.mContext, this.mId).setShortLabel(this.mLabel).setIntents(this.mIntents);
        IconCompat iconCompat = this.mIcon;
        if (iconCompat != null) {
            ShortcutInfo.Builder unused = oIX0oI2.setIcon(iconCompat.toIcon(this.mContext));
        }
        if (!TextUtils.isEmpty(this.mLongLabel)) {
            ShortcutInfo.Builder unused2 = oIX0oI2.setLongLabel(this.mLongLabel);
        }
        if (!TextUtils.isEmpty(this.mDisabledMessage)) {
            ShortcutInfo.Builder unused3 = oIX0oI2.setDisabledMessage(this.mDisabledMessage);
        }
        ComponentName componentName = this.mActivity;
        if (componentName != null) {
            ShortcutInfo.Builder unused4 = oIX0oI2.setActivity(componentName);
        }
        Set<String> set = this.mCategories;
        if (set != null) {
            ShortcutInfo.Builder unused5 = oIX0oI2.setCategories(set);
        }
        ShortcutInfo.Builder unused6 = oIX0oI2.setRank(this.mRank);
        PersistableBundle persistableBundle = this.mExtras;
        if (persistableBundle != null) {
            ShortcutInfo.Builder unused7 = oIX0oI2.setExtras(persistableBundle);
        }
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            if (personArr != null && personArr.length > 0) {
                ...
                ShortcutInfo.Builder unused8 = oIX0oI2.setPersons(personArr2);
            }
            LocusIdCompat locusIdCompat = this.mLocusId;
            if (locusIdCompat != null) {
                ShortcutInfo.Builder unused9 = oIX0oI2.setLocusId(locusIdCompat.toLocusId());
            }
            ShortcutInfo.Builder unused10 = oIX0oI2.setLongLived(this.mIsLongLived);
        } else {
            ShortcutInfo.Builder unused11 = oIX0oI2.setExtras(buildLegacyExtrasBundle());
        }
        if (Build.VERSION.SDK_INT >= 33) {
            Api33Impl.setExcludedFromSurfaces(oIX0oI2, this.mExcludedSurfaces);
        }
        return oIX0oI2.build();
    }
