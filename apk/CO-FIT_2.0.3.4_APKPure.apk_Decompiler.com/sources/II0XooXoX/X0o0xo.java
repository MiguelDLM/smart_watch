...
public class X0o0xo {
    ...
    public static final /* synthetic */ int f12oIX0oI = 0;
    ...
    public static byte[] II0xO0(String str, String str2) {
        try {
            String jSONStringer = new JSONStringer().object().key(MapItem.KEY_ITEM_SID).value(str).key("data").value(str2).key("ver").value(1).endObject().toString();
