...
public class II0XooXoX implements oOXoIIIo<DocumentData> {
    ...
    public static final JsonReader.oIX0oI f176II0xO0 = JsonReader.oIX0oI.oIX0oI("t", f.f23833a, "s", "j", "tr", "lh", "ls", "fc", "sc", "sw", MapBundleKey.MapObjKey.OBJ_OFFSET);

    /* renamed from: oIX0oI  reason: collision with root package name */
    public static final II0XooXoX f177oIX0oI = new II0XooXoX();
    ...
    public DocumentData oIX0oI(JsonReader jsonReader, float f) throws IOException {
        ...
        boolean z = true;
        while (jsonReader.XO()) {
            switch (jsonReader.Oo(f176II0xO0)) {
                case 0:
