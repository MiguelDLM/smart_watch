...
public final class MediaControllerCompat {
    ...
    public static class MediaControllerImplApi29 extends MediaControllerImplApi21 {
        ...
        public Bundle getSessionInfo() {
            ...
            Bundle oIX0oI2 = this.mControllerFwk.getSessionInfo();
            this.mSessionInfo = oIX0oI2;
            Bundle unparcelWithClassLoader = MediaSessionCompat.unparcelWithClassLoader(oIX0oI2);
            this.mSessionInfo = unparcelWithClassLoader;
            if (unparcelWithClassLoader == null) {
                return Bundle.EMPTY;
            }
    ...
    public static void validateCustomAction(String str, Bundle bundle) {
        if (str != null) {
            ...
            if (bundle == null || !bundle.containsKey(MediaSessionCompat.ARGUMENT_MEDIA_ATTRIBUTE)) {
                throw new IllegalArgumentException("An extra field android.support.v4.media.session.ARGUMENT_MEDIA_ATTRIBUTE is required for this action " + str + FileUtils.FILE_EXTENSION_SEPARATOR);
            }
        }
    }
