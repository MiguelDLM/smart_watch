...
public final class xoIox {
    ...
    public static final ThreadLocal<Path> f29I0Io = new II0xO0();

    /* renamed from: II0xO0  reason: collision with root package name */
    public static final ThreadLocal<PathMeasure> f30II0xO0 = new oIX0oI();

    /* renamed from: Oxx0IOOO  reason: collision with root package name */
    public static float f31Oxx0IOOO = -1.0f;

    /* renamed from: X0o0xo  reason: collision with root package name */
    public static final ThreadLocal<float[]> f32X0o0xo = new oxoX();

    /* renamed from: XO  reason: collision with root package name */
    public static final float f33XO = ((float) (Math.sqrt(2.0d) / 2.0d));

    /* renamed from: oIX0oI  reason: collision with root package name */
    public static final int f34oIX0oI = 1000000000;

    /* renamed from: oxoX  reason: collision with root package name */
    public static final ThreadLocal<Path> f35oxoX = new I0Io();
    ...
    public static float X0o0xo() {
        if (f31Oxx0IOOO == -1.0f) {
            f31Oxx0IOOO = Resources.getSystem().getDisplayMetrics().density;
        }
        return f31Oxx0IOOO;
    }
    ...
    public static void oIX0oI(Path path, float f, float f2, float f3) {
        X0o0xo.oIX0oI("applyTrimPathIfNeeded");
        PathMeasure pathMeasure = f30II0xO0.get();
        Path path2 = f29I0Io.get();
        Path path3 = f35oxoX.get();
        pathMeasure.setPath(path, false);
        float length = pathMeasure.getLength();
        if (f == 1.0f && f2 == 0.0f) {
            X0o0xo.II0xO0("applyTrimPathIfNeeded");
            ...
            if (min >= length && max >= length) {
                min = (float) xxIXOIIO.Oxx0IOOO(min, length);
                max = (float) xxIXOIIO.Oxx0IOOO(max, length);
            }
            if (min < 0.0f) {
                min = (float) xxIXOIIO.Oxx0IOOO(min, length);
            }
    ...
    public static void oO(Canvas canvas, RectF rectF, Paint paint, int i) {
        X0o0xo.oIX0oI("Utils#saveLayer");
        if (Build.VERSION.SDK_INT < 23) {
            canvas.saveLayer(rectF, paint, i);
        } else {
            canvas.saveLayer(rectF, paint);
        }
        X0o0xo.II0xO0("Utils#saveLayer");
    }
