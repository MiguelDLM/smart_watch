...
public class xxIXOIIO {
    ...
    public static PointF f36oIX0oI = new PointF();
    ...
    public static void ooOOo0oXI(oxoX oxox, int i, List<oxoX> list, oxoX oxox2, OOXIXo oOXIXo) {
