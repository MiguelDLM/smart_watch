...
public class XO extends II0XooXoX {

    /* renamed from: IXxxXO, reason: collision with root package name */
    public static XO f1002IXxxXO;

    public static XO IIxOXoOo0() {
        XO xo2 = f1002IXxxXO;
        if (xo2 == null) {
            XO xo3 = new XO();
            f1002IXxxXO = xo3;
    ...
    public int I0X0x0oIo() {
        double d;
        double d2 = ((((this.f978oIX0oI * 0.444d) * this.f973II0xO0) * 0.663d) * 88.83d) / 10000.0d;
        double oxoX2 = oxoX();
        double d3 = (1.0d - (oxoX2 / 80.0d)) * this.f978oIX0oI;
        if (oOoXoXO()) {
            d = 0.1d;
        } else {
            d = 0.05d;
        }
        return (int) (((1.0d - d) * this.f982oxoX) + ((d * ((d3 / d2) + (oxoX2 / 0.20000000298023224d))) / 2.0d));
    }
    ...
    */
    public double[] OOXIxO0() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: Ix0x.XO.OOXIxO0():double[]");
    }
    ...
    */
    public double[] Oo() {
        ...
        L45:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: Ix0x.XO.Oo():double[]");
    }
    ...
    */
    public double[] XOxIOxOx() {
        ...
        L45:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: Ix0x.XO.XOxIOxOx():double[]");
    }

    @Override // Ix0x.II0XooXoX
    public double XX0xXo() {
        return X0o0xo() * 0.3499999940395355d;
    }
    ...
    */
    public com.vtrump.vtble.Scale.ScaleInfo.a XoI0Ixx0() {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: Ix0x.XO.XoI0Ixx0():com.vtrump.vtble.Scale.ScaleInfo$a");
    }
    ...
    public int x0xO() {
        ...
        if (oOoXoXO()) {
            ...
            d2 = this.f978oIX0oI;
            d3 = (((((250.7286d - (1.2975d * d)) + (0.1631d * d5)) + (0.0114d * d2)) + (((0.4436d * d) * d) / d2)) - (((0.3007d * d2) * d5) / d)) + (((0.0082d * d2) * d2) / d5);
            d4 = 85.5984d;
        } else {
            d = this.f973II0xO0;
            double d6 = this.f982oxoX;
            d2 = this.f978oIX0oI;
            d3 = (((((158.6793d - (0.9336d * d)) - (0.4336d * d6)) + (0.4263d * d2)) + (((0.265d * d) * d) / d2)) + (((0.7336d * d2) * d6) / d)) - (((0.0786d * d2) * d2) / d6);
            d4 = 45.2435d;
        }
    ...
    */
    public double xoxXI() {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: Ix0x.XO.xoxXI():double");
    }
