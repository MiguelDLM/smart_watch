...
public final class Ox0O extends xoO0xx0<Short, short[], xOoOIoI> implements kotlinx.serialization.Oxx0IOOO<short[]> {

    /* renamed from: I0Io, reason: collision with root package name */
    @OXOo.OOXIXo
    public static final Ox0O f30659I0Io = new Ox0O();

    public Ox0O() {
        super(xx.oOoXoXO.oo0xXOI0I(kotlin.jvm.internal.OI0.f29295oIX0oI));
    }

    @Override // kotlinx.serialization.internal.oIX0oI
    /* renamed from: XI0IXoo, reason: merged with bridge method [inline-methods] */
    public int xoIox(@OXOo.OOXIXo short[] sArr) {
    ...
    public xOoOIoI x0xO0oo(@OXOo.OOXIXo short[] sArr) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(sArr, "<this>");
        return new xOoOIoI(sArr);
    }

    @Override // kotlinx.serialization.internal.xoO0xx0
    /* renamed from: xXxxox0I, reason: merged with bridge method [inline-methods] */
    public void X0IIOO(@OXOo.OOXIXo xIXoO0Xx.X0o0xo encoder, @OXOo.OOXIXo short[] content, int i) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(encoder, "encoder");
        kotlin.jvm.internal.IIX0o.x0xO0oo(content, "content");
        for (int i2 = 0; i2 < i; i2++) {
            encoder.encodeShortElement(oIX0oI(), i2, content[i2]);
        }
    }
    ...
    public void ooOOo0oXI(@OXOo.OOXIXo xIXoO0Xx.oxoX decoder, int i, @OXOo.OOXIXo xOoOIoI builder, boolean z) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(decoder, "decoder");
        kotlin.jvm.internal.IIX0o.x0xO0oo(builder, "builder");
        builder.X0o0xo(decoder.decodeShortElement(oIX0oI(), i));
    }
}
