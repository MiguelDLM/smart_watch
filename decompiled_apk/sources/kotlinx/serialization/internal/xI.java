...
public final class xI implements kotlinx.serialization.Oxx0IOOO<Float> {

    /* renamed from: oIX0oI, reason: collision with root package name */
    @OXOo.OOXIXo
    public static final xI f30754oIX0oI = new xI();

    /* renamed from: II0xO0, reason: collision with root package name */
    @OXOo.OOXIXo
    public static final kotlinx.serialization.descriptors.XO f30753II0xO0 = new xX0IIXIx0("kotlin.Float", X0o0xo.C1116X0o0xo.f30591oIX0oI);

    @Override // kotlinx.serialization.Oxx0xo
    public /* bridge */ /* synthetic */ void II0xO0(xIXoO0Xx.II0XooXoX iI0XooXoX, Object obj) {
        Oxx0IOOO(iI0XooXoX, ((Number) obj).floatValue());
    }

    public void Oxx0IOOO(@OXOo.OOXIXo xIXoO0Xx.II0XooXoX encoder, float f) {
    ...
    public Float oxoX(@OXOo.OOXIXo xIXoO0Xx.XO decoder) {
