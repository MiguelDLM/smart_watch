...
@IXIxx0.oxoX(c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7", f = "Zip.kt", i = {}, l = {308}, m = "invokeSuspend", n = {}, s = {})
@XX({"SMAP\nZip.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Zip.kt\nkotlinx/coroutines/flow/FlowKt__ZipKt$combineTransform$7\n*L\n1#1,332:1\n*E\n"})
/* loaded from: classes6.dex */
public final class FlowKt__ZipKt$combineTransform$7<R> extends SuspendLambda implements Oox.x0xO0oo<XO<? super R>, kotlin.coroutines.I0Io<? super oXIO0o0XI>, Object> {
    ...
    public static final class AnonymousClass1<T> extends Lambda implements Oox.oIX0oI<T[]> {
        ...
        public AnonymousClass1(X0o0xo<T>[] x0o0xoArr) {
            super(0);
    ...
    /* JADX INFO: Add missing generic type declarations: [T] */
    @IXIxx0.oxoX(c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2", f = "Zip.kt", i = {}, l = {308}, m = "invokeSuspend", n = {}, s = {})
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public FlowKt__ZipKt$combineTransform$7(X0o0xo<T>[] x0o0xoArr, Oox.IXxxXO<? super XO<? super R>, ? super T[], ? super kotlin.coroutines.I0Io<? super oXIO0o0XI>, ? extends Object> iXxxXO, kotlin.coroutines.I0Io<? super FlowKt__ZipKt$combineTransform$7> i0Io) {
        super(2, i0Io);
        this.$flowArray = x0o0xoArr;
        this.$transform = iXxxXO;
    }
    ...
    public final kotlin.coroutines.I0Io<oXIO0o0XI> create(@OXOo.oOoXoXO Object obj, @OXOo.OOXIXo kotlin.coroutines.I0Io<?> i0Io) {
        FlowKt__ZipKt$combineTransform$7 flowKt__ZipKt$combineTransform$7 = new FlowKt__ZipKt$combineTransform$7(this.$flowArray, this.$transform, i0Io);
    ...
    public final Object invokeSuspend(@OXOo.OOXIXo Object obj) {
        ...
        if (i != 0) {
            ...
            I0oOoX.x0XOIxOo(obj);
            XO xo2 = (XO) this.L$0;
            X0o0xo<T>[] x0o0xoArr = this.$flowArray;
            IIX0o.xoXoI();
    ...
    public final Object invoke(@OXOo.OOXIXo XO<? super R> xo2, @OXOo.oOoXoXO kotlin.coroutines.I0Io<? super oXIO0o0XI> i0Io) {
        return ((FlowKt__ZipKt$combineTransform$7) create(xo2, i0Io)).invokeSuspend(oXIO0o0XI.f29392oIX0oI);
    }
}
