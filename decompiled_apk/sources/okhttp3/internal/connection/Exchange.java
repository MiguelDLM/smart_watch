...
public final class Exchange {
    ...
    public final class RequestBodySink extends ForwardingSink {
        ...
        public RequestBodySink(@OOXIXo Exchange exchange, Sink delegate, long j) {
            super(delegate);
    ...
    public final class ResponseBodySource extends ForwardingSource {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public ResponseBodySource(@OOXIXo Exchange exchange, Source delegate, long j) {
            super(delegate);
            IIX0o.x0xO0oo(delegate, "delegate");
            this.this$0 = exchange;
            this.contentLength = j;
    ...
    public Exchange(@OOXIXo RealCall call, @OOXIXo EventListener eventListener, @OOXIXo ExchangeFinder finder, @OOXIXo ExchangeCodec codec) {
        IIX0o.x0xO0oo(call, "call");
        IIX0o.x0xO0oo(eventListener, "eventListener");
        IIX0o.x0xO0oo(finder, "finder");
        IIX0o.x0xO0oo(codec, "codec");
        this.call = call;
    ...
    @OOXIXo
    public final Sink createRequestBody(@OOXIXo Request request, boolean z) throws IOException {
    ...
    public final boolean isCoalescedConnection$okhttp() {
        return !IIX0o.Oxx0IOOO(this.finder.getAddress$okhttp().url().host(), this.connection.route().address().url().host());
    }
    ...
    @OOXIXo
    public final ResponseBody openResponseBody(@OOXIXo Response response) throws IOException {
    ...
    public final void responseHeadersEnd(@OOXIXo Response response) {
        IIX0o.x0xO0oo(response, "response");
    ...
    public final void writeRequestHeaders(@OOXIXo Request request) throws IOException {
        IIX0o.x0xO0oo(request, "request");
        try {
