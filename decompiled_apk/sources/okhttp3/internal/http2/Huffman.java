...
public final class Huffman {
    ...
    private final void addCode(int i, int i2, int i3) {
        ...
        IIX0o.ooOOo0oXI(children2);
        ooOOo0oXI.xX(children2, node, i6, (1 << i5) + i6);
    }

    public final void decode(@OOXIXo BufferedSource source, long j, @OOXIXo BufferedSink sink) {
    ...
    public final void encode(@OOXIXo ByteString source, @OOXIXo BufferedSink sink) throws IOException {
        IIX0o.x0xO0oo(source, "source");
        IIX0o.x0xO0oo(sink, "sink");
    ...
    public final int encodedLength(@OOXIXo ByteString bytes) {
