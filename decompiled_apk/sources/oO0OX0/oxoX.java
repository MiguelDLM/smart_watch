...
public class oxoX {
    ...
    public static final String[][] f31974I0Io;

    /* renamed from: II0XooXoX, reason: collision with root package name */
    public static final String[][] f31975II0XooXoX;

    /* renamed from: II0xO0, reason: collision with root package name */
    public static final String[][] f31976II0xO0;

    /* renamed from: Oxx0IOOO, reason: collision with root package name */
    public static final String[][] f31977Oxx0IOOO;

    /* renamed from: X0o0xo, reason: collision with root package name */
    public static final String[][] f31978X0o0xo;

    /* renamed from: XO, reason: collision with root package name */
    public static final String[][] f31979XO;

    /* renamed from: oIX0oI, reason: collision with root package name */
    public static final String[][] f31980oIX0oI;

    /* renamed from: oxoX, reason: collision with root package name */
    public static final String[][] f31981oxoX;

    /* renamed from: xoIox, reason: collision with root package name */
    public static final String[][] f31982xoIox;

    /* renamed from: xxIXOIIO, reason: collision with root package name */
    public static final String[][] f31983xxIXOIIO;
    ...
    static {
        ...
        f31974I0Io = strArr2;
        f31981oxoX = OOXIXo(strArr2);
        String[][] strArr3 = {new String[]{"\"", "&quot;"}, new String[]{"&", "&amp;"}, new String[]{"<", "&lt;"}, new String[]{">", "&gt;"}};
        f31978X0o0xo = strArr3;
        f31979XO = OOXIXo(strArr3);
        String[][] strArr4 = {new String[]{"'", "&apos;"}};
        f31977Oxx0IOOO = strArr4;
        f31975II0XooXoX = OOXIXo(strArr4);
        String[][] strArr5 = {new String[]{"\b", "\\b"}, new String[]{"\n", "\\n"}, new String[]{"\t", "\\t"}, new String[]{"\f", "\\f"}, new String[]{xXOx.f32950X0o0xo, "\\r"}};
        f31983xxIXOIIO = strArr5;
        f31982xoIox = OOXIXo(strArr5);
    }

    public static String[][] I0Io() {
        return (String[][]) f31978X0o0xo.clone();
    }

    public static String[][] II0XooXoX() {
        return (String[][]) f31976II0xO0.clone();
    }

    public static String[][] II0xO0() {
        return (String[][]) f31975II0XooXoX.clone();
    }

    public static String[][] OOXIXo(String[][] strArr) {
    ...
    public static String[][] Oxx0IOOO() {
        return (String[][]) f31980oIX0oI.clone();
    }

    public static String[][] X0o0xo() {
        return (String[][]) f31974I0Io.clone();
    }

    public static String[][] XO() {
        return (String[][]) f31981oxoX.clone();
    }

    public static String[][] oIX0oI() {
        return (String[][]) f31977Oxx0IOOO.clone();
    }

    public static String[][] oxoX() {
        return (String[][]) f31979XO.clone();
    }

    public static String[][] xoIox() {
        return (String[][]) f31982xoIox.clone();
    }

    public static String[][] xxIXOIIO() {
        return (String[][]) f31983xxIXOIIO.clone();
    }
}
