        ...
        Code(context, str, new ac() { // from class: com.huawei.hms.ads.bm.1
            ...
            public void Code(AdContentData adContentData) {
                ...
                if (adEventReport2 != null) {
                    jc.Code(context, adContentData, com.huawei.openalliance.ad.constant.ai.C, Long.valueOf(adEventReport2.c() == null ? 0L : adEventReport.c().longValue()), Long.valueOf(adEventReport.d() != null ? adEventReport.d().longValue() : 0L), Integer.valueOf(adEventReport.e() == null ? 0 : adEventReport.e().intValue()), Integer.valueOf(adEventReport.f() != null ? adEventReport.f().intValue() : 0));
                }
