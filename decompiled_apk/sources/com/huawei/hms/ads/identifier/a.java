...
public final class a implements ServiceConnection {
    ...
    public static final ThreadPoolExecutor f17296a = new ThreadPoolExecutor(0, 3, 60, TimeUnit.SECONDS, new LinkedBlockingQueue(2048), new ThreadPoolExecutor.DiscardPolicy());
    boolean b = false;
    ...
    public void onServiceConnected(ComponentName componentName, final IBinder iBinder) {
        ...
        f17296a.execute(new Runnable() { // from class: com.huawei.hms.ads.identifier.a.1
