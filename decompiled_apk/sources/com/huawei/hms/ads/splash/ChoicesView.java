...
public class ChoicesView extends ImageView {
    ...
    public class AnonymousClass1 implements Runnable {
        ...
        /* loaded from: classes10.dex */
        public class C06521 implements RemoteCallResultCallback<String> {
            public C06521() {
            }
            ...
            public void onRemoteCallResult(String str, CallResult<String> callResult) {
                ...
                sourceParam.I(data);
                z.Code(ChoicesView.this.getContext(), sourceParam, new an() { // from class: com.huawei.hms.ads.splash.ChoicesView.1.1.1
                    @Override // com.huawei.openalliance.ad.utils.an
                    public void Code() {
                        fb.Code("ChoicesView", "download icon fail, use local icon");
                        bf.Code(new Runnable() { // from class: com.huawei.hms.ads.splash.ChoicesView.1.1.1.2
                    ...
                    public void Code(String str2, final Drawable drawable) {
                        if (drawable != null) {
                            bf.Code(new Runnable() { // from class: com.huawei.hms.ads.splash.ChoicesView.1.1.1.1
                                @Override // java.lang.Runnable
                                public void run() {
        ...
        public void run() {
            ...
            sourceParam.V(false);
            sourceParam.I(true);
            sourceParam.Code(x.i);
            sourceParam.I(this.Code);
            sourceParam.I(true);
            JSONObject jSONObject = new JSONObject();
            try {
                jSONObject.put("content", aa.V(sourceParam));
                g.V(ChoicesView.this.getContext()).Code(s.L, jSONObject.toString(), new C06521(), String.class);
