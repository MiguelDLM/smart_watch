...
public class GDTFileProvider extends ContentProvider {
    ...
    public static class b implements a {
        ...
        public Uri a(File file) {
            try {
                ...
                return new Uri.Builder().scheme("content").authority(this.f19435a).encodedPath(Uri.encode(entry.getKey()) + IOUtils.DIR_SEPARATOR_UNIX + Uri.encode(canonicalPath.substring(length), "/")).build();
    ...
    public void attachInfo(Context context, ProviderInfo providerInfo) {
        ...
        this.f19434a = a(context, providerInfo.authority);
    }

    @Override // android.content.ContentProvider
    public int delete(Uri uri, String str, String[] strArr) {
        return this.f19434a.a(uri).delete() ? 1 : 0;
    }

    @Override // android.content.ContentProvider
    public String getType(Uri uri) {
        File a2 = this.f19434a.a(uri);
