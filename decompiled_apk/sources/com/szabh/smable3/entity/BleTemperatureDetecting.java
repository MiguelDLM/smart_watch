...
@XX({"SMAP\nBleTemperatureDetecting.kt\nKotlin\n*S Kotlin\n*F\n+ 1 BleTemperatureDetecting.kt\ncom/szabh/smable3/entity/BleTemperatureDetecting\n+ 2 BleReadable.kt\ncom/bestmafen/baseble/data/BleReadable\n*L\n1#1,31:1\n222#2,4:32\n*S KotlinDebug\n*F\n+ 1 BleTemperatureDetecting.kt\ncom/szabh/smable3/entity/BleTemperatureDetecting\n*L\n23#1:32,4\n*E\n"})
...
public final class BleTemperatureDetecting extends BleWritable {
    ...
    @OOXIXo
    public final BleTemperatureDetecting copy(@OOXIXo BleTimeRange mBleTimeRange, int i) {
    ...
    public boolean equals(@oOoXoXO Object obj) {
        ...
        return IIX0o.Oxx0IOOO(this.mBleTimeRange, bleTemperatureDetecting.mBleTimeRange) && this.mInterval == bleTemperatureDetecting.mInterval;
    }
    ...
    public /* synthetic */ BleTemperatureDetecting(BleTimeRange bleTimeRange, int i, int i2, IIXOooo iIXOooo) {
        this((i2 & 1) != 0 ? new BleTimeRange(0, 0, 0, 0, 0, 31, null) : bleTimeRange, (i2 & 2) != 0 ? 60 : i);
    }

    public BleTemperatureDetecting(@OOXIXo BleTimeRange mBleTimeRange, int i) {
        IIX0o.x0xO0oo(mBleTimeRange, "mBleTimeRange");
