...
@XX({"SMAP\nBleHrMonitoringSettings.kt\nKotlin\n*S Kotlin\n*F\n+ 1 BleHrMonitoringSettings.kt\ncom/szabh/smable3/entity/BleHrMonitoringSettings\n+ 2 BleReadable.kt\ncom/bestmafen/baseble/data/BleReadable\n*L\n1#1,28:1\n222#2,4:29\n*S KotlinDebug\n*F\n+ 1 BleHrMonitoringSettings.kt\ncom/szabh/smable3/entity/BleHrMonitoringSettings\n*L\n20#1:29,4\n*E\n"})
...
public final class BleHrMonitoringSettings extends BleWritable {
    ...
    @OOXIXo
    public final BleHrMonitoringSettings copy(@OOXIXo BleTimeRange mBleTimeRange, int i) {
    ...
    public boolean equals(@oOoXoXO Object obj) {
        ...
        return IIX0o.Oxx0IOOO(this.mBleTimeRange, bleHrMonitoringSettings.mBleTimeRange) && this.mInterval == bleHrMonitoringSettings.mInterval;
    }
    ...
    public /* synthetic */ BleHrMonitoringSettings(BleTimeRange bleTimeRange, int i, int i2, IIXOooo iIXOooo) {
        this((i2 & 1) != 0 ? new BleTimeRange(0, 0, 0, 0, 0, 31, null) : bleTimeRange, (i2 & 2) != 0 ? 60 : i);
    }

    public BleHrMonitoringSettings(@OOXIXo BleTimeRange mBleTimeRange, int i) {
        IIX0o.x0xO0oo(mBleTimeRange, "mBleTimeRange");
