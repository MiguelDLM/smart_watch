...
class BaseWXApiImplV10 implements IWXAPI {
    ...
    public BaseWXApiImplV10(Context context, String str, boolean z, int i) {
        ...
        this.launchMode = i;
        b.f26941a = context.getApplicationContext();
    }
    ...
    private boolean handleWxInternalRespType(String str, IWXAPIEventHandler iWXAPIEventHandler) {
        ...
        resp5.unionId = parse.getQueryParameter(oxoX.f1381oxoX);
    ...
    public void unregisterApp() {
        ...
        c1088a.f26931a = "com.tencent.mm";
        c1088a.b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c1088a.c = "weixin://unregisterapp?appid=" + this.appId;
        a.a(this.context, c1088a);
    }
    ...
    public boolean registerApp(String str, long j) {
        ...
        a.C1088a c1088a = new a.C1088a();
        c1088a.f26931a = "com.tencent.mm";
        c1088a.b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c1088a.c = "weixin://registerapp?appid=" + this.appId;
        c1088a.d = j;
        return a.a(this.context, c1088a);
    }
}
