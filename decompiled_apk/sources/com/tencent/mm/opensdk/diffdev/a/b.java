...
public class b extends AsyncTask<Void, Void, a> {
            ...
            if (bArr != null && bArr.length != 0) {
                ...
                try {
                    ...
                    if (i != 0) {
                        ...
                        aVar.f26936a = OAuthErrCode.WechatAuth_Err_NormalErr;
                    ...
                    if (string != null && string.length() != 0) {
                        ...
                        if (decode != null && decode.length != 0) {
                            aVar.f26936a = OAuthErrCode.WechatAuth_Err_OK;
                            aVar.e = decode;
                        ...
                        aVar.f26936a = OAuthErrCode.WechatAuth_Err_JsonDecodeErr;
                        return aVar;
                    }
    ...
    public a doInBackground(Void[] voidArr) {
        ...
        String format = String.format("https://open.weixin.qq.com/connect/sdk/qrconnect?appid=%s&noncestr=%s&timestamp=%s&scope=%s&signature=%s", this.f26935a, this.c, this.d, this.b, this.e);
    ...
    public void onPostExecute(a aVar) {
        a aVar2 = aVar;
        OAuthErrCode oAuthErrCode = aVar2.f26936a;
        ...
        this.f.onAuthFinish(aVar2.f26936a, null);
    }
}
