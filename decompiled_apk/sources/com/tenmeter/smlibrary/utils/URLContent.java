...
public class URLContent {
    ...
    public static String GET_POP_AD = "smhl/outer/pop";
    public static String ICON_LIST = "smhl/outer/icon/list";
    public static String POP_OPE = "smhl/outer/comp/pop/ope";
    public static String STYLE_TYPE_LIST = "smhl/outer/game/style/type/list";
