...
public enum PropertyId {
    ...
    SpeechServiceConnection_SynthBackend(OxXXx0X.f13062Oox),
    SpeechServiceConnection_SynthOfflineDataPath(OxXXx0X.f13081X00IxOx),
    SpeechServiceConnection_SynthOfflineVoice(OxXXx0X.f13184oXIoIo),
    ...
    SpeechServiceResponse_RequestWordBoundary(TTAdConstant.INIT_FAILED_LOAD_PLUGIN_FAILED),
    SpeechServiceResponse_RequestPunctuationBoundary(TTAdConstant.INIT_FAILED_CREATE_INITIALIZER_FAILED),
    ...
    SpeechServiceResponse_SynthesisServiceLatencyMs(FitnessStatusCodes.INCONSISTENT_PACKAGE_NAME),
    ...
    Conversation_Connection_Id(SessionCommand.COMMAND_CODE_PLAYER_SKIP_TO_NEXT_PLAYLIST_ITEM),
    SpeechServiceConnection_AutoDetectSourceLanguages(OxXXx0X.f13224x0xOIoO),
