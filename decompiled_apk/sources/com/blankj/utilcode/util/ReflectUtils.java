...
public final class ReflectUtils {
    ...
    private Method similarMethod(String str, Class<?>[] clsArr) throws NoSuchMethodException {
        ...
        throw new NoSuchMethodException("No similar method " + str + " with params " + Arrays.toString(clsArr) + " could be found on type " + type() + com.tenmeter.smlibrary.utils.FileUtils.FILE_EXTENSION_SEPARATOR);
    }
    ...
    public boolean equals(Object obj) {
        if ((obj instanceof ReflectUtils) && this.object.equals(((ReflectUtils) obj).get())) {
            return true;
        }
        return false;
    }
