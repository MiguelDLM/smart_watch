    ...
    public static boolean isIDCard18Exact(CharSequence charSequence) {
        if (isIDCard18(charSequence)) {
            ...
            if (simpleArrayMap.isEmpty()) {
                ...
                simpleArrayMap.put(com.tencent.connect.common.II0xO0.f26834o0IXXIx, "天津");
                simpleArrayMap.put(com.tencent.connect.common.II0xO0.f26825XoIxOXIXo, "河北");
                simpleArrayMap.put(com.tencent.connect.common.II0xO0.f26773OO0, "山西");
                simpleArrayMap.put("15", "内蒙古");
                simpleArrayMap.put("21", "辽宁");
                simpleArrayMap.put(com.tencent.connect.common.II0xO0.f26892xOOxIO, "吉林");
                simpleArrayMap.put(com.tencent.connect.common.II0xO0.f26768O0xxXxI, "黑龙江");
