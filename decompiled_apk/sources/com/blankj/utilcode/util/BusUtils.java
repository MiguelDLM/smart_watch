    ...
    public static final class BusInfo {
        ...
        private String getDesc() {
            ...
            if ("".equals(this.paramType)) {
                ...
                str = oIX0oI.I0Io.f4096II0xO0 + this.paramType + " " + this.paramName + oIX0oI.I0Io.f4095I0Io;
            }
            sb.append(str);
            return sb.toString();
        }
    ...
    private Method getMethodByBusInfo(BusInfo busInfo) {
        try {
            if ("".equals(busInfo.paramType)) {
                return Class.forName(busInfo.className).getDeclaredMethod(busInfo.funName, null);
            }
    ...
    private void invokeBuses(Object obj, BusInfo busInfo, Set<Object> set) {
        try {
            if (obj == NULL) {
                ...
                while (it.hasNext()) {
                    busInfo.method.invoke(it.next(), null);
                }
            } else {
