...
final class DecodedBitStreamParser {
    ...
    static {
        char[] cArr = {oOoXoXO.f2346I0Io, '\"', '#', '$', x0XOIxOo.f33309xxIXOIIO, XIxXXX0x0.f29558oxoX, '\'', HexStringBuilder.COMMENT_BEGIN_CHAR, HexStringBuilder.COMMENT_END_CHAR, '*', '+', ',', '-', '.', IOUtils.DIR_SEPARATOR_UNIX, ':', ';', XIxXXX0x0.f29542X0o0xo, '=', XIxXXX0x0.f29545XO, '?', ObjectUtils.f32506oIX0oI, '[', '\\', ']', '^', '_'};
