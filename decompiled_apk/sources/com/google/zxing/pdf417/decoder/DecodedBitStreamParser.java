    ...
    */
    ...
    public static int decodeMacroBlock(int[] iArr, int i, PDF417ResultMetadata pDF417ResultMetadata) throws FormatException {
        ...
        if (i + 2 <= iArr[0]) {
            ...
            if (i2 != -1) {
                int i5 = textCompaction - i2;
                if (pDF417ResultMetadata.isLastSegment()) {
                    i5--;
                }
                pDF417ResultMetadata.setOptionalData(Arrays.copyOfRange(iArr, i2, i5 + i2));
            }
    ...
    /* JADX WARN: Failed to find 'out' block for switch in B:61:0x00c1. Please report as an issue. */
