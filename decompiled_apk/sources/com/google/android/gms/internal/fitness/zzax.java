...
public final class zzax extends zze {
    ...
    static {
        ...
        zze = clientKey;
        zzf = new Api("Fitness.RECORDING_API", new zzar(null), clientKey);
        zzg = new Api("Fitness.RECORDING_CLIENT", new zzau(0 == true ? 1 : 0), clientKey);
    }

    public /* synthetic */ zzax(Context context, Looper looper, ClientSettings clientSettings, GoogleApiClient.ConnectionCallbacks connectionCallbacks, GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener, zzaw zzawVar) {
