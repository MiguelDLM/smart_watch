...
public final class zzbn extends zze {
    ...
    static {
        ...
        zze = clientKey;
        zzf = new Api("Fitness.SESSIONS_API", new zzbh(null), clientKey);
        zzg = new Api("Fitness.SESSIONS_CLIENT", new zzbk(0 == true ? 1 : 0), clientKey);
    }

    public /* synthetic */ zzbn(Context context, Looper looper, ClientSettings clientSettings, GoogleApiClient.ConnectionCallbacks connectionCallbacks, GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener, zzbm zzbmVar) {
