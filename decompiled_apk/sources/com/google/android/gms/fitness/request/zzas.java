...
public final class zzas extends AbstractSafeParcelable {
    ...
    public zzas(@SafeParcelable.Param(id = 1) PendingIntent pendingIntent, @Nullable @SafeParcelable.Param(id = 2) IBinder iBinder) {
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        if ((obj instanceof zzas) && Objects.equal(this.zza, ((zzas) obj).zza)) {
            return true;
        }
        return false;
    }
