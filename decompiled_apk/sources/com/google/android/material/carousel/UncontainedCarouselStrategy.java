...
public final class UncontainedCarouselStrategy extends CarouselStrategy {
    ...
    private KeylineState createLeftAlignedKeylineState(Context context, float f, float f2, float f3, int i, float f4, int i2, float f5) {
        ...
        float childMaskPercentage = CarouselStrategy.getChildMaskPercentage(max, f3, f);
        float childMaskPercentage2 = CarouselStrategy.getChildMaskPercentage(min, f3, f);
    ...
    public KeylineState onFirstChildMeasuredWithMargins(@NonNull Carousel carousel, @NonNull View view) {
        ...
        int max = Math.max(1, (int) Math.floor(f2 / f5));
        float f6 = f2 - (max * f5);
        ...
        return createLeftAlignedKeylineState(view.getContext(), f, f2, f5, max, calculateMediumChildSize(extraSmallSize, f5, f6), i, extraSmallSize2);
    }
}
