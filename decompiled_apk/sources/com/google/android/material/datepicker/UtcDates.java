...
public class UtcDates {
    ...
    public static String getDatePatternAsInputFormat(@NonNull String str) {
        return str.replaceAll("[^dMy/\\-.]", "").replaceAll("d{1,2}", DateFormatUtils.DD).replaceAll("M{1,2}", DateFormatUtils.MM).replaceAll("y{1,4}", DateFormatUtils.YYYY).replaceAll("\\.$", "").replaceAll("My", "M/y");
    }
