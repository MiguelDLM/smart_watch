...
public class DynamicColors {
        ...
        if (isDynamicColorAvailable()) {
            ...
            if (dynamicColorsOptions.getPrecondition().shouldApplyDynamicColors(activity, i)) {
                if (dynamicColorsOptions.getContentBasedSeedColor() != null) {
                    ...
                    ColorResourcesOverride oIX0oI2 = xxIXOIIO.oIX0oI();
                    if (oIX0oI2 == null || !oIX0oI2.applyIfPossible(activity, MaterialColorUtilitiesHelper.createColorResourcesIdsToColorValues(schemeContent))) {
                        return;
                    }
                } else {
    ...
    public static Context wrapContextIfAvailable(@NonNull Context context, @NonNull DynamicColorsOptions dynamicColorsOptions) {
        ...
        if (dynamicColorsOptions.getContentBasedSeedColor() != null) {
            ...
            ColorResourcesOverride oIX0oI2 = xxIXOIIO.oIX0oI();
            if (oIX0oI2 != null) {
                return oIX0oI2.wrapContextIfPossible(context, MaterialColorUtilitiesHelper.createColorResourcesIdsToColorValues(schemeContent));
            }
        }
