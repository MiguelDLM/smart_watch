...
public final class TemperatureCache {
    ...
    private List<Hct> getHctsByHue() {
        ...
        for (double d = XIXIX.OOXIXo.f3760XO; d <= 360.0d; d += 1.0d) {
    ...
    private List<Hct> getHctsByTemp() {
        ...
        comparing = Comparator.comparing(new Function() { // from class: com.google.android.material.color.utilities.OIxx0I0
        ...
        }, new Comparator() { // from class: com.google.android.material.color.utilities.OooO0XOx
