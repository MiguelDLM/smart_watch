...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable, MaterialCheckable<Chip> {
    ...
    private void validateAttributes(@Nullable AttributeSet attributeSet) {
        ...
        if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, StyleAttr.NAME_BACKGROUND) != null) {
            Log.w(TAG, "Do not set the background; Chip manages its own background drawable.");
        }
        if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, StyleAttr.NAME_DRAWABLE_LEFT) == null) {
            if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, "drawableStart") == null) {
                if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, "drawableEnd") == null) {
                    if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, StyleAttr.NAME_DRAWABLE_RIGHT) == null) {
    ...
    */
    public Chip(android.content.Context r8, android.util.AttributeSet r9, int r10) {
        ...
        La2:
            ...
            com.google.android.material.chip.II0xO0 r8 = new com.google.android.material.chip.II0xO0
            r8.<init>()
