...
public interface VideoRendererEventListener {
    ...
    public static final class EventDispatcher {
        ...
        public void decoderInitialized(final String str, final long j, final long j2) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.video.x0XOIxOo
        ...
        public void decoderReleased(final String str) {
            Handler handler = this.handler;
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.video.OOXIXo
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public void disabled(final DecoderCounters decoderCounters) {
            ...
            Handler handler = this.handler;
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.video.oOoXoXO
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public void droppedFrames(final int i, final long j) {
            Handler handler = this.handler;
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.video.xxIXOIIO
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public void enabled(final DecoderCounters decoderCounters) {
            Handler handler = this.handler;
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.video.oO
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public void inputFormatChanged(final Format format, @Nullable final DecoderReuseEvaluation decoderReuseEvaluation) {
            Handler handler = this.handler;
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.video.x0xO0oo
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public void renderedFirstFrame(final Object obj) {
            if (this.handler != null) {
                ...
                this.handler.post(new Runnable() { // from class: com.google.android.exoplayer2.video.xoIox
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public void reportVideoFrameProcessingOffset(final long j, final int i) {
            Handler handler = this.handler;
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.video.IXxxXO
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public void videoCodecError(final Exception exc) {
            Handler handler = this.handler;
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.video.ooOOo0oXI
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public void videoSizeChanged(final VideoSize videoSize) {
            Handler handler = this.handler;
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.video.II0XooXoX
                    @Override // java.lang.Runnable
                    public final void run() {
