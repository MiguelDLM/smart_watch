...
public final class Id3Decoder extends SimpleMetadataDecoder {
    ...
    public static final FramePredicate NO_FRAMES_PREDICATE = new FramePredicate() { // from class: com.google.android.exoplayer2.metadata.id3.oIX0oI
    ...
    private static ChapterFrame decodeChapterFrame(ParsableByteArray parsableByteArray, int i, int i2, boolean z, int i3, @Nullable FramePredicate framePredicate) {
        ...
        if (readUnsignedInt == BleWatchFaceId.WATCHFACE_ID_INVALID) {
            j = -1;
        } else {
            j = readUnsignedInt;
        }
        long readUnsignedInt2 = parsableByteArray.readUnsignedInt();
        if (readUnsignedInt2 == BleWatchFaceId.WATCHFACE_ID_INVALID) {
            j2 = -1;
        } else {
            j2 = readUnsignedInt2;
        }
