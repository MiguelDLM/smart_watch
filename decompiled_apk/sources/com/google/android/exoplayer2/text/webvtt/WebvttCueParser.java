...
public final class WebvttCueParser {
    ...
    public static class Element {
        private static final Comparator<Element> BY_START_POSITION_ASC = new Comparator() { // from class: com.google.android.exoplayer2.text.webvtt.oIX0oI
    ...
    static {
        ...
        hashMap.put(XXooOOI.oIX0oI.f4121ooOOo0oXI, Integer.valueOf(Color.rgb(255, 0, 0)));
        hashMap.put("yellow", Integer.valueOf(Color.rgb(255, 255, 0)));
        hashMap.put("magenta", Integer.valueOf(Color.rgb(255, 0, 255)));
        hashMap.put(XXooOOI.oIX0oI.f4119oO, Integer.valueOf(Color.rgb(0, 0, 255)));
    ...
    private static void parseCueSettingsList(String str, WebvttCueInfoBuilder webvttCueInfoBuilder) {
        ...
        while (matcher.find()) {
            ...
            try {
                ...
                } else if (MapBundleKey.OfflineMapKey.OFFLINE_TOTAL_SIZE.equals(str2)) {
