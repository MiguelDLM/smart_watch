...
public final class Cea708Decoder extends CeaDecoder {
    ...
    public static final class Cea708CueInfo {
        private static final Comparator<Cea708CueInfo> LEAST_IMPORTANT_FIRST = new Comparator() { // from class: com.google.android.exoplayer2.text.cea.oIX0oI
    ...
    private void handleG2Character(int i) {
        if (i != 32) {
            if (i != 33) {
                    ...
                    if (i != 42) {
                        if (i != 44) {
                            if (i != 63) {
                                            ...
                                            if (i != 61) {
                                                switch (i) {
                                                    case 48:
                                                        ...
                                                        return;
                                                    case 49:
                                                        this.currentCueInfoBuilder.append(XIxXXX0x0.f29564xoXoI);
                                                        return;
                                                    case 50:
                                                        this.currentCueInfoBuilder.append(XIxXXX0x0.f29548o00);
                                                        return;
                                                    case 51:
                                                        this.currentCueInfoBuilder.append(XIxXXX0x0.f29533O0xOxO);
                                                        return;
                                                    case 52:
                                                        this.currentCueInfoBuilder.append(XIxXXX0x0.f29541X0IIOO);
                                                        return;
                                                    case 53:
                                                        this.currentCueInfoBuilder.append(XIxXXX0x0.f29547XxX0x0xxx);
                                                        return;
                                                    default:
                                                        switch (i) {
                                                            case 118:
                                ...
                                this.currentCueInfoBuilder.append(XIxXXX0x0.f29555oo0xXOI0I);
                                return;
                            }
                ...
                this.currentCueInfoBuilder.append(XIxXXX0x0.f29562xXxxox0I);
                return;
            }
            this.currentCueInfoBuilder.append(XIxXXX0x0.f29537Oxx0IOOO);
            return;
        }
