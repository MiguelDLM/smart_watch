...
import com.google.android.exoplayer2.drm.xoIox;
...
public final class ServerSideAdInsertionMediaSource extends BaseMediaSource implements MediaSource.MediaSourceCaller, MediaSourceEventListener, DrmSessionEventListener {
    ...
    public static final class SharedMediaPeriod implements MediaPeriod.Callback {
        ...
        public boolean canReuseMediaPeriod(MediaSource.MediaPeriodId mediaPeriodId, long j) {
            ...
            if (ServerSideAdInsertionUtil.getStreamPositionUs(j, mediaPeriodId, this.adPlaybackState) == ServerSideAdInsertionUtil.getStreamPositionUs(ServerSideAdInsertionMediaSource.getMediaPeriodEndPositionUs(mediaPeriodImpl, this.adPlaybackState), mediaPeriodImpl.mediaPeriodId, this.adPlaybackState)) {
                return true;
            }
            return false;
        }
    ...
    public /* synthetic */ void onDrmSessionAcquired(int i, MediaSource.MediaPeriodId mediaPeriodId) {
        xoIox.oxoX(this, i, mediaPeriodId);
    }
            ...
            if (adPlaybackState != null) {
                for (int i = value.removedAdGroupCount; i < value.adGroupCount; i++) {
                    ...
                    if (i < adPlaybackState.adGroupCount && ServerSideAdInsertionUtil.getAdCountInGroup(value, i) < ServerSideAdInsertionUtil.getAdCountInGroup(adPlaybackState, i)) {
                        ...
                        if (adGroup.contentResumeOffsetUs + adGroup2.contentResumeOffsetUs == adPlaybackState.getAdGroup(i).contentResumeOffsetUs) {
                            z2 = true;
                        } else {
                            z2 = false;
                        }
        ...
        synchronized (this) {
            try {
                ...
                if (handler == null) {
                    ...
                    handler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.xxIXOIIO
                        @Override // java.lang.Runnable
                        public final void run() {
                            ServerSideAdInsertionMediaSource.this.lambda$setAdPlaybackStates$0(immutableMap);
                        }
                    });
                }
            } catch (Throwable th) {
