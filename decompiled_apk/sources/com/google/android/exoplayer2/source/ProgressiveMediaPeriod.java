...
public final class ProgressiveMediaPeriod implements MediaPeriod, ExtractorOutput, Loader.Callback<ExtractingLoadable>, Loader.ReleaseCallback, SampleQueue.UpstreamFormatChangedListener {
    ...
    private final Runnable maybeFinishPrepareRunnable = new Runnable() { // from class: com.google.android.exoplayer2.source.XIxXXX0x0
        @Override // java.lang.Runnable
        public final void run() {
            ProgressiveMediaPeriod.this.maybeFinishPrepare();
        }
    };
    private final Runnable onContinueLoadingRequestedRunnable = new Runnable() { // from class: com.google.android.exoplayer2.source.xxX
        @Override // java.lang.Runnable
        public final void run() {
    ...
    public void onLengthKnown() {
        this.handler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.XxX0x0xxx
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void lambda$seekMap$1(SeekMap seekMap) {
        ...
        int i = 1;
        if (!this.isLengthKnown && seekMap.getDurationUs() == C.TIME_UNSET) {
            z = true;
        } else {
            z = false;
        }
    ...
    public void seekMap(final SeekMap seekMap) {
        this.handler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.xXxxox0I
            @Override // java.lang.Runnable
            public final void run() {
