...
public class DefaultDrmSession implements DrmSession {
    ...
    private void doLicense(boolean z) {
        ...
        if (this.state == 4 || restoreKeys()) {
            ...
            if (licenseDurationRemainingSec <= 0) {
                ...
                this.state = 4;
                dispatchEvent(new Consumer() { // from class: com.google.android.exoplayer2.drm.II0xO0
    ...
    private void onError(final Exception exc, int i) {
        ...
        dispatchEvent(new Consumer() { // from class: com.google.android.exoplayer2.drm.I0Io
            @Override // com.google.android.exoplayer2.util.Consumer
            public final void accept(Object obj) {
        ...
        if (obj == this.currentKeyRequest && isOpen()) {
            ...
            try {
                ...
                if (this.mode == 3) {
                    ...
                    dispatchEvent(new Consumer() { // from class: com.google.android.exoplayer2.drm.oxoX
                        @Override // com.google.android.exoplayer2.util.Consumer
                ...
                this.state = 4;
                dispatchEvent(new Consumer() { // from class: com.google.android.exoplayer2.drm.X0o0xo
                    @Override // com.google.android.exoplayer2.util.Consumer
                    public final void accept(Object obj3) {
    ...
    private boolean openInternal() {
        ...
        try {
            ...
            final int i = 3;
            this.state = 3;
            dispatchEvent(new Consumer() { // from class: com.google.android.exoplayer2.drm.oIX0oI
                @Override // com.google.android.exoplayer2.util.Consumer
                public final void accept(Object obj) {
