...
public final class DownloadManager {
    ...
    public DownloadManager(Context context, DatabaseProvider databaseProvider, Cache cache, DataSource.Factory factory) {
        this(context, databaseProvider, cache, factory, new androidx.profileinstaller.I0Io());
    }
    ...
    public static Download mergeRequest(Download download, DownloadRequest downloadRequest, int i, long j) {
        ...
        if (i3 != 5 && !download.isTerminalState()) {
    ...
    public DownloadManager(Context context, WritableDownloadIndex writableDownloadIndex, DownloaderFactory downloaderFactory) {
        ...
        Handler createHandlerForCurrentOrMainLooper = Util.createHandlerForCurrentOrMainLooper(new Handler.Callback() { // from class: com.google.android.exoplayer2.offline.xoIox
        ...
        this.internalHandler = internalHandler;
        RequirementsWatcher.Listener listener = new RequirementsWatcher.Listener() { // from class: com.google.android.exoplayer2.offline.OOXIXo
    ...
    public static final class InternalHandler extends Handler {
        ...
        private Download putDownload(Download download) {
            ...
            if (downloadIndex == -1) {
                ...
                Collections.sort(this.downloads, new oOoXoXO());
            } else {
