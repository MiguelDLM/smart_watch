...
public final class Format implements Bundleable {
    ...
    public static final Bundleable.Creator<Format> CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.xoO0xx0
        ...
        if (format.drmInitData != null) {
            ...
            while (true) {
                ...
                if (uuid.equals(C.COMMON_PSSH_UUID)) {
                    ...
                    linkedHashSet.add("unknown (" + uuid + oIX0oI.I0Io.f4095I0Io);
                }
                i++;
            }
            sb.append(", drm=[");
