...
public class DefaultLoadControl implements LoadControl {
    ...
    public boolean shouldStartPlayback(long j, float f, boolean z, long j2) {
        ...
        if (j3 > 0 && playoutDurationForMediaDuration < j3 && (this.prioritizeTimeOverSizeThresholds || this.allocator.getTotalBytesAllocated() < this.targetBufferBytes)) {
            return false;
        }
        return true;
    }
