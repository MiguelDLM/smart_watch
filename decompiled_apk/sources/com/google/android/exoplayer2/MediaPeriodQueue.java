...
public final class MediaPeriodQueue {
    ...
    */
    ...
    private MediaPeriodInfo getMediaPeriodInfoForAd(Timeline timeline, Object obj, int i, int i2, long j, long j2) {
        ...
        if (adDurationUs != C.TIME_UNSET && j3 >= adDurationUs) {
            j4 = Math.max(0L, adDurationUs - 1);
        } else {
            j4 = j3;
        }
        return new MediaPeriodInfo(mediaPeriodId, j4, j, C.TIME_UNSET, adDurationUs, isServerSideInsertedAdGroup, false, false, false);
    }
    ...
    */
    ...
    private void notifyQueueUpdate() {
        ...
        this.analyticsCollectorHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.O0X
