...
public final class MediaCodecInfo {
    ...
    public static final class Api29 {
        ...
        public static int areResolutionAndFrameRateCovered(MediaCodecInfo.VideoCapabilities videoCapabilities, int i, int i2, double d) {
            ...
            oO.oIX0oI();
            MediaCodecInfo.VideoCapabilities.PerformancePoint oIX0oI2 = x0XOIxOo.oIX0oI(i, i2, (int) d);
            for (int i3 = 0; i3 < supportedPerformancePoints.size(); i3++) {
                covers = oOoXoXO.oIX0oI(supportedPerformancePoints.get(i3)).covers(oIX0oI2);
                if (covers) {
                    return 2;
                }
            }
