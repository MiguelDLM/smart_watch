...
public class AsynchronousMediaCodecBufferEnqueuer {
    ...
    private static void copy(CryptoInfo cryptoInfo, MediaCodec.CryptoInfo cryptoInfo2) {
        ...
        if (Util.SDK_INT >= 24) {
            Oxx0IOOO.oIX0oI();
            cryptoInfo2.setPattern(com.google.android.exoplayer2.decoder.I0Io.oIX0oI(cryptoInfo.encryptedBlocks, cryptoInfo.clearBlocks));
        }
    }
    ...
    public void doHandleMessage(Message message) {
        ...
        if (i != 0) {
            if (i != 1) {
                messageParams = null;
                if (i != 2) {
                    androidx.lifecycle.Oxx0IOOO.oIX0oI(this.pendingRuntimeException, null, new IllegalStateException(String.valueOf(message.what)));
                } else {
    ...
    private void doQueueInputBuffer(int i, int i2, int i3, long j, int i4) {
        try {
            ...
            androidx.lifecycle.Oxx0IOOO.oIX0oI(this.pendingRuntimeException, null, e);
        }
    }
