...
public class DefaultTimeBar extends View implements TimeBar {
    ...
    private void drawTimeBar(Canvas canvas) {
        ...
        for (int i6 = 0; i6 < this.adGroupCount; i6++) {
            ...
            int min = rect4.left + Math.min(rect4.width() - this.adMarkerWidth, Math.max(0, width));
            if (zArr[i6]) {
    ...
    */
    ...
    public DefaultTimeBar(Context context, @Nullable AttributeSet attributeSet, int i, @Nullable AttributeSet attributeSet2, int i2) {
        ...
        this.stopScrubbingRunnable = new Runnable() { // from class: com.google.android.exoplayer2.ui.oxoX
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.exoplayer2.ui.X0o0xo
