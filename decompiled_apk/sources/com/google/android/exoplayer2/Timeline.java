...
public abstract class Timeline implements Bundleable {
    ...
    public static final Bundleable.Creator<Timeline> CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.OooO0XOx
    ...
    public static final class Period implements Bundleable {
        ...
        public static final Bundleable.Creator<Period> CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.XxXX
            @Override // com.google.android.exoplayer2.Bundleable.Creator
            public final Bundleable fromBundle(Bundle bundle) {
        ...
        public int hashCode() {
            ...
            int i2 = (Command.CMD_GET_DEVICE_CONFIG_INFO + hashCode) * 31;
            ...
            return ((((i4 + ((int) (j2 ^ (j2 >>> 32)))) * 31) + (this.isPlaceholder ? 1 : 0)) * 31) + this.adPlaybackState.hashCode();
        }
    ...
    public static final class Window implements Bundleable {
        ...
        public static final Bundleable.Creator<Window> CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.o0Oo
            @Override // com.google.android.exoplayer2.Bundleable.Creator
            public final Bundleable fromBundle(Bundle bundle) {
        ...
        public int hashCode() {
            int hashCode;
            int hashCode2 = (((Command.CMD_GET_DEVICE_CONFIG_INFO + this.uid.hashCode()) * 31) + this.mediaItem.hashCode()) * 31;
    ...
    public int hashCode() {
        Window window = new Window();
        Period period = new Period();
        int windowCount = Command.CMD_GET_DEVICE_CONFIG_INFO + getWindowCount();
        for (int i = 0; i < getWindowCount(); i++) {
