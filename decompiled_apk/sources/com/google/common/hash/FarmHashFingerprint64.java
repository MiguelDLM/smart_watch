...
final class FarmHashFingerprint64 extends AbstractNonStreamingHashFunction {
    ...
    private static long hashLength0to16(byte[] bArr, int i, int i2) {
        ...
        if (i2 >= 4) {
            return hashLength16(i2 + ((LittleEndianByteArray.load32(bArr, i) & BleWatchFaceId.WATCHFACE_ID_INVALID) << 3), LittleEndianByteArray.load32(bArr, (i + i2) - 4) & BleWatchFaceId.WATCHFACE_ID_INVALID, (i2 * 2) + K2);
        }
        if (i2 <= 0) {
            return K2;
        }
    ...
    private static long hashLength65Plus(byte[] bArr, int i, int i2) {
        ...
        int i8 = i;
        while (true) {
            long rotateRight = Long.rotateRight(load64 + j + jArr[0] + LittleEndianByteArray.load64(bArr, i8 + 8), 37) * K1;
            long rotateRight2 = Long.rotateRight(j + jArr[1] + LittleEndianByteArray.load64(bArr, i8 + 48), 42) * K1;
            ...
            if (i8 == i4) {
                ...
                jArr[0] = j5;
                jArr2[0] = jArr2[0] + j5;
                long rotateRight4 = Long.rotateRight(rotateRight3 + load642 + jArr[0] + LittleEndianByteArray.load64(bArr, i6 - 55), 37) * j3;
                long rotateRight5 = Long.rotateRight(load642 + jArr[1] + LittleEndianByteArray.load64(bArr, i6 - 15), 42) * j3;
                ...
                weakHashLength32WithSeeds(bArr, i6 - 31, rotateRight6 + jArr2[1], LittleEndianByteArray.load64(bArr, i6 - 47) + load643, jArr2);
