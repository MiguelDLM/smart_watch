...
public abstract class CaseFormat {
    ...
    public static final CaseFormat LOWER_HYPHEN = new CaseFormat("LOWER_HYPHEN", 0, CharMatcher.is('-'), HelpFormatter.DEFAULT_OPT_PREFIX) { // from class: com.google.common.base.CaseFormat.1
