...
public final class DefaultDateTypeAdapter<T extends Date> extends TypeAdapter<T> {
    ...
    public String toString() {
        ...
        if (dateFormat instanceof SimpleDateFormat) {
            return "DefaultDateTypeAdapter(" + ((SimpleDateFormat) dateFormat).toPattern() + HexStringBuilder.COMMENT_END_CHAR;
        }
        return "DefaultDateTypeAdapter(" + dateFormat.getClass().getSimpleName() + HexStringBuilder.COMMENT_END_CHAR;
    }
