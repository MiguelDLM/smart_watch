...
public abstract class Converter<A, B> implements Function<A, B> {
    ...
    public static final class ConverterComposition<A, B, C> extends Converter<A, C> implements Serializable {
        ...
        public String toString() {
            return this.first + ".andThen(" + this.second + oIX0oI.I0Io.f4095I0Io;
        }
    }
    ...
    public static final class FunctionBasedConverter<A, B> extends Converter<A, B> implements Serializable {
        ...
        public String toString() {
            return "Converter.from(" + this.forwardFunction + ", " + this.backwardFunction + oIX0oI.I0Io.f4095I0Io;
        }
    ...
    public Iterable<B> convertAll(final Iterable<? extends A> iterable) {
        ...
        return new Iterable<B>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Converter.1
            @Override // java.lang.Iterable
            public Iterator<B> iterator() {
                return new Iterator<B>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Converter.1.1
