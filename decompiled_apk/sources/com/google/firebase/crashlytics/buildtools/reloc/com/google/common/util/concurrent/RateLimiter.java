...
public abstract class RateLimiter {
    ...
    public static abstract class SleepingStopwatch {
        public static SleepingStopwatch createFromSystemTimer() {
            return new SleepingStopwatch() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.util.concurrent.RateLimiter.SleepingStopwatch.1
    ...
    public final void setRate(double d) {
        boolean z;
        if (d > XIXIX.OOXIXo.f3760XO && !Double.isNaN(d)) {
            z = true;
        } else {
            z = false;
        }
