...
public abstract class Striped<L> {
    ...
    private static final Supplier<ReadWriteLock> READ_WRITE_LOCK_SUPPLIER = new Supplier<ReadWriteLock>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.util.concurrent.Striped.5
    ...
    private static final Supplier<ReadWriteLock> WEAK_SAFE_READ_WRITE_LOCK_SUPPLIER = new Supplier<ReadWriteLock>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.util.concurrent.Striped.6
        @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Supplier, java.util.function.Supplier
        public ReadWriteLock get() {
    ...
    public static class SmallLazyStriped<L> extends PowerOfTwoStriped<L> {
        ...
        private void drainQueue() {
            while (true) {
                ...
                if (poll != null) {
                    ...
                    com.google.common.util.concurrent.oxoX.oIX0oI(this.locks, arrayReference.index, arrayReference, null);
                } else {
                    return;
                }
            }
        ...
        public L getAt(int i) {
            ...
            while (!com.google.common.util.concurrent.oxoX.oIX0oI(this.locks, i, arrayReference, arrayReference2)) {
    ...
    public static Striped<Lock> lazyWeakLock(int i) {
        return lazy(i, new Supplier<Lock>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.util.concurrent.Striped.2
            @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Supplier, java.util.function.Supplier
            public Lock get() {
    ...
    public static Striped<Semaphore> lazyWeakSemaphore(int i, final int i2) {
        return lazy(i, new Supplier<Semaphore>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.util.concurrent.Striped.4
            @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Supplier, java.util.function.Supplier
    ...
    public static Striped<Lock> lock(int i) {
        return new CompactStriped(i, new Supplier<Lock>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.util.concurrent.Striped.1
            @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Supplier, java.util.function.Supplier
            public Lock get() {
    ...
    public static Striped<Semaphore> semaphore(int i, final int i2) {
        return new CompactStriped(i, new Supplier<Semaphore>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.util.concurrent.Striped.3
            @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Supplier, java.util.function.Supplier
            public Semaphore get() {
