...
public final class FileBackedOutputStream extends OutputStream {
    ...
    public FileBackedOutputStream(int i, boolean z) {
        ...
        if (z) {
            this.source = new ByteSource() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.io.FileBackedOutputStream.1
            ...
            this.source = new ByteSource() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.io.FileBackedOutputStream.2
                @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.io.ByteSource
                public InputStream openStream() throws IOException {
                    return FileBackedOutputStream.this.openInputStream();
                }
