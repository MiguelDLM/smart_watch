...
public final class MediaType {
    ...
    public static final MediaType XML_UTF_8 = createConstantUtf8("text", XIxXXX0x0.f31179xoXoI);
    ...
    public static final MediaType APPLICATION_XML_UTF_8 = createConstantUtf8("application", XIxXXX0x0.f31179xoXoI);
    ...
    private String computeToString() {
        ...
        if (!this.parameters.isEmpty()) {
            sb.append("; ");
            PARAMETER_JOINER.appendTo(sb, Multimaps.transformValues((ListMultimap) this.parameters, (Function) new Function<String, String>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.net.MediaType.2
