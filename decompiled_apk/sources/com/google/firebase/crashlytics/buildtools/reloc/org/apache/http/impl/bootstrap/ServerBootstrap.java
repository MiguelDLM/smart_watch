...
public class ServerBootstrap {
    ...
    /* JADX WARN: Type inference failed for: r2v2, types: [com.google.firebase.crashlytics.buildtools.reloc.org.apache.http.protocol.HttpRequestHandlerMapper] */
    /* JADX WARN: Type inference failed for: r2v24, types: [com.google.firebase.crashlytics.buildtools.reloc.org.apache.http.protocol.UriHttpRequestHandlerMapper] */
        ...
        if (r2 == 0) {
            ...
            if (map != null) {
                for (Map.Entry<String, HttpRequestHandler> entry : map.entrySet()) {
                    r2.register(entry.getKey(), entry.getValue());
                }
            }
        }
