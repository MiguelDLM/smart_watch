...
import com.google.firebase.crashlytics.buildtools.reloc.com.google.common.primitives.ImmutableDoubleArray;
...
public final class ImmutableDoubleArray implements Serializable {
    ...
    public Spliterator.OfDouble spliterator() {
        ...
        spliterator = Spliterators.spliterator(this.array, this.start, this.end, SubBinId.Bbpro.DSP_UI_PARAMETER_FILE);
        return spliterator;
    }
    ...
    public DoubleStream stream() {
        DoubleStream stream;
        stream = Arrays.stream(this.array, this.start, this.end);
        return stream;
    }
    ...
    public static final class Builder {
        ...
        public Builder addAll(DoubleStream doubleStream) {
            ...
            spliterator.forEachRemaining(new DoubleConsumer() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.primitives.Oxx0IOOO
