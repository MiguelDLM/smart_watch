    ...
    */
    public static int indexOf(int[] r5, int[] r6) {
        ...
        L2a:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.primitives.Ints.indexOf(int[], int[]):int");
    }
