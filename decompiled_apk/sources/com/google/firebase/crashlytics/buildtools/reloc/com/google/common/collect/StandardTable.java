...
public class StandardTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
            ...
            public Map.Entry<R, V> computeNext() {
                while (this.iterator.hasNext()) {
                    ...
                    if (next.getValue().containsKey(Column.this.columnKey)) {
                        return new AbstractMapEntry<R, V>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.StandardTable.Column.EntrySetIterator.1EntryImpl
    ...
    public class ColumnMap extends Maps.ViewCachingAbstractMap<C, Map<R, V>> {
        ...
        public class ColumnMapEntrySet extends StandardTable<R, C, V>.TableSet<Map.Entry<C, Map<R, V>>> {
            ...
            public Iterator<Map.Entry<C, Map<R, V>>> iterator() {
                return Maps.asMapEntryIterator(StandardTable.this.columnKeySet(), new Function<C, Map<R, V>>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.StandardTable.ColumnMap.ColumnMapEntrySet.1
    ...
    public class Row extends Maps.IteratorBasedAbstractMap<C, V> {
        ...
        public boolean containsKey(Object obj) {
            Map<C, V> backingRowMap = backingRowMap();
            if (obj != null && backingRowMap != null && Maps.safeContainsKey(backingRowMap, obj)) {
                return true;
            }
            return false;
        }
        ...
        public Iterator<Map.Entry<C, V>> entryIterator() {
            ...
            return new Iterator<Map.Entry<C, V>>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.StandardTable.Row.1
                @Override // java.util.Iterator
                public boolean hasNext() {
                    return it.hasNext();
                }
        ...
        public Spliterator<Map.Entry<C, V>> entrySpliterator() {
            ...
            spliterator = backingRowMap.entrySet().spliterator();
            return CollectSpliterators.map(spliterator, new java.util.function.Function() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.OxIxx0
        ...
        public Map.Entry<C, V> wrapEntry(final Map.Entry<C, V> entry) {
            return new ForwardingMapEntry<C, V>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.StandardTable.Row.2
    ...
    public class RowMap extends Maps.ViewCachingAbstractMap<R, Map<C, V>> {
        ...
        public class EntrySet extends StandardTable<R, C, V>.TableSet<Map.Entry<R, Map<C, V>>> {
            ...
            public Iterator<Map.Entry<R, Map<C, V>>> iterator() {
                return Maps.asMapEntryIterator(StandardTable.this.backingMap.keySet(), new Function<R, Map<C, V>>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.StandardTable.RowMap.EntrySet.1
                    @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Function, java.util.function.Function
                    public /* bridge */ /* synthetic */ Object apply(Object obj) {
                        return apply((AnonymousClass1) obj);
                    }
    ...
    public static /* synthetic */ Spliterator lambda$cellSpliterator$1(final Map.Entry entry) {
        ...
        return CollectSpliterators.map(spliterator, new java.util.function.Function() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.IoXO0XoX
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Table.Cell lambda$null$0;
                lambda$null$0 = StandardTable.lambda$null$0(entry, (Map.Entry) obj);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ Table.Cell lambda$null$0(Map.Entry entry, Map.Entry entry2) {
    ...
    public Spliterator<Table.Cell<R, C, V>> cellSpliterator() {
        ...
        return CollectSpliterators.flatMap(spliterator, new java.util.function.Function() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.OOOox
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
