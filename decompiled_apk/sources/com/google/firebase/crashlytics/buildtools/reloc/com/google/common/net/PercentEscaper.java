...
public final class PercentEscaper extends UnicodeEscaper {
    ...
    public char[] escape(int i) {
        ...
        if (i <= 127) {
            ...
            return new char[]{x0XOIxOo.f33309xxIXOIIO, cArr[i >>> 4], cArr[i & 15]};
        }
        if (i <= 2047) {
            char[] cArr2 = UPPER_HEX_DIGITS;
            return new char[]{x0XOIxOo.f33309xxIXOIIO, cArr2[(i >>> 10) | 12], cArr2[(i >>> 6) & 15], x0XOIxOo.f33309xxIXOIIO, cArr2[((i >>> 4) & 3) | 8], cArr2[i & 15]};
        }
        if (i <= 65535) {
            char[] cArr3 = UPPER_HEX_DIGITS;
            return new char[]{x0XOIxOo.f33309xxIXOIIO, 'E', cArr3[i >>> 12], x0XOIxOo.f33309xxIXOIIO, cArr3[((i >>> 10) & 3) | 8], cArr3[(i >>> 6) & 15], x0XOIxOo.f33309xxIXOIIO, cArr3[((i >>> 4) & 3) | 8], cArr3[i & 15]};
        }
        if (i <= 1114111) {
            char[] cArr4 = UPPER_HEX_DIGITS;
            return new char[]{x0XOIxOo.f33309xxIXOIIO, 'F', cArr4[(i >>> 18) & 7], x0XOIxOo.f33309xxIXOIIO, cArr4[((i >>> 16) & 3) | 8], cArr4[(i >>> 12) & 15], x0XOIxOo.f33309xxIXOIIO, cArr4[((i >>> 10) & 3) | 8], cArr4[(i >>> 6) & 15], x0XOIxOo.f33309xxIXOIIO, cArr4[((i >>> 4) & 3) | 8], cArr4[i & 15]};
        }
