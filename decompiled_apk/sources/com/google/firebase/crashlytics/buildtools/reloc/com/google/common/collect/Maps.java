...
public final class Maps {
    ...
    public static class Accumulator<K extends Enum<K>, V> {
        ...
        public Accumulator(BinaryOperator<V> binaryOperator) {
        ...
        public Accumulator<K, V> combine(Accumulator<K, V> accumulator) {
            ...
            enumMap.forEach(new BiConsumer() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.xXo
    ...
    public static class AsMapView<K, V> extends ViewCachingAbstractMap<K, V> {
        ...
        public /* synthetic */ void lambda$forEach$0(BiConsumer biConsumer, Object obj) {
        ...
        public Set<Map.Entry<K, V>> createEntrySet() {
            return new EntrySet<K, V>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.AsMapView.1EntrySetImpl
        ...
        public void forEach(final BiConsumer<? super K, ? super V> biConsumer) {
            ...
            backingSet().forEach(new Consumer() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.IxI
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    Maps.AsMapView.this.lambda$forEach$0(biConsumer, obj);
                }
            });
        }
    ...
    public static final class BiMapConverter<A, B> extends Converter<A, B> implements Serializable {
        ...
        public String toString() {
            return "Maps.asConverter(" + this.bimap + oIX0oI.I0Io.f4095I0Io;
        }
    }
    ...
    public static abstract class DescendingMap<K, V> extends ForwardingMap<K, V> implements NavigableMap<K, V> {
        ...
        public Set<Map.Entry<K, V>> createEntrySet() {
            return new EntrySet<K, V>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.DescendingMap.1EntrySetImpl
                @Override // java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, java.util.Set
                public Iterator<Map.Entry<K, V>> iterator() {
    ...
    public static abstract class EntrySet<K, V> extends Sets.ImprovedAbstractSet<Map.Entry<K, V>> {
        ...
        @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Sets.ImprovedAbstractSet, java.util.AbstractSet, java.util.AbstractCollection, java.util.Collection, java.util.Set
    ...
    public static final class FilteredEntryBiMap<K, V> extends FilteredEntryMap<K, V> implements BiMap<K, V> {
        ...
        private static <K, V> Predicate<Map.Entry<V, K>> inversePredicate(final Predicate<? super Map.Entry<K, V>> predicate) {
            return new Predicate<Map.Entry<V, K>>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.FilteredEntryBiMap.1
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ Object lambda$replaceAll$0(BiFunction biFunction, Object obj, Object obj2) {
            Object apply;
        ...
        public void replaceAll(final BiFunction<? super K, ? super V, ? extends V> biFunction) {
            unfiltered().replaceAll(new BiFunction() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.xIXOoI
                @Override // java.util.function.BiFunction
                public final Object apply(Object obj, Object obj2) {
                    Object lambda$replaceAll$0;
                    lambda$replaceAll$0 = Maps.FilteredEntryBiMap.this.lambda$replaceAll$0(biFunction, obj, obj2);
        ...
        @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.ViewCachingAbstractMap, java.util.AbstractMap, java.util.Map, com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.BiMap
        public Set<V> values() {
    ...
    public static class FilteredEntryMap<K, V> extends AbstractFilteredMap<K, V> {
        ...
        public class EntrySet extends ForwardingSet<Map.Entry<K, V>> {
            ...
            public Iterator<Map.Entry<K, V>> iterator() {
                return new TransformedIterator<Map.Entry<K, V>, Map.Entry<K, V>>(FilteredEntryMap.this.filteredEntrySet.iterator()) { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.FilteredEntryMap.EntrySet.1
                    ...
                    public Map.Entry<K, V> transform(final Map.Entry<K, V> entry) {
                        return new ForwardingMapEntry<K, V>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.FilteredEntryMap.EntrySet.1.1
    ...
    public static class FilteredEntryNavigableMap<K, V> extends AbstractNavigableMap<K, V> {
        ...
        @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.AbstractNavigableMap, java.util.NavigableMap
        public NavigableMap<K, V> descendingMap() {
        ...
        @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.AbstractNavigableMap, java.util.NavigableMap
        public NavigableSet<K> navigableKeySet() {
            return new NavigableKeySet<K, V>(this) { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.FilteredEntryNavigableMap.1
                @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Sets.ImprovedAbstractSet, java.util.AbstractSet, java.util.AbstractCollection, java.util.Collection, java.util.Set
                public boolean removeAll(Collection<?> collection) {
    ...
    public static class FilteredEntrySortedMap<K, V> extends FilteredEntryMap<K, V> implements SortedMap<K, V> {
        ...
        @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.FilteredEntryMap, com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.ViewCachingAbstractMap
    ...
    public static class FilteredKeyMap<K, V> extends AbstractFilteredMap<K, V> {
        ...
        @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.AbstractFilteredMap, java.util.AbstractMap, java.util.Map
        public boolean containsKey(Object obj) {
    ...
    public static abstract class IteratorBasedAbstractMap<K, V> extends AbstractMap<K, V> {
        ...
        @Override // java.util.AbstractMap, java.util.Map
        public Set<Map.Entry<K, V>> entrySet() {
            return new EntrySet<K, V>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.IteratorBasedAbstractMap.1
    ...
    public static class KeySet<K, V> extends Sets.ImprovedAbstractSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            this.map.forEach(new BiConsumer() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.oXoXxOo
                @Override // java.util.function.BiConsumer
                public final void accept(Object obj, Object obj2) {
                    consumer.accept(obj);
                }
    ...
    public static final class NavigableAsMapView<K, V> extends AbstractNavigableMap<K, V> {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ Map.Entry lambda$entrySpliterator$0(Object obj) {
            return Maps.immutableEntry(obj, this.function.apply(obj));
        }

        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$forEach$1(BiConsumer biConsumer, Object obj) {
            biConsumer.accept(obj, this.function.apply(obj));
        }
        ...
        public Spliterator<Map.Entry<K, V>> entrySpliterator() {
            ...
            return CollectSpliterators.map(spliterator, new java.util.function.Function() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.XIOOI
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
                    Map.Entry lambda$entrySpliterator$0;
                    lambda$entrySpliterator$0 = Maps.NavigableAsMapView.this.lambda$entrySpliterator$0(obj);
        ...
        @Override // java.util.Map
        public void forEach(final BiConsumer<? super K, ? super V> biConsumer) {
            this.set.forEach(new Consumer() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.OOxOOxIO
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    Maps.NavigableAsMapView.this.lambda$forEach$1(biConsumer, obj);
                }
            });
        }
    ...
    public static class NavigableKeySet<K, V> extends SortedKeySet<K, V> implements NavigableSet<K> {
        ...
        @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.SortedKeySet, java.util.SortedSet, java.util.NavigableSet
        public SortedSet<K> headSet(K k) {
        ...
        @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.SortedKeySet, com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.KeySet
    ...
    public static class SortedAsMapView<K, V> extends AsMapView<K, V> implements SortedMap<K, V> {
        ...
        @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.AsMapView
    ...
    public static class SortedKeySet<K, V> extends KeySet<K, V> implements SortedSet<K> {
        ...
        @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.KeySet
    ...
    public static class SortedMapDifferenceImpl<K, V> extends MapDifferenceImpl<K, V> implements SortedMapDifference<K, V> {
        ...
        @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.MapDifferenceImpl, com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.MapDifference
    ...
    public static class TransformedEntriesMap<K, V1, V2> extends IteratorBasedAbstractMap<K, V2> {
        ...
        public Spliterator<Map.Entry<K, V2>> entrySpliterator() {
            Spliterator spliterator;
            spliterator = this.fromMap.entrySet().spliterator();
            return CollectSpliterators.map(spliterator, Maps.asEntryToEntryFunction(this.transformer));
        }

        @Override // java.util.Map
        public void forEach(final BiConsumer<? super K, ? super V2> biConsumer) {
            Preconditions.checkNotNull(biConsumer);
            this.fromMap.forEach(new BiConsumer() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.oox000IX
                @Override // java.util.function.BiConsumer
                public final void accept(Object obj, Object obj2) {
                    Maps.TransformedEntriesMap.this.lambda$forEach$0(biConsumer, obj, obj2);
                }
            });
        }
    ...
    public static class TransformedEntriesNavigableMap<K, V1, V2> extends TransformedEntriesSortedMap<K, V1, V2> implements NavigableMap<K, V2> {
        ...
        @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.TransformedEntriesSortedMap, java.util.SortedMap, java.util.NavigableMap
        ...
        @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.TransformedEntriesSortedMap
    ...
    public static class ValueDifferenceImpl<V> implements MapDifference.ValueDifference<V> {
        ...
        public String toString() {
            return oIX0oI.I0Io.f4096II0xO0 + this.left + ", " + this.right + oIX0oI.I0Io.f4095I0Io;
        }
    }
    ...
    public static class Values<K, V> extends AbstractCollection<V> {
        ...
        public void forEach(final Consumer<? super V> consumer) {
            Preconditions.checkNotNull(consumer);
            this.map.forEach(new BiConsumer() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.ox0I
                @Override // java.util.function.BiConsumer
                public final void accept(Object obj, Object obj2) {
    ...
    public static <K, V1, V2> Function<Map.Entry<K, V1>, Map.Entry<K, V2>> asEntryToEntryFunction(final EntryTransformer<? super K, ? super V1, V2> entryTransformer) {
        ...
        return new Function<Map.Entry<K, V1>, Map.Entry<K, V2>>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.13
            @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Function, java.util.function.Function
    ...
    public static <K, V1, V2> Function<Map.Entry<K, V1>, V2> asEntryToValueFunction(final EntryTransformer<? super K, ? super V1, V2> entryTransformer) {
        Preconditions.checkNotNull(entryTransformer);
        return new Function<Map.Entry<K, V1>, V2>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.11
            @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Function, java.util.function.Function
    ...
    public static <K, V1, V2> EntryTransformer<K, V1, V2> asEntryTransformer(final Function<? super V1, V2> function) {
        ...
        return new EntryTransformer<K, V1, V2>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.9
    ...
    public static <K, V> Iterator<Map.Entry<K, V>> asMapEntryIterator(Set<K> set, final Function<? super K, V> function) {
        return new TransformedIterator<K, Map.Entry<K, V>>(set.iterator()) { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.3
            /* JADX WARN: Multi-variable type inference failed */
            @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.TransformedIterator
    ...
    public static <K, V1, V2> Function<V1, V2> asValueToValueFunction(final EntryTransformer<? super K, V1, V2> entryTransformer, final K k) {
        Preconditions.checkNotNull(entryTransformer);
        return new Function<V1, V2>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.10
            @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Function, java.util.function.Function
    ...
    public static <K, V> Iterator<K> keyIterator(Iterator<Map.Entry<K, V>> it) {
        return new TransformedIterator<Map.Entry<K, V>, K>(it) { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.1
            @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.TransformedIterator
    ...
    public static /* synthetic */ Accumulator lambda$toImmutableEnumMap$1() {
        return new Accumulator(new BinaryOperator() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.IXoIo
            @Override // java.util.function.BiFunction
            public final Object apply(Object obj, Object obj2) {
    ...
    public static /* synthetic */ void lambda$toImmutableEnumMap$2(java.util.function.Function function, java.util.function.Function function2, Accumulator accumulator, Object obj) {
        ...
        accumulator.put(r1, Preconditions.checkNotNull(apply2, "Null value for input %s", obj));
    }
    ...
    public static <E> NavigableSet<E> removeOnlyNavigableSet(final NavigableSet<E> navigableSet) {
        return new ForwardingNavigableSet<E>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.6
    ...
    public static <E> Set<E> removeOnlySet(final Set<E> set) {
        return new ForwardingSet<E>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.4
            @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.ForwardingCollection, java.util.Collection, java.util.Queue
            public boolean add(E e) {
                throw new UnsupportedOperationException();
            }
    ...
    public static <E> SortedSet<E> removeOnlySortedSet(final SortedSet<E> sortedSet) {
        return new ForwardingSortedSet<E>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.5
            @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.ForwardingCollection, java.util.Collection, java.util.Queue
            public boolean add(E e) {
                throw new UnsupportedOperationException();
            }
    ...
    public static <T, K extends Enum<K>, V> Collector<T, ?, ImmutableMap<K, V>> toImmutableEnumMap(final java.util.function.Function<? super T, ? extends K> function, final java.util.function.Function<? super T, ? extends V> function2) {
        ...
        Supplier supplier = new Supplier() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.OXIOoo0X0
        ...
        BiConsumer biConsumer = new BiConsumer() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.x0oox0
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
        ...
        I00O i00o = new I00O();
        oO0IXx oo0ixx = new oO0IXx();
        characteristics = Collector.Characteristics.UNORDERED;
        of = Collector.of(supplier, biConsumer, i00o, oo0ixx, characteristics);
        return of;
    }
    ...
    public static <V2, K, V1> Map.Entry<K, V2> transformEntry(final EntryTransformer<? super K, ? super V1, V2> entryTransformer, final Map.Entry<K, V1> entry) {
        ...
        return new AbstractMapEntry<K, V2>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.12
    ...
    public static <K, V> Map.Entry<K, V> unmodifiableEntry(final Map.Entry<? extends K, ? extends V> entry) {
        Preconditions.checkNotNull(entry);
        return new AbstractMapEntry<K, V>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.7
            @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.AbstractMapEntry, java.util.Map.Entry
            public K getKey() {
                return (K) entry.getKey();
            }
    ...
    public static <K, V> UnmodifiableIterator<Map.Entry<K, V>> unmodifiableEntryIterator(final Iterator<Map.Entry<K, V>> it) {
        return new UnmodifiableIterator<Map.Entry<K, V>>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.8
    ...
    public static <K, V> Iterator<V> valueIterator(Iterator<Map.Entry<K, V>> it) {
        return new TransformedIterator<Map.Entry<K, V>, V>(it) { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.2
            @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.TransformedIterator
    ...
    public static <T, K extends Enum<K>, V> Collector<T, ?, ImmutableMap<K, V>> toImmutableEnumMap(final java.util.function.Function<? super T, ? extends K> function, final java.util.function.Function<? super T, ? extends V> function2, final BinaryOperator<V> binaryOperator) {
        ...
        of = Collector.of(new Supplier() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.ooO0oXxI
            @Override // java.util.function.Supplier
            public final Object get() {
                Maps.Accumulator lambda$toImmutableEnumMap$3;
                lambda$toImmutableEnumMap$3 = Maps.lambda$toImmutableEnumMap$3(binaryOperator);
                return lambda$toImmutableEnumMap$3;
            }
        }, new BiConsumer() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.o0OO0
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
                Maps.lambda$toImmutableEnumMap$4(function, function2, (Maps.Accumulator) obj, obj2);
            }
        }, new I00O(), new oO0IXx(), new Collector.Characteristics[0]);
        return of;
    }
