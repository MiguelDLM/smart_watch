...
public class TreeRangeSet<C extends Comparable<?>> extends AbstractRangeSet<C> implements Serializable {
    ...
    public static final class ComplementRangesByLowerBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        public Iterator<Map.Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>((Cut) MoreObjects.firstNonNull(higherKey, Cut.aboveAll()), peekingIterator) { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.TreeRangeSet.ComplementRangesByLowerBound.2
        ...
        public Iterator<Map.Entry<Cut<C>, Range<C>>> entryIterator() {
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>(cut, peekingIterator) { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.TreeRangeSet.ComplementRangesByLowerBound.1
    ...
    public static final class RangesByUpperBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        public Iterator<Map.Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.TreeRangeSet.RangesByUpperBound.2
                @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.AbstractIterator
                public Map.Entry<Cut<C>, Range<C>> computeNext() {
                    if (!peekingIterator.hasNext()) {
                        return (Map.Entry) endOfData();
        ...
        public Iterator<Map.Entry<Cut<C>, Range<C>>> entryIterator() {
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.TreeRangeSet.RangesByUpperBound.1
                @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.AbstractIterator
                public Map.Entry<Cut<C>, Range<C>> computeNext() {
                    if (!it.hasNext()) {
                        return (Map.Entry) endOfData();
    ...
    public final class SubRangeSet extends TreeRangeSet<C> {
        ...
        */
        public SubRangeSet(com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Range<C> r5) {
            /*
                r3 = this;
                com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.TreeRangeSet.this = r4
                com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.TreeRangeSet$SubRangeSetRangesByLowerBound r0 = new com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.TreeRangeSet$SubRangeSetRangesByLowerBound
                com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Range r1 = com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Range.all()
                java.util.NavigableMap<com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Cut<C extends java.lang.Comparable<?>>, com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Range<C extends java.lang.Comparable<?>>> r4 = r4.rangesByLowerBound
                r2 = 0
                r0.<init>(r1, r5, r4)
                r3.<init>(r0)
                r3.restriction = r5
    ...
    public static final class SubRangeSetRangesByLowerBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        public Iterator<Map.Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
            ...
            Comparable endpoint = cut.endpoint();
            if (cut.typeAsUpperBound() == BoundType.CLOSED) {
                z = true;
            } else {
                z = false;
            }
            final Iterator it = navigableMap.headMap(endpoint, z).descendingMap().values().iterator();
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.TreeRangeSet.SubRangeSetRangesByLowerBound.2
                @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.AbstractIterator
                public Map.Entry<Cut<C>, Range<C>> computeNext() {
                    if (!it.hasNext()) {
                        return (Map.Entry) endOfData();
        ...
        public Iterator<Map.Entry<Cut<C>, Range<C>>> entryIterator() {
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.TreeRangeSet.SubRangeSetRangesByLowerBound.1
                @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.AbstractIterator
                public Map.Entry<Cut<C>, Range<C>> computeNext() {
                    if (!it.hasNext()) {
                        return (Map.Entry) endOfData();
    ...
    public RangeSet<C> subRangeSet(Range<C> range) {
        ...
        return new SubRangeSet(this, range);
    }
