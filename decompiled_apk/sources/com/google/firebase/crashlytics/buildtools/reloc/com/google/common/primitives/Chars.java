...
public final class Chars {
    ...
    public static char saturatedCast(long j) {
        if (j > 65535) {
            return kotlin.jvm.internal.x0xO0oo.f29362I0Io;
        }
        if (j < 0) {
            return (char) 0;
        }
    ...
    */
    public static int indexOf(char[] r5, char[] r6) {
        ...
        L2a:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.primitives.Chars.indexOf(char[], char[]):int");
    }
