...
public class XmlEscapers {
    ...
    static {
        ...
        builder.setUnsafeReplacement(oO.f31684oI0IIXIo);
        for (char c = 0; c <= 31; c = (char) (c + 1)) {
            if (c != '\t' && c != '\n' && c != '\r') {
                builder.addEscape(c, oO.f31684oI0IIXIo);
            }
        }
        builder.addEscape(XIxXXX0x0.f29558oxoX, "&amp;");
        builder.addEscape(XIxXXX0x0.f29542X0o0xo, "&lt;");
        builder.addEscape(XIxXXX0x0.f29545XO, "&gt;");
