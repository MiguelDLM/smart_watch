...
public final class IntMath {
    ...
    private static final int[] factorials = {1, 1, 2, 6, 24, 120, CameraManager.DEFAULTHEIGHT, ErrorCode.VIDEO_DURATION_ERROR, 40320, 362880, 3628800, 39916800, 479001600};

    @VisibleForTesting
    static int[] biggestBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, 65536, 2345, 477, 193, 110, 75, 58, 49, 43, 39, 37, 35, 34, 34, 33};

    /* renamed from: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.math.IntMath$1, reason: invalid class name */
    /* loaded from: classes10.dex */
