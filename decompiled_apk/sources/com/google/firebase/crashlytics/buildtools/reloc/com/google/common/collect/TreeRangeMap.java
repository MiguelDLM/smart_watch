...
public final class TreeRangeMap<K extends Comparable, V> implements RangeMap<K, V> {
    private static final RangeMap EMPTY_SUB_RANGE_MAP = new RangeMap() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.TreeRangeMap.1
    ...
    public class SubRangeMap implements RangeMap<K, V> {
        ...
        public class SubRangeMapAsMap extends AbstractMap<Range<K>, V> {
            ...
            public Iterator<Map.Entry<Range<K>, V>> entryIterator() {
                ...
                return new AbstractIterator<Map.Entry<Range<K>, V>>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.TreeRangeMap.SubRangeMap.SubRangeMapAsMap.3
            ...
            public Set<Map.Entry<Range<K>, V>> entrySet() {
                return new Maps.EntrySet<Range<K>, V>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.TreeRangeMap.SubRangeMap.SubRangeMapAsMap.2
            ...
            public Set<Range<K>> keySet() {
                return new Maps.KeySet<Range<K>, V>(this) { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.TreeRangeMap.SubRangeMap.SubRangeMapAsMap.1
            ...
            public Collection<V> values() {
                return new Maps.Values<Range<K>, V>(this) { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.TreeRangeMap.SubRangeMap.SubRangeMapAsMap.4
        ...
        public Map<Range<K>, V> asDescendingMapOfRanges() {
            return new TreeRangeMap<K, V>.SubRangeMap.SubRangeMapAsMap() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.TreeRangeMap.SubRangeMap.1
                ...
                public Iterator<Map.Entry<Range<K>, V>> entryIterator() {
                    ...
                    return new AbstractIterator<Map.Entry<Range<K>, V>>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.TreeRangeMap.SubRangeMap.1.1
                        @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.AbstractIterator
                        public Map.Entry<Range<K>, V> computeNext() {
                            if (it.hasNext()) {
                                RangeMapEntry rangeMapEntry = (RangeMapEntry) it.next();
