...
public final class TypeResolver {
    ...
    public static class WildcardCapturer {
        ...
        private WildcardCapturer forTypeVariable(final TypeVariable<?> typeVariable) {
            return new WildcardCapturer(this.id) { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.reflect.TypeResolver.WildcardCapturer.1
                @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.reflect.TypeResolver.WildcardCapturer
        ...
        public TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {
            return Types.newArtificialTypeVariable(WildcardCapturer.class, "capture#" + this.id.incrementAndGet() + "-of ? extends " + Joiner.on(XIxXXX0x0.f29558oxoX).join(typeArr), typeArr);
        }
    ...
    public static void populateTypeMappings(final Map<TypeVariableKey, Type> map, Type type, final Type type2) {
        ...
        new TypeVisitor() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.reflect.TypeResolver.1
            @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.reflect.TypeVisitor
            public void visitClass(Class<?> cls) {
    ...
    public static class TypeTable {
        ...
        public final Type resolve(final TypeVariable<?> typeVariable) {
            return resolveInternal(typeVariable, new TypeTable() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.reflect.TypeResolver.TypeTable.1
                @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.reflect.TypeResolver.TypeTable
