...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    public static final class And extends CharMatcher {
        ...
        public String toString() {
            return "CharMatcher.and(" + this.first + ", " + this.second + oIX0oI.I0Io.f4095I0Io;
        }
    }
    ...
    public static final class ForPredicate extends CharMatcher {
        ...
        @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.CharMatcher
        public String toString() {
            return "CharMatcher.forPredicate(" + this.predicate + oIX0oI.I0Io.f4095I0Io;
        }
    ...
    public static final class Or extends CharMatcher {
        ...
        @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.CharMatcher
        public String toString() {
            return "CharMatcher.or(" + this.first + ", " + this.second + oIX0oI.I0Io.f4095I0Io;
        }
    }
    ...
    public CharMatcher precomputedInternal() {
        ...
        return new NegatedFastMatcher(precomputedPositive(i, bitSet, str)) { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.CharMatcher.1
            @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.CharMatcher.Negated, com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.CharMatcher
            public String toString() {
                return charMatcher;
            }
        };
