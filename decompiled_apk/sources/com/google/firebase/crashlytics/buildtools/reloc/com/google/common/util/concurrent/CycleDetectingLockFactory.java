...
public class CycleDetectingLockFactory {
    ...
    private static final ThreadLocal<ArrayList<LockGraphNode>> acquiredLocks = new ThreadLocal<ArrayList<LockGraphNode>>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.util.concurrent.CycleDetectingLockFactory.1
    ...
    public static class ExampleStackTrace extends IllegalStateException {
        ...
        public ExampleStackTrace(LockGraphNode lockGraphNode, LockGraphNode lockGraphNode2) {
            super(lockGraphNode.getLockName() + org.apache.commons.text.oIX0oI.f33048oxoX + lockGraphNode2.getLockName());
    ...
    private static String getLockName(Enum<?> r2) {
        return r2.getDeclaringClass().getSimpleName() + FileUtils.FILE_EXTENSION_SEPARATOR + r2.name();
    }
