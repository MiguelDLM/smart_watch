...
public class ImmutableRangeMap<K extends Comparable<?>, V> implements RangeMap<K, V>, Serializable {
    ...
    @NullableDecl
    public V get(K k) {
        int binarySearch = SortedLists.binarySearch(this.ranges, (com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Function<? super E, Cut>) Range.lowerBoundFn(), Cut.belowValue(k), SortedLists.KeyPresentBehavior.ANY_PRESENT, SortedLists.KeyAbsentBehavior.NEXT_LOWER);
    ...
    public ImmutableRangeMap<K, V> subRangeMap(final Range<K> range) {
        ...
        com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Function upperBoundFn = Range.upperBoundFn();
        Cut<K> cut = range.lowerBound;
        SortedLists.KeyPresentBehavior keyPresentBehavior = SortedLists.KeyPresentBehavior.FIRST_AFTER;
        SortedLists.KeyAbsentBehavior keyAbsentBehavior = SortedLists.KeyAbsentBehavior.NEXT_HIGHER;
        final int binarySearch = SortedLists.binarySearch(immutableList, (com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Function<? super E, Cut<K>>) upperBoundFn, cut, keyPresentBehavior, keyAbsentBehavior);
        int binarySearch2 = SortedLists.binarySearch(this.ranges, (com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Function<? super E, Cut<K>>) Range.lowerBoundFn(), range.upperBound, SortedLists.KeyPresentBehavior.ANY_PRESENT, keyAbsentBehavior);
        if (binarySearch >= binarySearch2) {
            return of();
        }
        final int i = binarySearch2 - binarySearch;
        return (ImmutableRangeMap<K, V>) new ImmutableRangeMap<K, V>(new ImmutableList<Range<K>>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.ImmutableRangeMap.1
        ...
        }, this.values.subList(binarySearch, binarySearch2)) { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.ImmutableRangeMap.2
            @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.ImmutableRangeMap, com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.RangeMap
