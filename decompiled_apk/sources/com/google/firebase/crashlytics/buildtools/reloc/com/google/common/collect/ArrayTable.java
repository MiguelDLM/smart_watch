...
public final class ArrayTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    public static abstract class ArrayMap<K, V> extends Maps.IteratorBasedAbstractMap<K, V> {
        ...
        public Spliterator<Map.Entry<K, V>> entrySpliterator() {
            return CollectSpliterators.indexed(size(), 16, new IntFunction() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.OxxIIOOXO
    ...
    public Table.Cell<R, C, V> getCell(int i) {
        return new Tables.AbstractCell<R, C, V>(i) { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.ArrayTable.2
            final int columnIndex;
            final int rowIndex;
    ...
    public Spliterator<Table.Cell<R, C, V>> cellSpliterator() {
        return CollectSpliterators.indexed(size(), 273, new IntFunction() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Oxx0xo
            @Override // java.util.function.IntFunction
            public final Object apply(int i) {
                Table.Cell cell;
    ...
    public Spliterator<V> valuesSpliterator() {
        return CollectSpliterators.indexed(size(), 16, new IntFunction() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.oI0IIXIo
            @Override // java.util.function.IntFunction
            public final Object apply(int i) {
                Object value;
