        ...
        public enum UnsafeComparator implements Comparator<byte[]> {
            ...
            private static Unsafe getUnsafe() {
                try {
                    ...
                    return (Unsafe) AccessController.doPrivileged(new PrivilegedExceptionAction<Unsafe>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.primitives.UnsignedBytes.LexicographicalComparatorHolder.UnsafeComparator.1
