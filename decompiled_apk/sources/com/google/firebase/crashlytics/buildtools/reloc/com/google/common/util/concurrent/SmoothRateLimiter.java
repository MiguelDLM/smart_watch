...
public abstract class SmoothRateLimiter extends RateLimiter {
    ...
    public static final class SmoothBursty extends SmoothRateLimiter {
        ...
        @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.util.concurrent.SmoothRateLimiter
        ...
        public void doSetRate(double d, double d2) {
            ...
            double d5 = XIXIX.OOXIXo.f3760XO;
    ...
    public static final class SmoothWarmingUp extends SmoothRateLimiter {
        ...
        public void doSetRate(double d, double d2) {
            ...
            if (d3 == Double.POSITIVE_INFINITY) {
                this.storedPermits = XIXIX.OOXIXo.f3760XO;
                return;
            }
            if (d3 != XIXIX.OOXIXo.f3760XO) {
