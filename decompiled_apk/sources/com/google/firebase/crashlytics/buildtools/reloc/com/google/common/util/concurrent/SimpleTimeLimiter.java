...
import com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.ObjectArrays;
...
public final class SimpleTimeLimiter implements TimeLimiter {
    ...
    @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.util.concurrent.TimeLimiter
    ...
    public <T> T newProxy(final T t, Class<T> cls, final long j, final TimeUnit timeUnit) {
        ...
        return (T) newProxy(cls, new InvocationHandler() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.util.concurrent.SimpleTimeLimiter.1
            @Override // java.lang.reflect.InvocationHandler
            public Object invoke(Object obj, final Method method, final Object[] objArr) throws Throwable {
                return SimpleTimeLimiter.this.callWithTimeout(new Callable<Object>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.util.concurrent.SimpleTimeLimiter.1.1
