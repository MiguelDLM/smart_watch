...
public enum DWAttribute {
    ...
    EXTENSION(84, ShareConstants.MEDIA_EXTENSION),
    RANGES(85, "ranges"),
    ...
    SIGNATURE(105, oxoX.f1377Oxx0IOOO),
    ...
    REFERENCE(119, TypedValues.Custom.S_REFERENCE),
    ...
    MIPS_STRIDE(ARPMessageType.MSG_TYPE_OBR_TO_SDK, "MIPS_stride"),
    ...
    VMS_RTNBEG_PD_ADDRESS(GetFileTask.l, "VMS_rtnbeg_pd_address"),
    ...
    HI_USER(OOxOOxIO.f12624oIX0oI, "hi_user");
