...
public class XmlResourceUtils {
    ...
    public static List<BuildIdInfo> getBuildIds(Document document) {
        ...
        NodeList elementsByTagName = getLibElement(document).getElementsByTagName("item");
        NodeList elementsByTagName2 = getArchElement(document).getElementsByTagName("item");
        NodeList elementsByTagName3 = getBuildIdsElement(document).getElementsByTagName("item");
