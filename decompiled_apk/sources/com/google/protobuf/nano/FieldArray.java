...
public final class FieldArray implements Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (size() == fieldArray.size() && arrayEquals(this.mFieldNumbers, fieldArray.mFieldNumbers, this.mSize) && arrayEquals(this.mData, fieldArray.mData, this.mSize)) {
            return true;
        }
        return false;
    }
    ...
    public final FieldArray m267clone() {
        int size = size();
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (fieldData != null) {
                fieldArray.mData[i] = fieldData.m268clone();
            }
        }
