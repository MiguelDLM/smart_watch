...
public class DecodeFileThread extends Thread {
    ...
    public DecodeFileThread(BaseManager baseManager, String str, String str2, OnStateCallback onStateCallback, OnThreadFinishListener onThreadFinishListener) {
    ...
    public void run() {
        if (this.mManager != null) {
            ...
            if (!TextUtils.isEmpty(this.inFile) && !TextUtils.isEmpty(this.outFile) && file.exists() && file.isFile()) {
                this.mManager.nativeDecodeFile(this.inFile, this.outFile);
            } else {
