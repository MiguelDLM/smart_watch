...
public class WatchTestConstant {
    ...
    public static final int DEFAULT_BLE_MTU = 509;
    ...
    public static final boolean FILTER_DEVICE = true;
    public static final String KEY_FORCED_UPDATE_FLAG = "forced_update_flag_1";
    ...
    public static final String VERSION_W001 = "W001";
    public static final String VERSION_W002 = "W002";
}
