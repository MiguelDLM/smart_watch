...
public class RcspConstant {
    ...
    public static int[] DEFAULT_EQ_FREQS = {31, 63, 125, 250, 500, 1000, 2000, 4000, 8000, 16000};
    ...
    public static final int OP_CANCEL_TRANSFER = 2;
    ...
    public static final int PLATFORM_INTERFACE_CHATGPT_IFLYTEK = 1;
    public static final int PLATFORM_INTERFACE_IAT_IFLYTEK = 0;
    public static final int PLATFORM_INTERFACE_TTI_IFLYTEK = 3;
    public static final int PLATFORM_INTERFACE_TTS_IFLYTEK = 2;
    public static final int PLATFORM_INTERFACE_TYPE_API_KEY = 2;
    public static final int PLATFORM_INTERFACE_TYPE_API_SECRET = 1;
    public static final int PLATFORM_INTERFACE_TYPE_APP_ID = 0;
    ...
    public static final int TYPE_AI_CLOUD_DATA = 3;
    public static final int TYPE_ALI_DATA = 1;
    public static final int TYPE_CHECK_FILE = 0;
    public static final int TYPE_ESIM_CARD = 6;
    public static final int TYPE_FIRMWARE_UPGRADE = 1;
    public static final int TYPE_NETWORK_OTA = 7;
    public static final int TYPE_PLATFORM_INTERFACE_DATA = 5;
    public static final int TYPE_RAW_DATA = 0;
    public static final int TYPE_RTC_DATA = 2;
    public static final int TYPE_TTS_DATA = 4;
