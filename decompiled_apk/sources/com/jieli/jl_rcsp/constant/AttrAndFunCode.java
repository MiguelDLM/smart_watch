...
public class AttrAndFunCode {
    ...
    public static final int AI_DIAL_OP_GENERATE_DIAL = 2;
    public static final int AI_DIAL_OP_INSTALL_DIAL = 5;
    public static final int AI_DIAL_OP_NOTIFY_THUMB = 4;
    public static final int AI_DIAL_OP_PAINT_STYLE = 0;
    public static final int AI_DIAL_OP_RECORDING_AGAIN = 3;
    public static final int AI_DIAL_OP_REGENERATE_DIAL = 6;
    public static final int AI_DIAL_OP_UI = 1;
    public static final int AI_OP_AI_DIAL = 0;
