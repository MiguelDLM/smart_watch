...
public class BaseFragmentPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public BaseFragmentPagerAdapter(oIX0oI oix0oi) {
    ...
    public BaseFragmentPagerAdapter(oIX0oI oix0oi, CharSequence[] charSequenceArr) {
        super(oix0oi.provideFragmentManager());
        this.mFragments = oix0oi.initFragments();
        this.mTitles = charSequenceArr;
    }
    ...
    public BaseFragmentPagerAdapter(oIX0oI oix0oi, int i) {
        super(oix0oi.provideFragmentManager());
