...
@XX({"SMAP\nBaseRecyclerActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 BaseRecyclerActivity.kt\ncom/bestmafen/androidbase/recycler/BaseRecyclerActivity\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,35:1\n1#2:36\n*E\n"})
/* loaded from: classes8.dex */
public abstract class BaseRecyclerActivity<T> extends BaseActivity implements I0Io<T> {
    ...
    public void initView() {
        ...
        CommonAdapter<T> commonAdapter = new CommonAdapter<T>(this, mContext, itemLayoutId, mList) { // from class: com.bestmafen.androidbase.recycler.BaseRecyclerActivity$initView$1
