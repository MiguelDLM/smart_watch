...
public abstract class BaseDSLRecyclerFragment extends BaseFragment {
    ...
    public BaseDSLRecyclerFragment() {
        DslAdapter dslAdapter = new DslAdapter(null, 1, 0 == true ? 1 : 0);
    ...
    public static final void initBaseLayout$lambda$3$lambda$2(BaseDSLRecyclerFragment this$0) {
    ...
    public void initBaseLayout(int i, int i2) {
        ...
        if (recyclerView != null) {
            ...
            recyclerView.setLayoutManager(new LinearLayoutManager(context) { // from class: com.bestmafen.androidbase.recycler.BaseDSLRecyclerFragment$initBaseLayout$1$1
        ...
        if (i2 != 0 && (swipeRefreshLayout = (SwipeRefreshLayout) getDslViewHolder().v(i2)) != null) {
            ...
            swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() { // from class: com.bestmafen.androidbase.recycler.II0xO0
                @Override // androidx.swiperefreshlayout.widget.SwipeRefreshLayout.OnRefreshListener
                public final void onRefresh() {
                    BaseDSLRecyclerFragment.initBaseLayout$lambda$3$lambda$2(BaseDSLRecyclerFragment.this);
                }
            });
        }
    }
    ...
    public void initView() {
        setDslViewHolder(new DslViewHolder(getMView(), 0, 2, null));
