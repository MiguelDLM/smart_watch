...
public final class BaseDSLRecyclerFragmentKt {
    @OOXIXo
    public static final GridLayoutManager.SpanSizeLookup II0xO0(@OOXIXo GridLayoutManager gridLayoutManager, @OOXIXo final DslAdapter dslAdapter) {
        ...
        GridLayoutManager.SpanSizeLookup spanSizeLookup = new GridLayoutManager.SpanSizeLookup() { // from class: com.bestmafen.androidbase.recycler.BaseDSLRecyclerFragmentKt$dslSpanSizeLookup$spanSizeLookup$1
    ...
    public static final GridLayoutManager.SpanSizeLookup oIX0oI(@OOXIXo GridLayoutManager gridLayoutManager, @OOXIXo final RecyclerView recyclerView) {
        ...
        final int spanCount = gridLayoutManager.getSpanCount();
        GridLayoutManager.SpanSizeLookup spanSizeLookup = new GridLayoutManager.SpanSizeLookup() { // from class: com.bestmafen.androidbase.recycler.BaseDSLRecyclerFragmentKt$dslSpanSizeLookup$spanSizeLookup$2
            @Override // androidx.recyclerview.widget.GridLayoutManager.SpanSizeLookup
            public int getSpanSize(int i) {
