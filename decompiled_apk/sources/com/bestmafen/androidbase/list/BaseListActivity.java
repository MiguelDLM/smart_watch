...
@XX({"SMAP\nBaseListActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 BaseListActivity.kt\ncom/bestmafen/androidbase/list/BaseListActivity\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,35:1\n1#2:36\n*E\n"})
/* loaded from: classes8.dex */
public abstract class BaseListActivity<T> extends BaseActivity implements I0Io<T> {
    ...
    public static final class oIX0oI extends XIOOI.oIX0oI<T> {
        ...
        public final /* synthetic */ BaseListActivity<T> f10338Oxx0xo;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public oIX0oI(BaseListActivity<T> baseListActivity, Activity activity, int i, List<T> list) {
            super(activity, i, list);
            this.f10338Oxx0xo = baseListActivity;
        }
        ...
        public void II0xO0(@OOXIXo XIOOI.I0Io viewHolder, T t, int i) {
            ...
            this.f10338Oxx0xo.initItem(viewHolder, t, i);
        }

        @Override // XIOOI.II0xO0, android.widget.Adapter
        public int getCount() {
            return this.f10338Oxx0xo.getItemCount();
        }
    }
    ...
    public void initView() {
        ...
        setMList(initList());
        oIX0oI oix0oi = new oIX0oI(this, getMContext(), itemLayoutId(), getMList());
