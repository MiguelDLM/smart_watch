...
public class BNRelativeLayout extends RelativeLayout implements IVisibility {
    ...
    public void setVisibility(int i) {
        ...
        if (!isVisibilityValid(i)) {
            if (LogUtil.LOGGABLE) {
                ...
                LogUtil.printException("BNRelativeLayout setVisibility visibility: " + i + ", invalid visibility!!!", new IllegalArgumentException());
                return;
            }
            return;
        }
