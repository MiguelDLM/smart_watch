...
public class b extends com.baidu.navisdk.ui.routeguide.toolbox.b {
    ...
    public List<com.baidu.navisdk.ui.routeguide.toolbox.bean.a> j() {
        ...
        if (BNCommSettingManager.getInstance().getIsShowMapSwitch() == 1) {
            i = R.drawable.nsdk_drawable_toolbox_fullview_state;
            str = "路况条";
        } else {
            i = R.drawable.nsdk_drawable_toolbox_fullview_state;
            str = "全览小窗";
        }
        com.baidu.navisdk.ui.routeguide.toolbox.bean.a aVar6 = new com.baidu.navisdk.ui.routeguide.toolbox.bean.a(17);
        aVar6.b(str);
        aVar6.a(i);
        arrayList.add(aVar6);
