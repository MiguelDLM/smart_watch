...
public final class c extends com.baidu.navisdk.pronavi.ui.buttoncollect.btnlogic.a {
    private boolean b;
    ...
    public boolean a(@OOXIXo com.baidu.navisdk.pronavi.ui.base.b uiContext, @OOXIXo View view, @oOoXoXO Object obj) {
        ...
        if (!com.baidu.navisdk.ui.routeguide.b.V().x()) {
            ...
            if (gVar.d()) {
                gVar.e("RGHDBtnLogic", "onClicked: not hasCalcRouteOk");
            }
            return false;
        }
        ...
        b.a(f);
        com.baidu.navisdk.behavrules.util.a.a().a(new com.baidu.navisdk.behavrules.event.b(f == 3 ? "asr_e_c_hd_full" : "asr_e_c_hd_half"));
        return true;
    }
    ...
    public boolean a(@oOoXoXO com.baidu.navisdk.pronavi.ui.base.b bVar) {
        if (!com.baidu.navisdk.ui.routeguide.b.V().x()) {
            com.baidu.navisdk.util.common.g gVar = com.baidu.navisdk.util.common.g.PRO_NAV;
            if (gVar.d()) {
                gVar.e("RGHDBtnLogic", "visibility: not hasCalcRouteOk");
            }
            return false;
        }
        a0 I = a0.I();
        ...
        if (I.D()) {
            ...
            if (gVar2.d()) {
                gVar2.e("RGHDBtnLogic", "visibility: isYawing");
            }
            return false;
        }
