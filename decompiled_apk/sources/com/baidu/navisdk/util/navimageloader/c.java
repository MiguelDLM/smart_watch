...
public class c {
    ...
    private com.baidu.navisdk.util.navimageloader.b f9344a;
    private d b;
    private com.baidu.navisdk.util.navimageloader.a c;
    private e d;
    public com.baidu.navisdk.util.cache.a e;
    ...
    private com.baidu.navisdk.util.navimageloader.b c() {
        com.baidu.navisdk.util.navimageloader.b bVar = this.f9344a;
        if (bVar != null) {
            return bVar;
        }
        com.baidu.navisdk.util.navimageloader.b a2 = new b.C0502b().a();
        this.f9344a = a2;
        return a2;
    }
    ...
    private void f() {
        if (this.e == null) {
            this.e = new com.baidu.navisdk.util.cache.a(i, 50);
        }
        if (h == null) {
            h = new HashMap<>();
        }
    ...
    /* loaded from: classes8.dex */
    public class C0503c implements e {
    ...
    public void a(String str, ImageView imageView, com.baidu.navisdk.util.navimageloader.b bVar) {
        a(str, imageView, bVar, null);
    }

    public void a(String str, ImageView imageView, com.baidu.navisdk.util.navimageloader.b bVar, e eVar) {
        if (imageView == null) {
            return;
        }
        if (bVar == null) {
