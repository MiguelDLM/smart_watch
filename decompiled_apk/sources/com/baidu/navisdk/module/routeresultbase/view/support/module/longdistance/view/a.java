...
public class a extends LinearLayout {
    ...
    private void a() {
        ((LayoutInflater) this.f7537a.getSystemService("layout_inflater")).inflate(R.layout.nsdk_rr_navi_pass_service_info, this);
    ...
    public void a(com.baidu.navisdk.module.routeresultbase.logic.longdistance.checkpoint.a aVar) {
        if (aVar != null) {
            c(com.baidu.navisdk.module.routeresultbase.logic.longdistance.c.c(aVar.f7512a));
