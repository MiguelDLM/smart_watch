...
import com.baidu.navisdk.cmdrequest.HttpPostBase;
...
public class CmdGeneralHttpPostFunc extends HttpPostBase {
    public static final String e = "CmdGeneralHttpPostFunc";
    ...
    @Override // com.baidu.navisdk.cmdrequest.HttpPostBase, com.baidu.navisdk.cmdrequest.a
    public void c() {
        if (!this.b.f) {
    ...
    @Override // com.baidu.navisdk.cmdrequest.HttpPostBase
    public List<l> d() {
        a aVar = this.d;
        if (aVar != null) {
            return aVar.getRequestParams();
        }
        return null;
    }
