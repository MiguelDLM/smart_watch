...
public final class NavImageManager$mBleHandleCallback$1 implements BleHandleCallback {
    final /* synthetic */ NavImageManager this$0;

    public NavImageManager$mBleHandleCallback$1(NavImageManager navImageManager) {
        this.this$0 = navImageManager;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void onStreamProgress$lambda$0(NavImageManager this$0) {
        String str;
    ...
    public void onStreamProgress(boolean z, int i, int i2, int i3, @OOXIXo BleKey bleKey) {
        ...
        if (z) {
            ...
            if (i2 == i3) {
                ...
                final NavImageManager navImageManager = this.this$0;
                handler.postDelayed(new Runnable() { // from class: com.baidu.mapclient.liteapp.oxoX
                    @Override // java.lang.Runnable
                    public final void run() {
                        NavImageManager$mBleHandleCallback$1.onStreamProgress$lambda$0(NavImageManager.this);
                    }
                }, 500L);
                return;
            }
