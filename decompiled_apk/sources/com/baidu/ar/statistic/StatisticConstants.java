...
public class StatisticConstants {
    ...
    public static final String EVENT_AR_DIGIT_START = "event_ar_digit_start";
    public static final String EVENT_AR_VPAS_INDOOR_KEYPOINTS = "vps_indoor_keypoints";
    public static final String EVENT_AR_VPAS_NAVI_INIT_SUCCESS = "ar_navi_init_success";
    ...
    public static final String NAVIGATION_BUILDING_ID = "building_id";
    public static final String NAVIGATION_CUID = "cuid";
    public static final String NAVIGATION_DURATION = "ar_navi_duration";
    public static final String NAVIGATION_RESUME = "ar_navi_resume";
    public static final String NAVIGATION_SHOW_LAT = "ar_navi_lat";
    public static final String NAVIGATION_SHOW_LNG = "ar_navi_lng";
    public static final String NAVIGATION_SHOW_POSE = "ar_navi_pose";
    public static final String NAVIGATION_SHOW_TRAVEL = "ar_navi_travel";
    public static final String NAVIGATION_START = "ar_navi_start";
    public static final String NAVIGATION_START_SUCCESS = "ar_navi_start_success";
    ...
    public static final String VPS_BUILDING_ID = "building_id";
    ...
    public static final String VPS_SERVICE_TYPE = "service_type";
    ...
    public static final String VPS_SUCCESS_NUM = "success_num";
