...
public class ReserveHandleData {
    ...
    private int[] mByteFormats;
    private int[] mByteHeights;
    private int[] mByteWidths;
    private List<char[]> mCharArrayListData;
    private int mCharDataSize;
    private List<double[]> mDoubleArrayListData;
    private int mDoubleDataSize;
    private List<float[]> mFloatArrayListData;
    private int mFloatDataSize;
    private List<int[]> mIntArrayListData;
    private int mIntDataSize;
    private List<long[]> mLongArrayListData;
    private int mLongDataSize;
