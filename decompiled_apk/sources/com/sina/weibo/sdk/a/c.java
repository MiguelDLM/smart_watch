...
public abstract class c<Params, Progress, Result> {
    ...
    /* loaded from: classes11.dex */
    public abstract class AbstractC0925c extends FutureTask<Result> implements Comparable<Object> {
        int priority;

        public AbstractC0925c(d dVar) {
            super(dVar);
    ...
    public c() {
        ...
        this.M = dVar;
        this.N = new c<Params, Progress, Result>.AbstractC0925c(dVar) { // from class: com.sina.weibo.sdk.a.c.3
