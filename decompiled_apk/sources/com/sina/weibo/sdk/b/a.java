...
public final class a {
    ...
    public static C0926a c(Context context) {
        return e(context);
    }
    ...
    public static C0926a e(Context context) {
    ...
    private static C0926a a(Context context, String str) {
        ...
        try {
            ...
            while (true) {
                ...
                if (read != -1) {
                    ...
                    c0926a.ah = jSONObject.optInt("support_api", -1);
                    c0926a.ag = jSONObject.optString("authActivityName", null);
                    c0926a.packageName = str;
                    return c0926a;
                }
            }
        } catch (PackageManager.NameNotFoundException e) {
