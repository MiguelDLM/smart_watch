    ...
    public static byte[] fgs2Byte(String str, String str2, String str3, String str4, String str5) {
        ...
        try {
            if (TextUtils.isEmpty(str5)) {
                ...
                Log.d("DataUtils", "secretKey: " + II0XooXoX.f29508oIX0oI);
                oIX0oI2 = II0XooXoX.f29508oIX0oI.getBytes("UTF-8");
                Log.d("DataUtils", "secretKey hex: " + Hex.encodeHexString(oIX0oI2));
        ...
        return X0o0xo.II0xO0(Sid.FGS, new JSONStringer().object().key("msg_type").value("FGS_MSG_TYPE_DS_DOWNLOAD_REQ").key("code").value(200L).key("deviceSecret").value(oIX0oI3).key("message").value("success").key("sidver").value(1L).endObject().toString());
    }
}
