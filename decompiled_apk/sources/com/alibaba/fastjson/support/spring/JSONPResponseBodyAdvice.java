...
public class JSONPResponseBodyAdvice implements ResponseBodyAdvice<Object> {
    ...
    public boolean supports(MethodParameter methodParameter, Class<? extends HttpMessageConverter<?>> cls) {
        if (FastJsonHttpMessageConverter.class.isAssignableFrom(cls) && (methodParameter.getContainingClass().isAnnotationPresent(ResponseJSONP.class) || methodParameter.hasMethodAnnotation(ResponseJSONP.class))) {
            return true;
        }
        return false;
    }
