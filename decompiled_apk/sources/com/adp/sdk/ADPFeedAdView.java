...
public class ADPFeedAdView extends FrameLayout {
    ...
    private xXoOI00O.oIX0oI f4651a;
    ...
    private View g;
    private NativeAd h;
    private com.adp.sdk.listener.b i;
    private boolean j;
    ...
    public ADPFeedAdView(Context context, View view) {
        ...
        this.j = false;
        this.g = view;
        this.f = (FrameLayout) ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(R.layout.adp_feed_view, (ViewGroup) this, true);
    }

    private void a(Context context, View view) {
        this.c = context;
        FrameLayout frameLayout = (FrameLayout) ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(R.layout.adp_feed_view, (ViewGroup) this, true);
    ...
    public void render() {
        ...
        NativeAdResponse nativeAdResponse = this.b;
        if (nativeAdResponse != null) {
            nativeAdResponse.OxxIIOOXO(this, this.f4651a);
        }
    ...
    public ADPFeedAdView(Context context, xXoOI00O.oIX0oI oix0oi, NativeAdResponse nativeAdResponse) {
        super(context);
        this.f = null;
        this.j = false;
    ...
    public ADPFeedAdView(Context context, NativeAd nativeAd, com.adp.sdk.listener.b bVar) {
        super(context);
        this.f = null;
        this.j = false;
        this.h = nativeAd;
