...
public class ActionBarAppLandscape extends LinearLayout implements c {
        ...
        if (this.cx == null) {
            this.cx = new com.kwad.sdk.core.download.a.a() { // from class: com.kwad.components.ad.reward.widget.actionbar.ActionBarAppLandscape.1
                ...
                public final void onPaused(int i) {
                    ActionBarAppLandscape.this.Bt.e(com.kwad.sdk.core.response.b.a.dn(i), i);
                    ActionBarAppLandscape.this.Bu.setVisibility(8);
                }

                @Override // com.kwad.sdk.api.KsAppDownloadListener
                public final void onProgressUpdate(int i) {
                    ActionBarAppLandscape.this.Bt.e(com.kwad.sdk.core.response.b.a.dm(i), i);
                    ActionBarAppLandscape.this.Bu.setVisibility(8);
                }
            };
        }
    ...
    private void b(View view, final boolean z) {
        com.kwad.components.core.e.d.a.a(new a.C0788a(view.getContext()).ar(this.mAdTemplate).b(this.mApkDownloadHelper).ao(view == this.Bt).an(view == this.Bu ? 1 : 2).a(new a.b() { // from class: com.kwad.components.ad.reward.widget.actionbar.ActionBarAppLandscape.2
            @Override // com.kwad.components.core.e.d.a.b
            public final void onAdClicked() {
                if (ActionBarAppLandscape.this.Bv != null) {
                    ActionBarAppLandscape.this.Bv.N(z);
                }
            }
        }));
    }
