...
public class XGetInfoLoopTest implements IFrameSdu4Tx, IFrameSdu4Rx {
    public int sdkBuild;
    public int sdkMajor;
    public int sdkMinor;
    public int sdkSvn;
