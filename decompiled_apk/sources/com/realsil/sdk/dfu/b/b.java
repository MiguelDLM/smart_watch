...
public class b {
    ...
    public static final ArrayList<BinIndicator> f19530a;
    ...
    static {
        ...
        arrayList.add(new BinIndicator(14, "Factory", null, SubBinId.Bbpro.FACTORY_IAMGE, false, 1));
        ...
        arrayList.add(new BinIndicator(24, "Platform Ext", null, 10145, 517, false, 3, false));
    }

    public static BinIndicator a(int i) {
        Iterator<BinIndicator> it = f19530a.iterator();
        while (it.hasNext()) {
    ...
    public static BinIndicator c(int i) {
        Iterator<BinIndicator> it = f19530a.iterator();
        while (it.hasNext()) {
            BinIndicator next = it.next();
            if (next.imageId == i) {
