    ...
    public boolean f() {
        ...
        while (true) {
            ...
            if (characteristic2 == null) {
                ZLogger.d(this.j, "not found image version characteristic:" + fromShortValue2.toString());
                break;
            }
            ZLogger.d(this.j, "find image version characteristic: " + fromShortValue2.toString());
        ...
        for (int i3 = 65524; i3 <= 65526; i3++) {
            ...
            if (characteristic3 == null) {
                ZLogger.v(this.j, "not found image session size characteristic:" + fromShortValue3.toString());
                return true;
            }
            ZLogger.v(this.j, "find image session size characteristic: " + fromShortValue3.toString());
    ...
    public void g() {
        ...
        for (BluetoothGattCharacteristic bluetoothGattCharacteristic : this.v) {
            ...
            if (shortValue >= 65472 && shortValue <= 65487) {
                ...
                ZLogger.v(this.j, "read image section size :" + a7);
            }
        }
