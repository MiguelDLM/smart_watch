...
public class OkHttpNetWorkImpl<T> implements INetWork<T>, NotConfused {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void succCallBack(Class<T> cls, final String str, final NetWorkCallBack netWorkCallBack) {
        Handler tanxc_for = tanxc_do.tanxc_do().tanxc_for();
        final Object parseObject = JSON.parseObject(str, cls);
        tanxc_for.post(new Runnable() { // from class: com.alimm.tanx.core.net.okhttp.oIX0oI
            @Override // java.lang.Runnable
            public final void run() {
                OkHttpNetWorkImpl.lambda$succCallBack$14(NetWorkCallBack.this, parseObject, str);
            }
        });
    }
    ...
    public void sendHttpDownload(RequestBean requestBean, OnDownloadListener onDownloadListener) {
        try {
            ...
            onDownloadListener.onDownloadFailed(utErrorCode.getIntCode(), utErrorCode.getMsg() + "  " + LogUtils.getStackTraceMessage(e));
        }
    }
    ...
    public void sendHttpGet(RequestBean requestBean, final Class cls, boolean z, final boolean z2, final NetWorkCallBack netWorkCallBack) {
        try {
            ...
            UtErrorCode utErrorCode = UtErrorCode.OK_HTTP_ERROR;
            netWorkCallBack.error(utErrorCode.getIntCode(), "", utErrorCode.getMsg() + "  " + LogUtils.getStackTraceMessage(e));
        }
    }

    @Override // com.alimm.tanx.core.net.INetWork
    public void sendHttpPost(final RequestBean requestBean, final Class<T> cls, final boolean z, final NetWorkCallBack netWorkCallBack) {
        ...
        try {
            ...
            tanxc_do.tanxc_if(false).tanxc_do(requestBean.getUrl()).tanxc_if(getTag(requestBean, netWorkCallBack)).tanxc_do(requestBean.getHeads()).tanxc_if(requestBean.getParams()).tanxc_for(z ? EncryptUtils.encrypt(requestBean.getJson()) : requestBean.getJson()).tanxc_if(requestBean.isOnlyOneNet()).tanxc_do(requestBean.getTryAgainCount()).tanxc_do().tanxc_do(new ResultCall() { // from class: com.alimm.tanx.core.net.okhttp.OkHttpNetWorkImpl.2
                ...
                public void onError(int i, String str) {
                    ...
                    LogUtils.e(OkHttpNetWorkImpl.TAG, str, "OkHttp");
                    TanxBaseUt.utNetError(i, OkHttpNetWorkImpl.TAG, new UtErrorBean(requestBean, i, str), "OkHttp");
                }
