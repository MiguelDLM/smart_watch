...
public class TableScreenPortraitActivity extends Activity implements NotConfused {
    ...
    private void timerCancel() {
        try {
            ...
            this.btnForceClose.post(new Runnable() { // from class: com.alimm.tanx.core.ad.ad.template.rendering.table.screen.oIX0oI
                @Override // java.lang.Runnable
                public final void run() {
                    TableScreenPortraitActivity.this.lambda$timerCancel$6();
                }
            });
