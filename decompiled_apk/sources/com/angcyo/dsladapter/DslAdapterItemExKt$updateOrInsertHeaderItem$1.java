...
public final class DslAdapterItemExKt$updateOrInsertHeaderItem$1 extends Lambda implements Oox.oOoXoXO<List<DslAdapterItem>, oXIO0o0XI> {
    ...
    public DslAdapterItemExKt$updateOrInsertHeaderItem$1(DslAdapter dslAdapter, String str, int i, Oox.oOoXoXO<? super Item, ? extends Item> oooxoxo) {
        super(1);
