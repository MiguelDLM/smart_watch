...
public final class UpdateDataConfigKt$updateSingleData$3 extends Lambda implements oOoXoXO<UpdateDataConfig, oXIO0o0XI> {
    final /* synthetic */ oOoXoXO<UpdateDataConfig, oXIO0o0XI> $action;
    final /* synthetic */ List<Object> $dataList;
    final /* synthetic */ x0xO0oo<Item, Object, oXIO0o0XI> $initItem;
    final /* synthetic */ int $requestPage;
    final /* synthetic */ int $requestPageSize;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public UpdateDataConfigKt$updateSingleData$3(int i, int i2, List<? extends Object> list, oOoXoXO<? super UpdateDataConfig, oXIO0o0XI> oooxoxo, x0xO0oo<? super Item, Object, oXIO0o0XI> x0xo0oo) {
        super(1);
        this.$requestPage = i;
        this.$requestPageSize = i2;
        this.$dataList = list;
        this.$action = oooxoxo;
        this.$initItem = x0xo0oo;
    }
    ...
    public final void invoke2(@OOXIXo UpdateDataConfig updateData) {
        ...
        IIX0o.xoXoI();
        final x0xO0oo<Item, Object, oXIO0o0XI> x0xo0oo = this.$initItem;
        updateData.IXxxXO(new IXxxXO<DslAdapterItem, Object, Integer, DslAdapterItem>() { // from class: com.angcyo.dsladapter.data.UpdateDataConfigKt$updateSingleData$3.1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(3);
            ...
            @OXOo.oOoXoXO
            public final DslAdapterItem invoke(@OXOo.oOoXoXO DslAdapterItem dslAdapterItem, @OXOo.oOoXoXO final Object obj, int i) {
                IIX0o.OxI(4, "Item");
                IIX0o.xoXoI();
                final x0xO0oo<Item, Object, oXIO0o0XI> x0xo0oo2 = x0xo0oo;
                return UpdateDataConfigKt.x0xO0oo(DslAdapterItem.class, dslAdapterItem, new oOoXoXO<Item, oXIO0o0XI>() { // from class: com.angcyo.dsladapter.data.UpdateDataConfigKt.updateSingleData.3.1.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(1);
                    ...
                    public final void invoke(@OOXIXo DslAdapterItem updateOrCreateItemByClass) {
                        ...
                        x0xo0oo2.invoke(updateOrCreateItemByClass, obj);
                    }
                });
            }
        });
