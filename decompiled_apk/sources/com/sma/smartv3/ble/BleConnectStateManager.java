...
public final class BleConnectStateManager {

    /* renamed from: I0Io, reason: collision with root package name */
    public static final long f20308I0Io = 30000;

    /* renamed from: II0xO0, reason: collision with root package name */
    @OOXIXo
    public static final String f20310II0xO0 = "BleConnectStateManager";

    /* renamed from: X0o0xo, reason: collision with root package name */
    public static Application f20312X0o0xo;

    /* renamed from: oxoX, reason: collision with root package name */
    @oOoXoXO
    public static XoI0Ixx0 f20315oxoX;

    /* renamed from: oIX0oI, reason: collision with root package name */
    @OOXIXo
    public static final BleConnectStateManager f20314oIX0oI = new BleConnectStateManager();

    /* renamed from: XO, reason: collision with root package name */
    @OOXIXo
    public static final Handler f20313XO = new Handler();

    /* renamed from: Oxx0IOOO, reason: collision with root package name */
    @OOXIXo
    public static final Runnable f20311Oxx0IOOO = new Runnable() { // from class: com.sma.smartv3.ble.oIX0oI
        @Override // java.lang.Runnable
        public final void run() {
            BleConnectStateManager.Oxx0IOOO();
        }
    };

    /* renamed from: II0XooXoX, reason: collision with root package name */
    @OOXIXo
    public static final oIX0oI f20309II0XooXoX = new oIX0oI();
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onDeviceConnected(@OOXIXo BluetoothDevice device) {
            IIX0o.x0xO0oo(device, "device");
            LogUtils.d("BleConnectStateManager onDeviceConnected -> " + device);
        }

        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onDeviceConnecting(boolean z) {
            LogUtils.d("BleConnectStateManager onDeviceConnecting -> " + z);
            BleConnectStateManager.f20313XO.removeCallbacks(BleConnectStateManager.f20311Oxx0IOOO);
            if (z) {
                LogUtils.d("BleConnectStateManager onDeviceConnecting -> start ConnectTimeoutRunnable");
                BleConnectStateManager.f20313XO.postDelayed(BleConnectStateManager.f20311Oxx0IOOO, 30000L);
            }
        }
        ...
        public void onSessionStateChange(boolean z) {
            LogUtils.d("BleConnectStateManager onSessionStateChange -> " + z);
            if (z) {
                BleConnectStateManager.f20314oIX0oI.X0o0xo();
            }
        }
    ...
    */
    public final void II0XooXoX() {
        /*
            r5 = this;
            com.sma.smartv3.pop.XoI0Ixx0 r0 = com.sma.smartv3.ble.BleConnectStateManager.f20315oxoX
            r1 = 0
            if (r0 == 0) goto Ld
        ...
        Le:
            ...
            r3.<init>()
            java.lang.String r4 = "BleConnectStateManager showConnectTimeoutPopup -> "
            r3.append(r4)
            boolean r4 = com.blankj.utilcode.util.AppUtils.isAppForeground()
            r3.append(r4)
            java.lang.String r4 = ", "
            r3.append(r4)
            r3.append(r2)
        ...
        L3b:
            ...
            if (r0 == 0) goto L7a
            com.sma.smartv3.initializer.BleInitializer r2 = com.sma.smartv3.initializer.BleInitializer.f20700XO     // Catch: java.lang.Exception -> L74
            boolean r2 = r2.OOXIxO0()     // Catch: java.lang.Exception -> L74
            if (r2 == 0) goto L4a
            return
        L4a:
            com.sma.smartv3.model.EvaluationKt.putConnectionTimeoutTime()     // Catch: java.lang.Exception -> L74
            com.sma.smartv3.pop.XoI0Ixx0 r2 = new com.sma.smartv3.pop.XoI0Ixx0     // Catch: java.lang.Exception -> L74
            r3 = 2
            r4 = 0
            r2.<init>(r0, r1, r3, r4)     // Catch: java.lang.Exception -> L74
            r1 = 2132021798(0x7f141226, float:1.9681998E38)
            java.lang.Integer r1 = java.lang.Integer.valueOf(r1)     // Catch: java.lang.Exception -> L74
            r2.xI(r1)     // Catch: java.lang.Exception -> L74
            com.sma.smartv3.pop.XoI0Ixx0.IO(r2, r4, r4, r3, r4)     // Catch: java.lang.Exception -> L74
            com.sma.smartv3.ble.BleConnectStateManager$showConnectTimeoutPopup$1$1$1 r1 = new com.sma.smartv3.ble.BleConnectStateManager$showConnectTimeoutPopup$1$1$1     // Catch: java.lang.Exception -> L74
            r1.<init>()     // Catch: java.lang.Exception -> L74
            r0 = 2132018057(0x7f140389, float:1.967441E38)
            r2.x0o(r0, r1)     // Catch: java.lang.Exception -> L74
            com.sma.smartv3.ble.BleConnectStateManager.f20315oxoX = r2     // Catch: java.lang.Exception -> L74
            r2.IIXOooo()     // Catch: java.lang.Exception -> L74
            kotlin.oXIO0o0XI r0 = kotlin.oXIO0o0XI.f29392oIX0oI     // Catch: java.lang.Exception -> L74
            goto L7a
        L74:
            r0 = move-exception
            r0.printStackTrace()
        ...
        L7a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sma.smartv3.ble.BleConnectStateManager.II0XooXoX():void");
    }

    public final void X0o0xo() {
        XoI0Ixx0 xoI0Ixx0;
        XoI0Ixx0 xoI0Ixx02 = f20315oxoX;
        if (xoI0Ixx02 != null && xoI0Ixx02.isShowing() && (xoI0Ixx0 = f20315oxoX) != null) {
            xoI0Ixx0.dismiss();
        }
    }

    public final void XO(@OOXIXo Application app) {
        IIX0o.x0xO0oo(app, "app");
        LogUtils.d("BleConnectStateManager -> init");
        f20312X0o0xo = app;
        BleConnector.INSTANCE.addHandleCallback(f20309II0XooXoX);
    }
}
