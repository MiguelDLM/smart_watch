...
@XX({"SMAP\nSearchFuncActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 SearchFuncActivity.kt\ncom/sma/smartv3/ui/ai/SearchFuncActivity\n+ 2 TextView.kt\nandroidx/core/widget/TextViewKt\n+ 3 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n+ 4 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n*L\n1#1,308:1\n65#2,16:309\n93#2,3:325\n1855#3,2:328\n1549#3:333\n1620#3,2:334\n1622#3:337\n39#4,3:330\n42#4:336\n44#4,2:338\n31#4,2:340\n*S KotlinDebug\n*F\n+ 1 SearchFuncActivity.kt\ncom/sma/smartv3/ui/ai/SearchFuncActivity\n*L\n74#1:309,16\n74#1:325,3\n175#1:328,2\n187#1:333\n187#1:334,2\n187#1:337\n187#1:330,3\n187#1:336\n187#1:338,2\n269#1:340,2\n*E\n"})
/* loaded from: classes12.dex */
public final class SearchFuncActivity extends BaseDSLRecyclerActivity {
    ...
    @OXOo.OOXIXo
    private final String TAG = "SearchFunc";

    @OXOo.OOXIXo
    private final X0IIOO searchView$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<EditText>() { // from class: com.sma.smartv3.ui.ai.SearchFuncActivity$searchView$2
        {
            super(0);
        }
        ...
        public final EditText invoke() {
            return (EditText) SearchFuncActivity.this.findViewById(R.id.search_view);
        }
    });
    ...
    public static final class I0Io implements TextView.OnEditorActionListener {
        ...
        public boolean onEditorAction(@OXOo.oOoXoXO TextView textView, int i, @OXOo.oOoXoXO KeyEvent keyEvent) {
            ...
            Editable text = SearchFuncActivity.this.getSearchView().getText();
            SearchFuncActivity.this.saveRecords(text.toString());
            SearchFuncActivity.this.editChanged(text);
            return true;
        }
    }

    @XX({"SMAP\nTextView.kt\nKotlin\n*S Kotlin\n*F\n+ 1 TextView.kt\nandroidx/core/widget/TextViewKt$addTextChangedListener$textWatcher$1\n+ 2 SearchFuncActivity.kt\ncom/sma/smartv3/ui/ai/SearchFuncActivity\n+ 3 TextView.kt\nandroidx/core/widget/TextViewKt$addTextChangedListener$1\n+ 4 TextView.kt\nandroidx/core/widget/TextViewKt$addTextChangedListener$2\n*L\n1#1,97:1\n75#2,4:98\n71#3:102\n77#4:103\n*E\n"})
    /* loaded from: classes12.dex */
    public static final class II0xO0 implements TextWatcher {
        ...
        public void afterTextChanged(@OXOo.oOoXoXO Editable editable) {
            if (!SearchFuncActivity.this.isProgrammaticallySet()) {
                SearchFuncActivity.this.editChanged(editable);
            }
        }
    ...
    /* loaded from: classes12.dex */
    public static final class X0o0xo extends ADPAdListener {
        public X0o0xo() {
        }

        public void onAdFailed(@OXOo.OOXIXo ADPAdError error) {
            IIX0o.x0xO0oo(error, "error");
            OI0.oIX0oI.f1507oIX0oI.oIX0oI(SearchFuncActivity.this.TAG + " -> Ad State : Error, Info: " + error.getCode() + ", " + error.getMsg());
        }

        public void onAdLoaded() {
            OI0.oIX0oI.f1507oIX0oI.oIX0oI(SearchFuncActivity.this.TAG + " -> Ad State : Loaded");
        }
    }
    ...
    /* loaded from: classes12.dex */
    public static final class oxoX extends ADPCAdListener {
        public oxoX() {
        }
    ...
    public static /* synthetic */ List initList$default(SearchFuncActivity searchFuncActivity, String str, int i, Object obj) {
        if ((i & 1) != 0) {
            str = "";
        }
        return searchFuncActivity.initList(str);
    }
    ...
    private final void showData(String str) {
        ...
        renderAdapter(new Oox.oOoXoXO<DslAdapter, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.ai.SearchFuncActivity$showData$1
            ...
            public final void invoke2(@OXOo.OOXIXo final DslAdapter renderAdapter) {
                ...
                DslViewHolder dslViewHolder = SearchFuncActivity.this.getDslViewHolder();
                final SearchFuncActivity searchFuncActivity = SearchFuncActivity.this;
                final List<AIFunction> list = initList;
                dslViewHolder.postDelay(100L, new Oox.oIX0oI<oXIO0o0XI>() { // from class: com.sma.smartv3.ui.ai.SearchFuncActivity$showData$1.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }
                    ...
                    public final void invoke2() {
                        ...
                        List list3;
                        List list4;
                        i2 = SearchFuncActivity.this.mAdapterType;
                        switch (i2) {
                            case 253:
                                DslAdapter dslAdapter = renderAdapter;
                                list2 = SearchFuncActivity.this.mRecords;
                                IIX0o.ooOOo0oXI(list2);
                                DslAdapterExKt.x0xO0oo(dslAdapter, new AISearchTopItem(list2), new Oox.oOoXoXO<AISearchTopItem, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.ai.SearchFuncActivity.showData.1.1.1
                                    @Override // Oox.oOoXoXO
                            ...
                            case 254:
                                ...
                                list3 = SearchFuncActivity.this.mRecords;
                                IIX0o.ooOOo0oXI(list3);
                                DslAdapterExKt.x0xO0oo(dslAdapter2, new AISearchTopItem(list3), new Oox.oOoXoXO<AISearchTopItem, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.ai.SearchFuncActivity.showData.1.1.4
                                    @Override // Oox.oOoXoXO
                                    public /* bridge */ /* synthetic */ oXIO0o0XI invoke(AISearchTopItem aISearchTopItem) {
                                        invoke2(aISearchTopItem);
                                        return oXIO0o0XI.f29392oIX0oI;
                                ...
                                final SearchFuncActivity searchFuncActivity2 = SearchFuncActivity.this;
                                for (final AIFunction aIFunction : list5) {
                                    DslAdapterExKt.x0xO0oo(searchFuncActivity2.getDslAdapter(), new SearchAIFunctionItem(), new Oox.oOoXoXO<SearchAIFunctionItem, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.ai.SearchFuncActivity$showData$1$1$5$1
                                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                        {
                                            super(1);
                                        }
                                        ...
                                        public final void invoke2(@OXOo.OOXIXo SearchAIFunctionItem dslItem) {
                                            ...
                                            final SearchFuncActivity searchFuncActivity3 = searchFuncActivity2;
                                            final AIFunction aIFunction2 = AIFunction.this;
                                            dslItem.setItemClick(new Oox.oOoXoXO<View, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.ai.SearchFuncActivity$showData$1$1$5$1.1
                                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                                {
                                                    super(1);
                                                }
                                                ...
                                                public final void invoke2(@OXOo.OOXIXo View it) {
                                                    IIX0o.x0xO0oo(it, "it");
                                                    AIFunctionDataKt.toAIFunction(SearchFuncActivity.this, aIFunction2);
                                                }
                                            });
                                        }
                                    });
                            ...
                            case 255:
                                if (list.isEmpty()) {
                                    ...
                                    list4 = SearchFuncActivity.this.mRecords;
                                    IIX0o.ooOOo0oXI(list4);
                                    DslAdapterExKt.x0xO0oo(dslAdapter3, new AISearchTopItem(list4), new Oox.oOoXoXO<AISearchTopItem, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.ai.SearchFuncActivity.showData.1.1.2
                                        @Override // Oox.oOoXoXO
                                        public /* bridge */ /* synthetic */ oXIO0o0XI invoke(AISearchTopItem aISearchTopItem) {
                                            invoke2(aISearchTopItem);
                                            return oXIO0o0XI.f29392oIX0oI;
                                    ...
                                    final SearchFuncActivity searchFuncActivity3 = SearchFuncActivity.this;
                                    for (final AIFunction aIFunction2 : list6) {
                                        DslAdapterExKt.x0xO0oo(searchFuncActivity3.getDslAdapter(), new SearchAIFillingItem(), new Oox.oOoXoXO<SearchAIFillingItem, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.ai.SearchFuncActivity$showData$1$1$3$1
                                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                            {
                                                super(1);
                                            }
                                            ...
                                            public final void invoke2(@OXOo.OOXIXo final SearchAIFillingItem dslItem) {
                                                IIX0o.x0xO0oo(dslItem, "$this$dslItem");
                                                dslItem.setItemData(AIFunction.this);
                                                final SearchFuncActivity searchFuncActivity4 = searchFuncActivity3;
                                                final AIFunction aIFunction3 = AIFunction.this;
                                                dslItem.setItemClick(new Oox.oOoXoXO<View, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.ai.SearchFuncActivity$showData$1$1$3$1.1
                                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                                    {
                                                        super(1);
                                                    }
                                                    ...
                                                    public final void invoke2(@OXOo.OOXIXo View it) {
                                                        IIX0o.x0xO0oo(it, "it");
                                                        SearchFuncActivity.this.saveRecords(aIFunction3.getTitle());
                                                        SearchAIFillingItem searchAIFillingItem = dslItem;
                                                        final SearchFuncActivity searchFuncActivity5 = SearchFuncActivity.this;
                                                        final AIFunction aIFunction4 = aIFunction3;
                                                        searchAIFillingItem.setItemClick(new Oox.oOoXoXO<View, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.ai.SearchFuncActivity.showData.1.1.3.1.1.1
                                                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                                            {
                                                                super(1);
                                                            }
                                                            ...
                                                            public final void invoke2(@OXOo.OOXIXo View it2) {
                                                                ...
                                                                AIFunctionDataKt.toAIFunction(SearchFuncActivity.this, aIFunction4);
                                                            }
                                                        });
                                                    }
                                                });
                        ...
                        DslAdapter.render$default(renderAdapter, false, null, new Oox.oOoXoXO<DslAdapter, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.ai.SearchFuncActivity.showData.1.1.6
                            @Override // Oox.oOoXoXO
    ...
    public static /* synthetic */ void showData$default(SearchFuncActivity searchFuncActivity, String str, int i, Object obj) {
        if ((i & 1) != 0) {
            str = "";
        }
        searchFuncActivity.showData(str);
    }
    ...
    public void initView() {
        ...
        if (projectManager.IIX0()) {
            ...
            if (aDPCAdContainerView != null) {
                ...
                aDPCAdContainerView.setAdListener(new oxoX());
        ...
        if (projectManager.oXIO0o0XI() && (aDPAdContainerView = (ADPAdContainerView) findViewById(R.id.adpAdContainerView)) != null) {
            ...
            aDPAdContainerView.setAdListener(new X0o0xo());
    ...
    public final void showDeleteTipPopup() {
        if (this.mAllDeleteTipPopup == null) {
            ...
            xoI0Ixx0.X00IoxXI(Integer.valueOf(R.string.cancel), new Oox.oIX0oI<Boolean>() { // from class: com.sma.smartv3.ui.ai.SearchFuncActivity$showDeleteTipPopup$1$1
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // Oox.oIX0oI
                @OXOo.OOXIXo
            ...
            xoI0Ixx0.x0o(R.string.confirm, new Oox.oIX0oI<Boolean>() { // from class: com.sma.smartv3.ui.ai.SearchFuncActivity$showDeleteTipPopup$1$2
                {
                    super(0);
                }
                ...
                public final Boolean invoke() {
                    List list;
                    list = SearchFuncActivity.this.mRecords;
                    List o0Xo0XII = list != null ? CollectionsKt___CollectionsKt.o0Xo0XII(list) : null;
                    if (o0Xo0XII != null) {
                        o0Xo0XII.clear();
                    }
                    SearchFuncActivity.this.mRecords = o0Xo0XII != null ? CollectionsKt___CollectionsKt.oOo0o(o0Xo0XII) : null;
                    ...
                    SearchFuncActivity searchFuncActivity = SearchFuncActivity.this;
                    searchFuncActivity.notifyDataChanged(searchFuncActivity.getSearchView().getText().toString());
                    return Boolean.TRUE;
                }
            });
