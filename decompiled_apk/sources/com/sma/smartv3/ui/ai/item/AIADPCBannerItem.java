...
public final class AIADPCBannerItem extends BaseDslItem {
    ...
    @OOXIXo
    private final String TAG = "AIADPCBannerItem";
    ...
    public static final class oIX0oI extends ADPCAdListener {
        ...
        public void onADClosed() {
            OI0.oIX0oI.f1507oIX0oI.oIX0oI(AIADPCBannerItem.this.TAG + " -> Ad State : Closed");
            AIADPCBannerItem.this.isLoaded = false;
            AIADPCBannerItem.this.initView();
        }

        @Override // com.sma.smartv3.biz.ad.ADPCAdListener
        public void onADError(@OOXIXo ADPCAdError error) {
            IIX0o.x0xO0oo(error, "error");
            OI0.oIX0oI.f1507oIX0oI.oIX0oI(AIADPCBannerItem.this.TAG + " -> Ad State : Error, Info: " + error.getCode() + ", " + error.getMsg());
            AIADPCBannerItem.this.isLoaded = false;
            AIADPCBannerItem.this.isLoading = false;
            AIADPCBannerItem.this.initView();
        }

        @Override // com.sma.smartv3.biz.ad.ADPCAdListener
        public void onADPresent() {
            OI0.oIX0oI.f1507oIX0oI.oIX0oI(AIADPCBannerItem.this.TAG + " -> Ad State : Present");
        }

        @Override // com.sma.smartv3.biz.ad.ADPCAdListener
        public void onADReceive() {
            OI0.oIX0oI.f1507oIX0oI.oIX0oI(AIADPCBannerItem.this.TAG + " -> Ad State : Loaded");
            AIADPCBannerItem.this.isLoaded = true;
            AIADPCBannerItem.this.isLoading = false;
            AIADPCBannerItem.this.initView();
        }
    }
    ...
    public static final void bindView$lambda$2$lambda$0(AIADPCBannerItem this$0, LifecycleOwner source, Lifecycle.Event event) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void bindView$lambda$2$lambda$1(AIADPCBannerItem this$0, ADPCAdContainerView this_apply) {
        IIX0o.x0xO0oo(this$0, "this$0");
    ...
    public void bindView(@OOXIXo DslViewHolder itemHolder) {
        ...
        aDPCAdContainerView.setHostActivityObserver(new LifecycleEventObserver() { // from class: o0oxo0oI.I0Io
            @Override // androidx.lifecycle.LifecycleEventObserver
            public final void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
                AIADPCBannerItem.bindView$lambda$2$lambda$0(AIADPCBannerItem.this, lifecycleOwner, event);
            }
        });
        aDPCAdContainerView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: o0oxo0oI.oxoX
            @Override // android.view.ViewTreeObserver.OnGlobalLayoutListener
            public final void onGlobalLayout() {
                AIADPCBannerItem.bindView$lambda$2$lambda$1(AIADPCBannerItem.this, aDPCAdContainerView);
            }
        });
    }
    ...
    @Override // com.bestmafen.androidbase.dsl.BaseDslItem
    public int layoutId() {
        return R.layout.ai_item_banner_adpc;
    }
