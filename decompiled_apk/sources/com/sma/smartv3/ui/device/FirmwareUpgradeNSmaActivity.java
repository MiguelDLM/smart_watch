...
@kotlin.jvm.internal.XX({"SMAP\nFirmwareUpgradeNSmaActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 FirmwareUpgradeNSmaActivity.kt\ncom/sma/smartv3/ui/device/FirmwareUpgradeNSmaActivity\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n*L\n1#1,342:1\n15#2:343\n15#2:344\n*S KotlinDebug\n*F\n+ 1 FirmwareUpgradeNSmaActivity.kt\ncom/sma/smartv3/ui/device/FirmwareUpgradeNSmaActivity\n*L\n171#1:343\n172#1:344\n*E\n"})
...
public final class FirmwareUpgradeNSmaActivity extends BaseFirmwareUpgradeActivity {
    ...
    @OXOo.OOXIXo
    private final kotlin.X0IIOO mBleScanner$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<XOxIOxOx.II0xO0>() { // from class: com.sma.smartv3.ui.device.FirmwareUpgradeNSmaActivity$mBleScanner$2

        /* loaded from: classes12.dex */
        public static final class oIX0oI implements XOxIOxOx.oxoX {

            /* renamed from: oIX0oI, reason: collision with root package name */
            public final /* synthetic */ FirmwareUpgradeNSmaActivity f21860oIX0oI;

            public oIX0oI(FirmwareUpgradeNSmaActivity firmwareUpgradeNSmaActivity) {
                this.f21860oIX0oI = firmwareUpgradeNSmaActivity;
            }
            ...
            public void II0xO0(@OXOo.OOXIXo BleDevice device) {
                ...
                this.f21860oIX0oI.getMBleScanner().oOoXoXO(false);
                DfuServiceInitiator dfuServiceInitiator = new DfuServiceInitiator(device.getMBluetoothDevice().getAddress());
                FirmwareUpgradeNSmaActivity firmwareUpgradeNSmaActivity = this.f21860oIX0oI;
                ...
                firmwareVersion = firmwareUpgradeNSmaActivity.mLatestFirmware;
                kotlin.jvm.internal.IIX0o.ooOOo0oXI(firmwareVersion);
                dfuServiceInitiator.setZip(new File(oOoXoXO2, firmwareVersion.getFileName()).getAbsolutePath());
                dfuServiceInitiator.start(firmwareUpgradeNSmaActivity, DfuService.class);
            }

            @Override // XOxIOxOx.oxoX
            public void oIX0oI(boolean z) {
                this.f21860oIX0oI.getProgressButton().setEnabled(!z);
            }
        }
        ...
        public final XOxIOxOx.II0xO0 invoke() {
            return XOxIOxOx.oO.II0xO0(XOxIOxOx.oO.f3971oIX0oI, null, null, 3, null).Oo(10).IXxxXO(new XOxIOxOx.I0Io(BleCache.INSTANCE.getMDfuAddress())).ooOOo0oXI(new oIX0oI(FirmwareUpgradeNSmaActivity.this));
        }
    });

    @OXOo.OOXIXo
    private final I0Io mDfuProgressListener = new I0Io();
    ...
    /* loaded from: classes12.dex */
    public static final class I0Io extends DfuProgressListenerAdapter {
        public I0Io() {
        }

        public static final void II0xO0(FirmwareUpgradeNSmaActivity this$0) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
            this$0.upgrade();
        }

        @Override // no.nordicsemi.android.dfu.DfuProgressListenerAdapter, no.nordicsemi.android.dfu.DfuProgressListener
        public void onDfuAborted(@OXOo.OOXIXo String deviceAddress) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(deviceAddress, "deviceAddress");
            FirmwareUpgradeNSmaActivity.this.setMStarted(false);
            ProgressButton.X0o0xo(FirmwareUpgradeNSmaActivity.this.getProgressButton(), R.string.firmware_upgrading_failed, false, 2, null);
            com.sma.smartv3.util.Xo0.f24349oIX0oI.II0xO0().put(com.sma.smartv3.util.XoI0Ixx0.f24419XO, true);
        }

        @Override // no.nordicsemi.android.dfu.DfuProgressListenerAdapter, no.nordicsemi.android.dfu.DfuProgressListener
        public void onDfuCompleted(@OXOo.OOXIXo String deviceAddress) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(deviceAddress, "deviceAddress");
            com.sma.smartv3.util.Xo0.f24349oIX0oI.II0xO0().put(com.sma.smartv3.util.XoI0Ixx0.f24419XO, false);
            if (FirmwareUpgradeNSmaActivity.this.mStepsIndex < CollectionsKt__CollectionsKt.oo0xXOI0I(FirmwareUpgradeNSmaActivity.this.mSteps)) {
                FirmwareUpgradeNSmaActivity.this.getProgressButton().setProgress(0.0f);
                FirmwareUpgradeNSmaActivity.this.mStepsIndex++;
                TextView tvStep = FirmwareUpgradeNSmaActivity.this.getTvStep();
                final FirmwareUpgradeNSmaActivity firmwareUpgradeNSmaActivity = FirmwareUpgradeNSmaActivity.this;
                tvStep.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.device.IIX0
                    @Override // java.lang.Runnable
                    public final void run() {
                        FirmwareUpgradeNSmaActivity.I0Io.II0xO0(FirmwareUpgradeNSmaActivity.this);
                    }
                }, ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS);
                return;
            }
            ToastUtils.showLong(R.string.upgrade_successful);
            FirmwareUpgradeNSmaActivity.this.finish();
        }

        @Override // no.nordicsemi.android.dfu.DfuProgressListenerAdapter, no.nordicsemi.android.dfu.DfuProgressListener
        public void onDfuProcessStarting(@OXOo.OOXIXo String deviceAddress) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(deviceAddress, "deviceAddress");
            ProgressButton.X0o0xo(FirmwareUpgradeNSmaActivity.this.getProgressButton(), R.string.starting, false, 2, null);
        }

        @Override // no.nordicsemi.android.dfu.DfuProgressListenerAdapter, no.nordicsemi.android.dfu.DfuProgressListener
        public void onError(@OXOo.OOXIXo String deviceAddress, int i, int i2, @OXOo.oOoXoXO String str) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(deviceAddress, "deviceAddress");
            FirmwareUpgradeNSmaActivity.this.setMStarted(false);
            ProgressButton.X0o0xo(FirmwareUpgradeNSmaActivity.this.getProgressButton(), R.string.firmware_upgrading_failed, false, 2, null);
            com.sma.smartv3.util.Xo0.f24349oIX0oI.II0xO0().put(com.sma.smartv3.util.XoI0Ixx0.f24419XO, true);
        ...
        @Override // no.nordicsemi.android.dfu.DfuProgressListenerAdapter, no.nordicsemi.android.dfu.DfuProgressListener
        public void onProgressChanged(@OXOo.OOXIXo String deviceAddress, int i, float f, float f2, int i2, int i3) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(deviceAddress, "deviceAddress");
            FirmwareUpgradeNSmaActivity.this.getProgressButton().setProgress(i / 100.0f);
        }
    }
    ...
    public static final class II0xO0 implements BleHandleCallback {
        ...
        public /* synthetic */ class oIX0oI {
            ...
            /* renamed from: oIX0oI, reason: collision with root package name */
            public static final /* synthetic */ int[] f21859oIX0oI;
        ...
        public static final void I0Io(FirmwareUpgradeNSmaActivity this$0) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        ...
        public static final void oxoX(FirmwareUpgradeNSmaActivity this$0) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
            this$0.upgrade();
        }
        ...
        public void onCommandSendTimeout(@OXOo.OOXIXo BleKey bleKey, @OXOo.OOXIXo BleKeyFlag bleKeyFlag) {
            ...
            if (bleKey == BleKey.UI_FILE || bleKey == BleKey.LANGUAGE_FILE) {
                FirmwareUpgradeNSmaActivity.this.setMStarted(false);
                ProgressButton.XO(FirmwareUpgradeNSmaActivity.this.getProgressButton(), com.sma.smartv3.util.oO.f24511oIX0oI.X0o0xo(), false, 2, null);
            }
        }
        ...
        public void onOTA(boolean z) {
            if (z) {
                ...
                FirmwareUpgradeNSmaActivity.this.getMBleScanner().oOoXoXO(true);
            }
        }
        ...
        public void onSessionStateChange(boolean z) {
            if (z) {
                int i = oIX0oI.f21859oIX0oI[((FileType) FirmwareUpgradeNSmaActivity.this.mSteps.get(FirmwareUpgradeNSmaActivity.this.mStepsIndex)).ordinal()];
                if (i != 1) {
                    if (i == 2) {
                        ProgressButton.X0o0xo(FirmwareUpgradeNSmaActivity.this.getProgressButton(), R.string.Parsing, false, 2, null);
                        BleConnector bleConnector = BleConnector.INSTANCE;
                        BleKey bleKey = BleKey.LANGUAGE_FILE;
                        File oOoXoXO2 = com.sma.smartv3.initializer.IXxxXO.oOoXoXO(X00IoxXI.oIX0oI.f3233oIX0oI);
                        FirmwareVersion firmwareVersion = FirmwareUpgradeNSmaActivity.this.mLatestLanguage;
                        kotlin.jvm.internal.IIX0o.ooOOo0oXI(firmwareVersion);
                        BleConnector.sendStream$default(bleConnector, bleKey, new File(oOoXoXO2, firmwareVersion.getFileName()), 0, 4, (Object) null);
                        return;
                    }
                ...
                final FirmwareUpgradeNSmaActivity firmwareUpgradeNSmaActivity = FirmwareUpgradeNSmaActivity.this;
                handler.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.device.oOo
                    @Override // java.lang.Runnable
                    public final void run() {
                        FirmwareUpgradeNSmaActivity.II0xO0.I0Io(FirmwareUpgradeNSmaActivity.this);
                    }
                }, 10000L);
            }
        }
        ...
        public void onStreamProgress(boolean z, int i, int i2, int i3, @OXOo.OOXIXo BleKey bleKey) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(bleKey, "bleKey");
            if (z) {
                FirmwareUpgradeNSmaActivity.this.getProgressButton().setProgressDecimalPlaces(i3 / i2);
                if (i2 == i3) {
                    if (FirmwareUpgradeNSmaActivity.this.mStepsIndex < CollectionsKt__CollectionsKt.oo0xXOI0I(FirmwareUpgradeNSmaActivity.this.mSteps)) {
                        FirmwareUpgradeNSmaActivity.this.getProgressButton().setProgress(0.0f);
                        FirmwareUpgradeNSmaActivity.this.mStepsIndex++;
                        TextView tvStep = FirmwareUpgradeNSmaActivity.this.getTvStep();
                        final FirmwareUpgradeNSmaActivity firmwareUpgradeNSmaActivity = FirmwareUpgradeNSmaActivity.this;
                        tvStep.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.device.O0X
                            @Override // java.lang.Runnable
                            public final void run() {
                                FirmwareUpgradeNSmaActivity.II0xO0.oxoX(FirmwareUpgradeNSmaActivity.this);
                            }
                        }, ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS);
                        return;
                    }
    ...
    public /* synthetic */ class oIX0oI {
        ...
        /* renamed from: oIX0oI, reason: collision with root package name */
        public static final /* synthetic */ int[] f21861oIX0oI;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final XOxIOxOx.II0xO0 getMBleScanner() {
        return (XOxIOxOx.II0xO0) this.mBleScanner$delegate.getValue();
    }
    ...
    public final void upgrade() {
        ...
        int i = oIX0oI.f21861oIX0oI[this.mSteps.get(this.mStepsIndex).ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i == 3) {
                    BleConnector bleConnector = BleConnector.INSTANCE;
                    ...
                    new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.device.oXIO0o0XI
                        @Override // java.lang.Runnable
                        public final void run() {
            ...
            new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.device.XIXIX
                @Override // java.lang.Runnable
                public final void run() {
        ...
        com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.FirmwareUpgradeNSmaActivity$upgrade$1
            @Override // Oox.oOoXoXO
            public /* bridge */ /* synthetic */ kotlin.oXIO0o0XI invoke(BleConnector bleConnector2) {
                invoke2(bleConnector2);
    ...
    public final void onBottomClick(@OXOo.OOXIXo View view) {
        ...
        if (this.mStepsIndex == 0) {
            ...
            if (firmwareVersion != null) {
                NetWorkUtils.INSTANCE.download(firmwareVersion.getFileUrl(), com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(X00IoxXI.oIX0oI.f3233oIX0oI), this.mLatestFirmware.getFileName(), new HttpProgressCallback<String>() { // from class: com.sma.smartv3.ui.device.FirmwareUpgradeNSmaActivity$onBottomClick$1
            ...
            if (firmwareVersion2 != null) {
                NetWorkUtils.INSTANCE.download(firmwareVersion2.getFileUrl(), com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(X00IoxXI.oIX0oI.f3233oIX0oI), this.mLatestUi.getFileName(), new HttpProgressCallback<String>() { // from class: com.sma.smartv3.ui.device.FirmwareUpgradeNSmaActivity$onBottomClick$2
                    @Override // xxxI.II0xO0
                    public void handleError(@OXOo.OOXIXo String error) {
                        kotlin.jvm.internal.IIX0o.x0xO0oo(error, "error");
                        FirmwareUpgradeNSmaActivity.this.mDownloaded = 0;
            ...
            if (firmwareVersion3 != null) {
                NetWorkUtils.INSTANCE.download(firmwareVersion3.getFileUrl(), com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(X00IoxXI.oIX0oI.f3233oIX0oI), this.mLatestLanguage.getFileName(), new HttpProgressCallback<String>() { // from class: com.sma.smartv3.ui.device.FirmwareUpgradeNSmaActivity$onBottomClick$3
                    @Override // xxxI.II0xO0
                    public void handleError(@OXOo.OOXIXo String error) {
                        kotlin.jvm.internal.IIX0o.x0xO0oo(error, "error");
                        FirmwareUpgradeNSmaActivity.this.mDownloaded = 0;
