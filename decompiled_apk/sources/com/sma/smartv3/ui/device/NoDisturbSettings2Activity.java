...
public final class NoDisturbSettings2Activity extends BaseActivity {

    @OXOo.oOoXoXO
    private TimeRangePopup mTimeRangePopup;

    @OXOo.OOXIXo
    private final kotlin.X0IIOO rootView$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<View>() { // from class: com.sma.smartv3.ui.device.NoDisturbSettings2Activity$rootView$2
        {
            super(0);
        }
        ...
        public final View invoke() {
            return NoDisturbSettings2Activity.this.findViewById(R.id.root);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO item_all_header$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AbhSettingsHeader>() { // from class: com.sma.smartv3.ui.device.NoDisturbSettings2Activity$item_all_header$2
        {
            super(0);
        }
        ...
        public final AbhSettingsHeader invoke() {
            return (AbhSettingsHeader) NoDisturbSettings2Activity.this.findViewById(R.id.item_all_header);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO itemHeader$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AbhSettingsHeader>() { // from class: com.sma.smartv3.ui.device.NoDisturbSettings2Activity$itemHeader$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final AbhSettingsHeader invoke() {
            return (AbhSettingsHeader) NoDisturbSettings2Activity.this.findViewById(R.id.item_header);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO itemTimeRange$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AbhSettingsItem>() { // from class: com.sma.smartv3.ui.device.NoDisturbSettings2Activity$itemTimeRange$2
        {
            super(0);
        }
        ...
        public final AbhSettingsItem invoke() {
            return (AbhSettingsItem) NoDisturbSettings2Activity.this.findViewById(R.id.item_time_range);
        }
    });

    @OXOo.OOXIXo
    private BleNoDisturbSettings mNoDisturbSettings = (BleNoDisturbSettings) BleCache.getObjectNotNull$default(BleCache.INSTANCE, BleKey.NO_DISTURB_RANGE, BleNoDisturbSettings.class, null, null, 12, null);
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onNoDisturbUpdate(@OXOo.OOXIXo BleNoDisturbSettings noDisturbSettings) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(noDisturbSettings, "noDisturbSettings");
            NoDisturbSettings2Activity.this.mNoDisturbSettings = noDisturbSettings;
            NoDisturbSettings2Activity.this.updateUI();
        }
    ...
    public final void changeTimeRangeEnable(boolean z) {
        if (!kotlin.jvm.internal.IIX0o.Oxx0IOOO(BleCache.INSTANCE.getMPlatform(), BleDeviceInfo.PLATFORM_SIFLI)) {
            return;
        }
        if (z) {
            getItemHeader().setEnabled(false);
            getItemHeader().getTvTitle().setEnabled(false);
            AbhSettingsHeader itemHeader = getItemHeader();
            kotlin.jvm.internal.IIX0o.oO(itemHeader, "<get-itemHeader>(...)");
            UtilsKt.o0(itemHeader, true);
            getItemTimeRange().setEnabled(false);
            return;
        }
        getItemHeader().setEnabled(true);
        getItemHeader().getTvTitle().setEnabled(true);
        AbhSettingsHeader itemHeader2 = getItemHeader();
        kotlin.jvm.internal.IIX0o.oO(itemHeader2, "<get-itemHeader>(...)");
        UtilsKt.o0(itemHeader2, false);
        getItemTimeRange().setEnabled(true);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final AbhSettingsHeader getItem_all_header() {
        return (AbhSettingsHeader) this.item_all_header$delegate.getValue();
    }
    ...
    public final void updateUI() {
        AbhSettingsHeader item_all_header = getItem_all_header();
        item_all_header.setMListener(null);
        item_all_header.setChecked(oOXoIIIo.I0Io.II0xO0(this.mNoDisturbSettings.getMEnabled()));
        item_all_header.setMListener(new Oox.oOoXoXO<Boolean, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.NoDisturbSettings2Activity$updateUI$1$1
            {
                super(1);
            }
            ...
            public final void invoke(final boolean z) {
                AbhSettingsHeader item_all_header2;
                final NoDisturbSettings2Activity noDisturbSettings2Activity = NoDisturbSettings2Activity.this;
                if (com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.NoDisturbSettings2Activity$updateUI$1$1.1
                    ...
                    public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                        BleNoDisturbSettings bleNoDisturbSettings;
                        BleNoDisturbSettings bleNoDisturbSettings2;
                        kotlin.jvm.internal.IIX0o.x0xO0oo(it, "it");
                        NoDisturbSettings2Activity.this.changeTimeRangeEnable(z);
                        bleNoDisturbSettings = NoDisturbSettings2Activity.this.mNoDisturbSettings;
                        bleNoDisturbSettings.setMEnabled(oOXoIIIo.I0Io.I0Io(z));
                        BleKey bleKey = BleKey.NO_DISTURB_RANGE;
                        BleKeyFlag bleKeyFlag = BleKeyFlag.UPDATE;
                        bleNoDisturbSettings2 = NoDisturbSettings2Activity.this.mNoDisturbSettings;
                        BleConnector.sendObject$default(it, bleKey, bleKeyFlag, bleNoDisturbSettings2, false, false, 24, null);
                        com.sma.smartv3.util.x0xO0oo.II0xO0(com.sma.smartv3.util.x0xO0oo.f24574IXxxXO, null, 2, null);
                    }
                }, 1, null)) {
                    return;
                }
                item_all_header2 = NoDisturbSettings2Activity.this.getItem_all_header();
                item_all_header2.setChecked(!z);
            }
        });
        AbhSettingsHeader itemHeader = getItemHeader();
        itemHeader.setMListener(null);
        itemHeader.setChecked(oOXoIIIo.I0Io.II0xO0(this.mNoDisturbSettings.getMBleTimeRange1().getMEnabled()));
        itemHeader.setMListener(new Oox.oOoXoXO<Boolean, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.NoDisturbSettings2Activity$updateUI$2$1
            {
                super(1);
            }
            ...
            public final void invoke(final boolean z) {
                ...
                final NoDisturbSettings2Activity noDisturbSettings2Activity = NoDisturbSettings2Activity.this;
                if (com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.NoDisturbSettings2Activity$updateUI$2$1.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
                    ...
                    public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                        ...
                        kotlin.jvm.internal.IIX0o.x0xO0oo(it, "it");
                        bleNoDisturbSettings = NoDisturbSettings2Activity.this.mNoDisturbSettings;
                        bleNoDisturbSettings.getMBleTimeRange1().setMEnabled(oOXoIIIo.I0Io.I0Io(z));
                        BleKey bleKey = BleKey.NO_DISTURB_RANGE;
                        BleKeyFlag bleKeyFlag = BleKeyFlag.UPDATE;
                        bleNoDisturbSettings2 = NoDisturbSettings2Activity.this.mNoDisturbSettings;
                        BleConnector.sendObject$default(it, bleKey, bleKeyFlag, bleNoDisturbSettings2, false, false, 24, null);
                ...
                itemHeader2 = NoDisturbSettings2Activity.this.getItemHeader();
                itemHeader2.setChecked(!z);
            }
        });
        getItemTimeRange().setMRightText(TextConvertKt.xoxXI(this.mNoDisturbSettings.getMBleTimeRange1().getMStartHour(), this.mNoDisturbSettings.getMBleTimeRange1().getMStartMinute(), this.mNoDisturbSettings.getMBleTimeRange1().getMEndHour(), this.mNoDisturbSettings.getMBleTimeRange1().getMEndMinute(), ProjectManager.f19822oIX0oI.IO()));
        changeTimeRangeEnable(oOXoIIIo.I0Io.II0xO0(this.mNoDisturbSettings.getMEnabled()));
    }
    ...
    public void initView() {
        ((TextView) findViewById(R.id.abh_title_center)).setText(R.string.do_not_disturb);
        updateUI();
    }

    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_nodisturb_settings2;
    }
    ...
    public final void onSetTimeRange(@OXOo.OOXIXo View view) {
        ...
        if (this.mTimeRangePopup == null) {
            ...
            timeRangePopup.xI(new Oox.Oxx0xo<Integer, Integer, Integer, Integer, Boolean>() { // from class: com.sma.smartv3.ui.device.NoDisturbSettings2Activity$onSetTimeRange$1$1
                {
                    super(4);
                }
                ...
                public final Boolean invoke(final int i, final int i2, final int i3, final int i4) {
                    final NoDisturbSettings2Activity noDisturbSettings2Activity = NoDisturbSettings2Activity.this;
                    return Boolean.valueOf(com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.NoDisturbSettings2Activity$onSetTimeRange$1$1.1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
                        ...
                        public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                            ...
                            kotlin.jvm.internal.IIX0o.x0xO0oo(it, "it");
                            bleNoDisturbSettings = NoDisturbSettings2Activity.this.mNoDisturbSettings;
                            BleTimeRange mBleTimeRange1 = bleNoDisturbSettings.getMBleTimeRange1();
                            int i5 = i;
                            int i6 = i2;
                            int i7 = i3;
                            int i8 = i4;
                            ...
                            bleNoDisturbSettings2 = NoDisturbSettings2Activity.this.mNoDisturbSettings;
                            BleConnector.sendObject$default(it, bleKey, bleKeyFlag, bleNoDisturbSettings2, false, false, 24, null);
                            itemTimeRange = NoDisturbSettings2Activity.this.getItemTimeRange();
        ...
        if (timeRangePopup2 != null) {
            timeRangePopup2.oo0xXOI0I(this.mNoDisturbSettings.getMBleTimeRange1().getMStartHour(), this.mNoDisturbSettings.getMBleTimeRange1().getMStartMinute(), this.mNoDisturbSettings.getMBleTimeRange1().getMEndHour(), this.mNoDisturbSettings.getMBleTimeRange1().getMEndMinute());
