...
@kotlin.jvm.internal.XX({"SMAP\nReceiptCodeActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ReceiptCodeActivity.kt\ncom/sma/smartv3/ui/device/ReceiptCodeActivity\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n+ 3 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,236:1\n50#2,3:237\n53#2:243\n55#2,2:245\n35#2,2:247\n1549#3:240\n1620#3,2:241\n1622#3:244\n*S KotlinDebug\n*F\n+ 1 ReceiptCodeActivity.kt\ncom/sma/smartv3/ui/device/ReceiptCodeActivity\n*L\n94#1:237,3\n94#1:243\n94#1:245,2\n100#1:247,2\n94#1:240\n94#1:241,2\n94#1:244\n*E\n"})
/* loaded from: classes12.dex */
public final class ReceiptCodeActivity extends BaseListActivity<QrcodeTypeInfo> {
    ...
    @OXOo.OOXIXo
    private final kotlin.X0IIOO rootView$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<View>() { // from class: com.sma.smartv3.ui.device.ReceiptCodeActivity$rootView$2
        {
            super(0);
        }
        ...
        public final View invoke() {
            return ReceiptCodeActivity.this.findViewById(R.id.root_view);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO btnBottom$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<View>() { // from class: com.sma.smartv3.ui.device.ReceiptCodeActivity$btnBottom$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final View invoke() {
            return ReceiptCodeActivity.this.findViewById(R.id.btn_bottom);
        }
    });

    @OXOo.OOXIXo
    private final ArrayList<QrcodeTypeInfo> tmps = new ArrayList<>();

    @OXOo.OOXIXo
    private final oIX0oI bleHandleCallback = new oIX0oI();

    @kotlin.jvm.internal.XX({"SMAP\nReceiptCodeActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ReceiptCodeActivity.kt\ncom/sma/smartv3/ui/device/ReceiptCodeActivity$bleHandleCallback$1\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n*L\n1#1,236:1\n35#2,2:237\n35#2,2:239\n*S KotlinDebug\n*F\n+ 1 ReceiptCodeActivity.kt\ncom/sma/smartv3/ui/device/ReceiptCodeActivity$bleHandleCallback$1\n*L\n64#1:237,2\n77#1:239,2\n*E\n"})
    /* loaded from: classes12.dex */
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public void onCommandReply(@OXOo.OOXIXo BleKey bleKey, @OXOo.OOXIXo BleKeyFlag bleKeyFlag, boolean z) {
            ...
            if (bleKey == BleKey.QRCODE2 && bleKeyFlag == BleKeyFlag.DELETE) {
                ReceiptCodeActivity.this.getMList().clear();
                com.sma.smartv3.util.Xo0.f24349oIX0oI.XO().put(com.sma.smartv3.util.XoI0Ixx0.f24484xX0IIXIx0, new Gson().toJson(ReceiptCodeActivity.this.getMList()));
                ReceiptCodeActivity.this.getMListAdapter().notifyDataSetChanged();
                ReceiptCodeActivity.this.checkCount();
                com.sma.smartv3.pop.I0X0x0oIo i0X0x0oIo = ReceiptCodeActivity.this.mLoadingPopup;
                if (i0X0x0oIo != null) {
                    i0X0x0oIo.dismiss();
                }
            }
        ...
        public void onStreamProgress(boolean z, int i, int i2, int i3, @OXOo.OOXIXo BleKey bleKey) {
            ...
            if (i2 == i3) {
                ReceiptCodeActivity.this.getMList().clear();
                ReceiptCodeActivity.this.getMList().addAll(ReceiptCodeActivity.this.tmps);
                com.sma.smartv3.util.Xo0.f24349oIX0oI.XO().put(com.sma.smartv3.util.XoI0Ixx0.f24484xX0IIXIx0, new Gson().toJson(ReceiptCodeActivity.this.getMList()));
                ReceiptCodeActivity.this.getMListAdapter().notifyDataSetChanged();
                ReceiptCodeActivity.this.checkCount();
                com.sma.smartv3.pop.I0X0x0oIo i0X0x0oIo2 = ReceiptCodeActivity.this.mLoadingPopup;
                if (i0X0x0oIo2 != null) {
                    i0X0x0oIo2.dismiss();
                }
            }
    ...
    private final void addQrcode() {
        if (this.mEditPop == null) {
            com.sma.smartv3.pop.IIX0o iIX0o = new com.sma.smartv3.pop.IIX0o(getMContext(), 0, 2, null);
            iIX0o.xXxxox0I().addTextChangedListener(new com.sma.smartv3.util.XO(30));
            iIX0o.xXxxox0I().setTextColor(oIxOXo.oxoX.I0Io(getMContext(), R.color.line_color));
            iIX0o.xII(R.string.title);
            iIX0o.IO(new Oox.oOoXoXO<String, Boolean>() { // from class: com.sma.smartv3.ui.device.ReceiptCodeActivity$addQrcode$1$1
                {
                    super(1);
                }
                ...
                public final Boolean invoke(@OXOo.OOXIXo String text) {
                    ...
                    if (!TextUtils.isEmpty(text)) {
                        ...
                        int oIX0oI2 = AddQrcodeActivity.Companion.oIX0oI();
                        QrcodeTypeInfo qrcodeTypeInfo = new QrcodeTypeInfo(0, 0, 0, text, 0L, 0, null, 119, null);
                        Bundle bundle = new Bundle();
                        bundle.putString("mArg0", null);
                        bundle.putParcelable("mArg2", null);
                        bundle.putSerializable("mArg3", qrcodeTypeInfo);
                        Intent intent = new Intent(receiptCodeActivity, (Class<?>) AddQrcodeActivity.class);
                        intent.putExtras(bundle);
                        receiptCodeActivity.startActivityForResult(intent, oIX0oI2);
                    }
                    return Boolean.TRUE;
                }
            });
    ...
    public final void checkCount() {
        ...
        if (getMList().size() < ProductManager.f20544oIX0oI.XoI0Ixx0()) {
            z = true;
        } else {
            z = false;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$3$lambda$1(ReceiptCodeActivity this$0, IIX0o.II0xO0 iI0xO0) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean initView$lambda$3$lambda$2(final ReceiptCodeActivity this$0, final int i, IIX0o.II0xO0 iI0xO0, int i2) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        return !com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.ReceiptCodeActivity$initView$1$2$1
            ...
            public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                ...
                ReceiptCodeActivity.this.tmps.clear();
                ReceiptCodeActivity.this.tmps.addAll(ReceiptCodeActivity.this.getMList());
                ReceiptCodeActivity.this.tmps.remove(i);
                ReceiptCodeActivity receiptCodeActivity = ReceiptCodeActivity.this;
                receiptCodeActivity.syncQrcode(receiptCodeActivity.tmps);
            }
        }, 1, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$4(final ReceiptCodeActivity this$0) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.ReceiptCodeActivity$initView$2$1
            {
                super(1);
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void syncQrcode(List<QrcodeTypeInfo> list) {
        ...
        try {
            if (!list.isEmpty()) {
                BleConnector.INSTANCE.sendStream(BleKey.QRCODE2, com.sma.smartv3.util.XIo0oOXIx.f24335oIX0oI.II0XooXoX(list), 1);
            } else {
                BleConnector.sendInt8$default(BleConnector.INSTANCE, BleKey.QRCODE2, BleKeyFlag.DELETE, 1, false, false, 24, null);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public List<QrcodeTypeInfo> initList() {
        ...
        try {
            JsonArray asJsonArray = JsonParser.parseString(com.sma.smartv3.util.Xo0.f24349oIX0oI.XO().getString(com.sma.smartv3.util.XoI0Ixx0.f24484xX0IIXIx0)).getAsJsonArray();
            ...
            while (it.hasNext()) {
                ooXIXxIX2.add(new Gson().fromJson(it.next(), QrcodeTypeInfo.class));
            }
        } catch (Exception unused) {
            ooXIXxIX2 = CollectionsKt__CollectionsKt.ooXIXxIX();
        }
        List<QrcodeTypeInfo> o0Xo0XII = CollectionsKt___CollectionsKt.o0Xo0XII(ooXIXxIX2);
        int size = o0Xo0XII.size();
        ProductManager productManager = ProductManager.f20544oIX0oI;
        if (size > productManager.XoI0Ixx0()) {
            List<QrcodeTypeInfo> subList = o0Xo0XII.subList(0, productManager.XoI0Ixx0());
            com.sma.smartv3.util.Xo0.f24349oIX0oI.XO().put(com.sma.smartv3.util.XoI0Ixx0.f24484xX0IIXIx0, new Gson().toJson(subList));
            return subList;
        }
        return o0Xo0XII;
    }
    ...
    public void initView() {
        super.initView();
        ((TextView) findViewById(R.id.abh_title_center)).setText(R.string.receipt_code);
        ...
        swipeMenuListView.setMenuCreator(new IIX0o.I0Io() { // from class: com.sma.smartv3.ui.device.XoOxI0ox
            @Override // IIX0o.I0Io
            public final void oIX0oI(IIX0o.II0xO0 iI0xO0) {
                ReceiptCodeActivity.initView$lambda$3$lambda$1(ReceiptCodeActivity.this, iI0xO0);
            }
        });
        swipeMenuListView.setOnMenuItemClickListener(new SwipeMenuListView.II0xO0() { // from class: com.sma.smartv3.ui.device.X0ooXIooI
            ...
            public final boolean oIX0oI(int i, IIX0o.II0xO0 iI0xO0, int i2) {
                ...
                initView$lambda$3$lambda$2 = ReceiptCodeActivity.initView$lambda$3$lambda$2(ReceiptCodeActivity.this, i, iI0xO0, i2);
                return initView$lambda$3$lambda$2;
            }
        });
        if (!getMList().isEmpty()) {
            getRootView().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.device.oX000x
                @Override // java.lang.Runnable
                public final void run() {
                    ReceiptCodeActivity.initView$lambda$4(ReceiptCodeActivity.this);
                }
            }, 500L);
        }
    }
    ...
    public int itemLayoutId() {
        return R.layout.item_receipt_code;
    }
    ...
    public void onActivityResult(int i, int i2, @OXOo.oOoXoXO final Intent intent) {
        ...
        if (i2 == -1 && i == AddQrcodeActivity.Companion.oIX0oI()) {
            com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.ReceiptCodeActivity$onActivityResult$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                    ...
                    Serializable serializableExtra = intent2 != null ? intent2.getSerializableExtra("qrcode") : null;
                    kotlin.jvm.internal.IIX0o.x0XOIxOo(serializableExtra, "null cannot be cast to non-null type com.sma.smartv3.model.QrcodeTypeInfo");
                    this.tmps.clear();
                    this.tmps.addAll(this.getMList());
                    this.tmps.add((QrcodeTypeInfo) serializableExtra);
                    ReceiptCodeActivity receiptCodeActivity = this;
                    receiptCodeActivity.syncQrcode(receiptCodeActivity.tmps);
                }
            }, 1, null);
        }
    ...
    public void initItem(@OXOo.OOXIXo XIOOI.I0Io holder, @OXOo.OOXIXo QrcodeTypeInfo item, int i) {
        ...
        ((TextView) holder.X0o0xo(R.id.tv_number)).setText(com.sma.smartv3.util.xoIox.oxxXoxO(false, false, 3, null).format(Long.valueOf(item.getDateTime())));
        File file = new File(com.sma.smartv3.initializer.IXxxXO.OI0(X00IoxXI.oIX0oI.f3233oIX0oI), item.getDateTime() + ".jpg");
        if (FileUtils.isFileExists(file)) {
            ((ImageView) holder.X0o0xo(R.id.iv_qrcode)).setImageBitmap(ImageUtils.getBitmap(file));
        }
    }
}
