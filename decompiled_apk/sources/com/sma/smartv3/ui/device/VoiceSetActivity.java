...
@kotlin.jvm.internal.XX({"SMAP\nVoiceSetActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 VoiceSetActivity.kt\ncom/sma/smartv3/ui/device/VoiceSetActivity\n+ 2 NetWorkUtils.kt\ncom/sma/smartv3/network/NetWorkUtils\n+ 3 NetWork.kt\ncom/sma/androidnetworklib/method/NetWork\n*L\n1#1,155:1\n151#2,11:156\n171#2:175\n208#3,7:167\n226#3:174\n*S KotlinDebug\n*F\n+ 1 VoiceSetActivity.kt\ncom/sma/smartv3/ui/device/VoiceSetActivity\n*L\n87#1:156,11\n87#1:175\n87#1:167,7\n87#1:174\n*E\n"})
/* loaded from: classes12.dex */
public final class VoiceSetActivity extends BaseActivity {

    @OXOo.OOXIXo
    private final String TAG = "VoiceSet";

    @OXOo.OOXIXo
    private final kotlin.X0IIOO btnActive$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<Button>() { // from class: com.sma.smartv3.ui.device.VoiceSetActivity$btnActive$2
        {
            super(0);
        }
        ...
        public final Button invoke() {
            return (Button) VoiceSetActivity.this.findViewById(R.id.btn_active);
        }
    });
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public void onIdentityDeleteByDevice(boolean z) {
            VoiceSetActivity.this.dismissLoadPopup();
    ...
    public final void dismissLoadPopup() {
        ...
        if (i0X0x0oIo != null && i0X0x0oIo.isShowing()) {
            runOnUiThread(new Runnable() { // from class: com.sma.smartv3.ui.device.OoIXo
                @Override // java.lang.Runnable
                public final void run() {
                    VoiceSetActivity.dismissLoadPopup$lambda$3(VoiceSetActivity.this);
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void dismissLoadPopup$lambda$3(VoiceSetActivity this$0) {
    ...
    private final void getPayMacAddress() {
        ...
        final xxxI.II0xO0<DeviceState> iI0xO0 = new xxxI.II0xO0<DeviceState>() { // from class: com.sma.smartv3.ui.device.VoiceSetActivity$getPayMacAddress$1
            ...
            public void handleError(@OXOo.OOXIXo String error) {
                ...
                str = VoiceSetActivity.this.TAG;
                sb.append(str);
                sb.append(" getPayMacAddress -> error = ");
                sb.append(error);
            ...
            public void handleResponse(@OXOo.oOoXoXO DeviceState deviceState) {
                ...
                if (deviceState != null) {
                    VoiceSetActivity.this.sendNewAddress(deviceState.getPayAddress());
                }
            }
        };
        ...
        final xxxI.II0xO0<Response<DeviceState>> iI0xO02 = new xxxI.II0xO0<Response<DeviceState>>() { // from class: com.sma.smartv3.ui.device.VoiceSetActivity$getPayMacAddress$$inlined$post$default$1
            @Override // xxxI.II0xO0
            public void handleError(@OXOo.OOXIXo String error) {
                kotlin.jvm.internal.IIX0o.x0xO0oo(error, "error");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$0(VoiceSetActivity this$0, View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        if (this$0.mLoadingPopup == null) {
            this$0.mLoadingPopup = new com.sma.smartv3.pop.I0X0x0oIo(this$0);
        }
        com.sma.smartv3.pop.I0X0x0oIo i0X0x0oIo = this$0.mLoadingPopup;
        if (i0X0x0oIo != null && i0X0x0oIo.isShowing()) {
            return;
    ...
    public final void sendNewAddress(String str) {
        ...
        new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.device.XxIIOXIXx
            @Override // java.lang.Runnable
            public final void run() {
                VoiceSetActivity.sendNewAddress$lambda$2(VoiceSetActivity.this);
            }
        }, ToolTipPopup.DEFAULT_POPUP_DISPLAY_TIME);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void sendNewAddress$lambda$2(final VoiceSetActivity this$0) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        com.sma.smartv3.pop.I0X0x0oIo i0X0x0oIo = this$0.mLoadingPopup;
        if (i0X0x0oIo != null && i0X0x0oIo.isShowing()) {
            ...
            new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.device.xIoXXXIXo
                @Override // java.lang.Runnable
                public final void run() {
                    VoiceSetActivity.sendNewAddress$lambda$2$lambda$1(VoiceSetActivity.this);
                }
            }, 3000L);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void sendNewAddress$lambda$2$lambda$1(VoiceSetActivity this$0) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
    ...
    public void initView() {
        ((TextView) findViewById(R.id.abh_title_center)).setText(ProductManager.f20544oIX0oI.x0OxxIOxX());
        getBtnActive().setOnClickListener(new View.OnClickListener() { // from class: com.sma.smartv3.ui.device.X0xOO
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                VoiceSetActivity.initView$lambda$0(VoiceSetActivity.this, view);
            }
        });
    }
