...
import com.sma.smartv3.ui.device.FirmwareUpgradeGPSActivity;
...
@kotlin.jvm.internal.XX({"SMAP\nFirmwareUpgradeGPSActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 FirmwareUpgradeGPSActivity.kt\ncom/sma/smartv3/ui/device/FirmwareUpgradeGPSActivity\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n*L\n1#1,267:1\n15#2:268\n*S KotlinDebug\n*F\n+ 1 FirmwareUpgradeGPSActivity.kt\ncom/sma/smartv3/ui/device/FirmwareUpgradeGPSActivity\n*L\n101#1:268\n*E\n"})
/* loaded from: classes12.dex */
public final class FirmwareUpgradeGPSActivity extends BaseFirmwareUpgradeActivity {

    @OXOo.OOXIXo
    private final String TAG = "UpgradeGps";
    ...
    public static final class FileType {
        ...
        public static final FileType GPS_FIRMWARE = new FileType("GPS_FIRMWARE", 0);
        public static final FileType AGPS_FILE = new FileType("AGPS_FILE", 1);

        private static final /* synthetic */ FileType[] $values() {
            return new FileType[]{GPS_FIRMWARE, AGPS_FILE};
        }
    ...
    public static final class II0xO0 implements BleHandleCallback {
        ...
        public /* synthetic */ class oIX0oI {
            ...
            public static final /* synthetic */ int[] f21817oIX0oI;

            static {
                int[] iArr = new int[FileType.values().length];
                try {
                    iArr[FileType.AGPS_FILE.ordinal()] = 1;
                } catch (NoSuchFieldError unused) {
                }
                try {
                    iArr[FileType.GPS_FIRMWARE.ordinal()] = 2;
        ...
        public static final void II0xO0(FirmwareUpgradeGPSActivity this$0) {
        ...
        public void onCommandSendTimeout(@OXOo.OOXIXo BleKey bleKey, @OXOo.OOXIXo BleKeyFlag bleKeyFlag) {
            ...
            if (bleKey == BleKey.AGPS_FILE || bleKey == BleKey.GPS_FIRMWARE_VERSION) {
                FirmwareUpgradeGPSActivity.this.setMStarted(false);
                ProgressButton.XO(FirmwareUpgradeGPSActivity.this.getProgressButton(), com.sma.smartv3.util.oO.f24511oIX0oI.X0o0xo(), false, 2, null);
            }
        }
        ...
        public void onSessionStateChange(boolean z) {
            if (z) {
                int i = oIX0oI.f21817oIX0oI[((FileType) FirmwareUpgradeGPSActivity.this.mSteps.get(FirmwareUpgradeGPSActivity.this.mStepsIndex)).ordinal()];
                if (i != 1) {
                    if (i == 2) {
                        OI0.oIX0oI.f1507oIX0oI.oIX0oI(FirmwareUpgradeGPSActivity.this.TAG + " gps_fimware_file");
                        ProgressButton.X0o0xo(FirmwareUpgradeGPSActivity.this.getProgressButton(), R.string.Parsing, false, 2, null);
                        BleConnector bleConnector = BleConnector.INSTANCE;
                        BleKey bleKey = BleKey.GPS_FIRMWARE_FILE;
                        File oOoXoXO2 = com.sma.smartv3.initializer.IXxxXO.oOoXoXO(X00IoxXI.oIX0oI.f3233oIX0oI);
                        FirmwareVersion firmwareVersion = FirmwareUpgradeGPSActivity.this.mLatestGpsFirmware;
                ...
                OI0.oIX0oI.f1507oIX0oI.oIX0oI(FirmwareUpgradeGPSActivity.this.TAG + " agps_file");
                ProgressButton.X0o0xo(FirmwareUpgradeGPSActivity.this.getProgressButton(), R.string.Parsing, false, 2, null);
                BleConnector.sendStream$default(BleConnector.INSTANCE, BleKey.AGPS_FILE, com.sma.smartv3.initializer.IXxxXO.XO(X00IoxXI.oIX0oI.f3233oIX0oI), 0, 4, (Object) null);
            }
        }
        ...
        public void onStreamProgress(boolean z, int i, int i2, int i3, @OXOo.OOXIXo BleKey bleKey) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(bleKey, "bleKey");
            if (z) {
                FirmwareUpgradeGPSActivity.this.getProgressButton().setProgressDecimalPlaces(i3 / i2);
                if (i2 == i3) {
                    if (FirmwareUpgradeGPSActivity.this.mStepsIndex < CollectionsKt__CollectionsKt.oo0xXOI0I(FirmwareUpgradeGPSActivity.this.mSteps)) {
                        FirmwareUpgradeGPSActivity.this.getProgressButton().setProgress(0.0f);
                        FirmwareUpgradeGPSActivity.this.mStepsIndex++;
                        TextView tvStep = FirmwareUpgradeGPSActivity.this.getTvStep();
                        final FirmwareUpgradeGPSActivity firmwareUpgradeGPSActivity = FirmwareUpgradeGPSActivity.this;
                        tvStep.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.device.IoOoo
                            @Override // java.lang.Runnable
                            public final void run() {
                                FirmwareUpgradeGPSActivity.II0xO0.II0xO0(FirmwareUpgradeGPSActivity.this);
                            }
                        }, ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS);
                        return;
                    }
                    FirmwareUpgradeGPSActivity.this.upgradeDone();
                    return;
                }
                return;
            }
    ...
    public /* synthetic */ class oIX0oI {
        ...
        /* renamed from: oIX0oI, reason: collision with root package name */
        public static final /* synthetic */ int[] f21818oIX0oI;

        static {
            int[] iArr = new int[FileType.values().length];
            try {
                iArr[FileType.GPS_FIRMWARE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[FileType.AGPS_FILE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            f21818oIX0oI = iArr;
        }
    ...
    public FirmwareUpgradeGPSActivity() {
        FirmwareVersion firmwareVersion;
        ExtraPackVersions extraPackVersions = (ExtraPackVersions) new Gson().fromJson(com.sma.smartv3.util.Xo0.f24349oIX0oI.II0xO0().getString(ExtraPackVersions.class.getName()), ExtraPackVersions.class);
        ...
        this.mLatestGpsFirmware = firmwareVersion;
        this.mCurrentGps = BleCache.getString$default(BleCache.INSTANCE, BleKey.GPS_FIRMWARE_VERSION, null, null, 6, null);
    ...
    private final Spanned getTip(int i, int i2) {
        ...
        sb.append(kotlin.text.OxI.IIOIX(string, "\n", "<br>", false, 4, null));
        sb.append("</font><br><br>");
        String string2 = getString(i2);
        kotlin.jvm.internal.IIX0o.oO(string2, "getString(...)");
        sb.append(kotlin.text.OxI.IIOIX(string2, "\n", "<br>", false, 4, null));
        Spanned fromHtml = Html.fromHtml(sb.toString());
        kotlin.jvm.internal.IIX0o.oO(fromHtml, "fromHtml(...)");
        return fromHtml;
    }
    ...
    public final void upgrade() {
        ...
        int i = oIX0oI.f21818oIX0oI[this.mSteps.get(this.mStepsIndex).ordinal()];
        if (i != 1) {
            if (i == 2) {
                oix0oi.oIX0oI(this.TAG + " agps_file");
                BleConnector bleConnector = BleConnector.INSTANCE;
                if (bleConnector.isAvailable()) {
                    BleConnector.sendStream$default(bleConnector, BleKey.AGPS_FILE, com.sma.smartv3.initializer.IXxxXO.XO(X00IoxXI.oIX0oI.f3233oIX0oI), 0, 4, (Object) null);
                    return;
                } else {
                    new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.device.xoxXI
                        @Override // java.lang.Runnable
                        public final void run() {
                            FirmwareUpgradeGPSActivity.upgrade$lambda$1();
                        }
                    }, 4000L);
                    return;
                }
        ...
        if (bleConnector2.isAvailable()) {
            BleKey bleKey = BleKey.GPS_FIRMWARE_FILE;
            File oOoXoXO2 = com.sma.smartv3.initializer.IXxxXO.oOoXoXO(X00IoxXI.oIX0oI.f3233oIX0oI);
            FirmwareVersion firmwareVersion = this.mLatestGpsFirmware;
            kotlin.jvm.internal.IIX0o.ooOOo0oXI(firmwareVersion);
            BleConnector.sendStream$default(bleConnector2, bleKey, new File(oOoXoXO2, firmwareVersion.getFileName()), 0, 4, (Object) null);
            return;
        }
        new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.device.I0oOIX
            @Override // java.lang.Runnable
            public final void run() {
                FirmwareUpgradeGPSActivity.upgrade$lambda$0();
            }
        }, 4000L);
    }
    ...
    public void initView() {
        String str;
        super.initView();
        TextView tvTopTip = getTvTopTip();
        if (tvTopTip != null) {
            tvTopTip.setText(R.string.gps_firmware_upgrade_tip_2);
        }
        OI0.oIX0oI oix0oi = OI0.oIX0oI.f1507oIX0oI;
        ...
        if (firmwareVersion == null) {
            getTvLatest().setText(getString(R.string.v_s, String.valueOf(this.mCurrentGps)));
        ...
        this.mSteps.add(FileType.AGPS_FILE);
        getTvStep().setVisibility(0);
        getTvTip().setText(getTip(R.string.gps_firmware_upgrade_tip, R.string.jl_firmware_upgrade_tip));
    }

    @Override // com.sma.smartv3.ui.device.BaseFirmwareUpgradeActivity
    ...
    public final void onBottomClick(@OXOo.OOXIXo View view) {
        ...
        com.sma.smartv3.util.Xo0.f24349oIX0oI.II0xO0().put(com.sma.smartv3.util.XoI0Ixx0.f24409X0o0xo, true);
        this.mDownloaded = 0;
        setMStarted(true);
        ...
        if (this.mStepsIndex == 0) {
            ...
            if (firmwareVersion != null) {
                ...
                kotlin.jvm.internal.IIX0o.ooOOo0oXI(firmwareVersion);
                String fileUrl = firmwareVersion.getFileUrl();
                String ooOOo0oXI2 = com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(X00IoxXI.oIX0oI.f3233oIX0oI);
                FirmwareVersion firmwareVersion2 = this.mLatestGpsFirmware;
                kotlin.jvm.internal.IIX0o.ooOOo0oXI(firmwareVersion2);
                netWorkUtils.download(fileUrl, ooOOo0oXI2, firmwareVersion2.getFileName(), new HttpProgressCallback<String>() { // from class: com.sma.smartv3.ui.device.FirmwareUpgradeGPSActivity$onBottomClick$1
                    @Override // xxxI.II0xO0
                    public void handleError(@OXOo.OOXIXo String error) {
                        kotlin.jvm.internal.IIX0o.x0xO0oo(error, "error");
                        OI0.oIX0oI.f1507oIX0oI.oIX0oI(FirmwareUpgradeGPSActivity.this.TAG + " download gpsfw error -> " + error);
                        FirmwareUpgradeGPSActivity.this.mDownloaded = 0;
                        FirmwareUpgradeGPSActivity.this.setMStarted(false);
                    }
                    ...
                    public void handleResponse(@OXOo.oOoXoXO String str) {
                        int i;
                        FirmwareUpgradeGPSActivity firmwareUpgradeGPSActivity = FirmwareUpgradeGPSActivity.this;
                        i = firmwareUpgradeGPSActivity.mDownloaded;
                        firmwareUpgradeGPSActivity.mDownloaded = i + 1;
                        FirmwareUpgradeGPSActivity.this.checkDownload();
                    }
                });
            }
            NetWorkUtils.INSTANCE.download(BleCache.INSTANCE.getMAGpsFileUrl(), com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(X00IoxXI.oIX0oI.f3233oIX0oI), com.sma.smartv3.initializer.IXxxXO.f20837II0xO0, new HttpProgressCallback<String>() { // from class: com.sma.smartv3.ui.device.FirmwareUpgradeGPSActivity$onBottomClick$2
                @Override // xxxI.II0xO0
                public void handleError(@OXOo.OOXIXo String error) {
                    kotlin.jvm.internal.IIX0o.x0xO0oo(error, "error");
                    OI0.oIX0oI.f1507oIX0oI.oIX0oI(FirmwareUpgradeGPSActivity.this.TAG + " download networkfw error -> " + error);
                    FirmwareUpgradeGPSActivity.this.mDownloaded = 0;
                    FirmwareUpgradeGPSActivity.this.setMStarted(false);
                }
    ...
    public void onDestroy() {
        ...
        if (com.sma.smartv3.util.Xo0.f24349oIX0oI.II0xO0().getBoolean(com.sma.smartv3.util.XoI0Ixx0.f24409X0o0xo, false)) {
            com.sma.smartv3.util.x0xO0oo.II0xO0(com.sma.smartv3.util.XoI0Ixx0.f24409X0o0xo, null, 2, null);
        }
        super.onDestroy();
    }

    public final void upgradeDone() {
        com.sma.smartv3.util.Xo0.f24349oIX0oI.II0xO0().put(com.sma.smartv3.util.XoI0Ixx0.f24409X0o0xo, false);
        BleConnector.sendData$default(BleConnector.INSTANCE, BleKey.GPS_FIRMWARE_VERSION, BleKeyFlag.READ, null, false, false, 28, null);
        com.sma.smartv3.util.x0xO0oo.II0xO0(com.sma.smartv3.util.x0xO0oo.f24664xoO0xx0, null, 2, null);
        finish();
    }
}
