...
@kotlin.jvm.internal.XX({"SMAP\nFirmwareUpgradeGActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 FirmwareUpgradeGActivity.kt\ncom/sma/smartv3/ui/device/FirmwareUpgradeGActivity\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n*L\n1#1,170:1\n15#2:171\n*S KotlinDebug\n*F\n+ 1 FirmwareUpgradeGActivity.kt\ncom/sma/smartv3/ui/device/FirmwareUpgradeGActivity\n*L\n34#1:171\n*E\n"})
/* loaded from: classes12.dex */
public final class FirmwareUpgradeGActivity extends BaseFirmwareUpgradeActivity implements Observer<Object>, EasyDfu.DfuEvent {
    ...
    @OXOo.OOXIXo
    private final kotlin.X0IIOO mActivity$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<FirmwareUpgradeGActivity>() { // from class: com.sma.smartv3.ui.device.FirmwareUpgradeGActivity$mActivity$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        @OXOo.OOXIXo
        public final FirmwareUpgradeGActivity invoke() {
            return FirmwareUpgradeGActivity.this;
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO mDevice$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<BluetoothDevice>() { // from class: com.sma.smartv3.ui.device.FirmwareUpgradeGActivity$mDevice$2
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // Oox.oIX0oI
        public final BluetoothDevice invoke() {
            return BluetoothAdapter.getDefaultAdapter().getRemoteDevice(BleCache.INSTANCE.getMBleAddress());
        }
    });
    ...
    public static final class II0xO0 implements BleHandleCallback {
        ...
        public void onOTA(boolean z) {
            if (z) {
                FirmwareUpgradeGActivity.this.upgrade();
            } else {
                FirmwareUpgradeGActivity.this.setMStarted(false);
                ProgressButton.X0o0xo(FirmwareUpgradeGActivity.this.getProgressButton(), R.string.firmware_upgrading_failed, false, 2, null);
            }
        }
    ...
    public /* synthetic */ class oIX0oI {
        ...
        public static final /* synthetic */ int[] f21814oIX0oI;
    ...
    private final FirmwareUpgradeGActivity getMActivity() {
        return (FirmwareUpgradeGActivity) this.mActivity$delegate.getValue();
    }
    ...
    public final void upgrade() {
        ...
        setMStarted(true);
        getProgressButton().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.device.O0Xx
            @Override // java.lang.Runnable
            public final void run() {
                FirmwareUpgradeGActivity.upgrade$lambda$1(FirmwareUpgradeGActivity.this);
            }
        }, 4000L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void upgrade$lambda$1(FirmwareUpgradeGActivity this$0) {
    ...
    public final void onBottomClick(@OXOo.OOXIXo View view) {
        ...
        netWorkUtils.download(firmwareVersion.getFileUrl(), com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(X00IoxXI.oIX0oI.f3233oIX0oI), this.mLatest.getFileName(), new HttpProgressCallback<String>() { // from class: com.sma.smartv3.ui.device.FirmwareUpgradeGActivity$onBottomClick$1
            ...
            public void handleResponse(@OXOo.oOoXoXO String str) {
                ...
                firmwareVersion2 = FirmwareUpgradeGActivity.this.mLatest;
                File file2 = new File(file, firmwareVersion2.getFileName());
                FirmwareUpgradeGActivity firmwareUpgradeGActivity = FirmwareUpgradeGActivity.this;
                ...
                firmwareUpgradeGActivity.mDfuFiles = arrayList;
                list = FirmwareUpgradeGActivity.this.mDfuFiles;
                if (list == null) {
                ...
                if (list.size() < 2) {
                    ...
                    com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.FirmwareUpgradeGActivity$onBottomClick$1$handleResponse$2
    ...
    public void onChanged(@OXOo.OOXIXo Object connState) {
        ...
        if (connState instanceof DfuConnection.ConnState) {
            int i = oIX0oI.f21814oIX0oI[((DfuConnection.ConnState) connState).ordinal()];
