...
import com.sma.smartv3.ui.device.fragment.AllAppStoreFragment;
import com.sma.smartv3.ui.device.fragment.MyAppStoreFragment;
...
@kotlin.jvm.internal.XX({"SMAP\nAppStoreActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 AppStoreActivity.kt\ncom/sma/smartv3/ui/device/AppStoreActivity\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,398:1\n1549#2:399\n1620#2,3:400\n*S KotlinDebug\n*F\n+ 1 AppStoreActivity.kt\ncom/sma/smartv3/ui/device/AppStoreActivity\n*L\n365#1:399\n365#1:400,3\n*E\n"})
/* loaded from: classes12.dex */
public final class AppStoreActivity extends BaseFragmentPagerActivity {
    public AllAppStoreFragment mAllAppStoreFragment;
    public MyAppStoreFragment mMyAppStoreFragment;

    @OXOo.OOXIXo
    private final String TAG = "AppStoreActivity";

    @OXOo.OOXIXo
    private final kotlin.X0IIOO table$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TabLayout>() { // from class: com.sma.smartv3.ui.device.AppStoreActivity$table$2
        {
            super(0);
        }
        ...
        public final TabLayout invoke() {
            return (TabLayout) AppStoreActivity.this.findViewById(R.id.table);
        }
    });

    @OXOo.OOXIXo
    private final List<AppStoreDataItem> mAppStoreGameItem = new ArrayList();

    @OXOo.OOXIXo
    private final List<AppStoreDataItem> mAppStoreToolItem = new ArrayList();

    @OXOo.OOXIXo
    private final List<AppStoreItemList> mAppStoreItemList = new ArrayList();

    @OXOo.OOXIXo
    private String totalDeviceStorage = "";

    @OXOo.OOXIXo
    private String freeSizeDeviceStorage = "";
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onAppOpUpdate(@OXOo.OOXIXo BleAppOp appOp) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(appOp, "appOp");
            OI0.oIX0oI.f1507oIX0oI.oIX0oI("AppStoreActivity onAppOpUpdate " + appOp);
            if (appOp.getMStatus() == 1) {
                if (AppStoreActivity.this.getMAllAppStoreFragment().isNeedToDownloadFile()) {
                    AppStoreActivity.this.getMAllAppStoreFragment().setNeedToDownloadFile(false);
                    AppStoreActivity.this.getMAllAppStoreFragment().syncProgress(100.0f, 100.0f);
                } else {
                    FileTransmissionKt.changAppStoreCurrentCategory(appOp.getMPackage());
                }
            }
        }
        ...
        public void onCommandReply(@OXOo.OOXIXo BleKey bleKey, @OXOo.OOXIXo BleKeyFlag bleKeyFlag, boolean z) {
            ...
            OI0.oIX0oI.f1507oIX0oI.oIX0oI("AppStoreActivity onCommandReply " + bleKey + TokenParser.SP + bleKeyFlag + org.apache.commons.text.oIX0oI.f33048oxoX + z);
        }
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onReadAppInfoList(@OXOo.OOXIXo BleAppInfoList appInfoList) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(appInfoList, "appInfoList");
            AppStoreActivity.this.checkAppStoreList(appInfoList);
        }
        ...
        public void onReadSDCardInfo(@OXOo.OOXIXo BleSDCardInfo sdCardInfo) {
            ...
            AppStoreActivity.this.watchFreeSpaceToText(sdCardInfo);
        }
        ...
        public void onStreamProgress(boolean z, int i, int i2, int i3, @OXOo.OOXIXo BleKey bleKey) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(bleKey, "bleKey");
            if (i != 0) {
                ToastUtils.showLong(R.string.app_stfore_ailed_to_install);
                AppStoreActivity.this.getMAllAppStoreFragment().syncProgress(0.0f, 0.0f);
            } else if (AppStoreActivity.this.getMAllAppStoreFragment().isSync()) {
                float f = i3;
                float f2 = i2;
                if (((int) ((f / f2) * 100)) < 99 && AppStoreActivity.this.getMAllAppStoreFragment().isNeedToDownloadFile()) {
                    AppStoreActivity.this.getMAllAppStoreFragment().syncProgress(f, f2);
                } else {
                    AppStoreActivity.this.getMAllAppStoreFragment().syncProgress(f, f2);
                }
            }
    ...
    private final int getAppStoreInstallType(BleAppInfo bleAppInfo) {
        AppStoreItemType appStoreItemType;
        if (bleAppInfo == null) {
            return AppStoreItemType.INSTALL.getType();
        }
        if (bleAppInfo.getMHide() == 1) {
            appStoreItemType = AppStoreItemType.INSTALL;
        } else {
            appStoreItemType = AppStoreItemType.INSTALLED;
        }
        return appStoreItemType.getType();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final int getAppStoreItemType(BleAppInfo bleAppInfo, String str) {
        boolean z;
        boolean z2;
        boolean z3;
        boolean z4 = true;
        if (bleAppInfo != null && str != null) {
            String mVersion = bleAppInfo.getMVersion();
            String mApiVersion = bleAppInfo.getMApiVersion();
            if (str.length() == 0 || mVersion.length() == 0 || mApiVersion.length() == 0) {
                ...
                sb.append(z3);
                sb.append(" , ");
                if (mApiVersion.length() != 0) {
                    z4 = false;
                }
                sb.append(z4);
                oix0oi.II0xO0(sb.toString());
                return getAppStoreInstallType(bleAppInfo);
            }
            List<Long> versionToList = versionToList(str);
            List<Long> versionToList2 = versionToList(mVersion);
            List<Long> versionToList3 = versionToList(mApiVersion);
            if (versionToList.size() == 4 && versionToList2.size() == 4 && versionToList3.size() == 4) {
                long versionListToLong = versionListToLong(versionToList);
                long versionListToLong2 = versionListToLong(versionToList2);
                versionListToLong(versionToList3);
                if (versionToList.get(0).longValue() > versionToList3.get(0).longValue()) {
                    return AppStoreItemType.NOT_RENEW.getType();
                }
                if (versionListToLong > versionListToLong2) {
                    return AppStoreItemType.RENEW.getType();
                }
                return getAppStoreInstallType(bleAppInfo);
            }
            return getAppStoreInstallType(bleAppInfo);
    ...
    private final String[] getTiTle() {
        String string = getString(R.string.app_store_all_fg_title);
        kotlin.jvm.internal.IIX0o.oO(string, "getString(...)");
        String string2 = getString(R.string.app_store_my_fg_title);
        kotlin.jvm.internal.IIX0o.oO(string2, "getString(...)");
        return new String[]{string, string2};
    }

    private final long versionListToLong(List<Long> list) {
        return (list.get(0).longValue() << 24) + (list.get(1).longValue() << 16) + (list.get(2).longValue() << 8) + list.get(3).longValue();
    }

    private final List<Long> versionToList(String str) {
    ...
    public final void checkAppStoreList(@OXOo.oOoXoXO final BleAppInfoList bleAppInfoList) {
        if (bleAppInfoList != null) {
            AppStoreFileManager.INSTANCE.getAppStoreFileList("1", new Oox.oOoXoXO<List<? extends AppStoreFileList>, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.AppStoreActivity$checkAppStoreList$1
                ...
                public final void invoke2(@OXOo.oOoXoXO List<AppStoreFileList> list) {
                    String str;
                    int appStoreItemType;
                    int appStoreItemType2;
                    String str2;
                    String appStoreBinOnlinePath;
                    int appStoreItemType3;
                    String appStoreBinOnlinePath2;
                    int appStoreItemType4;
                    String appStoreBinOnlinePath3;
                    String appStoreBinOnlinePath4;
                    if (list != null) {
                        AppStoreActivity.this.getMAppStoreToolItem().clear();
                        AppStoreActivity.this.getMAppStoreGameItem().clear();
                        AppStoreActivity.this.getMAppStoreItemList().clear();
                        if (!list.isEmpty()) {
                            OI0.oIX0oI oix0oi = OI0.oIX0oI.f1507oIX0oI;
                            StringBuilder sb = new StringBuilder();
                            str2 = AppStoreActivity.this.TAG;
                            sb.append(str2);
                            sb.append(" checkAppStoreList it.isNotEmpty()");
                            oix0oi.oIX0oI(sb.toString());
                            BleAppInfoList bleAppInfoList2 = bleAppInfoList;
                            AppStoreActivity appStoreActivity = AppStoreActivity.this;
                            Iterator<T> it = list.iterator();
                            while (it.hasNext()) {
                                AppFileDetail[] appx = ((AppStoreFileList) it.next()).getAppx();
                                if (appx != null) {
                                    for (AppFileDetail appFileDetail : appx) {
                                        List<BleAppInfo> mList = bleAppInfoList2.getMList();
                                        ArrayList arrayList = new ArrayList();
                                        for (Object obj : mList) {
                                            if (kotlin.jvm.internal.IIX0o.Oxx0IOOO(((BleAppInfo) obj).getMPackage(), appFileDetail.getAppPackName())) {
                                                arrayList.add(obj);
                                            }
                                        }
                                        if (arrayList.isEmpty()) {
                                            String appPackName = appFileDetail.getAppPackName();
                                            if (appPackName.length() == 0) {
                                                appPackName = "if-empty";
                                            }
                                            BleAppInfo bleAppInfo = new BleAppInfo(appPackName, null, appFileDetail.getAppName(), (int) (appFileDetail.getAppSize() * 1024), 1, oOXoIIIo.I0Io.I0Io(!kotlin.jvm.internal.IIX0o.Oxx0IOOO(appFileDetail.getAppGroupId(), "app_group:2")), null, 66, null);
                                            if (kotlin.jvm.internal.IIX0o.Oxx0IOOO(appFileDetail.getAppGroupId(), "app_group:2")) {
                                                List<AppStoreDataItem> mAppStoreGameItem = appStoreActivity.getMAppStoreGameItem();
                                                String appPreImg = appFileDetail.getAppPreImg();
                                                boolean appNewFlag = appFileDetail.getAppNewFlag();
                                                appStoreBinOnlinePath4 = appStoreActivity.getAppStoreBinOnlinePath(appFileDetail.getAppPack());
                                                mAppStoreGameItem.add(new AppStoreDataItem(0, bleAppInfo, 0, appPreImg, appStoreBinOnlinePath4, appNewFlag, 0, 69, null));
                                            } else {
                                                List<AppStoreDataItem> mAppStoreToolItem = appStoreActivity.getMAppStoreToolItem();
                                                String appPreImg2 = appFileDetail.getAppPreImg();
                                                boolean appNewFlag2 = appFileDetail.getAppNewFlag();
                                                appStoreBinOnlinePath3 = appStoreActivity.getAppStoreBinOnlinePath(appFileDetail.getAppPack());
                                                mAppStoreToolItem.add(new AppStoreDataItem(0, bleAppInfo, 0, appPreImg2, appStoreBinOnlinePath3, appNewFlag2, 0, 69, null));
                                            }
                                        } else {
                                            BleAppInfo bleAppInfo2 = (BleAppInfo) CollectionsKt___CollectionsKt.O0OOX0IIx(arrayList);
                                            bleAppInfo2.setMName(appFileDetail.getAppName());
                                            if (bleAppInfo2.getMIsGame() == 0) {
                                                List<AppStoreDataItem> mAppStoreGameItem2 = appStoreActivity.getMAppStoreGameItem();
                                                String appPreImg3 = appFileDetail.getAppPreImg();
                                                boolean appNewFlag3 = appFileDetail.getAppNewFlag();
                                                appStoreBinOnlinePath2 = appStoreActivity.getAppStoreBinOnlinePath(appFileDetail.getAppPack());
                                                appStoreItemType4 = appStoreActivity.getAppStoreItemType(bleAppInfo2, appFileDetail.getAppPackVersion());
                                                mAppStoreGameItem2.add(new AppStoreDataItem(0, bleAppInfo2, 0, appPreImg3, appStoreBinOnlinePath2, appNewFlag3, appStoreItemType4, 5, null));
                                            } else {
                                                List<AppStoreDataItem> mAppStoreToolItem2 = appStoreActivity.getMAppStoreToolItem();
                                                String appPreImg4 = appFileDetail.getAppPreImg();
                                                boolean appNewFlag4 = appFileDetail.getAppNewFlag();
                                                appStoreBinOnlinePath = appStoreActivity.getAppStoreBinOnlinePath(appFileDetail.getAppPack());
                                                appStoreItemType3 = appStoreActivity.getAppStoreItemType(bleAppInfo2, appFileDetail.getAppPackVersion());
                                                mAppStoreToolItem2.add(new AppStoreDataItem(0, bleAppInfo2, 0, appPreImg4, appStoreBinOnlinePath, appNewFlag4, appStoreItemType3, 5, null));
                                            }
                                        }
                                    }
                                }
                            ...
                            OI0.oIX0oI oix0oi2 = OI0.oIX0oI.f1507oIX0oI;
                            StringBuilder sb2 = new StringBuilder();
                            str = AppStoreActivity.this.TAG;
                            sb2.append(str);
                            sb2.append(" checkAppStoreList it.isEmpty()");
                            oix0oi2.oIX0oI(sb2.toString());
                            List<BleAppInfo> mList2 = bleAppInfoList.getMList();
                            AppStoreActivity appStoreActivity2 = AppStoreActivity.this;
                            for (BleAppInfo bleAppInfo3 : mList2) {
                                if (oOXoIIIo.I0Io.II0xO0(bleAppInfo3.getMIsGame())) {
                                    List<AppStoreDataItem> mAppStoreToolItem3 = appStoreActivity2.getMAppStoreToolItem();
                                    int appStoreIcon = FileTransmissionKt.getAppStoreIcon(bleAppInfo3.getMPackage());
                                    appStoreItemType = appStoreActivity2.getAppStoreItemType(bleAppInfo3, "");
                                    mAppStoreToolItem3.add(new AppStoreDataItem(0, bleAppInfo3, appStoreIcon, null, null, false, appStoreItemType, 57, null));
                                } else {
                                    List<AppStoreDataItem> mAppStoreGameItem3 = appStoreActivity2.getMAppStoreGameItem();
                                    int appStoreIcon2 = FileTransmissionKt.getAppStoreIcon(bleAppInfo3.getMPackage());
                                    appStoreItemType2 = appStoreActivity2.getAppStoreItemType(bleAppInfo3, "");
                                    mAppStoreGameItem3.add(new AppStoreDataItem(0, bleAppInfo3, appStoreIcon2, null, null, false, appStoreItemType2, 57, null));
                                }
                            }
                        }
                        List<AppStoreItemList> mAppStoreItemList = AppStoreActivity.this.getMAppStoreItemList();
                        String string = AppStoreActivity.this.getString(R.string.app_store_tool);
                        kotlin.jvm.internal.IIX0o.oO(string, "getString(...)");
                        mAppStoreItemList.add(new AppStoreItemList(string, AppStoreActivity.this.getMAppStoreToolItem(), false, 4, null));
                        List<AppStoreItemList> mAppStoreItemList2 = AppStoreActivity.this.getMAppStoreItemList();
                        String string2 = AppStoreActivity.this.getString(R.string.app_store_game);
                        kotlin.jvm.internal.IIX0o.oO(string2, "getString(...)");
                        mAppStoreItemList2.add(new AppStoreItemList(string2, AppStoreActivity.this.getMAppStoreGameItem(), false, 4, null));
                        AppStoreActivity.this.getMAllAppStoreFragment().upData(AppStoreActivity.this.getMAppStoreItemList());
                        AppStoreActivity.this.getMMyAppStoreFragment().upData(AppStoreActivity.this.getMAppStoreItemList());
                    }
                }
            });
        }
    ...
    public final void getAppStoreList() {
        BleConnector.sendData$default(BleConnector.INSTANCE, BleKey.APP_OP, BleKeyFlag.READ, null, false, false, 28, null);
    }

    @OXOo.OOXIXo
    public final String getFreeSizeDeviceStorage() {
        return this.freeSizeDeviceStorage;
    }

    @OXOo.OOXIXo
    public final AllAppStoreFragment getMAllAppStoreFragment() {
        AllAppStoreFragment allAppStoreFragment = this.mAllAppStoreFragment;
        if (allAppStoreFragment != null) {
            return allAppStoreFragment;
        }
        kotlin.jvm.internal.IIX0o.XOxIOxOx("mAllAppStoreFragment");
        return null;
    }

    @OXOo.OOXIXo
    public final List<AppStoreDataItem> getMAppStoreGameItem() {
        return this.mAppStoreGameItem;
    }
    ...
    @OXOo.OOXIXo
    public final List<AppStoreDataItem> getMAppStoreToolItem() {
        return this.mAppStoreToolItem;
    }

    @OXOo.OOXIXo
    public final MyAppStoreFragment getMMyAppStoreFragment() {
        MyAppStoreFragment myAppStoreFragment = this.mMyAppStoreFragment;
        if (myAppStoreFragment != null) {
            return myAppStoreFragment;
        }
        kotlin.jvm.internal.IIX0o.XOxIOxOx("mMyAppStoreFragment");
        return null;
    }
    ...
    @OXOo.OOXIXo
    public final String getTotalDeviceStorage() {
    ...
    public List<Fragment> initFragments() {
        setMAllAppStoreFragment(new AllAppStoreFragment());
        setMMyAppStoreFragment(new MyAppStoreFragment());
        return CollectionsKt__CollectionsKt.X00IoxXI(getMAllAppStoreFragment(), getMMyAppStoreFragment());
    }

    @Override // com.bestmafen.androidbase.viewpager.BaseFragmentPagerActivity, com.bestmafen.androidbase.base.oIX0oI
    public void initView() {
        super.initView();
        ((TextView) findViewById(R.id.abh_title_center)).setText(getString(R.string.item_app_store_title));
        ...
        if (bleSDCardInfo != null && bleSDCardInfo.getMTotalSize() > 0) {
            watchFreeSpaceToText(bleSDCardInfo);
        }
    }
    ...
    public final void setFreeSizeDeviceStorage(@OXOo.OOXIXo String str) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(str, "<set-?>");
        this.freeSizeDeviceStorage = str;
    }

    public final void setMAllAppStoreFragment(@OXOo.OOXIXo AllAppStoreFragment allAppStoreFragment) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(allAppStoreFragment, "<set-?>");
        this.mAllAppStoreFragment = allAppStoreFragment;
    }

    public final void setMMyAppStoreFragment(@OXOo.OOXIXo MyAppStoreFragment myAppStoreFragment) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(myAppStoreFragment, "<set-?>");
        this.mMyAppStoreFragment = myAppStoreFragment;
    }

    public final void setTotalDeviceStorage(@OXOo.OOXIXo String str) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(str, "<set-?>");
        this.totalDeviceStorage = str;
    }

    public final void watchFreeSpaceToText(@OXOo.oOoXoXO BleSDCardInfo bleSDCardInfo) {
        long j;
        long j2;
        long j3;
        double d;
        ...
        StringBuilder sb = new StringBuilder();
        sb.append(ConvertUtils.byte2FitMemorySize((long) (1073741824 * d), 0));
        ...
        sb.append(format);
        this.totalDeviceStorage = sb.toString();
        String byte2FitMemorySize = ConvertUtils.byte2FitMemorySize(j4, 0);
        kotlin.jvm.internal.IIX0o.oO(byte2FitMemorySize, "byte2FitMemorySize(...)");
        this.freeSizeDeviceStorage = byte2FitMemorySize;
    }
}
