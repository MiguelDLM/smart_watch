...
public final class ClassicPairGuide2Fragment extends BaseGuideFragment {
    ...
    @OOXIXo
    private final X0IIOO tvHighTip$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.device.guide.ClassicPairGuide2Fragment$tvHighTip$2
        {
            super(0);
        }
        ...
        public final TextView invoke() {
            View mView;
            mView = ClassicPairGuide2Fragment.this.getMView();
            return (TextView) mView.findViewById(R.id.tv_high_tip);
        }
    });

    @OOXIXo
    private ClassicPairGuide2Fragment$mBluetoothReceiver$1 mBluetoothReceiver = new BroadcastReceiver() { // from class: com.sma.smartv3.ui.device.guide.ClassicPairGuide2Fragment$mBluetoothReceiver$1
        ...
        */
        public void onReceive(@OXOo.oOoXoXO android.content.Context r5, @OXOo.oOoXoXO android.content.Intent r6) {
            /*
                ...
                if (r5 == 0) goto Le7
                com.sma.smartv3.ui.device.guide.ClassicPairGuide2Fragment r0 = com.sma.smartv3.ui.device.guide.ClassicPairGuide2Fragment.this
            ...
            L45:
                ...
                java.lang.String r2 = r2.getMClassicAddress()
            ...
            L59:
                ...
                r2.append(r5)
                int r5 = com.sma.smartv3.ui.device.guide.ClassicPairGuide2Fragment.access$getBondFailedTime$p(r0)
                r2.append(r5)
                ...
                goto Le7
            L8f:
                com.sma.smartv3.pop.I0X0x0oIo r5 = com.sma.smartv3.ui.device.guide.ClassicPairGuide2Fragment.access$getMLoadingPopup$p(r0)
                if (r5 == 0) goto L98
                r5.dismiss()
            L98:
                ...
                r6 = 4
                r5.setVisibility(r6)
                com.sma.smartv3.ui.device.guide.ClassicPairGuide2Fragment.access$doPairDone(r0, r1)
                goto Le7
            La4:
                com.sma.smartv3.pop.I0X0x0oIo r5 = com.sma.smartv3.ui.device.guide.ClassicPairGuide2Fragment.access$getMLoadingPopup$p(r0)
                if (r5 == 0) goto Lad
            ...
            Lad:
                int r5 = com.sma.smartv3.ui.device.guide.ClassicPairGuide2Fragment.access$getBondFailedTime$p(r0)
                int r5 = r5 + r1
                com.sma.smartv3.ui.device.guide.ClassicPairGuide2Fragment.access$setBondFailedTime$p(r0, r5)
                int r5 = com.sma.smartv3.ui.device.guide.ClassicPairGuide2Fragment.access$getBondFailedTime$p(r0)
                int r6 = com.sma.smartv3.ui.device.guide.ClassicPairGuide2Fragment.access$getBOUND_MAX_TIME$p(r0)
                if (r5 < r6) goto Le7
                r5 = 0
                com.sma.smartv3.ui.device.guide.ClassicPairGuide2Fragment.access$doPairDone(r0, r5)
                android.widget.Button r6 = r0.getBtnSet()
                r1 = 2132021286(0x7f141026, float:1.968096E38)
                r6.setText(r1)
                android.widget.TextView r6 = com.sma.smartv3.ui.device.guide.ClassicPairGuide2Fragment.access$getTvHighTip(r0)
                r6.setVisibility(r5)
                goto Le7
            Ld5:
            ...
            Le7:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.sma.smartv3.ui.device.guide.ClassicPairGuide2Fragment$mBluetoothReceiver$1.onReceive(android.content.Context, android.content.Intent):void");
        }
    };
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean initView$lambda$1(ClassicPairGuide2Fragment this$0, View view, int i, KeyEvent keyEvent) {
        I0X0x0oIo i0X0x0oIo;
    ...
    public void init(@oOoXoXO Bundle bundle) {
        ...
        Activity mActivity = getMActivity();
        ClassicPairGuide2Fragment$mBluetoothReceiver$1 classicPairGuide2Fragment$mBluetoothReceiver$1 = this.mBluetoothReceiver;
        IntentFilter intentFilter = new IntentFilter();
        intentFilter.addAction("android.bluetooth.device.action.BOND_STATE_CHANGED");
        intentFilter.addAction("android.bluetooth.device.action.ACL_DISCONNECTED");
        oXIO0o0XI oxio0o0xi = oXIO0o0XI.f29392oIX0oI;
        oix0oi.oIX0oI(mActivity, classicPairGuide2Fragment$mBluetoothReceiver$1, intentFilter, 2);
    }
    ...
    public void initView() {
        ...
        if (ProductManager.f20544oIX0oI.XXIoX0()) {
            if (OI0.oxoX.xoIox()) {
                tip = getString(R.string.guide_classic_pair_new_hos_tip);
            } else {
                tip = getString(R.string.guide_classic_pair_new_tip);
            }
        } else {
            tip = getTip(R.string.guide_classic_pair_tip, R.string.guide_classic_pair_tip_2);
        }
        tvTip.setText(tip);
        ...
        getBtnSet().setOnKeyListener(new View.OnKeyListener() { // from class: com.sma.smartv3.ui.device.guide.oxoX
            @Override // android.view.View.OnKeyListener
            public final boolean onKey(View view, int i, KeyEvent keyEvent) {
                boolean initView$lambda$1;
                initView$lambda$1 = ClassicPairGuide2Fragment.initView$lambda$1(ClassicPairGuide2Fragment.this, view, i, keyEvent);
    ...
    public void onSetClick() {
        ...
        if (this.bondFailedTime >= this.BOUND_MAX_TIME) {
            ...
            AppGuideActivity appGuideActivity = getAppGuideActivity();
            if (appGuideActivity != null) {
                appGuideActivity.setNeedConnectClassic(false);
            }
            getMActivity().finish();
            return;
        }
