...
import com.sma.smartv3.ui.timezonepicker.TimeZoneInfo;
import com.sma.smartv3.ui.timezonepicker.TimeZonePicker;
import com.sma.smartv3.ui.timezonepicker.TimeZoneResult;
import com.sma.smartv3.view.MyDigitalClock;
...
@kotlin.jvm.internal.XX({"SMAP\nWorldClockActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 WorldClockActivity.kt\ncom/sma/smartv3/ui/device/WorldClockActivity\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n+ 3 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,267:1\n1#2:268\n1549#3:269\n1620#3,3:270\n*S KotlinDebug\n*F\n+ 1 WorldClockActivity.kt\ncom/sma/smartv3/ui/device/WorldClockActivity\n*L\n242#1:269\n242#1:270,3\n*E\n"})
/* loaded from: classes12.dex */
public final class WorldClockActivity extends BaseListActivity<BleWorldClock> {
    private BleWorldClock mLocalWorldClock;

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvTip$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.device.WorldClockActivity$tvTip$2
        {
            super(0);
        }
        ...
        public final TextView invoke() {
            return (TextView) WorldClockActivity.this.findViewById(R.id.tv_tip);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO btnBottom$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<View>() { // from class: com.sma.smartv3.ui.device.WorldClockActivity$btnBottom$2
        {
            super(0);
        }
        ...
        public final View invoke() {
            return WorldClockActivity.this.findViewById(R.id.btn_bottom);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO mtvLocalTime$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<MyDigitalClock>() { // from class: com.sma.smartv3.ui.device.WorldClockActivity$mtvLocalTime$2
        {
            super(0);
        }
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // Oox.oIX0oI
        public final MyDigitalClock invoke() {
            return (MyDigitalClock) WorldClockActivity.this.findViewById(R.id.tv_title);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO mtvLocalName$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.device.WorldClockActivity$mtvLocalName$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final TextView invoke() {
            return (TextView) WorldClockActivity.this.findViewById(R.id.tv_name);
        }
    });
    private final int DIFF = 900000;
    private final int MAX = ProductManager.f20544oIX0oI.X0xII0I() - 1;

    @OXOo.OOXIXo
    private final oIX0oI mBleHandleCallback = new oIX0oI();

    @kotlin.jvm.internal.XX({"SMAP\nWorldClockActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 WorldClockActivity.kt\ncom/sma/smartv3/ui/device/WorldClockActivity$mBleHandleCallback$1\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,267:1\n350#2,7:268\n1855#2,2:275\n*S KotlinDebug\n*F\n+ 1 WorldClockActivity.kt\ncom/sma/smartv3/ui/device/WorldClockActivity$mBleHandleCallback$1\n*L\n50#1:268,7\n61#1:275,2\n*E\n"})
    /* loaded from: classes12.dex */
    public static final class oIX0oI implements BleHandleCallback {
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onReadWorldClock(@OXOo.OOXIXo List<BleWorldClock> clocks) {
            BleWorldClock bleWorldClock;
            BleWorldClock bleWorldClock2;
            BleWorldClock bleWorldClock3;
            kotlin.jvm.internal.IIX0o.x0xO0oo(clocks, "clocks");
            WorldClockActivity.this.getMList().clear();
            WorldClockActivity worldClockActivity = WorldClockActivity.this;
            boolean z = false;
            for (BleWorldClock bleWorldClock4 : clocks) {
                if (bleWorldClock4.isLocal() == 1) {
                    z = true;
                } else {
                    worldClockActivity.getMList().add(bleWorldClock4);
                }
            }
            WorldClockActivity worldClockActivity2 = WorldClockActivity.this;
            int offset = TimeZone.getDefault().getOffset(System.currentTimeMillis()) / WorldClockActivity.this.DIFF;
            String string = WorldClockActivity.this.getString(R.string.local_time);
            kotlin.jvm.internal.IIX0o.oO(string, "getString(...)");
            worldClockActivity2.mLocalWorldClock = new BleWorldClock(1, offset, 0, string, 4, null);
            if (z) {
                BleConnector bleConnector = BleConnector.INSTANCE;
                BleKey bleKey = BleKey.WORLD_CLOCK;
                BleKeyFlag bleKeyFlag = BleKeyFlag.UPDATE;
                BleWorldClock bleWorldClock5 = WorldClockActivity.this.mLocalWorldClock;
                if (bleWorldClock5 == null) {
                    kotlin.jvm.internal.IIX0o.XOxIOxOx("mLocalWorldClock");
                    bleWorldClock3 = null;
                } else {
                    bleWorldClock3 = bleWorldClock5;
                }
                BleConnector.sendObject$default(bleConnector, bleKey, bleKeyFlag, bleWorldClock3, false, false, 24, null);
                bleWorldClock2 = null;
            } else {
                BleConnector bleConnector2 = BleConnector.INSTANCE;
                BleKey bleKey2 = BleKey.WORLD_CLOCK;
                BleKeyFlag bleKeyFlag2 = BleKeyFlag.CREATE;
                BleWorldClock bleWorldClock6 = WorldClockActivity.this.mLocalWorldClock;
                if (bleWorldClock6 == null) {
                    kotlin.jvm.internal.IIX0o.XOxIOxOx("mLocalWorldClock");
                    bleWorldClock = null;
                } else {
                    bleWorldClock = bleWorldClock6;
                }
                BleConnector.sendObject$default(bleConnector2, bleKey2, bleKeyFlag2, bleWorldClock, false, false, 24, null);
                int rawoffset = new TimeZoneInfo(WorldClockActivity.this, TimeZone.getTimeZone("Europe/London"), null).getRawoffset() / WorldClockActivity.this.DIFF;
                String string2 = WorldClockActivity.this.getString(R.string.london);
                kotlin.jvm.internal.IIX0o.oO(string2, "getString(...)");
                BleWorldClock bleWorldClock7 = new BleWorldClock(0, rawoffset, 0, string2, 4, null);
                WorldClockActivity worldClockActivity3 = WorldClockActivity.this;
                BleConnector.sendObject$default(bleConnector2, bleKey2, bleKeyFlag2, bleWorldClock7, false, false, 24, null);
                worldClockActivity3.getMList().add(bleWorldClock7);
                bleWorldClock2 = null;
                int rawoffset2 = new TimeZoneInfo(WorldClockActivity.this, TimeZone.getTimeZone("America/New_York"), null).getRawoffset() / WorldClockActivity.this.DIFF;
                String string3 = WorldClockActivity.this.getString(R.string.new_york);
                kotlin.jvm.internal.IIX0o.oO(string3, "getString(...)");
                BleWorldClock bleWorldClock8 = new BleWorldClock(0, rawoffset2, 0, string3, 4, null);
                WorldClockActivity worldClockActivity4 = WorldClockActivity.this;
                BleConnector.sendObject$default(bleConnector2, bleKey2, bleKeyFlag2, bleWorldClock8, false, false, 24, null);
                worldClockActivity4.getMList().add(bleWorldClock8);
            }
            WorldClockActivity worldClockActivity5 = WorldClockActivity.this;
            BleWorldClock bleWorldClock9 = worldClockActivity5.mLocalWorldClock;
            if (bleWorldClock9 == null) {
                kotlin.jvm.internal.IIX0o.XOxIOxOx("mLocalWorldClock");
            } else {
                bleWorldClock2 = bleWorldClock9;
            }
            worldClockActivity5.showLocalTime(bleWorldClock2);
            WorldClockActivity.this.getMListAdapter().notifyDataSetChanged();
            WorldClockActivity.this.checkCount();
        }
        ...
        public void onWorldClockDelete(int i) {
            Iterator it = WorldClockActivity.this.getMList().iterator();
            int i2 = 0;
            while (true) {
                if (it.hasNext()) {
                    if (((BleWorldClock) it.next()).getMId() == i) {
                        break;
                    } else {
                        i2++;
                    }
            ...
            if (i2 > -1 && i2 < WorldClockActivity.this.getMList().size()) {
                WorldClockActivity.this.getMList().remove(i2);
                WorldClockActivity.this.getMListAdapter().notifyDataSetChanged();
            }
            WorldClockActivity.this.checkCount();
        }
    ...
    public final void checkCount() {
        int i = 0;
        getTvTip().setText(getString(R.string.world_clock_max_tip, Integer.valueOf(ProductManager.f20544oIX0oI.X0xII0I())));
        LogUtils.i("checkCount:" + getMList().size());
        View btnBottom = getBtnBottom();
        if (getMList().size() >= 4) {
            i = 8;
        }
        btnBottom.setVisibility(i);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final List<BleWorldClock> getList() {
        Object obj;
        ...
        Iterator<T> it = list$default.iterator();
        while (true) {
            if (it.hasNext()) {
                obj = it.next();
                if (((BleWorldClock) obj).isLocal() == 1) {
                    break;
                }
            } else {
                obj = null;
        ...
        if (bleWorldClock != null) {
            list$default.remove(bleWorldClock);
        }
        int size = list$default.size();
        int i = this.MAX;
        if (size > i) {
            List<BleWorldClock> subList = list$default.subList(0, i);
            BleCache.putList$default(BleCache.INSTANCE, BleKey.WORLD_CLOCK, subList, null, 4, null);
            return subList;
        }
        return list$default;
    }

    private final TextView getMtvLocalName() {
        return (TextView) this.mtvLocalName$delegate.getValue();
    }

    private final MyDigitalClock getMtvLocalTime() {
        return (MyDigitalClock) this.mtvLocalTime$delegate.getValue();
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$3$lambda$1(WorldClockActivity this$0, IIX0o.II0xO0 iI0xO0) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean initView$lambda$3$lambda$2(final WorldClockActivity this$0, final int i, IIX0o.II0xO0 iI0xO0, int i2) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        return !com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.WorldClockActivity$initView$1$2$1
            ...
            public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                ...
                BleConnector.sendInt8$default(it, BleKey.WORLD_CLOCK, BleKeyFlag.DELETE, ((BleWorldClock) WorldClockActivity.this.getMList().remove(i)).getMId(), false, false, 24, null);
                WorldClockActivity.this.getMListAdapter().notifyDataSetChanged();
                WorldClockActivity.this.checkCount();
            }
        }, 1, null);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final BleWorldClock objectToBleObject(TimeZoneResult timeZoneResult) {
        int XO2 = timeZoneResult.XO() / this.DIFF;
        int I0Io2 = oOXoIIIo.I0Io.I0Io(timeZoneResult.II0XooXoX());
        String oIX0oI2 = timeZoneResult.oIX0oI();
        kotlin.jvm.internal.IIX0o.oO(oIX0oI2, "getCityName(...)");
        return new BleWorldClock(I0Io2, XO2, 0, oIX0oI2, 4, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void showLocalTime(BleWorldClock bleWorldClock) {
        getMtvLocalTime().setTextColor(oIxOXo.oxoX.X0o0xo(getMContext(), R.drawable.selector_text_color_white_gray8a));
        Calendar mCalendar = getMtvLocalTime().getMCalendar();
        if (mCalendar != null) {
            mCalendar.setTimeZone(TimeZone.getTimeZone("GMT+0"));
        }
        getMtvLocalTime().setMOffset(bleWorldClock.getMTimeZoneOffset() * this.DIFF);
        getMtvLocalTime().setMFormat(com.sma.smartv3.util.xoIox.f24709oo0xXOI0I);
        TextView mtvLocalName = getMtvLocalName();
        BleWorldClock bleWorldClock2 = this.mLocalWorldClock;
        if (bleWorldClock2 == null) {
            kotlin.jvm.internal.IIX0o.XOxIOxOx("mLocalWorldClock");
            bleWorldClock2 = null;
        }
        mtvLocalName.setText(bleWorldClock2.getMCityName());
    }
    ...
    public void init(@OXOo.oOoXoXO Bundle bundle) {
        ...
        int offset = TimeZone.getDefault().getOffset(System.currentTimeMillis()) / this.DIFF;
        String string = getString(R.string.local_time);
        kotlin.jvm.internal.IIX0o.oO(string, "getString(...)");
        this.mLocalWorldClock = new BleWorldClock(1, offset, 0, string, 4, null);
    ...
    @OXOo.OOXIXo
    public List<BleWorldClock> initList() {
        return getList();
    }
    ...
    public void initView() {
        super.initView();
        ((TextView) findViewById(R.id.abh_title_center)).setText(R.string.world_clock);
        ...
        swipeMenuListView.setMenuCreator(new IIX0o.I0Io() { // from class: com.sma.smartv3.ui.device.O0O0Io00X
            @Override // IIX0o.I0Io
            public final void oIX0oI(IIX0o.II0xO0 iI0xO0) {
                WorldClockActivity.initView$lambda$3$lambda$1(WorldClockActivity.this, iI0xO0);
            }
        });
        swipeMenuListView.setOnMenuItemClickListener(new SwipeMenuListView.II0xO0() { // from class: com.sma.smartv3.ui.device.OIIXOxo
            ...
            public final boolean oIX0oI(int i, IIX0o.II0xO0 iI0xO0, int i2) {
                ...
                initView$lambda$3$lambda$2 = WorldClockActivity.initView$lambda$3$lambda$2(WorldClockActivity.this, i, iI0xO0, i2);
                return initView$lambda$3$lambda$2;
            }
        });
        BleWorldClock bleWorldClock = this.mLocalWorldClock;
        if (bleWorldClock == null) {
            kotlin.jvm.internal.IIX0o.XOxIOxOx("mLocalWorldClock");
            bleWorldClock = null;
        }
        showLocalTime(bleWorldClock);
    }

    @Override // com.bestmafen.androidbase.list.II0xO0
    public int itemLayoutId() {
        return R.layout.item_world_clock;
    }
    ...
    public void onActivityResult(int i, int i2, @OXOo.oOoXoXO final Intent intent) {
        ...
        if (i2 == -1 && i == 992) {
            com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.WorldClockActivity$onActivityResult$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                    List list;
                    BleWorldClock objectToBleObject;
                    kotlin.jvm.internal.IIX0o.x0xO0oo(it, "it");
                    ArrayList<TimeZoneResult> II0xO02 = TimeZonePicker.II0xO0(intent);
                    kotlin.jvm.internal.IIX0o.oO(II0xO02, "obtainResult(...)");
                    WorldClockActivity worldClockActivity = this;
                    for (TimeZoneResult timeZoneResult : II0xO02) {
                        BleConnector bleConnector = BleConnector.INSTANCE;
                        BleKey bleKey = BleKey.WORLD_CLOCK;
                        BleKeyFlag bleKeyFlag = BleKeyFlag.CREATE;
                        kotlin.jvm.internal.IIX0o.ooOOo0oXI(timeZoneResult);
                        objectToBleObject = worldClockActivity.objectToBleObject(timeZoneResult);
                        BleConnector.sendObject$default(bleConnector, bleKey, bleKeyFlag, objectToBleObject, false, false, 24, null);
                    }
                    this.getMList().clear();
                    List mList = this.getMList();
                    list = this.getList();
                    mList.addAll(list);
    ...
    public final void onBottomClick(@OXOo.OOXIXo View view) {
        ...
        TimeZonePicker.Builder loadingType = new TimeZonePicker.Builder(this).hideScrollbar(false).setMaxSelectCount(this.MAX).showTrack(true).searchIconColor(-1).setChoiceMode(1).bubbleTextColor(-1).setTitleText(getString(R.string.add_world_clock)).setLoadingType(1);
        List<BleWorldClock> mList = getMList();
        ArrayList arrayList = new ArrayList(kotlin.collections.OxxIIOOXO.xo0x(mList, 10));
        Iterator<T> it = mList.iterator();
        while (it.hasNext()) {
            arrayList.add(((BleWorldClock) it.next()).getMCityName());
        }
        loadingType.setSelected((List<String>) arrayList).showPickerForResult(992);
    }
    ...
    public void initItem(@OXOo.OOXIXo XIOOI.I0Io holder, @OXOo.OOXIXo BleWorldClock item, int i) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(holder, "holder");
        kotlin.jvm.internal.IIX0o.x0xO0oo(item, "item");
        int mTimeZoneOffset = item.getMTimeZoneOffset() * this.DIFF;
        MyDigitalClock myDigitalClock = (MyDigitalClock) holder.X0o0xo(R.id.tv_title);
        myDigitalClock.setTextColor(oIxOXo.oxoX.X0o0xo(getMContext(), R.drawable.selector_text_color_white_gray8a));
        Calendar mCalendar = myDigitalClock.getMCalendar();
        if (mCalendar != null) {
            mCalendar.setTimeZone(TimeZone.getTimeZone("GMT+0"));
        }
        myDigitalClock.setMOffset(mTimeZoneOffset);
        myDigitalClock.setMFormat("HH:mm");
        ((TextView) holder.X0o0xo(R.id.tv_name)).setText(item.getMCityName());
    }
}
