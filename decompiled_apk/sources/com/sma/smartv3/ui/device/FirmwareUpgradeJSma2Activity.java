...
@kotlin.jvm.internal.XX({"SMAP\nFirmwareUpgradeJSma2Activity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 FirmwareUpgradeJSma2Activity.kt\ncom/sma/smartv3/ui/device/FirmwareUpgradeJSma2Activity\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n*L\n1#1,505:1\n15#2:506\n15#2:507\n*S KotlinDebug\n*F\n+ 1 FirmwareUpgradeJSma2Activity.kt\ncom/sma/smartv3/ui/device/FirmwareUpgradeJSma2Activity\n*L\n150#1:506\n151#1:507\n*E\n"})
/* loaded from: classes12.dex */
public final class FirmwareUpgradeJSma2Activity extends BaseFirmwareUpgradeActivity {
    ...
    public static final class FileType {
        ...
        public static final FileType FIRMWARE2 = new FileType("FIRMWARE2", 1);
        public static final FileType UI_PACK = new FileType("UI_PACK", 2);
        public static final FileType LANGUAGE_PACK = new FileType("LANGUAGE_PACK", 3);

        private static final /* synthetic */ FileType[] $values() {
            return new FileType[]{FIRMWARE, FIRMWARE2, UI_PACK, LANGUAGE_PACK};
        }
    ...
    public static final class I0Io extends BluetoothEventListener {
        ...
        public void onConnection(@OXOo.OOXIXo BluetoothDevice device, int i) {
            ...
            sb.append(FirmwareUpgradeJSma2Activity.this.mOTAStatus);
            sb.append(", ");
            sb.append(device);
            sb.append(" ,status = ");
            sb.append(i);
            sb.append(" ,isOTA = ");
            OTAManager oTAManager = FirmwareUpgradeJSma2Activity.this.mOTAManager;
            if (oTAManager != null) {
            ...
            if (i == 0) {
                ...
                if (FirmwareUpgradeJSma2Activity.this.mOTAStatus == OTAStatus.UPGRADE_PREPARE) {
                    FirmwareUpgradeJSma2Activity.this.updateUpgradeStatus(OTAStatus.UPGRADE_PREPARE_FAILED);
                }
            }
        }
    }
    ...
    public static final class II0xO0 implements BleHandleCallback {
        ...
        public /* synthetic */ class oIX0oI {
            ...
            public static final /* synthetic */ int[] f21830oIX0oI;
        ...
        public static final void I0Io(FirmwareUpgradeJSma2Activity this$0) {
        ...
        public static final void oxoX(FirmwareUpgradeJSma2Activity this$0) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
            this$0.upgrade();
        }
        ...
        public void onCommandSendTimeout(@OXOo.OOXIXo BleKey bleKey, @OXOo.OOXIXo BleKeyFlag bleKeyFlag) {
            ...
            if (bleKey == BleKey.UI_FILE || bleKey == BleKey.LANGUAGE_FILE) {
                FirmwareUpgradeJSma2Activity.this.setMStarted(false);
                ProgressButton.XO(FirmwareUpgradeJSma2Activity.this.getProgressButton(), com.sma.smartv3.util.oO.f24511oIX0oI.X0o0xo(), false, 2, null);
            }
        }
        ...
        public void onSessionStateChange(boolean z) {
            if (z) {
                int i = oIX0oI.f21830oIX0oI[((FileType) FirmwareUpgradeJSma2Activity.this.mSteps.get(FirmwareUpgradeJSma2Activity.this.mStepsIndex)).ordinal()];
                if (i != 1) {
                    if (i == 2) {
                        ProgressButton.X0o0xo(FirmwareUpgradeJSma2Activity.this.getProgressButton(), R.string.Parsing, false, 2, null);
                        BleConnector bleConnector = BleConnector.INSTANCE;
                        BleKey bleKey = BleKey.LANGUAGE_FILE;
                        File oOoXoXO2 = com.sma.smartv3.initializer.IXxxXO.oOoXoXO(X00IoxXI.oIX0oI.f3233oIX0oI);
                        FirmwareVersion firmwareVersion = FirmwareUpgradeJSma2Activity.this.mLatestLanguage;
                        kotlin.jvm.internal.IIX0o.ooOOo0oXI(firmwareVersion);
                        BleConnector.sendStream$default(bleConnector, bleKey, new File(oOoXoXO2, firmwareVersion.getFileName()), 0, 4, (Object) null);
                        return;
                    }
                ...
                final FirmwareUpgradeJSma2Activity firmwareUpgradeJSma2Activity = FirmwareUpgradeJSma2Activity.this;
                handler.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.device.Ioxxx
                    @Override // java.lang.Runnable
                    public final void run() {
                        FirmwareUpgradeJSma2Activity.II0xO0.I0Io(FirmwareUpgradeJSma2Activity.this);
                    }
                }, 10000L);
            }
        }
        ...
        public void onStreamProgress(boolean z, int i, int i2, int i3, @OXOo.OOXIXo BleKey bleKey) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(bleKey, "bleKey");
            if (z) {
                FirmwareUpgradeJSma2Activity.this.getProgressButton().setProgressDecimalPlaces(i3 / i2);
                if (i2 == i3) {
                    if (FirmwareUpgradeJSma2Activity.this.mStepsIndex < CollectionsKt__CollectionsKt.oo0xXOI0I(FirmwareUpgradeJSma2Activity.this.mSteps)) {
                        FirmwareUpgradeJSma2Activity.this.getProgressButton().setProgress(0.0f);
                        FirmwareUpgradeJSma2Activity.this.mStepsIndex++;
                        TextView tvStep = FirmwareUpgradeJSma2Activity.this.getTvStep();
                        final FirmwareUpgradeJSma2Activity firmwareUpgradeJSma2Activity = FirmwareUpgradeJSma2Activity.this;
                        tvStep.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.device.xxIO
                            @Override // java.lang.Runnable
                            public final void run() {
                                FirmwareUpgradeJSma2Activity.II0xO0.oxoX(FirmwareUpgradeJSma2Activity.this);
                            }
                        }, ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS);
                        return;
                    }
                    FirmwareUpgradeJSma2Activity.this.finish();
                    return;
                }
                return;
            }
    ...
    public static final class X0o0xo implements IUpgradeCallback {
        ...
        public static final void II0xO0(FirmwareUpgradeJSma2Activity this$0) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
            this$0.upgrade();
        }
        ...
        public void onCancelOTA() {
            ...
            FirmwareUpgradeJSma2Activity.this.updateUpgradeStatus(OTAStatus.UPGRADE_FAILED);
        }

        @Override // com.jieli.jl_bt_ota.interfaces.IUpgradeCallback
        public void onError(@OXOo.OOXIXo BaseError p0) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(p0, "p0");
            LogUtils.d("onError -> status = " + FirmwareUpgradeJSma2Activity.this.mOTAStatus + ", error = " + p0);
        ...
        public void onNeedReconnect(@OXOo.OOXIXo String p0, boolean z) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(p0, "p0");
            LogUtils.d("onNeedReconnect : " + p0 + ", " + z);
            FirmwareUpgradeJSma2Activity.this.isUseDfuAddress = true;
        }

        @Override // com.jieli.jl_bt_ota.interfaces.IUpgradeCallback
        public void onProgress(int i, float f) {
            if (i == 0) {
                FirmwareUpgradeJSma2Activity.this.mOTAStatus = OTAStatus.UPGRADE_CHECKING;
                ProgressButton progressButton = FirmwareUpgradeJSma2Activity.this.getProgressButton();
                String string = FirmwareUpgradeJSma2Activity.this.getString(R.string.check_file);
                kotlin.jvm.internal.IIX0o.oO(string, "getString(...)");
                progressButton.II0xO0(string, Math.round(f) / 100.0f);
                return;
            }
            FirmwareUpgradeJSma2Activity.this.mOTAStatus = OTAStatus.UPGRADEING;
            FirmwareUpgradeJSma2Activity.this.getProgressButton().setProgress(Math.round(f) / 100.0f);
        }
        ...
        public void onStartOTA() {
            ...
            FirmwareUpgradeJSma2Activity.this.updateUpgradeStatus(OTAStatus.UPGRADE_START);
        }
        ...
        public void onStopOTA() {
            ...
            FirmwareUpgradeJSma2Activity.this.isUseDfuAddress = false;
            FirmwareUpgradeJSma2Activity.this.updateUpgradeStatus(OTAStatus.UPGRADE_STOP);
            FirmwareVersion firmwareVersion = FirmwareUpgradeJSma2Activity.this.mLatestFirmware;
            ...
            if (!TextUtils.isEmpty(str)) {
                if (FirmwareUpgradeJSma2Activity.this.mSteps.get(FirmwareUpgradeJSma2Activity.this.mStepsIndex) == FileType.FIRMWARE2) {
                    com.sma.smartv3.util.Xo0.f24349oIX0oI.II0xO0().put(com.sma.smartv3.util.XoI0Ixx0.f24419XO, false);
                }
            } else {
                com.sma.smartv3.util.Xo0.f24349oIX0oI.II0xO0().put(com.sma.smartv3.util.XoI0Ixx0.f24419XO, false);
            }
            FirmwareUpgradeJSma2Activity.this.getProgressButton().setProgress(1.0f);
            if (FirmwareUpgradeJSma2Activity.this.mStepsIndex < CollectionsKt__CollectionsKt.oo0xXOI0I(FirmwareUpgradeJSma2Activity.this.mSteps)) {
                FirmwareUpgradeJSma2Activity.this.getProgressButton().setProgress(0.0f);
                FirmwareUpgradeJSma2Activity.this.mStepsIndex++;
                TextView tvStep = FirmwareUpgradeJSma2Activity.this.getTvStep();
                final FirmwareUpgradeJSma2Activity firmwareUpgradeJSma2Activity = FirmwareUpgradeJSma2Activity.this;
                tvStep.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.device.XX0xXo
                    @Override // java.lang.Runnable
                    public final void run() {
                        FirmwareUpgradeJSma2Activity.X0o0xo.II0xO0(FirmwareUpgradeJSma2Activity.this);
                    }
                }, 4000L);
                return;
            }
    ...
    public /* synthetic */ class oIX0oI {
        ...
        public static final /* synthetic */ int[] f21832II0xO0;

        /* renamed from: oIX0oI, reason: collision with root package name */
        public static final /* synthetic */ int[] f21833oIX0oI;
        ...
        static {
            ...
            try {
                iArr[FileType.FIRMWARE2.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[FileType.UI_PACK.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                iArr[FileType.LANGUAGE_PACK.ordinal()] = 4;
    ...
    public static final class oxoX extends BtEventCallback {
        ...
        public void onConnection(@OXOo.OOXIXo BluetoothDevice device, int i) {
            ...
            sb.append(bool);
            LogUtils.d(sb.toString());
            OTAManager oTAManager2 = FirmwareUpgradeJSma2Activity.this.mOTAManager;
            kotlin.jvm.internal.IIX0o.ooOOo0oXI(oTAManager2);
            if (!oTAManager2.isOTA()) {
                if (i != 0) {
                    if (i == 1) {
                        FirmwareUpgradeJSma2Activity firmwareUpgradeJSma2Activity = FirmwareUpgradeJSma2Activity.this;
                        if (firmwareUpgradeJSma2Activity.canOTA(firmwareUpgradeJSma2Activity.mOTAStatus)) {
                            if (FirmwareUpgradeJSma2Activity.this.mSteps.get(FirmwareUpgradeJSma2Activity.this.mStepsIndex) == FileType.FIRMWARE2) {
                                FirmwareUpgradeJSma2Activity firmwareUpgradeJSma2Activity2 = FirmwareUpgradeJSma2Activity.this;
                                File oOoXoXO2 = com.sma.smartv3.initializer.IXxxXO.oOoXoXO(X00IoxXI.oIX0oI.f3233oIX0oI);
                                FirmwareVersion firmwareVersion = FirmwareUpgradeJSma2Activity.this.mLatestFirmware;
                                kotlin.jvm.internal.IIX0o.ooOOo0oXI(firmwareVersion);
                                String absolutePath = new File(oOoXoXO2, firmwareVersion.getFileName2()).getAbsolutePath();
                                kotlin.jvm.internal.IIX0o.oO(absolutePath, "getAbsolutePath(...)");
                                firmwareUpgradeJSma2Activity2.startOTA(absolutePath);
                                return;
                            }
                            FirmwareUpgradeJSma2Activity firmwareUpgradeJSma2Activity3 = FirmwareUpgradeJSma2Activity.this;
                            File oOoXoXO3 = com.sma.smartv3.initializer.IXxxXO.oOoXoXO(X00IoxXI.oIX0oI.f3233oIX0oI);
                            FirmwareVersion firmwareVersion2 = FirmwareUpgradeJSma2Activity.this.mLatestFirmware;
                            kotlin.jvm.internal.IIX0o.ooOOo0oXI(firmwareVersion2);
                            String absolutePath2 = new File(oOoXoXO3, firmwareVersion2.getFileName()).getAbsolutePath();
                            kotlin.jvm.internal.IIX0o.oO(absolutePath2, "getAbsolutePath(...)");
                            firmwareUpgradeJSma2Activity3.startOTA(absolutePath2);
                            return;
                        }
                        return;
                    }
    ...
    public FirmwareUpgradeJSma2Activity() {
    ...
    private final boolean isOTAError(OTAStatus oTAStatus) {
        int i = oIX0oI.f21832II0xO0[oTAStatus.ordinal()];
        if (i == 1 || i == 2 || i == 3) {
            return true;
        }
        return false;
    ...
    public final void upgrade() {
        ...
        int i = oIX0oI.f21833oIX0oI[this.mSteps.get(this.mStepsIndex).ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
                    if (i == 4) {
                        ...
                        new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.device.XIo0oOXIx
                            @Override // java.lang.Runnable
                            public final void run() {
                                FirmwareUpgradeJSma2Activity.upgrade$lambda$1();
                            }
                        }, 4000L);
                        return;
                    }
                ...
                new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.device.OO0x0xX
                    @Override // java.lang.Runnable
                    public final void run() {
                        FirmwareUpgradeJSma2Activity.upgrade$lambda$0();
                    }
                }, 4000L);
                return;
            }
        ...
        initOTA();
        if (this.isUseDfuAddress) {
            LogUtils.d("upgrade FIRMWARE -> use dfuAddress");
            connectDevice(BleCache.INSTANCE.getMDfuAddress());
        } else {
            LogUtils.d("upgrade FIRMWARE -> use bleAddress");
            connectDevice(BleCache.INSTANCE.getMBleAddress());
        }
        updateUpgradeStatus(OTAStatus.UPGRADE_PREPARE);
    }
    ...
    public void initView() {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            if (firmwareVersion2 != null) {
                str5 = firmwareVersion2.getVersion();
            }
        } else {
            FirmwareVersion firmwareVersion3 = this.mLatestFirmware;
            if (firmwareVersion3 != null) {
                str5 = firmwareVersion3.getVersion2();
            }
        }
        if (str5 == null) {
            str5 = this.mCurrentFirmware;
        }
        FirmwareVersion firmwareVersion4 = this.mLatestUi;
        if (firmwareVersion4 == null || (str2 = firmwareVersion4.getVersion()) == null) {
            str2 = this.mCurrentUi;
        }
        String IIOIX4 = kotlin.text.OxI.IIOIX(str2, FileUtils.FILE_EXTENSION_SEPARATOR, "", false, 4, null);
        FirmwareVersion firmwareVersion5 = this.mLatestLanguage;
        if (firmwareVersion5 == null || (str3 = firmwareVersion5.getVersion()) == null) {
            str3 = this.mCurrentLanguage;
        }
        String IIOIX5 = kotlin.text.OxI.IIOIX(str3, FileUtils.FILE_EXTENSION_SEPARATOR, "", false, 4, null);
        getTvLatest().setText(getString(R.string.v_s, str5 + '.' + IIOIX4 + IIOIX5));
        ...
        if (this.mLatestFirmware != null) {
            ...
            if (!TextUtils.isEmpty(this.mLatestFirmware.getFileUrl2())) {
                this.mSteps.add(FileType.FIRMWARE2);
            }
        }
    ...
    public final void onBottomClick(@OXOo.OOXIXo View view) {
        ...
        if (this.mStepsIndex == 0) {
            FirmwareVersion firmwareVersion = this.mLatestFirmware;
            if (firmwareVersion != null) {
                if (!TextUtils.isEmpty(firmwareVersion.getFileUrl2())) {
                    NetWorkUtils.INSTANCE.download(this.mLatestFirmware.getFileUrl2(), com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(X00IoxXI.oIX0oI.f3233oIX0oI), this.mLatestFirmware.getFileName2(), new HttpProgressCallback<String>() { // from class: com.sma.smartv3.ui.device.FirmwareUpgradeJSma2Activity$onBottomClick$1
                        @Override // xxxI.II0xO0
                        public void handleError(@OXOo.OOXIXo String error) {
                            kotlin.jvm.internal.IIX0o.x0xO0oo(error, "error");
                            FirmwareUpgradeJSma2Activity.this.mDownloaded = 0;
                            FirmwareUpgradeJSma2Activity.this.setMStarted(false);
                        }
                        ...
                        public void handleResponse(@OXOo.oOoXoXO String str) {
                            int i;
                            FirmwareUpgradeJSma2Activity firmwareUpgradeJSma2Activity = FirmwareUpgradeJSma2Activity.this;
                            i = firmwareUpgradeJSma2Activity.mDownloaded;
                            firmwareUpgradeJSma2Activity.mDownloaded = i + 1;
                            FirmwareUpgradeJSma2Activity.this.checkDownload();
                            FirmwareUpgradeJSma2Activity firmwareUpgradeJSma2Activity2 = FirmwareUpgradeJSma2Activity.this;
                            BaseFirmwareUpgradeActivity.uploadDownloadInfo$default(firmwareUpgradeJSma2Activity2, firmwareUpgradeJSma2Activity2.mLatestFirmware.getFileUrl2(), FirmwareUpgradeJSma2Activity.this.mLatestFirmware.getFileName2(), 0, 4, null);
                        }
                    });
                }
                NetWorkUtils.INSTANCE.download(this.mLatestFirmware.getFileUrl(), com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(X00IoxXI.oIX0oI.f3233oIX0oI), this.mLatestFirmware.getFileName(), new HttpProgressCallback<String>() { // from class: com.sma.smartv3.ui.device.FirmwareUpgradeJSma2Activity$onBottomClick$2
                    @Override // xxxI.II0xO0
                    public void handleError(@OXOo.OOXIXo String error) {
                        kotlin.jvm.internal.IIX0o.x0xO0oo(error, "error");
                        FirmwareUpgradeJSma2Activity.this.mDownloaded = 0;
                    ...
                    public void handleResponse(@OXOo.oOoXoXO String str) {
                        ...
                        FirmwareUpgradeJSma2Activity.this.checkDownload();
                        FirmwareUpgradeJSma2Activity firmwareUpgradeJSma2Activity2 = FirmwareUpgradeJSma2Activity.this;
                        BaseFirmwareUpgradeActivity.uploadDownloadInfo$default(firmwareUpgradeJSma2Activity2, firmwareUpgradeJSma2Activity2.mLatestFirmware.getFileUrl(), FirmwareUpgradeJSma2Activity.this.mLatestFirmware.getFileName(), 0, 4, null);
                    }
                });
            }
            FirmwareVersion firmwareVersion2 = this.mLatestUi;
            if (firmwareVersion2 != null) {
                NetWorkUtils.INSTANCE.download(firmwareVersion2.getFileUrl(), com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(X00IoxXI.oIX0oI.f3233oIX0oI), this.mLatestUi.getFileName(), new HttpProgressCallback<String>() { // from class: com.sma.smartv3.ui.device.FirmwareUpgradeJSma2Activity$onBottomClick$3
                    @Override // xxxI.II0xO0
                    public void handleError(@OXOo.OOXIXo String error) {
                        kotlin.jvm.internal.IIX0o.x0xO0oo(error, "error");
                        FirmwareUpgradeJSma2Activity.this.mDownloaded = 0;
                    ...
                    public void handleResponse(@OXOo.oOoXoXO String str) {
                        ...
                        FirmwareUpgradeJSma2Activity.this.checkDownload();
                        FirmwareUpgradeJSma2Activity firmwareUpgradeJSma2Activity2 = FirmwareUpgradeJSma2Activity.this;
                        BaseFirmwareUpgradeActivity.uploadDownloadInfo$default(firmwareUpgradeJSma2Activity2, firmwareUpgradeJSma2Activity2.mLatestUi.getFileUrl(), FirmwareUpgradeJSma2Activity.this.mLatestUi.getFileName(), 0, 4, null);
                    }
                });
            }
            FirmwareVersion firmwareVersion3 = this.mLatestLanguage;
            if (firmwareVersion3 != null) {
                NetWorkUtils.INSTANCE.download(firmwareVersion3.getFileUrl(), com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(X00IoxXI.oIX0oI.f3233oIX0oI), this.mLatestLanguage.getFileName(), new HttpProgressCallback<String>() { // from class: com.sma.smartv3.ui.device.FirmwareUpgradeJSma2Activity$onBottomClick$4
                    @Override // xxxI.II0xO0
                    public void handleError(@OXOo.OOXIXo String error) {
                        kotlin.jvm.internal.IIX0o.x0xO0oo(error, "error");
                        FirmwareUpgradeJSma2Activity.this.mDownloaded = 0;
                    ...
                    public void handleResponse(@OXOo.oOoXoXO String str) {
                        ...
                        FirmwareUpgradeJSma2Activity.this.checkDownload();
                        FirmwareUpgradeJSma2Activity firmwareUpgradeJSma2Activity2 = FirmwareUpgradeJSma2Activity.this;
                        BaseFirmwareUpgradeActivity.uploadDownloadInfo$default(firmwareUpgradeJSma2Activity2, firmwareUpgradeJSma2Activity2.mLatestLanguage.getFileUrl(), FirmwareUpgradeJSma2Activity.this.mLatestLanguage.getFileName(), 0, 4, null);
                    }
                });
                return;
            }
