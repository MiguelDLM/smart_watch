...
@kotlin.jvm.internal.XX({"SMAP\nMyCardCodeActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 MyCardCodeActivity.kt\ncom/sma/smartv3/ui/device/MyCardCodeActivity\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n+ 3 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,236:1\n50#2,3:237\n53#2:243\n55#2,2:245\n35#2,2:247\n1549#3:240\n1620#3,2:241\n1622#3:244\n*S KotlinDebug\n*F\n+ 1 MyCardCodeActivity.kt\ncom/sma/smartv3/ui/device/MyCardCodeActivity\n*L\n94#1:237,3\n94#1:243\n94#1:245,2\n100#1:247,2\n94#1:240\n94#1:241,2\n94#1:244\n*E\n"})
/* loaded from: classes12.dex */
public final class MyCardCodeActivity extends BaseListActivity<QrcodeTypeInfo> {
    ...
    @OXOo.OOXIXo
    private final kotlin.X0IIOO rootView$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<View>() { // from class: com.sma.smartv3.ui.device.MyCardCodeActivity$rootView$2
        {
            super(0);
        }
        ...
        public final View invoke() {
            return MyCardCodeActivity.this.findViewById(R.id.root_view);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO btnBottom$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<View>() { // from class: com.sma.smartv3.ui.device.MyCardCodeActivity$btnBottom$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final View invoke() {
            return MyCardCodeActivity.this.findViewById(R.id.btn_bottom);
        }
    });
    ...
    @kotlin.jvm.internal.XX({"SMAP\nMyCardCodeActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 MyCardCodeActivity.kt\ncom/sma/smartv3/ui/device/MyCardCodeActivity$bleHandleCallback$1\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n*L\n1#1,236:1\n35#2,2:237\n35#2,2:239\n*S KotlinDebug\n*F\n+ 1 MyCardCodeActivity.kt\ncom/sma/smartv3/ui/device/MyCardCodeActivity$bleHandleCallback$1\n*L\n64#1:237,2\n77#1:239,2\n*E\n"})
    /* loaded from: classes12.dex */
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public void onCommandReply(@OXOo.OOXIXo BleKey bleKey, @OXOo.OOXIXo BleKeyFlag bleKeyFlag, boolean z) {
            ...
            if (bleKey == BleKey.QRCODE2 && bleKeyFlag == BleKeyFlag.DELETE) {
                MyCardCodeActivity.this.getMList().clear();
                com.sma.smartv3.util.Xo0.f24349oIX0oI.XO().put(com.sma.smartv3.util.XoI0Ixx0.f24395OX00O0xII, new Gson().toJson(MyCardCodeActivity.this.getMList()));
                MyCardCodeActivity.this.getMListAdapter().notifyDataSetChanged();
                MyCardCodeActivity.this.checkCount();
                com.sma.smartv3.pop.I0X0x0oIo i0X0x0oIo = MyCardCodeActivity.this.mLoadingPopup;
                if (i0X0x0oIo != null) {
                    i0X0x0oIo.dismiss();
                }
            }
        ...
        public void onStreamProgress(boolean z, int i, int i2, int i3, @OXOo.OOXIXo BleKey bleKey) {
            ...
            if (i2 == i3) {
                MyCardCodeActivity.this.getMList().clear();
                MyCardCodeActivity.this.getMList().addAll(MyCardCodeActivity.this.tmps);
                com.sma.smartv3.util.Xo0.f24349oIX0oI.XO().put(com.sma.smartv3.util.XoI0Ixx0.f24395OX00O0xII, new Gson().toJson(MyCardCodeActivity.this.getMList()));
                MyCardCodeActivity.this.getMListAdapter().notifyDataSetChanged();
                MyCardCodeActivity.this.checkCount();
                com.sma.smartv3.pop.I0X0x0oIo i0X0x0oIo2 = MyCardCodeActivity.this.mLoadingPopup;
                if (i0X0x0oIo2 != null) {
                    i0X0x0oIo2.dismiss();
                }
            }
    ...
    private final void addQrcode() {
        if (this.mEditPop == null) {
            ...
            iIX0o.IO(new Oox.oOoXoXO<String, Boolean>() { // from class: com.sma.smartv3.ui.device.MyCardCodeActivity$addQrcode$1$1
                {
                    super(1);
                }
                ...
                public final Boolean invoke(@OXOo.OOXIXo String text) {
                    ...
                    if (!TextUtils.isEmpty(text)) {
                        ...
                        Intent intent = new Intent(myCardCodeActivity, (Class<?>) AddQrcodeActivity.class);
                        intent.putExtras(bundle);
                        myCardCodeActivity.startActivityForResult(intent, oIX0oI2);
                    }
                    return Boolean.TRUE;
                }
            });
    ...
    public final void checkCount() {
        ...
        if (getMList().size() < ProductManager.f20544oIX0oI.XX0()) {
            z = true;
        } else {
            z = false;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$3$lambda$1(MyCardCodeActivity this$0, IIX0o.II0xO0 iI0xO0) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean initView$lambda$3$lambda$2(final MyCardCodeActivity this$0, final int i, IIX0o.II0xO0 iI0xO0, int i2) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        return !com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.MyCardCodeActivity$initView$1$2$1
            ...
            public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                ...
                MyCardCodeActivity.this.tmps.clear();
                MyCardCodeActivity.this.tmps.addAll(MyCardCodeActivity.this.getMList());
                MyCardCodeActivity.this.tmps.remove(i);
                MyCardCodeActivity myCardCodeActivity = MyCardCodeActivity.this;
                myCardCodeActivity.syncQrcode(myCardCodeActivity.tmps);
            }
        }, 1, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$4(final MyCardCodeActivity this$0) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.MyCardCodeActivity$initView$2$1
            {
                super(1);
            }
    ...
    public final void syncQrcode(List<QrcodeTypeInfo> list) {
        ...
        try {
            if (!list.isEmpty()) {
                BleConnector.INSTANCE.sendStream(BleKey.QRCODE2, com.sma.smartv3.util.XIo0oOXIx.f24335oIX0oI.II0XooXoX(list), 2);
            } else {
                BleConnector.sendInt8$default(BleConnector.INSTANCE, BleKey.QRCODE2, BleKeyFlag.DELETE, 2, false, false, 24, null);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public List<QrcodeTypeInfo> initList() {
        ...
        try {
            JsonArray asJsonArray = JsonParser.parseString(com.sma.smartv3.util.Xo0.f24349oIX0oI.XO().getString(com.sma.smartv3.util.XoI0Ixx0.f24395OX00O0xII)).getAsJsonArray();
        ...
        if (size > productManager.XX0()) {
            List<QrcodeTypeInfo> subList = o0Xo0XII.subList(0, productManager.XX0());
            com.sma.smartv3.util.Xo0.f24349oIX0oI.XO().put(com.sma.smartv3.util.XoI0Ixx0.f24395OX00O0xII, new Gson().toJson(subList));
            return subList;
        }
        return o0Xo0XII;
    }
    ...
    public void initView() {
        super.initView();
        ((TextView) findViewById(R.id.abh_title_center)).setText(R.string.my_card_code);
        ...
        swipeMenuListView.setMenuCreator(new IIX0o.I0Io() { // from class: com.sma.smartv3.ui.device.oX0ooo0I0
            @Override // IIX0o.I0Io
            public final void oIX0oI(IIX0o.II0xO0 iI0xO0) {
                MyCardCodeActivity.initView$lambda$3$lambda$1(MyCardCodeActivity.this, iI0xO0);
            }
        });
        swipeMenuListView.setOnMenuItemClickListener(new SwipeMenuListView.II0xO0() { // from class: com.sma.smartv3.ui.device.oo00
            ...
            public final boolean oIX0oI(int i, IIX0o.II0xO0 iI0xO0, int i2) {
                ...
                initView$lambda$3$lambda$2 = MyCardCodeActivity.initView$lambda$3$lambda$2(MyCardCodeActivity.this, i, iI0xO0, i2);
                return initView$lambda$3$lambda$2;
            }
        });
        if (!getMList().isEmpty()) {
            getRootView().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.device.OxXXx0X
                @Override // java.lang.Runnable
                public final void run() {
                    MyCardCodeActivity.initView$lambda$4(MyCardCodeActivity.this);
                }
            }, 500L);
        }
    }
    ...
    public int itemLayoutId() {
        return R.layout.item_my_card_code;
    }

    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_my_card_code;
    }
    ...
    public void onActivityResult(int i, int i2, @OXOo.oOoXoXO final Intent intent) {
        ...
        if (i2 == -1 && i == AddQrcodeActivity.Companion.oIX0oI()) {
            com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.MyCardCodeActivity$onActivityResult$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                    ...
                    MyCardCodeActivity myCardCodeActivity = this;
                    myCardCodeActivity.syncQrcode(myCardCodeActivity.tmps);
                }
            }, 1, null);
        }
