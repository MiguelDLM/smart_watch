...
public final class StandbyWatchFaceItem extends BaseDeviceItem {
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onReadStandbyWatchFaceSet(@OOXIXo BleStandbyWatchFaceSet standbyWatchFaceSet) {
            IIX0o.x0xO0oo(standbyWatchFaceSet, "standbyWatchFaceSet");
            StandbyWatchFaceItem.this.initView();
        }
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onStandbyWatchFaceSetUpdate(@OOXIXo BleStandbyWatchFaceSet standbyWatchFaceSet) {
            IIX0o.x0xO0oo(standbyWatchFaceSet, "standbyWatchFaceSet");
            StandbyWatchFaceItem.this.initView();
        }
    ...
    public void initView() {
        setItemHidden(!ProductManager.f20544oIX0oI.Oxxo());
        if (BleConnector.INSTANCE.isBound()) {
            BleStandbyWatchFaceSet bleStandbyWatchFaceSet = (BleStandbyWatchFaceSet) BleCache.getObjectNotNull$default(BleCache.INSTANCE, BleKey.STANDBY_WATCH_FACE_SET, BleStandbyWatchFaceSet.class, null, null, 12, null);
            TextView tvRight = getTvRight();
            if (tvRight != null) {
                tvRight.setText(TextConvertKt.IXxxXO(bleStandbyWatchFaceSet.getMStandbyEnable()));
                return;
            }
            return;
        }
    ...
    @Override // com.bestmafen.androidbase.dsl.BaseDslItem
    public int layoutId() {
        return R.layout.device_item_standby_watchface;
    }
    ...
    @XO0.XO(tag = x0xO0oo.f24601Oxx0xo)
    public final void onStandbyWatchFaceChange(@OOXIXo Object data) {
