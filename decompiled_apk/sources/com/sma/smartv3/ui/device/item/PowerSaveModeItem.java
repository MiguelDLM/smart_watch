...
public final class PowerSaveModeItem extends BaseDeviceItem {
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public void onPowerSaveModeState(int i) {
            PowerSaveModeItem.this.initView();
        }
    ...
    public void initView() {
        setItemHidden(!ProductManager.f20544oIX0oI.IoXO0XoX());
        if (BleConnector.INSTANCE.isBound()) {
            TextView tvRight = getTvRight();
            if (tvRight != null) {
                tvRight.setText(TextConvertKt.IXxxXO(BleCache.getInt$default(BleCache.INSTANCE, BleKey.POWER_SAVE_MODE, 0, null, 6, null)));
                return;
            }
            return;
        }
    ...
    @Override // com.bestmafen.androidbase.dsl.BaseDslItem
    public int layoutId() {
        return R.layout.device_item_power_save_mode;
    }
