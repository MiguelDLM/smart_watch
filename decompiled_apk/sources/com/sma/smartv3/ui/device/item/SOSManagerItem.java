...
public final class SOSManagerItem extends BaseDeviceItem {
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public void onReadSOSSettings(@OOXIXo BleSOSSettings bleSOSSettings) {
            IIX0o.x0xO0oo(bleSOSSettings, "bleSOSSettings");
            SOSManagerItem.this.initView();
        }
    ...
    public void initView() {
        setItemHidden(!ProductManager.f20544oIX0oI.IO0xX());
        if (BleConnector.INSTANCE.isBound()) {
            BleSOSSettings bleSOSSettings = (BleSOSSettings) BleCache.getObjectNotNull$default(BleCache.INSTANCE, BleKey.SOS_SET, BleSOSSettings.class, null, null, 12, null);
            TextView tvRight = getTvRight();
            if (tvRight != null) {
                tvRight.setText(TextConvertKt.IXxxXO(bleSOSSettings.getMEnabled()));
                return;
            }
            return;
        }
    ...
    @Override // com.bestmafen.androidbase.dsl.BaseDslItem
    public int layoutId() {
        return R.layout.device_item_sos_manager;
    }
    ...
    @XO0.XO(tag = x0xO0oo.f24596Oo)
    public final void onSOSChange(@OOXIXo Object data) {
