...
public final class MusicControlItem extends BaseDeviceItem {
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public void onHIDState(int i) {
            MusicControlItem.this.initView();
        }
    ...
    public void initView() {
        setItemHidden(!ProductManager.f20544oIX0oI.xoIXOxX());
        TextView tvRight = getTvRight();
        if (tvRight != null) {
            tvRight.setText(TextConvertKt.IXxxXO(BleConnector.INSTANCE.getMHidState()));
        }
    }

    @Override // com.bestmafen.androidbase.dsl.BaseDslItem
    public int layoutId() {
        return R.layout.device_item_music_control;
    }
