...
public final class IncomingCallRingItem extends BaseDeviceItem {
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public void onIncomingCallRingUpdate(int i) {
            IncomingCallRingItem.this.initView();
        }
    ...
    public void initView() {
        setItemHidden(!ProductManager.f20544oIX0oI.IIIxO());
        if (BleConnector.INSTANCE.isBound()) {
            TextView tvRight = getTvRight();
            if (tvRight != null) {
                tvRight.setText(TextConvertKt.IXxxXO(BleCache.getInt$default(BleCache.INSTANCE, BleKey.INCOMING_CALL_RING, 0, null, 6, null)));
                return;
            }
            return;
        }
    ...
    @Override // com.bestmafen.androidbase.dsl.BaseDslItem
    public int layoutId() {
        return R.layout.device_item_incoming_call_ring;
    }
