...
public final class NoDisturb2Item extends BaseDeviceItem {
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onNoDisturbUpdate(@OOXIXo BleNoDisturbSettings noDisturbSettings) {
            IIX0o.x0xO0oo(noDisturbSettings, "noDisturbSettings");
            NoDisturb2Item.this.initView();
        }
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onReadNoDisturb(@OOXIXo BleNoDisturbSettings noDisturbSettings) {
            IIX0o.x0xO0oo(noDisturbSettings, "noDisturbSettings");
            NoDisturb2Item.this.initView();
        }
    ...
    public void initView() {
        setItemHidden(!ProductManager.f20544oIX0oI.IxO0Oxo());
        if (BleConnector.INSTANCE.isBound()) {
            ...
            if (oOXoIIIo.I0Io.II0xO0(bleNoDisturbSettings.getMEnabled())) {
                TextView tvRight = getTvRight();
                if (tvRight != null) {
                    tvRight.setText(TextConvertKt.IXxxXO(bleNoDisturbSettings.getMEnabled()));
                    return;
                }
                return;
            }
            if (oOXoIIIo.I0Io.II0xO0(bleNoDisturbSettings.getMBleTimeRange1().getMEnabled())) {
                TextView tvRight2 = getTvRight();
                if (tvRight2 != null) {
                    tvRight2.setText(TextConvertKt.xoxXI(bleNoDisturbSettings.getMBleTimeRange1().getMStartHour(), bleNoDisturbSettings.getMBleTimeRange1().getMStartMinute(), bleNoDisturbSettings.getMBleTimeRange1().getMEndHour(), bleNoDisturbSettings.getMBleTimeRange1().getMEndMinute(), ProjectManager.f19822oIX0oI.IO()));
                    return;
                }
                return;
            }
            ...
            if (tvRight3 != null) {
                tvRight3.setText(TextConvertKt.IXxxXO(bleNoDisturbSettings.getMBleTimeRange1().getMEnabled()));
                return;
            }
            return;
        }
    ...
    @Override // com.bestmafen.androidbase.dsl.BaseDslItem
    public int layoutId() {
        return R.layout.device_item_disturb2;
    }
    ...
    @XO0.XO(tag = x0xO0oo.f24574IXxxXO)
    public final void onNoDisturbChange(@OOXIXo Object data) {
