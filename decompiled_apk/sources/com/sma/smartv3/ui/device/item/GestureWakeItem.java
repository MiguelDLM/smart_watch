...
public final class GestureWakeItem extends BaseDeviceItem {
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onGestureWakeUpdate(@OOXIXo BleGestureWake gestureWake) {
            IIX0o.x0xO0oo(gestureWake, "gestureWake");
            GestureWakeItem.this.initView();
        }
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onReadGestureWake(@OOXIXo BleGestureWake gestureWake) {
            IIX0o.x0xO0oo(gestureWake, "gestureWake");
            GestureWakeItem.this.initView();
        }
    ...
    public void initView() {
        ...
        if (BleConnector.INSTANCE.isBound()) {
            BleGestureWake bleGestureWake = (BleGestureWake) BleCache.getObjectNotNull$default(BleCache.INSTANCE, BleKey.GESTURE_WAKE, BleGestureWake.class, null, null, 12, null);
            TextView tvRight = getTvRight();
            if (tvRight != null) {
                tvRight.setText(TextConvertKt.IXxxXO(bleGestureWake.getMBleTimeRange().getMEnabled()));
                return;
            }
            return;
        }
