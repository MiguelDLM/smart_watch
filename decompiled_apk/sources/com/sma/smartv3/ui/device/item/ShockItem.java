...
public final class ShockItem extends BaseDeviceItem {
    ...
    public void initView() {
        ...
        if (productManager.Ix0() && !ProjectManager.f19822oIX0oI.o0xxxXXxX()) {
            z = false;
        } else {
            z = true;
        }
        ...
        if (BleConnector.INSTANCE.isBound()) {
            ...
            if (tvRight != null) {
                tvRight.setText(TextConvertKt.IoOoo(BleCache.getInt$default(BleCache.INSTANCE, BleKey.VIBRATION, 0, null, 6, null)));
            }
        } else {
        ...
        if (tvLeft != null) {
            tvLeft.setText(productManager.OooI());
        }
    }

    @Override // com.bestmafen.androidbase.dsl.BaseDslItem
    public int layoutId() {
        return R.layout.device_item_shock;
    }
