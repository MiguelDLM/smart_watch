...
public final class GestureWake2Item extends BaseDeviceItem {
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onGestureWake2Update(@OOXIXo BleGestureWake2 gestureWake2) {
            IIX0o.x0xO0oo(gestureWake2, "gestureWake2");
            GestureWake2Item.this.initView();
        }
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onReadGestureWake2(@OOXIXo BleGestureWake2 gestureWake2) {
            IIX0o.x0xO0oo(gestureWake2, "gestureWake2");
            GestureWake2Item.this.initView();
        }
    ...
    public void initView() {
        setItemHidden(!ProductManager.f20544oIX0oI.oI0X0());
        if (BleConnector.INSTANCE.isBound()) {
            BleGestureWake2 bleGestureWake2 = (BleGestureWake2) BleCache.getObjectNotNull$default(BleCache.INSTANCE, BleKey.GESTURE_WAKE2, BleGestureWake2.class, null, null, 12, null);
            if (oOXoIIIo.I0Io.II0xO0(bleGestureWake2.getMEnabled())) {
                TextView tvRight = getTvRight();
                if (tvRight != null) {
                    tvRight.setText(TextConvertKt.IXxxXO(bleGestureWake2.getMEnabled()));
                    return;
                }
                return;
            }
            if (oOXoIIIo.I0Io.II0xO0(bleGestureWake2.getMBleTimeRange1().getMEnabled())) {
                TextView tvRight2 = getTvRight();
                if (tvRight2 != null) {
                    tvRight2.setText(TextConvertKt.xoxXI(bleGestureWake2.getMBleTimeRange1().getMStartHour(), bleGestureWake2.getMBleTimeRange1().getMStartMinute(), bleGestureWake2.getMBleTimeRange1().getMEndHour(), bleGestureWake2.getMBleTimeRange1().getMEndMinute(), ProjectManager.f19822oIX0oI.IO()));
                    return;
                }
                return;
            }
            ...
            if (tvRight3 != null) {
                tvRight3.setText(TextConvertKt.IXxxXO(bleGestureWake2.getMBleTimeRange1().getMEnabled()));
                return;
            }
            return;
        }
    ...
    @Override // com.bestmafen.androidbase.dsl.BaseDslItem
    public int layoutId() {
        return R.layout.device_item_gesture_wake;
    }
    ...
    public final void onGestureWakeChange(@OOXIXo Object data) {
