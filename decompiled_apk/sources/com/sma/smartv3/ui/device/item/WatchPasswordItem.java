...
public final class WatchPasswordItem extends BaseDeviceItem {
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public void onReadNoDisturb(@OOXIXo BleNoDisturbSettings noDisturbSettings) {
            ...
            WatchPasswordItem.this.initView();
        }
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onWatchPasswordUpdate(@OOXIXo BleSettingWatchPassword watchPassword) {
    ...
    public void initView() {
        setItemHidden(!ProductManager.f20544oIX0oI.IOo0());
        if (BleConnector.INSTANCE.isBound()) {
            BleSettingWatchPassword bleSettingWatchPassword = (BleSettingWatchPassword) BleCache.getObjectNotNull$default(BleCache.INSTANCE, BleKey.SET_WATCH_PASSWORD, BleSettingWatchPassword.class, null, null, 12, null);
            TextView tvRight = getTvRight();
            if (tvRight != null) {
                tvRight.setText(TextConvertKt.IXxxXO(bleSettingWatchPassword.getMEnabled()));
                return;
            }
            return;
        }
    ...
    @Override // com.bestmafen.androidbase.dsl.BaseDslItem
    public int layoutId() {
        return R.layout.device_item_watch_password;
    }
    ...
    @XO0.XO(tag = x0xO0oo.f24569IIX0o)
    public final void onWatchPasswordChange(@OOXIXo Object data) {
