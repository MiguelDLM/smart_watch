...
public final class IncomingCallRingVibrationItem extends BaseDeviceItem {
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onRingVibrationSetUpdate(@OOXIXo BleRingVibrationSettings ringVibrationSettings) {
            IIX0o.x0xO0oo(ringVibrationSettings, "ringVibrationSettings");
            IncomingCallRingVibrationItem.this.setView();
        }
    ...
    public final void setView() {
        TextView tvRight;
        String oI0IIXIo2;
        BleRingVibrationSettings bleRingVibrationSettings = (BleRingVibrationSettings) BleCache.getObject$default(BleCache.INSTANCE, BleKey.RING_VIBRATION_SET, BleRingVibrationSettings.class, null, 4, null);
        if (bleRingVibrationSettings != null && (tvRight = getTvRight()) != null) {
            if (bleRingVibrationSettings.getMVibration() == 1 && bleRingVibrationSettings.getMRing() == 1) {
                oI0IIXIo2 = UtilsKt.oI0IIXIo(R.string.choose_shake_and_sound);
            } else if (bleRingVibrationSettings.getMVibration() == 1 && bleRingVibrationSettings.getMRing() == 0) {
                oI0IIXIo2 = UtilsKt.oI0IIXIo(R.string.choose_shake);
            } else if (bleRingVibrationSettings.getMVibration() == 0 && bleRingVibrationSettings.getMRing() == 1) {
                oI0IIXIo2 = UtilsKt.oI0IIXIo(R.string.choose_sound);
            } else {
                oI0IIXIo2 = UtilsKt.oI0IIXIo(R.string.off);
            }
            tvRight.setText(oI0IIXIo2);
        }
    }
    ...
    public void initView() {
        String oI0IIXIo2;
        setItemHidden(!ProductManager.f20544oIX0oI.xoxo());
        TextView tvLeft = getTvLeft();
        if (tvLeft != null) {
            if (ProjectManager.f19822oIX0oI.XIxXXX0x0()) {
                oI0IIXIo2 = UtilsKt.oI0IIXIo(R.string.Incoming_call_settings);
            } else {
                oI0IIXIo2 = UtilsKt.oI0IIXIo(R.string.incoming_call_ring_vibration);
            }
            tvLeft.setText(oI0IIXIo2);
        }
        setView();
    }
    ...
    @Override // com.bestmafen.androidbase.dsl.BaseDslItem
    public int layoutId() {
        return R.layout.device_item_incoming_call_ring_vibration;
    }
