...
public final class DoubleClickScreenItem extends BaseDeviceItem {
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onDoubleScreenSettingsUpdate(@OOXIXo BleDoubleScreenSettings doubleScreenSettings) {
            IIX0o.x0xO0oo(doubleScreenSettings, "doubleScreenSettings");
            DoubleClickScreenItem.this.initView();
        }
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onReadDoubleScreenSettings(@OOXIXo BleDoubleScreenSettings doubleScreenSettings) {
            IIX0o.x0xO0oo(doubleScreenSettings, "doubleScreenSettings");
            DoubleClickScreenItem.this.initView();
        }
    ...
    public void initView() {
        setItemHidden(!ProductManager.f20544oIX0oI.x00X0xoXO());
        if (BleConnector.INSTANCE.isBound()) {
            BleDoubleScreenSettings bleDoubleScreenSettings = (BleDoubleScreenSettings) BleCache.getObjectNotNull$default(BleCache.INSTANCE, BleKey.DOUBLE_SCREEN, BleDoubleScreenSettings.class, null, null, 12, null);
            TextView tvRight = getTvRight();
            if (tvRight != null) {
                tvRight.setText(TextConvertKt.IXxxXO(bleDoubleScreenSettings.getMBleTimeRange1().getMEnabled()));
                return;
            }
            return;
        }
    ...
    @Override // com.bestmafen.androidbase.dsl.BaseDslItem
    public int layoutId() {
        return R.layout.device_item_doubleclick_screen;
    }
    ...
    @XO0.XO(tag = x0xO0oo.f24651x0xO0oo)
    public final void onDoubleClickChange(@OOXIXo Object data) {
