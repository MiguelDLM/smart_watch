...
public final class NoDisturbItem extends BaseDeviceItem {
    ...
    public void initView() {
        ...
        if (productManager.IxO0Oxo()) {
            z = productManager.IxO0Oxo();
        } else if (!BleConnector.INSTANCE.isBound()) {
            z = true;
        } else {
            z = false;
        }
        ...
        if (BleConnector.INSTANCE.isBound()) {
            ...
            if (productManager.xOxxXO()) {
                if (oOXoIIIo.I0Io.II0xO0(bleNoDisturbSettings.getMBleTimeRange1().getMEnabled())) {
                    TextView tvRight = getTvRight();
                    if (tvRight != null) {
                        tvRight.setText(TextConvertKt.xoxXI(bleNoDisturbSettings.getMBleTimeRange1().getMStartHour(), bleNoDisturbSettings.getMBleTimeRange1().getMStartMinute(), bleNoDisturbSettings.getMBleTimeRange1().getMEndHour(), bleNoDisturbSettings.getMBleTimeRange1().getMEndMinute(), ProjectManager.f19822oIX0oI.IO()));
                        return;
                    }
                    return;
                }
    ...
    @Override // com.bestmafen.androidbase.dsl.BaseDslItem
    public int layoutId() {
        return R.layout.device_item_disturb;
    }
