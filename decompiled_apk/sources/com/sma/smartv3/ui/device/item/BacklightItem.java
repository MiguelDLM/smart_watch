...
public final class BacklightItem extends BaseDeviceItem {
    ...
    public void initView() {
        if (BleConnector.INSTANCE.isBound()) {
            ...
            if (tvRight != null) {
                tvRight.setText(TextConvertKt.oxXx0IX(BleCache.getInt$default(BleCache.INSTANCE, BleKey.BACK_LIGHT, 0, null, 6, null) + ProductManager.f20544oIX0oI.xoXoI()));
                return;
            }
            return;
        }
    ...
    @Override // com.bestmafen.androidbase.dsl.BaseDslItem
    public int layoutId() {
        return R.layout.device_item_backlight;
    }
