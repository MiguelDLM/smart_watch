...
public final class GestureWakeSettingsActivity extends BaseActivity {

    @OXOo.oOoXoXO
    private TimeRangePopup mTimeRangePopup;

    @OXOo.OOXIXo
    private final kotlin.X0IIOO rootView$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<View>() { // from class: com.sma.smartv3.ui.device.GestureWakeSettingsActivity$rootView$2
        {
            super(0);
        }
        ...
        public final View invoke() {
            return GestureWakeSettingsActivity.this.findViewById(R.id.root);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO itemHeader$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AbhSettingsHeader>() { // from class: com.sma.smartv3.ui.device.GestureWakeSettingsActivity$itemHeader$2
        {
            super(0);
        }
        ...
        public final AbhSettingsHeader invoke() {
            return (AbhSettingsHeader) GestureWakeSettingsActivity.this.findViewById(R.id.item_header);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO itemTimeRange$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AbhSettingsItem>() { // from class: com.sma.smartv3.ui.device.GestureWakeSettingsActivity$itemTimeRange$2
        {
            super(0);
        }
        ...
        public final AbhSettingsItem invoke() {
            return (AbhSettingsItem) GestureWakeSettingsActivity.this.findViewById(R.id.item_time_range);
        }
    });

    @OXOo.OOXIXo
    private BleGestureWake mGestureWake = (BleGestureWake) BleCache.getObjectNotNull$default(BleCache.INSTANCE, BleKey.GESTURE_WAKE, BleGestureWake.class, null, null, 12, null);
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onGestureWakeUpdate(@OXOo.OOXIXo BleGestureWake gestureWake) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(gestureWake, "gestureWake");
            GestureWakeSettingsActivity.this.mGestureWake = gestureWake;
            GestureWakeSettingsActivity.this.updateUI();
        }
    ...
    public final void updateUI() {
        ...
        itemHeader.setChecked(oOXoIIIo.I0Io.II0xO0(this.mGestureWake.getMBleTimeRange().getMEnabled()));
        itemHeader.setMListener(new Oox.oOoXoXO<Boolean, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.GestureWakeSettingsActivity$updateUI$1$1
            {
                super(1);
            }
            ...
            public final void invoke(final boolean z) {
                ...
                final GestureWakeSettingsActivity gestureWakeSettingsActivity = GestureWakeSettingsActivity.this;
                if (com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.GestureWakeSettingsActivity$updateUI$1$1.1
                    ...
                    public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                        BleGestureWake bleGestureWake;
                        BleGestureWake bleGestureWake2;
                        kotlin.jvm.internal.IIX0o.x0xO0oo(it, "it");
                        bleGestureWake = GestureWakeSettingsActivity.this.mGestureWake;
                        bleGestureWake.getMBleTimeRange().setMEnabled(oOXoIIIo.I0Io.I0Io(z));
                        BleConnector bleConnector = BleConnector.INSTANCE;
                        BleKey bleKey = BleKey.GESTURE_WAKE;
                        BleKeyFlag bleKeyFlag = BleKeyFlag.UPDATE;
                        bleGestureWake2 = GestureWakeSettingsActivity.this.mGestureWake;
                        BleConnector.sendObject$default(bleConnector, bleKey, bleKeyFlag, bleGestureWake2, false, false, 24, null);
                        com.sma.smartv3.util.x0xO0oo.II0xO0("sedentariness_change", null, 2, null);
                    }
                }, 1, null)) {
                    return;
                }
                itemHeader2 = GestureWakeSettingsActivity.this.getItemHeader();
                itemHeader2.setChecked(!z);
            }
        });
        getItemTimeRange().setMRightText(TextConvertKt.xoxXI(this.mGestureWake.getMBleTimeRange().getMStartHour(), this.mGestureWake.getMBleTimeRange().getMStartMinute(), this.mGestureWake.getMBleTimeRange().getMEndHour(), this.mGestureWake.getMBleTimeRange().getMEndMinute(), ProjectManager.f19822oIX0oI.IO()));
    }
    ...
    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_gesture_wake_settings;
    }
    ...
    public final void onSetTimeRange(@OXOo.OOXIXo View view) {
        ...
        if (this.mTimeRangePopup == null) {
            ...
            timeRangePopup.xI(new Oox.Oxx0xo<Integer, Integer, Integer, Integer, Boolean>() { // from class: com.sma.smartv3.ui.device.GestureWakeSettingsActivity$onSetTimeRange$1$1
                {
                    super(4);
                }
                ...
                public final Boolean invoke(final int i, final int i2, final int i3, final int i4) {
                    final GestureWakeSettingsActivity gestureWakeSettingsActivity = GestureWakeSettingsActivity.this;
                    return Boolean.valueOf(com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.GestureWakeSettingsActivity$onSetTimeRange$1$1.1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
                        ...
                        public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                            ...
                            kotlin.jvm.internal.IIX0o.x0xO0oo(it, "it");
                            bleGestureWake = GestureWakeSettingsActivity.this.mGestureWake;
                            BleTimeRange mBleTimeRange = bleGestureWake.getMBleTimeRange();
                            int i5 = i;
                            int i6 = i2;
                            int i7 = i3;
                            int i8 = i4;
                            ...
                            BleKeyFlag bleKeyFlag = BleKeyFlag.UPDATE;
                            bleGestureWake2 = GestureWakeSettingsActivity.this.mGestureWake;
                            BleConnector.sendObject$default(it, bleKey, bleKeyFlag, bleGestureWake2, false, false, 24, null);
                            itemTimeRange = GestureWakeSettingsActivity.this.getItemTimeRange();
        ...
        if (timeRangePopup2 != null) {
            timeRangePopup2.oo0xXOI0I(this.mGestureWake.getMBleTimeRange().getMStartHour(), this.mGestureWake.getMBleTimeRange().getMStartMinute(), this.mGestureWake.getMBleTimeRange().getMEndHour(), this.mGestureWake.getMBleTimeRange().getMEndMinute());
