...
import com.sma.smartv3.ui.device.model.ResourceRenewal;
...
@kotlin.jvm.internal.XX({"SMAP\nResourceRenewalActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ResourceRenewalActivity.kt\ncom/sma/smartv3/ui/device/ResourceRenewalActivity\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,244:1\n1864#2,3:245\n*S KotlinDebug\n*F\n+ 1 ResourceRenewalActivity.kt\ncom/sma/smartv3/ui/device/ResourceRenewalActivity\n*L\n173#1:245,3\n*E\n"})
/* loaded from: classes12.dex */
public final class ResourceRenewalActivity extends BaseDSLRecyclerActivity {
    ...
    @OXOo.OOXIXo
    private final kotlin.X0IIOO mEmptyImg$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<View>() { // from class: com.sma.smartv3.ui.device.ResourceRenewalActivity$mEmptyImg$2
        {
            super(0);
        }
        ...
        public final View invoke() {
            return ResourceRenewalActivity.this.findViewById(R.id.iv_reports_generation);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO mEmptyTv$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<View>() { // from class: com.sma.smartv3.ui.device.ResourceRenewalActivity$mEmptyTv$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final View invoke() {
            return ResourceRenewalActivity.this.findViewById(R.id.tv_reports_generation);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO titleCenter$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<PFMedium>() { // from class: com.sma.smartv3.ui.device.ResourceRenewalActivity$titleCenter$2
        {
            super(0);
        }
        ...
        public final PFMedium invoke() {
            return (PFMedium) ResourceRenewalActivity.this.findViewById(R.id.abh_title_center);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO mSwipeRefreshLayout$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<SwipeRefreshLayout>() { // from class: com.sma.smartv3.ui.device.ResourceRenewalActivity$mSwipeRefreshLayout$2
        {
            super(0);
        }
        ...
        public final SwipeRefreshLayout invoke() {
            return (SwipeRefreshLayout) ResourceRenewalActivity.this.findViewById(R.id.srf);
        }
    });

    @OXOo.OOXIXo
    private final ResourceRenewal viewModel = (ResourceRenewal) new ViewModelProvider.NewInstanceFactory().create(ResourceRenewal.class);
    private int mResourceId = -1;

    @OXOo.OOXIXo
    private final ArrayList<AppFileDetail> renewalList = new ArrayList<>();

    @OXOo.OOXIXo
    private final oIX0oI mBleHandleCallback = new oIX0oI();

    /* loaded from: classes12.dex */
    public static final class II0xO0 implements Observer, kotlin.jvm.internal.XI0IXoo {

        /* renamed from: XO, reason: collision with root package name */
        public final /* synthetic */ Oox.oOoXoXO f22014XO;

        public II0xO0(Oox.oOoXoXO function) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(function, "function");
            this.f22014XO = function;
        }
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public void onAppOpUpdate(@OXOo.OOXIXo BleAppOp appOp) {
            ...
            if (appOp.getMStatus() == 1 && ResourceRenewalActivity.this.isNeedToDownloadFile()) {
                ResourceRenewalActivity.this.setNeedToDownloadFile(false);
                ResourceRenewalActivity.this.syncProgress(100.0f, 100.0f);
            }
        }
        ...
        public void onCommandSendTimeout(@OXOo.OOXIXo BleKey bleKey, @OXOo.OOXIXo BleKeyFlag bleKeyFlag) {
            ...
            com.sma.smartv3.pop.xOOOX mProgressPop = ResourceRenewalActivity.this.getMProgressPop();
        ...
        public void onStreamProgress(boolean z, int i, int i2, int i3, @OXOo.OOXIXo BleKey bleKey) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(bleKey, "bleKey");
            ResourceRenewalActivity.this.syncProgress(i3, i2);
        }
    ...
    public final void findData(ArrayList<AppFileDetail> arrayList) {
        final int i = 0;
        for (Object obj : arrayList) {
            ...
            final AppFileDetail appFileDetail = (AppFileDetail) obj;
            DslAdapterExKt.oO(getDslAdapter(), this.viewModel.getLayoutId(this.mResourceId), new Oox.oOoXoXO<DslAdapterItem, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.ResourceRenewalActivity$findData$1$1

                /* renamed from: com.sma.smartv3.ui.device.ResourceRenewalActivity$findData$1$1$1, reason: invalid class name */
                /* loaded from: classes12.dex */
                public static final class AnonymousClass1 extends Lambda implements Oox.Oxx0xo<DslViewHolder, Integer, DslAdapterItem, List<? extends Object>, kotlin.oXIO0o0XI> {
                    ...
                    final /* synthetic */ AppFileDetail $item;
                    final /* synthetic */ ResourceRenewalActivity this$0;

                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    public AnonymousClass1(AppFileDetail appFileDetail, ResourceRenewalActivity resourceRenewalActivity, int i) {
                        super(4);
                        this.$item = appFileDetail;
                        this.this$0 = resourceRenewalActivity;
                        this.$index = i;
                    }

                    /* JADX INFO: Access modifiers changed from: private */
                    public static final void invoke$lambda$0(ResourceRenewalActivity this$0, AppFileDetail item, View view) {
                        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
                        kotlin.jvm.internal.IIX0o.x0xO0oo(item, "$item");
                        this$0.onTvRenew(item);
                    }
                    ...
                    public final void invoke(@OXOo.OOXIXo DslViewHolder itemHolder, int i, @OXOo.OOXIXo DslAdapterItem dslAdapterItem, @OXOo.OOXIXo List<? extends Object> list) {
                        ...
                        TextView tv = itemHolder.tv(R.id.item_quran_title);
                        TextView tv2 = itemHolder.tv(R.id.item_quran_size);
                        if (tv != null) {
                            tv.setText(this.$item.getAppGroupId());
                        }
                        i2 = this.this$0.mResourceId;
                        if (i2 != -1) {
                            if (tv != null) {
                                tv.setText((this.$index + 1) + '.' + this.$item.getAppName());
                            }
                            if (tv2 != null) {
                                tv2.setText(((int) (this.$item.getAppSize() * 1020)) + "kb");
                            }
                            TextView tv3 = itemHolder.tv(R.id.tv_renew);
                            if (tv3 != null) {
                                tv3.setVisibility(0);
                            }
                            if (tv3 != null) {
                                final ResourceRenewalActivity resourceRenewalActivity = this.this$0;
                                final AppFileDetail appFileDetail = this.$item;
                                tv3.setOnClickListener(
                                /*  JADX ERROR: Method code generation error
                                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0092: INVOKE 
                                      (r5v1 'tv3' android.widget.TextView)
                                      (wrap:android.view.View$OnClickListener:0x008f: CONSTRUCTOR 
                                      (r6v7 'resourceRenewalActivity' com.sma.smartv3.ui.device.ResourceRenewalActivity A[DONT_INLINE])
                                      (r7v3 'appFileDetail' com.sma.smartv3.model.AppFileDetail A[DONT_INLINE])
                                     A[MD:(com.sma.smartv3.ui.device.ResourceRenewalActivity, com.sma.smartv3.model.AppFileDetail):void (m), WRAPPED] call: com.sma.smartv3.ui.device.Ix0.<init>(com.sma.smartv3.ui.device.ResourceRenewalActivity, com.sma.smartv3.model.AppFileDetail):void type: CONSTRUCTOR)
                                     VIRTUAL call: android.view.View.setOnClickListener(android.view.View$OnClickListener):void A[MD:(android.view.View$OnClickListener):void (c)] in method: com.sma.smartv3.ui.device.ResourceRenewalActivity$findData$1$1.1.invoke(com.angcyo.dsladapter.DslViewHolder, int, com.angcyo.dsladapter.DslAdapterItem, java.util.List<? extends java.lang.Object>):void, file: classes12.dex
                                    ...
                                    Caused by: jadx.core.utils.exceptions.JadxRuntimeException: Expected class to be processed at this point, class: com.sma.smartv3.ui.device.Ix0, state: NOT_LOADED
                                ...
                                /*
                                    ...
                                    kotlin.jvm.internal.IIX0o.x0xO0oo(r7, r6)
                                    java.lang.String r6 = "<anonymous parameter 3>"
                                    kotlin.jvm.internal.IIX0o.x0xO0oo(r8, r6)
                                    r6 = 2131364901(0x7f0a0c25, float:1.8349652E38)
                                    android.widget.TextView r6 = r5.tv(r6)
                                    r7 = 2131364900(0x7f0a0c24, float:1.834965E38)
                                    android.widget.TextView r7 = r5.tv(r7)
                                    if (r6 != 0) goto L20
                                    goto L29
                                L20:
                                    com.sma.smartv3.model.AppFileDetail r8 = r4.$item
                                    java.lang.String r8 = r8.getAppGroupId()
                                    r6.setText(r8)
                                L29:
                                    com.sma.smartv3.ui.device.ResourceRenewalActivity r8 = r4.this$0
                                    int r8 = com.sma.smartv3.ui.device.ResourceRenewalActivity.access$getMResourceId$p(r8)
                                    r0 = -1
                                    if (r8 == r0) goto L95
                                    if (r6 != 0) goto L35
                                    goto L56
                                L35:
                                    ...
                                    r0 = 46
                                    r8.append(r0)
                                    com.sma.smartv3.model.AppFileDetail r0 = r4.$item
                                ...
                                L59:
                                    ...
                                    r7.setText(r6)
                                L79:
                                    r6 = 2131368443(0x7f0a19fb, float:1.8356836E38)
                                    android.widget.TextView r5 = r5.tv(r6)
                                    if (r5 != 0) goto L83
                                    goto L87
                                L83:
                                    r6 = 0
                                ...
                                L87:
                                    if (r5 == 0) goto L95
                                    com.sma.smartv3.ui.device.ResourceRenewalActivity r6 = r4.this$0
                                    com.sma.smartv3.model.AppFileDetail r7 = r4.$item
                                    com.sma.smartv3.ui.device.Ix0 r8 = new com.sma.smartv3.ui.device.Ix0
                                    r8.<init>(r6, r7)
                                    r5.setOnClickListener(r8)
                                L95:
                                    return
                                */
                                throw new UnsupportedOperationException("Method not decompiled: com.sma.smartv3.ui.device.ResourceRenewalActivity$findData$1$1.AnonymousClass1.invoke(com.angcyo.dsladapter.DslViewHolder, int, com.angcyo.dsladapter.DslAdapterItem, java.util.List):void");
                            }
                        }
                        ...
                        public final void invoke2(@OXOo.OOXIXo DslAdapterItem dslItem) {
                            ...
                            dslItem.setItemBindOverride(new AnonymousClass1(AppFileDetail.this, this, i));
                            final ResourceRenewalActivity resourceRenewalActivity = this;
                            final int i3 = i;
                            dslItem.setItemClick(new Oox.oOoXoXO<View, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.ResourceRenewalActivity$findData$1$1.2
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                {
                                    super(1);
                                }
                                ...
                                public final void invoke2(@OXOo.OOXIXo View it) {
                                    ...
                                    ResourceRenewalActivity resourceRenewalActivity2 = ResourceRenewalActivity.this;
                                    String valueOf = String.valueOf(i3);
                                    Bundle bundle = new Bundle();
                                    bundle.putString("mArg0", valueOf);
                                    bundle.putParcelable("mArg2", null);
                                    bundle.putSerializable("mArg3", null);
                                    Intent intent = new Intent(resourceRenewalActivity2, (Class<?>) ResourceRenewalActivity.class);
                                    intent.putExtras(bundle);
                                    resourceRenewalActivity2.startActivity(intent);
                                }
                            });
                        }
                    });
            ...
            private final PFMedium getTitleCenter() {
                return (PFMedium) this.titleCenter$delegate.getValue();
            }

            /* JADX INFO: Access modifiers changed from: private */
            public final void onTvRenew(AppFileDetail appFileDetail) {
                if (appFileDetail.getAppPack() != null) {
                    syncData();
                    this.viewModel.downloadFile(this.mResourceId, appFileDetail);
                } else {
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public final void showList(final ArrayList<AppFileDetail> arrayList) {
                renderAdapter(new Oox.oOoXoXO<DslAdapter, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.ResourceRenewalActivity$showList$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
                    ...
                    public final void invoke2(@OXOo.OOXIXo DslAdapter renderAdapter) {
                        ...
                        DslViewHolder dslViewHolder = ResourceRenewalActivity.this.getDslViewHolder();
                        final ResourceRenewalActivity resourceRenewalActivity = ResourceRenewalActivity.this;
                        final ArrayList<AppFileDetail> arrayList2 = arrayList;
                        dslViewHolder.postDelay(300L, new Oox.oIX0oI<kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.ResourceRenewalActivity$showList$1.1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(0);
                            }
                            ...
                            public final void invoke2() {
                                final ResourceRenewalActivity resourceRenewalActivity2 = ResourceRenewalActivity.this;
                                final ArrayList<AppFileDetail> arrayList3 = arrayList2;
                                resourceRenewalActivity2.renderAdapter(new Oox.oOoXoXO<DslAdapter, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.ResourceRenewalActivity.showList.1.1.1
                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                    {
                                        super(1);
                                    }
                                    ...
                                    public final void invoke2(@OXOo.OOXIXo DslAdapter renderAdapter2) {
                                        ...
                                        if (arrayList3.isEmpty()) {
                                            resourceRenewalActivity2.getRecyclerView().setVisibility(8);
                                            mEmptyImg2 = resourceRenewalActivity2.getMEmptyImg();
                                            mEmptyImg2.setVisibility(0);
                                            mEmptyTv2 = resourceRenewalActivity2.getMEmptyTv();
                                            mEmptyTv2.setVisibility(0);
                                            return;
                                        }
                                        resourceRenewalActivity2.getRecyclerView().setVisibility(0);
                                        mEmptyImg = resourceRenewalActivity2.getMEmptyImg();
                                        mEmptyImg.setVisibility(8);
                                        mEmptyTv = resourceRenewalActivity2.getMEmptyTv();
                                        mEmptyTv.setVisibility(8);
                                        resourceRenewalActivity2.findData(arrayList3);
                                    }
                                });
                            }
                        });
            ...
            public static /* synthetic */ void syncFailed$default(ResourceRenewalActivity resourceRenewalActivity, int i, int i2, Object obj) {
                if ((i2 & 1) != 0) {
                    i = 0;
                }
                resourceRenewalActivity.syncFailed(i);
            }

            public static /* synthetic */ void syncProgress$default(ResourceRenewalActivity resourceRenewalActivity, float f, float f2, int i, Object obj) {
                if ((i & 1) != 0) {
                    f = 0.0f;
                }
                if ((i & 2) != 0) {
                ...
                resourceRenewalActivity.syncProgress(f, f2);
            }

            @OXOo.oOoXoXO
            public final com.sma.smartv3.pop.xOOOX getMProgressPop() {
                return this.mProgressPop;
            }

            @OXOo.OOXIXo
            public final ArrayList<AppFileDetail> getRenewalList() {
            ...
            public void init(@OXOo.oOoXoXO Bundle bundle) {
                ...
                if (mArg0 != null) {
                    i = Integer.parseInt(mArg0);
                } else {
                    i = -1;
                }
                this.mResourceId = i;
                LogUtils.i("savedInstanceState size" + this.mResourceId);
            ...
            public void initView() {
                super.initView();
                getTitleCenter().setText(this.viewModel.getTitleString(this.mResourceId));
                getMSwipeRefreshLayout().setEnabled(false);
                this.viewModel.getRenewalLiveData().observe(this, new II0xO0(new Oox.oOoXoXO<ArrayList<AppFileDetail>, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.ResourceRenewalActivity$initView$1
                    {
                        super(1);
                    }

                    @Override // Oox.oOoXoXO
                    public /* bridge */ /* synthetic */ kotlin.oXIO0o0XI invoke(ArrayList<AppFileDetail> arrayList) {
                        invoke2(arrayList);
                        return kotlin.oXIO0o0XI.f29392oIX0oI;
                    }

                    /* renamed from: invoke, reason: avoid collision after fix types in other method */
                    public final void invoke2(ArrayList<AppFileDetail> arrayList) {
                        ResourceRenewalActivity.this.getRenewalList().clear();
                        ResourceRenewalActivity.this.getRenewalList().addAll(arrayList);
                        LogUtils.i("renewalList.size" + ResourceRenewalActivity.this.getRenewalList().size());
                        ResourceRenewalActivity resourceRenewalActivity = ResourceRenewalActivity.this;
                        resourceRenewalActivity.showList(resourceRenewalActivity.getRenewalList());
                    }
                }));
            }
            ...
            @Override // com.bestmafen.androidbase.base.oIX0oI
            public int layoutId() {
                return R.layout.activity_resource_renewal;
            }
            ...
            public void onInitBaseLayoutAfter() {
                ...
                this.viewModel.getData(this.mResourceId);
            }
            ...
            public final void setMProgressPop(@OXOo.oOoXoXO com.sma.smartv3.pop.xOOOX xooox) {
                this.mProgressPop = xooox;
            }
            ...
            public final void syncProgress(float f, float f2) {
                ...
                if (f2 == f) {
                    ...
                    this.isSync = false;
                    if (f != 0.0f || f2 != 0.0f) {
                        com.sma.smartv3.util.x0xO0oo.II0xO0("add_app_store_success", null, 2, null);
                    }
                }
            }
        }
