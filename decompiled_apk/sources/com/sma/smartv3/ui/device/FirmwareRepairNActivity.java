...
@kotlin.jvm.internal.XX({"SMAP\nFirmwareRepairNActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 FirmwareRepairNActivity.kt\ncom/sma/smartv3/ui/device/FirmwareRepairNActivity\n+ 2 NetWorkUtils.kt\ncom/sma/smartv3/network/NetWorkUtils\n+ 3 NetWork.kt\ncom/sma/androidnetworklib/method/NetWork\n*L\n1#1,182:1\n151#2,11:183\n171#2:202\n208#3,7:194\n226#3:201\n*S KotlinDebug\n*F\n+ 1 FirmwareRepairNActivity.kt\ncom/sma/smartv3/ui/device/FirmwareRepairNActivity\n*L\n133#1:183,11\n133#1:202\n133#1:194,7\n133#1:201\n*E\n"})
/* loaded from: classes12.dex */
public final class FirmwareRepairNActivity extends BaseFirmwareRepairActivity {

    @OXOo.oOoXoXO
    private BluetoothDevice mDevice;

    @OXOo.OOXIXo
    private final kotlin.X0IIOO mBleScanner$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<XOxIOxOx.II0xO0>() { // from class: com.sma.smartv3.ui.device.FirmwareRepairNActivity$mBleScanner$2

        /* loaded from: classes12.dex */
        public static final class oIX0oI implements XOxIOxOx.oxoX {

            /* renamed from: oIX0oI, reason: collision with root package name */
            public final /* synthetic */ FirmwareRepairNActivity f21800oIX0oI;

            public oIX0oI(FirmwareRepairNActivity firmwareRepairNActivity) {
                this.f21800oIX0oI = firmwareRepairNActivity;
            }
            ...
            public void II0xO0(@OXOo.OOXIXo BleDevice device) {
                ...
                this.f21800oIX0oI.mDevice = device.getMBluetoothDevice();
                this.f21800oIX0oI.getMBleScanner().oOoXoXO(false);
                this.f21800oIX0oI.checkFirmware();
            }
            ...
            public void oIX0oI(boolean z) {
                ...
                if (!z) {
                    bluetoothDevice = this.f21800oIX0oI.mDevice;
                    if (bluetoothDevice == null) {
                        this.f21800oIX0oI.setMStarted(false);
                        this.f21800oIX0oI.getTvTip().setText(R.string.firmware_repair_device_not_found);
                        return;
                    }
                    return;
                }
                this.f21800oIX0oI.getTvTip().setText(R.string.firmware_repair_search_tip);
            }
        }
        ...
        public final XOxIOxOx.II0xO0 invoke() {
            return XOxIOxOx.oO.II0xO0(XOxIOxOx.oO.f3971oIX0oI, null, null, 3, null).Oo(10).IXxxXO(new XOxIOxOx.I0Io(BleCache.INSTANCE.getMDfuAddress())).ooOOo0oXI(new oIX0oI(FirmwareRepairNActivity.this));
        }
    });

    @OXOo.OOXIXo
    private final II0xO0 mDfuProgressListener = new II0xO0();

    @OXOo.OOXIXo
    private final oIX0oI mBleHandleCallback = new oIX0oI();

    /* loaded from: classes12.dex */
    public static final class II0xO0 extends DfuProgressListenerAdapter {
        public II0xO0() {
        }
        ...
        public void onDfuAborted(@OXOo.OOXIXo String deviceAddress) {
            ...
            FirmwareRepairNActivity.this.setMStarted(false);
            FirmwareRepairNActivity.this.getTvTip().setText(R.string.firmware_upgrading_failed);
        }
        ...
        public void onDfuCompleted(@OXOo.OOXIXo String deviceAddress) {
            ...
            FirmwareRepairNActivity.this.finish();
        }

        @Override // no.nordicsemi.android.dfu.DfuProgressListenerAdapter, no.nordicsemi.android.dfu.DfuProgressListener
        public void onDfuProcessStarting(@OXOo.OOXIXo String deviceAddress) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(deviceAddress, "deviceAddress");
            FirmwareRepairNActivity.this.getTvTip().setText(R.string.starting);
        }
        ...
        public void onProgressChanged(@OXOo.OOXIXo String deviceAddress, int i, float f, float f2, int i2, int i3) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(deviceAddress, "deviceAddress");
            FirmwareRepairNActivity.this.getDfuProgress().setProgress(i / 100.0f);
        }
    }
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public void onOTA(boolean z) {
            if (z) {
                ...
                FirmwareRepairNActivity.this.getMBleScanner().oOoXoXO(true);
            }
        }
    ...
    public final void checkFirmware() {
        ...
        HashMap checkFirmwareVersionBody$default = RequestBodyKt.getCheckFirmwareVersionBody$default("0", null, null, null, 14, null);
        final xxxI.II0xO0<FirmwareVersion> iI0xO0 = new xxxI.II0xO0<FirmwareVersion>() { // from class: com.sma.smartv3.ui.device.FirmwareRepairNActivity$checkFirmware$1
            ...
            public void handleResponse(@OXOo.oOoXoXO FirmwareVersion firmwareVersion) {
                if (firmwareVersion != null) {
                    FirmwareRepairNActivity firmwareRepairNActivity = FirmwareRepairNActivity.this;
                    firmwareRepairNActivity.getTvName().setText(firmwareVersion.getFileName());
                    firmwareRepairNActivity.getTvSize().setText(ConvertUtils.byte2FitMemorySize(firmwareVersion.getFileSize()));
                    firmwareRepairNActivity.download(firmwareVersion);
                }
            }
        };
        ...
        final xxxI.II0xO0<Response<FirmwareVersion>> iI0xO02 = new xxxI.II0xO0<Response<FirmwareVersion>>() { // from class: com.sma.smartv3.ui.device.FirmwareRepairNActivity$checkFirmware$$inlined$post$default$1
            @Override // xxxI.II0xO0
            public void handleError(@OXOo.OOXIXo String error) {
                kotlin.jvm.internal.IIX0o.x0xO0oo(error, "error");
    ...
    public final void download(@OXOo.OOXIXo final FirmwareVersion firmwareVersion) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(firmwareVersion, "firmwareVersion");
        NetWorkUtils.INSTANCE.download(firmwareVersion.getFileUrl(), com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(X00IoxXI.oIX0oI.f3233oIX0oI), firmwareVersion.getFileName(), new HttpProgressCallback<String>() { // from class: com.sma.smartv3.ui.device.FirmwareRepairNActivity$download$1
            @Override // xxxI.II0xO0
            public void handleError(@OXOo.OOXIXo String error) {
                kotlin.jvm.internal.IIX0o.x0xO0oo(error, "error");
                FirmwareRepairNActivity.this.setMStarted(false);
            ...
            public void handleResponse(@OXOo.oOoXoXO String str) {
                BluetoothDevice bluetoothDevice;
                bluetoothDevice = FirmwareRepairNActivity.this.mDevice;
                if (bluetoothDevice != null) {
                    ...
                    dfuServiceInitiator.setZip(new File(com.sma.smartv3.initializer.IXxxXO.oOoXoXO(X00IoxXI.oIX0oI.f3233oIX0oI), firmwareVersion2.getFileName()).getAbsolutePath());
                    dfuServiceInitiator.start(firmwareRepairNActivity, DfuService.class);
                }
            }
        });
    }
