...
public final class NoDisturbSettingsActivity extends BaseActivity {

    @OXOo.oOoXoXO
    private TimeRangePopup mTimeRangePopup;

    @OXOo.OOXIXo
    private final kotlin.X0IIOO rootView$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<View>() { // from class: com.sma.smartv3.ui.device.NoDisturbSettingsActivity$rootView$2
        {
            super(0);
        }
        ...
        public final View invoke() {
            return NoDisturbSettingsActivity.this.findViewById(R.id.root);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO itemHeader$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AbhSettingsHeader>() { // from class: com.sma.smartv3.ui.device.NoDisturbSettingsActivity$itemHeader$2
        {
            super(0);
        }
        ...
        public final AbhSettingsHeader invoke() {
            return (AbhSettingsHeader) NoDisturbSettingsActivity.this.findViewById(R.id.item_header);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO itemTimeRange$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AbhSettingsItem>() { // from class: com.sma.smartv3.ui.device.NoDisturbSettingsActivity$itemTimeRange$2
        {
            super(0);
        }
        ...
        public final AbhSettingsItem invoke() {
            return (AbhSettingsItem) NoDisturbSettingsActivity.this.findViewById(R.id.item_time_range);
        }
    });
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public void onNoDisturbUpdate(@OXOo.OOXIXo BleNoDisturbSettings noDisturbSettings) {
            ...
            NoDisturbSettingsActivity.this.mNoDisturbSettings = noDisturbSettings;
            NoDisturbSettingsActivity.this.updateUI();
        }
    ...
    public final void updateUI() {
        ...
        itemHeader.setMListener(new Oox.oOoXoXO<Boolean, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.NoDisturbSettingsActivity$updateUI$1$1
            {
                super(1);
            }
            ...
            public final void invoke(final boolean z) {
                ...
                final NoDisturbSettingsActivity noDisturbSettingsActivity = NoDisturbSettingsActivity.this;
                if (com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.NoDisturbSettingsActivity$updateUI$1$1.1
                    ...
                    public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                        ...
                        bleNoDisturbSettings = NoDisturbSettingsActivity.this.mNoDisturbSettings;
                        ...
                        bleNoDisturbSettings2 = NoDisturbSettingsActivity.this.mNoDisturbSettings;
                ...
                itemHeader2 = NoDisturbSettingsActivity.this.getItemHeader();
    ...
    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_nodisturb_settings;
    }
    ...
    public final void onSetTimeRange(@OXOo.OOXIXo View view) {
        ...
        if (this.mTimeRangePopup == null) {
            ...
            timeRangePopup.xI(new Oox.Oxx0xo<Integer, Integer, Integer, Integer, Boolean>() { // from class: com.sma.smartv3.ui.device.NoDisturbSettingsActivity$onSetTimeRange$1$1
                {
                    super(4);
                }
                ...
                public final Boolean invoke(final int i, final int i2, final int i3, final int i4) {
                    final NoDisturbSettingsActivity noDisturbSettingsActivity = NoDisturbSettingsActivity.this;
                    return Boolean.valueOf(com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.NoDisturbSettingsActivity$onSetTimeRange$1$1.1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
                        ...
                        public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                            ...
                            bleNoDisturbSettings2 = NoDisturbSettingsActivity.this.mNoDisturbSettings;
                            BleConnector.sendObject$default(it, bleKey, bleKeyFlag, bleNoDisturbSettings2, false, false, 24, null);
                            itemTimeRange = NoDisturbSettingsActivity.this.getItemTimeRange();
