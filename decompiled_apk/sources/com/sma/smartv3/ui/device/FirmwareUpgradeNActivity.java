...
@kotlin.jvm.internal.XX({"SMAP\nFirmwareUpgradeNActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 FirmwareUpgradeNActivity.kt\ncom/sma/smartv3/ui/device/FirmwareUpgradeNActivity\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n*L\n1#1,156:1\n15#2:157\n*S KotlinDebug\n*F\n+ 1 FirmwareUpgradeNActivity.kt\ncom/sma/smartv3/ui/device/FirmwareUpgradeNActivity\n*L\n107#1:157\n*E\n"})
/* loaded from: classes12.dex */
public final class FirmwareUpgradeNActivity extends BaseFirmwareUpgradeActivity {

    @OXOo.OOXIXo
    private final String TAG = "UpgradeN";

    @OXOo.OOXIXo
    private final kotlin.X0IIOO mBleScanner$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<XOxIOxOx.II0xO0>() { // from class: com.sma.smartv3.ui.device.FirmwareUpgradeNActivity$mBleScanner$2

        /* loaded from: classes12.dex */
        public static final class oIX0oI implements XOxIOxOx.oxoX {

            /* renamed from: oIX0oI, reason: collision with root package name */
            public final /* synthetic */ FirmwareUpgradeNActivity f21854oIX0oI;

            public oIX0oI(FirmwareUpgradeNActivity firmwareUpgradeNActivity) {
                this.f21854oIX0oI = firmwareUpgradeNActivity;
            }
            ...
            public void II0xO0(@OXOo.OOXIXo BleDevice device) {
                ...
                this.f21854oIX0oI.getMBleScanner().oOoXoXO(false);
                DfuServiceInitiator dfuServiceInitiator = new DfuServiceInitiator(device.getMBluetoothDevice().getAddress());
                FirmwareUpgradeNActivity firmwareUpgradeNActivity = this.f21854oIX0oI;
                ...
                firmwareVersion = firmwareUpgradeNActivity.mLatest;
                ...
                dfuServiceInitiator.start(firmwareUpgradeNActivity, DfuService.class);
            }

            @Override // XOxIOxOx.oxoX
            public void oIX0oI(boolean z) {
                this.f21854oIX0oI.getProgressButton().setEnabled(!z);
            }
        }
        ...
        public final XOxIOxOx.II0xO0 invoke() {
            return XOxIOxOx.oO.II0xO0(XOxIOxOx.oO.f3971oIX0oI, null, null, 3, null).Oo(10).IXxxXO(new XOxIOxOx.I0Io(BleCache.INSTANCE.getMDfuAddress())).ooOOo0oXI(new oIX0oI(FirmwareUpgradeNActivity.this));
        }
    });
    ...
    public static final class II0xO0 extends DfuProgressListenerAdapter {
        ...
        public void onDfuAborted(@OXOo.OOXIXo String deviceAddress) {
            ...
            FirmwareUpgradeNActivity.this.setMStarted(false);
            ProgressButton.X0o0xo(FirmwareUpgradeNActivity.this.getProgressButton(), R.string.firmware_upgrading_failed, false, 2, null);
        ...
        public void onDfuCompleted(@OXOo.OOXIXo String deviceAddress) {
            ...
            FirmwareUpgradeNActivity.this.finish();
        }

        @Override // no.nordicsemi.android.dfu.DfuProgressListenerAdapter, no.nordicsemi.android.dfu.DfuProgressListener
        public void onDfuProcessStarting(@OXOo.OOXIXo String deviceAddress) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(deviceAddress, "deviceAddress");
            ProgressButton.X0o0xo(FirmwareUpgradeNActivity.this.getProgressButton(), R.string.starting, false, 2, null);
        }

        @Override // no.nordicsemi.android.dfu.DfuProgressListenerAdapter, no.nordicsemi.android.dfu.DfuProgressListener
        public void onError(@OXOo.OOXIXo String deviceAddress, int i, int i2, @OXOo.oOoXoXO String str) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(deviceAddress, "deviceAddress");
            OI0.oIX0oI.f1507oIX0oI.oIX0oI(FirmwareUpgradeNActivity.this.TAG + " -> onError, " + i + ", " + i2 + ", " + str);
            FirmwareUpgradeNActivity.this.setMStarted(false);
            ProgressButton.X0o0xo(FirmwareUpgradeNActivity.this.getProgressButton(), R.string.firmware_upgrading_failed, false, 2, null);
            com.sma.smartv3.util.Xo0.f24349oIX0oI.II0xO0().put(com.sma.smartv3.util.XoI0Ixx0.f24419XO, true);
        }
        ...
        public void onProgressChanged(@OXOo.OOXIXo String deviceAddress, int i, float f, float f2, int i2, int i3) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(deviceAddress, "deviceAddress");
            FirmwareUpgradeNActivity.this.getProgressButton().setProgress(i / 100.0f);
        }
    }
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public void onOTA(boolean z) {
            if (z) {
                ...
                FirmwareUpgradeNActivity.this.getMBleScanner().oOoXoXO(true);
            }
        }
    ...
    public final void onBottomClick(@OXOo.OOXIXo View view) {
        ...
        kotlin.jvm.internal.IIX0o.ooOOo0oXI(firmwareVersion);
        netWorkUtils.download(firmwareVersion.getFileUrl(), com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(X00IoxXI.oIX0oI.f3233oIX0oI), this.mLatest.getFileName(), new HttpProgressCallback<String>() { // from class: com.sma.smartv3.ui.device.FirmwareUpgradeNActivity$onBottomClick$1
            ...
            public void handleResponse(@OXOo.oOoXoXO String str) {
                com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.FirmwareUpgradeNActivity$onBottomClick$1$handleResponse$1
