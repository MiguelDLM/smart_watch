...
public final class AutoBindActivity extends BaseActivity {

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvTip1$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.device.AutoBindActivity$tvTip1$2
        {
            super(0);
        }
        ...
        public final TextView invoke() {
            return (TextView) AutoBindActivity.this.findViewById(R.id.tv_tip1);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvTip2$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.device.AutoBindActivity$tvTip2$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final TextView invoke() {
            return (TextView) AutoBindActivity.this.findViewById(R.id.tv_tip2);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO ivBindTip1$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<GifImageView>() { // from class: com.sma.smartv3.ui.device.AutoBindActivity$ivBindTip1$2
        {
            super(0);
        }
        ...
        public final GifImageView invoke() {
            return (GifImageView) AutoBindActivity.this.findViewById(R.id.iv_bind_tip_1);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO ivBindTip2$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<GifImageView>() { // from class: com.sma.smartv3.ui.device.AutoBindActivity$ivBindTip2$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final GifImageView invoke() {
            return (GifImageView) AutoBindActivity.this.findViewById(R.id.iv_bind_tip_2);
        }
    });
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        /* renamed from: com.sma.smartv3.ui.device.AutoBindActivity$oIX0oI$oIX0oI, reason: collision with other inner class name */
        /* loaded from: classes12.dex */
        public static final class C0942oIX0oI implements GifImageView.oIX0oI {

            /* renamed from: oIX0oI, reason: collision with root package name */
            public final /* synthetic */ AutoBindActivity f21702oIX0oI;

            public C0942oIX0oI(AutoBindActivity autoBindActivity) {
                this.f21702oIX0oI = autoBindActivity;
            }

            @Override // com.sma.smartv3.view.GifImageView.oIX0oI
            public /* synthetic */ void I0Io(boolean z) {
                com.sma.smartv3.view.xoIox.II0xO0(this, z);
            }

            @Override // com.sma.smartv3.view.GifImageView.oIX0oI
            public /* synthetic */ void II0xO0() {
                com.sma.smartv3.view.xoIox.I0Io(this);
            }

            @Override // com.sma.smartv3.view.GifImageView.oIX0oI
            public void oIX0oI() {
                this.f21702oIX0oI.finish();
            }

            @Override // com.sma.smartv3.view.GifImageView.oIX0oI
            public /* synthetic */ void onPlayStart() {
                com.sma.smartv3.view.xoIox.oxoX(this);
            }

            @Override // com.sma.smartv3.view.GifImageView.oIX0oI
            public /* synthetic */ void oxoX(float f) {
                com.sma.smartv3.view.xoIox.X0o0xo(this, f);
            }
        }
        ...
        public void onReadFirmwareVersion(@OXOo.OOXIXo String version) {
            ...
            AutoBindActivity.this.getIvBindTip1().setVisibility(8);
            AutoBindActivity.this.getIvBindTip2().setVisibility(0);
            AutoBindActivity.this.getTvTip1().setText(R.string.bind_success);
            AutoBindActivity.this.getTvTip2().setVisibility(4);
            AutoBindActivity.this.getIvBindTip2().setOnPlayListener(new C0942oIX0oI(AutoBindActivity.this));
            AutoBindActivity.this.getIvBindTip2().play();
        }
    ...
    public final GifImageView getIvBindTip1() {
        return (GifImageView) this.ivBindTip1$delegate.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final GifImageView getIvBindTip2() {
        return (GifImageView) this.ivBindTip2$delegate.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final TextView getTvTip1() {
        return (TextView) this.tvTip1$delegate.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final TextView getTvTip2() {
        return (TextView) this.tvTip2$delegate.getValue();
    }
    ...
    public void initView() {
        ...
        BarUtils.addMarginTopEqualStatusBarHeight(findViewById(R.id.top_panel));
        String oO2 = IIXOxIxOo.I0Io.IXxxXO().oO();
        kotlin.jvm.internal.IIX0o.oO(oO2, "getCurSkinName(...)");
        if (StringsKt__StringsKt.o00xOoIO(oO2, ToastUtils.MODE.LIGHT, false, 2, null)) {
            getIvBindTip1().setGifResource(R.drawable.pic_bind_tip_1_light);
            getIvBindTip2().setGifResource(R.drawable.pic_bind_tip_2_light);
        } else {
            getIvBindTip1().setGifResource(R.raw.pic_bind_tip_1);
            getIvBindTip2().setGifResource(R.raw.pic_bind_tip_2);
        }
        getIvBindTip1().setVisibility(0);
        getIvBindTip2().setVisibility(8);
        getIvBindTip2().pause();
        ...
        bleConnector.setAddress(mArg0).connect(true);
    }

    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_autobind;
    }
