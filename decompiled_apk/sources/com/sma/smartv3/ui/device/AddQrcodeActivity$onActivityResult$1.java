...
public final class AddQrcodeActivity$onActivityResult$1 extends Lambda implements Oox.oIX0oI<kotlin.oXIO0o0XI> {
    final /* synthetic */ Intent $data;
    final /* synthetic */ AddQrcodeActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AddQrcodeActivity$onActivityResult$1(AddQrcodeActivity addQrcodeActivity, Intent intent) {
        super(0);
        this.this$0 = addQrcodeActivity;
        this.$data = intent;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void invoke$lambda$1(AddQrcodeActivity this$0) {
    ...
    public final void invoke2() {
        try {
            ...
            if (xxIXOIIO2 != null) {
                this.this$0.createQrcodeTypeInfo(xxIXOIIO2);
            } else {
                ToastUtils.showLong(R.string.qrcode_failed);
            }
        } catch (Exception e) {
            e.printStackTrace();
            final AddQrcodeActivity addQrcodeActivity = this.this$0;
            addQrcodeActivity.runOnUiThread(new Runnable() { // from class: com.sma.smartv3.ui.device.II0xO0
                @Override // java.lang.Runnable
                public final void run() {
                    AddQrcodeActivity$onActivityResult$1.invoke$lambda$1(AddQrcodeActivity.this);
                }
            });
        }
    }
