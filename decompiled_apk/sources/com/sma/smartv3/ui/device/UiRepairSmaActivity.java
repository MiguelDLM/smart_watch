...
@kotlin.jvm.internal.XX({"SMAP\nUiRepairSmaActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 UiRepairSmaActivity.kt\ncom/sma/smartv3/ui/device/UiRepairSmaActivity\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n*L\n1#1,150:1\n18#2,2:151\n15#2:153\n27#2,2:154\n*S KotlinDebug\n*F\n+ 1 UiRepairSmaActivity.kt\ncom/sma/smartv3/ui/device/UiRepairSmaActivity\n*L\n73#1:151,2\n73#1:153\n143#1:154,2\n*E\n"})
/* loaded from: classes12.dex */
public final class UiRepairSmaActivity extends BaseFirmwareRepairActivity {

    @OXOo.OOXIXo
    private final String TAG = "RepairUI";
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public void onCommandSendTimeout(@OXOo.OOXIXo BleKey bleKey, @OXOo.OOXIXo BleKeyFlag bleKeyFlag) {
            ...
            if (bleKey == BleKey.UI_FILE) {
                UiRepairSmaActivity.this.setMStarted(false);
                UiRepairSmaActivity.this.getTvTip().setText(com.sma.smartv3.util.oO.f24511oIX0oI.X0o0xo());
            }
        }
        ...
        public void onStreamProgress(boolean z, int i, int i2, int i3, @OXOo.OOXIXo BleKey bleKey) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(bleKey, "bleKey");
            if (z) {
                UiRepairSmaActivity.this.getDfuProgress().setProgress(i3 / i2);
                if (i2 == i3) {
                    ToastUtils.showLong(R.string.repair_successful);
                    UiRepairSmaActivity.this.finish();
                    return;
                }
                return;
            }
            UiRepairSmaActivity.this.setMStarted(false);
            UiRepairSmaActivity.this.getTvTip().setText(i + " - " + UiRepairSmaActivity.this.getString(R.string.firmware_upgrading_failed_and_retry));
        }
    ...
    private final void downloadUiPage() {
        ...
        NetWorkUtils.INSTANCE.download(this.mUiData.getFileUrl(), com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(X00IoxXI.oIX0oI.f3233oIX0oI), this.mUiData.getFileName(), new HttpProgressCallback<String>() { // from class: com.sma.smartv3.ui.device.UiRepairSmaActivity$downloadUiPage$1
            ...
            public void handleError(@OXOo.OOXIXo String error) {
                ...
                str = UiRepairSmaActivity.this.TAG;
                sb.append(str);
                sb.append(" download ui error -> ");
                sb.append(error);
            ...
            public void handleResponse(@OXOo.oOoXoXO String str) {
                UiRepairSmaActivity.this.upgrade();
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$0(UiRepairSmaActivity this$0, View view) {
    ...
    public final void upgrade() {
        ...
        com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.UiRepairSmaActivity$upgrade$1
            {
                super(1);
            }
            ...
            public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                ...
                extraPackageData = UiRepairSmaActivity.this.mUiData;
                BleConnector.sendStream$default(bleConnector, bleKey, new File(oOoXoXO2, extraPackageData.getFileName()), 0, 4, (Object) null);
            }
        }, 1, null);
    }
    ...
    public void initView() {
        ...
        getTvTip().setOnClickListener(new View.OnClickListener() { // from class: com.sma.smartv3.ui.device.OIxI0O
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                UiRepairSmaActivity.initView$lambda$0(UiRepairSmaActivity.this, view);
            }
        });
        downloadUiPage();
    }
