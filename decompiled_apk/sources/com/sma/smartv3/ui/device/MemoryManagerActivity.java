...
public final class MemoryManagerActivity extends BaseActivity {

    @OXOo.OOXIXo
    private final kotlin.X0IIOO mProgressBar$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<ProgressBar>() { // from class: com.sma.smartv3.ui.device.MemoryManagerActivity$mProgressBar$2
        {
            super(0);
        }
        ...
        public final ProgressBar invoke() {
            return (ProgressBar) MemoryManagerActivity.this.findViewById(R.id.memory_progress);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO mAllMemory$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<PFMedium>() { // from class: com.sma.smartv3.ui.device.MemoryManagerActivity$mAllMemory$2
        {
            super(0);
        }
        ...
        public final PFMedium invoke() {
            return (PFMedium) MemoryManagerActivity.this.findViewById(R.id.memory_all_tv);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO mUsedMemory$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<PFMedium>() { // from class: com.sma.smartv3.ui.device.MemoryManagerActivity$mUsedMemory$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final PFMedium invoke() {
            return (PFMedium) MemoryManagerActivity.this.findViewById(R.id.used_memory_tv);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO mFreeMemory$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<PFMedium>() { // from class: com.sma.smartv3.ui.device.MemoryManagerActivity$mFreeMemory$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final PFMedium invoke() {
            return (PFMedium) MemoryManagerActivity.this.findViewById(R.id.available_memory_tv);
        }
    });
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public void onReadSDCardInfo(@OXOo.OOXIXo BleSDCardInfo sdCardInfo) {
            ...
            MemoryManagerActivity.this.showFreeSpace();
        }
    ...
    public final void showFreeSpace() {
        ...
        getMProgressBar().setMax(bleSDCardInfo.getMTotalSize());
        getMProgressBar().setProgress(bleSDCardInfo.getMTotalSize() - bleSDCardInfo.getMFreeSize());
        long mTotalSize = bleSDCardInfo.getMTotalSize() * 1024;
        long mFreeSize = bleSDCardInfo.getMFreeSize() * 1024;
        if (mTotalSize <= com.garmin.fit.O0Xx.f12382xxX) {
            d = 0.5d;
        } else if (mTotalSize <= 1073741824) {
            d = 1.0d;
        } else {
            long j2 = 1073741824;
            if (mTotalSize % j2 == 0) {
        ...
        double d2 = 1073741824 * d;
        double d3 = d2 - mFreeSize;
        PFMedium mAllMemory = getMAllMemory();
        StringBuilder sb = new StringBuilder();
        sb.append(ConvertUtils.byte2FitMemorySize((long) d2, 0));
        ...
        sb.append(format);
        mAllMemory.setText(sb.toString());
        getMFreeMemory().setText(getString(R.string.available_memory_key, ConvertUtils.byte2FitMemorySize(mFreeSize, 0)));
        getMUsedMemory().setText(getString(R.string.used_memory_key, ConvertUtils.byte2FitMemorySize((long) d3, 0)));
    }

    public final PFMedium getMAllMemory() {
        return (PFMedium) this.mAllMemory$delegate.getValue();
    }

    public final PFMedium getMFreeMemory() {
        return (PFMedium) this.mFreeMemory$delegate.getValue();
    }
    ...
    public final PFMedium getMUsedMemory() {
        return (PFMedium) this.mUsedMemory$delegate.getValue();
    }
    ...
    public void initView() {
        ((TextView) findViewById(R.id.abh_title_center)).setText(R.string.local_broadcast_memory_key);
