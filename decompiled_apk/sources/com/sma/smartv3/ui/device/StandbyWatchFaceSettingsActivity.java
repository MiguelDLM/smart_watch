...
public final class StandbyWatchFaceSettingsActivity extends BaseActivity {

    @OXOo.oOoXoXO
    private TimeRangePopup mTimeRangePopup;

    @OXOo.OOXIXo
    private final kotlin.X0IIOO rootView$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<View>() { // from class: com.sma.smartv3.ui.device.StandbyWatchFaceSettingsActivity$rootView$2
        {
            super(0);
        }
        ...
        public final View invoke() {
            return StandbyWatchFaceSettingsActivity.this.findViewById(R.id.root);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO itemStandbyHeader$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AbhSettingsHeader>() { // from class: com.sma.smartv3.ui.device.StandbyWatchFaceSettingsActivity$itemStandbyHeader$2
        {
            super(0);
        }
        ...
        public final AbhSettingsHeader invoke() {
            return (AbhSettingsHeader) StandbyWatchFaceSettingsActivity.this.findViewById(R.id.item_standby_header);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO itemAllDayHeader$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AbhSettingsHeader>() { // from class: com.sma.smartv3.ui.device.StandbyWatchFaceSettingsActivity$itemAllDayHeader$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final AbhSettingsHeader invoke() {
            return (AbhSettingsHeader) StandbyWatchFaceSettingsActivity.this.findViewById(R.id.item_all_day_header);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO itemHeader$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AbhSettingsHeader>() { // from class: com.sma.smartv3.ui.device.StandbyWatchFaceSettingsActivity$itemHeader$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final AbhSettingsHeader invoke() {
            return (AbhSettingsHeader) StandbyWatchFaceSettingsActivity.this.findViewById(R.id.item_header);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO itemTimeRange$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AbhSettingsItem>() { // from class: com.sma.smartv3.ui.device.StandbyWatchFaceSettingsActivity$itemTimeRange$2
        {
            super(0);
        }
        ...
        public final AbhSettingsItem invoke() {
            return (AbhSettingsItem) StandbyWatchFaceSettingsActivity.this.findViewById(R.id.item_time_range);
        }
    });

    @OXOo.OOXIXo
    private BleStandbyWatchFaceSet mSettings = (BleStandbyWatchFaceSet) BleCache.getObjectNotNull$default(BleCache.INSTANCE, BleKey.STANDBY_WATCH_FACE_SET, BleStandbyWatchFaceSet.class, null, null, 12, null);
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onReadStandbyWatchFaceSet(@OXOo.OOXIXo BleStandbyWatchFaceSet standbyWatchFaceSet) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(standbyWatchFaceSet, "standbyWatchFaceSet");
            StandbyWatchFaceSettingsActivity.this.mSettings = standbyWatchFaceSet;
            StandbyWatchFaceSettingsActivity.this.updateUI();
        }
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onStandbyWatchFaceSetUpdate(@OXOo.OOXIXo BleStandbyWatchFaceSet standbyWatchFaceSet) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(standbyWatchFaceSet, "standbyWatchFaceSet");
            StandbyWatchFaceSettingsActivity.this.mSettings = standbyWatchFaceSet;
            StandbyWatchFaceSettingsActivity.this.updateUI();
        }
    ...
    public final AbhSettingsHeader getItemAllDayHeader() {
        return (AbhSettingsHeader) this.itemAllDayHeader$delegate.getValue();
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final AbhSettingsHeader getItemStandbyHeader() {
        return (AbhSettingsHeader) this.itemStandbyHeader$delegate.getValue();
    }
    ...
    public final void updateUI() {
        int i;
        View findViewById = findViewById(R.id.set_panel);
        if (oOXoIIIo.I0Io.II0xO0(this.mSettings.getMStandbyEnable())) {
            i = 0;
        } else {
            i = 8;
        }
        findViewById.setVisibility(i);
        AbhSettingsHeader itemStandbyHeader = getItemStandbyHeader();
        itemStandbyHeader.setMListener(null);
        itemStandbyHeader.setChecked(oOXoIIIo.I0Io.II0xO0(this.mSettings.getMStandbyEnable()));
        itemStandbyHeader.setMListener(new Oox.oOoXoXO<Boolean, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.StandbyWatchFaceSettingsActivity$updateUI$1$1
            {
                super(1);
            }
            ...
            public final void invoke(final boolean z) {
                AbhSettingsHeader itemStandbyHeader2;
                final StandbyWatchFaceSettingsActivity standbyWatchFaceSettingsActivity = StandbyWatchFaceSettingsActivity.this;
                if (com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.StandbyWatchFaceSettingsActivity$updateUI$1$1.1
                    ...
                    public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                        BleStandbyWatchFaceSet bleStandbyWatchFaceSet;
                        BleStandbyWatchFaceSet bleStandbyWatchFaceSet2;
                        kotlin.jvm.internal.IIX0o.x0xO0oo(it, "it");
                        bleStandbyWatchFaceSet = StandbyWatchFaceSettingsActivity.this.mSettings;
                        bleStandbyWatchFaceSet.setMStandbyEnable(oOXoIIIo.I0Io.I0Io(z));
                        BleKey bleKey = BleKey.STANDBY_WATCH_FACE_SET;
                        BleKeyFlag bleKeyFlag = BleKeyFlag.UPDATE;
                        bleStandbyWatchFaceSet2 = StandbyWatchFaceSettingsActivity.this.mSettings;
                        BleConnector.sendObject$default(it, bleKey, bleKeyFlag, bleStandbyWatchFaceSet2, false, false, 24, null);
                        com.sma.smartv3.util.x0xO0oo.II0xO0(com.sma.smartv3.util.x0xO0oo.f24601Oxx0xo, null, 2, null);
                        StandbyWatchFaceSettingsActivity.this.updateUI();
                    }
                }, 1, null)) {
                    return;
                }
                itemStandbyHeader2 = StandbyWatchFaceSettingsActivity.this.getItemStandbyHeader();
                itemStandbyHeader2.setChecked(!z);
            }
        });
        AbhSettingsHeader itemAllDayHeader = getItemAllDayHeader();
        itemAllDayHeader.setMListener(null);
        itemAllDayHeader.setChecked(oOXoIIIo.I0Io.II0xO0(this.mSettings.getMEnabled()));
        itemAllDayHeader.setMListener(new Oox.oOoXoXO<Boolean, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.StandbyWatchFaceSettingsActivity$updateUI$2$1
            {
                super(1);
            }
            ...
            public final void invoke(final boolean z) {
                AbhSettingsHeader itemAllDayHeader2;
                final StandbyWatchFaceSettingsActivity standbyWatchFaceSettingsActivity = StandbyWatchFaceSettingsActivity.this;
                if (com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.StandbyWatchFaceSettingsActivity$updateUI$2$1.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
                    ...
                    public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                        BleStandbyWatchFaceSet bleStandbyWatchFaceSet;
                        BleStandbyWatchFaceSet bleStandbyWatchFaceSet2;
                        BleStandbyWatchFaceSet bleStandbyWatchFaceSet3;
                        kotlin.jvm.internal.IIX0o.x0xO0oo(it, "it");
                        bleStandbyWatchFaceSet = StandbyWatchFaceSettingsActivity.this.mSettings;
                        bleStandbyWatchFaceSet.setMEnabled(oOXoIIIo.I0Io.I0Io(z));
                        bleStandbyWatchFaceSet2 = StandbyWatchFaceSettingsActivity.this.mSettings;
                        bleStandbyWatchFaceSet2.getMBleTimeRange1().setMEnabled(oOXoIIIo.I0Io.I0Io(!z));
                        BleKey bleKey = BleKey.STANDBY_WATCH_FACE_SET;
                        BleKeyFlag bleKeyFlag = BleKeyFlag.UPDATE;
                        bleStandbyWatchFaceSet3 = StandbyWatchFaceSettingsActivity.this.mSettings;
                        BleConnector.sendObject$default(it, bleKey, bleKeyFlag, bleStandbyWatchFaceSet3, false, false, 24, null);
                        com.sma.smartv3.util.x0xO0oo.II0xO0(com.sma.smartv3.util.x0xO0oo.f24601Oxx0xo, null, 2, null);
                        StandbyWatchFaceSettingsActivity.this.updateUI();
                    }
                }, 1, null)) {
                ...
                itemAllDayHeader2 = StandbyWatchFaceSettingsActivity.this.getItemAllDayHeader();
                itemAllDayHeader2.setChecked(!z);
            }
        });
        AbhSettingsHeader itemHeader = getItemHeader();
        itemHeader.setMListener(null);
        itemHeader.setChecked(oOXoIIIo.I0Io.II0xO0(this.mSettings.getMBleTimeRange1().getMEnabled()));
        itemHeader.setMListener(new Oox.oOoXoXO<Boolean, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.StandbyWatchFaceSettingsActivity$updateUI$3$1
            {
                super(1);
            }
            ...
            public final void invoke(final boolean z) {
                ...
                final StandbyWatchFaceSettingsActivity standbyWatchFaceSettingsActivity = StandbyWatchFaceSettingsActivity.this;
                if (com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.StandbyWatchFaceSettingsActivity$updateUI$3$1.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
                ...
                itemHeader2 = StandbyWatchFaceSettingsActivity.this.getItemHeader();
                itemHeader2.setChecked(!z);
            }
        });
        getItemTimeRange().setMRightText(TextConvertKt.xoxXI(this.mSettings.getMBleTimeRange1().getMStartHour(), this.mSettings.getMBleTimeRange1().getMStartMinute(), this.mSettings.getMBleTimeRange1().getMEndHour(), this.mSettings.getMBleTimeRange1().getMEndMinute(), ProjectManager.f19822oIX0oI.IO()));
    }
    ...
    public void initView() {
        ((TextView) findViewById(R.id.abh_title_center)).setText(R.string.standby_watchface);
    ...
    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_standby_watchface_settings;
    }
    ...
    public final void onSetTimeRange(@OXOo.OOXIXo View view) {
        ...
        if (this.mTimeRangePopup == null) {
            ...
            timeRangePopup.xI(new Oox.Oxx0xo<Integer, Integer, Integer, Integer, Boolean>() { // from class: com.sma.smartv3.ui.device.StandbyWatchFaceSettingsActivity$onSetTimeRange$1$1
                {
                    super(4);
                }
                ...
                public final Boolean invoke(final int i, final int i2, final int i3, final int i4) {
                    final StandbyWatchFaceSettingsActivity standbyWatchFaceSettingsActivity = StandbyWatchFaceSettingsActivity.this;
                    return Boolean.valueOf(com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.StandbyWatchFaceSettingsActivity$onSetTimeRange$1$1.1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
                        ...
                        public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                            ...
                            kotlin.jvm.internal.IIX0o.x0xO0oo(it, "it");
                            bleStandbyWatchFaceSet = StandbyWatchFaceSettingsActivity.this.mSettings;
                            BleTimeRange mBleTimeRange1 = bleStandbyWatchFaceSet.getMBleTimeRange1();
                            int i5 = i;
                            int i6 = i2;
                            int i7 = i3;
                            int i8 = i4;
                            mBleTimeRange1.setMStartHour(i5);
                            mBleTimeRange1.setMStartMinute(i6);
                            mBleTimeRange1.setMEndHour(i7);
                            mBleTimeRange1.setMEndMinute(i8);
                            BleKey bleKey = BleKey.STANDBY_WATCH_FACE_SET;
                            BleKeyFlag bleKeyFlag = BleKeyFlag.UPDATE;
                            bleStandbyWatchFaceSet2 = StandbyWatchFaceSettingsActivity.this.mSettings;
                            BleConnector.sendObject$default(it, bleKey, bleKeyFlag, bleStandbyWatchFaceSet2, false, false, 24, null);
                            itemTimeRange = StandbyWatchFaceSettingsActivity.this.getItemTimeRange();
        ...
        if (timeRangePopup2 != null) {
            timeRangePopup2.oo0xXOI0I(this.mSettings.getMBleTimeRange1().getMStartHour(), this.mSettings.getMBleTimeRange1().getMStartMinute(), this.mSettings.getMBleTimeRange1().getMEndHour(), this.mSettings.getMBleTimeRange1().getMEndMinute());
