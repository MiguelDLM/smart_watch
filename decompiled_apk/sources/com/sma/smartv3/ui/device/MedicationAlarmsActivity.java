...
import com.sma.smartv3.view.TimeView;
...
@kotlin.jvm.internal.XX({"SMAP\nMedicationAlarmsActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 MedicationAlarmsActivity.kt\ncom/sma/smartv3/ui/device/MedicationAlarmsActivity\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n+ 3 Activity.kt\ncom/bestmafen/androidbase/extension/ActivityKt\n+ 4 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,260:1\n1855#2,2:261\n173#3,7:263\n180#3,3:271\n143#3,7:274\n183#3:281\n173#3,7:282\n180#3,3:290\n143#3,7:293\n183#3:300\n1#4:270\n1#4:289\n*S KotlinDebug\n*F\n+ 1 MedicationAlarmsActivity.kt\ncom/sma/smartv3/ui/device/MedicationAlarmsActivity\n*L\n155#1:261,2\n227#1:263,7\n227#1:271,3\n227#1:274,7\n227#1:281\n124#1:282,7\n124#1:290,3\n124#1:293,7\n124#1:300\n227#1:270\n124#1:289\n*E\n"})
/* loaded from: classes12.dex */
public final class MedicationAlarmsActivity extends BaseListActivity<BleMedicationAlarm> {

    @OXOo.OOXIXo
    public static final oIX0oI Companion = new oIX0oI(null);

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvTip$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.device.MedicationAlarmsActivity$tvTip$2
        {
            super(0);
        }
        ...
        public final TextView invoke() {
            return (TextView) MedicationAlarmsActivity.this.findViewById(R.id.tv_tip);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO btnBottom$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<View>() { // from class: com.sma.smartv3.ui.device.MedicationAlarmsActivity$btnBottom$2
        {
            super(0);
        }
        ...
        public final View invoke() {
            return MedicationAlarmsActivity.this.findViewById(R.id.btn_bottom);
        }
    });
    ...
    @kotlin.jvm.internal.XX({"SMAP\nMedicationAlarmsActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 MedicationAlarmsActivity.kt\ncom/sma/smartv3/ui/device/MedicationAlarmsActivity$mBleHandleCallback$1\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,260:1\n350#2,7:261\n350#2,7:268\n1855#2,2:275\n*S KotlinDebug\n*F\n+ 1 MedicationAlarmsActivity.kt\ncom/sma/smartv3/ui/device/MedicationAlarmsActivity$mBleHandleCallback$1\n*L\n44#1:261,7\n52#1:268,7\n75#1:275,2\n*E\n"})
    /* loaded from: classes12.dex */
    public static final class I0Io implements BleHandleCallback {
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onMedicationAlarmAdd(@OXOo.OOXIXo BleMedicationAlarm alarm) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(alarm, "alarm");
            if (alarm.getMRepeat() == 0 && alarm.getMEnabled() == 1 && MedicationAlarmsActivity.Companion.oIX0oI(alarm)) {
                BleConnector.sendObject$default(BleConnector.INSTANCE, BleKey.MEDICATION_ALARM, BleKeyFlag.UPDATE, alarm, false, false, 24, null);
            }
            MedicationAlarmsActivity.this.getMList().add(alarm);
            MedicationAlarmsActivity.this.getMListAdapter().notifyDataSetChanged();
            MedicationAlarmsActivity.this.checkAlarmCount();
        }

        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onMedicationAlarmDelete(int i) {
            Iterator it = MedicationAlarmsActivity.this.getMList().iterator();
            int i2 = 0;
            while (true) {
                if (it.hasNext()) {
                    if (((BleMedicationAlarm) it.next()).getMId() == i) {
                        break;
                    } else {
                        i2++;
                    }
            ...
            if (i2 > -1 && i2 < MedicationAlarmsActivity.this.getMList().size()) {
                MedicationAlarmsActivity.this.getMList().remove(i2);
                MedicationAlarmsActivity.this.getMListAdapter().notifyDataSetChanged();
            }
            MedicationAlarmsActivity.this.checkAlarmCount();
        }
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onMedicationAlarmUpdate(@OXOo.OOXIXo BleMedicationAlarm alarm) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(alarm, "alarm");
            if (alarm.getMRepeat() == 0 && alarm.getMEnabled() == 1 && MedicationAlarmsActivity.Companion.oIX0oI(alarm)) {
                BleConnector.sendObject$default(BleConnector.INSTANCE, BleKey.MEDICATION_ALARM, BleKeyFlag.UPDATE, alarm, false, false, 24, null);
            }
            ...
            while (true) {
                if (it.hasNext()) {
                    if (((BleMedicationAlarm) it.next()).getMId() == alarm.getMId()) {
                        break;
                    } else {
                        i++;
                    }
            ...
            if (i > -1 && i < MedicationAlarmsActivity.this.getMList().size()) {
                MedicationAlarmsActivity.this.getMList().set(i, alarm);
                MedicationAlarmsActivity.this.getMListAdapter().notifyDataSetChanged();
            }
        }
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onReadMedicationAlarm(@OXOo.OOXIXo List<BleMedicationAlarm> alarms) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(alarms, "alarms");
            MedicationAlarmsActivity.this.getMList().clear();
            MedicationAlarmsActivity.this.getMList().addAll(alarms);
            for (BleMedicationAlarm bleMedicationAlarm : MedicationAlarmsActivity.this.getMList()) {
                if (bleMedicationAlarm.getMRepeat() == 0 && bleMedicationAlarm.getMEnabled() == 1 && MedicationAlarmsActivity.Companion.oIX0oI(bleMedicationAlarm)) {
                    BleConnector.sendObject$default(BleConnector.INSTANCE, BleKey.MEDICATION_ALARM, BleKeyFlag.UPDATE, bleMedicationAlarm, false, false, 24, null);
                }
            }
            MedicationAlarmsActivity.this.getMListAdapter().notifyDataSetChanged();
            MedicationAlarmsActivity.this.checkAlarmCount();
    ...
    /* loaded from: classes12.dex */
    public static final class II0xO0 implements SwipeMenuListView.oxoX {

        /* renamed from: oIX0oI, reason: collision with root package name */
        public final /* synthetic */ SwipeMenuListView f21943oIX0oI;

        public II0xO0(SwipeMenuListView swipeMenuListView) {
            this.f21943oIX0oI = swipeMenuListView;
        }

        @Override // com.baoyz.swipemenulistview.SwipeMenuListView.oxoX
        public void II0xO0(int i) {
        }

        @Override // com.baoyz.swipemenulistview.SwipeMenuListView.oxoX
        public void oIX0oI(int i) {
            SwipeMenuListView swipeMenuListView = this.f21943oIX0oI;
            ...
            if (childAt != null && (childAt instanceof SwipeMenuLayout)) {
                childAt.setBackgroundResource(R.drawable.swipe_menu_layout_color);
            }
        }
    }
    ...
    public static final class oIX0oI {
        ...
        public final boolean II0xO0(@OXOo.OOXIXo BleMedicationAlarm alarm) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(alarm, "alarm");
            Calendar calendar = Calendar.getInstance();
            Calendar calendar2 = Calendar.getInstance();
            calendar2.set(1, alarm.getMYear());
            calendar2.set(2, alarm.getMMonth() - 1);
            calendar2.set(5, alarm.getMDay());
            calendar2.set(11, alarm.getMHour());
            calendar2.set(12, alarm.getMMinute());
            return calendar.before(calendar2);
        }

        public final boolean oIX0oI(@OXOo.OOXIXo BleMedicationAlarm alarm) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(alarm, "alarm");
            if (!II0xO0(alarm)) {
                Calendar calendar = Calendar.getInstance();
                kotlin.jvm.internal.IIX0o.ooOOo0oXI(calendar);
                alarm.setMYear(oOXoIIIo.II0xO0.oO(calendar));
                alarm.setMMonth(oOXoIIIo.II0xO0.OOXIXo(calendar));
                alarm.setMDay(oOXoIIIo.II0xO0.II0xO0(calendar) + 1);
                return true;
            }
            return false;
        }
    ...
    public final void checkAlarmCount() {
        int i;
        boolean z = true;
        ...
        int xXOx2 = ProductManager.f20544oIX0oI.xXOx();
        getTvTip().setText(getString(R.string.medication_alarm_max_tip, Integer.valueOf(xXOx2)));
        View btnBottom = getBtnBottom();
        if (getMList().size() >= xXOx2) {
            z = false;
        }
        btnBottom.setEnabled(z);
    }

    private final List<BleMedicationAlarm> checkAlarmList(List<BleMedicationAlarm> list) {
        if (!BleConnector.INSTANCE.isAvailable() || !ProductManager.f20544oIX0oI.oXIoIo()) {
            for (BleMedicationAlarm bleMedicationAlarm : list) {
                if (bleMedicationAlarm.getMRepeat() == 0 && bleMedicationAlarm.getMEnabled() == 1 && !Companion.II0xO0(bleMedicationAlarm)) {
                    bleMedicationAlarm.setMEnabled(0);
                    BleConnector.sendObject$default(BleConnector.INSTANCE, BleKey.MEDICATION_ALARM, BleKeyFlag.UPDATE, bleMedicationAlarm, false, false, 24, null);
                }
            }
        }
    ...
    private final List<BleMedicationAlarm> getAlarmList() {
        BleCache bleCache = BleCache.INSTANCE;
        BleKey bleKey = BleKey.MEDICATION_ALARM;
        List<BleMedicationAlarm> checkAlarmList = checkAlarmList(BleCache.getList$default(bleCache, bleKey, BleMedicationAlarm.class, null, 4, null));
        int size = checkAlarmList.size();
        ProductManager productManager = ProductManager.f20544oIX0oI;
        if (size > productManager.xXOx()) {
            List<BleMedicationAlarm> subList = checkAlarmList.subList(0, productManager.xXOx());
            BleCache.putList$default(bleCache, bleKey, subList, null, 4, null);
            return subList;
        }
        return checkAlarmList;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void initItem$lambda$8$lambda$7(XIOOI.I0Io holder, final MedicationAlarmsActivity this$0, final int i, CompoundButton compoundButton, final boolean z) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(holder, "$holder");
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        if (!com.sma.smartv3.ble.I0Io.oIX0oI(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.MedicationAlarmsActivity$initItem$2$1$1
            ...
            public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                ...
                ((BleMedicationAlarm) MedicationAlarmsActivity.this.getMList().get(i)).setMEnabled(oOXoIIIo.I0Io.I0Io(z));
                MedicationAlarmsActivity.this.getMListAdapter().notifyDataSetChanged();
                if (((BleMedicationAlarm) MedicationAlarmsActivity.this.getMList().get(i)).getMRepeat() == 0 && z) {
                    MedicationAlarmsActivity.Companion.oIX0oI((BleMedicationAlarm) MedicationAlarmsActivity.this.getMList().get(i));
                }
                BleConnector.sendObject$default(it, BleKey.MEDICATION_ALARM, BleKeyFlag.UPDATE, (BleBuffer) MedicationAlarmsActivity.this.getMList().get(i), false, false, 24, null);
            }
        })) {
            compoundButton.setChecked(!z);
            holder.X0o0xo(R.id.item_panel).setSelected(!z);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$3$lambda$1(MedicationAlarmsActivity this$0, IIX0o.II0xO0 iI0xO0) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        IIX0o.oxoX oxox = new IIX0o.oxoX(this$0.getMContext());
        oxox.Oo(SizeUtils.dp2px(62.0f));
        oxox.xoIox(R.drawable.ic_delete);
        oxox.II0XooXoX(R.color.swipe_menu_item_color);
        iI0xO0.oIX0oI(oxox);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean initView$lambda$3$lambda$2(final MedicationAlarmsActivity this$0, final int i, IIX0o.II0xO0 iI0xO0, int i2) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        return !com.sma.smartv3.ble.I0Io.oIX0oI(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.MedicationAlarmsActivity$initView$1$2$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                kotlin.jvm.internal.IIX0o.x0xO0oo(it, "it");
                BleConnector.sendInt8$default(it, BleKey.MEDICATION_ALARM, BleKeyFlag.DELETE, ((BleMedicationAlarm) MedicationAlarmsActivity.this.getMList().remove(i)).getMId(), false, false, 24, null);
                MedicationAlarmsActivity.this.getMListAdapter().notifyDataSetChanged();
                MedicationAlarmsActivity.this.checkAlarmCount();
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$4(MedicationAlarmsActivity this$0, AdapterView adapterView, View view, int i, long j) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        if (oOXoIIIo.I0Io.II0xO0(this$0.getMList().get(i).getMEnabled())) {
            Bundle bundle = new Bundle();
            bundle.putString("mArg0", null);
            bundle.putInt("mArg1", i);
            bundle.putParcelable("mArg2", null);
            bundle.putSerializable("mArg3", null);
            Intent intent = new Intent(this$0, (Class<?>) MedicationAlarmEditActivity.class);
    ...
    @OXOo.OOXIXo
    public List<BleMedicationAlarm> initList() {
        return getAlarmList();
    }
    ...
    public void initView() {
        super.initView();
        ((TextView) findViewById(R.id.abh_title_center)).setText(R.string.medication_alarm);
        ...
        swipeMenuListView.setMenuCreator(new IIX0o.I0Io() { // from class: com.sma.smartv3.ui.device.OooI
            @Override // IIX0o.I0Io
            public final void oIX0oI(IIX0o.II0xO0 iI0xO0) {
                MedicationAlarmsActivity.initView$lambda$3$lambda$1(MedicationAlarmsActivity.this, iI0xO0);
            }
        });
        swipeMenuListView.setOnMenuItemClickListener(new SwipeMenuListView.II0xO0() { // from class: com.sma.smartv3.ui.device.OIx00oxx
            ...
            public final boolean oIX0oI(int i, IIX0o.II0xO0 iI0xO0, int i2) {
                ...
                initView$lambda$3$lambda$2 = MedicationAlarmsActivity.initView$lambda$3$lambda$2(MedicationAlarmsActivity.this, i, iI0xO0, i2);
                return initView$lambda$3$lambda$2;
            }
        });
        swipeMenuListView.setOnSwipeListener(new II0xO0(swipeMenuListView));
        getMListView().setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: com.sma.smartv3.ui.device.xIXX
            @Override // android.widget.AdapterView.OnItemClickListener
            public final void onItemClick(AdapterView adapterView, View view, int i, long j) {
                MedicationAlarmsActivity.initView$lambda$4(MedicationAlarmsActivity.this, adapterView, view, i, j);
            }
        });
        BleConnector bleConnector = BleConnector.INSTANCE;
        bleConnector.addHandleCallback(this.mBleHandleCallback);
        if (ProductManager.f20544oIX0oI.oXIoIo()) {
    ...
    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_medication_alarms;
    }
    ...
    public final void onBottomClick(@OXOo.OOXIXo View view) {
        ...
        bundle.putParcelable("mArg2", null);
        bundle.putSerializable("mArg3", null);
        Intent intent = new Intent(this, (Class<?>) MedicationAlarmEditActivity.class);
        intent.putExtras(bundle);
    ...
    public void initItem(@OXOo.OOXIXo final XIOOI.I0Io holder, @OXOo.OOXIXo BleMedicationAlarm item, final int i) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(holder, "holder");
        kotlin.jvm.internal.IIX0o.x0xO0oo(item, "item");
        boolean II0xO02 = oOXoIIIo.I0Io.II0xO0(item.getMEnabled());
        TimeView timeView = (TimeView) holder.X0o0xo(R.id.time_view);
        timeView.oIX0oI(item.getMYear(), item.getMMonth(), item.getMDay(), item.getMHour(), item.getMMinute());
        timeView.setEnabled(II0xO02);
        CheckBox checkBox = (CheckBox) holder.X0o0xo(R.id.check_enabled);
        checkBox.setChecked(II0xO02);
        checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.sma.smartv3.ui.device.OO0
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                MedicationAlarmsActivity.initItem$lambda$8$lambda$7(XIOOI.I0Io.this, this, i, compoundButton, z);
            }
        });
        holder.X0o0xo(R.id.item_panel).setSelected(((CheckBox) holder.X0o0xo(R.id.check_enabled)).isChecked());
        TextView textView = (TextView) holder.X0o0xo(R.id.tv_repeat);
        textView.setText(TextConvertKt.Io(item.getMRepeat()));
        textView.setEnabled(II0xO02);
    }
}
