...
public final class DialCategoryActivity extends BaseFragmentPagerActivity {
    ...
    private DialCategoryFragment onlineFragment;

    @OOXIXo
    private final X0IIOO table$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TabLayout>() { // from class: com.sma.smartv3.ui.device.dial.category.DialCategoryActivity$table$2
        {
            super(0);
        }
        ...
        public final TabLayout invoke() {
            return (TabLayout) DialCategoryActivity.this.findViewById(R.id.table);
        }
    });

    @OOXIXo
    private final X0IIOO abhTitleCenter$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<PFMedium>() { // from class: com.sma.smartv3.ui.device.dial.category.DialCategoryActivity$abhTitleCenter$2
        {
            super(0);
        }
        ...
        public final PFMedium invoke() {
            return (PFMedium) DialCategoryActivity.this.findViewById(R.id.abh_title_center);
        }
    });
    ...
    public static final class oIX0oI implements TabLayout.OnTabSelectedListener {
        ...
        public void onTabSelected(@oOoXoXO TabLayout.Tab tab) {
            ...
            if (IIX0o.Oxx0IOOO(charSequence, DialCategoryActivity.this.getString(R.string.aigc)) && !DialCategoryActivity.this.isShowAiKeyPop) {
                ProductManager productManager = ProductManager.f20544oIX0oI;
                if (!productManager.oO0OX0() && !productManager.OOIXx0x() && TextUtils.isEmpty(productManager.I0Io())) {
                    UtilsKt.XOxIOxOx(DialCategoryActivity.this.getMContext());
                    DialCategoryActivity.this.isShowAiKeyPop = true;
                }
            }
        }
    ...
    public void init(@oOoXoXO Bundle bundle) {
        this.onlineFragment = new DialCategoryFragment();
    ...
    public List<Fragment> initFragments() {
        LogUtils.d("initFragments " + BleCache.INSTANCE.getMWatchFaceType());
        ProductManager productManager = ProductManager.f20544oIX0oI;
        Object obj = null;
        if (productManager.OOXIxO0()) {
            ArrayList arrayList = new ArrayList();
            DialCategoryFragment dialCategoryFragment = this.onlineFragment;
            if (dialCategoryFragment == null) {
                IIX0o.XOxIOxOx("onlineFragment");
                dialCategoryFragment = null;
            }
            arrayList.add(dialCategoryFragment);
        ...
        DialCategoryFragment dialCategoryFragment2 = this.onlineFragment;
        if (dialCategoryFragment2 == null) {
            IIX0o.XOxIOxOx("onlineFragment");
        } else {
            obj = dialCategoryFragment2;
        }
    ...
    public void initView() {
        ...
        getAbhTitleCenter().setText(OnlineWatchFaceKt.getWatchFaceCategoryName(getMContext(), 0));
    ...
    public void onBackPressed() {
        ...
        if (dialCategoryFragment.isSync()) {
