...
@kotlin.jvm.internal.XX({"SMAP\nDialOnlineFragment.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DialOnlineFragment.kt\ncom/sma/smartv3/ui/device/dial/DialOnlineFragment\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n+ 3 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n*L\n1#1,405:1\n1#2:406\n90#3:407\n*S KotlinDebug\n*F\n+ 1 DialOnlineFragment.kt\ncom/sma/smartv3/ui/device/dial/DialOnlineFragment\n*L\n226#1:407\n*E\n"})
...
public final class DialOnlineFragment extends BaseRecyclerFragment<WatchFaceInfo> {
    ...
    @OXOo.OOXIXo
    private final kotlin.X0IIOO recyclerView$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<RecyclerView>() { // from class: com.sma.smartv3.ui.device.dial.DialOnlineFragment$recyclerView$2
        {
            super(0);
        }
    ...
    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvView$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.device.dial.DialOnlineFragment$tvView$2
        {
            super(0);
        }
    ...
    @kotlin.jvm.internal.XX({"SMAP\nDialOnlineFragment.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DialOnlineFragment.kt\ncom/sma/smartv3/ui/device/dial/DialOnlineFragment$mBleHandleCallback$1\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,405:1\n1855#2,2:406\n*S KotlinDebug\n*F\n+ 1 DialOnlineFragment.kt\ncom/sma/smartv3/ui/device/dial/DialOnlineFragment$mBleHandleCallback$1\n*L\n156#1:406,2\n*E\n"})
    /* loaded from: classes12.dex */
    public static final class II0xO0 implements BleHandleCallback {
        ...
        public void onCommandSendTimeout(@OXOo.OOXIXo BleKey bleKey, @OXOo.OOXIXo BleKeyFlag bleKeyFlag) {
            ...
            if (bleKey == BleKey.WATCH_FACE) {
                ...
                DialOnlineFragment.this.getMRecyclerAdapter().notifyDataSetChanged();
            }
        }
        ...
        public void onReadWatchFaceId(@OXOo.OOXIXo BleWatchFaceId watchFaceId) {
            ...
            DialOnlineFragment.this.mDialIds.clear();
            ...
            while (it.hasNext()) {
                ...
                if (intValue <= 0) {
                    dialOnlineFragment.mDialIds.add(0);
                } else {
                    dialOnlineFragment.mDialIds.add(Integer.valueOf(intValue));
                }
            }
            LogUtils.d("mDialIds -> " + DialOnlineFragment.this.mDialIds);
            DialOnlineFragment.this.getMRecyclerAdapter().notifyDataSetChanged();
        }
        ...
        public void onSessionStateChange(boolean z) {
            ...
            if (DialOnlineFragment.this.mCurSyncDialId != 0 && DialOnlineFragment.this.mCurSyncStatus == SyncStatus.SYNCING) {
                DialOnlineFragment.this.mCurSyncStatus = SyncStatus.FAILED;
            }
            DialOnlineFragment.this.getMRecyclerAdapter().notifyDataSetChanged();
        }
        ...
        public void onStreamProgress(boolean z, int i, int i2, int i3, @OXOo.OOXIXo BleKey bleKey) {
            ...
            if (z) {
                ...
                if (i2 == i3) {
                    ...
                    DialOnlineFragment.this.mDialIds.set(DialOnlineFragment.this.mCurSyncDevicePosition, Integer.valueOf(DialOnlineFragment.this.mCurSyncDialId));
                    if (!ProductManager.f20544oIX0oI.OOoOoO0o()) {
                        com.sma.smartv3.util.Xo0.f24349oIX0oI.II0xO0().put("syncId", DialOnlineFragment.this.mCurSyncDialId);
                    }
                ...
                DialOnlineFragment.this.mDialIds.set(DialOnlineFragment.this.mCurSyncDevicePosition, 0);
                if (!ProductManager.f20544oIX0oI.OOoOoO0o()) {
                    com.sma.smartv3.util.Xo0.f24349oIX0oI.II0xO0().put("syncId", 0);
                }
            }
            DialOnlineFragment.this.mCurSyncTotal = i2;
            DialOnlineFragment.this.mCurSyncCompleted = i3;
            DialOnlineFragment.this.getMRecyclerAdapter().notifyItemChanged(DialOnlineFragment.this.mCurSyncPosition, Integer.valueOf(DialOnlineFragment.this.mCurSyncDialId));
        }
        ...
        public void onWatchFaceIdUpdate(boolean z) {
            if (DialOnlineFragment.this.isResumed()) {
                ...
                String str = DialOnlineFragment.this.mBinFileName;
                if (str == null) {
                    kotlin.jvm.internal.IIX0o.XOxIOxOx("mBinFileName");
                    str = null;
                }
                bleConnector.sendStream(bleKey, com.sma.smartv3.initializer.IXxxXO.X0o0xo(oix0oi, str), DialOnlineFragment.this.mCurSyncDevicePosition);
    ...
    public /* synthetic */ class oIX0oI {
        ...
        public static final /* synthetic */ int[] f22166oIX0oI;
    ...
    public static final void initItem$lambda$1(final DialOnlineFragment this$0, final int i, final int i2, final ProgressButton progressButton, final WatchFaceInfo item, View view) {
        ...
        if (this$0.isSync()) {
            ...
            com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.dial.DialOnlineFragment$initItem$1$1

                /* loaded from: classes12.dex */
                public static final class oIX0oI implements xIXX {

                    /* renamed from: I0Io, reason: collision with root package name */
                    public final /* synthetic */ int f22161I0Io;

                    /* renamed from: II0xO0, reason: collision with root package name */
                    public final /* synthetic */ int f22162II0xO0;

                    /* renamed from: X0o0xo, reason: collision with root package name */
                    public final /* synthetic */ WatchFaceInfo f22163X0o0xo;

                    /* renamed from: oIX0oI, reason: collision with root package name */
                    public final /* synthetic */ DialOnlineFragment f22164oIX0oI;

                    /* renamed from: oxoX, reason: collision with root package name */
                    public final /* synthetic */ ProgressButton f22165oxoX;

                    public oIX0oI(DialOnlineFragment dialOnlineFragment, int i, int i2, ProgressButton progressButton, WatchFaceInfo watchFaceInfo) {
                        this.f22164oIX0oI = dialOnlineFragment;
                        this.f22162II0xO0 = i;
                        this.f22161I0Io = i2;
                        this.f22165oxoX = progressButton;
                        this.f22163X0o0xo = watchFaceInfo;
                    }

                    @Override // com.sma.smartv3.ui.device.dial.xIXX
                    public void oIX0oI(int i) {
                        DialOnlineFragment dialOnlineFragment = this.f22164oIX0oI;
                        int i2 = this.f22162II0xO0;
                        int i3 = this.f22161I0Io;
                        ProgressButton progressButton = this.f22165oxoX;
                        kotlin.jvm.internal.IIX0o.oO(progressButton, "$progressButton");
                        dialOnlineFragment.syncDial(i2, i3, i, progressButton, this.f22163X0o0xo);
                    }
                }
                ...
                public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                    ...
                    kotlin.jvm.internal.IIX0o.x0XOIxOo(mActivity, "null cannot be cast to non-null type com.bestmafen.androidbase.base.BaseActivity");
                    ...
                    if (ProductManager.f20544oIX0oI.OOoOoO0o()) {
                        ...
                        if (dialPickerPopup == null || !dialPickerPopup.isShowing()) {
                            ...
                            dialOnlineFragment.dialPickerPopup = new DialPickerPopup(mActivity2, DialOnlineFragment.this.mDialIds, 0, new oIX0oI(DialOnlineFragment.this, i, i2, progressButton, item));
                            ...
                            if (dialPickerPopup2 != null) {
                                ...
                                kotlin.jvm.internal.IIX0o.oO(recyclerView, "access$getRecyclerView(...)");
                    ...
                    kotlin.jvm.internal.IIX0o.oO(progressButton2, "$progressButton");
                    dialOnlineFragment2.syncDial(i3, i4, 0, progressButton2, item);
                }
            }, 1, null);
        }
    }
    ...
    public final void sendDial() {
        ...
        bleConnector.sendStream(bleKey, com.sma.smartv3.initializer.IXxxXO.X0o0xo(oix0oi, str), this.mCurSyncDevicePosition);
        productManager.xOIO();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void syncDial(int i, int i2, int i3, final ProgressButton progressButton, final WatchFaceInfo watchFaceInfo) {
        if (ProductManager.f20544oIX0oI.Ox0XO()) {
        ...
        X00IoxXI.oIX0oI oix0oi = X00IoxXI.oIX0oI.f3233oIX0oI;
        File XI0IXoo2 = com.sma.smartv3.initializer.IXxxXO.XI0IXoo(oix0oi);
        String str = this.mBinFileName;
        String str2 = null;
        if (str == null) {
            kotlin.jvm.internal.IIX0o.XOxIOxOx("mBinFileName");
        ...
        File file2 = new File(com.sma.smartv3.initializer.IXxxXO.XI0IXoo(oix0oi), bleCache.getMPrototype() + '_' + bleCache.getMBleName() + '_' + watchFaceInfo.getId());
        ...
        netWorkUtils.download(binPath, absolutePath, str2, new HttpProgressCallback<String>() { // from class: com.sma.smartv3.ui.device.dial.DialOnlineFragment$syncDial$1
            ...
            public void handleResponse(@OXOo.oOoXoXO String str5) {
                ...
                StatManager.f20200oIX0oI.I0Io(WatchFaceInfo.this.getBinPath(), FileUtils.getLength(file), 0, WatchFaceInfo.this.getId());
                ProgressButton.X0o0xo(progressButton, R.string.syncing, false, 2, null);
                this.sendDial();
            }
        });
    ...
    public final void syncStatusChange(ProgressButton progressButton, SyncStatus syncStatus) {
        int i = oIX0oI.f22166oIX0oI[syncStatus.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
                    if (i == 4) {
    ...
    public void initView() {
        ...
        CommonAdapter<WatchFaceInfo> commonAdapter = new CommonAdapter<WatchFaceInfo>(mActivity, itemLayoutId, mList) { // from class: com.sma.smartv3.ui.device.dial.DialOnlineFragment$initView$1
            ...
            public void convert(@OXOo.OOXIXo ViewHolder viewHolder, @OXOo.OOXIXo WatchFaceInfo item, int i) {
                kotlin.jvm.internal.IIX0o.x0xO0oo(viewHolder, "viewHolder");
                kotlin.jvm.internal.IIX0o.x0xO0oo(item, "item");
                DialOnlineFragment.this.initItem(viewHolder, item, i);
            }

            /* renamed from: onBindViewHolder, reason: avoid collision after fix types in other method */
            public void onBindViewHolder2(@OXOo.OOXIXo ViewHolder holder, int i, @OXOo.OOXIXo List<Object> payloads) {
                ...
                dialOnlineFragment.syncStatusChange((ProgressButton) view, DialOnlineFragment.this.mCurSyncStatus);
            }
        };
        ...
        SPUtils I0Io2 = com.sma.smartv3.util.Xo0.f24349oIX0oI.I0Io();
        WatchFaceInfo[] watchFaceInfoArr = (WatchFaceInfo[]) new Gson().fromJson(I0Io2.getString(com.sma.smartv3.util.XoI0Ixx0.f24488xo0x + '_' + WatchFaceInfo[].class.getName()), WatchFaceInfo[].class);
        StringBuilder sb = new StringBuilder();
        sb.append("list -> ");
        if (watchFaceInfoArr != null) {
            num = Integer.valueOf(watchFaceInfoArr.length);
        } else {
            num = null;
        }
        sb.append(num);
        ...
        if (watchFaceInfoArr != null && watchFaceInfoArr.length != 0) {
            ...
            getMList().addAll(ArraysKt___ArraysKt.XOXXox0(watchFaceInfoArr));
    ...
    public void onResume() {
        ...
        this.mDialIds.set(0, Integer.valueOf(com.sma.smartv3.util.Xo0.f24349oIX0oI.II0xO0().getInt("syncId", 0)));
        LogUtils.d("mDialIds -> " + this.mDialIds);
        getMRecyclerAdapter().notifyDataSetChanged();
    }

    @Override // com.bestmafen.androidbase.recycler.I0Io
    public void initItem(@OXOo.OOXIXo ViewHolder holder, @OXOo.OOXIXo final WatchFaceInfo item, final int i) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(holder, "holder");
        kotlin.jvm.internal.IIX0o.x0xO0oo(item, "item");
        ...
        kotlin.jvm.internal.IIX0o.ooOOo0oXI(progressButton);
        ProgressButton.X0o0xo(progressButton, R.string.sync, false, 2, null);
        ...
        holder.setOnClickListener(R.id.pb, new View.OnClickListener() { // from class: com.sma.smartv3.ui.device.dial.OIx00oxx
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                DialOnlineFragment.initItem$lambda$1(DialOnlineFragment.this, id, i, progressButton, item, view);
            }
        });
    }
}
