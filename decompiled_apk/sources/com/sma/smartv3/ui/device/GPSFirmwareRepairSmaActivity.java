...
@kotlin.jvm.internal.XX({"SMAP\nGPSFirmwareRepairSmaActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 GPSFirmwareRepairSmaActivity.kt\ncom/sma/smartv3/ui/device/GPSFirmwareRepairSmaActivity\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n*L\n1#1,232:1\n15#2:233\n18#2,2:234\n15#2:236\n27#2,2:237\n*S KotlinDebug\n*F\n+ 1 GPSFirmwareRepairSmaActivity.kt\ncom/sma/smartv3/ui/device/GPSFirmwareRepairSmaActivity\n*L\n37#1:233\n87#1:234,2\n87#1:236\n225#1:237,2\n*E\n"})
/* loaded from: classes12.dex */
public final class GPSFirmwareRepairSmaActivity extends BaseFirmwareRepairActivity {

    @OXOo.OOXIXo
    private final String TAG = "RepairGPSFirmware";
    ...
    public static final class II0xO0 implements BleHandleCallback {
        ...
        public static final void II0xO0(GPSFirmwareRepairSmaActivity this$0) {
        ...
        public void onCommandSendTimeout(@OXOo.OOXIXo BleKey bleKey, @OXOo.OOXIXo BleKeyFlag bleKeyFlag) {
            ...
            if (bleKey == BleKey.UI_FILE) {
                GPSFirmwareRepairSmaActivity.this.setMStarted(false);
                GPSFirmwareRepairSmaActivity.this.getTvTip().setText(com.sma.smartv3.util.oO.f24511oIX0oI.X0o0xo());
            }
        }
        ...
        public void onStreamProgress(boolean z, int i, int i2, int i3, @OXOo.OOXIXo BleKey bleKey) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(bleKey, "bleKey");
            if (z) {
                GPSFirmwareRepairSmaActivity.this.getDfuProgress().setProgress(i3 / i2);
                if (i2 == i3) {
                    if (GPSFirmwareRepairSmaActivity.this.mStepsIndex < CollectionsKt__CollectionsKt.oo0xXOI0I(GPSFirmwareRepairSmaActivity.this.mSteps)) {
                        GPSFirmwareRepairSmaActivity.this.getDfuProgress().setProgress(0.0f);
                        GPSFirmwareRepairSmaActivity.this.mStepsIndex++;
                        TextView tvTip = GPSFirmwareRepairSmaActivity.this.getTvTip();
                        final GPSFirmwareRepairSmaActivity gPSFirmwareRepairSmaActivity = GPSFirmwareRepairSmaActivity.this;
                        tvTip.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.device.IO0XoXxO
                            @Override // java.lang.Runnable
                            public final void run() {
                                GPSFirmwareRepairSmaActivity.II0xO0.II0xO0(GPSFirmwareRepairSmaActivity.this);
                            }
                        }, ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS);
                        return;
                    }
                    GPSFirmwareRepairSmaActivity.this.upgradeDone();
                    return;
                }
                return;
            }
            GPSFirmwareRepairSmaActivity.this.setMStarted(false);
            GPSFirmwareRepairSmaActivity.this.getTvTip().setText(i + " - " + GPSFirmwareRepairSmaActivity.this.getString(R.string.firmware_upgrading_failed_and_retry));
        }
    ...
    public /* synthetic */ class oIX0oI {
        ...
        public static final /* synthetic */ int[] f21891oIX0oI;
    ...
    public GPSFirmwareRepairSmaActivity() {
        ...
        Object fromJson = new Gson().fromJson(xo0.oxoX().getString(ExtraPackageData.class.getName()), (Class<Object>) ExtraPackageData.class);
    ...
    private final void downloadUiPage() {
        OI0.oIX0oI oix0oi = OI0.oIX0oI.f1507oIX0oI;
        oix0oi.oIX0oI(this.TAG + " Server -> " + UtilsKt.IXxxXO());
        oix0oi.oIX0oI(this.TAG + " download -> " + this.mUiData);
        ...
        if (this.mStepsIndex == 0) {
            ...
            if (firmwareVersion != null) {
                ...
                netWorkUtils.download(fileUrl, ooOOo0oXI2, firmwareVersion2.getFileName(), new HttpProgressCallback<String>() { // from class: com.sma.smartv3.ui.device.GPSFirmwareRepairSmaActivity$downloadUiPage$1
                    ...
                    public void handleError(@OXOo.OOXIXo String error) {
                        ...
                        str = GPSFirmwareRepairSmaActivity.this.TAG;
                        sb.append(str);
                        sb.append(" download gpsfw error -> ");
                        sb.append(error);
                        oix0oi2.oIX0oI(sb.toString());
                        GPSFirmwareRepairSmaActivity.this.mDownloaded = 0;
                        GPSFirmwareRepairSmaActivity.this.setMStarted(false);
                    }
                    ...
                    public void handleResponse(@OXOo.oOoXoXO String str) {
                        int i;
                        GPSFirmwareRepairSmaActivity gPSFirmwareRepairSmaActivity = GPSFirmwareRepairSmaActivity.this;
                        i = gPSFirmwareRepairSmaActivity.mDownloaded;
                        gPSFirmwareRepairSmaActivity.mDownloaded = i + 1;
                        GPSFirmwareRepairSmaActivity.this.checkDownload();
                    }
                });
            }
            NetWorkUtils.INSTANCE.download(BleCache.INSTANCE.getMAGpsFileUrl(), com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(X00IoxXI.oIX0oI.f3233oIX0oI), com.sma.smartv3.initializer.IXxxXO.f20837II0xO0, new HttpProgressCallback<String>() { // from class: com.sma.smartv3.ui.device.GPSFirmwareRepairSmaActivity$downloadUiPage$2
                @Override // xxxI.II0xO0
                public void handleError(@OXOo.OOXIXo String error) {
                    String str;
                    kotlin.jvm.internal.IIX0o.x0xO0oo(error, "error");
                    ...
                    str = GPSFirmwareRepairSmaActivity.this.TAG;
                    sb.append(str);
                    sb.append(" download networkfw error -> ");
                    sb.append(error);
                    oix0oi2.oIX0oI(sb.toString());
                    GPSFirmwareRepairSmaActivity.this.mDownloaded = 0;
                    GPSFirmwareRepairSmaActivity.this.setMStarted(false);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$0(GPSFirmwareRepairSmaActivity this$0, View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
    ...
    public final void upgrade() {
        ...
        int i = oIX0oI.f21891oIX0oI[this.mSteps.get(this.mStepsIndex).ordinal()];
        if (i != 1) {
            if (i == 2) {
                OI0.oIX0oI.f1507oIX0oI.oIX0oI(this.TAG + " agps_file");
                ...
                if (bleConnector.isAvailable()) {
                    ...
                    new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.device.X0xxXX0
                        @Override // java.lang.Runnable
                        public final void run() {
                            GPSFirmwareRepairSmaActivity.upgrade$lambda$2();
                        }
                    }, 4000L);
                    return;
                }
        ...
        OI0.oIX0oI.f1507oIX0oI.oIX0oI(this.TAG + " gps_firmware");
        ...
        new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.device.X0xII0I
            @Override // java.lang.Runnable
            public final void run() {
                GPSFirmwareRepairSmaActivity.upgrade$lambda$1();
            }
        }, 4000L);
    }
    ...
    public void initView() {
        ...
        super.initView();
        setMStarted(false);
        ((TextView) findViewById(R.id.abh_title_center)).setText(R.string.gps_firmware_repair);
        TextView tvName = getTvName();
        FirmwareVersion firmwareVersion = this.mLatestGpsFirmware;
        if (firmwareVersion != null) {
            str = firmwareVersion.getVersion();
        } else {
            str = null;
        }
        tvName.setText(str);
        ...
        if (firmwareVersion2 != null) {
            j = firmwareVersion2.getFileSize();
        } else {
            j = 0;
        }
        tvSize.setText(ConvertUtils.byte2FitMemorySize(j));
        getTvTip().setText(R.string.preparing);
        getTvTip().setOnClickListener(new View.OnClickListener() { // from class: com.sma.smartv3.ui.device.x0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                GPSFirmwareRepairSmaActivity.initView$lambda$0(GPSFirmwareRepairSmaActivity.this, view);
            }
        });
    ...
    @Override // com.sma.smartv3.ui.device.BaseFirmwareRepairActivity
