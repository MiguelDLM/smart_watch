...
@XX({"SMAP\nPointerElementFragment.kt\nKotlin\n*S Kotlin\n*F\n+ 1 PointerElementFragment.kt\ncom/sma/smartv3/ui/device/watchface/fragment/PointerElementFragment$initView$3\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,120:1\n1864#2,3:121\n*S KotlinDebug\n*F\n+ 1 PointerElementFragment.kt\ncom/sma/smartv3/ui/device/watchface/fragment/PointerElementFragment$initView$3\n*L\n63#1:121,3\n*E\n"})
/* loaded from: classes12.dex */
public final class PointerElementFragment$initView$3 extends CommonAdapter<ResourcesIdInfo> {
    final /* synthetic */ PointerElementFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PointerElementFragment$initView$3(PointerElementFragment pointerElementFragment, FragmentActivity fragmentActivity, int i, List<ResourcesIdInfo> list) {
        super(fragmentActivity, i, list);
        this.this$0 = pointerElementFragment;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void convert$lambda$1(PointerElementFragment$initView$3 this$0, PointerElementFragment this$1, int i, View view) {
    ...
    public void convert(@OXOo.OOXIXo ViewHolder holder, @OXOo.OOXIXo ResourcesIdInfo resourcesIdInfo, final int i) {
        ...
        relativeLayout.setOnClickListener(new View.OnClickListener() { // from class: com.sma.smartv3.ui.device.watchface.fragment.xxIXOIIO
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                PointerElementFragment$initView$3.convert$lambda$1(PointerElementFragment$initView$3.this, pointerElementFragment, i, view);
            }
        });
    }
}
