...
public final class FindWatchActivity extends BaseActivity {
    private boolean start;

    @OXOo.OOXIXo
    private final kotlin.X0IIOO mImageButton$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<ImageView>() { // from class: com.sma.smartv3.ui.device.FindWatchActivity$mImageButton$2
        {
            super(0);
        }
        ...
        public final ImageView invoke() {
            return (ImageView) FindWatchActivity.this.findViewById(R.id.find_watch_img_button);
        }
    });
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public void onFindWatchUpdate(int i) {
            FindWatchActivity.this.setStart(oOXoIIIo.I0Io.II0xO0(i));
            LogUtils.d("onReadFindWatch findWatch = " + i + "  start = " + FindWatchActivity.this.getStart());
            FindWatchActivity.this.showImage();
        }
    ...
    private final ImageView getMImageButton() {
        return (ImageView) this.mImageButton$delegate.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$0(FindWatchActivity this$0, View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        this$0.start = !this$0.start;
        LogUtils.d("start.toInt() = " + oOXoIIIo.I0Io.I0Io(this$0.start));
        BleConnector.sendInt8$default(BleConnector.INSTANCE, BleKey.FIND_WATCH, BleKeyFlag.UPDATE, oOXoIIIo.I0Io.I0Io(this$0.start), false, false, 24, null);
        this$0.showImage();
    }
    ...
    public void initView() {
        ((TextView) findViewById(R.id.abh_title_center)).setText(R.string.find_watch);
        showImage();
        getMImageButton().setOnClickListener(new View.OnClickListener() { // from class: com.sma.smartv3.ui.device.XoX
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                FindWatchActivity.initView$lambda$0(FindWatchActivity.this, view);
            }
        });
    }
    ...
    public final void showImage() {
        int i;
        ImageView mImageButton = getMImageButton();
        if (this.start) {
            i = R.drawable.icon_find_watch_pause;
        } else {
            i = R.drawable.icon_find_watch_start;
        }
        mImageButton.setImageResource(i);
    }
}
