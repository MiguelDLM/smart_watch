...
@kotlin.jvm.internal.XX({"SMAP\nLanguageRepairSmaActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 LanguageRepairSmaActivity.kt\ncom/sma/smartv3/ui/device/LanguageRepairSmaActivity\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n*L\n1#1,139:1\n18#2,2:140\n15#2:142\n27#2,2:143\n*S KotlinDebug\n*F\n+ 1 LanguageRepairSmaActivity.kt\ncom/sma/smartv3/ui/device/LanguageRepairSmaActivity\n*L\n70#1:140,2\n70#1:142\n136#1:143,2\n*E\n"})
/* loaded from: classes12.dex */
public final class LanguageRepairSmaActivity extends BaseFirmwareRepairActivity {
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public void onCommandSendTimeout(@OXOo.OOXIXo BleKey bleKey, @OXOo.OOXIXo BleKeyFlag bleKeyFlag) {
            ...
            if (bleKey == bleKey2) {
                ...
                LanguageRepairSmaActivity.this.setMStarted(false);
                LanguageRepairSmaActivity.this.getTvTip().setText(com.sma.smartv3.util.oO.f24511oIX0oI.X0o0xo());
            }
        }
        ...
        public void onStreamProgress(boolean z, int i, int i2, int i3, @OXOo.OOXIXo BleKey bleKey) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(bleKey, "bleKey");
            if (z) {
                LanguageRepairSmaActivity.this.getDfuProgress().setProgress(i3 / i2);
                if (i2 == i3) {
                    if (ProductManager.f20544oIX0oI.IXO()) {
                        com.sma.smartv3.util.Xo0 xo0 = com.sma.smartv3.util.Xo0.f24349oIX0oI;
                        xo0.II0xO0().put(com.sma.smartv3.util.XoI0Ixx0.f24413XI0IXoo, LanguageRepairSmaActivity.this.mLanguageData.getType());
                        BleConnector.sendInt8$default(BleConnector.INSTANCE, BleKey.LANGUAGE, BleKeyFlag.UPDATE, xo0.II0xO0().getInt(com.sma.smartv3.util.XoI0Ixx0.f24413XI0IXoo, Languages.languageToCode$default(Languages.INSTANCE, null, 0, 3, null)), false, false, 24, null);
                    }
                    LanguageRepairSmaActivity.this.finish();
                    return;
                }
                return;
            }
            BleCache.remove$default(BleCache.INSTANCE, BleKey.LANGUAGE_FILE, null, 2, null);
            LanguageRepairSmaActivity.this.setMStarted(false);
            LanguageRepairSmaActivity.this.getTvTip().setText(com.sma.smartv3.util.oO.f24511oIX0oI.X0o0xo());
        }
    ...
    public LanguageRepairSmaActivity() {
    ...
    private final void downloadLanguagePage() {
        NetWorkUtils.INSTANCE.download(this.mLanguageData.getFileUrl(), com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(X00IoxXI.oIX0oI.f3233oIX0oI), this.mLanguageData.getFileName(), new HttpProgressCallback<String>() { // from class: com.sma.smartv3.ui.device.LanguageRepairSmaActivity$downloadLanguagePage$1
            ...
            public void handleResponse(@OXOo.oOoXoXO String str) {
                LanguageRepairSmaActivity.this.upgrade();
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$0(LanguageRepairSmaActivity this$0, View view) {
    ...
    public final void upgrade() {
        ...
        BleConnector.sendStream$default(BleConnector.INSTANCE, BleKey.LANGUAGE_FILE, new File(com.sma.smartv3.initializer.IXxxXO.oOoXoXO(X00IoxXI.oIX0oI.f3233oIX0oI), this.mLanguageData.getFileName()), 0, 4, (Object) null);
    }
    ...
    public void initView() {
        ...
        getTvTip().setOnClickListener(new View.OnClickListener() { // from class: com.sma.smartv3.ui.device.Oxx
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                LanguageRepairSmaActivity.initView$lambda$0(LanguageRepairSmaActivity.this, view);
            }
        });
        setMStarted(true);
