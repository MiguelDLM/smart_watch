...
@kotlin.jvm.internal.XX({"SMAP\nAlarmsActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 AlarmsActivity.kt\ncom/sma/smartv3/ui/device/AlarmsActivity\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n+ 3 Activity.kt\ncom/bestmafen/androidbase/extension/ActivityKt\n+ 4 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,271:1\n1855#2,2:272\n173#3,7:274\n180#3,3:282\n143#3,7:285\n183#3:292\n173#3,7:293\n180#3,3:301\n143#3,7:304\n183#3:311\n1#4:281\n1#4:300\n*S KotlinDebug\n*F\n+ 1 AlarmsActivity.kt\ncom/sma/smartv3/ui/device/AlarmsActivity\n*L\n158#1:272,2\n238#1:274,7\n238#1:282,3\n238#1:285,7\n238#1:292\n129#1:293,7\n129#1:301,3\n129#1:304,7\n129#1:311\n238#1:281\n129#1:300\n*E\n"})
/* loaded from: classes12.dex */
public final class AlarmsActivity extends BaseListActivity<BleAlarm> {

    @OXOo.OOXIXo
    public static final oIX0oI Companion = new oIX0oI(null);

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvTip$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.device.AlarmsActivity$tvTip$2
        {
            super(0);
        }
        ...
        public final TextView invoke() {
            return (TextView) AlarmsActivity.this.findViewById(R.id.tv_tip);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO btnBottom$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<View>() { // from class: com.sma.smartv3.ui.device.AlarmsActivity$btnBottom$2
        {
            super(0);
        }
        ...
        public final View invoke() {
            return AlarmsActivity.this.findViewById(R.id.btn_bottom);
        }
    });
    ...
    @kotlin.jvm.internal.XX({"SMAP\nAlarmsActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 AlarmsActivity.kt\ncom/sma/smartv3/ui/device/AlarmsActivity$mBleHandleCallback$1\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,271:1\n350#2,7:272\n350#2,7:279\n1855#2,2:286\n*S KotlinDebug\n*F\n+ 1 AlarmsActivity.kt\ncom/sma/smartv3/ui/device/AlarmsActivity$mBleHandleCallback$1\n*L\n49#1:272,7\n57#1:279,7\n80#1:286,2\n*E\n"})
    /* loaded from: classes12.dex */
    public static final class I0Io implements BleHandleCallback {
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onAlarmAdd(@OXOo.OOXIXo BleAlarm alarm) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(alarm, "alarm");
            if (alarm.getMRepeat() == 0 && alarm.getMEnabled() == 1 && AlarmsActivity.Companion.oIX0oI(alarm)) {
                BleConnector.sendObject$default(BleConnector.INSTANCE, BleKey.ALARM, BleKeyFlag.UPDATE, alarm, false, false, 24, null);
            }
            AlarmsActivity.this.getMList().add(alarm);
            AlarmsActivity.this.getMListAdapter().notifyDataSetChanged();
            AlarmsActivity.this.checkAlarmCount();
        }

        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onAlarmDelete(int i) {
            Iterator it = AlarmsActivity.this.getMList().iterator();
            int i2 = 0;
            while (true) {
                if (it.hasNext()) {
                    if (((BleAlarm) it.next()).getMId() == i) {
                        break;
                    } else {
                        i2++;
                    }
            ...
            if (i2 > -1 && i2 < AlarmsActivity.this.getMList().size()) {
                AlarmsActivity.this.getMList().remove(i2);
                AlarmsActivity.this.getMListAdapter().notifyDataSetChanged();
            }
            AlarmsActivity.this.checkAlarmCount();
        }
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onAlarmUpdate(@OXOo.OOXIXo BleAlarm alarm) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(alarm, "alarm");
            if (alarm.getMRepeat() == 0 && alarm.getMEnabled() == 1 && AlarmsActivity.Companion.oIX0oI(alarm)) {
                BleConnector.sendObject$default(BleConnector.INSTANCE, BleKey.ALARM, BleKeyFlag.UPDATE, alarm, false, false, 24, null);
            }
            ...
            while (true) {
                if (it.hasNext()) {
                    if (((BleAlarm) it.next()).getMId() == alarm.getMId()) {
                        break;
                    } else {
                        i++;
                    }
            ...
            if (i > -1 && i < AlarmsActivity.this.getMList().size()) {
                AlarmsActivity.this.getMList().set(i, alarm);
                AlarmsActivity.this.getMListAdapter().notifyDataSetChanged();
            }
        }
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onReadAlarm(@OXOo.OOXIXo List<BleAlarm> alarms) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(alarms, "alarms");
            AlarmsActivity.this.getMList().clear();
            AlarmsActivity.this.getMList().addAll(alarms);
            for (BleAlarm bleAlarm : AlarmsActivity.this.getMList()) {
                if (bleAlarm.getMRepeat() == 0 && bleAlarm.getMEnabled() == 1 && AlarmsActivity.Companion.oIX0oI(bleAlarm)) {
                    BleConnector.sendObject$default(BleConnector.INSTANCE, BleKey.ALARM, BleKeyFlag.UPDATE, bleAlarm, false, false, 24, null);
                }
            }
            AlarmsActivity.this.getMListAdapter().notifyDataSetChanged();
            AlarmsActivity.this.checkAlarmCount();
    ...
    public static final class II0xO0 implements SwipeMenuListView.oxoX {
        ...
        public final /* synthetic */ SwipeMenuListView f21679oIX0oI;

        public II0xO0(SwipeMenuListView swipeMenuListView) {
            this.f21679oIX0oI = swipeMenuListView;
        }
        ...
        public void oIX0oI(int i) {
            SwipeMenuListView swipeMenuListView = this.f21679oIX0oI;
    ...
    public static final class oIX0oI {
        ...
        public final boolean II0xO0(@OXOo.OOXIXo BleAlarm alarm) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(alarm, "alarm");
        ...
        public final boolean oIX0oI(@OXOo.OOXIXo BleAlarm alarm) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(alarm, "alarm");
            if (!II0xO0(alarm)) {
                Calendar calendar = Calendar.getInstance();
    ...
    public final void checkAlarmCount() {
        ...
        int X00IoxXI2 = ProductManager.f20544oIX0oI.X00IoxXI();
        getTvTip().setText(getString(R.string.alarm_max_tip, Integer.valueOf(X00IoxXI2)));
        View btnBottom = getBtnBottom();
        if (getMList().size() >= X00IoxXI2) {
            z = false;
        }
        btnBottom.setEnabled(z);
        View btnBottom2 = getBtnBottom();
        if (getMList().size() >= X00IoxXI2) {
            i2 = 4;
        }
        btnBottom2.setVisibility(i2);
    }

    private final List<BleAlarm> checkAlarmList(List<BleAlarm> list) {
        if (!BleConnector.INSTANCE.isAvailable() || !ProductManager.f20544oIX0oI.xoxXI()) {
            for (BleAlarm bleAlarm : list) {
                if (bleAlarm.getMRepeat() == 0 && bleAlarm.getMEnabled() == 1 && !Companion.II0xO0(bleAlarm)) {
                    bleAlarm.setMEnabled(0);
                    BleConnector.sendObject$default(BleConnector.INSTANCE, BleKey.ALARM, BleKeyFlag.UPDATE, bleAlarm, false, false, 24, null);
                }
            }
        }
    ...
    private final List<BleAlarm> getAlarmList() {
        BleCache bleCache = BleCache.INSTANCE;
        BleKey bleKey = BleKey.ALARM;
        List<BleAlarm> checkAlarmList = checkAlarmList(BleCache.getList$default(bleCache, bleKey, BleAlarm.class, null, 4, null));
        int size = checkAlarmList.size();
        ProductManager productManager = ProductManager.f20544oIX0oI;
        if (size > productManager.X00IoxXI()) {
            List<BleAlarm> subList = checkAlarmList.subList(0, productManager.X00IoxXI());
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void initItem$lambda$8$lambda$7(final AlarmsActivity this$0, final int i, XIOOI.I0Io holder, CompoundButton compoundButton, final boolean z) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        kotlin.jvm.internal.IIX0o.x0xO0oo(holder, "$holder");
        if (this$0.getMList().size() > i) {
            if (!com.sma.smartv3.ble.I0Io.oIX0oI(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.AlarmsActivity$initItem$2$1$1
                ...
                public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                    ...
                    ((BleAlarm) AlarmsActivity.this.getMList().get(i)).setMEnabled(oOXoIIIo.I0Io.I0Io(z));
                    AlarmsActivity.this.getMListAdapter().notifyDataSetChanged();
                    if (((BleAlarm) AlarmsActivity.this.getMList().get(i)).getMRepeat() == 0 && z) {
                        AlarmsActivity.Companion.oIX0oI((BleAlarm) AlarmsActivity.this.getMList().get(i));
                    }
                    BleConnector.sendObject$default(it, BleKey.ALARM, BleKeyFlag.UPDATE, (BleBuffer) AlarmsActivity.this.getMList().get(i), false, false, 24, null);
                }
            })) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$3$lambda$1(AlarmsActivity this$0, IIX0o.II0xO0 iI0xO0) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean initView$lambda$3$lambda$2(final AlarmsActivity this$0, final int i, IIX0o.II0xO0 iI0xO0, int i2) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        return !com.sma.smartv3.ble.I0Io.oIX0oI(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.AlarmsActivity$initView$1$2$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                kotlin.jvm.internal.IIX0o.x0xO0oo(it, "it");
                BleConnector.sendInt8$default(it, BleKey.ALARM, BleKeyFlag.DELETE, ((BleAlarm) AlarmsActivity.this.getMList().remove(i)).getMId(), false, false, 24, null);
                AlarmsActivity.this.getMListAdapter().notifyDataSetChanged();
                AlarmsActivity.this.checkAlarmCount();
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$4(AlarmsActivity this$0, AdapterView adapterView, View view, int i, long j) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        ...
        Intent intent = new Intent(this$0, (Class<?>) AlarmEditActivity.class);
    ...
    public void initView() {
        super.initView();
        ((TextView) findViewById(R.id.abh_title_center)).setText(R.string.alarm_clock);
        ...
        swipeMenuListView.setMenuCreator(new IIX0o.I0Io() { // from class: com.sma.smartv3.ui.device.I0Io
            @Override // IIX0o.I0Io
            public final void oIX0oI(IIX0o.II0xO0 iI0xO0) {
                AlarmsActivity.initView$lambda$3$lambda$1(AlarmsActivity.this, iI0xO0);
            }
        });
        swipeMenuListView.setOnMenuItemClickListener(new SwipeMenuListView.II0xO0() { // from class: com.sma.smartv3.ui.device.oxoX
            ...
            public final boolean oIX0oI(int i, IIX0o.II0xO0 iI0xO0, int i2) {
                ...
                initView$lambda$3$lambda$2 = AlarmsActivity.initView$lambda$3$lambda$2(AlarmsActivity.this, i, iI0xO0, i2);
                return initView$lambda$3$lambda$2;
            }
        });
        swipeMenuListView.setOnSwipeListener(new II0xO0(swipeMenuListView));
        getMListView().setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: com.sma.smartv3.ui.device.X0o0xo
            @Override // android.widget.AdapterView.OnItemClickListener
            public final void onItemClick(AdapterView adapterView, View view, int i, long j) {
                AlarmsActivity.initView$lambda$4(AlarmsActivity.this, adapterView, view, i, j);
            }
        });
        BleConnector bleConnector = BleConnector.INSTANCE;
        bleConnector.addHandleCallback(this.mBleHandleCallback);
        if (ProductManager.f20544oIX0oI.xoxXI()) {
    ...
    public void initItem(@OXOo.OOXIXo final XIOOI.I0Io holder, @OXOo.OOXIXo BleAlarm item, final int i) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(holder, "holder");
        ...
        holder.o00(R.id.tv_tag, item.getMTag());
        CheckBox checkBox = (CheckBox) holder.X0o0xo(R.id.check_enabled);
        checkBox.setChecked(II0xO02);
        checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.sma.smartv3.ui.device.XO
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                AlarmsActivity.initItem$lambda$8$lambda$7(AlarmsActivity.this, i, holder, compoundButton, z);
            }
        });
