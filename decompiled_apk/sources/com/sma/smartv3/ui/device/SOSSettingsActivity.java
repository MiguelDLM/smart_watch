...
public final class SOSSettingsActivity extends BaseActivity {

    @OXOo.oOoXoXO
    private com.sma.smartv3.pop.XoI0Ixx0 mPermissionPopup;

    @OXOo.OOXIXo
    private final kotlin.X0IIOO itemHeader$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AbhSettingsHeader>() { // from class: com.sma.smartv3.ui.device.SOSSettingsActivity$itemHeader$2
        {
            super(0);
        }
        ...
        public final AbhSettingsHeader invoke() {
            return (AbhSettingsHeader) SOSSettingsActivity.this.findViewById(R.id.item_header);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO rootView$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<View>() { // from class: com.sma.smartv3.ui.device.SOSSettingsActivity$rootView$2
        {
            super(0);
        }
        ...
        public final View invoke() {
            return SOSSettingsActivity.this.findViewById(R.id.root);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvLabel$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.device.SOSSettingsActivity$tvLabel$2
        {
            super(0);
        }
        ...
        public final TextView invoke() {
            return (TextView) SOSSettingsActivity.this.findViewById(R.id.tv_label);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO etPhone$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextInputEditText>() { // from class: com.sma.smartv3.ui.device.SOSSettingsActivity$etPhone$2
        {
            super(0);
        }
        ...
        public final TextInputEditText invoke() {
            return (TextInputEditText) SOSSettingsActivity.this.findViewById(R.id.et_phone_value);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvCode$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.device.SOSSettingsActivity$tvCode$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final TextView invoke() {
            return (TextView) SOSSettingsActivity.this.findViewById(R.id.tv_code);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO fallDetectionHeader$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AbhSettingsHeader>() { // from class: com.sma.smartv3.ui.device.SOSSettingsActivity$fallDetectionHeader$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final AbhSettingsHeader invoke() {
            return (AbhSettingsHeader) SOSSettingsActivity.this.findViewById(R.id.fall_detection_header);
        }
    });

    @OXOo.OOXIXo
    private BleSOSSettings mBleSOSSettings = (BleSOSSettings) BleCache.getObjectNotNull$default(BleCache.INSTANCE, BleKey.SOS_SET, BleSOSSettings.class, null, null, 12, null);
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public void onFallSetUpdate(int i) {
            ...
            SOSSettingsActivity.this.upFallDetection();
        }
        ...
        public void onReadSOSSettings(@OXOo.OOXIXo BleSOSSettings bleSOSSettings) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(bleSOSSettings, "bleSOSSettings");
            SOSSettingsActivity.this.mBleSOSSettings = bleSOSSettings;
            SOSSettingsActivity.this.updateUI();
            com.sma.smartv3.util.x0xO0oo.II0xO0(com.sma.smartv3.util.x0xO0oo.f24596Oo, null, 2, null);
        }
    ...
    private final TextInputEditText getEtPhone() {
        return (TextInputEditText) this.etPhone$delegate.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final AbhSettingsHeader getFallDetectionHeader() {
        return (AbhSettingsHeader) this.fallDetectionHeader$delegate.getValue();
    }
    ...
    public final void noPermissionRemind() {
        if (this.mPermissionPopup == null) {
            ...
            xoI0Ixx0.x0o(R.string.settings, new Oox.oIX0oI<Boolean>() { // from class: com.sma.smartv3.ui.device.SOSSettingsActivity$noPermissionRemind$1$1
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // Oox.oIX0oI
                @OXOo.OOXIXo
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void onCountryCode$lambda$5$lambda$4(SOSSettingsActivity this$0, CountryCodeSelectorFragment countryCodeSelectorFragment, Country country) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        String oIX0oI2 = country.oIX0oI();
        kotlin.jvm.internal.IIX0o.oO(oIX0oI2, "getCode(...)");
        if (oIX0oI2.length() > 0) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void setViewPhone$lambda$3(String phone, SOSSettingsActivity this$0) {
        String str;
        kotlin.jvm.internal.IIX0o.x0xO0oo(phone, "$phone");
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        String str2 = null;
        if (StringsKt__StringsKt.o00xOoIO(phone, HelpFormatter.DEFAULT_OPT_PREFIX, false, 2, null)) {
            List XXoO0oX2 = StringsKt__StringsKt.XXoO0oX(phone, new String[]{HelpFormatter.DEFAULT_OPT_PREFIX}, false, 0, 6, null);
            TextView tvCode = this$0.getTvCode();
            if (XXoO0oX2 != null) {
                str = (String) XXoO0oX2.get(0);
            } else {
                str = null;
            }
            tvCode.setText(str);
            ...
            if (XXoO0oX2 != null) {
                str2 = (String) XXoO0oX2.get(XXoO0oX2.size() - 1);
            }
            etPhone.setText(str2);
            return;
        }
        this$0.getEtPhone().setText(phone);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void upFallDetection() {
        int i;
        AbhSettingsHeader fallDetectionHeader = getFallDetectionHeader();
        if (ProductManager.f20544oIX0oI.Xx0()) {
            i = 0;
        } else {
            i = 8;
        }
        fallDetectionHeader.setVisibility(i);
        fallDetectionHeader.setMListener(null);
        fallDetectionHeader.setChecked(oOXoIIIo.I0Io.II0xO0(BleCache.getInt$default(BleCache.INSTANCE, BleKey.FALL_SET, 0, null, 6, null)));
        fallDetectionHeader.setMListener(new Oox.oOoXoXO<Boolean, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.SOSSettingsActivity$upFallDetection$1$1
            {
                super(1);
            }
            ...
            public final void invoke(boolean z) {
                AbhSettingsHeader fallDetectionHeader2;
                fallDetectionHeader2 = SOSSettingsActivity.this.getFallDetectionHeader();
                fallDetectionHeader2.setChecked(z);
            }
        });
    }
    ...
    public final void updateUI() {
        int i;
        getTvLabel().setEnabled(oOXoIIIo.I0Io.II0xO0(this.mBleSOSSettings.getMEnabled()));
        AbhSettingsHeader itemHeader = getItemHeader();
        itemHeader.setMListener(null);
        itemHeader.setChecked(oOXoIIIo.I0Io.II0xO0(this.mBleSOSSettings.getMEnabled()));
        itemHeader.setMListener(new Oox.oOoXoXO<Boolean, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.SOSSettingsActivity$updateUI$2$1
            {
                super(1);
            }
            ...
            public final void invoke(boolean z) {
                ...
                TextView tvLabel;
                itemHeader2 = SOSSettingsActivity.this.getItemHeader();
                itemHeader2.setChecked(z);
                tvLabel = SOSSettingsActivity.this.getTvLabel();
                tvLabel.setEnabled(z);
            }
        });
        if (ProductManager.f20544oIX0oI.Xx0()) {
            i = R.string.sos_tip_v2;
        } else {
            i = R.string.sos_tip;
        }
        String string = getString(i);
        kotlin.jvm.internal.IIX0o.oO(string, "getString(...)");
        itemHeader.setMDescription(string);
        upFallDetection();
        setViewPhone(this.mBleSOSSettings.getMPhone());
    }
    ...
    public void init(@OXOo.oOoXoXO Bundle bundle) {
        ...
        if (ProductManager.f20544oIX0oI.Xx0()) {
            BleConnector.sendInt8$default(bleConnector, BleKey.FALL_SET, BleKeyFlag.READ, 255, false, false, 24, null);
        }
    }

    @Override // com.bestmafen.androidbase.base.oIX0oI
    public void initView() {
        ((TextView) findViewById(R.id.abh_title_center)).setText(R.string.sos_manager);
        updateUI();
    }
    ...
    @OXOo.oOoXoXO
    public final ArrayList<ContactResult> obtainResult(@OXOo.OOXIXo Intent data) {
    ...
    public void onActivityResult(int i, int i2, @OXOo.oOoXoXO Intent intent) {
        ...
        if (i2 == -1 && i == 991 && intent != null) {
            ArrayList<ContactResult> obtainResult = obtainResult(intent);
            if (obtainResult != null) {
                contactResult = obtainResult.get(0);
            } else {
                contactResult = null;
            }
            kotlin.jvm.internal.IIX0o.ooOOo0oXI(contactResult);
    ...
    public final void onCountryCode(@OXOo.OOXIXo View view) {
        ...
        newInstance.setOnCountrySelectListener(new CountryCodeSelectorFragment.oIX0oI() { // from class: com.sma.smartv3.ui.device.oo0oIXo
            @Override // me.zheteng.countrycodeselector.CountryCodeSelectorFragment.oIX0oI
            public final void oIX0oI(Country country) {
                SOSSettingsActivity.onCountryCode$lambda$5$lambda$4(SOSSettingsActivity.this, newInstance, country);
            }
        });
    }
    ...
    public final void onSaveClick(@OXOo.OOXIXo View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(view, "view");
        final String valueOf = String.valueOf(getEtPhone().getText());
        if (valueOf.length() == 0) {
            ToastUtils.showShort(R.string.input_phone_num_tip);
            return;
        }
        if (getTvCode().getText().toString().length() != 0) {
            valueOf = ((Object) getTvCode().getText()) + '-' + valueOf;
        }
        ...
        if (bytes.length > 18) {
            ToastUtils.showShort(getString(R.string.phone_number) + getString(R.string.conten_too_long), new Object[0]);
            return;
        }
        if (com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.SOSSettingsActivity$onSaveClick$1
            ...
            public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                AbhSettingsHeader itemHeader;
                AbhSettingsHeader fallDetectionHeader;
                kotlin.jvm.internal.IIX0o.x0xO0oo(it, "it");
                BleKey bleKey = BleKey.SOS_SET;
                BleKeyFlag bleKeyFlag = BleKeyFlag.UPDATE;
                itemHeader = SOSSettingsActivity.this.getItemHeader();
                BleConnector.sendObject$default(it, bleKey, bleKeyFlag, new BleSOSSettings(oOXoIIIo.I0Io.I0Io(itemHeader.I0Io()), valueOf), false, false, 24, null);
                if (ProductManager.f20544oIX0oI.Xx0()) {
                    BleKey bleKey2 = BleKey.FALL_SET;
                    fallDetectionHeader = SOSSettingsActivity.this.getFallDetectionHeader();
                    BleConnector.sendInt8$default(it, bleKey2, bleKeyFlag, oOXoIIIo.I0Io.I0Io(fallDetectionHeader.I0Io()), false, false, 24, null);
                }
            }
        }, 1, null)) {
            ToastUtils.showLong(R.string.success_save);
            com.sma.smartv3.util.x0xO0oo.II0xO0(com.sma.smartv3.util.x0xO0oo.f24596Oo, null, 2, null);
        }
    }
    ...
    public final void pickContact(@OXOo.OOXIXo View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(view, "view");
        ...
        oOXoIIIo.X0o0xo.I0Io(permission, null, null, new Oox.oOoXoXO<PermissionStatus, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.SOSSettingsActivity$pickContact$1
            {
                super(1);
            }
            ...
            public final void invoke2(@OXOo.OOXIXo PermissionStatus it) {
                ...
                if (it != PermissionStatus.GRANTED) {
                    SOSSettingsActivity.this.noPermissionRemind();
                } else {
                    new ContactPicker.Builder(SOSSettingsActivity.this).hideScrollbar(false).setMaxSelectCount(1).showTrack(true).searchIconColor(-1).setChoiceMode(1).bubbleTextColor(-1).setTitleText(SOSSettingsActivity.this.getString(R.string.picker_title)).setLoadingType(1).limitToColumn(LimitColumn.PHONE).showPickerForResult(991);
                }
            }
        }, 3, null);
    }

    public final void setViewPhone(@OXOo.OOXIXo final String phone) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(phone, "phone");
        runOnUiThread(new Runnable() { // from class: com.sma.smartv3.ui.device.oxIO0IIo
            @Override // java.lang.Runnable
            public final void run() {
                SOSSettingsActivity.setViewPhone$lambda$3(phone, this);
            }
        });
    }
}
