...
public final class DoubleClickSettingsActivity extends BaseActivity {

    @OXOo.oOoXoXO
    private TimeRangePopup mTimeRangePopup;

    @OXOo.OOXIXo
    private final kotlin.X0IIOO rootView$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<View>() { // from class: com.sma.smartv3.ui.device.DoubleClickSettingsActivity$rootView$2
        {
            super(0);
        }
        ...
        public final View invoke() {
            return DoubleClickSettingsActivity.this.findViewById(R.id.root);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO itemHeader$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AbhSettingsHeader>() { // from class: com.sma.smartv3.ui.device.DoubleClickSettingsActivity$itemHeader$2
        {
            super(0);
        }
        ...
        public final AbhSettingsHeader invoke() {
            return (AbhSettingsHeader) DoubleClickSettingsActivity.this.findViewById(R.id.item_header);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO itemTimeRange$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AbhSettingsItem>() { // from class: com.sma.smartv3.ui.device.DoubleClickSettingsActivity$itemTimeRange$2
        {
            super(0);
        }
        ...
        public final AbhSettingsItem invoke() {
            return (AbhSettingsItem) DoubleClickSettingsActivity.this.findViewById(R.id.item_time_range);
        }
    });

    @OXOo.OOXIXo
    private BleDoubleScreenSettings mDoubleScreenSettings = (BleDoubleScreenSettings) BleCache.getObjectNotNull$default(BleCache.INSTANCE, BleKey.DOUBLE_SCREEN, BleDoubleScreenSettings.class, null, null, 12, null);
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onDoubleScreenSettingsUpdate(@OXOo.OOXIXo BleDoubleScreenSettings doubleScreenSettings) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(doubleScreenSettings, "doubleScreenSettings");
            DoubleClickSettingsActivity.this.mDoubleScreenSettings = doubleScreenSettings;
            DoubleClickSettingsActivity.this.updateUI();
        }
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onReadDoubleScreenSettings(@OXOo.OOXIXo BleDoubleScreenSettings doubleScreenSettings) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(doubleScreenSettings, "doubleScreenSettings");
            DoubleClickSettingsActivity.this.mDoubleScreenSettings = doubleScreenSettings;
            DoubleClickSettingsActivity.this.updateUI();
        }
    ...
    public final void updateUI() {
        ...
        itemHeader.setChecked(oOXoIIIo.I0Io.II0xO0(this.mDoubleScreenSettings.getMBleTimeRange1().getMEnabled()));
        itemHeader.setMListener(new Oox.oOoXoXO<Boolean, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.DoubleClickSettingsActivity$updateUI$1$1
            {
                super(1);
            }
            ...
            public final void invoke(final boolean z) {
                ...
                final DoubleClickSettingsActivity doubleClickSettingsActivity = DoubleClickSettingsActivity.this;
                if (com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.DoubleClickSettingsActivity$updateUI$1$1.1
                    ...
                    public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                        BleDoubleScreenSettings bleDoubleScreenSettings;
                        BleDoubleScreenSettings bleDoubleScreenSettings2;
                        kotlin.jvm.internal.IIX0o.x0xO0oo(it, "it");
                        bleDoubleScreenSettings = DoubleClickSettingsActivity.this.mDoubleScreenSettings;
                        bleDoubleScreenSettings.getMBleTimeRange1().setMEnabled(oOXoIIIo.I0Io.I0Io(z));
                        BleKey bleKey = BleKey.DOUBLE_SCREEN;
                        BleKeyFlag bleKeyFlag = BleKeyFlag.UPDATE;
                        bleDoubleScreenSettings2 = DoubleClickSettingsActivity.this.mDoubleScreenSettings;
                        BleConnector.sendObject$default(it, bleKey, bleKeyFlag, bleDoubleScreenSettings2, false, false, 24, null);
                        com.sma.smartv3.util.x0xO0oo.II0xO0(com.sma.smartv3.util.x0xO0oo.f24651x0xO0oo, null, 2, null);
                    }
                }, 1, null)) {
                    return;
                }
                itemHeader2 = DoubleClickSettingsActivity.this.getItemHeader();
                itemHeader2.setChecked(!z);
            }
        });
        getItemTimeRange().setMRightText(TextConvertKt.xoxXI(this.mDoubleScreenSettings.getMBleTimeRange1().getMStartHour(), this.mDoubleScreenSettings.getMBleTimeRange1().getMStartMinute(), this.mDoubleScreenSettings.getMBleTimeRange1().getMEndHour(), this.mDoubleScreenSettings.getMBleTimeRange1().getMEndMinute(), ProjectManager.f19822oIX0oI.IO()));
    }
    ...
    public void initView() {
        ((TextView) findViewById(R.id.abh_title_center)).setText(R.string.double_click_screen);
        updateUI();
    }

    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_double_screen_settings;
    }
    ...
    public final void onSetTimeRange(@OXOo.OOXIXo View view) {
        ...
        if (this.mTimeRangePopup == null) {
            ...
            timeRangePopup.xI(new Oox.Oxx0xo<Integer, Integer, Integer, Integer, Boolean>() { // from class: com.sma.smartv3.ui.device.DoubleClickSettingsActivity$onSetTimeRange$1$1
                {
                    super(4);
                }
                ...
                public final Boolean invoke(final int i, final int i2, final int i3, final int i4) {
                    final DoubleClickSettingsActivity doubleClickSettingsActivity = DoubleClickSettingsActivity.this;
                    return Boolean.valueOf(com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.DoubleClickSettingsActivity$onSetTimeRange$1$1.1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
                        ...
                        public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                            ...
                            kotlin.jvm.internal.IIX0o.x0xO0oo(it, "it");
                            bleDoubleScreenSettings = DoubleClickSettingsActivity.this.mDoubleScreenSettings;
                            BleTimeRange mBleTimeRange1 = bleDoubleScreenSettings.getMBleTimeRange1();
                            int i5 = i;
                            int i6 = i2;
                            int i7 = i3;
                            int i8 = i4;
                            ...
                            bleDoubleScreenSettings2 = DoubleClickSettingsActivity.this.mDoubleScreenSettings;
                            BleConnector.sendObject$default(it, bleKey, bleKeyFlag, bleDoubleScreenSettings2, false, false, 24, null);
                            itemTimeRange = DoubleClickSettingsActivity.this.getItemTimeRange();
        ...
        if (timeRangePopup2 != null) {
            timeRangePopup2.oo0xXOI0I(this.mDoubleScreenSettings.getMBleTimeRange1().getMStartHour(), this.mDoubleScreenSettings.getMBleTimeRange1().getMStartMinute(), this.mDoubleScreenSettings.getMBleTimeRange1().getMEndHour(), this.mDoubleScreenSettings.getMBleTimeRange1().getMEndMinute());
