...
public final class WatchPasswordActivity extends BaseActivity {

    @OXOo.oOoXoXO
    private com.sma.smartv3.pop.XX0xXo mPasswordPopup;

    @OXOo.OOXIXo
    private final kotlin.X0IIOO rootView$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<View>() { // from class: com.sma.smartv3.ui.device.WatchPasswordActivity$rootView$2
        {
            super(0);
        }
        ...
        public final View invoke() {
            return WatchPasswordActivity.this.findViewById(R.id.root_view);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO itemHeader$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AbhSettingsHeader>() { // from class: com.sma.smartv3.ui.device.WatchPasswordActivity$itemHeader$2
        {
            super(0);
        }
        ...
        public final AbhSettingsHeader invoke() {
            return (AbhSettingsHeader) WatchPasswordActivity.this.findViewById(R.id.item_header);
        }
    });

    @OXOo.OOXIXo
    private BleSettingWatchPassword mWatchPassword = (BleSettingWatchPassword) BleCache.getObjectNotNull$default(BleCache.INSTANCE, BleKey.SET_WATCH_PASSWORD, BleSettingWatchPassword.class, null, null, 12, null);
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onWatchPasswordUpdate(@OXOo.OOXIXo BleSettingWatchPassword watchPassword) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(watchPassword, "watchPassword");
            WatchPasswordActivity.this.mWatchPassword = watchPassword;
            WatchPasswordActivity.this.updateUI();
        }
    ...
    public final void updateUI() {
        ...
        itemHeader.setChecked(oOXoIIIo.I0Io.II0xO0(this.mWatchPassword.getMEnabled()));
        itemHeader.setMListener(new Oox.oOoXoXO<Boolean, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.WatchPasswordActivity$updateUI$1$1
            {
                super(1);
            }
            ...
            public final void invoke(final boolean z) {
                ...
                final WatchPasswordActivity watchPasswordActivity = WatchPasswordActivity.this;
                if (com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.WatchPasswordActivity$updateUI$1$1.1
                    ...
                    public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                        BleSettingWatchPassword bleSettingWatchPassword;
                        BleSettingWatchPassword bleSettingWatchPassword2;
                        kotlin.jvm.internal.IIX0o.x0xO0oo(it, "it");
                        bleSettingWatchPassword = WatchPasswordActivity.this.mWatchPassword;
                        bleSettingWatchPassword.setMEnabled(oOXoIIIo.I0Io.I0Io(z));
                        BleKey bleKey = BleKey.SET_WATCH_PASSWORD;
                        BleKeyFlag bleKeyFlag = BleKeyFlag.UPDATE;
                        bleSettingWatchPassword2 = WatchPasswordActivity.this.mWatchPassword;
                        BleConnector.sendObject$default(it, bleKey, bleKeyFlag, bleSettingWatchPassword2, false, false, 24, null);
                        com.sma.smartv3.util.x0xO0oo.II0xO0(com.sma.smartv3.util.x0xO0oo.f24569IIX0o, null, 2, null);
                    }
                }, 1, null)) {
                    return;
                }
                itemHeader2 = WatchPasswordActivity.this.getItemHeader();
    ...
    public void initView() {
        ((TextView) findViewById(R.id.abh_title_center)).setText(R.string.watch_password);
        updateUI();
    }

    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_watch_password;
    }
    ...
    public final void onResetPassword(@OXOo.OOXIXo View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(view, "view");
        if (this.mPasswordPopup == null) {
            com.sma.smartv3.pop.XX0xXo xX0xXo = new com.sma.smartv3.pop.XX0xXo(getMContext());
            xX0xXo.xXxxox0I().setHint(getString(R.string.input_password));
            xX0xXo.oo(2);
            xX0xXo.xXxxox0I().setFilters(new InputFilter[]{new InputFilter.LengthFilter(4)});
            xX0xXo.xXxxox0I().setEnabled(false);
            xX0xXo.IoOoX(new Oox.oOoXoXO<String, Boolean>() { // from class: com.sma.smartv3.ui.device.WatchPasswordActivity$onResetPassword$1$1
                {
                    super(1);
                }
                ...
                @Override // Oox.oOoXoXO
                @OXOo.OOXIXo
                public final Boolean invoke(@OXOo.OOXIXo final String text) {
                    kotlin.jvm.internal.IIX0o.x0xO0oo(text, "text");
                    boolean z = false;
                    if (text.length() > 0 && text.length() == 4) {
                        final WatchPasswordActivity watchPasswordActivity = WatchPasswordActivity.this;
                        z = com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.WatchPasswordActivity$onResetPassword$1$1.1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(1);
                            }
                            ...
                            public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                                ...
                                kotlin.jvm.internal.IIX0o.x0xO0oo(it, "it");
                                bleSettingWatchPassword = WatchPasswordActivity.this.mWatchPassword;
                                bleSettingWatchPassword.setMPassword(text);
                                BleKey bleKey = BleKey.SET_WATCH_PASSWORD;
                                BleKeyFlag bleKeyFlag = BleKeyFlag.UPDATE;
                                bleSettingWatchPassword2 = WatchPasswordActivity.this.mWatchPassword;
                                BleConnector.sendObject$default(it, bleKey, bleKeyFlag, bleSettingWatchPassword2, false, false, 24, null);
            ...
            this.mPasswordPopup = xX0xXo;
        }
        com.sma.smartv3.pop.XX0xXo xX0xXo2 = this.mPasswordPopup;
        if (xX0xXo2 != null) {
            View rootView = getRootView();
            kotlin.jvm.internal.IIX0o.oO(rootView, "<get-rootView>(...)");
            xX0xXo2.OxxIIOOXO(rootView);
        }
    }
