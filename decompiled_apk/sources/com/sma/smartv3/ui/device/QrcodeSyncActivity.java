...
public final class QrcodeSyncActivity extends BaseActivity {
    ...
    @OXOo.OOXIXo
    private final kotlin.X0IIOO rootView$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<View>() { // from class: com.sma.smartv3.ui.device.QrcodeSyncActivity$rootView$2
        {
            super(0);
        }
        ...
        public final View invoke() {
            return QrcodeSyncActivity.this.findViewById(R.id.root_view);
        }
    });
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public void onStreamProgress(boolean z, int i, int i2, int i3, @OXOo.OOXIXo BleKey bleKey) {
            ...
            if (!z) {
                com.sma.smartv3.pop.I0X0x0oIo i0X0x0oIo = QrcodeSyncActivity.this.mLoadingPopup;
                if (i0X0x0oIo != null) {
                    i0X0x0oIo.dismiss();
                }
            ...
            if (i2 == i3) {
                com.sma.smartv3.pop.I0X0x0oIo i0X0x0oIo2 = QrcodeSyncActivity.this.mLoadingPopup;
                if (i0X0x0oIo2 != null) {
                    i0X0x0oIo2.dismiss();
                }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void syncQrcode(String str) {
        StringBuilder sb = new StringBuilder();
        sb.append("syncQrcode -> mQrcodeTypeInfo=");
        ...
        byte[] Oxx0IOOO2 = xIo0oOXIx.Oxx0IOOO(str, qrcodeTypeInfo3.getQrcodeType());
        if (Oxx0IOOO2 != null) {
            BleConnector bleConnector = BleConnector.INSTANCE;
            BleKey bleKey = BleKey.QRCODE;
            QrcodeTypeInfo qrcodeTypeInfo4 = this.mQrcodeTypeInfo;
            if (qrcodeTypeInfo4 == null) {
                kotlin.jvm.internal.IIX0o.XOxIOxOx("mQrcodeTypeInfo");
            } else {
                qrcodeTypeInfo2 = qrcodeTypeInfo4;
            }
            bleConnector.sendStream(bleKey, Oxx0IOOO2, qrcodeTypeInfo2.getQrcodeStreamType());
        }
    }
    ...
    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_qrcode_sync;
    }
    ...
    public void onActivityResult(int i, int i2, @OXOo.oOoXoXO Intent intent) {
        ...
        if (i2 == -1 && i == this.REQUEST_CODE) {
            ...
            showLoading();
            xoIXOxX.II0xO0.I0Io(false, false, null, null, 0, new QrcodeSyncActivity$onActivityResult$1(this, intent), 31, null);
        }
    }
    ...
    public final void onSelect(@OXOo.OOXIXo View v) {
        ...
        if (this.mSelectPopup == null) {
            ...
            xx0x0.xI(new Oox.oIX0oI<kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.QrcodeSyncActivity$onSelect$1$1
                {
                    super(0);
                }
                ...
                public final void invoke2() {
                    ...
                    final QrcodeSyncActivity qrcodeSyncActivity = QrcodeSyncActivity.this;
                    oOXoIIIo.X0o0xo.I0Io(permission, null, null, new Oox.oOoXoXO<PermissionStatus, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.QrcodeSyncActivity$onSelect$1$1.1
                        {
                            super(1);
                        }
                        ...
                        public final void invoke2(@OXOo.OOXIXo PermissionStatus it) {
                            ...
                            if (it == PermissionStatus.GRANTED) {
                                com.sma.smartv3.util.XIo0oOXIx xIo0oOXIx = com.sma.smartv3.util.XIo0oOXIx.f24335oIX0oI;
                                final QrcodeSyncActivity qrcodeSyncActivity2 = QrcodeSyncActivity.this;
                                com.sma.smartv3.util.XIo0oOXIx.OOXIXo(xIo0oOXIx, qrcodeSyncActivity2, false, new Oox.oOoXoXO<String, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.QrcodeSyncActivity.onSelect.1.1.1.1
                                    {
                                        super(1);
                                    }
                                    ...
                                    public final void invoke2(@OXOo.oOoXoXO String str) {
                                        com.sma.smartv3.pop.xx0X0 xx0x02;
                                        xx0x02 = QrcodeSyncActivity.this.mSelectPopup;
                                        if (xx0x02 != null) {
                                            xx0x02.dismiss();
                                        }
                                        QrcodeSyncActivity.this.showLoading();
                                        if (str != null) {
                                            QrcodeSyncActivity.this.syncQrcode(str);
                                        }
                                    }
                                }, 2, null);
                            }
            ...
            xx0x0.ooXIXxIX(new Oox.oIX0oI<kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.QrcodeSyncActivity$onSelect$1$2
                {
                    super(0);
                }
                ...
                public final void invoke2() {
                    ...
                    kotlin.jvm.internal.IIX0o.oO(permission, "permission(...)");
                    final QrcodeSyncActivity qrcodeSyncActivity = QrcodeSyncActivity.this;
                    oOXoIIIo.X0o0xo.I0Io(permission, null, null, new Oox.oOoXoXO<PermissionStatus, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.QrcodeSyncActivity$onSelect$1$2.1
                        {
                            super(1);
                        }
                        ...
                        public final void invoke2(@OXOo.OOXIXo PermissionStatus it) {
                            ...
                            if (it == PermissionStatus.GRANTED) {
                                ...
                                QrcodeSyncActivity qrcodeSyncActivity2 = QrcodeSyncActivity.this;
                                intent.setDataAndType(uri, "image/*");
                                i = qrcodeSyncActivity2.REQUEST_CODE;
                                qrcodeSyncActivity2.startActivityForResult(intent, i);
                            }
                        }
                    }, 3, null);
                }
