...
public final class GestureWake2SettingsActivity extends BaseActivity {

    @OXOo.oOoXoXO
    private TimeRangePopup mTimeRangePopup;

    @OXOo.OOXIXo
    private final kotlin.X0IIOO rootView$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<View>() { // from class: com.sma.smartv3.ui.device.GestureWake2SettingsActivity$rootView$2
        {
            super(0);
        }
        ...
        public final View invoke() {
            return GestureWake2SettingsActivity.this.findViewById(R.id.root);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO item_all_header$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AbhSettingsHeader>() { // from class: com.sma.smartv3.ui.device.GestureWake2SettingsActivity$item_all_header$2
        {
            super(0);
        }
        ...
        public final AbhSettingsHeader invoke() {
            return (AbhSettingsHeader) GestureWake2SettingsActivity.this.findViewById(R.id.item_all_header);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO itemHeader$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AbhSettingsHeader>() { // from class: com.sma.smartv3.ui.device.GestureWake2SettingsActivity$itemHeader$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final AbhSettingsHeader invoke() {
            return (AbhSettingsHeader) GestureWake2SettingsActivity.this.findViewById(R.id.item_header);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO itemTimeRange$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AbhSettingsItem>() { // from class: com.sma.smartv3.ui.device.GestureWake2SettingsActivity$itemTimeRange$2
        {
            super(0);
        }
        ...
        public final AbhSettingsItem invoke() {
            return (AbhSettingsItem) GestureWake2SettingsActivity.this.findViewById(R.id.item_time_range);
        }
    });

    @OXOo.OOXIXo
    private BleGestureWake2 mSettings = (BleGestureWake2) BleCache.getObjectNotNull$default(BleCache.INSTANCE, BleKey.GESTURE_WAKE2, BleGestureWake2.class, null, null, 12, null);
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onGestureWake2Update(@OXOo.OOXIXo BleGestureWake2 gestureWake2) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(gestureWake2, "gestureWake2");
            GestureWake2SettingsActivity.this.mSettings = gestureWake2;
            GestureWake2SettingsActivity.this.updateUI();
        }
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onReadGestureWake2(@OXOo.OOXIXo BleGestureWake2 gestureWake2) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(gestureWake2, "gestureWake2");
            GestureWake2SettingsActivity.this.mSettings = gestureWake2;
            GestureWake2SettingsActivity.this.updateUI();
        }
    ...
    public final void updateUI() {
        ...
        item_all_header.setChecked(oOXoIIIo.I0Io.II0xO0(this.mSettings.getMEnabled()));
        item_all_header.setMListener(new Oox.oOoXoXO<Boolean, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.GestureWake2SettingsActivity$updateUI$1$1
            {
                super(1);
            }
            ...
            public final void invoke(final boolean z) {
                ...
                final GestureWake2SettingsActivity gestureWake2SettingsActivity = GestureWake2SettingsActivity.this;
                if (com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.GestureWake2SettingsActivity$updateUI$1$1.1
                    ...
                    public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                        BleGestureWake2 bleGestureWake2;
                        BleGestureWake2 bleGestureWake22;
                        kotlin.jvm.internal.IIX0o.x0xO0oo(it, "it");
                        GestureWake2SettingsActivity.this.changeTimeRangeEnable(z);
                        bleGestureWake2 = GestureWake2SettingsActivity.this.mSettings;
                        bleGestureWake2.setMEnabled(oOXoIIIo.I0Io.I0Io(z));
                        BleKey bleKey = BleKey.GESTURE_WAKE2;
                        BleKeyFlag bleKeyFlag = BleKeyFlag.UPDATE;
                        bleGestureWake22 = GestureWake2SettingsActivity.this.mSettings;
                        BleConnector.sendObject$default(it, bleKey, bleKeyFlag, bleGestureWake22, false, false, 24, null);
                ...
                item_all_header2 = GestureWake2SettingsActivity.this.getItem_all_header();
        ...
        itemHeader.setMListener(new Oox.oOoXoXO<Boolean, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.GestureWake2SettingsActivity$updateUI$2$1
            {
                super(1);
            }
            ...
            public final void invoke(final boolean z) {
                ...
                final GestureWake2SettingsActivity gestureWake2SettingsActivity = GestureWake2SettingsActivity.this;
                if (com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.GestureWake2SettingsActivity$updateUI$2$1.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
                    ...
                    public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                        ...
                        kotlin.jvm.internal.IIX0o.x0xO0oo(it, "it");
                        bleGestureWake2 = GestureWake2SettingsActivity.this.mSettings;
                        bleGestureWake2.getMBleTimeRange1().setMEnabled(oOXoIIIo.I0Io.I0Io(z));
                        BleKey bleKey = BleKey.GESTURE_WAKE2;
                        BleKeyFlag bleKeyFlag = BleKeyFlag.UPDATE;
                        bleGestureWake22 = GestureWake2SettingsActivity.this.mSettings;
                        BleConnector.sendObject$default(it, bleKey, bleKeyFlag, bleGestureWake22, false, false, 24, null);
                ...
                itemHeader2 = GestureWake2SettingsActivity.this.getItemHeader();
        ...
        changeTimeRangeEnable(oOXoIIIo.I0Io.II0xO0(this.mSettings.getMEnabled()));
    }
    ...
    public void initView() {
        ((TextView) findViewById(R.id.abh_title_center)).setText(R.string.turn_the_wrist_screen);
        updateUI();
    }

    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_gesture_wake2_settings;
    }
    ...
    public final void onSetTimeRange(@OXOo.OOXIXo View view) {
        ...
        if (this.mTimeRangePopup == null) {
            ...
            timeRangePopup.xI(new Oox.Oxx0xo<Integer, Integer, Integer, Integer, Boolean>() { // from class: com.sma.smartv3.ui.device.GestureWake2SettingsActivity$onSetTimeRange$1$1
                {
                    super(4);
                }
                ...
                public final Boolean invoke(final int i, final int i2, final int i3, final int i4) {
                    final GestureWake2SettingsActivity gestureWake2SettingsActivity = GestureWake2SettingsActivity.this;
                    return Boolean.valueOf(com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.GestureWake2SettingsActivity$onSetTimeRange$1$1.1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
                        ...
                        public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                            ...
                            kotlin.jvm.internal.IIX0o.x0xO0oo(it, "it");
                            bleGestureWake2 = GestureWake2SettingsActivity.this.mSettings;
                            BleTimeRange mBleTimeRange1 = bleGestureWake2.getMBleTimeRange1();
                            int i5 = i;
                            int i6 = i2;
                            int i7 = i3;
                            int i8 = i4;
                            ...
                            bleGestureWake22 = GestureWake2SettingsActivity.this.mSettings;
                            BleConnector.sendObject$default(it, bleKey, bleKeyFlag, bleGestureWake22, false, false, 24, null);
                            itemTimeRange = GestureWake2SettingsActivity.this.getItemTimeRange();
