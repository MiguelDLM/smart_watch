...
public class BaseJLFileManageActivity extends BaseDSLRecyclerActivity {
    ...
    @OXOo.oOoXoXO
    private com.sma.smartv3.pop.XoI0Ixx0 mDeleteTipPopup;

    @OXOo.oOoXoXO
    private com.sma.smartv3.pop.I0X0x0oIo mLoadingPopup;
    private int mTotalListSize;
    private boolean openDeleteType;

    @OXOo.OOXIXo
    private String mSDCardName = "music";

    @OXOo.OOXIXo
    private final List<FileStruct> mFiles = new ArrayList();

    @OXOo.OOXIXo
    private final kotlin.X0IIOO recyclerViewTitle$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<View>() { // from class: com.sma.smartv3.ui.device.BaseJLFileManageActivity$recyclerViewTitle$2
        {
            super(0);
        }
        ...
        public final View invoke() {
            return BaseJLFileManageActivity.this.findViewById(R.id.audio_book_reclerview_title);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO openDeleteBtn$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<PFMedium>() { // from class: com.sma.smartv3.ui.device.BaseJLFileManageActivity$openDeleteBtn$2
        {
            super(0);
        }
        ...
        public final PFMedium invoke() {
            return (PFMedium) BaseJLFileManageActivity.this.findViewById(R.id.audio_book_open_delete_btn);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO leftBtn$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<Button>() { // from class: com.sma.smartv3.ui.device.BaseJLFileManageActivity$leftBtn$2
        {
            super(0);
        }
        ...
        public final Button invoke() {
            return (Button) BaseJLFileManageActivity.this.findViewById(R.id.audio_book_left_btn);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO rightBtn$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<Button>() { // from class: com.sma.smartv3.ui.device.BaseJLFileManageActivity$rightBtn$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final Button invoke() {
            return (Button) BaseJLFileManageActivity.this.findViewById(R.id.audio_book_right_btn);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvFreeSpace$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.device.BaseJLFileManageActivity$tvFreeSpace$2
        {
            super(0);
        }
        ...
        public final TextView invoke() {
            return (TextView) BaseJLFileManageActivity.this.findViewById(R.id.tv_free_space);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO taskPanel$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<View>() { // from class: com.sma.smartv3.ui.device.BaseJLFileManageActivity$taskPanel$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final View invoke() {
            return BaseJLFileManageActivity.this.findViewById(R.id.task_panel);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvProgress$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.device.BaseJLFileManageActivity$tvProgress$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final TextView invoke() {
            return (TextView) BaseJLFileManageActivity.this.findViewById(R.id.tv_progress);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvProgressTip$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.device.BaseJLFileManageActivity$tvProgressTip$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final TextView invoke() {
            return (TextView) BaseJLFileManageActivity.this.findViewById(R.id.tv_progress_tip);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO pbProgress$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<ProgressBar>() { // from class: com.sma.smartv3.ui.device.BaseJLFileManageActivity$pbProgress$2
        {
            super(0);
        }
        ...
        public final ProgressBar invoke() {
            return (ProgressBar) BaseJLFileManageActivity.this.findViewById(R.id.pb_progress);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvCancel$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<View>() { // from class: com.sma.smartv3.ui.device.BaseJLFileManageActivity$tvCancel$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final View invoke() {
            return BaseJLFileManageActivity.this.findViewById(R.id.tv_cancel);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvRetry$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<View>() { // from class: com.sma.smartv3.ui.device.BaseJLFileManageActivity$tvRetry$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final View invoke() {
            return BaseJLFileManageActivity.this.findViewById(R.id.tv_retry);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvTotalProgress$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.device.BaseJLFileManageActivity$tvTotalProgress$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final TextView invoke() {
            return (TextView) BaseJLFileManageActivity.this.findViewById(R.id.tv_total_progress);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvName$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.device.BaseJLFileManageActivity$tvName$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final TextView invoke() {
            return (TextView) BaseJLFileManageActivity.this.findViewById(R.id.tv_name);
        }
    });
    ...
    public static final class II0xO0 implements BleHandleCallback {
        ...
        public void onAppOpUpdate(@OXOo.OOXIXo BleAppOp appOp) {
            ...
            BleHandleCallback.DefaultImpls.onAppOpUpdate(this, appOp);
            BaseJLFileManageActivity.this.onAudioAppOpUpdate(appOp);
        }
        ...
        public void onCommandReply(@OXOo.OOXIXo BleKey bleKey, @OXOo.OOXIXo BleKeyFlag bleKeyFlag, boolean z) {
            ...
            if (bleKey == BleKey.FILE_PATH) {
                OI0.oIX0oI.f1507oIX0oI.oIX0oI(BaseJLFileManageActivity.this.TAG + " onCommandReply status = " + z);
                BaseJLFileManageActivity.this.deleteFilePath(z);
            }
        }
        ...
        public void onCommandSendTimeout(@OXOo.OOXIXo BleKey bleKey, @OXOo.OOXIXo BleKeyFlag bleKeyFlag) {
            ...
            if (bleKey == BleKey.FILE_PATH) {
                ToastUtils.showLong("Command Send Timeout", new Object[0]);
                BaseJLFileManageActivity.this.getTaskPanel().setVisibility(8);
                BaseJLFileManageActivity.this.getRecyclerView().setVisibility(0);
                BaseJLFileManageActivity.this.getRecyclerViewTitle().setVisibility(0);
                BaseJLFileManageActivity.this.getRightBtn().setVisibility(0);
            }
        }
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onReadFilePath(@OXOo.OOXIXo BleAppAudioBookList filePath) {
            int i;
            kotlin.jvm.internal.IIX0o.x0xO0oo(filePath, "filePath");
            BleHandleCallback.DefaultImpls.onReadFilePath(this, filePath);
            PFMedium openDeleteBtn = BaseJLFileManageActivity.this.getOpenDeleteBtn();
            if (filePath.getMCount() == 0) {
                i = 8;
            } else {
                i = 0;
            }
            openDeleteBtn.setVisibility(i);
            BaseJLFileManageActivity.this.upListData(filePath);
        }
        ...
        public void onReadSDCardInfo(@OXOo.OOXIXo BleSDCardInfo sdCardInfo) {
            ...
            BaseJLFileManageActivity.this.showFreeSpace();
        }
        ...
        public void onStreamProgress(boolean z, int i, int i2, int i3, @OXOo.OOXIXo BleKey bleKey) {
            ...
            if (i != 0) {
                ToastUtils.showLong("errorCode = " + i, new Object[0]);
                BaseJLFileManageActivity.this.getTaskPanel().setVisibility(8);
                BaseJLFileManageActivity.this.getRecyclerView().setVisibility(0);
                BaseJLFileManageActivity.this.getRecyclerViewTitle().setVisibility(0);
                BaseJLFileManageActivity.this.getRightBtn().setVisibility(0);
            ...
            if (i4 < 100) {
                TextView tvProgressTip = BaseJLFileManageActivity.this.getTvProgressTip();
                StringBuilder sb = new StringBuilder();
                AudioBookItem mAudioBookItem = BaseJLFileManageActivity.this.getMAudioBookItem();
                if (mAudioBookItem != null) {
                    str = mAudioBookItem.getName();
                } else {
                    str = null;
                }
                sb.append(str);
                sb.append(BaseJLFileManageActivity.this.getString(R.string.transfering));
                tvProgressTip.setText(sb.toString());
                BaseJLFileManageActivity.this.getTvName().setText(BaseJLFileManageActivity.this.getString(R.string.waiting));
                TextView tvTotalProgress = BaseJLFileManageActivity.this.getTvTotalProgress();
                StringBuilder sb2 = new StringBuilder();
                sb2.append(BaseJLFileManageActivity.this.getMCurListSize());
                sb2.append(IOUtils.DIR_SEPARATOR_UNIX);
                sb2.append(BaseJLFileManageActivity.this.getMTotalListSize());
                tvTotalProgress.setText(sb2.toString());
                BaseJLFileManageActivity.this.getPbProgress().setProgress(i4);
                TextView tvProgress = BaseJLFileManageActivity.this.getTvProgress();
                StringBuilder sb3 = new StringBuilder();
                sb3.append(i4);
                sb3.append(org.apache.log4j.helpers.x0XOIxOo.f33309xxIXOIIO);
                tvProgress.setText(sb3.toString());
                if (!BaseJLFileManageActivity.this.isTransfer()) {
                    BaseJLFileManageActivity.this.setTransfer(true);
                }
            }
        }
    ...
    public static final class oIX0oI extends SimpleFileObserver {
        ...
        public final /* synthetic */ String f21708I0Io;

        /* renamed from: II0xO0, reason: collision with root package name */
        public final /* synthetic */ SDCardBean f21709II0xO0;

        public oIX0oI(SDCardBean sDCardBean, String str) {
            this.f21709II0xO0 = sDCardBean;
            this.f21708I0Io = str;
        }
        ...
        public void onFileReadStop(boolean z) {
            ...
            FileBrowseManager.getInstance().removeFileObserver(this);
            BaseJLFileManageActivity.this.browToDir(this.f21709II0xO0, this.f21708I0Io);
        }
    ...
    public static /* synthetic */ void changeDeleteBtnText$default(BaseJLFileManageActivity baseJLFileManageActivity, int i, int i2, Object obj) {
        if (obj == null) {
            if ((i2 & 1) != 0) {
                i = 0;
            }
            baseJLFileManageActivity.changeDeleteBtnText(i);
            return;
        }
        throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: changeDeleteBtnText");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void dismissLoading$lambda$7(BaseJLFileManageActivity this$0) {
    ...
    private final Button getLeftBtn() {
        return (Button) this.leftBtn$delegate.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final PFMedium getOpenDeleteBtn() {
        return (PFMedium) this.openDeleteBtn$delegate.getValue();
    }

    private final void getSDCardInfo() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$2(BaseJLFileManageActivity this$0, View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        this$0.openDeleteType = !this$0.openDeleteType;
        this$0.deleteNum = 0;
        this$0.allSelect(false);
        this$0.changeActivityState();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$3(BaseJLFileManageActivity this$0, View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        this$0.allSelect(!this$0.isAllSelect);
    }

    private final void loadMore(SDCardBean sDCardBean) {
    ...
    public static /* synthetic */ void showDeleteTipPopup$default(BaseJLFileManageActivity baseJLFileManageActivity, int i, int i2, int i3, int i4, Object obj) {
        if (obj == null) {
            if ((i4 & 1) != 0) {
                i = R.string.tip;
            }
            ...
            baseJLFileManageActivity.showDeleteTipPopup(i, i2, i3);
            return;
        }
    ...
    public static /* synthetic */ void showLoading$default(BaseJLFileManageActivity baseJLFileManageActivity, boolean z, int i, Object obj) {
        if (obj == null) {
            if ((i & 1) != 0) {
                z = false;
            }
            baseJLFileManageActivity.showLoading(z);
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void showLoading$lambda$6(BaseJLFileManageActivity this$0, boolean z) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        if (this$0.mLoadingPopup == null) {
            com.sma.smartv3.pop.I0X0x0oIo i0X0x0oIo = new com.sma.smartv3.pop.I0X0x0oIo(this$0.getMContext());
            if (z) {
                i0X0x0oIo.xxX(Integer.valueOf(R.string.waiting));
            }
    ...
    public final void add() {
        doTransfer(new Oox.oIX0oI<kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.BaseJLFileManageActivity$add$1
            {
                super(0);
            }
            ...
            public final void invoke2() {
                BaseJLFileManageActivity.this.getFile();
            }
        });
    }
    ...
    public void allSelect(boolean z) {
        ...
        if (this.isAllSelect) {
            ...
            string = getString(R.string.text_select_all);
        }
        leftBtn.setText(string);
    }

    public final void changeActivityState() {
        String string;
        getDslAdapter().notifyDataChanged();
        int i = 0;
        changeDeleteBtnText$default(this, 0, 1, null);
        Button leftBtn = getLeftBtn();
        if (!this.openDeleteType) {
            i = 8;
        }
        leftBtn.setVisibility(i);
        PFMedium openDeleteBtn = getOpenDeleteBtn();
        if (this.openDeleteType) {
            string = getString(R.string.cancel);
        } else {
            string = getString(R.string.delete);
        }
        openDeleteBtn.setText(string);
    }

    public final void changeDeleteBtnText(int i) {
        String string;
        Button rightBtn = getRightBtn();
        if (!this.openDeleteType) {
            getLeftBtn().setVisibility(8);
            string = getString(R.string.audio_book_btn_add_files);
        } else if (i > 0) {
            string = getString(R.string.item_audio_book_learn_delete) + HexStringBuilder.COMMENT_BEGIN_CHAR + i + HexStringBuilder.COMMENT_END_CHAR;
        } else {
            string = getString(R.string.item_audio_book_learn_delete);
        }
    ...
    public final void dismissLoading() {
        runOnUiThread(new Runnable() { // from class: com.sma.smartv3.ui.device.Oxx0xo
            @Override // java.lang.Runnable
            public final void run() {
                BaseJLFileManageActivity.dismissLoading$lambda$7(BaseJLFileManageActivity.this);
            }
        });
    }

    public final boolean doTransfer(@OXOo.OOXIXo Oox.oIX0oI<kotlin.oXIO0o0XI> action) {
    ...
    @OXOo.oOoXoXO
    public final AudioBookItem getMAudioBookItem() {
        return this.mAudioBookItem;
    }

    public final int getMCurListSize() {
        return this.mCurListSize;
    }
    ...
    public final int getMTotalListSize() {
        return this.mTotalListSize;
    }

    public final boolean getOpenDeleteType() {
        return this.openDeleteType;
    }
    ...
    public final View getRecyclerViewTitle() {
        return (View) this.recyclerViewTitle$delegate.getValue();
    }

    public final Button getRightBtn() {
        return (Button) this.rightBtn$delegate.getValue();
    }
    ...
    public void initView() {
        ...
        getSDCardInfo();
        showFreeSpace();
        getOpenDeleteBtn().setOnClickListener(new View.OnClickListener() { // from class: com.sma.smartv3.ui.device.x0xO0oo
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                BaseJLFileManageActivity.initView$lambda$2(BaseJLFileManageActivity.this, view);
            }
        });
        getLeftBtn().setOnClickListener(new View.OnClickListener() { // from class: com.sma.smartv3.ui.device.IXxxXO
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                BaseJLFileManageActivity.initView$lambda$3(BaseJLFileManageActivity.this, view);
            }
        });
    ...
    public void onBackPressed() {
        if (doTransfer(new Oox.oIX0oI<kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.device.BaseJLFileManageActivity$onBackPressed$1
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2() {
            }
    ...
    public final void onCancel(@OXOo.OOXIXo View view) {
        ...
        xoI0Ixx0.xI(Integer.valueOf(R.string.cancel_transfer));
        xoI0Ixx0.oo0xXOI0I(1);
        xoI0Ixx0.X00IoxXI(Integer.valueOf(R.string.cancel), new Oox.oIX0oI<Boolean>() { // from class: com.sma.smartv3.ui.device.BaseJLFileManageActivity$onCancel$1$1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // Oox.oIX0oI
            @OXOo.OOXIXo
        ...
        xoI0Ixx0.x0o(R.string.confirm, new Oox.oIX0oI<Boolean>() { // from class: com.sma.smartv3.ui.device.BaseJLFileManageActivity$onCancel$1$2
            {
                super(0);
            }
    ...
    public final void setDeleteNum(int i) {
        this.deleteNum = i;
    }

    public final void setMAudioBookItem(@OXOo.oOoXoXO AudioBookItem audioBookItem) {
        this.mAudioBookItem = audioBookItem;
    }

    public final void setMCurListSize(int i) {
        this.mCurListSize = i;
    }
    ...
    public final void setMSDCardName(@OXOo.OOXIXo String str) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(str, "<set-?>");
        this.mSDCardName = str;
    }

    public final void setMTotalListSize(int i) {
        this.mTotalListSize = i;
    }

    public final void setOpenDeleteType(boolean z) {
        this.openDeleteType = z;
    }
    ...
    public final void showDeleteTipPopup(int i, int i2, int i3) {
        if (this.mDeleteTipPopup == null) {
            ...
            xoI0Ixx0.oo0xXOI0I(1);
            xoI0Ixx0.X00IoxXI(Integer.valueOf(R.string.cancel), new Oox.oIX0oI<Boolean>() { // from class: com.sma.smartv3.ui.device.BaseJLFileManageActivity$showDeleteTipPopup$1$1
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // Oox.oIX0oI
                @OXOo.OOXIXo
                public final Boolean invoke() {
            ...
            xoI0Ixx0.x0o(i3, new Oox.oIX0oI<Boolean>() { // from class: com.sma.smartv3.ui.device.BaseJLFileManageActivity$showDeleteTipPopup$1$2
                {
                    super(0);
                }
                ...
                @OXOo.OOXIXo
                public final Boolean invoke() {
                    BaseJLFileManageActivity.this.confirmDeleteFile();
                    return Boolean.TRUE;
                }
            });
            this.mDeleteTipPopup = xoI0Ixx0;
        }
        com.sma.smartv3.pop.XoI0Ixx0 xoI0Ixx02 = this.mDeleteTipPopup;
        if (xoI0Ixx02 != null) {
            xoI0Ixx02.IIXOooo();
        }
    }
    ...
    public final void showLoading(final boolean z) {
        runOnUiThread(new Runnable() { // from class: com.sma.smartv3.ui.device.oI0IIXIo
            @Override // java.lang.Runnable
            public final void run() {
                BaseJLFileManageActivity.showLoading$lambda$6(BaseJLFileManageActivity.this, z);
            }
        });
    }
