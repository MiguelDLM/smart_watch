...
import com.sma.smartv3.ui.me.DeveloperUpgradeZActivity;
...
@kotlin.jvm.internal.XX({"SMAP\nDeveloperUpgradeZActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperUpgradeZActivity.kt\ncom/sma/smartv3/ui/me/DeveloperUpgradeZActivity\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n*L\n1#1,406:1\n19#2:407\n15#2:408\n15#2:409\n11#2,2:410\n*S KotlinDebug\n*F\n+ 1 DeveloperUpgradeZActivity.kt\ncom/sma/smartv3/ui/me/DeveloperUpgradeZActivity\n*L\n50#1:407\n50#1:408\n151#1:409\n229#1:410,2\n*E\n"})
/* loaded from: classes11.dex */
public final class DeveloperUpgradeZActivity extends BaseFirmwareUpgradeActivity {
    ...
    @OXOo.OOXIXo
    private final I0Io mBluetoothEventListener;
    ...
    @OXOo.OOXIXo
    private final oxoX mOTAEventListener;
    ...
    /* loaded from: classes11.dex */
    public static final class I0Io implements BluetoothEventListener {

        @kotlin.jvm.internal.XX({"SMAP\nTimer.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Timer.kt\nkotlin/concurrent/TimersKt$timerTask$1\n+ 2 DeveloperUpgradeZActivity.kt\ncom/sma/smartv3/ui/me/DeveloperUpgradeZActivity$mBluetoothEventListener$1\n*L\n1#1,148:1\n94#2,4:149\n*E\n"})
        /* loaded from: classes11.dex */
        public static final class oIX0oI extends TimerTask {

            /* renamed from: XO, reason: collision with root package name */
            public final /* synthetic */ DeveloperUpgradeZActivity f23299XO;

            public oIX0oI(DeveloperUpgradeZActivity developerUpgradeZActivity) {
                this.f23299XO = developerUpgradeZActivity;
            }

            @Override // java.util.TimerTask, java.lang.Runnable
            public void run() {
                BleManager bleManager = this.f23299XO.mBluetoothManager;
                if (bleManager != null && bleManager.isReady()) {
                    ABOta aBOta = this.f23299XO.mAbOta;
                    if (aBOta == null || !aBOta.isUpdating()) {
                        DeveloperUpgradeZActivity developerUpgradeZActivity = this.f23299XO;
                        StringBuilder sb = new StringBuilder();
                        sb.append(com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(X00IoxXI.oIX0oI.f3233oIX0oI));
                        sb.append(IOUtils.DIR_SEPARATOR_UNIX);
                        FirmwareVersion firmwareVersion = this.f23299XO.mLatestFirmware;
                        kotlin.jvm.internal.IIX0o.ooOOo0oXI(firmwareVersion);
                        sb.append(firmwareVersion.getFileName());
                        developerUpgradeZActivity.startOTA(sb.toString());
                    }
                }
            }
        }
        ...
        public static final void II0xO0(DeveloperUpgradeZActivity this$0) {
        ...
        public void onBluetoothReady() {
            OI0.oIX0oI.f1507oIX0oI.oIX0oI(DeveloperUpgradeZActivity.this.TAG + " onBluetoothReady");
            ABOta aBOta = DeveloperUpgradeZActivity.this.mAbOta;
            if (aBOta != null) {
                aBOta.prepareToUpdate();
            }
            new Timer().schedule(new oIX0oI(DeveloperUpgradeZActivity.this), ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS);
        }

        @Override // com.bluetrum.abota.bluetooth.BluetoothEventListener
        public void onConnectionStateChange(@OXOo.oOoXoXO BluetoothGatt bluetoothGatt, int i, int i2) {
            if (i2 == 0) {
                OI0.oIX0oI.f1507oIX0oI.oIX0oI(DeveloperUpgradeZActivity.this.TAG + " onConnectionStateChange -> disconnected");
                final DeveloperUpgradeZActivity developerUpgradeZActivity = DeveloperUpgradeZActivity.this;
                developerUpgradeZActivity.runOnUiThread(new Runnable() { // from class: com.sma.smartv3.ui.me.IOOoXo0Ix
                    @Override // java.lang.Runnable
                    public final void run() {
                        DeveloperUpgradeZActivity.I0Io.II0xO0(DeveloperUpgradeZActivity.this);
                    }
                });
            }
        }
    ...
    public static final class II0xO0 implements BleHandleCallback {
        ...
        public static final void I0Io(final DeveloperUpgradeZActivity this$0) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
            ...
            new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.XOxoX
                @Override // java.lang.Runnable
                public final void run() {
                    DeveloperUpgradeZActivity.II0xO0.oxoX(DeveloperUpgradeZActivity.this);
                }
            }, 5000L);
        }

        public static final void oxoX(DeveloperUpgradeZActivity this$0) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        ...
        public void onCommandReply(@OXOo.OOXIXo BleKey bleKey, @OXOo.OOXIXo BleKeyFlag bleKeyFlag, boolean z) {
            ...
            if (bleKey == BleKey.SHUTDOWN) {
                com.sma.smartv3.pop.I0X0x0oIo i0X0x0oIo = DeveloperUpgradeZActivity.this.mLoadingPopup;
                if (i0X0x0oIo != null) {
                    i0X0x0oIo.dismiss();
                }
                OI0.oIX0oI.f1507oIX0oI.oIX0oI(DeveloperUpgradeZActivity.this.TAG + " shutdown success");
                DeveloperUpgradeZActivity.this.upgradeExit();
            }
        }
        ...
        public void onDeviceConnected(@OXOo.OOXIXo BluetoothDevice device) {
            ...
            OI0.oIX0oI.f1507oIX0oI.oIX0oI(DeveloperUpgradeZActivity.this.TAG + " onDeviceConnected " + DeveloperUpgradeZActivity.this.isStartShutdown);
            if (DeveloperUpgradeZActivity.this.isStartShutdown) {
                Handler handler = new Handler();
                final DeveloperUpgradeZActivity developerUpgradeZActivity = DeveloperUpgradeZActivity.this;
                handler.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.xIXIOX
                    @Override // java.lang.Runnable
                    public final void run() {
                        DeveloperUpgradeZActivity.II0xO0.I0Io(DeveloperUpgradeZActivity.this);
                    }
                }, 4000L);
            }
        }
    ...
    public /* synthetic */ class oIX0oI {
        ...
        public static final /* synthetic */ int[] f23301oIX0oI;
    ...
    /* loaded from: classes11.dex */
    public static final class oxoX implements ABOta.EventListener {
        public oxoX() {
        }
        ...
        public void onReceiveVersion(int i) {
            ...
            OI0.oIX0oI.f1507oIX0oI.oIX0oI(DeveloperUpgradeZActivity.this.TAG + " onReceiveVersion -> " + format);
        }

        @Override // com.bluetrum.fota.abota.ABOta.EventListener
        public void onStatusChanged(int i, int i2) {
            OI0.oIX0oI.f1507oIX0oI.oIX0oI(DeveloperUpgradeZActivity.this.TAG + " onStatusChanged -> " + i + ", " + i2);
            switch (i) {
                case 0:
                    DeveloperUpgradeZActivity.this.otaReady();
                    return;
                case 1:
                    DeveloperUpgradeZActivity.this.otaStart();
                    return;
                case 2:
                    DeveloperUpgradeZActivity.this.otaUpdating(i2);
                    return;
                case 3:
                    DeveloperUpgradeZActivity.this.otaPause();
                    return;
                case 4:
                    DeveloperUpgradeZActivity.this.otaContinue();
                    return;
                case 5:
                    DeveloperUpgradeZActivity.this.otaFinish();
                    return;
                case 6:
                    DeveloperUpgradeZActivity.this.otaWaitFinish();
                    return;
                case 7:
                    DeveloperUpgradeZActivity.this.otaStatusFail(i2);
                    return;
                default:
                    return;
            }
    ...
    public DeveloperUpgradeZActivity() {
        ...
        this.mBluetoothEventListener = new I0Io();
        this.mOTAEventListener = new oxoX();
    ...
    private final void initOTA() {
        BleManager bleManager = new BleManager(this, BluetoothAdapter.getDefaultAdapter().getRemoteDevice(this.deviceAddress));
    ...
    public final void otaUpdating(final int i) {
        runOnUiThread(new Runnable() { // from class: com.sma.smartv3.ui.me.x0oxIIIX
            @Override // java.lang.Runnable
            public final void run() {
                DeveloperUpgradeZActivity.otaUpdating$lambda$3(DeveloperUpgradeZActivity.this, i);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void otaUpdating$lambda$3(DeveloperUpgradeZActivity this$0, int i) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
    ...
    public final void updateUpgradeStatus(boolean z, String str) {
        if (z) {
            if (this.autoRetryCount < 1) {
                OI0.oIX0oI.f1507oIX0oI.oIX0oI(this.TAG + " wait to retry Upgrade -> autoRetryCount = " + this.autoRetryCount);
                new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.oX000x
                    @Override // java.lang.Runnable
                    public final void run() {
                        DeveloperUpgradeZActivity.updateUpgradeStatus$lambda$2(DeveloperUpgradeZActivity.this);
                    }
                }, 3000L);
                return;
            }
    ...
    public static /* synthetic */ void updateUpgradeStatus$default(DeveloperUpgradeZActivity developerUpgradeZActivity, boolean z, String str, int i, Object obj) {
        if ((i & 2) != 0) {
            str = "";
        }
        developerUpgradeZActivity.updateUpgradeStatus(z, str);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void updateUpgradeStatus$lambda$2(DeveloperUpgradeZActivity this$0) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
    ...
    private final void upgrade() {
        ...
        if (oIX0oI.f23301oIX0oI[this.mSteps.get(this.mStepsIndex).ordinal()] == 1) {
    ...
    private final void upgradeDone() {
        if (this.isAutoShutdown) {
            ...
            new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.xIOXX
                @Override // java.lang.Runnable
                public final void run() {
                    DeveloperUpgradeZActivity.upgradeDone$lambda$0(DeveloperUpgradeZActivity.this);
                }
            }, 25000L);
            ...
            if (bleConnector.isAvailable()) {
                ...
                new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.IxIo
                    @Override // java.lang.Runnable
                    public final void run() {
                        DeveloperUpgradeZActivity.upgradeDone$lambda$1(DeveloperUpgradeZActivity.this);
                    }
                }, 10000L);
                return;
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void upgradeDone$lambda$0(DeveloperUpgradeZActivity this$0) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        com.sma.smartv3.pop.I0X0x0oIo i0X0x0oIo = this$0.mLoadingPopup;
        if (i0X0x0oIo != null && i0X0x0oIo.isShowing()) {
            ...
            LogUtils.d("shutdown time out force exit!");
            this$0.upgradeExit();
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void upgradeDone$lambda$1(DeveloperUpgradeZActivity this$0) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        BleConnector bleConnector = BleConnector.INSTANCE;
    ...
    public void initView() {
        ...
        if (firmwareVersion == null) {
            getTvLatest().setText(getString(R.string.v_s, this.mCurrentFirmware));
            ...
            getTvLatest().setText(getString(R.string.v_s, firmwareVersion.getVersion()));
            getTvCurrent().setText(getString(R.string.v_s, this.mCurrentFirmware));
    ...
    public final void onBottomClick(@OXOo.OOXIXo View view) {
        ...
        if (this.mStepsIndex == 0) {
            FirmwareVersion firmwareVersion = this.mLatestFirmware;
            if (firmwareVersion != null) {
                NetWorkUtils.INSTANCE.download(firmwareVersion.getFileUrl(), com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(X00IoxXI.oIX0oI.f3233oIX0oI), this.mLatestFirmware.getFileName(), new HttpProgressCallback<String>() { // from class: com.sma.smartv3.ui.me.DeveloperUpgradeZActivity$onBottomClick$1
                    @Override // xxxI.II0xO0
                    public void handleError(@OXOo.OOXIXo String error) {
                        kotlin.jvm.internal.IIX0o.x0xO0oo(error, "error");
                        DeveloperUpgradeZActivity.this.mDownloaded = 0;
                        DeveloperUpgradeZActivity.this.setMStarted(false);
                    }
                    ...
                    public void handleResponse(@OXOo.oOoXoXO String str) {
                        int i;
                        DeveloperUpgradeZActivity developerUpgradeZActivity = DeveloperUpgradeZActivity.this;
                        i = developerUpgradeZActivity.mDownloaded;
                        developerUpgradeZActivity.mDownloaded = i + 1;
                        DeveloperUpgradeZActivity.this.checkDownload();
                    }
                });
                return;
            }
