...
public final class DeveloperFileSystemTestActivity extends BaseActivity {
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public void onCommandSendTimeout(@OXOo.OOXIXo BleKey bleKey, @OXOo.OOXIXo BleKeyFlag bleKeyFlag) {
            ...
            if (bleKey == BleKey.FAT_BIN_FILE) {
                DeveloperFileSystemTestActivity.syncFailed$default(DeveloperFileSystemTestActivity.this, 0, 1, null);
            }
        }
        ...
        public void onSessionStateChange(boolean z) {
            if (!z && DeveloperFileSystemTestActivity.this.mProgressPop != null) {
                DeveloperFileSystemTestActivity.syncFailed$default(DeveloperFileSystemTestActivity.this, 0, 1, null);
            }
        }
        ...
        public void onStreamProgress(boolean z, int i, int i2, int i3, @OXOo.OOXIXo BleKey bleKey) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(bleKey, "bleKey");
            if (z) {
                com.sma.smartv3.pop.xOOOX xooox = DeveloperFileSystemTestActivity.this.mProgressPop;
                if (xooox != null) {
                    xooox.XIxXXX0x0((int) ((i3 / i2) * 100));
                }
                if (i2 == i3) {
                    com.sma.smartv3.pop.xOOOX xooox2 = DeveloperFileSystemTestActivity.this.mProgressPop;
                    if (xooox2 != null) {
                        xooox2.dismiss();
                    }
                    DeveloperFileSystemTestActivity.this.mProgressPop = null;
                    ToastUtils.showLong("同步完成", new Object[0]);
                    return;
                }
                return;
            }
            DeveloperFileSystemTestActivity.this.syncFailed(i);
        }
    ...
    public static /* synthetic */ void syncFailed$default(DeveloperFileSystemTestActivity developerFileSystemTestActivity, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = 0;
        }
        developerFileSystemTestActivity.syncFailed(i);
    }
    ...
    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_developer_file_system_test;
    }
    ...
    public void onActivityResult(int i, int i2, @OXOo.oOoXoXO Intent intent) {
        ...
        if (i2 == -1 && intent != null && (data = intent.getData()) != null && (openInputStream = getContentResolver().openInputStream(data)) != null && this.mProgressPop == null) {
            ...
            xooox.IIXOooo();
            BleConnector.sendStream$default(BleConnector.INSTANCE, BleKey.FAT_BIN_FILE, openInputStream, 0, 4, (Object) null);
        }
    }
