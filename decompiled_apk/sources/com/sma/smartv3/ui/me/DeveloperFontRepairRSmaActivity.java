...
import com.sma.smartv3.ui.device.BaseFirmwareRepairActivity;
...
public final class DeveloperFontRepairRSmaActivity extends BaseFirmwareRepairActivity {
    ...
    public static final class II0xO0 implements BleHandleCallback {
        ...
        public void onCommandSendTimeout(@OXOo.OOXIXo BleKey bleKey, @OXOo.OOXIXo BleKeyFlag bleKeyFlag) {
            ...
            if (bleKey == bleKey2) {
                DeveloperFontRepairRSmaActivity.this.setMStarted(false);
                DeveloperFontRepairRSmaActivity.this.getTvTip().setText(com.sma.smartv3.util.oO.f24511oIX0oI.X0o0xo());
        ...
        public void onStreamProgress(boolean z, int i, int i2, int i3, @OXOo.OOXIXo BleKey bleKey) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(bleKey, "bleKey");
            if (z) {
                DeveloperFontRepairRSmaActivity.this.getDfuProgress().setProgress(i3 / i2);
                if (i2 == i3) {
                    DeveloperFontRepairRSmaActivity.this.finish();
                    return;
                }
                return;
            }
            LogUtils.e("FirmwareUpgradeRActivity onError: status=" + z + ", errorCode=" + i);
            DeveloperFontRepairRSmaActivity.this.setMStarted(false);
            DeveloperFontRepairRSmaActivity.this.getTvTip().setText(com.sma.smartv3.util.oO.f24511oIX0oI.X0o0xo());
    ...
    public static final void initView$lambda$0(DeveloperFontRepairRSmaActivity this$0, View view) {
    ...
    private final void upgrade() {
        ...
        if (TextUtils.isEmpty(getMArg0())) {
            LogUtils.d("android_asset def file -> " + getMArg0());
            BleKey bleKey = BleKey.FONT_FILE;
            InputStream open = getAssets().open("firmware_font/" + ProductManager.f20544oIX0oI.XoX());
            kotlin.jvm.internal.IIX0o.oO(open, "open(...)");
            BleConnector.sendStream$default(bleConnector, bleKey, open, 0, 4, (Object) null);
            return;
        }
        String mArg0 = getMArg0();
        kotlin.jvm.internal.IIX0o.ooOOo0oXI(mArg0);
        if (!StringsKt__StringsKt.o00xOoIO(mArg0, "file", false, 2, null)) {
            String mArg02 = getMArg0();
            kotlin.jvm.internal.IIX0o.ooOOo0oXI(mArg02);
            if (!StringsKt__StringsKt.o00xOoIO(mArg02, "content", false, 2, null)) {
                LogUtils.d("android_asset file -> " + getMArg0());
                BleKey bleKey2 = BleKey.FONT_FILE;
                InputStream open2 = getAssets().open("firmware_font/" + getMArg0());
                kotlin.jvm.internal.IIX0o.oO(open2, "open(...)");
                BleConnector.sendStream$default(bleConnector, bleKey2, open2, 0, 4, (Object) null);
                return;
            }
        }
        LogUtils.d("file -> " + getMArg0());
        InputStream openInputStream = getContentResolver().openInputStream(Uri.parse(getMArg0()));
        if (openInputStream != null) {
            BleConnector.sendStream$default(bleConnector, BleKey.FONT_FILE, openInputStream, 0, 4, (Object) null);
        }
    }
    ...
    public void initView() {
        ...
        if (TextUtils.isEmpty(getMArg0())) {
            available = getAssets().open("firmware_font/" + ProductManager.f20544oIX0oI.XoX()).available();
        } else {
            String mArg0 = getMArg0();
            kotlin.jvm.internal.IIX0o.ooOOo0oXI(mArg0);
            if (!StringsKt__StringsKt.o00xOoIO(mArg0, "file", false, 2, null)) {
                ...
                kotlin.jvm.internal.IIX0o.ooOOo0oXI(mArg02);
                if (!StringsKt__StringsKt.o00xOoIO(mArg02, "content", false, 2, null)) {
                    available = getAssets().open("firmware_font/" + getMArg0()).available();
                }
            }
            InputStream openInputStream = getContentResolver().openInputStream(Uri.parse(getMArg0()));
            if (openInputStream != null) {
                ...
                getTvTip().setOnClickListener(new View.OnClickListener() { // from class: com.sma.smartv3.ui.me.o0
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        DeveloperFontRepairRSmaActivity.initView$lambda$0(DeveloperFontRepairRSmaActivity.this, view);
                    }
                });
                upgrade();
            }
