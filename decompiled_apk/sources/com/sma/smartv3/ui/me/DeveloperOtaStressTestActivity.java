...
import com.sma.smartv3.ui.device.FirmwareUpgradeSActivity;
...
@kotlin.jvm.internal.XX({"SMAP\nDeveloperOtaStressTestActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperOtaStressTestActivity.kt\ncom/sma/smartv3/ui/me/DeveloperOtaStressTestActivity\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n+ 3 View.kt\nandroidx/core/view/ViewKt\n+ 4 Activity.kt\ncom/bestmafen/androidbase/extension/ActivityKt\n+ 5 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,271:1\n19#2:272\n15#2:273\n27#2,2:274\n11#2,2:276\n256#3,2:278\n256#3,2:280\n256#3,2:282\n256#3,2:284\n69#4,3:286\n72#4,5:290\n1#5:289\n*S KotlinDebug\n*F\n+ 1 DeveloperOtaStressTestActivity.kt\ncom/sma/smartv3/ui/me/DeveloperOtaStressTestActivity\n*L\n120#1:272\n120#1:273\n176#1:274,2\n177#1:276,2\n221#1:278,2\n222#1:280,2\n224#1:282,2\n225#1:284,2\n242#1:286,3\n242#1:290,5\n242#1:289\n*E\n"})
/* loaded from: classes11.dex */
public final class DeveloperOtaStressTestActivity extends BaseListActivity<FirmwareVersion> {
    ...
    @OXOo.OOXIXo
    private final String TAG = "OtaStressTest";

    @OXOo.OOXIXo
    private final kotlin.X0IIOO btStart$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AppCompatButton>() { // from class: com.sma.smartv3.ui.me.DeveloperOtaStressTestActivity$btStart$2
        {
            super(0);
        }
        ...
        public final AppCompatButton invoke() {
            return (AppCompatButton) DeveloperOtaStressTestActivity.this.findViewById(R.id.bt_start);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO btStop$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AppCompatButton>() { // from class: com.sma.smartv3.ui.me.DeveloperOtaStressTestActivity$btStop$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final AppCompatButton invoke() {
            return (AppCompatButton) DeveloperOtaStressTestActivity.this.findViewById(R.id.bt_stop);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO etTestTime$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<EditText>() { // from class: com.sma.smartv3.ui.me.DeveloperOtaStressTestActivity$etTestTime$2
        {
            super(0);
        }
        ...
        public final EditText invoke() {
            return (EditText) DeveloperOtaStressTestActivity.this.findViewById(R.id.et_test_time);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvStatus$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.me.DeveloperOtaStressTestActivity$tvStatus$2
        {
            super(0);
        }
        ...
        public final TextView invoke() {
            return (TextView) DeveloperOtaStressTestActivity.this.findViewById(R.id.tv_status);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO cbSkipCheckBox$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<CheckBox>() { // from class: com.sma.smartv3.ui.me.DeveloperOtaStressTestActivity$cbSkipCheckBox$2
        {
            super(0);
        }
        ...
        public final CheckBox invoke() {
            return (CheckBox) DeveloperOtaStressTestActivity.this.findViewById(R.id.cb_skip_failed);
        }
    });

    @OXOo.OOXIXo
    private List<FirmwareVersion> mTestFirmwareList = new ArrayList();
    private int mTotalTestTime = 1;
    ...
    @OXOo.OOXIXo
    private final Runnable mConnectedFailRunnable = new Runnable() { // from class: com.sma.smartv3.ui.me.xoO0xx0
        @Override // java.lang.Runnable
        public final void run() {
            DeveloperOtaStressTestActivity.mConnectedFailRunnable$lambda$2(DeveloperOtaStressTestActivity.this);
        }
    };

    @kotlin.jvm.internal.XX({"SMAP\nDeveloperOtaStressTestActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperOtaStressTestActivity.kt\ncom/sma/smartv3/ui/me/DeveloperOtaStressTestActivity$mBleHandleCallback$1\n+ 2 View.kt\nandroidx/core/view/ViewKt\n*L\n1#1,271:1\n254#2:272\n254#2:273\n*S KotlinDebug\n*F\n+ 1 DeveloperOtaStressTestActivity.kt\ncom/sma/smartv3/ui/me/DeveloperOtaStressTestActivity$mBleHandleCallback$1\n*L\n92#1:272\n102#1:273\n*E\n"})
    /* loaded from: classes11.dex */
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public void onCommandSendTimeout(@OXOo.OOXIXo BleKey bleKey, @OXOo.OOXIXo BleKeyFlag bleKeyFlag) {
            ...
            if (bleKey == BleKey.PACKAGE_STATUS) {
                DeveloperOtaStressTestActivity.this.testFailed("BleKey.PACKAGE_STATUS send timeout");
            }
        }
        ...
        public void onDeviceConnecting(boolean z) {
            if (z) {
                ToastUtils.showLong(R.string.device_connecting);
            }
        }
        ...
        public void onReadPackageStatus(@OXOo.OOXIXo BlePackageStatus packageStatus) {
            ...
            AppCompatButton btStop = DeveloperOtaStressTestActivity.this.getBtStop();
            kotlin.jvm.internal.IIX0o.oO(btStop, "access$getBtStop(...)");
            if (btStop.getVisibility() == 0) {
                if (packageStatus.getMUIPackageStatus() == 1) {
                    DeveloperOtaStressTestActivity.this.testFailed("ui error");
                } else {
                    if (packageStatus.getMFontPackageStatus() == 1) {
                        DeveloperOtaStressTestActivity.this.testFailed("font error");
                        return;
                    }
                    DeveloperOtaStressTestActivity.this.mCurTestSuccessTime++;
                    DeveloperOtaStressTestActivity.this.startNextTest();
                }
            }
        }
        ...
        public void onSessionStateChange(boolean z) {
            if (z) {
                DeveloperOtaStressTestActivity.this.mHandler.removeCallbacks(DeveloperOtaStressTestActivity.this.mConnectedFailRunnable);
                ToastUtils.showLong(R.string.device_connectied);
                AppCompatButton btStop = DeveloperOtaStressTestActivity.this.getBtStop();
                kotlin.jvm.internal.IIX0o.oO(btStop, "access$getBtStop(...)");
                if (btStop.getVisibility() == 0 && !ProductManager.f20544oIX0oI.IIoX0OoI()) {
    ...
    private final void changeStatus() {
        getTvStatus().setText("当前测试" + this.mCurTestTime + "次，成功" + this.mCurTestSuccessTime + "次，失败" + this.mCurTestFailedTime + (char) 27425);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final EditText getEtTestTime() {
        return (EditText) this.etTestTime$delegate.getValue();
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void mConnectedFailRunnable$lambda$2(DeveloperOtaStressTestActivity this$0) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        if (!BleConnector.INSTANCE.isAvailable()) {
            OI0.oIX0oI.f1507oIX0oI.oIX0oI(this$0.TAG + " testFailed -> The device connection is abnormal");
            this$0.mCurTestFailedTime = this$0.mCurTestFailedTime + 1;
            this$0.changeBtn(false);
            this$0.changeStatus();
            this$0.getTvStatus().append("\n设备连接异常");
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void startNextTest() {
        if (this.mCurTestTime >= this.mTotalTestTime) {
            OI0.oIX0oI.f1507oIX0oI.oIX0oI(this.TAG + " -> Test done!");
            changeBtn(false);
            ToastUtils.showLong("压测结束", new Object[0]);
            changeStatus();
            getTvStatus().append("\n压测结束");
            return;
        }
    ...
    public final void startTest() {
        if (BleInitializer.f20700XO.OOXIxO0()) {
            OI0.oIX0oI.f1507oIX0oI.oIX0oI(this.TAG + " startTest -> Upgrading");
            return;
        }
        this.mCurTestTime++;
        this.isSkipFailed = getCbSkipCheckBox().isChecked();
        int size = this.mCurTestTime % this.mTestFirmwareList.size();
        com.sma.smartv3.util.Xo0 xo0 = com.sma.smartv3.util.Xo0.f24349oIX0oI;
        xo0.II0xO0().remove(ExtraPackVersions.class.getName());
        xo0.II0xO0().put(FirmwareVersion.class.getName(), new Gson().toJson(this.mTestFirmwareList.get(size)));
        OI0.oIX0oI.f1507oIX0oI.oIX0oI(this.TAG + " startTest -> isSkipFailed:" + this.isSkipFailed + ", mCurTestTime:" + this.mCurTestTime + ", mTotalTestTime:" + this.mTotalTestTime + ", " + this.mTestFirmwareList.get(size));
        toFirmwareUpdate();
    }
    ...
    public final void testFailed(String str) {
        ...
        if (this.isSkipFailed) {
            ...
            new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.OX00O0xII
                @Override // java.lang.Runnable
                public final void run() {
                    DeveloperOtaStressTestActivity.testFailed$lambda$1(DeveloperOtaStressTestActivity.this);
                }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void testFailed$lambda$1(DeveloperOtaStressTestActivity this$0) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        this$0.startNextTest();
    }

    private final void toFirmwareUpdate() {
        final Bundle bundle = new Bundle();
        bundle.putBoolean("isAutoUpdate", true);
        String mPlatform = BleCache.INSTANCE.getMPlatform();
        int hashCode = mPlatform.hashCode();
        if (hashCode != 2370) {
            if (hashCode != 70659068) {
                if (hashCode != 78896685) {
                    if (hashCode != 1697379018 || !mPlatform.equals(BleDeviceInfo.PLATFORM_JL707LITE)) {
                        return;
                    }
                } else {
                    if (mPlatform.equals(BleDeviceInfo.PLATFORM_SIFLI)) {
                        com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.me.DeveloperOtaStressTestActivity$toFirmwareUpdate$1
                            ...
                            public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                                ...
                                DeveloperOtaStressTestActivity developerOtaStressTestActivity = DeveloperOtaStressTestActivity.this;
                                Bundle bundle2 = bundle;
                                Intent intent = new Intent(developerOtaStressTestActivity, (Class<?>) FirmwareUpgradeSActivity.class);
                                if (bundle2 != null) {
                                    intent.putExtras(bundle2);
                                }
                                developerOtaStressTestActivity.startActivity(intent);
                            }
                        }, 1, null);
                        return;
                    }
            ...
            } else if (!mPlatform.equals(BleDeviceInfo.PLATFORM_JL707)) {
                return;
            }
        } else if (!mPlatform.equals(BleDeviceInfo.PLATFORM_JL)) {
            return;
        }
        Intent intent = new Intent(this, (Class<?>) FirmwareUpgradeJSmaActivity.class);
    ...
    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_developer_ota_stress_test;
    }
    ...
    public final void onFirmwareUpgradeDone(@OXOo.OOXIXo String data) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(data, "data");
        OI0.oIX0oI.f1507oIX0oI.oIX0oI(this.TAG + " onFirmwareUpgradeDone " + data);
        changeStatus();
        this.mHandler.removeCallbacks(this.mConnectedFailRunnable);
        this.mHandler.postDelayed(this.mConnectedFailRunnable, TimeUnit.MINUTES.toMillis(2L));
    }
    ...
    public final void onStartTest(@OXOo.OOXIXo View view) {
        ...
        if (arrayList.size() < 2) {
            ToastUtils.showLong("ota错误, 轮训升级的ota配置文件不能少于两个版本信息", new Object[0]);
        } else {
            com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.me.DeveloperOtaStressTestActivity$onStartTest$1
                {
                    super(1);
                }
                ...
                public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                    ...
                    kotlin.jvm.internal.IIX0o.x0xO0oo(it, "it");
                    DeveloperOtaStressTestActivity developerOtaStressTestActivity = DeveloperOtaStressTestActivity.this;
                    etTestTime = developerOtaStressTestActivity.getEtTestTime();
                    Editable text = etTestTime.getText();
                    developerOtaStressTestActivity.mTotalTestTime = (text == null || (obj = text.toString()) == null) ? 1 : Integer.parseInt(obj);
                    DeveloperOtaStressTestActivity.this.mCurTestTime = 0;
                    DeveloperOtaStressTestActivity.this.mCurTestSuccessTime = 0;
                    DeveloperOtaStressTestActivity.this.mCurTestFailedTime = 0;
                    DeveloperOtaStressTestActivity.this.changeBtn(true);
                    list = DeveloperOtaStressTestActivity.this.mTestFirmwareList;
                    list.clear();
                    list2 = DeveloperOtaStressTestActivity.this.mTestFirmwareList;
                    arrayList2 = DeveloperOtaStressTestActivity.this.dataList;
                    if (arrayList2 == null) {
                        kotlin.jvm.internal.IIX0o.XOxIOxOx("dataList");
                        arrayList2 = null;
                    }
                    list2.addAll(CollectionsKt___CollectionsKt.O0o000XOX(arrayList2, 2));
                    DeveloperOtaStressTestActivity.this.startTest();
                }
            }, 1, null);
        }
    }
    ...
    public void initItem(@OXOo.OOXIXo XIOOI.I0Io holder, @OXOo.OOXIXo FirmwareVersion item, int i) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(holder, "holder");
        kotlin.jvm.internal.IIX0o.x0xO0oo(item, "item");
        holder.o00(android.R.id.text1, item.toString());
