...
import com.sma.smartv3.ui.me.DeveloperUpgradeJSmaActivity;
...
@kotlin.jvm.internal.XX({"SMAP\nDeveloperUpgradeJSmaActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperUpgradeJSmaActivity.kt\ncom/sma/smartv3/ui/me/DeveloperUpgradeJSmaActivity\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n*L\n1#1,737:1\n19#2:738\n15#2:739\n15#2:740\n15#2:741\n19#2:742\n15#2:743\n11#2,2:744\n*S KotlinDebug\n*F\n+ 1 DeveloperUpgradeJSmaActivity.kt\ncom/sma/smartv3/ui/me/DeveloperUpgradeJSmaActivity\n*L\n61#1:738\n61#1:739\n256#1:740\n257#1:741\n317#1:742\n317#1:743\n730#1:744,2\n*E\n"})
/* loaded from: classes11.dex */
public final class DeveloperUpgradeJSmaActivity extends BaseFirmwareUpgradeActivity {

    @OXOo.OOXIXo
    private final String TAG = "DeveloperUpgradeJ";
    ...
    @OXOo.OOXIXo
    private final String deviceOTAAddress;
    private boolean isAutoShutdown;
    private int isRepairMode;
    private boolean isStartShutdown;
    private boolean isSupportOTAFile;
    ...
    @OXOo.OOXIXo
    private final I0Io mBtEventListener;
    ...
    @OXOo.oOoXoXO
    private final FirmwareVersion mLatestBrand;
    ...
    public static final class FileType {
        ...
        public static final FileType BRAND_PACK = new FileType("BRAND_PACK", 3);
        public static final FileType FONT_PACK = new FileType("FONT_PACK", 4);
        public static final FileType OTA_PACK = new FileType("OTA_PACK", 5);

        private static final /* synthetic */ FileType[] $values() {
            return new FileType[]{FIRMWARE, UI_PACK, LANGUAGE_PACK, BRAND_PACK, FONT_PACK, OTA_PACK};
        }
    ...
    public static final class I0Io extends BluetoothEventListener {
        ...
        public void onAdapterStatus(boolean z) {
            OI0.oIX0oI.f1507oIX0oI.oIX0oI(DeveloperUpgradeJSmaActivity.this.TAG + " bt onAdapterStatus " + z);
        }
        ...
        public void onConnection(@OXOo.OOXIXo BluetoothDevice device, int i) {
            ...
            sb.append(DeveloperUpgradeJSmaActivity.this.TAG);
            sb.append(" bt onConnection -> mOTAStatus = ");
            sb.append(DeveloperUpgradeJSmaActivity.this.mOTAStatus);
            sb.append(", ");
            sb.append(device);
            sb.append(" ,status = ");
            sb.append(i);
            sb.append(" ,isOTA = ");
            OTAManager oTAManager = DeveloperUpgradeJSmaActivity.this.mOTAManager;
            if (oTAManager != null) {
            ...
            if (i == 0) {
                oix0oi.oIX0oI(DeveloperUpgradeJSmaActivity.this.TAG + " bt onConnection -> device disconnected");
                if (DeveloperUpgradeJSmaActivity.this.mOTAStatus == OTAStatus.UPGRADE_PREPARE) {
                    DeveloperUpgradeJSmaActivity.this.updateUpgradeStatus(OTAStatus.UPGRADE_PREPARE_FAILED);
                }
            }
        }
    }
    ...
    public static final class II0xO0 implements BleHandleCallback {
        ...
        public /* synthetic */ class oIX0oI {
            ...
            public static final /* synthetic */ int[] f23267oIX0oI;
            ...
            static {
                ...
                try {
                    iArr[FileType.BRAND_PACK.ordinal()] = 4;
        ...
        public static final void II0XooXoX(final DeveloperUpgradeJSmaActivity this$0) {
            ...
            if (this$0.isStartShutdown) {
                BleConnector.sendInt8$default(bleConnector, BleKey.SHUTDOWN, BleKeyFlag.UPDATE, 0, false, false, 24, null);
                new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.OooI
                    @Override // java.lang.Runnable
                    public final void run() {
                        DeveloperUpgradeJSmaActivity.II0xO0.xxIXOIIO(DeveloperUpgradeJSmaActivity.this);
                    }
                }, 3000L);
            }
        }

        public static final void OOXIXo(DeveloperUpgradeJSmaActivity this$0) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
            this$0.upgrade();
        }

        public static final void Oxx0IOOO(DeveloperUpgradeJSmaActivity this$0) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
            this$0.upgrade();
        }

        public static final void oOoXoXO(DeveloperUpgradeJSmaActivity this$0) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
            this$0.upgrade();
        }

        public static final void xoIox(DeveloperUpgradeJSmaActivity this$0) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
            int i = oIX0oI.f23267oIX0oI[((FileType) this$0.mSteps.get(this$0.mStepsIndex)).ordinal()];
            if (i != 1) {
                if (i != 2) {
                    if (i != 3) {
                        if (i != 4) {
                        ...
                        BleKey bleKey2 = BleKey.BRAND_INFO_FILE;
                        File oOoXoXO3 = com.sma.smartv3.initializer.IXxxXO.oOoXoXO(X00IoxXI.oIX0oI.f3233oIX0oI);
                        FirmwareVersion firmwareVersion2 = this$0.mLatestBrand;
                    ...
                    FirmwareVersion firmwareVersion3 = this$0.mLatestFont;
                ...
                BleKey bleKey4 = BleKey.LANGUAGE_FILE;
                File oOoXoXO5 = com.sma.smartv3.initializer.IXxxXO.oOoXoXO(X00IoxXI.oIX0oI.f3233oIX0oI);
                FirmwareVersion firmwareVersion4 = this$0.mLatestLanguage;
        ...
        public static final void xxIXOIIO(DeveloperUpgradeJSmaActivity this$0) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
            com.sma.smartv3.pop.I0X0x0oIo i0X0x0oIo = this$0.mLoadingPopup;
            if (i0X0x0oIo != null) {
                i0X0x0oIo.dismiss();
            }
            OI0.oIX0oI.f1507oIX0oI.oIX0oI(this$0.TAG + " force exit");
            this$0.upgradeExit();
        }
        ...
        public void onCommandReply(@OXOo.OOXIXo BleKey bleKey, @OXOo.OOXIXo BleKeyFlag bleKeyFlag, boolean z) {
            ...
            if (bleKey == BleKey.SHUTDOWN) {
                com.sma.smartv3.pop.I0X0x0oIo i0X0x0oIo = DeveloperUpgradeJSmaActivity.this.mLoadingPopup;
                if (i0X0x0oIo != null) {
                    i0X0x0oIo.dismiss();
                }
                OI0.oIX0oI.f1507oIX0oI.oIX0oI(DeveloperUpgradeJSmaActivity.this.TAG + " shutdown success");
                DeveloperUpgradeJSmaActivity.this.upgradeExit();
            }
        }
        ...
        public void onCommandSendTimeout(@OXOo.OOXIXo BleKey bleKey, @OXOo.OOXIXo BleKeyFlag bleKeyFlag) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(bleKey, "bleKey");
            kotlin.jvm.internal.IIX0o.x0xO0oo(bleKeyFlag, "bleKeyFlag");
            if (bleKey == BleKey.UI_FILE || bleKey == BleKey.LANGUAGE_FILE || bleKey == BleKey.OTA_FILE) {
                DeveloperUpgradeJSmaActivity.this.setMStarted(false);
                ProgressButton.X0o0xo(DeveloperUpgradeJSmaActivity.this.getProgressButton(), R.string.starting, false, 2, null);
                TextView tvStep = DeveloperUpgradeJSmaActivity.this.getTvStep();
                final DeveloperUpgradeJSmaActivity developerUpgradeJSmaActivity = DeveloperUpgradeJSmaActivity.this;
                tvStep.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.oXIoO
                    @Override // java.lang.Runnable
                    public final void run() {
                        DeveloperUpgradeJSmaActivity.II0xO0.Oxx0IOOO(DeveloperUpgradeJSmaActivity.this);
                    }
                }, AbsBleConnector.TIMEOUT);
                return;
            }
            if (bleKey == BleKey.SESSION) {
                BleConnector bleConnector = BleConnector.INSTANCE;
                String str = DeveloperUpgradeJSmaActivity.this.deviceAddress;
                kotlin.jvm.internal.IIX0o.oO(str, "access$getDeviceAddress$p(...)");
        ...
        public void onDeviceConnected(@OXOo.OOXIXo BluetoothDevice device) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(device, "device");
            OI0.oIX0oI.f1507oIX0oI.oIX0oI(DeveloperUpgradeJSmaActivity.this.TAG + " onDeviceConnected " + DeveloperUpgradeJSmaActivity.this.isStartShutdown + " BUFFER_MAX_SIZE: " + BleStreamPacket.Companion.getBUFFER_MAX_SIZE());
            Handler handler = new Handler();
            final DeveloperUpgradeJSmaActivity developerUpgradeJSmaActivity = DeveloperUpgradeJSmaActivity.this;
            handler.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.Oxx
                @Override // java.lang.Runnable
                public final void run() {
                    DeveloperUpgradeJSmaActivity.II0xO0.II0XooXoX(DeveloperUpgradeJSmaActivity.this);
                }
            }, 5000L);
        }
        ...
        public void onSessionStateChange(boolean z) {
            ...
            StringBuilder sb = new StringBuilder();
            sb.append(DeveloperUpgradeJSmaActivity.this.TAG);
            sb.append(" onSessionStateChange BUFFER_MAX_SIZE: ");
            BleStreamPacket.Companion companion = BleStreamPacket.Companion;
            sb.append(companion.getBUFFER_MAX_SIZE());
            oix0oi.oIX0oI(sb.toString());
            if (!z) {
                DeveloperUpgradeJSmaActivity.this.setMStarted(false);
                companion.setBUFFER_MAX_SIZE(480L);
                return;
            }
            companion.setBUFFER_MAX_SIZE(com.sma.smartv3.util.Xo0.f24349oIX0oI.II0xO0().getLong(com.sma.smartv3.util.XoI0Ixx0.f24493xoxXI, 1018L));
            oix0oi.oIX0oI(DeveloperUpgradeJSmaActivity.this.TAG + " onSessionStateChange BUFFER_MAX_SIZE: " + companion.getBUFFER_MAX_SIZE() + ", step:" + DeveloperUpgradeJSmaActivity.this.mSteps.get(DeveloperUpgradeJSmaActivity.this.mStepsIndex));
            DeveloperUpgradeJSmaActivity.this.startTime = System.currentTimeMillis();
            DeveloperUpgradeJSmaActivity.this.getTvStep().setVisibility(0);
            ProgressButton.X0o0xo(DeveloperUpgradeJSmaActivity.this.getProgressButton(), R.string.starting, false, 2, null);
            TextView tvStep = DeveloperUpgradeJSmaActivity.this.getTvStep();
            DeveloperUpgradeJSmaActivity developerUpgradeJSmaActivity = DeveloperUpgradeJSmaActivity.this;
            tvStep.setText(developerUpgradeJSmaActivity.getString(R.string.upgrade_steps_d_d, Integer.valueOf(developerUpgradeJSmaActivity.mStepsIndex + 1), Integer.valueOf(DeveloperUpgradeJSmaActivity.this.mSteps.size())));
            Handler handler = new Handler();
            final DeveloperUpgradeJSmaActivity developerUpgradeJSmaActivity2 = DeveloperUpgradeJSmaActivity.this;
            handler.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.OO0
                @Override // java.lang.Runnable
                public final void run() {
                    DeveloperUpgradeJSmaActivity.II0xO0.xoIox(DeveloperUpgradeJSmaActivity.this);
                }
            }, 1000L);
        }
        ...
        public void onStreamProgress(boolean z, int i, int i2, int i3, @OXOo.OOXIXo BleKey bleKey) {
            ...
            if (!z) {
                ...
                TextView tvStep = DeveloperUpgradeJSmaActivity.this.getTvStep();
                final DeveloperUpgradeJSmaActivity developerUpgradeJSmaActivity = DeveloperUpgradeJSmaActivity.this;
                tvStep.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.XoIxOXIXo
                    @Override // java.lang.Runnable
                    public final void run() {
                        DeveloperUpgradeJSmaActivity.II0xO0.oOoXoXO(DeveloperUpgradeJSmaActivity.this);
                    }
                }, AbsBleConnector.TIMEOUT);
                return;
            }
            if (System.currentTimeMillis() - DeveloperUpgradeJSmaActivity.this.time1 > 1000) {
                DeveloperUpgradeJSmaActivity.this.time1 = System.currentTimeMillis();
                DeveloperUpgradeJSmaActivity.this.getTvSpeed().setText(new DecimalFormat("#.##", DecimalFormatSymbols.getInstance(Locale.ENGLISH)).format((i3 - DeveloperUpgradeJSmaActivity.this.lastPackageSize) / 1024.0d) + " KB/s");
                DeveloperUpgradeJSmaActivity.this.lastPackageSize = i3;
            }
            DeveloperUpgradeJSmaActivity.this.getProgressButton().setProgressDecimalPlaces(i3 / i2);
            if (i2 == i3) {
                OI0.oIX0oI.f1507oIX0oI.oIX0oI(DeveloperUpgradeJSmaActivity.this.TAG + " onStreamProgress " + bleKey + " done. " + ((System.currentTimeMillis() - DeveloperUpgradeJSmaActivity.this.startTime) / 1000) + 's');
                if (DeveloperUpgradeJSmaActivity.this.mStepsIndex >= CollectionsKt__CollectionsKt.oo0xXOI0I(DeveloperUpgradeJSmaActivity.this.mSteps)) {
                    DeveloperUpgradeJSmaActivity.this.upgradeDone();
                    return;
                }
                DeveloperUpgradeJSmaActivity.this.getProgressButton().setProgress(0.0f);
                if (DeveloperUpgradeJSmaActivity.this.mSteps.get(DeveloperUpgradeJSmaActivity.this.mStepsIndex) != FileType.OTA_PACK) {
                    TextView tvStep2 = DeveloperUpgradeJSmaActivity.this.getTvStep();
                    final DeveloperUpgradeJSmaActivity developerUpgradeJSmaActivity2 = DeveloperUpgradeJSmaActivity.this;
                    tvStep2.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.o0IXXIx
                        @Override // java.lang.Runnable
                        public final void run() {
                            DeveloperUpgradeJSmaActivity.II0xO0.OOXIXo(DeveloperUpgradeJSmaActivity.this);
                        }
                    }, 5000L);
                }
                DeveloperUpgradeJSmaActivity.this.mStepsIndex++;
            }
        }
    ...
    /* loaded from: classes11.dex */
    public static final class X0o0xo implements IUpgradeCallback {
        public X0o0xo() {
        }

        public static final void I0Io(DeveloperUpgradeJSmaActivity this$0) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
            this$0.upgrade();
        }

        public static final void oxoX(DeveloperUpgradeJSmaActivity this$0) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
            this$0.upgradeDone();
        }
        ...
        public void onCancelOTA() {
            OI0.oIX0oI.f1507oIX0oI.oIX0oI(DeveloperUpgradeJSmaActivity.this.TAG + " onCancelOTA");
            DeveloperUpgradeJSmaActivity.this.updateUpgradeStatus(OTAStatus.UPGRADE_FAILED);
        }

        @Override // com.jieli.jl_bt_ota.interfaces.IUpgradeCallback
        public void onError(@OXOo.OOXIXo BaseError p0) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(p0, "p0");
            OI0.oIX0oI.f1507oIX0oI.oIX0oI(DeveloperUpgradeJSmaActivity.this.TAG + " onError -> status = " + DeveloperUpgradeJSmaActivity.this.mOTAStatus + ", error = " + p0);
            ToastUtils.showLong(p0.getMessage(), new Object[0]);
            DeveloperUpgradeJSmaActivity.this.updateUpgradeStatus(OTAStatus.UPGRADE_FAILED);
        }

        @Override // com.jieli.jl_bt_ota.interfaces.IUpgradeCallback
        public void onNeedReconnect(@OXOo.OOXIXo String p0, boolean z) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(p0, "p0");
            OI0.oIX0oI.f1507oIX0oI.oIX0oI(DeveloperUpgradeJSmaActivity.this.TAG + " onNeedReconnect : " + p0 + ", " + z);
            DeveloperUpgradeJSmaActivity.this.isUseDfuAddress = true;
        }

        @Override // com.jieli.jl_bt_ota.interfaces.IUpgradeCallback
        public void onProgress(int i, float f) {
            if (i == 0) {
                DeveloperUpgradeJSmaActivity.this.mOTAStatus = OTAStatus.UPGRADE_CHECKING;
                ProgressButton progressButton = DeveloperUpgradeJSmaActivity.this.getProgressButton();
                String string = DeveloperUpgradeJSmaActivity.this.getString(R.string.check_file);
                kotlin.jvm.internal.IIX0o.oO(string, "getString(...)");
                progressButton.II0xO0(string, Math.round(f) / 100.0f);
                return;
            }
            DeveloperUpgradeJSmaActivity.this.mOTAStatus = OTAStatus.UPGRADEING;
            DeveloperUpgradeJSmaActivity.this.getProgressButton().setProgress(Math.round(f) / 100.0f);
        }

        @Override // com.jieli.jl_bt_ota.interfaces.IUpgradeCallback
        public void onStartOTA() {
            OI0.oIX0oI.f1507oIX0oI.oIX0oI(DeveloperUpgradeJSmaActivity.this.TAG + " onStartOTA");
            DeveloperUpgradeJSmaActivity.this.updateUpgradeStatus(OTAStatus.UPGRADE_START);
        }

        @Override // com.jieli.jl_bt_ota.interfaces.IUpgradeCallback
        public void onStopOTA() {
            OI0.oIX0oI.f1507oIX0oI.oIX0oI(DeveloperUpgradeJSmaActivity.this.TAG + " onStopOTA upgrade done. " + ((System.currentTimeMillis() - DeveloperUpgradeJSmaActivity.this.startTime) / 1000) + 's');
            DeveloperUpgradeJSmaActivity.this.updateUpgradeStatus(OTAStatus.UPGRADE_STOP);
            DeveloperUpgradeJSmaActivity.this.getProgressButton().setProgress(1.0f);
            if (DeveloperUpgradeJSmaActivity.this.mStepsIndex >= CollectionsKt__CollectionsKt.oo0xXOI0I(DeveloperUpgradeJSmaActivity.this.mSteps)) {
                TextView tvStep = DeveloperUpgradeJSmaActivity.this.getTvStep();
                final DeveloperUpgradeJSmaActivity developerUpgradeJSmaActivity = DeveloperUpgradeJSmaActivity.this;
                tvStep.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.xIXX
                    @Override // java.lang.Runnable
                    public final void run() {
                        DeveloperUpgradeJSmaActivity.X0o0xo.oxoX(DeveloperUpgradeJSmaActivity.this);
                    }
                }, 4000L);
            } else {
                DeveloperUpgradeJSmaActivity.this.getProgressButton().setProgress(0.0f);
                ...
                TextView tvStep2 = DeveloperUpgradeJSmaActivity.this.getTvStep();
                final DeveloperUpgradeJSmaActivity developerUpgradeJSmaActivity2 = DeveloperUpgradeJSmaActivity.this;
                tvStep2.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.OIx00oxx
                    @Override // java.lang.Runnable
                    public final void run() {
                        DeveloperUpgradeJSmaActivity.X0o0xo.I0Io(DeveloperUpgradeJSmaActivity.this);
                    }
                }, 4000L);
            }
        }
    ...
    public /* synthetic */ class oIX0oI {
        ...
        public static final /* synthetic */ int[] f23269II0xO0;

        /* renamed from: oIX0oI, reason: collision with root package name */
        public static final /* synthetic */ int[] f23270oIX0oI;
        ...
        static {
            ...
            try {
                iArr[FileType.BRAND_PACK.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                iArr[FileType.OTA_PACK.ordinal()] = 6;
    ...
    public static final class oxoX extends BtEventCallback {
        ...
        public void onConnection(@OXOo.OOXIXo BluetoothDevice device, int i) {
            ...
            sb.append(" ,isOTA = ");
            OTAManager oTAManager = DeveloperUpgradeJSmaActivity.this.mOTAManager;
            kotlin.jvm.internal.IIX0o.ooOOo0oXI(oTAManager);
            sb.append(oTAManager.isOTA());
            oix0oi.oIX0oI(sb.toString());
            OTAManager oTAManager2 = DeveloperUpgradeJSmaActivity.this.mOTAManager;
            kotlin.jvm.internal.IIX0o.ooOOo0oXI(oTAManager2);
            if (!oTAManager2.isOTA()) {
                if (i != 0) {
                    if (i == 1) {
                        DeveloperUpgradeJSmaActivity developerUpgradeJSmaActivity = DeveloperUpgradeJSmaActivity.this;
                        if (developerUpgradeJSmaActivity.canOTA(developerUpgradeJSmaActivity.mOTAStatus)) {
                            DeveloperUpgradeJSmaActivity developerUpgradeJSmaActivity2 = DeveloperUpgradeJSmaActivity.this;
                            File oOoXoXO2 = com.sma.smartv3.initializer.IXxxXO.oOoXoXO(X00IoxXI.oIX0oI.f3233oIX0oI);
                            FirmwareVersion firmwareVersion = DeveloperUpgradeJSmaActivity.this.mLatestFirmware;
                            kotlin.jvm.internal.IIX0o.ooOOo0oXI(firmwareVersion);
                            ...
                            developerUpgradeJSmaActivity2.startOTA(absolutePath);
                            return;
                        }
                        return;
                    }
                ...
                oix0oi.oIX0oI(DeveloperUpgradeJSmaActivity.this.TAG + " ota onConnection -> device disconnected");
                if (DeveloperUpgradeJSmaActivity.this.mOTAStatus == OTAStatus.UPGRADE_PREPARE) {
                    DeveloperUpgradeJSmaActivity.this.updateUpgradeStatus(OTAStatus.UPGRADE_PREPARE_FAILED);
                }
            }
    ...
    public DeveloperUpgradeJSmaActivity() {
        ...
        String deviceAddress = xo0.II0xO0().getString(com.sma.smartv3.util.XoI0Ixx0.f24456oo);
        ...
        String format = String.format("%012X", Arrays.copyOf(new Object[]{Long.valueOf(Long.parseLong(kotlin.text.OxI.IIOIX(deviceAddress, ":", "", false, 4, null), kotlin.text.II0xO0.oIX0oI(16)) + 1)}, 1));
        kotlin.jvm.internal.IIX0o.oO(format, "format(...)");
        this.deviceOTAAddress = CollectionsKt___CollectionsKt.OoIXo(StringsKt___StringsKt.X0OXI(format, 2), ":", null, null, 0, null, null, 62, null);
        this.isAutoShutdown = xo0.II0xO0().getBoolean(com.sma.smartv3.util.XoI0Ixx0.f24382O0Xx, false);
        this.isSupportOTAFile = xo0.II0xO0().getBoolean(com.sma.smartv3.util.XoI0Ixx0.f24354I0oOIX, false);
        this.isRepairMode = -1;
        this.mOTAStatus = OTAStatus.NONE;
        this.mBtEventListener = new I0Io();
        this.mOTAEventCallback = new oxoX();
        ...
        if (extraPackVersions != null) {
            firmwareVersion3 = extraPackVersions.getBrandPackVersion();
        } else {
            firmwareVersion3 = null;
        }
        this.mLatestBrand = firmwareVersion3;
    ...
    private final void connectDevice(String str) {
    ...
    private final boolean isOTAError(OTAStatus oTAStatus) {
        int i = oIX0oI.f23269II0xO0[oTAStatus.ordinal()];
        if (i == 1 || i == 2 || i == 3) {
            return true;
        }
        return false;
    ...
    public final void updateUpgradeStatus(OTAStatus oTAStatus) {
        OI0.oIX0oI oix0oi = OI0.oIX0oI.f1507oIX0oI;
        oix0oi.oIX0oI(this.TAG + " updateUpgradeStatus status = " + oTAStatus + ", autoRetryCount = " + this.autoRetryCount);
        this.mOTAStatus = oTAStatus;
        if (isOTAError(oTAStatus)) {
            if (this.autoRetryCount < 1) {
                oix0oi.oIX0oI(this.TAG + " wait to retry Upgrade -> autoRetryCount = " + this.autoRetryCount);
                new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.XOxxooXI
                    @Override // java.lang.Runnable
                    public final void run() {
                        DeveloperUpgradeJSmaActivity.updateUpgradeStatus$lambda$5(DeveloperUpgradeJSmaActivity.this);
                    }
                }, 5000L);
                return;
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void updateUpgradeStatus$lambda$5(DeveloperUpgradeJSmaActivity this$0) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        this$0.autoRetryCount++;
        if (this$0.isOTAError(this$0.mOTAStatus)) {
            OI0.oIX0oI oix0oi = OI0.oIX0oI.f1507oIX0oI;
            oix0oi.oIX0oI(this$0.TAG + " retry Upgrade -> autoRetryCount = " + this$0.autoRetryCount);
            this$0.destroyOTA();
            this$0.initOTA();
            if (this$0.isUseDfuAddress) {
                oix0oi.oIX0oI(this$0.TAG + " upgrade -> use dfuAddress");
                this$0.connectDevice(this$0.deviceOTAAddress);
            } else {
                oix0oi.oIX0oI(this$0.TAG + " upgrade -> use bleAddress");
                String deviceAddress = this$0.deviceAddress;
                kotlin.jvm.internal.IIX0o.oO(deviceAddress, "deviceAddress");
                this$0.connectDevice(deviceAddress);
            }
            this$0.updateUpgradeStatus(OTAStatus.UPGRADE_PREPARE);
        }
    }
    ...
    public final void upgrade() {
        ...
        switch (oIX0oI.f23270oIX0oI[this.mSteps.get(this.mStepsIndex).ordinal()]) {
            case 1:
                OI0.oIX0oI oix0oi = OI0.oIX0oI.f1507oIX0oI;
                oix0oi.oIX0oI("FIRMWARE");
                destroyOTA();
                initOTA();
                if (this.isUseDfuAddress) {
                    oix0oi.oIX0oI(this.TAG + " upgrade -> use dfuAddress");
                    connectDevice(this.deviceOTAAddress);
                } else {
                ...
                return;
            case 2:
                OI0.oIX0oI.f1507oIX0oI.oIX0oI("UI_PACK");
                jlDestory();
                BleConnector bleConnector = BleConnector.INSTANCE;
                ...
                new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.IOoo
                    @Override // java.lang.Runnable
                    public final void run() {
                        DeveloperUpgradeJSmaActivity.upgrade$lambda$0(DeveloperUpgradeJSmaActivity.this);
                    }
                }, 4000L);
                return;
            case 3:
                OI0.oIX0oI.f1507oIX0oI.oIX0oI("LANGUAGE_PACK");
                jlDestory();
                BleConnector bleConnector2 = BleConnector.INSTANCE;
                ...
                new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.oIIxXoo
                    @Override // java.lang.Runnable
                    public final void run() {
                        DeveloperUpgradeJSmaActivity.upgrade$lambda$1(DeveloperUpgradeJSmaActivity.this);
                    }
                }, 4000L);
                return;
            case 4:
                OI0.oIX0oI.f1507oIX0oI.oIX0oI("FONT_PACK");
                jlDestory();
                BleConnector bleConnector3 = BleConnector.INSTANCE;
                ...
                new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.oXX0IoI
                    @Override // java.lang.Runnable
                    public final void run() {
                        DeveloperUpgradeJSmaActivity.upgrade$lambda$2(DeveloperUpgradeJSmaActivity.this);
                    }
                }, 4000L);
                return;
            case 5:
                OI0.oIX0oI.f1507oIX0oI.oIX0oI("BRAND_PACK");
                jlDestory();
                BleConnector bleConnector4 = BleConnector.INSTANCE;
                if (bleConnector4.isAvailable()) {
                    BleKey bleKey4 = BleKey.BRAND_INFO_FILE;
                    File oOoXoXO5 = com.sma.smartv3.initializer.IXxxXO.oOoXoXO(X00IoxXI.oIX0oI.f3233oIX0oI);
                    FirmwareVersion firmwareVersion4 = this.mLatestBrand;
                    kotlin.jvm.internal.IIX0o.ooOOo0oXI(firmwareVersion4);
                    BleConnector.sendStream$default(bleConnector4, bleKey4, new File(oOoXoXO5, firmwareVersion4.getFileName()), 0, 4, (Object) null);
                    return;
                }
                new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.XXXI
                    @Override // java.lang.Runnable
                    public final void run() {
                        DeveloperUpgradeJSmaActivity.upgrade$lambda$3(DeveloperUpgradeJSmaActivity.this);
                    }
                }, 4000L);
                return;
            case 6:
                OI0.oIX0oI.f1507oIX0oI.oIX0oI("OTA_PACK");
                jlDestory();
                BleConnector bleConnector5 = BleConnector.INSTANCE;
                if (bleConnector5.isAvailable()) {
                    BleKey bleKey5 = BleKey.OTA_FILE;
                    File oOoXoXO6 = com.sma.smartv3.initializer.IXxxXO.oOoXoXO(X00IoxXI.oIX0oI.f3233oIX0oI);
                    FirmwareVersion firmwareVersion5 = this.mLatestFirmware;
                    kotlin.jvm.internal.IIX0o.ooOOo0oXI(firmwareVersion5);
                    BleConnector.sendStream$default(bleConnector5, bleKey5, new File(oOoXoXO6, firmwareVersion5.getFileName()), 0, 4, (Object) null);
                    return;
                }
                new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.I0xX0
                    @Override // java.lang.Runnable
                    public final void run() {
                        DeveloperUpgradeJSmaActivity.upgrade$lambda$4(DeveloperUpgradeJSmaActivity.this);
                    }
                }, 4000L);
                return;
            default:
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void upgrade$lambda$0(DeveloperUpgradeJSmaActivity this$0) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        BleConnector bleConnector = BleConnector.INSTANCE;
        String deviceAddress = this$0.deviceAddress;
        kotlin.jvm.internal.IIX0o.oO(deviceAddress, "deviceAddress");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void upgrade$lambda$1(DeveloperUpgradeJSmaActivity this$0) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        BleConnector bleConnector = BleConnector.INSTANCE;
        String deviceAddress = this$0.deviceAddress;
        kotlin.jvm.internal.IIX0o.oO(deviceAddress, "deviceAddress");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void upgrade$lambda$2(DeveloperUpgradeJSmaActivity this$0) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        BleConnector bleConnector = BleConnector.INSTANCE;
        String deviceAddress = this$0.deviceAddress;
        kotlin.jvm.internal.IIX0o.oO(deviceAddress, "deviceAddress");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void upgrade$lambda$3(DeveloperUpgradeJSmaActivity this$0) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        BleConnector bleConnector = BleConnector.INSTANCE;
        String deviceAddress = this$0.deviceAddress;
        kotlin.jvm.internal.IIX0o.oO(deviceAddress, "deviceAddress");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void upgrade$lambda$4(DeveloperUpgradeJSmaActivity this$0) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        BleConnector bleConnector = BleConnector.INSTANCE;
        String deviceAddress = this$0.deviceAddress;
        kotlin.jvm.internal.IIX0o.oO(deviceAddress, "deviceAddress");
    ...
    public final void upgradeDone() {
        if (this.isRepairMode == 1) {
            finish();
            return;
        }
        if (this.isAutoShutdown) {
            OI0.oIX0oI.f1507oIX0oI.oIX0oI(this.TAG + " start shutdown");
            ...
            new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.IO0XoXxO
                @Override // java.lang.Runnable
                public final void run() {
                    DeveloperUpgradeJSmaActivity.upgradeDone$lambda$6(DeveloperUpgradeJSmaActivity.this);
                }
            }, 25000L);
            ...
            if (bleConnector.isAvailable()) {
                ...
                new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.oXxOI0oIx
                    @Override // java.lang.Runnable
                    public final void run() {
                        DeveloperUpgradeJSmaActivity.upgradeDone$lambda$7(DeveloperUpgradeJSmaActivity.this);
                    }
                }, 10000L);
                return;
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void upgradeDone$lambda$6(DeveloperUpgradeJSmaActivity this$0) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        com.sma.smartv3.pop.I0X0x0oIo i0X0x0oIo = this$0.mLoadingPopup;
        if (i0X0x0oIo != null && i0X0x0oIo.isShowing()) {
            ...
            OI0.oIX0oI.f1507oIX0oI.oIX0oI(this$0.TAG + " shutdown time out force exit!");
            this$0.upgradeExit();
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void upgradeDone$lambda$7(DeveloperUpgradeJSmaActivity this$0) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        BleConnector bleConnector = BleConnector.INSTANCE;
        String deviceAddress = this$0.deviceAddress;
        kotlin.jvm.internal.IIX0o.oO(deviceAddress, "deviceAddress");
    ...
    public final void upgradeExit() {
        OI0.oIX0oI.f1507oIX0oI.oIX0oI(this.TAG + " ota => upgradeExit");
    ...
    public void initView() {
        ...
        if (firmwareVersion == null && this.mLatestUi == null && this.mLatestLanguage == null && this.mLatestBrand == null && this.mLatestFont == null) {
            ...
            getTvLatest().setText(getString(R.string.v_s, str6 + '.' + IIOIX2 + IIOIX3 + "000"));
            ...
            FirmwareVersion firmwareVersion5 = this.mLatestFont;
            if (firmwareVersion5 == null || (version = firmwareVersion5.getVersion()) == null) {
                str5 = "000";
            } else {
                str5 = version;
            }
            String IIOIX7 = kotlin.text.OxI.IIOIX(str5, FileUtils.FILE_EXTENSION_SEPARATOR, "", false, 4, null);
            getTvLatest().setText(getString(R.string.v_s, str + '.' + IIOIX4 + IIOIX5 + IIOIX6 + IIOIX7));
            String IIOIX8 = kotlin.text.OxI.IIOIX(this.mCurrentUi, FileUtils.FILE_EXTENSION_SEPARATOR, "", false, 4, null);
            String IIOIX9 = kotlin.text.OxI.IIOIX(this.mCurrentLanguage, FileUtils.FILE_EXTENSION_SEPARATOR, "", false, 4, null);
            getTvCurrent().setText(getString(R.string.v_s, this.mCurrentFirmware + '.' + IIOIX8 + IIOIX9));
            if (this.mLatestFirmware != null) {
                if (this.isSupportOTAFile) {
            ...
            if (this.isRepairMode != 1) {
                ...
                if (this.mLatestBrand != null) {
                    this.mSteps.add(FileType.BRAND_PACK);
                }
            }
            getTvStep().setVisibility(0);
        }
        ...
        getTvInfo().setText("Jsma " + this.deviceAddress + ", Mode:" + this.isRepairMode + ", " + this.isSupportOTAFile);
        OI0.oIX0oI.f1507oIX0oI.oIX0oI(this.TAG + " ota => deviceAddress:" + this.deviceAddress + " deviceOTAAddress:" + this.deviceOTAAddress + ", mSteps:" + this.mSteps);
    ...
    public final void onBottomClick(@OXOo.OOXIXo View view) {
        ...
        if (this.mStepsIndex == 0) {
            ...
            if (firmwareVersion != null) {
                NetWorkUtils.INSTANCE.download(firmwareVersion.getFileUrl(), com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(X00IoxXI.oIX0oI.f3233oIX0oI), this.mLatestFirmware.getFileName(), new HttpProgressCallback<String>() { // from class: com.sma.smartv3.ui.me.DeveloperUpgradeJSmaActivity$onBottomClick$1
                    @Override // xxxI.II0xO0
                    public void handleError(@OXOo.OOXIXo String error) {
                        kotlin.jvm.internal.IIX0o.x0xO0oo(error, "error");
                        DeveloperUpgradeJSmaActivity.this.mDownloaded = 0;
                        DeveloperUpgradeJSmaActivity.this.setMStarted(false);
                    }
                    ...
                    public void handleResponse(@OXOo.oOoXoXO String str) {
                        int i;
                        DeveloperUpgradeJSmaActivity developerUpgradeJSmaActivity = DeveloperUpgradeJSmaActivity.this;
                        i = developerUpgradeJSmaActivity.mDownloaded;
                        developerUpgradeJSmaActivity.mDownloaded = i + 1;
                        DeveloperUpgradeJSmaActivity.this.checkDownload();
                    }
                });
            }
            FirmwareVersion firmwareVersion2 = this.mLatestUi;
            if (firmwareVersion2 != null) {
                NetWorkUtils.INSTANCE.download(firmwareVersion2.getFileUrl(), com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(X00IoxXI.oIX0oI.f3233oIX0oI), this.mLatestUi.getFileName(), new HttpProgressCallback<String>() { // from class: com.sma.smartv3.ui.me.DeveloperUpgradeJSmaActivity$onBottomClick$2
                    @Override // xxxI.II0xO0
                    public void handleError(@OXOo.OOXIXo String error) {
                        kotlin.jvm.internal.IIX0o.x0xO0oo(error, "error");
                        DeveloperUpgradeJSmaActivity.this.mDownloaded = 0;
            ...
            if (firmwareVersion3 != null) {
                NetWorkUtils.INSTANCE.download(firmwareVersion3.getFileUrl(), com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(X00IoxXI.oIX0oI.f3233oIX0oI), this.mLatestLanguage.getFileName(), new HttpProgressCallback<String>() { // from class: com.sma.smartv3.ui.me.DeveloperUpgradeJSmaActivity$onBottomClick$3
                    @Override // xxxI.II0xO0
                    public void handleError(@OXOo.OOXIXo String error) {
                        kotlin.jvm.internal.IIX0o.x0xO0oo(error, "error");
                        DeveloperUpgradeJSmaActivity.this.mDownloaded = 0;
            ...
            if (firmwareVersion4 != null) {
                NetWorkUtils.INSTANCE.download(firmwareVersion4.getFileUrl(), com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(X00IoxXI.oIX0oI.f3233oIX0oI), this.mLatestBrand.getFileName(), new HttpProgressCallback<String>() { // from class: com.sma.smartv3.ui.me.DeveloperUpgradeJSmaActivity$onBottomClick$4
                    @Override // xxxI.II0xO0
                    public void handleError(@OXOo.OOXIXo String error) {
                        kotlin.jvm.internal.IIX0o.x0xO0oo(error, "error");
                        DeveloperUpgradeJSmaActivity.this.mDownloaded = 0;
            ...
            if (firmwareVersion5 != null) {
                NetWorkUtils.INSTANCE.download(firmwareVersion5.getFileUrl(), com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(X00IoxXI.oIX0oI.f3233oIX0oI), this.mLatestFont.getFileName(), new HttpProgressCallback<String>() { // from class: com.sma.smartv3.ui.me.DeveloperUpgradeJSmaActivity$onBottomClick$5
                    @Override // xxxI.II0xO0
                    public void handleError(@OXOo.OOXIXo String error) {
                        kotlin.jvm.internal.IIX0o.x0xO0oo(error, "error");
                        DeveloperUpgradeJSmaActivity.this.mDownloaded = 0;
    ...
    public final void startOTA(@OXOo.OOXIXo String filePath) {
        ...
        OTAManager oTAManager2 = this.mOTAManager;
        if (oTAManager2 != null) {
            oTAManager2.startOTA(new X0o0xo());
        }
    }
}
