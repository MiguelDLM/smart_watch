...
import com.sma.smartv3.ui.me.DeveloperUpgradeSActivity;
import com.sma.smartv3.ui.me.DeveloperUpgradeSActivity$localBroadcastReceiver$2;
...
@kotlin.jvm.internal.XX({"SMAP\nDeveloperUpgradeSActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperUpgradeSActivity.kt\ncom/sma/smartv3/ui/me/DeveloperUpgradeSActivity\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n*L\n1#1,294:1\n19#2:295\n15#2:296\n15#2:297\n11#2,2:298\n*S KotlinDebug\n*F\n+ 1 DeveloperUpgradeSActivity.kt\ncom/sma/smartv3/ui/me/DeveloperUpgradeSActivity\n*L\n71#1:295\n71#1:296\n79#1:297\n159#1:298,2\n*E\n"})
/* loaded from: classes11.dex */
public final class DeveloperUpgradeSActivity extends BaseFirmwareUpgradeActivity {

    @OXOo.OOXIXo
    private final String TAG = "DeveloperUpgradeS";
    ...
    @OXOo.OOXIXo
    private oIX0oI mBleHandleCallback;
    ...
    /* loaded from: classes11.dex */
    public static final class II0xO0 implements ServiceConnection {
        public II0xO0() {
        }
        ...
        public void onServiceConnected(@OXOo.OOXIXo ComponentName name, @OXOo.OOXIXo IBinder service) {
            ...
            DeveloperUpgradeSActivity.this.mBinder = (SifliDFUService.SifliDFUBinder) service;
            DeveloperUpgradeSActivity developerUpgradeSActivity = DeveloperUpgradeSActivity.this;
            SifliDFUService.SifliDFUBinder sifliDFUBinder = developerUpgradeSActivity.mBinder;
            kotlin.jvm.internal.IIX0o.ooOOo0oXI(sifliDFUBinder);
            developerUpgradeSActivity.sifliDFUService = sifliDFUBinder.getDfuService();
            DeveloperUpgradeSActivity.this.isBound = true;
            DeveloperUpgradeSActivity.this.checkFirmware();
            OI0.oIX0oI.f1507oIX0oI.oIX0oI(DeveloperUpgradeSActivity.this.TAG + " onServiceConnected");
        }

        @Override // android.content.ServiceConnection
        public void onServiceDisconnected(@OXOo.OOXIXo ComponentName name) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(name, "name");
            OI0.oIX0oI.f1507oIX0oI.oIX0oI(DeveloperUpgradeSActivity.this.TAG + " onServiceDisconnected");
            DeveloperUpgradeSActivity.this.isBound = false;
        }
    }
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public static final void I0Io(final DeveloperUpgradeSActivity this$0) {
            ...
            this$0.mHandler.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.XoOxI0ox
                @Override // java.lang.Runnable
                public final void run() {
                    DeveloperUpgradeSActivity.oIX0oI.oxoX(DeveloperUpgradeSActivity.this);
                }
            }, 5000L);
        }

        public static final void oxoX(DeveloperUpgradeSActivity this$0) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
            OI0.oIX0oI.f1507oIX0oI.oIX0oI(this$0.TAG + " force exit " + this$0.deviceAddress);
        ...
        public void onDeviceConnected(@OXOo.OOXIXo BluetoothDevice device) {
            ...
            BleHandleCallback.DefaultImpls.onDeviceConnected(this, device);
            if (DeveloperUpgradeSActivity.this.isAutoShutdown) {
                Handler handler = DeveloperUpgradeSActivity.this.mHandler;
                final DeveloperUpgradeSActivity developerUpgradeSActivity = DeveloperUpgradeSActivity.this;
                handler.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.X0ooXIooI
                    @Override // java.lang.Runnable
                    public final void run() {
                        DeveloperUpgradeSActivity.oIX0oI.I0Io(DeveloperUpgradeSActivity.this);
                    }
    ...
    public DeveloperUpgradeSActivity() {
        ...
        this.deviceAddress = xo0.II0xO0().getString(com.sma.smartv3.util.XoI0Ixx0.f24456oo);
        ...
        this.localBroadcastReceiver$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<DeveloperUpgradeSActivity$localBroadcastReceiver$2.AnonymousClass1>() { // from class: com.sma.smartv3.ui.me.DeveloperUpgradeSActivity$localBroadcastReceiver$2

            /* renamed from: com.sma.smartv3.ui.me.DeveloperUpgradeSActivity$localBroadcastReceiver$2$1, reason: invalid class name */
            /* loaded from: classes11.dex */
            public static final class AnonymousClass1 extends BroadcastReceiver {

                /* renamed from: oIX0oI, reason: collision with root package name */
                public final /* synthetic */ DeveloperUpgradeSActivity f23296oIX0oI;

                public AnonymousClass1(DeveloperUpgradeSActivity developerUpgradeSActivity) {
                    this.f23296oIX0oI = developerUpgradeSActivity;
                }

                public static final void X0o0xo(int i, final DeveloperUpgradeSActivity this$0) {
                    TextView tvTip;
                    ProgressButton progressButton;
                    kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
                    if (i != 0) {
                        tvTip = this$0.getTvTip();
                        tvTip.setText(this$0.getString(R.string.firmware_upgrading_failed) + "  error=" + i);
                        progressButton = this$0.getProgressButton();
                        ProgressButton.X0o0xo(progressButton, R.string.firmware_upgrading_failed, false, 2, null);
                    } else if (!this$0.isAutoShutdown) {
                        this$0.upgradeExit();
                    } else {
                        this$0.mHandler.postDelayed(
                        /*  JADX ERROR: Method code generation error
                            jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0019: INVOKE 
                              (wrap:android.os.Handler:0x000e: IGET (r6v0 'this$0' com.sma.smartv3.ui.me.DeveloperUpgradeSActivity) A[MD:(com.sma.smartv3.ui.me.DeveloperUpgradeSActivity):android.os.Handler (m), WRAPPED] (LINE:1) com.sma.smartv3.ui.me.DeveloperUpgradeSActivity.mHandler android.os.Handler)
                              (wrap:java.lang.Runnable:0x0014: CONSTRUCTOR (r6v0 'this$0' com.sma.smartv3.ui.me.DeveloperUpgradeSActivity A[DONT_INLINE]) A[MD:(com.sma.smartv3.ui.me.DeveloperUpgradeSActivity):void (m), WRAPPED] (LINE:21) call: com.sma.smartv3.ui.me.IIOIX.<init>(com.sma.smartv3.ui.me.DeveloperUpgradeSActivity):void type: CONSTRUCTOR)
                              (wrap:long:SGET  A[WRAPPED] com.google.android.exoplayer2.ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS long)
                             VIRTUAL call: android.os.Handler.postDelayed(java.lang.Runnable, long):boolean A[MD:(java.lang.Runnable, long):boolean (c)] (LINE:26) in method: com.sma.smartv3.ui.me.DeveloperUpgradeSActivity$localBroadcastReceiver$2.1.X0o0xo(int, com.sma.smartv3.ui.me.DeveloperUpgradeSActivity):void, file: classes11.dex
                            ...
                            Caused by: jadx.core.utils.exceptions.JadxRuntimeException: Expected class to be processed at this point, class: com.sma.smartv3.ui.me.IIOIX, state: NOT_LOADED
                        ...
                        /*
                            ...
                            r0 = 0
                            if (r5 != 0) goto L21
                            boolean r5 = com.sma.smartv3.ui.me.DeveloperUpgradeSActivity.access$isAutoShutdown$p(r6)
                            if (r5 == 0) goto L1d
                            android.os.Handler r5 = com.sma.smartv3.ui.me.DeveloperUpgradeSActivity.access$getMHandler$p(r6)
                            com.sma.smartv3.ui.me.IIOIX r1 = new com.sma.smartv3.ui.me.IIOIX
                            r1.<init>(r6)
                            r2 = 2000(0x7d0, double:9.88E-321)
                            r5.postDelayed(r1, r2)
                            goto L4c
                        L1d:
                            com.sma.smartv3.ui.me.DeveloperUpgradeSActivity.access$upgradeExit(r6)
                            goto L4c
                        L21:
                            android.widget.TextView r1 = com.sma.smartv3.ui.me.DeveloperUpgradeSActivity.access$getTvTip(r6)
                            ...
                            r1.setText(r5)
                            com.sma.smartv3.view.ProgressButton r5 = com.sma.smartv3.ui.me.DeveloperUpgradeSActivity.access$getProgressButton(r6)
                            r1 = 2
                            r2 = 0
                            com.sma.smartv3.view.ProgressButton.X0o0xo(r5, r3, r0, r1, r2)
                        L4c:
                            com.sma.smartv3.ui.me.DeveloperUpgradeSActivity.access$setMStarted(r6, r0)
                            return
                        */
                        throw new UnsupportedOperationException("Method not decompiled: com.sma.smartv3.ui.me.DeveloperUpgradeSActivity$localBroadcastReceiver$2.AnonymousClass1.X0o0xo(int, com.sma.smartv3.ui.me.DeveloperUpgradeSActivity):void");
                    }

                    public static final void XO(DeveloperUpgradeSActivity this$0) {
                        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
                        BleConnector bleConnector = BleConnector.INSTANCE;
                    ...
                    public static final void oxoX(DeveloperUpgradeSActivity this$0, int i) {
                        TextView tvTip;
                        ProgressButton progressButton;
                        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
                        tvTip = this$0.getTvTip();
                        tvTip.setText(this$0.getString(R.string.starting));
                        progressButton = this$0.getProgressButton();
                        progressButton.setProgress(i / 100.0f);
                    }
                    ...
                    public void onReceive(@OXOo.OOXIXo Context context, @OXOo.OOXIXo Intent intent) {
                            ...
                            if (hashCode != -1936294892) {
                                if (hashCode != 888644493) {
                                    if (hashCode == 1761809728 && action.equals(SifliDFUService.BROADCAST_DFU_LOG)) {
                                        ...
                                        OI0.oIX0oI.f1507oIX0oI.oIX0oI(this.f23296oIX0oI.TAG + " DFU LOG - " + stringExtra);
                                        return;
                                    }
                                    return;
                                }
                                if (action.equals(SifliDFUService.BROADCAST_DFU_STATE)) {
                                    ...
                                    OI0.oIX0oI.f1507oIX0oI.oIX0oI(this.f23296oIX0oI.TAG + " BROADCAST_DFU_STATE result : dfuState=" + intExtra + "  dfuStateResult = " + intExtra2);
                                    if (intExtra == 100) {
                                        final DeveloperUpgradeSActivity developerUpgradeSActivity = this.f23296oIX0oI;
                                        ...
                                        /*  JADX ERROR: Method code generation error
                                            jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x009f: INVOKE 
                                              ...
                                              (r4v9 'developerUpgradeSActivity' com.sma.smartv3.ui.me.DeveloperUpgradeSActivity A[DONT_INLINE])
                                             A[MD:(int, com.sma.smartv3.ui.me.DeveloperUpgradeSActivity):void (m), WRAPPED] (LINE:157) call: com.sma.smartv3.ui.me.oXO0oOx0.<init>(int, com.sma.smartv3.ui.me.DeveloperUpgradeSActivity):void type: CONSTRUCTOR)
                                             STATIC call: com.blankj.utilcode.util.ThreadUtils.runOnUiThread(java.lang.Runnable):void A[MD:(java.lang.Runnable):void (m)] (LINE:160) in method: com.sma.smartv3.ui.me.DeveloperUpgradeSActivity$localBroadcastReceiver$2.1.onReceive(android.content.Context, android.content.Intent):void, file: classes11.dex
                                            	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:310)
                                            	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:273)
                                            	at jadx.core.codegen.RegionGen.makeSimpleBlock(RegionGen.java:94)
                                            	at jadx.core.dex.nodes.IBlock.generate(IBlock.java:15)
                                            	...
                                            	at java.base/java.util.stream.SortedOps$RefSortingSink.end(SortedOps.java:395)
                                            	at java.base/java.util.stream.Sink$ChainedReference.end(Sink.java:261)
                                            Caused by: jadx.core.utils.exceptions.JadxRuntimeException: Expected class to be processed at this point, class: com.sma.smartv3.ui.me.oXO0oOx0, state: NOT_LOADED
                                            	at jadx.core.dex.nodes.ClassNode.ensureProcessed(ClassNode.java:304)
                                            	at jadx.core.codegen.InsnGen.inlineAnonymousConstructor(InsnGen.java:781)
                                            	at jadx.core.codegen.InsnGen.makeConstructor(InsnGen.java:730)
                                            	at jadx.core.codegen.InsnGen.makeInsnBody(InsnGen.java:418)
                                        ...
                                        L30:
                                            ...
                                            r0.<init>()
                                            com.sma.smartv3.ui.me.DeveloperUpgradeSActivity r1 = r3.f23296oIX0oI
                                            java.lang.String r1 = com.sma.smartv3.ui.me.DeveloperUpgradeSActivity.access$getTAG$p(r1)
                                            r0.append(r1)
                                        ...
                                        L61:
                                            ...
                                            r1.<init>()
                                            com.sma.smartv3.ui.me.DeveloperUpgradeSActivity r2 = r3.f23296oIX0oI
                                            java.lang.String r2 = com.sma.smartv3.ui.me.DeveloperUpgradeSActivity.access$getTAG$p(r2)
                                            r1.append(r2)
                                            ...
                                            r0 = 100
                                            if (r4 != r0) goto Le0
                                            com.sma.smartv3.ui.me.DeveloperUpgradeSActivity r4 = r3.f23296oIX0oI
                                            com.sma.smartv3.ui.me.oXO0oOx0 r0 = new com.sma.smartv3.ui.me.oXO0oOx0
                                            r0.<init>(r5, r4)
                                        ...
                                        Lac:
                                            ...
                                            r5.oIX0oI(r0)
                                            com.sma.smartv3.ui.me.DeveloperUpgradeSActivity r5 = r3.f23296oIX0oI
                                            com.sma.smartv3.ui.me.xIx r0 = new com.sma.smartv3.ui.me.xIx
                                            r0.<init>(r5, r4)
                                            com.blankj.utilcode.util.ThreadUtils.runOnUiThread(r0)
                                        Le0:
                                            return
                                        */
                                        throw new UnsupportedOperationException("Method not decompiled: com.sma.smartv3.ui.me.DeveloperUpgradeSActivity$localBroadcastReceiver$2.AnonymousClass1.onReceive(android.content.Context, android.content.Intent):void");
                                    }
                                }
                                ...
                                public final AnonymousClass1 invoke() {
                                    return new AnonymousClass1(DeveloperUpgradeSActivity.this);
                                }
                            });
                            this.serviceConnection = new II0xO0();
                        }
                        ...
                        public final void checkFirmware() {
                            ...
                            if (firmwareVersion != null) {
                                ...
                                this.mFilePath = com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(X00IoxXI.oIX0oI.f3233oIX0oI) + IOUtils.DIR_SEPARATOR_UNIX + firmwareVersion.getFileName();
                                if (getMArg1() > 0) {
                                    upgrade();
                                } else {
                        ...
                        public final void download(@OXOo.OOXIXo FirmwareVersion firmwareVersion) {
                            ...
                            NetWorkUtils.INSTANCE.download(firmwareVersion.getFileUrl(), com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(X00IoxXI.oIX0oI.f3233oIX0oI), firmwareVersion.getFileName(), new HttpProgressCallback<String>() { // from class: com.sma.smartv3.ui.me.DeveloperUpgradeSActivity$download$1
                                @Override // xxxI.II0xO0
                                public void handleError(@OXOo.OOXIXo String error) {
                                    TextView tvTip;
                                    kotlin.jvm.internal.IIX0o.x0xO0oo(error, "error");
                                    OI0.oIX0oI.f1507oIX0oI.oIX0oI(DeveloperUpgradeSActivity.this.TAG + " download firmware error -> " + error);
                                    tvTip = DeveloperUpgradeSActivity.this.getTvTip();
                                    tvTip.setText(String.valueOf(DeveloperUpgradeSActivity.this.getString(R.string.request_error)));
                                    DeveloperUpgradeSActivity.this.setMStarted(false);
                                }
                                ...
                                public void handleResponse(@OXOo.oOoXoXO String str) {
                                    DeveloperUpgradeSActivity.this.upgrade();
                                }
                            });
                        }
                        ...
                        public void initView() {
                            ...
                            getTvLatest().setText(getString(R.string.v_s, this.mLatest.getVersion()));
                            getTvCurrent().setText(getString(R.string.v_s, this.mCurrent));
                        }
                        ...
                        public final void startOTA(@OXOo.OOXIXo String zipFilePath, @OXOo.OOXIXo String destDirPath) {
                            ...
                            iSifliDFUService.startActionDFUNorExt(this, this.deviceAddress, oxoX2, 0, 0);
                            setMStarted(true);
                        }
                        ...
                        public final void upgrade() {
                            ...
                            sb.append("/ota_hcpu.zip");
                            String sb2 = sb.toString();
                            if (FileUtils.copy(this.mFilePath, sb2)) {
                                startOTA(sb2, com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(oix0oi));
                                return;
                            }
                            ToastUtils.showLong(this.TAG + " 文件错误", new Object[0]);
                        }
                    }
