...
@kotlin.jvm.internal.XX({"SMAP\nDeveloperUpgradeNActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperUpgradeNActivity.kt\ncom/sma/smartv3/ui/me/DeveloperUpgradeNActivity\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n*L\n1#1,198:1\n19#2:199\n15#2:200\n15#2:201\n*S KotlinDebug\n*F\n+ 1 DeveloperUpgradeNActivity.kt\ncom/sma/smartv3/ui/me/DeveloperUpgradeNActivity\n*L\n42#1:199\n42#1:200\n132#1:201\n*E\n"})
/* loaded from: classes11.dex */
public final class DeveloperUpgradeNActivity extends BaseFirmwareUpgradeActivity {
    ...
    @OXOo.OOXIXo
    private final kotlin.X0IIOO mBleScanner$delegate;

    @OXOo.OOXIXo
    private final String mCurrent;

    @OXOo.OOXIXo
    private final II0xO0 mDfuProgressListener;

    @OXOo.oOoXoXO
    private final FirmwareVersion mLatest;

    @kotlin.jvm.internal.XX({"SMAP\nDeveloperUpgradeNActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperUpgradeNActivity.kt\ncom/sma/smartv3/ui/me/DeveloperUpgradeNActivity$mDfuProgressListener$1\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n*L\n1#1,198:1\n11#2,2:199\n*S KotlinDebug\n*F\n+ 1 DeveloperUpgradeNActivity.kt\ncom/sma/smartv3/ui/me/DeveloperUpgradeNActivity$mDfuProgressListener$1\n*L\n103#1:199,2\n*E\n"})
    /* loaded from: classes11.dex */
    public static final class II0xO0 extends DfuProgressListenerAdapter {
        ...
        public void onDfuAborted(@OXOo.OOXIXo String deviceAddress) {
            ...
            DeveloperUpgradeNActivity.this.setMStarted(false);
            ProgressButton.X0o0xo(DeveloperUpgradeNActivity.this.getProgressButton(), R.string.firmware_upgrading_failed, false, 2, null);
        ...
        public void onDfuCompleted(@OXOo.OOXIXo String deviceAddress) {
            ...
            DeveloperUpgradeNActivity.this.alreadyUpdateDeviceList.oxoX().add(xo0.II0xO0().getString(com.sma.smartv3.util.XoI0Ixx0.f24456oo));
            xo0.II0xO0().put(ooOOo0oXI.class.getName(), new Gson().toJson(DeveloperUpgradeNActivity.this.alreadyUpdateDeviceList));
            DeveloperUpgradeNActivity.this.finish();
        }

        @Override // no.nordicsemi.android.dfu.DfuProgressListenerAdapter, no.nordicsemi.android.dfu.DfuProgressListener
        public void onDfuProcessStarting(@OXOo.OOXIXo String deviceAddress) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(deviceAddress, "deviceAddress");
            ProgressButton.X0o0xo(DeveloperUpgradeNActivity.this.getProgressButton(), R.string.starting, false, 2, null);
        }

        @Override // no.nordicsemi.android.dfu.DfuProgressListenerAdapter, no.nordicsemi.android.dfu.DfuProgressListener
        public void onError(@OXOo.OOXIXo String deviceAddress, int i, int i2, @OXOo.oOoXoXO String str) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(deviceAddress, "deviceAddress");
            LogUtils.d("DeveloperUpgradeNActivity onError -> " + deviceAddress + TokenParser.SP + i + TokenParser.SP + i2 + TokenParser.SP + str);
            DeveloperUpgradeNActivity.this.setMStarted(false);
            ProgressButton.X0o0xo(DeveloperUpgradeNActivity.this.getProgressButton(), R.string.firmware_upgrading_failed, false, 2, null);
            com.sma.smartv3.util.Xo0.f24349oIX0oI.II0xO0().put(com.sma.smartv3.util.XoI0Ixx0.f24419XO, true);
        }
        ...
        public void onProgressChanged(@OXOo.OOXIXo String deviceAddress, int i, float f, float f2, int i2, int i3) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(deviceAddress, "deviceAddress");
            DeveloperUpgradeNActivity.this.getProgressButton().setProgress(i / 100.0f);
        }
    }
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public void onOTA(boolean z) {
            if (z) {
                ...
                DeveloperUpgradeNActivity.this.getMBleScanner().oOoXoXO(true);
                DeveloperUpgradeNActivity.this.setMStarted(true);
            }
        }
    ...
    public DeveloperUpgradeNActivity() {
        com.sma.smartv3.util.Xo0 xo0 = com.sma.smartv3.util.Xo0.f24349oIX0oI;
        ...
        this.mBleScanner$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<XOxIOxOx.II0xO0>() { // from class: com.sma.smartv3.ui.me.DeveloperUpgradeNActivity$mBleScanner$2

            /* loaded from: classes11.dex */
            public static final class oIX0oI implements XOxIOxOx.oxoX {

                /* renamed from: oIX0oI, reason: collision with root package name */
                public final /* synthetic */ DeveloperUpgradeNActivity f23278oIX0oI;

                public oIX0oI(DeveloperUpgradeNActivity developerUpgradeNActivity) {
                    this.f23278oIX0oI = developerUpgradeNActivity;
                }
                ...
                public void II0xO0(@OXOo.OOXIXo BleDevice device) {
                    ...
                    this.f23278oIX0oI.getMBleScanner().oOoXoXO(false);
                    DfuServiceInitiator dfuServiceInitiator = new DfuServiceInitiator(device.getMBluetoothDevice().getAddress());
                    DeveloperUpgradeNActivity developerUpgradeNActivity = this.f23278oIX0oI;
                    ...
                    firmwareVersion = developerUpgradeNActivity.mLatest;
                    ...
                    dfuServiceInitiator.start(developerUpgradeNActivity, DfuService.class);
                }

                @Override // XOxIOxOx.oxoX
                public void oIX0oI(boolean z) {
                    this.f23278oIX0oI.getProgressButton().setEnabled(!z);
                }
            }
            ...
            public final XOxIOxOx.II0xO0 invoke() {
                XOxIOxOx.II0xO0 Oo2 = XOxIOxOx.oO.II0xO0(XOxIOxOx.oO.f3971oIX0oI, null, null, 3, null).Oo(10);
                DeveloperUpgradeNActivity developerUpgradeNActivity = DeveloperUpgradeNActivity.this;
                String string = com.sma.smartv3.util.Xo0.f24349oIX0oI.II0xO0().getString(com.sma.smartv3.util.XoI0Ixx0.f24456oo);
                kotlin.jvm.internal.IIX0o.oO(string, "getString(...)");
                return Oo2.IXxxXO(new XOxIOxOx.I0Io(developerUpgradeNActivity.getNordicOtaModeAddress(string))).ooOOo0oXI(new oIX0oI(DeveloperUpgradeNActivity.this));
            }
        });
        this.mDfuProgressListener = new II0xO0();
    ...
    @OXOo.OOXIXo
    public final String getNordicOtaModeAddress(@OXOo.OOXIXo String address) {
    ...
    public final void onBottomClick(@OXOo.OOXIXo View view) {
        ...
        kotlin.jvm.internal.IIX0o.ooOOo0oXI(firmwareVersion);
        netWorkUtils.download(firmwareVersion.getFileUrl(), com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(X00IoxXI.oIX0oI.f3233oIX0oI), this.mLatest.getFileName(), new DeveloperUpgradeNActivity$onBottomClick$1(this));
    }
