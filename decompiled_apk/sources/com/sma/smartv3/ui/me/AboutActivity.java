...
@kotlin.jvm.internal.XX({"SMAP\nAboutActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 AboutActivity.kt\ncom/sma/smartv3/ui/me/AboutActivity\n+ 2 Activity.kt\ncom/bestmafen/androidbase/extension/ActivityKt\n+ 3 fake.kt\nkotlin/jvm/internal/FakeKt\n+ 4 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n*L\n1#1,284:1\n69#2,3:285\n72#2,5:289\n1#3:288\n19#4:294\n15#4:295\n90#4:296\n*S KotlinDebug\n*F\n+ 1 AboutActivity.kt\ncom/sma/smartv3/ui/me/AboutActivity\n*L\n89#1:285,3\n89#1:289,5\n89#1:288\n142#1:294\n142#1:295\n146#1:296\n*E\n"})
...
public class AboutActivity extends BaseActivity {
    ...
    @OXOo.OOXIXo
    private final kotlin.X0IIOO rootView$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<View>() { // from class: com.sma.smartv3.ui.me.AboutActivity$rootView$2
        {
            super(0);
        }
        ...
        public final View invoke() {
            return AboutActivity.this.findViewById(R.id.root_view);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO ll_open_source$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<View>() { // from class: com.sma.smartv3.ui.me.AboutActivity$ll_open_source$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final View invoke() {
            return AboutActivity.this.findViewById(R.id.ll_open_source);
        }
    });
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public void onReadDeviceFile(@OXOo.OOXIXo BleDeviceFile deviceFile) {
            ...
            boolean z = ActivityUtils.getTopActivity() instanceof AboutActivity;
    ...
    public final void dismissLoadPopup() {
        runOnUiThread(new Runnable() { // from class: com.sma.smartv3.ui.me.oIX0oI
            @Override // java.lang.Runnable
            public final void run() {
                AboutActivity.dismissLoadPopup$lambda$4(AboutActivity.this);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void dismissLoadPopup$lambda$4(AboutActivity this$0) {
    ...
    private final String getAppVersionName() {
        ...
        if (kotlin.jvm.internal.IIX0o.Oxx0IOOO(api.getBASE_URL(), O0X.f23385II0xO0)) {
            return appVersionName + "-ceshi";
        }
        if (kotlin.jvm.internal.IIX0o.Oxx0IOOO(api.getBASE_URL(), O0X.f23389oIX0oI)) {
            return appVersionName + "-dev";
        }
        if (StringsKt__StringsKt.o00xOoIO(api.getBASE_URL(), "192.168", false, 2, null)) {
            return appVersionName + '-' + api.getBASE_URL();
        }
        return appVersionName;
    }

    private final View getLl_open_source() {
        return (View) this.ll_open_source$delegate.getValue();
    }
    ...
    public void initView() {
        int i;
        ((TextView) findViewById(R.id.abh_title_center)).setText(R.string.about);
        ((TextView) findViewById(R.id.tvVersion)).setText(getAppVersionName());
        View ll_open_source = getLl_open_source();
        ProjectManager projectManager = ProjectManager.f19822oIX0oI;
        int i2 = 8;
        if (projectManager.oX0I0O()) {
            i = 0;
        } else {
            i = 8;
        }
        ll_open_source.setVisibility(i);
        View findViewById = findViewById(R.id.ll_icp);
        if (findViewById != null) {
            if (projectManager.IoOoo()) {
                i2 = 0;
            }
    ...
    public final void onUploadLog(@OXOo.OOXIXo View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(view, "view");
        ...
        SPUtils XO2 = xo0.XO();
        AppUser appUser = new AppUser(0, null, null, null, null, null, null, 0, 0, 0.0f, 0.0f, null, null, null, null, null, null, 0.0f, 0.0f, 0, 0, null, null, null, null, null, 67108863, null);
        ...
        ?? identity = ((AppUser) objectRef.element).getIdentity();
        objectRef2.element = identity;
        if (((CharSequence) identity).length() == 0) {
            ...
            if (appUser2 != null) {
                objectRef2.element = appUser2.getIdentity();
            }
        }
        com.sma.smartv3.pop.XoI0Ixx0 xoI0Ixx0 = new com.sma.smartv3.pop.XoI0Ixx0(this, 0, 2, null);
        xoI0Ixx0.IoOoX(R.string.upload_log);
        xoI0Ixx0.oo(getString(R.string.upload_log_tip) + "\nName:\n" + ((AppUser) objectRef.element).getNickname() + "\nId:\n" + ((String) objectRef2.element) + "\nServer:\n" + UtilsKt.IXxxXO());
        TextView textView = (TextView) xoI0Ixx0.xxIXOIIO().findViewById(R.id.tv_content);
        FrameLayout xxIXOIIO2 = xoI0Ixx0.xxIXOIIO();
        textView.setMaxLines(Integer.MAX_VALUE);
        com.sma.smartv3.pop.XoI0Ixx0.IO(xoI0Ixx0, Integer.valueOf(R.string.cancel), null, 2, null);
        xoI0Ixx0.x0o(R.string.upload_log, new AboutActivity$onUploadLog$2$1(this, objectRef, objectRef2, xoI0Ixx0, xxIXOIIO2));
        xoI0Ixx0.IIXOooo();
    }

    public final void onVersion(@OXOo.OOXIXo View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(view, "view");
        int i = this.mVersionClicked + 1;
        this.mVersionClicked = i;
        if (i == 7) {
            this.mVersionClicked = 0;
            View findViewById = findViewById(R.id.ll_upload_log);
            if (findViewById != null) {
    ...
    public final void openSource(@OXOo.OOXIXo View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(view, "view");
        startActivity(new Intent(this, (Class<?>) OpenSourceComponentNotification.class));
    }

    public final void toDeveloper(@OXOo.OOXIXo View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(view, "view");
        int i = this.mClicked + 1;
        this.mClicked = i;
        if (i == 7) {
            this.mClicked = 0;
            if (this.mEditPop == null) {
                com.sma.smartv3.pop.IIX0o iIX0o = new com.sma.smartv3.pop.IIX0o(getMContext(), 0, 2, null);
                iIX0o.xXxxox0I().setHint(LocationInfo.NA);
                iIX0o.X00IoxXI(2);
                iIX0o.IO(new Oox.oOoXoXO<String, Boolean>() { // from class: com.sma.smartv3.ui.me.AboutActivity$toDeveloper$1$1
                    {
                        super(1);
                    }
                    ...
                    public final Boolean invoke(@OXOo.OOXIXo String text) {
                        ...
                        boolean Oxx0IOOO2 = kotlin.jvm.internal.IIX0o.Oxx0IOOO(text, "837765");
                        Boolean valueOf = Boolean.valueOf(Oxx0IOOO2);
    ...
    public final void toPrivacyPolicy(@OXOo.OOXIXo View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(view, "view");
        ProjectManager.f19822oIX0oI.OIxx0I0(this);
    }
}
