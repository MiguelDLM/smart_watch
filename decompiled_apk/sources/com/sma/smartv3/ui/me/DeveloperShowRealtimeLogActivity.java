...
public final class DeveloperShowRealtimeLogActivity extends BaseListActivity<BleRealtimeLog> {

    @OXOo.OOXIXo
    private final ArrayList<BleRealtimeLog> dataList = new ArrayList<>();
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public void onReceiveRealtimeLog(@OXOo.OOXIXo BleRealtimeLog realtimeLog) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(realtimeLog, "realtimeLog");
            DeveloperShowRealtimeLogActivity.this.dataList.add(realtimeLog);
            DeveloperShowRealtimeLogActivity.this.getMListAdapter().notifyDataSetChanged();
        }
    ...
    public final void clearData(@OXOo.OOXIXo View view) {
        ...
        ToastUtils.showLong("Clear Show", new Object[0]);
    }
    ...
    @OXOo.OOXIXo
    public List<BleRealtimeLog> initList() {
    ...
    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return com.sma.smartv3.co_fit.R.layout.activity_developer_show_realtime_log;
    }
    ...
    public void initItem(@OXOo.OOXIXo XIOOI.I0Io holder, @OXOo.OOXIXo BleRealtimeLog item, int i) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(holder, "holder");
        kotlin.jvm.internal.IIX0o.x0xO0oo(item, "item");
        holder.o00(R.id.text1, item.getMContent());
    }
}
