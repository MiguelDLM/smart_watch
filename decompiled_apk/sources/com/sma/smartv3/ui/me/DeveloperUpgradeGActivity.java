...
import com.sma.smartv3.ui.me.DeveloperUpgradeGActivity;
...
@kotlin.jvm.internal.XX({"SMAP\nDeveloperUpgradeGActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperUpgradeGActivity.kt\ncom/sma/smartv3/ui/me/DeveloperUpgradeGActivity\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n*L\n1#1,210:1\n19#2:211\n15#2:212\n15#2:213\n11#2,2:214\n*S KotlinDebug\n*F\n+ 1 DeveloperUpgradeGActivity.kt\ncom/sma/smartv3/ui/me/DeveloperUpgradeGActivity\n*L\n40#1:211\n40#1:212\n53#1:213\n135#1:214,2\n*E\n"})
/* loaded from: classes11.dex */
public final class DeveloperUpgradeGActivity extends BaseFirmwareUpgradeActivity implements Observer<Object>, EasyDfu.DfuEvent {
    ...
    @OXOo.OOXIXo
    private final kotlin.X0IIOO mActivity$delegate;
    ...
    @OXOo.OOXIXo
    private final kotlin.X0IIOO mDevice$delegate;
    private List<? extends File> mDfuFiles;
    ...
    public static final class II0xO0 implements BleHandleCallback {
        ...
        public static final void II0xO0() {
        ...
        public void onOTA(boolean z) {
            LogUtils.d("test " + z);
            if (z) {
                DeveloperUpgradeGActivity.this.upgrade();
                return;
            }
            DeveloperUpgradeGActivity.this.setMStarted(false);
            ProgressButton.X0o0xo(DeveloperUpgradeGActivity.this.getProgressButton(), R.string.firmware_upgrading_failed, false, 2, null);
            ToastUtils.showLong("发送OTA指令失败，延时4秒后自动重试，请稍后..", new Object[0]);
            new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.X0xII0I
                @Override // java.lang.Runnable
                public final void run() {
                    DeveloperUpgradeGActivity.II0xO0.II0xO0();
                }
            }, 4000L);
        }
    ...
    public /* synthetic */ class oIX0oI {
        ...
        public static final /* synthetic */ int[] f23260oIX0oI;
    ...
    public DeveloperUpgradeGActivity() {
        ...
        this.mActivity$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<DeveloperUpgradeGActivity>() { // from class: com.sma.smartv3.ui.me.DeveloperUpgradeGActivity$mActivity$2
            {
                super(0);
            }
            ...
            @Override // Oox.oIX0oI
            @OXOo.OOXIXo
            public final DeveloperUpgradeGActivity invoke() {
                return DeveloperUpgradeGActivity.this;
            }
        });
        this.mDevice$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<BluetoothDevice>() { // from class: com.sma.smartv3.ui.me.DeveloperUpgradeGActivity$mDevice$2
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // Oox.oIX0oI
            public final BluetoothDevice invoke() {
                return BluetoothAdapter.getDefaultAdapter().getRemoteDevice(com.sma.smartv3.util.Xo0.f24349oIX0oI.II0xO0().getString(com.sma.smartv3.util.XoI0Ixx0.f24456oo));
            }
        });
    ...
    private final DeveloperUpgradeGActivity getMActivity() {
        return (DeveloperUpgradeGActivity) this.mActivity$delegate.getValue();
    }
    ...
    private final void resetDfuConnection() {
        DfuConnection dfuConnection = this.dfuConnection;
        if (dfuConnection != null) {
            dfuConnection.ooOOo0oXI().removeObserver(getMActivity());
            dfuConnection.x0xO0oo().removeObserver(getMActivity());
            dfuConnection.oO().setListener(null);
        }
        DfuConnection dfuConnection2 = this.dfuConnection;
        if (dfuConnection2 != null) {
            dfuConnection2.IXxxXO();
        }
    }
    ...
    public final void upgrade() {
        ...
        setMStarted(true);
        getProgressButton().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.x0
            @Override // java.lang.Runnable
            public final void run() {
                DeveloperUpgradeGActivity.upgrade$lambda$1(DeveloperUpgradeGActivity.this);
            }
        }, 10000L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void upgrade$lambda$1(DeveloperUpgradeGActivity this$0) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        LogUtils.d("test upgrade");
        this$0.resetDfuConnection();
        DfuConnection dfuConnection = new DfuConnection(this$0.getMContext(), this$0.getMDevice());
        LogUtils.d("test dfuConnection");
        dfuConnection.ooOOo0oXI().observe(this$0.getMActivity(), this$0.getMActivity());
        dfuConnection.x0xO0oo().observe(this$0.getMActivity(), this$0.getMActivity());
        dfuConnection.oO().setListener(this$0.getMActivity());
        dfuConnection.Oo();
        this$0.dfuConnection = dfuConnection;
    }
    ...
    public final void onBottomClick(@OXOo.OOXIXo View view) {
        ...
        netWorkUtils.download(firmwareVersion.getFileUrl(), com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(X00IoxXI.oIX0oI.f3233oIX0oI), this.mLatest.getFileName(), new HttpProgressCallback<String>() { // from class: com.sma.smartv3.ui.me.DeveloperUpgradeGActivity$onBottomClick$1
            ...
            public void handleResponse(@OXOo.oOoXoXO String str) {
                ...
                firmwareVersion2 = DeveloperUpgradeGActivity.this.mLatest;
                File file2 = new File(file, firmwareVersion2.getFileName());
                DeveloperUpgradeGActivity developerUpgradeGActivity = DeveloperUpgradeGActivity.this;
                List<File> unzipFile = ZipUtils.unzipFile(file2, file);
                kotlin.jvm.internal.IIX0o.oO(unzipFile, "unzipFile(...)");
                ArrayList arrayList = new ArrayList();
                for (Object obj : unzipFile) {
                    File file3 = (File) obj;
                    if (file3.isFile()) {
                        String path = file3.getPath();
                        kotlin.jvm.internal.IIX0o.oO(path, "getPath(...)");
                        if (kotlin.text.OxI.XO0o(path, ".bin", false, 2, null)) {
                            arrayList.add(obj);
                        }
                    }
                }
                developerUpgradeGActivity.mDfuFiles = arrayList;
                list = DeveloperUpgradeGActivity.this.mDfuFiles;
                if (list == null) {
                    kotlin.jvm.internal.IIX0o.XOxIOxOx("mDfuFiles");
                    list = null;
                }
                if (list.size() < 2) {
                    DeveloperUpgradeGActivity.this.setMStarted(false);
    ...
    public void onChanged(@OXOo.OOXIXo Object connState) {
        DfuConnection dfuConnection;
        EasyDfu oO2;
        kotlin.jvm.internal.IIX0o.x0xO0oo(connState, "connState");
        LogUtils.d("test " + connState);
        if (connState instanceof DfuConnection.ConnState) {
            int i = oIX0oI.f23260oIX0oI[((DfuConnection.ConnState) connState).ordinal()];
            List<? extends File> list = null;
            if (i != 1) {
                if (i == 2 && (dfuConnection = this.dfuConnection) != null && (oO2 = dfuConnection.oO()) != null) {
                    List<? extends File> list2 = this.mDfuFiles;
                    if (list2 == null) {
                        kotlin.jvm.internal.IIX0o.XOxIOxOx("mDfuFiles");
                        list2 = null;
                    }
                    FileInputStream fileInputStream = new FileInputStream(list2.get(0));
                    List<? extends File> list3 = this.mDfuFiles;
                    if (list3 == null) {
                        kotlin.jvm.internal.IIX0o.XOxIOxOx("mDfuFiles");
                    } else {
                        list = list3;
                    }
                    oO2.startDfuInABMode(fileInputStream, new FileInputStream(list.get(1)));
                    return;
                }
                return;
            }
    ...
    public void onDfuComplete() {
        ArrayList<String> oxoX2 = this.alreadyUpdateDeviceList.oxoX();
        com.sma.smartv3.util.Xo0 xo0 = com.sma.smartv3.util.Xo0.f24349oIX0oI;
        oxoX2.add(xo0.II0xO0().getString(com.sma.smartv3.util.XoI0Ixx0.f24456oo));
        xo0.II0xO0().put(ooOOo0oXI.class.getName(), new Gson().toJson(this.alreadyUpdateDeviceList));
        finish();
    }

    @Override // com.goodix.ble.gr.libdfu.EasyDfu.DfuEvent
    public void onDfuError(@OXOo.OOXIXo String p0, @OXOo.OOXIXo Error p1) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(p0, "p0");
        kotlin.jvm.internal.IIX0o.x0xO0oo(p1, "p1");
        setMStarted(false);
    ...
    public void onDfuProgress(int i) {
        getProgressButton().setProgress(i / 100.0f);
    }
