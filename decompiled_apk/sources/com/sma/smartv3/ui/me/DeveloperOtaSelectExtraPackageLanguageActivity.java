...
@kotlin.jvm.internal.XX({"SMAP\nDeveloperOtaSelectExtraPackageLanguageActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperOtaSelectExtraPackageLanguageActivity.kt\ncom/sma/smartv3/ui/me/DeveloperOtaSelectExtraPackageLanguageActivity\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n+ 3 Activity.kt\ncom/bestmafen/androidbase/extension/ActivityKt\n+ 4 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,89:1\n19#2:90\n15#2:91\n19#2:92\n15#2:93\n11#2,2:112\n69#3,3:94\n72#3,5:98\n69#3,3:103\n72#3,5:107\n1#4:97\n1#4:106\n*S KotlinDebug\n*F\n+ 1 DeveloperOtaSelectExtraPackageLanguageActivity.kt\ncom/sma/smartv3/ui/me/DeveloperOtaSelectExtraPackageLanguageActivity\n*L\n26#1:90\n26#1:91\n32#1:92\n32#1:93\n74#1:112,2\n42#1:94,3\n42#1:98,5\n85#1:103,3\n85#1:107,5\n42#1:97\n85#1:106\n*E\n"})
/* loaded from: classes11.dex */
public final class DeveloperOtaSelectExtraPackageLanguageActivity extends BaseListActivity<ExtraPackageData> {

    @OXOo.OOXIXo
    private final ExtraPackVersions extraPackVersions;

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvSelectRemind$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.me.DeveloperOtaSelectExtraPackageLanguageActivity$tvSelectRemind$2
        {
            super(0);
        }
        ...
        public final TextView invoke() {
            return (TextView) DeveloperOtaSelectExtraPackageLanguageActivity.this.findViewById(R.id.tv_select_remind);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvSelect$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.me.DeveloperOtaSelectExtraPackageLanguageActivity$tvSelect$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final TextView invoke() {
            return (TextView) DeveloperOtaSelectExtraPackageLanguageActivity.this.findViewById(R.id.tv_select);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO btNext$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AppCompatButton>() { // from class: com.sma.smartv3.ui.me.DeveloperOtaSelectExtraPackageLanguageActivity$btNext$2
        {
            super(0);
        }
        ...
        public final AppCompatButton invoke() {
            return (AppCompatButton) DeveloperOtaSelectExtraPackageLanguageActivity.this.findViewById(R.id.bt_next);
        }
    });
    ...
    public DeveloperOtaSelectExtraPackageLanguageActivity() {
    ...
    public static final void initItem$lambda$1$lambda$0(DeveloperOtaSelectExtraPackageLanguageActivity this$0, ExtraPackageData item, View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        kotlin.jvm.internal.IIX0o.x0xO0oo(item, "$item");
        this$0.getTvSelect().setText(item.getVersion() + "  -- " + item.getInfo());
        this$0.extraPackVersions.setLanguagePackVersion(new FirmwareVersion(item.getFileName(), item.getFileSize(), item.getFileUrl(), item.getVersion(), item.getInfo(), 0, null, null, null, 480, null));
    ...
    public void init(@OXOo.oOoXoXO Bundle bundle) {
        ...
        if (this.dataList.size() == 0) {
            startActivity(new Intent(this, (Class<?>) DeveloperOtaSelectExtraPackageBrandActivity.class));
        }
    }
    ...
    public void initView() {
        super.initView();
        getTvSelectRemind().setText(R.string.select_remind_language_pack);
    }
    ...
    public void initItem(@OXOo.OOXIXo XIOOI.I0Io holder, @OXOo.OOXIXo final ExtraPackageData item, int i) {
        ...
        holder.oO(android.R.id.text1, new View.OnClickListener() { // from class: com.sma.smartv3.ui.me.XI0oooXX
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                DeveloperOtaSelectExtraPackageLanguageActivity.initItem$lambda$1$lambda$0(DeveloperOtaSelectExtraPackageLanguageActivity.this, item, view);
            }
        });
    }
}
