...
import com.sma.smartv3.ui.me.DeveloperTestHRActivity;
...
@kotlin.jvm.internal.XX({"SMAP\nDeveloperTestHRActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperTestHRActivity.kt\ncom/sma/smartv3/ui/me/DeveloperTestHRActivity\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,157:1\n1#2:158\n*E\n"})
/* loaded from: classes11.dex */
public final class DeveloperTestHRActivity extends BaseListActivity<HeartRate> {
    ...
    @OXOo.OOXIXo
    private final kotlin.X0IIOO etReadHrInterval$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<EditText>() { // from class: com.sma.smartv3.ui.me.DeveloperTestHRActivity$etReadHrInterval$2
        {
            super(0);
        }
        ...
        public final EditText invoke() {
            return (EditText) DeveloperTestHRActivity.this.findViewById(R.id.et_read_hr_interval);
        }
    });
    private int interval = 2;

    @OXOo.OOXIXo
    private final ArrayList<HeartRate> dataList = new ArrayList<>();

    @OXOo.OOXIXo
    private final oIX0oI mBleHandleCallback = new oIX0oI();

    @kotlin.jvm.internal.XX({"SMAP\nDeveloperTestHRActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperTestHRActivity.kt\ncom/sma/smartv3/ui/me/DeveloperTestHRActivity$mBleHandleCallback$1\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,157:1\n1549#2:158\n1620#2,3:159\n*S KotlinDebug\n*F\n+ 1 DeveloperTestHRActivity.kt\ncom/sma/smartv3/ui/me/DeveloperTestHRActivity$mBleHandleCallback$1\n*L\n52#1:158\n52#1:159,3\n*E\n"})
    /* loaded from: classes11.dex */
    public static final class oIX0oI implements BleHandleCallback {
        public oIX0oI() {
        }

        public static final void II0xO0(DeveloperTestHRActivity this$0) {
        ...
        public void onReadHeartRate(@OXOo.OOXIXo List<BleHeartRate> heartRates) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(heartRates, "heartRates");
            BleHandleCallback.DefaultImpls.onReadHeartRate(this, heartRates);
            SimpleDateFormat I0Io2 = com.sma.smartv3.util.xoIox.I0Io();
            Date date = new Date();
            long offset = TimeZone.getDefault().getOffset(System.currentTimeMillis());
            List<BleHeartRate> list = heartRates;
            ArrayList<HeartRate> arrayList = new ArrayList(kotlin.collections.OxxIIOOXO.xo0x(list, 10));
            Iterator<T> it = list.iterator();
            while (it.hasNext()) {
                HeartRate heartRate = new HeartRate((BleHeartRate) it.next(), offset);
            ...
            if (!DeveloperTestHRActivity.this.isTesting) {
                return;
            }
            for (HeartRate heartRate2 : arrayList) {
                DeveloperTestHRActivity.this.dataList.add(0, heartRate2);
                File file = DeveloperTestHRActivity.this.testDataFile;
                if (file != null) {
                    StringBuilder sb = new StringBuilder();
                    sb.append(heartRate2);
                    sb.append('\n');
                    FilesKt__FileReadWriteKt.xxIXOIIO(file, sb.toString(), null, 2, null);
                }
                DeveloperTestHRActivity.this.getMListAdapter().notifyDataSetChanged();
            }
        }
        ...
        public void onSyncData(int i, @OXOo.OOXIXo BleKey bleKey) {
            ...
            if (i == -2 || i == -1 || i == 0) {
                ...
                final DeveloperTestHRActivity developerTestHRActivity = DeveloperTestHRActivity.this;
                handler.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.oOoIIO0
                    @Override // java.lang.Runnable
                    public final void run() {
                        DeveloperTestHRActivity.oIX0oI.II0xO0(DeveloperTestHRActivity.this);
                    }
                }, DeveloperTestHRActivity.this.interval * 1000);
            }
        }
    ...
    private final EditText getEtReadHrInterval() {
        return (EditText) this.etReadHrInterval$delegate.getValue();
    }
    ...
    private final File getShareFile(String str) {
        return X00IoxXI.oIX0oI.f3233oIX0oI.oIX0oI(Location.EXTERNAL, X00IoxXI.II0xO0.f3231II0xO0.X0o0xo().II0xO0("share"), str);
    }

    public final void clearData(@OXOo.OOXIXo View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(view, "view");
        stopTest(view);
        this.dataList.clear();
        getMListAdapter().notifyDataSetChanged();
        FileUtils.delete(com.sma.smartv3.initializer.IXxxXO.xXOx(X00IoxXI.oIX0oI.f3233oIX0oI));
        ToastUtils.showLong("Stop and delete All data", new Object[0]);
    }

    public final void exportData(@OXOo.OOXIXo View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(view, "view");
        File shareFile = getShareFile("test-data-" + getMNow() + OTAManager.OTA_ZIP_SUFFIX);
        FileUtils.createOrExistsFile(shareFile);
        X00IoxXI.oIX0oI oix0oi = X00IoxXI.oIX0oI.f3233oIX0oI;
        ZipUtils.zipFile(com.sma.smartv3.initializer.IXxxXO.xXOx(oix0oi), shareFile);
        Intent intent = new Intent("android.intent.action.SEND");
        intent.putExtra("android.intent.extra.TEXT", "Share test data");
        intent.putExtra("android.intent.extra.STREAM", oix0oi.oxoX(shareFile));
    ...
    @OXOo.OOXIXo
    public List<HeartRate> initList() {
    ...
    public void initView() {
        super.initView();
        getEtReadHrInterval().setText(String.valueOf(this.interval));
    }
    ...
    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_developer_test_hr;
    }
    ...
    public final void setReadDataInterval(@OXOo.OOXIXo View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(view, "view");
        this.interval = Integer.parseInt(getEtReadHrInterval().getText().toString());
        ToastUtils.showLong("done", new Object[0]);
    }

    public final void startTest(@OXOo.OOXIXo View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(view, "view");
        this.isTesting = true;
        if (this.testDataFile == null) {
            this.testDataFile = com.sma.smartv3.initializer.IXxxXO.OO0x0xX(X00IoxXI.oIX0oI.f3233oIX0oI, new SimpleDateFormat("yyyyMMddHHmmss", Locale.getDefault()).format(new Date()) + ".txt");
        }
        BleConnector bleConnector = BleConnector.INSTANCE;
        if (bleConnector.isAvailable()) {
            BleConnector.sendData$default(bleConnector, BleKey.HEART_RATE, BleKeyFlag.READ, null, false, false, 28, null);
        } else {
            ToastUtils.showShort(R.string.not_connected);
        }
    }

    public final void stopTest(@OXOo.OOXIXo View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(view, "view");
    ...
    public void initItem(@OXOo.OOXIXo XIOOI.I0Io holder, @OXOo.OOXIXo HeartRate item, int i) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(holder, "holder");
        kotlin.jvm.internal.IIX0o.x0xO0oo(item, "item");
        holder.o00(android.R.id.text1, item.getMLocalTime());
        holder.o00(android.R.id.text2, String.valueOf(item.getMBpm()));
    }
}
