...
import com.sma.smartv3.ui.me.DeveloperFontRepairStartActivity;
...
@kotlin.jvm.internal.XX({"SMAP\nDeveloperFontRepairStartActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperFontRepairStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperFontRepairStartActivity\n+ 2 Activity.kt\ncom/bestmafen/androidbase/extension/ActivityKt\n+ 3 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,201:1\n173#2,7:202\n180#2,3:210\n143#2,7:213\n183#2:220\n1#3:209\n*S KotlinDebug\n*F\n+ 1 DeveloperFontRepairStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperFontRepairStartActivity\n*L\n142#1:202,7\n142#1:210,3\n142#1:213,7\n142#1:220\n142#1:209\n*E\n"})
/* loaded from: classes11.dex */
public final class DeveloperFontRepairStartActivity extends BaseListFunctionActivity<BleDevice> {

    @OXOo.oOoXoXO
    private com.sma.smartv3.pop.I0X0x0oIo mLoadingPopup;

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvFile$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.me.DeveloperFontRepairStartActivity$tvFile$2
        {
            super(0);
        }
        ...
        public final TextView invoke() {
            return (TextView) DeveloperFontRepairStartActivity.this.findViewById(R.id.tv_file);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO etSignal$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<EditText>() { // from class: com.sma.smartv3.ui.me.DeveloperFontRepairStartActivity$etSignal$2
        {
            super(0);
        }
        ...
        public final EditText invoke() {
            return (EditText) DeveloperFontRepairStartActivity.this.findViewById(R.id.et_signal);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO mScanner$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<XOxIOxOx.II0xO0>() { // from class: com.sma.smartv3.ui.me.DeveloperFontRepairStartActivity$mScanner$2

        @kotlin.jvm.internal.XX({"SMAP\nDeveloperFontRepairStartActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperFontRepairStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperFontRepairStartActivity$mScanner$2$2\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,201:1\n1002#2,2:202\n*S KotlinDebug\n*F\n+ 1 DeveloperFontRepairStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperFontRepairStartActivity$mScanner$2$2\n*L\n66#1:202,2\n*E\n"})
        /* loaded from: classes11.dex */
        public static final class II0xO0 implements XOxIOxOx.oxoX {

            /* renamed from: oIX0oI, reason: collision with root package name */
            public final /* synthetic */ DeveloperFontRepairStartActivity f23170oIX0oI;

            @kotlin.jvm.internal.XX({"SMAP\nComparisons.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Comparisons.kt\nkotlin/comparisons/ComparisonsKt__ComparisonsKt$compareBy$2\n+ 2 DeveloperFontRepairStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperFontRepairStartActivity$mScanner$2$2\n*L\n1#1,328:1\n66#2:329\n*E\n"})
            /* loaded from: classes11.dex */
            ...
            public II0xO0(DeveloperFontRepairStartActivity developerFontRepairStartActivity) {
                this.f23170oIX0oI = developerFontRepairStartActivity;
            }
            ...
            public void II0xO0(@OXOo.OOXIXo BleDevice device) {
                ...
                mList = this.f23170oIX0oI.getMList();
                if (!mList.contains(device)) {
                    mList2 = this.f23170oIX0oI.getMList();
                    mList2.add(device);
                    mList3 = this.f23170oIX0oI.getMList();
                    if (mList3.size() > 1) {
                        kotlin.collections.o00.OO0x0xX(mList3, new oIX0oI());
                    }
                    mListAdapter = this.f23170oIX0oI.getMListAdapter();
        ...
        public static final class oIX0oI implements XOxIOxOx.X0o0xo {
            ...
            public boolean oIX0oI(@OXOo.OOXIXo BleDevice device) {
                kotlin.jvm.internal.IIX0o.x0xO0oo(device, "device");
                if (device.getMRssi() > com.sma.smartv3.util.Xo0.f24349oIX0oI.II0xO0().getInt(com.sma.smartv3.util.XoI0Ixx0.f24428Xo0, -60)) {
                    return true;
                }
                return false;
            }
        ...
        public final XOxIOxOx.II0xO0 invoke() {
            return XOxIOxOx.oO.II0xO0(XOxIOxOx.oO.f3971oIX0oI, null, ScanMode.LOW_LATENCY, 1, null).Oo(10).IXxxXO(new oIX0oI()).ooOOo0oXI(new II0xO0(DeveloperFontRepairStartActivity.this));
        }
    });
    ...
    @kotlin.jvm.internal.XX({"SMAP\nDeveloperFontRepairStartActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperFontRepairStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperFontRepairStartActivity$mBleHandleCallback$1\n+ 2 Activity.kt\ncom/bestmafen/androidbase/extension/ActivityKt\n+ 3 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,201:1\n87#2,7:202\n94#2,3:210\n70#2,7:213\n97#2:220\n1#3:209\n*S KotlinDebug\n*F\n+ 1 DeveloperFontRepairStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperFontRepairStartActivity$mBleHandleCallback$1\n*L\n78#1:202,7\n78#1:210,3\n78#1:213,7\n78#1:220\n78#1:209\n*E\n"})
    /* loaded from: classes11.dex */
    public static final class oIX0oI implements BleHandleCallback {
        public oIX0oI() {
        }

        public static final void II0xO0(DeveloperFontRepairStartActivity this$0) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
            com.sma.smartv3.pop.I0X0x0oIo i0X0x0oIo = this$0.mLoadingPopup;
            if (i0X0x0oIo != null) {
                i0X0x0oIo.dismiss();
            }
            String obj = this$0.getTvFile().getText().toString();
            Bundle bundle = new Bundle();
            bundle.putString("mArg0", obj);
            bundle.putParcelable("mArg2", null);
            bundle.putSerializable("mArg3", null);
            Intent intent = new Intent(this$0, (Class<?>) DeveloperFontRepairRSmaActivity.class);
        ...
        public void onDeviceConnected(@OXOo.OOXIXo BluetoothDevice device) {
            ...
            final DeveloperFontRepairStartActivity developerFontRepairStartActivity = DeveloperFontRepairStartActivity.this;
            handler.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.I0oOoX
                @Override // java.lang.Runnable
                public final void run() {
                    DeveloperFontRepairStartActivity.oIX0oI.II0xO0(DeveloperFontRepairStartActivity.this);
                }
    ...
    public final TextView getTvFile() {
        return (TextView) this.tvFile$delegate.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$0(DeveloperFontRepairStartActivity this$0, AdapterView adapterView, View view, int i, long j) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        if (TextUtils.isEmpty(this$0.getTvFile().getText().toString())) {
            ToastUtils.showLong("Choose a file", new Object[0]);
            return;
        }
        ...
        BleDevice bleDevice = this$0.getMList().get(i);
        ...
        LogUtils.d("connect new device -> " + bleDevice);
    }
    ...
    public final void requestLocationPermission() {
        ...
        oOXoIIIo.X0o0xo.I0Io(permission, null, null, new Oox.oOoXoXO<PermissionStatus, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.me.DeveloperFontRepairStartActivity$requestLocationPermission$1

            /* loaded from: classes11.dex */
            public /* synthetic */ class oIX0oI {

                /* renamed from: oIX0oI, reason: collision with root package name */
                public static final /* synthetic */ int[] f23172oIX0oI;
            ...
            public final void invoke2(@OXOo.OOXIXo PermissionStatus it) {
                ...
                int i = oIX0oI.f23172oIX0oI[it.ordinal()];
                if (i == 1) {
                    DeveloperFontRepairStartActivity developerFontRepairStartActivity = DeveloperFontRepairStartActivity.this;
                    mListView = developerFontRepairStartActivity.getMListView();
                    developerFontRepairStartActivity.startSearch(mListView);
                } else if (i == 2) {
                    DeveloperFontRepairStartActivity.this.requestLocationPermission();
                } else {
                    DeveloperFontRepairStartActivity.this.permissionRemind();
                }
            }
        }, 3, null);
    }

    public final void chooseAssetFile(@OXOo.OOXIXo View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(view, "view");
        Bundle bundle = new Bundle();
        bundle.putString("mArg0", "firmware_font");
        bundle.putParcelable("mArg2", null);
        bundle.putSerializable("mArg3", null);
        Intent intent = new Intent(this, (Class<?>) DeveloperAssetFilesActivity.class);
        intent.putExtras(bundle);
        startActivityForResult(intent, 123);
    }

    public final void chooseFile(@OXOo.OOXIXo View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(view, "view");
    ...
    public void initView() {
        super.initView();
        getEtSignal().setText(String.valueOf(-com.sma.smartv3.util.Xo0.f24349oIX0oI.II0xO0().getInt(com.sma.smartv3.util.XoI0Ixx0.f24428Xo0, -60)));
        getMListView().setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: com.sma.smartv3.ui.me.XX
            @Override // android.widget.AdapterView.OnItemClickListener
            public final void onItemClick(AdapterView adapterView, View view, int i, long j) {
                DeveloperFontRepairStartActivity.initView$lambda$0(DeveloperFontRepairStartActivity.this, adapterView, view, i, j);
            }
        });
        startSearch(getMListView());
    }
    ...
    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_developer_test_fontrepair_start;
    }
    ...
    public void onActivityResult(int i, int i2, @OXOo.oOoXoXO Intent intent) {
        ...
        if (i2 == -1) {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                getTvFile().setText(data.toString());
            }
        }
    }
    ...
    public final void startSearch(@OXOo.OOXIXo View view) {
        ...
        com.sma.smartv3.util.Xo0.f24349oIX0oI.II0xO0().put(com.sma.smartv3.util.XoI0Ixx0.f24428Xo0, -Integer.parseInt(getEtSignal().getText().toString()));
        getMList().clear();
