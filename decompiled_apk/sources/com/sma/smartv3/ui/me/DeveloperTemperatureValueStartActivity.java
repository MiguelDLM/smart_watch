...
import com.sma.smartv3.ui.me.DeveloperTemperatureValueStartActivity;
...
@kotlin.jvm.internal.XX({"SMAP\nDeveloperTemperatureValueStartActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperTemperatureValueStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperTemperatureValueStartActivity\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n*L\n1#1,330:1\n19#2:331\n15#2:332\n27#2,2:333\n*S KotlinDebug\n*F\n+ 1 DeveloperTemperatureValueStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperTemperatureValueStartActivity\n*L\n172#1:331\n172#1:332\n252#1:333,2\n*E\n"})
/* loaded from: classes11.dex */
public final class DeveloperTemperatureValueStartActivity extends BaseListFunctionActivity<BleDevice> {
    private boolean isAutoTemperatureValue;

    @OXOo.oOoXoXO
    private com.sma.smartv3.pop.I0X0x0oIo mLoadingPopup;

    @OXOo.OOXIXo
    private final kotlin.X0IIOO etOldBleName$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<EditText>() { // from class: com.sma.smartv3.ui.me.DeveloperTemperatureValueStartActivity$etOldBleName$2
        {
            super(0);
        }
        ...
        public final EditText invoke() {
            return (EditText) DeveloperTemperatureValueStartActivity.this.findViewById(R.id.et_old_ble_name);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO btStartTemperatureValue$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AppCompatButton>() { // from class: com.sma.smartv3.ui.me.DeveloperTemperatureValueStartActivity$btStartTemperatureValue$2
        {
            super(0);
        }
        ...
        public final AppCompatButton invoke() {
            return (AppCompatButton) DeveloperTemperatureValueStartActivity.this.findViewById(R.id.bt_start_temperature_value);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO btStopTemperatureValue$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AppCompatButton>() { // from class: com.sma.smartv3.ui.me.DeveloperTemperatureValueStartActivity$btStopTemperatureValue$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final AppCompatButton invoke() {
            return (AppCompatButton) DeveloperTemperatureValueStartActivity.this.findViewById(R.id.bt_stop_temperature_value);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO etSignal$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<EditText>() { // from class: com.sma.smartv3.ui.me.DeveloperTemperatureValueStartActivity$etSignal$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final EditText invoke() {
            return (EditText) DeveloperTemperatureValueStartActivity.this.findViewById(R.id.et_signal);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvSearchNumber$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.me.DeveloperTemperatureValueStartActivity$tvSearchNumber$2
        {
            super(0);
        }
        ...
        public final TextView invoke() {
            return (TextView) DeveloperTemperatureValueStartActivity.this.findViewById(R.id.tv_search_number);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvAlreadyTemperatureValue$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.me.DeveloperTemperatureValueStartActivity$tvAlreadyTemperatureValue$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final TextView invoke() {
            return (TextView) DeveloperTemperatureValueStartActivity.this.findViewById(R.id.tv_already_temperature_value);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO etTemperatureValue$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<EditText>() { // from class: com.sma.smartv3.ui.me.DeveloperTemperatureValueStartActivity$etTemperatureValue$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final EditText invoke() {
            return (EditText) DeveloperTemperatureValueStartActivity.this.findViewById(R.id.et_temperature_value);
        }
    });
    ...
    @OXOo.OOXIXo
    private final kotlin.X0IIOO mScanner$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<XOxIOxOx.II0xO0>() { // from class: com.sma.smartv3.ui.me.DeveloperTemperatureValueStartActivity$mScanner$2

        @kotlin.jvm.internal.XX({"SMAP\nDeveloperTemperatureValueStartActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperTemperatureValueStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperTemperatureValueStartActivity$mScanner$2$2\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n+ 3 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,330:1\n19#2:331\n15#2:332\n1002#3,2:333\n*S KotlinDebug\n*F\n+ 1 DeveloperTemperatureValueStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperTemperatureValueStartActivity$mScanner$2$2\n*L\n89#1:331\n89#1:332\n95#1:333,2\n*E\n"})
        /* loaded from: classes11.dex */
        public static final class II0xO0 implements XOxIOxOx.oxoX {

            /* renamed from: oIX0oI, reason: collision with root package name */
            public final /* synthetic */ DeveloperTemperatureValueStartActivity f23226oIX0oI;

            @kotlin.jvm.internal.XX({"SMAP\nComparisons.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Comparisons.kt\nkotlin/comparisons/ComparisonsKt__ComparisonsKt$compareBy$2\n+ 2 DeveloperTemperatureValueStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperTemperatureValueStartActivity$mScanner$2$2\n*L\n1#1,328:1\n95#2:329\n*E\n"})
            /* loaded from: classes11.dex */
            ...
            public II0xO0(DeveloperTemperatureValueStartActivity developerTemperatureValueStartActivity) {
                this.f23226oIX0oI = developerTemperatureValueStartActivity;
            }
            ...
            public void II0xO0(@OXOo.OOXIXo BleDevice device) {
                ...
                mList = this.f23226oIX0oI.getMList();
                if (mList.contains(device)) {
                    return;
                }
                SPUtils XO2 = com.sma.smartv3.util.Xo0.f24349oIX0oI.XO();
                Object oOXIXo = new OOXIXo(null, 1, null);
                Object fromJson = new Gson().fromJson(XO2.getString(OOXIXo.class.getName()), (Class<Object>) OOXIXo.class);
                if (fromJson != null) {
                    oOXIXo = fromJson;
                }
                if (!((OOXIXo) oOXIXo).oxoX().contains(device.getMBluetoothDevice().getAddress())) {
                    mList2 = this.f23226oIX0oI.getMList();
                    mList2.add(device);
                    mList3 = this.f23226oIX0oI.getMList();
                    if (mList3.size() > 1) {
                        kotlin.collections.o00.OO0x0xX(mList3, new oIX0oI());
                    }
                    tvSearchNumber = this.f23226oIX0oI.getTvSearchNumber();
                    DeveloperTemperatureValueStartActivity developerTemperatureValueStartActivity = this.f23226oIX0oI;
                    mList4 = developerTemperatureValueStartActivity.getMList();
                    tvSearchNumber.setText(developerTemperatureValueStartActivity.getString(R.string.device_found, Integer.valueOf(mList4.size())));
                    mListAdapter = this.f23226oIX0oI.getMListAdapter();
            ...
            public void oIX0oI(boolean z) {
                AppCompatButton btStartTemperatureValue;
                boolean z2;
                AppCompatButton btStartTemperatureValue2;
                if (z) {
                    btStartTemperatureValue2 = this.f23226oIX0oI.getBtStartTemperatureValue();
                    btStartTemperatureValue2.setVisibility(8);
                    return;
                }
                btStartTemperatureValue = this.f23226oIX0oI.getBtStartTemperatureValue();
                btStartTemperatureValue.setVisibility(0);
                z2 = this.f23226oIX0oI.isAutoTemperatureValue;
                if (z2) {
                    DeveloperTemperatureValueStartActivity developerTemperatureValueStartActivity = this.f23226oIX0oI;
                    EditText etOldBleName = developerTemperatureValueStartActivity.getEtOldBleName();
                    kotlin.jvm.internal.IIX0o.oO(etOldBleName, "access$getEtOldBleName(...)");
                    developerTemperatureValueStartActivity.startTemperatureValue(etOldBleName);
                }
            }
        }
        ...
        public static final class oIX0oI implements XOxIOxOx.X0o0xo {
            ...
            public boolean oIX0oI(@OXOo.OOXIXo BleDevice device) {
                ...
                if (string.length() == 0) {
                    if (device.getMRssi() <= xo0.XO().getInt(com.sma.smartv3.util.XoI0Ixx0.f24428Xo0, -60)) {
                        return false;
                    }
                } else if (device.getMRssi() <= xo0.XO().getInt(com.sma.smartv3.util.XoI0Ixx0.f24428Xo0, -60) || !kotlin.jvm.internal.IIX0o.Oxx0IOOO(ProductManager.f20544oIX0oI.x0xO0oo(device.getMName()), xo0.XO().getString(com.sma.smartv3.util.XoI0Ixx0.f24429XoI0Ixx0, ""))) {
                    return false;
                }
                return true;
            }
        ...
        public final XOxIOxOx.II0xO0 invoke() {
            return XOxIOxOx.oO.II0xO0(XOxIOxOx.oO.f3971oIX0oI, null, ScanMode.LOW_LATENCY, 1, null).Oo(10).IXxxXO(new oIX0oI()).ooOOo0oXI(new II0xO0(DeveloperTemperatureValueStartActivity.this));
        }
    });
    ...
    @kotlin.jvm.internal.XX({"SMAP\nDeveloperTemperatureValueStartActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperTemperatureValueStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperTemperatureValueStartActivity$mBleHandleCallback$1\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n*L\n1#1,330:1\n19#2:331\n15#2:332\n11#2,2:333\n19#2:335\n15#2:336\n19#2:337\n15#2:338\n*S KotlinDebug\n*F\n+ 1 DeveloperTemperatureValueStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperTemperatureValueStartActivity$mBleHandleCallback$1\n*L\n144#1:331\n144#1:332\n147#1:333,2\n149#1:335\n149#1:336\n118#1:337\n118#1:338\n*E\n"})
    /* loaded from: classes11.dex */
    public static final class oIX0oI implements BleHandleCallback {
        public oIX0oI() {
        }

        public static final void X0o0xo(final DeveloperTemperatureValueStartActivity this$0) {
            ...
            if (!((OOXIXo) oOXIXo).oxoX().contains(this$0.deviceAddress)) {
                ...
                BleCache.remove$default(BleCache.INSTANCE, BleKey.TEMPERATURE_VALUE, null, 2, null);
                this$0.failedList.add(this$0.deviceAddress);
                ThreadUtils.runOnUiThread(new Runnable() { // from class: com.sma.smartv3.ui.me.x0OIX00oO
                    @Override // java.lang.Runnable
                    public final void run() {
                        DeveloperTemperatureValueStartActivity.oIX0oI.XO(DeveloperTemperatureValueStartActivity.this);
                    }
                });
            }
        }

        public static final void XO(DeveloperTemperatureValueStartActivity this$0) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
            ToastUtils.showLong(R.string.auto_next_temperature_value);
            EditText etOldBleName = this$0.getEtOldBleName();
            kotlin.jvm.internal.IIX0o.oO(etOldBleName, "access$getEtOldBleName(...)");
            this$0.startSearch(etOldBleName);
        }

        public static final void oxoX(final DeveloperTemperatureValueStartActivity this$0) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
            ...
            BleConnector.sendInt16$default(bleConnector, BleKey.TEMPERATURE_VALUE, BleKeyFlag.UPDATE, (int) (Float.parseFloat(this$0.getEtTemperatureValue().getText().toString()) * 10), null, false, false, 56, null);
            new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.IxIX0I
                @Override // java.lang.Runnable
                public final void run() {
                    DeveloperTemperatureValueStartActivity.oIX0oI.X0o0xo(DeveloperTemperatureValueStartActivity.this);
                }
            }, 5000L);
        }
        ...
        public void onCommandReply(@OXOo.OOXIXo BleKey bleKey, @OXOo.OOXIXo BleKeyFlag bleKeyFlag, boolean z) {
            ...
            BleKey bleKey2 = BleKey.TEMPERATURE_VALUE;
            if (bleKey == bleKey2) {
                com.sma.smartv3.pop.I0X0x0oIo i0X0x0oIo = DeveloperTemperatureValueStartActivity.this.mLoadingPopup;
                if (i0X0x0oIo != null) {
                    i0X0x0oIo.dismiss();
                }
                LogUtils.d("Temperature Value success");
                BleConnector.INSTANCE.closeConnection(true);
                ...
                OOXIXo oOXIXo2 = (OOXIXo) oOXIXo;
                oOXIXo2.oxoX().add(DeveloperTemperatureValueStartActivity.this.deviceAddress);
                xo0.XO().put(OOXIXo.class.getName(), new Gson().toJson(oOXIXo2));
                TextView tvAlreadyTemperatureValue = DeveloperTemperatureValueStartActivity.this.getTvAlreadyTemperatureValue();
                SPUtils XO3 = xo0.XO();
                Object oOXIXo3 = new OOXIXo(null, 1, null);
                Object fromJson2 = new Gson().fromJson(XO3.getString(OOXIXo.class.getName()), (Class<Object>) OOXIXo.class);
                if (fromJson2 != null) {
                    oOXIXo3 = fromJson2;
                }
                tvAlreadyTemperatureValue.setText(String.valueOf(((OOXIXo) oOXIXo3).oxoX().size()));
                ToastUtils.showLong(R.string.auto_next_temperature_value);
                DeveloperTemperatureValueStartActivity developerTemperatureValueStartActivity = DeveloperTemperatureValueStartActivity.this;
                EditText etOldBleName = developerTemperatureValueStartActivity.getEtOldBleName();
                kotlin.jvm.internal.IIX0o.oO(etOldBleName, "access$getEtOldBleName(...)");
                developerTemperatureValueStartActivity.startSearch(etOldBleName);
            }
        }
        ...
        public void onDeviceConnected(@OXOo.OOXIXo BluetoothDevice device) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(device, "device");
            DeveloperTemperatureValueStartActivity.this.getBtStopTemperatureValue().setVisibility(0);
            LogUtils.d("onDeviceConnected -> " + device);
            Handler handler = new Handler();
            final DeveloperTemperatureValueStartActivity developerTemperatureValueStartActivity = DeveloperTemperatureValueStartActivity.this;
            handler.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.XXoOx0
                @Override // java.lang.Runnable
                public final void run() {
                    DeveloperTemperatureValueStartActivity.oIX0oI.oxoX(DeveloperTemperatureValueStartActivity.this);
                }
            }, 3000L);
        }
    ...
    public final AppCompatButton getBtStartTemperatureValue() {
        return (AppCompatButton) this.btStartTemperatureValue$delegate.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final AppCompatButton getBtStopTemperatureValue() {
        return (AppCompatButton) this.btStopTemperatureValue$delegate.getValue();
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final TextView getTvAlreadyTemperatureValue() {
        return (TextView) this.tvAlreadyTemperatureValue$delegate.getValue();
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$0(DeveloperTemperatureValueStartActivity this$0, AdapterView adapterView, View view, int i, long j) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
    ...
    private final void permissionBackgroundLocationRemind() {
        if (getMPermissionBackgroundPopup() == null) {
            ...
            xoI0Ixx0.x0o(R.string.settings, new Oox.oIX0oI<Boolean>() { // from class: com.sma.smartv3.ui.me.DeveloperTemperatureValueStartActivity$permissionBackgroundLocationRemind$1$1
                {
                    super(0);
                }
                ...
                public final Boolean invoke() {
                    Activity mContext;
                    mContext = DeveloperTemperatureValueStartActivity.this.getMContext();
    ...
    public final void requestLocationPermission() {
        ...
        oOXoIIIo.X0o0xo.I0Io(permission, null, null, new Oox.oOoXoXO<PermissionStatus, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.me.DeveloperTemperatureValueStartActivity$requestLocationPermission$1

            /* loaded from: classes11.dex */
            public /* synthetic */ class oIX0oI {

                /* renamed from: oIX0oI, reason: collision with root package name */
                public static final /* synthetic */ int[] f23228oIX0oI;
            ...
            public final void invoke2(@OXOo.OOXIXo PermissionStatus it) {
                ...
                int i = oIX0oI.f23228oIX0oI[it.ordinal()];
                if (i != 1) {
                    if (i == 2) {
                        DeveloperTemperatureValueStartActivity.this.requestLocationPermission();
                        return;
                    } else {
                        DeveloperTemperatureValueStartActivity.this.permissionRemind();
                        return;
                    }
                }
                DeveloperTemperatureValueStartActivity developerTemperatureValueStartActivity = DeveloperTemperatureValueStartActivity.this;
                TextView tvAlreadyTemperatureValue = developerTemperatureValueStartActivity.getTvAlreadyTemperatureValue();
                kotlin.jvm.internal.IIX0o.oO(tvAlreadyTemperatureValue, "access$getTvAlreadyTemperatureValue(...)");
                developerTemperatureValueStartActivity.startSearch(tvAlreadyTemperatureValue);
            }
        }, 3, null);
    }

    public final void clearTemperatureValueHistory(@OXOo.OOXIXo View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(view, "view");
        com.sma.smartv3.util.Xo0.f24349oIX0oI.XO().remove(OOXIXo.class.getName());
        getTvAlreadyTemperatureValue().setText("0");
    ...
    public void initView() {
        super.initView();
        getBtStartTemperatureValue().setVisibility(8);
        getBtStopTemperatureValue().setVisibility(8);
        getMListView().setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: com.sma.smartv3.ui.me.OIOoIIOIx
            @Override // android.widget.AdapterView.OnItemClickListener
            public final void onItemClick(AdapterView adapterView, View view, int i, long j) {
                DeveloperTemperatureValueStartActivity.initView$lambda$0(DeveloperTemperatureValueStartActivity.this, adapterView, view, i, j);
            }
        });
        TextView tvAlreadyTemperatureValue = getTvAlreadyTemperatureValue();
        SPUtils XO2 = com.sma.smartv3.util.Xo0.f24349oIX0oI.XO();
        Object oOXIXo = new OOXIXo(null, 1, null);
        Object fromJson = new Gson().fromJson(XO2.getString(OOXIXo.class.getName()), (Class<Object>) OOXIXo.class);
        if (fromJson != null) {
        ...
        tvAlreadyTemperatureValue.setText(String.valueOf(((OOXIXo) oOXIXo).oxoX().size()));
    }
    ...
    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_developer_test_temperature_value_start;
    }
    ...
    public final void startTemperatureValue(@OXOo.OOXIXo View view) {
        BleDevice bleDevice;
        kotlin.jvm.internal.IIX0o.x0xO0oo(view, "view");
        LogUtils.d("startTemperatureValue failedList=" + this.failedList);
        if (getMList().isEmpty()) {
            ToastUtils.showLong(R.string.no_device_not_temperature_value);
            return;
        }
        this.isAutoTemperatureValue = true;
        ...
        if (bleDevice == null) {
            ...
            ToastUtils.showLong(R.string.no_device_to_temperature_value);
            this.isAutoTemperatureValue = false;
            return;
        }
        ...
        getBtStopTemperatureValue().setVisibility(0);
        ...
        LogUtils.d(this.isAutoTemperatureValue + " connect new device -> " + bleDevice);
    }

    public final void stopTemperatureValue(@OXOo.OOXIXo View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(view, "view");
        ToastUtils.showLong(R.string.close_auto_temperature_value_tip);
        this.isAutoTemperatureValue = false;
        getBtStopTemperatureValue().setVisibility(8);
    }
