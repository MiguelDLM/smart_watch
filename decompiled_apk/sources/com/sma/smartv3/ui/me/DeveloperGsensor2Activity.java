...
@kotlin.jvm.internal.XX({"SMAP\nDeveloperGsensor2Activity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperGsensor2Activity.kt\ncom/sma/smartv3/ui/me/DeveloperGsensor2Activity\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n+ 3 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,287:1\n19#2:288\n15#2:289\n1549#3:290\n1620#3,3:291\n1549#3:294\n1620#3,3:295\n*S KotlinDebug\n*F\n+ 1 DeveloperGsensor2Activity.kt\ncom/sma/smartv3/ui/me/DeveloperGsensor2Activity\n*L\n61#1:288\n61#1:289\n103#1:290\n103#1:291,3\n104#1:294\n104#1:295,3\n*E\n"})
/* loaded from: classes11.dex */
public final class DeveloperGsensor2Activity extends BaseActivity implements BleHandleCallback {
    private final long MAX_TIME;
    private int count;
    private long endTime;

    @OXOo.OOXIXo
    private final SimpleDateFormat hmssformat;

    @OXOo.OOXIXo
    private final AppUser mAppUser;

    @OXOo.OOXIXo
    private oIX0oI mCountDownTimer;
    ...
    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvInfo$delegate;

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvTime$delegate;

    @OXOo.OOXIXo
    private final kotlin.X0IIOO lineChart$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<LineChart>() { // from class: com.sma.smartv3.ui.me.DeveloperGsensor2Activity$lineChart$2
        {
            super(0);
        }
        ...
        public final LineChart invoke() {
            return (LineChart) DeveloperGsensor2Activity.this.findViewById(R.id.line_chart);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO btn$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<Button>() { // from class: com.sma.smartv3.ui.me.DeveloperGsensor2Activity$btn$2
        {
            super(0);
        }
        ...
        public final Button invoke() {
            return (Button) DeveloperGsensor2Activity.this.findViewById(R.id.btn_start);
        }
    });
    ...
    public static final class oIX0oI extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            DeveloperGsensor2Activity developerGsensor2Activity = DeveloperGsensor2Activity.this;
            TextView tvInfo = developerGsensor2Activity.getTvInfo();
            kotlin.jvm.internal.IIX0o.oO(tvInfo, "access$getTvInfo(...)");
            developerGsensor2Activity.toggle(tvInfo);
        }

        @Override // android.os.CountDownTimer
        public void onTick(long j) {
            System.out.println((Object) ("onTick -> " + j));
            DeveloperGsensor2Activity.this.getTvTime().setText("剩余时间:" + com.sma.smartv3.util.xoIox.IO((int) j));
        }
    }

    public DeveloperGsensor2Activity() {
        ...
        this.tvInfo$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.me.DeveloperGsensor2Activity$tvInfo$2
            {
                super(0);
            }
            ...
            public final TextView invoke() {
                return (TextView) DeveloperGsensor2Activity.this.findViewById(R.id.tv_info);
            }
        });
        this.tvTime$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.me.DeveloperGsensor2Activity$tvTime$2
            {
                super(0);
            }
            ...
            @Override // Oox.oIX0oI
            public final TextView invoke() {
                return (TextView) DeveloperGsensor2Activity.this.findViewById(R.id.tv_time);
            }
        });
        long millis = TimeUnit.MINUTES.toMillis(2L);
        this.MAX_TIME = millis;
        this.hmssformat = new SimpleDateFormat("HH:mm:ss.SSS", Locale.getDefault());
        this.mCountDownTimer = new oIX0oI(millis);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void share$lambda$7(DeveloperGsensor2Activity this$0) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        xoIXOxX.II0xO0.I0Io(false, false, null, null, 0, new DeveloperGsensor2Activity$share$1$1(this$0), 31, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void toggle$lambda$6(DeveloperGsensor2Activity this$0) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        this$0.getTvInfo().scrollTo(0, (this$0.getTvInfo().getLayout().getLineTop(this$0.getTvInfo().getLineCount()) - this$0.getTvInfo().getHeight()) + 10);
    }
    ...
    public final void clear(@OXOo.OOXIXo View view) {
    ...
    public final void copy(@OXOo.OOXIXo View view) {
        String str;
        kotlin.jvm.internal.IIX0o.x0xO0oo(view, "view");
    ...
    public void initView() {
        ...
        getTvInfo().setMovementMethod(new ScrollingMovementMethod());
    }

    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_developer_gsensor_2;
    }
    ...
    public void onReceiveGSensorRaw(@OXOo.OOXIXo List<BleGSensorRaw> gSensorRaws) {
        ...
        if (this.mState) {
            ...
            String IIOIX2 = kotlin.text.OxI.IIOIX(CollectionsKt___CollectionsKt.OoIXo(list, null, null, null, 0, null, new Oox.oOoXoXO<BleGSensorRaw, CharSequence>() { // from class: com.sma.smartv3.ui.me.DeveloperGsensor2Activity$onReceiveGSensorRaw$gsensorText$1
    ...
    public void onReceiveHRRaw(@OXOo.OOXIXo List<BleHRRaw> hrRaws) {
        ...
        if (this.mState) {
            final SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyyMMdd_HHmmss", Locale.getDefault());
            String IIOIX2 = kotlin.text.OxI.IIOIX(CollectionsKt___CollectionsKt.OoIXo(hrRaws, null, null, null, 0, null, new Oox.oOoXoXO<BleHRRaw, CharSequence>() { // from class: com.sma.smartv3.ui.me.DeveloperGsensor2Activity$onReceiveHRRaw$hrText$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
    ...
    public final void share(@OXOo.OOXIXo View view) {
        ...
        new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.I0X0x0oIo
            @Override // java.lang.Runnable
            public final void run() {
                DeveloperGsensor2Activity.share$lambda$7(DeveloperGsensor2Activity.this);
            }
    ...
    public final void toggle(@OXOo.OOXIXo View view) {
        ...
        if (this.mState) {
            ...
            getTvInfo().append('\n' + this.count + "\n开始时间:" + this.hmssformat.format(Long.valueOf(this.startTime)));
            this.mCountDownTimer.start();
        } else {
            this.endTime = System.currentTimeMillis();
            getTvInfo().append("\n结束时间:" + this.hmssformat.format(Long.valueOf(this.endTime)));
            this.mCountDownTimer.cancel();
        }
        getTvTime().setText("剩余时间:");
        getTvInfo().post(new Runnable() { // from class: com.sma.smartv3.ui.me.oX
            @Override // java.lang.Runnable
            public final void run() {
                DeveloperGsensor2Activity.toggle$lambda$6(DeveloperGsensor2Activity.this);
            }
        });
    }
