...
import com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity;
...
@kotlin.jvm.internal.XX({"SMAP\nDeveloperIMEIStartActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperIMEIStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperIMEISetStartActivity\n+ 2 NetWorkUtils.kt\ncom/sma/smartv3/network/NetWorkUtils\n+ 3 NetWork.kt\ncom/sma/androidnetworklib/method/NetWork\n+ 4 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n+ 5 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,463:1\n151#2,11:464\n171#2:483\n208#3,7:475\n226#3:482\n19#4:484\n15#4:485\n27#4,2:486\n1#5:488\n*S KotlinDebug\n*F\n+ 1 DeveloperIMEIStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperIMEISetStartActivity\n*L\n260#1:464,11\n260#1:483\n260#1:475,7\n260#1:482\n363#1:484\n363#1:485\n387#1:486,2\n*E\n"})
/* loaded from: classes11.dex */
public final class DeveloperIMEISetStartActivity extends BaseListFunctionActivity<BleDevice> {
    private boolean isAutoSet;
    private boolean isReadAgain;
    private boolean isWriteAgain;

    @OXOo.oOoXoXO
    private OIxx0I0 mCurIMEICheckAvailableData;

    @OXOo.oOoXoXO
    private com.sma.smartv3.pop.I0X0x0oIo mLoadingPopup;

    @OXOo.OOXIXo
    private final String TAG = "IMEISet";

    @OXOo.OOXIXo
    private final kotlin.X0IIOO etOldBleName$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<EditText>() { // from class: com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity$etOldBleName$2
        {
            super(0);
        }
        ...
        public final EditText invoke() {
            return (EditText) DeveloperIMEISetStartActivity.this.findViewById(R.id.et_old_ble_name);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO btStartSet$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AppCompatButton>() { // from class: com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity$btStartSet$2
        {
            super(0);
        }
        ...
        public final AppCompatButton invoke() {
            return (AppCompatButton) DeveloperIMEISetStartActivity.this.findViewById(R.id.bt_start_set);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO btStopSet$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AppCompatButton>() { // from class: com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity$btStopSet$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final AppCompatButton invoke() {
            return (AppCompatButton) DeveloperIMEISetStartActivity.this.findViewById(R.id.bt_stop_set);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO etSignal$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<EditText>() { // from class: com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity$etSignal$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final EditText invoke() {
            return (EditText) DeveloperIMEISetStartActivity.this.findViewById(R.id.et_signal);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvSearchNumber$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity$tvSearchNumber$2
        {
            super(0);
        }
        ...
        public final TextView invoke() {
            return (TextView) DeveloperIMEISetStartActivity.this.findViewById(R.id.tv_search_number);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvValue$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity$tvValue$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final TextView invoke() {
            return (TextView) DeveloperIMEISetStartActivity.this.findViewById(R.id.tv_value);
        }
    });
    ...
    @OXOo.OOXIXo
    private final kotlin.X0IIOO mScanner$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<XOxIOxOx.II0xO0>() { // from class: com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity$mScanner$2

        @kotlin.jvm.internal.XX({"SMAP\nDeveloperIMEIStartActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperIMEIStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperIMEISetStartActivity$mScanner$2$2\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n+ 3 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n+ 4 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,463:1\n1#2:464\n19#3:465\n15#3:466\n1002#4,2:467\n*S KotlinDebug\n*F\n+ 1 DeveloperIMEIStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperIMEISetStartActivity$mScanner$2$2\n*L\n123#1:465\n123#1:466\n129#1:467,2\n*E\n"})
        /* loaded from: classes11.dex */
        public static final class II0xO0 implements XOxIOxOx.oxoX {

            /* renamed from: oIX0oI, reason: collision with root package name */
            public final /* synthetic */ DeveloperIMEISetStartActivity f23191oIX0oI;

            @kotlin.jvm.internal.XX({"SMAP\nComparisons.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Comparisons.kt\nkotlin/comparisons/ComparisonsKt__ComparisonsKt$compareBy$2\n+ 2 DeveloperIMEIStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperIMEISetStartActivity$mScanner$2$2\n*L\n1#1,328:1\n129#2:329\n*E\n"})
            /* loaded from: classes11.dex */
            ...
            public II0xO0(DeveloperIMEISetStartActivity developerIMEISetStartActivity) {
                this.f23191oIX0oI = developerIMEISetStartActivity;
            }

            public static final void X0o0xo(DeveloperIMEISetStartActivity this$0) {
            ...
            public void II0xO0(@OXOo.OOXIXo BleDevice device) {
                ...
                mList = this.f23191oIX0oI.getMList();
                if (!mList.contains(device)) {
                    str = this.f23191oIX0oI.filterName;
                    if (!TextUtils.isEmpty(str)) {
                        String x0xO0oo2 = ProductManager.f20544oIX0oI.x0xO0oo(device.getMName());
                        str2 = this.f23191oIX0oI.filterName;
                        if (!kotlin.jvm.internal.IIX0o.Oxx0IOOO(x0xO0oo2, str2)) {
                            return;
                        }
                    }
                    HashMap hashMap = this.f23191oIX0oI.mConnectedFailMap;
                    ...
                    if (((Number) obj).intValue() >= 8) {
                        OI0.oIX0oI.f1507oIX0oI.oIX0oI(this.f23191oIX0oI.TAG + TokenParser.SP + device.getMBluetoothDevice().getAddress() + " When the connection times out, skip first");
                        return;
                    }
                    SPUtils XO2 = com.sma.smartv3.util.Xo0.f24349oIX0oI.XO();
                    Object iI0XooXoX = new II0XooXoX(null, 1, null);
                    Object fromJson = new Gson().fromJson(XO2.getString(II0XooXoX.class.getName()), (Class<Object>) II0XooXoX.class);
                    if (fromJson != null) {
                        iI0XooXoX = fromJson;
                    }
                    if (!((II0XooXoX) iI0XooXoX).oxoX().contains(device.getMBluetoothDevice().getAddress())) {
                        mList2 = this.f23191oIX0oI.getMList();
                        mList2.add(device);
                        mList3 = this.f23191oIX0oI.getMList();
                        if (mList3.size() > 1) {
                            kotlin.collections.o00.OO0x0xX(mList3, new oIX0oI());
                        }
                        tvSearchNumber = this.f23191oIX0oI.getTvSearchNumber();
                        DeveloperIMEISetStartActivity developerIMEISetStartActivity = this.f23191oIX0oI;
                        mList4 = developerIMEISetStartActivity.getMList();
                        tvSearchNumber.setText(developerIMEISetStartActivity.getString(R.string.device_found, Integer.valueOf(mList4.size())));
                        mListAdapter = this.f23191oIX0oI.getMListAdapter();
                        mListAdapter.notifyDataSetChanged();
                        return;
                    }
                    OI0.oIX0oI.f1507oIX0oI.oIX0oI(this.f23191oIX0oI.TAG + TokenParser.SP + device.getMBluetoothDevice().getAddress() + " The operation was successful");
                }
            }
            ...
            public void oIX0oI(boolean z) {
                ...
                if (z) {
                    btStartSet3 = this.f23191oIX0oI.getBtStartSet();
                    btStartSet3.setVisibility(8);
                    return;
                }
                z2 = this.f23191oIX0oI.isAutoSet;
                if (z2) {
                    btStartSet2 = this.f23191oIX0oI.getBtStartSet();
                    btStartSet2.setVisibility(8);
                    mList = this.f23191oIX0oI.getMList();
                    if (mList.isEmpty()) {
                        OI0.oIX0oI.f1507oIX0oI.oIX0oI(this.f23191oIX0oI.TAG + " The search is empty, try again later");
                        Handler handler = new Handler();
                        final DeveloperIMEISetStartActivity developerIMEISetStartActivity = this.f23191oIX0oI;
                        handler.postDelayed(
                        /*  JADX ERROR: Method code generation error
                            jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0055: INVOKE 
                              (r5v12 'handler' android.os.Handler)
                              (wrap:java.lang.Runnable:0x0050: CONSTRUCTOR (r0v5 'developerIMEISetStartActivity' com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity A[DONT_INLINE]) A[MD:(com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity):void (m), WRAPPED] (LINE:81) call: com.sma.smartv3.ui.me.XIo0oOXIx.<init>(com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity):void type: CONSTRUCTOR)
                              (wrap:long:SGET  A[WRAPPED] com.google.android.exoplayer2.ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS long)
                             VIRTUAL call: android.os.Handler.postDelayed(java.lang.Runnable, long):boolean A[MD:(java.lang.Runnable, long):boolean (c)] (LINE:86) in method: com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity$mScanner$2.II0xO0.oIX0oI(boolean):void, file: classes11.dex
                            ...
                            Caused by: jadx.core.utils.exceptions.JadxRuntimeException: Expected class to be processed at this point, class: com.sma.smartv3.ui.me.XIo0oOXIx, state: NOT_LOADED
                        ...
                        /*
                            ...
                            r0 = 8
                            if (r5 == 0) goto Le
                            com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity r5 = r4.f23191oIX0oI
                            androidx.appcompat.widget.AppCompatButton r5 = com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity.access$getBtStartSet(r5)
                            r5.setVisibility(r0)
                            goto L72
                        Le:
                            com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity r5 = r4.f23191oIX0oI
                            boolean r5 = com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity.access$isAutoSet$p(r5)
                            if (r5 == 0) goto L68
                            com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity r5 = r4.f23191oIX0oI
                            androidx.appcompat.widget.AppCompatButton r5 = com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity.access$getBtStartSet(r5)
                            r5.setVisibility(r0)
                            com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity r5 = r4.f23191oIX0oI
                            java.util.List r5 = com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity.access$getMList(r5)
                            boolean r5 = r5.isEmpty()
                            if (r5 == 0) goto L59
                            OI0.oIX0oI r5 = OI0.oIX0oI.f1507oIX0oI
                            java.lang.StringBuilder r0 = new java.lang.StringBuilder
                            r0.<init>()
                            com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity r1 = r4.f23191oIX0oI
                            java.lang.String r1 = com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity.access$getTAG$p(r1)
                            r0.append(r1)
                            ...
                            r5.<init>()
                            com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity r0 = r4.f23191oIX0oI
                            com.sma.smartv3.ui.me.XIo0oOXIx r1 = new com.sma.smartv3.ui.me.XIo0oOXIx
                            r1.<init>(r0)
                        ...
                        L59:
                            com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity r5 = r4.f23191oIX0oI
                            android.widget.EditText r0 = com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity.access$getEtOldBleName(r5)
                        ...
                        L72:
                            return
                        */
                        throw new UnsupportedOperationException("Method not decompiled: com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity$mScanner$2.II0xO0.oIX0oI(boolean):void");
                    }
                }
                ...
                public static final class oIX0oI implements XOxIOxOx.X0o0xo {
                    ...
                    /* renamed from: oIX0oI, reason: collision with root package name */
                    public final /* synthetic */ DeveloperIMEISetStartActivity f23192oIX0oI;

                    public oIX0oI(DeveloperIMEISetStartActivity developerIMEISetStartActivity) {
                        this.f23192oIX0oI = developerIMEISetStartActivity;
                    }
                ...
                public final XOxIOxOx.II0xO0 invoke() {
                    return XOxIOxOx.oO.II0xO0(XOxIOxOx.oO.f3971oIX0oI, null, ScanMode.LOW_LATENCY, 1, null).Oo(10).IXxxXO(new oIX0oI(DeveloperIMEISetStartActivity.this)).ooOOo0oXI(new II0xO0(DeveloperIMEISetStartActivity.this));
                }
            });
            ...
            @OXOo.OOXIXo
            private final Runnable mConnectedFailRunnable = new Runnable() { // from class: com.sma.smartv3.ui.me.XoI0Ixx0
                @Override // java.lang.Runnable
                public final void run() {
                    DeveloperIMEISetStartActivity.mConnectedFailRunnable$lambda$1(DeveloperIMEISetStartActivity.this);
                }
            };
            ...
            @kotlin.jvm.internal.XX({"SMAP\nDeveloperIMEIStartActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperIMEIStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperIMEISetStartActivity$mBleHandleCallback$1\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n+ 3 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n*L\n1#1,463:1\n1#2:464\n19#3:465\n15#3:466\n11#3,2:467\n*S KotlinDebug\n*F\n+ 1 DeveloperIMEIStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperIMEISetStartActivity$mBleHandleCallback$1\n*L\n181#1:465\n181#1:466\n184#1:467,2\n*E\n"})
            /* loaded from: classes11.dex */
            public static final class oIX0oI implements BleHandleCallback {
                public oIX0oI() {
                }

                public static final void II0XooXoX(DeveloperIMEISetStartActivity this$0) {
                    kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
                    OI0.oIX0oI.f1507oIX0oI.oIX0oI(this$0.TAG + " onReadDeviceUniqueDataSettings Shutdown success! Force closeConnection!");
                    this$0.reStart();
                }

                public static final void Oxx0IOOO(DeveloperIMEISetStartActivity this$0) {
                    kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
                    ...
                    if (!bleConnector.isBound()) {
                        ...
                        BleConnector.sendInt8$default(bleConnector, BleKey.DEVICE_UNIQUE_DATA_SET, BleKeyFlag.READ, 1, false, false, 24, null);
                        OI0.oIX0oI.f1507oIX0oI.oIX0oI(this$0.TAG + " onDeviceConnected -> read DEVICE_UNIQUE_DATA_SET");
                    }
                }

                public static final void X0o0xo(DeveloperIMEISetStartActivity this$0) {
                    kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
                    BleConnector.sendData$default(BleConnector.INSTANCE, BleKey.DEVICE_UNIQUE_DATA_SET, BleKeyFlag.READ, null, false, false, 28, null);
                    this$0.isReadAgain = true;
                }

                public static final void XO(DeveloperIMEISetStartActivity this$0) {
                    kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
                    if (!this$0.isWriteAgain && this$0.mCurIMEICheckAvailableData != null) {
                        OIxx0I0 oIxx0I0 = this$0.mCurIMEICheckAvailableData;
                        kotlin.jvm.internal.IIX0o.ooOOo0oXI(oIxx0I0);
                        this$0.sendIMEI(oIxx0I0.I0Io());
                        this$0.isWriteAgain = true;
                    }
                }
                ...
                public void onCommandReply(@OXOo.OOXIXo BleKey bleKey, @OXOo.OOXIXo BleKeyFlag bleKeyFlag, boolean z) {
                    ...
                    if (bleKey == BleKey.DEVICE_UNIQUE_DATA_SET) {
                        if (z) {
                            OI0.oIX0oI.f1507oIX0oI.oIX0oI(DeveloperIMEISetStartActivity.this.TAG + " onCommandReply -> The code has been written, and the status needs to be read again!");
                            Handler handler = new Handler();
                            final DeveloperIMEISetStartActivity developerIMEISetStartActivity = DeveloperIMEISetStartActivity.this;
                            handler.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.xoIxX
                                @Override // java.lang.Runnable
                                public final void run() {
                                    DeveloperIMEISetStartActivity.oIX0oI.X0o0xo(DeveloperIMEISetStartActivity.this);
                                }
                            }, ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS);
                            return;
                        }
                        OI0.oIX0oI.f1507oIX0oI.oIX0oI(DeveloperIMEISetStartActivity.this.TAG + " onCommandReply -> needs to be write again!");
                        Handler handler2 = new Handler();
                        final DeveloperIMEISetStartActivity developerIMEISetStartActivity2 = DeveloperIMEISetStartActivity.this;
                        handler2.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.x0xO
                            @Override // java.lang.Runnable
                            public final void run() {
                                DeveloperIMEISetStartActivity.oIX0oI.XO(DeveloperIMEISetStartActivity.this);
                            }
                        }, ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS);
                    }
                }
                ...
                public void onCommandSendTimeout(@OXOo.OOXIXo BleKey bleKey, @OXOo.OOXIXo BleKeyFlag bleKeyFlag) {
                    ...
                    kotlin.jvm.internal.IIX0o.x0xO0oo(bleKeyFlag, "bleKeyFlag");
                    if (bleKey == BleKey.DEVICE_UNIQUE_DATA_SET) {
                        DeveloperIMEISetStartActivity.this.reStart();
                    }
                }
                ...
                public void onDeviceConnected(@OXOo.OOXIXo BluetoothDevice device) {
                    kotlin.jvm.internal.IIX0o.x0xO0oo(device, "device");
                    DeveloperIMEISetStartActivity.this.getBtStopSet().setVisibility(0);
                    Handler handler = new Handler();
                    final DeveloperIMEISetStartActivity developerIMEISetStartActivity = DeveloperIMEISetStartActivity.this;
                    handler.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.OO0x0xX
                        @Override // java.lang.Runnable
                        public final void run() {
                            DeveloperIMEISetStartActivity.oIX0oI.Oxx0IOOO(DeveloperIMEISetStartActivity.this);
                        }
                    }, 5000L);
                }
                ...
                @Override // com.szabh.smable3.component.BleHandleCallback
                public void onReadDeviceUniqueDataSettings(@OXOo.OOXIXo BleDeviceUniqueDataSettings deviceUniqueDataSettings) {
                    String str;
                    kotlin.jvm.internal.IIX0o.x0xO0oo(deviceUniqueDataSettings, "deviceUniqueDataSettings");
                    String str2 = new String(deviceUniqueDataSettings.getMData(), kotlin.text.oxoX.f29584XO);
                    OIxx0I0 oIxx0I0 = DeveloperIMEISetStartActivity.this.mCurIMEICheckAvailableData;
                    if (oIxx0I0 != null) {
                        str = oIxx0I0.I0Io();
                    } else {
                        str = null;
                    }
                    if (kotlin.jvm.internal.IIX0o.Oxx0IOOO(str2, str)) {
                        OI0.oIX0oI.f1507oIX0oI.oIX0oI(DeveloperIMEISetStartActivity.this.TAG + " onReadDeviceUniqueDataSettings -> done! " + DeveloperIMEISetStartActivity.this.deviceAddress + org.apache.commons.text.oIX0oI.f33048oxoX + str2);
                        ...
                        II0XooXoX iI0XooXoX2 = (II0XooXoX) iI0XooXoX;
                        iI0XooXoX2.oxoX().add(DeveloperIMEISetStartActivity.this.deviceAddress);
                        xo0.XO().put(II0XooXoX.class.getName(), new Gson().toJson(iI0XooXoX2));
                        DeveloperIMEISetStartActivity.this.getTvValue().setText(String.valueOf(iI0XooXoX2.oxoX().size()));
                        BleConnector.sendInt8$default(BleConnector.INSTANCE, BleKey.SHUTDOWN, BleKeyFlag.UPDATE, 0, false, false, 24, null);
                        Handler handler = new Handler();
                        final DeveloperIMEISetStartActivity developerIMEISetStartActivity = DeveloperIMEISetStartActivity.this;
                        handler.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.IoOoo
                            @Override // java.lang.Runnable
                            public final void run() {
                                DeveloperIMEISetStartActivity.oIX0oI.II0XooXoX(DeveloperIMEISetStartActivity.this);
                            }
                        }, ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS);
                        return;
                    }
                    if (DeveloperIMEISetStartActivity.this.isReadAgain) {
                        OI0.oIX0oI.f1507oIX0oI.oIX0oI(DeveloperIMEISetStartActivity.this.TAG + " onReadDeviceUniqueDataSettings -> imei failed!");
                        DeveloperIMEISetStartActivity.this.mConnectedFailMap.put(DeveloperIMEISetStartActivity.this.deviceAddress, 10);
                        DeveloperIMEISetStartActivity.this.reStart();
                        return;
                    }
                    OI0.oIX0oI.f1507oIX0oI.oIX0oI(DeveloperIMEISetStartActivity.this.TAG + " onReadDeviceUniqueDataSettings -> getIMEIInfo");
                    DeveloperIMEISetStartActivity developerIMEISetStartActivity2 = DeveloperIMEISetStartActivity.this;
                    developerIMEISetStartActivity2.getIMEIInfo(developerIMEISetStartActivity2.deviceName, DeveloperIMEISetStartActivity.this.deviceAddress, str2);
                }
                ...
                public void onSessionStateChange(boolean z) {
                    if (!z) {
                        try {
                            HashMap hashMap = DeveloperIMEISetStartActivity.this.mConnectedFailMap;
                            String str = DeveloperIMEISetStartActivity.this.deviceAddress;
                            Object obj = DeveloperIMEISetStartActivity.this.mConnectedFailMap.get(DeveloperIMEISetStartActivity.this.deviceAddress);
                            if (obj == null) {
                                obj = 0;
                            }
            ...
            private final void dismissLoadPopup() {
                runOnUiThread(new Runnable() { // from class: com.sma.smartv3.ui.me.O0Xx
                    @Override // java.lang.Runnable
                    public final void run() {
                        DeveloperIMEISetStartActivity.dismissLoadPopup$lambda$4(DeveloperIMEISetStartActivity.this);
                    }
                });
            }

            /* JADX INFO: Access modifiers changed from: private */
            public static final void dismissLoadPopup$lambda$4(DeveloperIMEISetStartActivity this$0) {
                kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public static final void initView$lambda$3(DeveloperIMEISetStartActivity this$0, AdapterView adapterView, View view, int i, long j) {
                kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public static final void mConnectedFailRunnable$lambda$1(DeveloperIMEISetStartActivity this$0) {
                kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
            ...
            private final void permissionBackgroundLocationRemind() {
                if (getMPermissionBackgroundPopup() == null) {
                    ...
                    xoI0Ixx0.x0o(R.string.settings, new Oox.oIX0oI<Boolean>() { // from class: com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity$permissionBackgroundLocationRemind$1$1
                        {
                            super(0);
                        }
                        ...
                        public final Boolean invoke() {
                            Activity mContext;
                            mContext = DeveloperIMEISetStartActivity.this.getMContext();
            ...
            public final void reStart() {
                this.mCurIMEICheckAvailableData = null;
            ...
            public final void requestLocationPermission() {
                ...
                oOXoIIIo.X0o0xo.I0Io(permission, null, null, new Oox.oOoXoXO<PermissionStatus, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity$requestLocationPermission$1

                    /* loaded from: classes11.dex */
                    public /* synthetic */ class oIX0oI {

                        /* renamed from: oIX0oI, reason: collision with root package name */
                        public static final /* synthetic */ int[] f23194oIX0oI;
                    ...
                    public final void invoke2(@OXOo.OOXIXo PermissionStatus it) {
                        ...
                        int i = oIX0oI.f23194oIX0oI[it.ordinal()];
                        if (i != 1) {
                            if (i == 2) {
                                DeveloperIMEISetStartActivity.this.requestLocationPermission();
                                return;
                            } else {
                                DeveloperIMEISetStartActivity.this.permissionRemind();
                                return;
                            }
                        }
                        DeveloperIMEISetStartActivity developerIMEISetStartActivity = DeveloperIMEISetStartActivity.this;
                        etOldBleName = developerIMEISetStartActivity.getEtOldBleName();
                        kotlin.jvm.internal.IIX0o.oO(etOldBleName, "access$getEtOldBleName(...)");
                        developerIMEISetStartActivity.startSearch(etOldBleName);
                    }
                }, 3, null);
            }

            /* JADX INFO: Access modifiers changed from: private */
            public final void sendIMEI(String str) {
                byte[] bytes = str.getBytes(kotlin.text.oxoX.f29584XO);
                kotlin.jvm.internal.IIX0o.oO(bytes, "getBytes(...)");
                BleDeviceUniqueDataSettings bleDeviceUniqueDataSettings = new BleDeviceUniqueDataSettings(1, bytes);
                OI0.oIX0oI.f1507oIX0oI.oIX0oI(this.TAG + " sendIMEI -> " + bleDeviceUniqueDataSettings);
                BleConnector.sendObject$default(BleConnector.INSTANCE, BleKey.DEVICE_UNIQUE_DATA_SET, BleKeyFlag.UPDATE, bleDeviceUniqueDataSettings, false, false, 24, null);
            }
            ...
            public final void clearHistory(@OXOo.OOXIXo View view) {
                ...
                com.sma.smartv3.util.Xo0.f24349oIX0oI.XO().remove(II0XooXoX.class.getName());
            ...
            public final void getIMEIInfo(@OXOo.OOXIXo String name, @OXOo.OOXIXo String mac, @OXOo.OOXIXo String imei) {
                ...
                hashMap.put("mac", kotlin.text.OxI.IIOIX(mac, ":", "", false, 4, null));
                hashMap.put(O0OOX0IIx.f23381X0o0xo, imei);
                final DeveloperIMEISetStartActivity$getIMEIInfo$2 developerIMEISetStartActivity$getIMEIInfo$2 = new DeveloperIMEISetStartActivity$getIMEIInfo$2(this, imei);
                final Activity activity = null;
                final com.sma.smartv3.pop.I0X0x0oIo loadPopup = netWorkUtils.loadPopup(null, null);
                String convertBaseUrl = netWorkUtils.convertBaseUrl(Api.INSTANCE.getBASE_URL(), O0OOX0IIx.f23380II0xO0);
                netWorkUtils.printParam(convertBaseUrl + O0OOX0IIx.f23380II0xO0, hashMap);
                NetWork netWork = NetWork.f19682oIX0oI;
                String str = convertBaseUrl + O0OOX0IIx.f23380II0xO0;
                final xxxI.II0xO0<Response<OIxx0I0>> iI0xO0 = new xxxI.II0xO0<Response<OIxx0I0>>() { // from class: com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity$getIMEIInfo$$inlined$post$default$1
                    @Override // xxxI.II0xO0
                    public void handleError(@OXOo.OOXIXo String error) {
                        kotlin.jvm.internal.IIX0o.x0xO0oo(error, "error");
                        NetWorkUtils.INSTANCE.errorData(error, developerIMEISetStartActivity$getIMEIInfo$2, loadPopup);
                    }

                    @Override // xxxI.II0xO0
                    /* renamed from: oIX0oI, reason: merged with bridge method [inline-methods] */
                    public void handleResponse(@OXOo.oOoXoXO Response<OIxx0I0> response) {
                        NetWorkUtils netWorkUtils2 = NetWorkUtils.INSTANCE;
                        Activity activity2 = activity;
                        xxxI.II0xO0 iI0xO02 = developerIMEISetStartActivity$getIMEIInfo$2;
                ...
                AndroidNetworking.post(str).addBodyParameter((Map<String, String>) hashMap).setTag((Object) str).setPriority(Priority.HIGH).build().getAsParsed(TypeToken.getParameterized(Response.class, OIxx0I0.class), new ParsedRequestListener<Response<OIxx0I0>>() { // from class: com.sma.smartv3.ui.me.DeveloperIMEISetStartActivity$getIMEIInfo$$inlined$post$default$2
                    @Override // com.androidnetworking.interfaces.ParsedRequestListener
                    /* renamed from: oIX0oI, reason: merged with bridge method [inline-methods] */
                    public void onResponse(@OXOo.OOXIXo Response<OIxx0I0> response) {
            ...
            public void initView() {
                ...
                getMListView().setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: com.sma.smartv3.ui.me.I0oOIX
                    @Override // android.widget.AdapterView.OnItemClickListener
                    public final void onItemClick(AdapterView adapterView, View view, int i, long j) {
                        DeveloperIMEISetStartActivity.initView$lambda$3(DeveloperIMEISetStartActivity.this, adapterView, view, i, j);
                    }
                });
            }
            ...
            @Override // com.bestmafen.androidbase.base.oIX0oI
            public int layoutId() {
                return R.layout.activity_developer_test_imei_set_start;
            }
            ...
            public final void startSearch(@OXOo.OOXIXo View view) {
                ...
                tvValue.setText(String.valueOf(((II0XooXoX) iI0XooXoX).oxoX().size()));
            }
