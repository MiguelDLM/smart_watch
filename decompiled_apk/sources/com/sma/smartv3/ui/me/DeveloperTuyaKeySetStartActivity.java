...
import com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity;
...
@kotlin.jvm.internal.XX({"SMAP\nDeveloperTuyaKeySetStartActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperTuyaKeySetStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperTuyaKeySetStartActivity\n+ 2 NetWorkUtils.kt\ncom/sma/smartv3/network/NetWorkUtils\n+ 3 NetWork.kt\ncom/sma/androidnetworklib/method/NetWork\n+ 4 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n+ 5 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,407:1\n151#2,11:408\n171#2:427\n208#3,7:419\n226#3:426\n19#4:428\n15#4:429\n27#4,2:430\n1#5:432\n*S KotlinDebug\n*F\n+ 1 DeveloperTuyaKeySetStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperTuyaKeySetStartActivity\n*L\n191#1:408,11\n191#1:427\n191#1:419,7\n191#1:426\n274#1:428\n274#1:429\n330#1:430,2\n*E\n"})
/* loaded from: classes11.dex */
public final class DeveloperTuyaKeySetStartActivity extends BaseListFunctionActivity<BleDevice> {
    ...
    @OXOo.OOXIXo
    private final String TAG = "TuyaKeySet";

    @OXOo.OOXIXo
    private final kotlin.X0IIOO etOldBleName$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<EditText>() { // from class: com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity$etOldBleName$2
        {
            super(0);
        }
        ...
        public final EditText invoke() {
            return (EditText) DeveloperTuyaKeySetStartActivity.this.findViewById(R.id.et_old_ble_name);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO btStartSet$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AppCompatButton>() { // from class: com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity$btStartSet$2
        {
            super(0);
        }
        ...
        public final AppCompatButton invoke() {
            return (AppCompatButton) DeveloperTuyaKeySetStartActivity.this.findViewById(R.id.bt_start_set);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO btStopSet$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AppCompatButton>() { // from class: com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity$btStopSet$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final AppCompatButton invoke() {
            return (AppCompatButton) DeveloperTuyaKeySetStartActivity.this.findViewById(R.id.bt_stop_set);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO etSignal$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<EditText>() { // from class: com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity$etSignal$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final EditText invoke() {
            return (EditText) DeveloperTuyaKeySetStartActivity.this.findViewById(R.id.et_signal);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvSearchNumber$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity$tvSearchNumber$2
        {
            super(0);
        }
        ...
        public final TextView invoke() {
            return (TextView) DeveloperTuyaKeySetStartActivity.this.findViewById(R.id.tv_search_number);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvValue$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity$tvValue$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final TextView invoke() {
            return (TextView) DeveloperTuyaKeySetStartActivity.this.findViewById(R.id.tv_value);
        }
    });
    ...
    @OXOo.OOXIXo
    private final kotlin.X0IIOO mScanner$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<XOxIOxOx.II0xO0>() { // from class: com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity$mScanner$2

        @kotlin.jvm.internal.XX({"SMAP\nDeveloperTuyaKeySetStartActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperTuyaKeySetStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperTuyaKeySetStartActivity$mScanner$2$2\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n+ 3 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n+ 4 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,407:1\n1#2:408\n19#3:409\n15#3:410\n1002#4,2:411\n*S KotlinDebug\n*F\n+ 1 DeveloperTuyaKeySetStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperTuyaKeySetStartActivity$mScanner$2$2\n*L\n130#1:409\n130#1:410\n136#1:411,2\n*E\n"})
        /* loaded from: classes11.dex */
        public static final class II0xO0 implements XOxIOxOx.oxoX {

            /* renamed from: oIX0oI, reason: collision with root package name */
            public final /* synthetic */ DeveloperTuyaKeySetStartActivity f23235oIX0oI;

            @kotlin.jvm.internal.XX({"SMAP\nComparisons.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Comparisons.kt\nkotlin/comparisons/ComparisonsKt__ComparisonsKt$compareBy$2\n+ 2 DeveloperTuyaKeySetStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperTuyaKeySetStartActivity$mScanner$2$2\n*L\n1#1,328:1\n136#2:329\n*E\n"})
            /* loaded from: classes11.dex */
            ...
            public II0xO0(DeveloperTuyaKeySetStartActivity developerTuyaKeySetStartActivity) {
                this.f23235oIX0oI = developerTuyaKeySetStartActivity;
            }

            public static final void X0o0xo(DeveloperTuyaKeySetStartActivity this$0) {
            ...
            public void II0xO0(@OXOo.OOXIXo BleDevice device) {
                ...
                mList = this.f23235oIX0oI.getMList();
                if (mList.contains(device)) {
                    return;
                }
                if (!TextUtils.isEmpty(this.f23235oIX0oI.filterName) && !kotlin.jvm.internal.IIX0o.Oxx0IOOO(ProductManager.f20544oIX0oI.x0xO0oo(device.getMName()), this.f23235oIX0oI.filterName)) {
                    return;
                }
                if (!kotlin.jvm.internal.IIX0o.Oxx0IOOO(address, "9B:02:00:00:18:00") && !kotlin.jvm.internal.IIX0o.Oxx0IOOO(address, "E0:36:15:00:08:00")) {
                    HashMap hashMap = this.f23235oIX0oI.mConnectedFailMap;
                    kotlin.jvm.internal.IIX0o.ooOOo0oXI(address);
                    Object obj = hashMap.get(address);
                    if (obj == null) {
                        obj = 0;
                    }
                    if (((Number) obj).intValue() >= 4) {
                        OI0.oIX0oI.f1507oIX0oI.oIX0oI(this.f23235oIX0oI.TAG + TokenParser.SP + address + " When the connection times out, skip first");
                        return;
                    }
                }
                SPUtils XO2 = com.sma.smartv3.util.Xo0.f24349oIX0oI.XO();
                Object oooxoxo = new oOoXoXO(null, 1, null);
                Object fromJson = new Gson().fromJson(XO2.getString(oOoXoXO.class.getName()), (Class<Object>) oOoXoXO.class);
                if (fromJson != null) {
                    oooxoxo = fromJson;
                }
                if (!((oOoXoXO) oooxoxo).oxoX().contains(address)) {
                    mList2 = this.f23235oIX0oI.getMList();
                    mList2.add(device);
                    mList3 = this.f23235oIX0oI.getMList();
                    if (mList3.size() > 1) {
                        kotlin.collections.o00.OO0x0xX(mList3, new oIX0oI());
                    }
                    tvSearchNumber = this.f23235oIX0oI.getTvSearchNumber();
                    DeveloperTuyaKeySetStartActivity developerTuyaKeySetStartActivity = this.f23235oIX0oI;
                    mList4 = developerTuyaKeySetStartActivity.getMList();
                    tvSearchNumber.setText(developerTuyaKeySetStartActivity.getString(R.string.device_found, Integer.valueOf(mList4.size())));
                    mListAdapter = this.f23235oIX0oI.getMListAdapter();
                    mListAdapter.notifyDataSetChanged();
                    return;
                }
                OI0.oIX0oI.f1507oIX0oI.oIX0oI(this.f23235oIX0oI.TAG + TokenParser.SP + address + " The operation was successful");
            }
            ...
            public void oIX0oI(boolean z) {
                ...
                if (z) {
                    btStartSet3 = this.f23235oIX0oI.getBtStartSet();
                    btStartSet3.setVisibility(8);
                    return;
                }
                z2 = this.f23235oIX0oI.isAutoSet;
                if (z2) {
                    btStartSet2 = this.f23235oIX0oI.getBtStartSet();
                    btStartSet2.setVisibility(8);
                    mList = this.f23235oIX0oI.getMList();
                    if (mList.isEmpty()) {
                        OI0.oIX0oI.f1507oIX0oI.oIX0oI(this.f23235oIX0oI.TAG + " The search is empty, try again later");
                        ToastUtils.showLong("没有搜到设备，正在重试...", new Object[0]);
                        Handler handler = new Handler();
                        final DeveloperTuyaKeySetStartActivity developerTuyaKeySetStartActivity = this.f23235oIX0oI;
                        handler.postDelayed(
                        /*  JADX ERROR: Method code generation error
                            jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x005d: INVOKE 
                              (r5v13 'handler' android.os.Handler)
                              (wrap:java.lang.Runnable:0x0058: CONSTRUCTOR (r0v5 'developerTuyaKeySetStartActivity' com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity A[DONT_INLINE]) A[MD:(com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity):void (m), WRAPPED] (LINE:89) call: com.sma.smartv3.ui.me.IoXIXo.<init>(com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity):void type: CONSTRUCTOR)
                              (wrap:long:SGET  A[WRAPPED] com.google.android.exoplayer2.ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS long)
                             VIRTUAL call: android.os.Handler.postDelayed(java.lang.Runnable, long):boolean A[MD:(java.lang.Runnable, long):boolean (c)] (LINE:94) in method: com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity$mScanner$2.II0xO0.oIX0oI(boolean):void, file: classes11.dex
                            ...
                            Caused by: jadx.core.utils.exceptions.JadxRuntimeException: Expected class to be processed at this point, class: com.sma.smartv3.ui.me.IoXIXo, state: NOT_LOADED
                        ...
                        /*
                            ...
                            r0 = 8
                            if (r5 == 0) goto Le
                            com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity r5 = r4.f23235oIX0oI
                            androidx.appcompat.widget.AppCompatButton r5 = com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity.access$getBtStartSet(r5)
                            r5.setVisibility(r0)
                            goto L79
                        Le:
                            com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity r5 = r4.f23235oIX0oI
                            boolean r5 = com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity.access$isAutoSet$p(r5)
                            r1 = 0
                            if (r5 == 0) goto L70
                            com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity r5 = r4.f23235oIX0oI
                            androidx.appcompat.widget.AppCompatButton r5 = com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity.access$getBtStartSet(r5)
                            r5.setVisibility(r0)
                            com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity r5 = r4.f23235oIX0oI
                            java.util.List r5 = com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity.access$getMList(r5)
                            boolean r5 = r5.isEmpty()
                            if (r5 == 0) goto L61
                            OI0.oIX0oI r5 = OI0.oIX0oI.f1507oIX0oI
                            java.lang.StringBuilder r0 = new java.lang.StringBuilder
                            r0.<init>()
                            com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity r2 = r4.f23235oIX0oI
                            java.lang.String r2 = com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity.access$getTAG$p(r2)
                            r0.append(r2)
                            java.lang.String r2 = " The search is empty, try again later"
                            r0.append(r2)
                            ...
                            r5.<init>()
                            com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity r0 = r4.f23235oIX0oI
                            com.sma.smartv3.ui.me.IoXIXo r1 = new com.sma.smartv3.ui.me.IoXIXo
                            r1.<init>(r0)
                        ...
                        L61:
                            com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity r5 = r4.f23235oIX0oI
                            android.widget.EditText r0 = com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity.access$getEtOldBleName(r5)
                        ...
                        L79:
                            return
                        */
                        throw new UnsupportedOperationException("Method not decompiled: com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity$mScanner$2.II0xO0.oIX0oI(boolean):void");
                    }
                }
                ...
                public static final class oIX0oI implements XOxIOxOx.X0o0xo {
                    ...
                    /* renamed from: oIX0oI, reason: collision with root package name */
                    public final /* synthetic */ DeveloperTuyaKeySetStartActivity f23236oIX0oI;

                    public oIX0oI(DeveloperTuyaKeySetStartActivity developerTuyaKeySetStartActivity) {
                        this.f23236oIX0oI = developerTuyaKeySetStartActivity;
                    }
                ...
                public final XOxIOxOx.II0xO0 invoke() {
                    return XOxIOxOx.oO.II0xO0(XOxIOxOx.oO.f3971oIX0oI, null, ScanMode.LOW_LATENCY, 1, null).Oo(10).IXxxXO(new oIX0oI(DeveloperTuyaKeySetStartActivity.this)).ooOOo0oXI(new II0xO0(DeveloperTuyaKeySetStartActivity.this));
                }
            });
            ...
            @OXOo.OOXIXo
            private final Runnable mConnectedFailRunnable = new Runnable() { // from class: com.sma.smartv3.ui.me.Ix00oIoI
                @Override // java.lang.Runnable
                public final void run() {
                    DeveloperTuyaKeySetStartActivity.mConnectedFailRunnable$lambda$1(DeveloperTuyaKeySetStartActivity.this);
                }
            };
            ...
            public static final class oIX0oI implements BleHandleCallback {
                ...
                public static final void II0xO0(DeveloperTuyaKeySetStartActivity this$0, BluetoothDevice device) {
                    kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
                    kotlin.jvm.internal.IIX0o.x0xO0oo(device, "$device");
                    ...
                    String str = this$0.filterName;
                    String address = device.getAddress();
                    kotlin.jvm.internal.IIX0o.oO(address, "getAddress(...)");
                    this$0.tuyaKeyCheckAvailable(str, kotlin.text.OxI.IIOIX(address, ":", "", false, 4, null));
                }
                ...
                public void onCommandReply(@OXOo.OOXIXo BleKey bleKey, @OXOo.OOXIXo BleKeyFlag bleKeyFlag, boolean z) {
                    ...
                    if (bleKey == BleKey.TUYA_KEY_SET) {
                        OI0.oIX0oI.f1507oIX0oI.oIX0oI(DeveloperTuyaKeySetStartActivity.this.TAG + " tuyaKey settings! Force closeConnection!");
                        DeveloperTuyaKeySetStartActivity.this.reStart();
                    }
                }
                ...
                public void onCommandSendTimeout(@OXOo.OOXIXo BleKey bleKey, @OXOo.OOXIXo BleKeyFlag bleKeyFlag) {
                    ...
                    kotlin.jvm.internal.IIX0o.x0xO0oo(bleKeyFlag, "bleKeyFlag");
                    if (bleKey == BleKey.TUYA_KEY_SET) {
                        OI0.oIX0oI.f1507oIX0oI.oIX0oI(DeveloperTuyaKeySetStartActivity.this.TAG + " tuyaKey settings time out! Force closeConnection!");
                        DeveloperTuyaKeySetStartActivity.this.mConnectedFailMap.put(DeveloperTuyaKeySetStartActivity.this.deviceAddress, 10);
                        DeveloperTuyaKeySetStartActivity.this.reStart();
                    }
                }

                @Override // com.szabh.smable3.component.BleHandleCallback
                public void onDeviceConnected(@OXOo.OOXIXo final BluetoothDevice device) {
                    kotlin.jvm.internal.IIX0o.x0xO0oo(device, "device");
                    DeveloperTuyaKeySetStartActivity.this.getBtStopSet().setVisibility(0);
                    Handler handler = new Handler();
                    final DeveloperTuyaKeySetStartActivity developerTuyaKeySetStartActivity = DeveloperTuyaKeySetStartActivity.this;
                    handler.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.O0IxXx
                        @Override // java.lang.Runnable
                        public final void run() {
                            DeveloperTuyaKeySetStartActivity.oIX0oI.II0xO0(DeveloperTuyaKeySetStartActivity.this, device);
                        }
                    }, 4000L);
                }
            ...
            private final void dismissLoadPopup() {
                runOnUiThread(new Runnable() { // from class: com.sma.smartv3.ui.me.IXO
                    @Override // java.lang.Runnable
                    public final void run() {
                        DeveloperTuyaKeySetStartActivity.dismissLoadPopup$lambda$4(DeveloperTuyaKeySetStartActivity.this);
                    }
                });
            }

            /* JADX INFO: Access modifiers changed from: private */
            public static final void dismissLoadPopup$lambda$4(DeveloperTuyaKeySetStartActivity this$0) {
                kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public static final void initView$lambda$3(DeveloperTuyaKeySetStartActivity this$0, AdapterView adapterView, View view, int i, long j) {
                kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public static final void mConnectedFailRunnable$lambda$1(DeveloperTuyaKeySetStartActivity this$0) {
                kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
            ...
            private final void permissionBackgroundLocationRemind() {
                if (getMPermissionBackgroundPopup() == null) {
                    ...
                    xoI0Ixx0.x0o(R.string.settings, new Oox.oIX0oI<Boolean>() { // from class: com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity$permissionBackgroundLocationRemind$1$1
                        {
                            super(0);
                        }
                        ...
                        public final Boolean invoke() {
                            Activity mContext;
                            mContext = DeveloperTuyaKeySetStartActivity.this.getMContext();
            ...
            public final void requestLocationPermission() {
                ...
                oOXoIIIo.X0o0xo.I0Io(permission, null, null, new Oox.oOoXoXO<PermissionStatus, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity$requestLocationPermission$1

                    /* loaded from: classes11.dex */
                    public /* synthetic */ class oIX0oI {

                        /* renamed from: oIX0oI, reason: collision with root package name */
                        public static final /* synthetic */ int[] f23238oIX0oI;
                    ...
                    public final void invoke2(@OXOo.OOXIXo PermissionStatus it) {
                        ...
                        int i = oIX0oI.f23238oIX0oI[it.ordinal()];
                        if (i != 1) {
                            if (i == 2) {
                                DeveloperTuyaKeySetStartActivity.this.requestLocationPermission();
                                return;
                            } else {
                                DeveloperTuyaKeySetStartActivity.this.permissionRemind();
                                return;
                            }
                        }
                        DeveloperTuyaKeySetStartActivity developerTuyaKeySetStartActivity = DeveloperTuyaKeySetStartActivity.this;
                        etOldBleName = developerTuyaKeySetStartActivity.getEtOldBleName();
                        kotlin.jvm.internal.IIX0o.oO(etOldBleName, "access$getEtOldBleName(...)");
                        developerTuyaKeySetStartActivity.startSearch(etOldBleName);
                    }
                }, 3, null);
            }
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public final void tuyaKeyCheckAvailable(String str, String str2) {
                OI0.oIX0oI.f1507oIX0oI.oIX0oI(this.TAG + " tuyaKeyCheckAvailable -> " + str + ", " + str2);
                NetWorkUtils netWorkUtils = NetWorkUtils.INSTANCE;
                HashMap hashMap = new HashMap();
                hashMap.put("bleName", str);
                hashMap.put("mac", str2);
                final DeveloperTuyaKeySetStartActivity$tuyaKeyCheckAvailable$2 developerTuyaKeySetStartActivity$tuyaKeyCheckAvailable$2 = new DeveloperTuyaKeySetStartActivity$tuyaKeyCheckAvailable$2(this, str2);
                final Activity activity = null;
                final com.sma.smartv3.pop.I0X0x0oIo loadPopup = netWorkUtils.loadPopup(null, null);
                String convertBaseUrl = netWorkUtils.convertBaseUrl(Api.INSTANCE.getBASE_URL(), xIXOoI.f23625II0xO0);
                netWorkUtils.printParam(convertBaseUrl + xIXOoI.f23625II0xO0, hashMap);
                NetWork netWork = NetWork.f19682oIX0oI;
                String str3 = convertBaseUrl + xIXOoI.f23625II0xO0;
                final xxxI.II0xO0<Response<OIoxIx>> iI0xO0 = new xxxI.II0xO0<Response<OIoxIx>>() { // from class: com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity$tuyaKeyCheckAvailable$$inlined$post$default$1
                    @Override // xxxI.II0xO0
                    public void handleError(@OXOo.OOXIXo String error) {
                        kotlin.jvm.internal.IIX0o.x0xO0oo(error, "error");
                        NetWorkUtils.INSTANCE.errorData(error, developerTuyaKeySetStartActivity$tuyaKeyCheckAvailable$2, loadPopup);
                    }

                    @Override // xxxI.II0xO0
                    /* renamed from: oIX0oI, reason: merged with bridge method [inline-methods] */
                    public void handleResponse(@OXOo.oOoXoXO Response<OIoxIx> response) {
                        NetWorkUtils netWorkUtils2 = NetWorkUtils.INSTANCE;
                        Activity activity2 = activity;
                        xxxI.II0xO0 iI0xO02 = developerTuyaKeySetStartActivity$tuyaKeyCheckAvailable$2;
                ...
                AndroidNetworking.post(str3).addBodyParameter((Map<String, String>) hashMap).setTag((Object) str3).setPriority(Priority.HIGH).build().getAsParsed(TypeToken.getParameterized(Response.class, OIoxIx.class), new ParsedRequestListener<Response<OIoxIx>>() { // from class: com.sma.smartv3.ui.me.DeveloperTuyaKeySetStartActivity$tuyaKeyCheckAvailable$$inlined$post$default$2
                    @Override // com.androidnetworking.interfaces.ParsedRequestListener
                    /* renamed from: oIX0oI, reason: merged with bridge method [inline-methods] */
                    public void onResponse(@OXOo.OOXIXo Response<OIoxIx> response) {
            ...
            public final void clearHistory(@OXOo.OOXIXo View view) {
                ...
                com.sma.smartv3.util.Xo0.f24349oIX0oI.XO().remove(oOoXoXO.class.getName());
            ...
            public void initView() {
                ...
                getMListView().setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: com.sma.smartv3.ui.me.oI
                    @Override // android.widget.AdapterView.OnItemClickListener
                    public final void onItemClick(AdapterView adapterView, View view, int i, long j) {
                        DeveloperTuyaKeySetStartActivity.initView$lambda$3(DeveloperTuyaKeySetStartActivity.this, adapterView, view, i, j);
                    }
                });
                ...
                tvValue.setText(String.valueOf(((oOoXoXO) oooxoxo).oxoX().size()));
            }
            ...
            @Override // com.bestmafen.androidbase.base.oIX0oI
            public int layoutId() {
                return R.layout.activity_developer_test_tuyakey_set_start;
            }
            ...
            public final void startSearch(@OXOo.OOXIXo View view) {
                ...
                OI0.oIX0oI.f1507oIX0oI.oIX0oI(this.TAG + " start scan s: " + this.filterName + ", " + this.rssi);
            }
