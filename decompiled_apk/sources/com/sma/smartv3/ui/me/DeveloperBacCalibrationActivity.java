...
public final class DeveloperBacCalibrationActivity extends BaseListFunctionActivity<String> {

    @OXOo.OOXIXo
    private final kotlin.X0IIOO start_tv1$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AppCompatButton>() { // from class: com.sma.smartv3.ui.me.DeveloperBacCalibrationActivity$start_tv1$2
        {
            super(0);
        }
        ...
        public final AppCompatButton invoke() {
            return (AppCompatButton) DeveloperBacCalibrationActivity.this.findViewById(R.id.start_tv1);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO start_tv2$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AppCompatButton>() { // from class: com.sma.smartv3.ui.me.DeveloperBacCalibrationActivity$start_tv2$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final AppCompatButton invoke() {
            return (AppCompatButton) DeveloperBacCalibrationActivity.this.findViewById(R.id.start_tv2);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO read_tv$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AppCompatButton>() { // from class: com.sma.smartv3.ui.me.DeveloperBacCalibrationActivity$read_tv$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final AppCompatButton invoke() {
            return (AppCompatButton) DeveloperBacCalibrationActivity.this.findViewById(R.id.read_tv);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO value1_btn$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AppCompatButton>() { // from class: com.sma.smartv3.ui.me.DeveloperBacCalibrationActivity$value1_btn$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final AppCompatButton invoke() {
            return (AppCompatButton) DeveloperBacCalibrationActivity.this.findViewById(R.id.value1_btn);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO value2_btn$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AppCompatButton>() { // from class: com.sma.smartv3.ui.me.DeveloperBacCalibrationActivity$value2_btn$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final AppCompatButton invoke() {
            return (AppCompatButton) DeveloperBacCalibrationActivity.this.findViewById(R.id.value2_btn);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO press1_btn$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AppCompatButton>() { // from class: com.sma.smartv3.ui.me.DeveloperBacCalibrationActivity$press1_btn$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final AppCompatButton invoke() {
            return (AppCompatButton) DeveloperBacCalibrationActivity.this.findViewById(R.id.press1_btn);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO press2_btn$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AppCompatButton>() { // from class: com.sma.smartv3.ui.me.DeveloperBacCalibrationActivity$press2_btn$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final AppCompatButton invoke() {
            return (AppCompatButton) DeveloperBacCalibrationActivity.this.findViewById(R.id.press2_btn);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO list_view$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<ListView>() { // from class: com.sma.smartv3.ui.me.DeveloperBacCalibrationActivity$list_view$2
        {
            super(0);
        }
        ...
        public final ListView invoke() {
            return (ListView) DeveloperBacCalibrationActivity.this.findViewById(R.id.list_view);
        }
    });
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onReadBacCalibration(@OXOo.OOXIXo BleBacCalibration bac, @OXOo.OOXIXo BleKeyFlag bleKeyFlag) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(bac, "bac");
            kotlin.jvm.internal.IIX0o.x0xO0oo(bleKeyFlag, "bleKeyFlag");
            if (bleKeyFlag == BleKeyFlag.READ) {
                DeveloperBacCalibrationActivity.this.getValue1_btn().setText("标定值1: " + bac.getValue2());
                DeveloperBacCalibrationActivity.this.getValue2_btn().setText("标定值2: " + bac.getValue4());
                DeveloperBacCalibrationActivity.this.getPress1_btn().setText("电压值1: " + bac.getValue3());
                DeveloperBacCalibrationActivity.this.getPress2_btn().setText("电压值2: " + bac.getValue5());
                return;
            }
            int value1 = bac.getValue1();
            if (value1 != 1) {
                if (value1 != 2) {
                    if (value1 != 3) {
                        if (value1 == 4) {
                            DeveloperBacCalibrationActivity.this.setResult("标定失败");
                        }
                    } else {
                        DeveloperBacCalibrationActivity.this.setResult("标定成功");
                    }
                } else {
                    DeveloperBacCalibrationActivity.this.setResult("采集数据中(10s超时)");
                }
            } else {
                DeveloperBacCalibrationActivity.this.setResult("预热中(25s超时)");
            }
            DeveloperBacCalibrationActivity.this.getMList().add(DeveloperBacCalibrationActivity.this.getResult());
            DeveloperBacCalibrationActivity.this.getMListAdapter().notifyDataSetChanged();
            DeveloperBacCalibrationActivity.this.getList_view().setSelection(DeveloperBacCalibrationActivity.this.getList_view().getBottom());
        }
        ...
        public void onReadFirmwareVersion(@OXOo.OOXIXo String version) {
            ...
            DeveloperBacCalibrationActivity.this.onCodePairChange(new Object());
        }
    ...
    public final ListView getList_view() {
        return (ListView) this.list_view$delegate.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final AppCompatButton getPress1_btn() {
        return (AppCompatButton) this.press1_btn$delegate.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final AppCompatButton getPress2_btn() {
        return (AppCompatButton) this.press2_btn$delegate.getValue();
    }

    private final AppCompatButton getRead_tv() {
        return (AppCompatButton) this.read_tv$delegate.getValue();
    }

    private final AppCompatButton getStart_tv1() {
        return (AppCompatButton) this.start_tv1$delegate.getValue();
    }

    private final AppCompatButton getStart_tv2() {
        return (AppCompatButton) this.start_tv2$delegate.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final AppCompatButton getValue1_btn() {
        return (AppCompatButton) this.value1_btn$delegate.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final AppCompatButton getValue2_btn() {
        return (AppCompatButton) this.value2_btn$delegate.getValue();
    }

    public static /* synthetic */ void updatePairState$default(DeveloperBacCalibrationActivity developerBacCalibrationActivity, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
            z = true;
        }
        developerBacCalibrationActivity.updatePairState(z);
    }
    ...
    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_developer_test_bac_calibration;
    }
    ...
    public final void onCodePairChange(@OXOo.OOXIXo Object data) {
        ...
        RequestCommonMethod.INSTANCE.updateDeviceInfo(new xxxI.II0xO0<String>() { // from class: com.sma.smartv3.ui.me.DeveloperBacCalibrationActivity$onCodePairChange$1
    ...
    public final void read(@OXOo.OOXIXo View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(view, "view");
        BleConnector.sendData$default(BleConnector.INSTANCE, BleKey.BAC_CALIBRATION, BleKeyFlag.READ, null, false, false, 28, null);
    }

    public final void setResult(@OXOo.OOXIXo String str) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(str, "<set-?>");
        this.result = str;
    }

    public final void toStartSendText1(@OXOo.OOXIXo View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(view, "view");
        com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.me.DeveloperBacCalibrationActivity$toStartSendText1$1
            ...
            public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                ...
                BleKey bleKey = BleKey.BAC_CALIBRATION;
                BleBacCalibration bleBacCalibration = (BleBacCalibration) BleCache.getObjectNotNull$default(bleCache, bleKey, BleBacCalibration.class, null, null, 12, null);
                bleBacCalibration.setValue1(1);
                bleBacCalibration.setValue2(1);
                bleBacCalibration.setValue3(2);
                BleConnector.sendObject$default(it, bleKey, BleKeyFlag.UPDATE, bleBacCalibration, false, false, 24, null);
            }
        }, 1, null);
    }

    public final void toStartSendText2(@OXOo.OOXIXo View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(view, "view");
        com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.me.DeveloperBacCalibrationActivity$toStartSendText2$1
            @Override // Oox.oOoXoXO
            public /* bridge */ /* synthetic */ kotlin.oXIO0o0XI invoke(BleConnector bleConnector) {
                invoke2(bleConnector);
                return kotlin.oXIO0o0XI.f29392oIX0oI;
            ...
            public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                ...
                BleBacCalibration bleBacCalibration = (BleBacCalibration) BleCache.getObjectNotNull$default(bleCache, bleKey, BleBacCalibration.class, null, null, 12, null);
                bleBacCalibration.setValue1(1);
                bleBacCalibration.setValue2(2);
                bleBacCalibration.setValue3(8);
                BleConnector.sendObject$default(it, bleKey, BleKeyFlag.UPDATE, bleBacCalibration, false, false, 24, null);
            }
        }, 1, null);
    }
