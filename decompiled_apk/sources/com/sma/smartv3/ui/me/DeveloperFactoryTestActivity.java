...
import com.sma.smartv3.ui.me.DeveloperFactoryTestActivity$mBleHandleCallback$2;
...
public final class DeveloperFactoryTestActivity extends BaseActivity {

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvInfo$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.me.DeveloperFactoryTestActivity$tvInfo$2
        {
            super(0);
        }
        ...
        public final TextView invoke() {
            return (TextView) DeveloperFactoryTestActivity.this.findViewById(R.id.tv_info);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO mBleHandleCallback$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<DeveloperFactoryTestActivity$mBleHandleCallback$2.oIX0oI>() { // from class: com.sma.smartv3.ui.me.DeveloperFactoryTestActivity$mBleHandleCallback$2

        /* loaded from: classes11.dex */
        public static final class oIX0oI implements BleHandleCallback {

            /* renamed from: XO, reason: collision with root package name */
            public final /* synthetic */ DeveloperFactoryTestActivity f23167XO;

            public oIX0oI(DeveloperFactoryTestActivity developerFactoryTestActivity) {
                this.f23167XO = developerFactoryTestActivity;
            }
            ...
            @Override // com.szabh.smable3.component.BleHandleCallback
            public void onFactoryTestUpdate(@OXOo.OOXIXo BleFactoryTest factoryTest) {
                TextView tvInfo;
                TextView tvInfo2;
                kotlin.jvm.internal.IIX0o.x0xO0oo(factoryTest, "factoryTest");
                tvInfo = this.f23167XO.getTvInfo();
                tvInfo.setText(String.valueOf(factoryTest.getMType()));
                tvInfo2 = this.f23167XO.getTvInfo();
                tvInfo2.append("\n\n" + factoryTest.getMResponse());
            }
        ...
        public final oIX0oI invoke() {
            return new oIX0oI(DeveloperFactoryTestActivity.this);
        }
    });

    private final DeveloperFactoryTestActivity$mBleHandleCallback$2.oIX0oI getMBleHandleCallback() {
        return (DeveloperFactoryTestActivity$mBleHandleCallback$2.oIX0oI) this.mBleHandleCallback$delegate.getValue();
    }
    ...
    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_developer_factory_test;
    }
    ...
    public void onDestroy() {
        ...
        bleConnector.removeHandleCallback(getMBleHandleCallback());
        if (bleConnector.isAvailable()) {
            BleConnector.sendInt8$default(bleConnector, BleKey.FACTORY_TEST, BleKeyFlag.UPDATE, FactoryTestType.EXIT.getType(), false, false, 24, null);
        }
    }

    public final void onEnter(@OXOo.OOXIXo View v) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(v, "v");
        com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.me.DeveloperFactoryTestActivity$onEnter$1
            ...
            public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                ...
                BleConnector.sendInt8$default(BleConnector.INSTANCE, BleKey.FACTORY_TEST, BleKeyFlag.UPDATE, FactoryTestType.ENTER.getType(), false, false, 24, null);
            }
        }, 1, null);
    }

    public final void onExit(@OXOo.OOXIXo View v) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(v, "v");
        com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.me.DeveloperFactoryTestActivity$onExit$1
            @Override // Oox.oOoXoXO
            public /* bridge */ /* synthetic */ kotlin.oXIO0o0XI invoke(BleConnector bleConnector) {
                invoke2(bleConnector);
                return kotlin.oXIO0o0XI.f29392oIX0oI;
            ...
            public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                kotlin.jvm.internal.IIX0o.x0xO0oo(it, "it");
                BleConnector.sendInt8$default(BleConnector.INSTANCE, BleKey.FACTORY_TEST, BleKeyFlag.UPDATE, FactoryTestType.EXIT.getType(), false, false, 24, null);
            }
        }, 1, null);
    }

    public final void onGSensor(@OXOo.OOXIXo View v) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(v, "v");
        com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.me.DeveloperFactoryTestActivity$onGSensor$1
            @Override // Oox.oOoXoXO
            public /* bridge */ /* synthetic */ kotlin.oXIO0o0XI invoke(BleConnector bleConnector) {
                invoke2(bleConnector);
                return kotlin.oXIO0o0XI.f29392oIX0oI;
            ...
            public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                kotlin.jvm.internal.IIX0o.x0xO0oo(it, "it");
                BleConnector.sendInt8$default(BleConnector.INSTANCE, BleKey.FACTORY_TEST, BleKeyFlag.UPDATE, FactoryTestType.GSENSOR.getType(), false, false, 24, null);
            }
        }, 1, null);
    }

    public final void onHrLeak(@OXOo.OOXIXo View v) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(v, "v");
        com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.me.DeveloperFactoryTestActivity$onHrLeak$1
            @Override // Oox.oOoXoXO
            public /* bridge */ /* synthetic */ kotlin.oXIO0o0XI invoke(BleConnector bleConnector) {
                invoke2(bleConnector);
                return kotlin.oXIO0o0XI.f29392oIX0oI;
            ...
            public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                kotlin.jvm.internal.IIX0o.x0xO0oo(it, "it");
                BleConnector.sendInt8$default(BleConnector.INSTANCE, BleKey.FACTORY_TEST, BleKeyFlag.UPDATE, FactoryTestType.HR_LEAK.getType(), false, false, 24, null);
            }
        }, 1, null);
    }
}
