...
import com.szabh.smable3.entity.BleTestInfoSet;
...
@kotlin.jvm.internal.XX({"SMAP\nDeveloperTestBoxActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperTestBoxActivity.kt\ncom/sma/smartv3/ui/me/DeveloperTestBoxActivity\n+ 2 Activity.kt\ncom/bestmafen/androidbase/extension/ActivityKt\n+ 3 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,79:1\n69#2,3:80\n72#2,5:84\n1#3:83\n*S KotlinDebug\n*F\n+ 1 DeveloperTestBoxActivity.kt\ncom/sma/smartv3/ui/me/DeveloperTestBoxActivity\n*L\n53#1:80,3\n53#1:84,5\n53#1:83\n*E\n"})
/* loaded from: classes11.dex */
public final class DeveloperTestBoxActivity extends BaseActivity {

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvInfo$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.me.DeveloperTestBoxActivity$tvInfo$2
        {
            super(0);
        }
        ...
        public final TextView invoke() {
            return (TextView) DeveloperTestBoxActivity.this.findViewById(R.id.tv_info);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO etSsid$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<EditText>() { // from class: com.sma.smartv3.ui.me.DeveloperTestBoxActivity$etSsid$2
        {
            super(0);
        }
        ...
        public final EditText invoke() {
            return (EditText) DeveloperTestBoxActivity.this.findViewById(R.id.et_ssid);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO etPassword$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<EditText>() { // from class: com.sma.smartv3.ui.me.DeveloperTestBoxActivity$etPassword$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final EditText invoke() {
            return (EditText) DeveloperTestBoxActivity.this.findViewById(R.id.et_password);
        }
    });
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public void onSessionStateChange(boolean z) {
            DeveloperTestBoxActivity.this.showInto();
        }
    ...
    public final EditText getEtPassword() {
        return (EditText) this.etPassword$delegate.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final EditText getEtSsid() {
        return (EditText) this.etSsid$delegate.getValue();
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void showInto() {
        if (BleConnector.INSTANCE.isAvailable()) {
            getTvInfo().setText(BleCache.INSTANCE.getMBleName() + TokenParser.SP + getString(R.string.device_connectied));
            return;
        }
        getTvInfo().setText(BleCache.INSTANCE.getMBleName() + TokenParser.SP + getString(R.string.device_disconnected));
    }
    ...
    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_developer_test_box;
    }

    public final void onAdd(@OXOo.OOXIXo View v) {
    ...
    public final void onSet(@OXOo.OOXIXo View v) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(v, "v");
        com.sma.smartv3.ble.I0Io.II0xO0(false, new Oox.oOoXoXO<BleConnector, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.me.DeveloperTestBoxActivity$onSet$1
            {
                super(1);
            }
            ...
            public final void invoke2(@OXOo.OOXIXo BleConnector it) {
                ...
                etSsid = DeveloperTestBoxActivity.this.getEtSsid();
                String obj = etSsid.getText().toString();
                etPassword = DeveloperTestBoxActivity.this.getEtPassword();
                String obj2 = etPassword.getText().toString();
                if (TextUtils.isEmpty(obj)) {
                    return;
                }
                BleConnector.sendObject$default(BleConnector.INSTANCE, BleKey.TEST_INFO_SET, BleKeyFlag.UPDATE, new BleTestInfoSet(obj, obj2), false, false, 24, null);
            }
        }, 1, null);
    }

    public final void onUnbind(@OXOo.OOXIXo View v) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(v, "v");
