...
import com.sma.smartv3.ui.me.DeveloperBtNameStartActivity;
...
import com.szabh.smable3.entity.BleBtName;
...
@kotlin.jvm.internal.XX({"SMAP\nDeveloperBtNameStartActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperBtNameStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperBtNameStartActivity\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n*L\n1#1,343:1\n19#2:344\n15#2:345\n27#2,2:346\n*S KotlinDebug\n*F\n+ 1 DeveloperBtNameStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperBtNameStartActivity\n*L\n177#1:344\n177#1:345\n263#1:346,2\n*E\n"})
/* loaded from: classes11.dex */
public final class DeveloperBtNameStartActivity extends BaseListFunctionActivity<BleDevice> {
    private boolean isAutoBtName;

    @OXOo.oOoXoXO
    private com.sma.smartv3.pop.I0X0x0oIo mLoadingPopup;

    @OXOo.OOXIXo
    private final kotlin.X0IIOO etOldBleName$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<EditText>() { // from class: com.sma.smartv3.ui.me.DeveloperBtNameStartActivity$etOldBleName$2
        {
            super(0);
        }
        ...
        public final EditText invoke() {
            return (EditText) DeveloperBtNameStartActivity.this.findViewById(R.id.et_old_ble_name);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO btStartBtName$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AppCompatButton>() { // from class: com.sma.smartv3.ui.me.DeveloperBtNameStartActivity$btStartBtName$2
        {
            super(0);
        }
        ...
        public final AppCompatButton invoke() {
            return (AppCompatButton) DeveloperBtNameStartActivity.this.findViewById(R.id.bt_start_bt_name);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO btStopBtName$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AppCompatButton>() { // from class: com.sma.smartv3.ui.me.DeveloperBtNameStartActivity$btStopBtName$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final AppCompatButton invoke() {
            return (AppCompatButton) DeveloperBtNameStartActivity.this.findViewById(R.id.bt_stop_bt_name);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO etSignal$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<EditText>() { // from class: com.sma.smartv3.ui.me.DeveloperBtNameStartActivity$etSignal$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final EditText invoke() {
            return (EditText) DeveloperBtNameStartActivity.this.findViewById(R.id.et_signal);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvSearchNumber$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.me.DeveloperBtNameStartActivity$tvSearchNumber$2
        {
            super(0);
        }
        ...
        public final TextView invoke() {
            return (TextView) DeveloperBtNameStartActivity.this.findViewById(R.id.tv_search_number);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvAlreadyBtName$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.me.DeveloperBtNameStartActivity$tvAlreadyBtName$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final TextView invoke() {
            return (TextView) DeveloperBtNameStartActivity.this.findViewById(R.id.tv_already_bt_name);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO etBtName$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<EditText>() { // from class: com.sma.smartv3.ui.me.DeveloperBtNameStartActivity$etBtName$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final EditText invoke() {
            return (EditText) DeveloperBtNameStartActivity.this.findViewById(R.id.et_bt_name);
        }
    });
    ...
    @OXOo.OOXIXo
    private final kotlin.X0IIOO mScanner$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<XOxIOxOx.II0xO0>() { // from class: com.sma.smartv3.ui.me.DeveloperBtNameStartActivity$mScanner$2

        @kotlin.jvm.internal.XX({"SMAP\nDeveloperBtNameStartActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperBtNameStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperBtNameStartActivity$mScanner$2$2\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n+ 3 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,343:1\n19#2:344\n15#2:345\n1002#3,2:346\n*S KotlinDebug\n*F\n+ 1 DeveloperBtNameStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperBtNameStartActivity$mScanner$2$2\n*L\n91#1:344\n91#1:345\n97#1:346,2\n*E\n"})
        /* loaded from: classes11.dex */
        public static final class II0xO0 implements XOxIOxOx.oxoX {

            /* renamed from: oIX0oI, reason: collision with root package name */
            public final /* synthetic */ DeveloperBtNameStartActivity f23164oIX0oI;

            @kotlin.jvm.internal.XX({"SMAP\nComparisons.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Comparisons.kt\nkotlin/comparisons/ComparisonsKt__ComparisonsKt$compareBy$2\n+ 2 DeveloperBtNameStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperBtNameStartActivity$mScanner$2$2\n*L\n1#1,328:1\n97#2:329\n*E\n"})
            /* loaded from: classes11.dex */
            ...
            public II0xO0(DeveloperBtNameStartActivity developerBtNameStartActivity) {
                this.f23164oIX0oI = developerBtNameStartActivity;
            }
            ...
            public void II0xO0(@OXOo.OOXIXo BleDevice device) {
                ...
                mList = this.f23164oIX0oI.getMList();
                if (mList.contains(device)) {
                    return;
                }
                SPUtils XO2 = com.sma.smartv3.util.Xo0.f24349oIX0oI.XO();
                Object x0o0xo = new X0o0xo(null, 1, null);
                Object fromJson = new Gson().fromJson(XO2.getString(X0o0xo.class.getName()), (Class<Object>) X0o0xo.class);
                if (fromJson != null) {
                    x0o0xo = fromJson;
                }
                if (!((X0o0xo) x0o0xo).oxoX().contains(device.getMBluetoothDevice().getAddress())) {
                    mList2 = this.f23164oIX0oI.getMList();
                    mList2.add(device);
                    mList3 = this.f23164oIX0oI.getMList();
                    if (mList3.size() > 1) {
                        kotlin.collections.o00.OO0x0xX(mList3, new oIX0oI());
                    }
                    tvSearchNumber = this.f23164oIX0oI.getTvSearchNumber();
                    DeveloperBtNameStartActivity developerBtNameStartActivity = this.f23164oIX0oI;
                    mList4 = developerBtNameStartActivity.getMList();
                    tvSearchNumber.setText(developerBtNameStartActivity.getString(R.string.device_found, Integer.valueOf(mList4.size())));
                    mListAdapter = this.f23164oIX0oI.getMListAdapter();
            ...
            public void oIX0oI(boolean z) {
                AppCompatButton btStartBtName;
                boolean z2;
                AppCompatButton btStartBtName2;
                if (z) {
                    btStartBtName2 = this.f23164oIX0oI.getBtStartBtName();
                    btStartBtName2.setVisibility(8);
                    return;
                }
                btStartBtName = this.f23164oIX0oI.getBtStartBtName();
                btStartBtName.setVisibility(0);
                z2 = this.f23164oIX0oI.isAutoBtName;
                if (z2) {
                    DeveloperBtNameStartActivity developerBtNameStartActivity = this.f23164oIX0oI;
                    EditText etOldBleName = developerBtNameStartActivity.getEtOldBleName();
                    kotlin.jvm.internal.IIX0o.oO(etOldBleName, "access$getEtOldBleName(...)");
                    developerBtNameStartActivity.startBtName(etOldBleName);
                }
            }
        }
        ...
        public final XOxIOxOx.II0xO0 invoke() {
            return XOxIOxOx.oO.II0xO0(XOxIOxOx.oO.f3971oIX0oI, null, ScanMode.LOW_LATENCY, 1, null).Oo(10).IXxxXO(new oIX0oI()).ooOOo0oXI(new II0xO0(DeveloperBtNameStartActivity.this));
        }
    });
    ...
    @kotlin.jvm.internal.XX({"SMAP\nDeveloperBtNameStartActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperBtNameStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperBtNameStartActivity$mBleHandleCallback$1\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n*L\n1#1,343:1\n19#2:344\n15#2:345\n11#2,2:346\n19#2:348\n15#2:349\n19#2:350\n15#2:351\n*S KotlinDebug\n*F\n+ 1 DeveloperBtNameStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperBtNameStartActivity$mBleHandleCallback$1\n*L\n149#1:344\n149#1:345\n152#1:346,2\n154#1:348\n154#1:349\n123#1:350\n123#1:351\n*E\n"})
    /* loaded from: classes11.dex */
    public static final class oIX0oI implements BleHandleCallback {
        public oIX0oI() {
        }

        public static final void X0o0xo(final DeveloperBtNameStartActivity this$0) {
            ...
            if (!((X0o0xo) x0o0xo).oxoX().contains(this$0.deviceAddress)) {
                ...
                BleCache.remove$default(BleCache.INSTANCE, BleKey.BT_NAME, null, 2, null);
                this$0.failedList.add(this$0.deviceAddress);
                ThreadUtils.runOnUiThread(new Runnable() { // from class: com.sma.smartv3.ui.me.OI0
                    @Override // java.lang.Runnable
                    public final void run() {
                        DeveloperBtNameStartActivity.oIX0oI.XO(DeveloperBtNameStartActivity.this);
                    }
                });
            }
        }

        public static final void XO(DeveloperBtNameStartActivity this$0) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
            ToastUtils.showLong(R.string.auto_next_bt_name);
            EditText etOldBleName = this$0.getEtOldBleName();
            kotlin.jvm.internal.IIX0o.oO(etOldBleName, "access$getEtOldBleName(...)");
            this$0.startSearch(etOldBleName);
        }

        public static final void oxoX(final DeveloperBtNameStartActivity this$0) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
            ...
            String obj = this$0.getEtBtName().getText().toString();
            if (!TextUtils.isEmpty(obj) && obj.length() >= 2) {
                BleConnector.sendObject$default(bleConnector, BleKey.BT_NAME, BleKeyFlag.UPDATE, new BleBtName(obj), false, false, 24, null);
                new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.XOxIOxOx
                    @Override // java.lang.Runnable
                    public final void run() {
                        DeveloperBtNameStartActivity.oIX0oI.X0o0xo(DeveloperBtNameStartActivity.this);
                    }
                }, 5000L);
            } else {
                ToastUtils.showLong("请输入2-30长度的蓝牙名", new Object[0]);
            }
        }
        ...
        public void onCommandReply(@OXOo.OOXIXo BleKey bleKey, @OXOo.OOXIXo BleKeyFlag bleKeyFlag, boolean z) {
            ...
            BleKey bleKey2 = BleKey.BT_NAME;
            if (bleKey == bleKey2) {
                com.sma.smartv3.pop.I0X0x0oIo i0X0x0oIo = DeveloperBtNameStartActivity.this.mLoadingPopup;
                if (i0X0x0oIo != null) {
                    i0X0x0oIo.dismiss();
                }
                LogUtils.d("Bt Name success");
                BleConnector.INSTANCE.closeConnection(true);
                ...
                X0o0xo x0o0xo2 = (X0o0xo) x0o0xo;
                x0o0xo2.oxoX().add(DeveloperBtNameStartActivity.this.deviceAddress);
                xo0.XO().put(X0o0xo.class.getName(), new Gson().toJson(x0o0xo2));
                TextView tvAlreadyBtName = DeveloperBtNameStartActivity.this.getTvAlreadyBtName();
                SPUtils XO3 = xo0.XO();
                Object x0o0xo3 = new X0o0xo(null, 1, null);
                Object fromJson2 = new Gson().fromJson(XO3.getString(X0o0xo.class.getName()), (Class<Object>) X0o0xo.class);
                if (fromJson2 != null) {
                    x0o0xo3 = fromJson2;
                }
                tvAlreadyBtName.setText(String.valueOf(((X0o0xo) x0o0xo3).oxoX().size()));
                ToastUtils.showLong(R.string.auto_next_bt_name);
                DeveloperBtNameStartActivity developerBtNameStartActivity = DeveloperBtNameStartActivity.this;
                EditText etOldBleName = developerBtNameStartActivity.getEtOldBleName();
                kotlin.jvm.internal.IIX0o.oO(etOldBleName, "access$getEtOldBleName(...)");
                developerBtNameStartActivity.startSearch(etOldBleName);
            }
        }
        ...
        public void onDeviceConnected(@OXOo.OOXIXo BluetoothDevice device) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(device, "device");
            DeveloperBtNameStartActivity.this.getBtStopBtName().setVisibility(0);
            LogUtils.d("onDeviceConnected -> " + device);
            Handler handler = new Handler();
            final DeveloperBtNameStartActivity developerBtNameStartActivity = DeveloperBtNameStartActivity.this;
            handler.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.x0o
                @Override // java.lang.Runnable
                public final void run() {
                    DeveloperBtNameStartActivity.oIX0oI.oxoX(DeveloperBtNameStartActivity.this);
                }
            }, 3000L);
        }
    ...
    public final AppCompatButton getBtStartBtName() {
        return (AppCompatButton) this.btStartBtName$delegate.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final AppCompatButton getBtStopBtName() {
        return (AppCompatButton) this.btStopBtName$delegate.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final EditText getEtBtName() {
        return (EditText) this.etBtName$delegate.getValue();
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$0(DeveloperBtNameStartActivity this$0, AdapterView adapterView, View view, int i, long j) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
    ...
    private final void permissionBackgroundLocationRemind() {
        if (getMPermissionBackgroundPopup() == null) {
            ...
            xoI0Ixx0.x0o(R.string.settings, new Oox.oIX0oI<Boolean>() { // from class: com.sma.smartv3.ui.me.DeveloperBtNameStartActivity$permissionBackgroundLocationRemind$1$1
                {
                    super(0);
                }
                ...
                public final Boolean invoke() {
                    Activity mContext;
                    mContext = DeveloperBtNameStartActivity.this.getMContext();
    ...
    public final void requestLocationPermission() {
        ...
        oOXoIIIo.X0o0xo.I0Io(permission, null, null, new Oox.oOoXoXO<PermissionStatus, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.me.DeveloperBtNameStartActivity$requestLocationPermission$1

            /* loaded from: classes11.dex */
            public /* synthetic */ class oIX0oI {

                /* renamed from: oIX0oI, reason: collision with root package name */
                public static final /* synthetic */ int[] f23166oIX0oI;
            ...
            public final void invoke2(@OXOo.OOXIXo PermissionStatus it) {
                ...
                int i = oIX0oI.f23166oIX0oI[it.ordinal()];
                if (i != 1) {
                    if (i == 2) {
                        DeveloperBtNameStartActivity.this.requestLocationPermission();
                        return;
                    } else {
                        DeveloperBtNameStartActivity.this.permissionRemind();
                        return;
                    }
                }
                DeveloperBtNameStartActivity developerBtNameStartActivity = DeveloperBtNameStartActivity.this;
                TextView tvAlreadyBtName = developerBtNameStartActivity.getTvAlreadyBtName();
                kotlin.jvm.internal.IIX0o.oO(tvAlreadyBtName, "access$getTvAlreadyBtName(...)");
                developerBtNameStartActivity.startSearch(tvAlreadyBtName);
            }
        }, 3, null);
    }

    public final void clearBtNameHistory(@OXOo.OOXIXo View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(view, "view");
        com.sma.smartv3.util.Xo0.f24349oIX0oI.XO().remove(X0o0xo.class.getName());
        getTvAlreadyBtName().setText("0");
    ...
    public void initView() {
        ...
        getBtStopBtName().setVisibility(8);
        getMListView().setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: com.sma.smartv3.ui.me.xII
            @Override // android.widget.AdapterView.OnItemClickListener
            public final void onItemClick(AdapterView adapterView, View view, int i, long j) {
                DeveloperBtNameStartActivity.initView$lambda$0(DeveloperBtNameStartActivity.this, adapterView, view, i, j);
            }
        });
        ...
        tvAlreadyBtName.setText(String.valueOf(((X0o0xo) x0o0xo).oxoX().size()));
    }
    ...
    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_developer_test_bt_name_start;
    }
    ...
    public final void startBtName(@OXOo.OOXIXo View view) {
        BleDevice bleDevice;
        kotlin.jvm.internal.IIX0o.x0xO0oo(view, "view");
        LogUtils.d("startTemperatureValue failedList=" + this.failedList);
        if (TextUtils.isEmpty(getEtBtName().getText().toString())) {
            ToastUtils.showLong("Please enter the bt name", new Object[0]);
            return;
        }
        if (getMList().isEmpty()) {
            ToastUtils.showLong(R.string.no_device_not_bt_name);
            return;
        }
        this.isAutoBtName = true;
        ...
        if (bleDevice == null) {
            ...
            ToastUtils.showLong(R.string.no_device_to_bt_name);
            this.isAutoBtName = false;
            return;
        }
        ...
        getBtStopBtName().setVisibility(0);
        ...
        LogUtils.d(this.isAutoBtName + " connect new device -> " + bleDevice);
    }
    ...
    public final void stopBleName(@OXOo.OOXIXo View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(view, "view");
        ToastUtils.showLong(R.string.close_auto_bt_name_tip);
        this.isAutoBtName = false;
        getBtStopBtName().setVisibility(8);
    }
