...
public final class DeveloperShowRealtimeMapAndLocationActivity extends BaseListActivity<String> {

    @OXOo.oOoXoXO
    private File mGpsInfo;

    @OXOo.OOXIXo
    public static final oIX0oI Companion = new oIX0oI(null);
    private static final CoordinateConverter COORDINATE_CONVERTER = new CoordinateConverter().from(CoordinateConverter.CoordType.GPS);

    @OXOo.OOXIXo
    private final kotlin.X0IIOO mMapView$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextureMapView>() { // from class: com.sma.smartv3.ui.me.DeveloperShowRealtimeMapAndLocationActivity$mMapView$2
        {
            super(0);
        }
        ...
        public final TextureMapView invoke() {
            return (TextureMapView) DeveloperShowRealtimeMapAndLocationActivity.this.findViewById(R.id.mapView);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO mMap$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<BaiduMap>() { // from class: com.sma.smartv3.ui.me.DeveloperShowRealtimeMapAndLocationActivity$mMap$2
        {
            super(0);
        }
        ...
        public final BaiduMap invoke() {
            ...
            mMapView = DeveloperShowRealtimeMapAndLocationActivity.this.getMMapView();
            return mMapView.getMap();
        }
    });

    @OXOo.OOXIXo
    private final List<String> mLocationInfoList = new ArrayList();

    @OXOo.OOXIXo
    private final List<LatLng> mLatLngList = new ArrayList();

    @OXOo.OOXIXo
    private final SimpleDateFormat format = new SimpleDateFormat("yyyyMMdd_HHmmss", Locale.getDefault());

    @OXOo.OOXIXo
    private String mPower = String.valueOf(com.sma.smartv3.util.Xo0.f24349oIX0oI.II0xO0().getInt(com.sma.smartv3.util.XoI0Ixx0.f24396Oo));
    ...
    public static final class II0xO0 implements BleHandleCallback {
        ...
        public void onReadPower(int i) {
            com.sma.smartv3.util.Xo0.f24349oIX0oI.II0xO0().put(com.sma.smartv3.util.XoI0Ixx0.f24396Oo, i);
            DeveloperShowRealtimeMapAndLocationActivity.this.mPower = String.valueOf(i);
        }
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onReceiveLocationGga(@OXOo.OOXIXo BleLocationGga locationGga) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(locationGga, "locationGga");
            String str = DeveloperShowRealtimeMapAndLocationActivity.this.getFormat().format(new Date()) + ',' + DeveloperShowRealtimeMapAndLocationActivity.this.mPower + ",,,,,,,,," + locationGga.getMLatitude() + ',' + locationGga.getMLongitude() + '\n';
            DeveloperShowRealtimeMapAndLocationActivity.this.mLocationInfoList.add(str);
            File file = DeveloperShowRealtimeMapAndLocationActivity.this.mGpsInfo;
            if (file != null) {
                FilesKt__FileReadWriteKt.xxIXOIIO(file, str, null, 2, null);
            }
            DeveloperShowRealtimeMapAndLocationActivity.this.getMListAdapter().notifyDataSetChanged();
            LatLng latLng = new LatLng(locationGga.getMLatitude(), locationGga.getMLongitude());
            List list = DeveloperShowRealtimeMapAndLocationActivity.this.mLatLngList;
            LatLng convert = DeveloperShowRealtimeMapAndLocationActivity.COORDINATE_CONVERTER.coord(latLng).convert();
            kotlin.jvm.internal.IIX0o.oO(convert, "convert(...)");
            list.add(convert);
            if (DeveloperShowRealtimeMapAndLocationActivity.this.mLatLngList.size() == 1) {
                DeveloperShowRealtimeMapAndLocationActivity.this.getMMap().setMapStatus(MapStatusUpdateFactory.newLatLng((LatLng) CollectionsKt___CollectionsKt.O0OOX0IIx(DeveloperShowRealtimeMapAndLocationActivity.this.mLatLngList)));
                DeveloperShowRealtimeMapAndLocationActivity.this.getMMap().setMapStatus(MapStatusUpdateFactory.zoomTo(20.0f));
            } else {
                PolylineOptions points = new PolylineOptions().width(16).color(ContextCompat.getColor(DeveloperShowRealtimeMapAndLocationActivity.this.getMContext(), R.color.colorAccent)).points(CollectionsKt___CollectionsKt.oxXIOXO(DeveloperShowRealtimeMapAndLocationActivity.this.mLatLngList, 2));
                kotlin.jvm.internal.IIX0o.oO(points, "points(...)");
                DeveloperShowRealtimeMapAndLocationActivity.this.getMMap().addOverlay(points);
            }
            TextOptions position = new TextOptions().text(String.valueOf(DeveloperShowRealtimeMapAndLocationActivity.this.mLatLngList.size())).bgColor(ViewCompat.MEASURED_STATE_MASK).fontSize(32).fontColor(-1).position((LatLng) CollectionsKt___CollectionsKt.O0O0Io00X(DeveloperShowRealtimeMapAndLocationActivity.this.mLatLngList));
            kotlin.jvm.internal.IIX0o.oO(position, "position(...)");
            DeveloperShowRealtimeMapAndLocationActivity.this.getMMap().addOverlay(position);
        }

        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onReceiveLocationGsv(@OXOo.OOXIXo List<BleLocationGsv> locationGsv) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(locationGsv, "locationGsv");
            String str = DeveloperShowRealtimeMapAndLocationActivity.this.getFormat().format(new Date()) + ',' + DeveloperShowRealtimeMapAndLocationActivity.this.mPower;
            for (int i = 0; i < locationGsv.size(); i++) {
                str = str + ',' + locationGsv.get(i).getSnr();
                if (i == locationGsv.size() - 1 || i == 7) {
                    str = str + " \n";
                    break;
                }
            }
    ...
    public void init(@OXOo.oOoXoXO Bundle bundle) {
        ...
        File II0xO02 = com.sma.smartv3.initializer.IXxxXO.II0xO0(X00IoxXI.oIX0oI.f3233oIX0oI, "GPS_INFO_" + this.format.format(new Date()) + ".csv");
        this.mGpsInfo = II0xO02;
        if (II0xO02 != null) {
            FilesKt__FileReadWriteKt.xxIXOIIO(II0xO02, "Time,Power(%),snr1,snr2,snr3,snr4,snr5,snr6,snr7,snr8,mLatitude,mLongitude\n", null, 2, null);
        }
    }
    ...
    public int itemLayoutId() {
        return R.layout.list_small_item_1;
    }

    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_developer_show_realtime_map_and_location;
    }
    ...
    public void initItem(@OXOo.OOXIXo XIOOI.I0Io holder, @OXOo.OOXIXo String item, int i) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(holder, "holder");
        kotlin.jvm.internal.IIX0o.x0xO0oo(item, "item");
        holder.o00(android.R.id.text1, (i + 1) + ". " + item);
    }
}
