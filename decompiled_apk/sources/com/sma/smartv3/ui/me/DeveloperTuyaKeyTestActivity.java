...
import com.sma.smartv3.ui.me.DeveloperTuyaKeyTestActivity$mBleHandleCallback$2;
...
public final class DeveloperTuyaKeyTestActivity extends BaseActivity {

    @OXOo.OOXIXo
    private final kotlin.X0IIOO mEtContent$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<EditText>() { // from class: com.sma.smartv3.ui.me.DeveloperTuyaKeyTestActivity$mEtContent$2
        {
            super(0);
        }
        ...
        public final EditText invoke() {
            return (EditText) DeveloperTuyaKeyTestActivity.this.findViewById(R.id.et_content);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO mBleHandleCallback$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<DeveloperTuyaKeyTestActivity$mBleHandleCallback$2.oIX0oI>() { // from class: com.sma.smartv3.ui.me.DeveloperTuyaKeyTestActivity$mBleHandleCallback$2

        /* loaded from: classes11.dex */
        public static final class oIX0oI implements BleHandleCallback {

            /* renamed from: XO, reason: collision with root package name */
            public final /* synthetic */ DeveloperTuyaKeyTestActivity f23241XO;

            public oIX0oI(DeveloperTuyaKeyTestActivity developerTuyaKeyTestActivity) {
                this.f23241XO = developerTuyaKeyTestActivity;
            }
            ...
            @Override // com.szabh.smable3.component.BleHandleCallback
            public void onReadTuyaKey(@OXOo.OOXIXo BleTuyaKey tuyaKey) {
                EditText mEtContent;
                kotlin.jvm.internal.IIX0o.x0xO0oo(tuyaKey, "tuyaKey");
                mEtContent = this.f23241XO.getMEtContent();
                mEtContent.setText(tuyaKey.getMUuid() + tuyaKey.getMKey() + tuyaKey.getMMac());
            }
        ...
        public final oIX0oI invoke() {
            return new oIX0oI(DeveloperTuyaKeyTestActivity.this);
        }
    });

    private final DeveloperTuyaKeyTestActivity$mBleHandleCallback$2.oIX0oI getMBleHandleCallback() {
        return (DeveloperTuyaKeyTestActivity$mBleHandleCallback$2.oIX0oI) this.mBleHandleCallback$delegate.getValue();
    }
    ...
    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_developer_tuya_key_test;
    }
    ...
    public final void onRead(@OXOo.OOXIXo View v) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(v, "v");
        BleConnector.sendData$default(BleConnector.INSTANCE, BleKey.TUYA_KEY_SET, BleKeyFlag.READ, null, false, false, 28, null);
    }

    public final void onSend(@OXOo.OOXIXo View v) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(v, "v");
        String obj = getMEtContent().getText().toString();
        if (obj.length() == 60) {
            BleConnector bleConnector = BleConnector.INSTANCE;
            BleKey bleKey = BleKey.TUYA_KEY_SET;
            ...
            String substring2 = obj.substring(16, 48);
            kotlin.jvm.internal.IIX0o.oO(substring2, "substring(...)");
            String substring3 = obj.substring(48, 60);
            kotlin.jvm.internal.IIX0o.oO(substring3, "substring(...)");
            BleConnector.sendObject$default(bleConnector, bleKey, bleKeyFlag, new BleTuyaKey(0, substring, substring2, substring3, 1, null), false, false, 24, null);
            return;
        }
        ToastUtils.showLong("length:" + obj.length(), new Object[0]);
    }
}
