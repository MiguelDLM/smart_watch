...
import com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity;
...
@kotlin.jvm.internal.XX({"SMAP\nDeveloperBleAddressSetStartActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperBleAddressSetStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperBleAddressSetStartActivity\n+ 2 NetWorkUtils.kt\ncom/sma/smartv3/network/NetWorkUtils\n+ 3 NetWork.kt\ncom/sma/androidnetworklib/method/NetWork\n*L\n1#1,382:1\n151#2,11:383\n171#2:402\n208#3,7:394\n226#3:401\n*S KotlinDebug\n*F\n+ 1 DeveloperBleAddressSetStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperBleAddressSetStartActivity\n*L\n180#1:383,11\n180#1:402\n180#1:394,7\n180#1:401\n*E\n"})
/* loaded from: classes11.dex */
public final class DeveloperBleAddressSetStartActivity extends BaseListFunctionActivity<BleDevice> {
    ...
    @OXOo.OOXIXo
    private final String TAG = "AddressSet";

    @OXOo.OOXIXo
    private final kotlin.X0IIOO etOldBleName$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<EditText>() { // from class: com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity$etOldBleName$2
        {
            super(0);
        }
        ...
        public final EditText invoke() {
            return (EditText) DeveloperBleAddressSetStartActivity.this.findViewById(R.id.et_old_ble_name);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO btStartSet$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AppCompatButton>() { // from class: com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity$btStartSet$2
        {
            super(0);
        }
        ...
        public final AppCompatButton invoke() {
            return (AppCompatButton) DeveloperBleAddressSetStartActivity.this.findViewById(R.id.bt_start_set);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO btStopSet$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AppCompatButton>() { // from class: com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity$btStopSet$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final AppCompatButton invoke() {
            return (AppCompatButton) DeveloperBleAddressSetStartActivity.this.findViewById(R.id.bt_stop_set);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO etSignal$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<EditText>() { // from class: com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity$etSignal$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final EditText invoke() {
            return (EditText) DeveloperBleAddressSetStartActivity.this.findViewById(R.id.et_signal);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvSearchNumber$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity$tvSearchNumber$2
        {
            super(0);
        }
        ...
        public final TextView invoke() {
            return (TextView) DeveloperBleAddressSetStartActivity.this.findViewById(R.id.tv_search_number);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO cbAlipay$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<CheckBox>() { // from class: com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity$cbAlipay$2
        {
            super(0);
        }
        ...
        public final CheckBox invoke() {
            return (CheckBox) DeveloperBleAddressSetStartActivity.this.findViewById(R.id.cb_alipay);
        }
    });
    ...
    @OXOo.OOXIXo
    private final kotlin.X0IIOO mScanner$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<XOxIOxOx.II0xO0>() { // from class: com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity$mScanner$2

        @kotlin.jvm.internal.XX({"SMAP\nDeveloperBleAddressSetStartActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperBleAddressSetStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperBleAddressSetStartActivity$mScanner$2$2\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,382:1\n1002#2,2:383\n*S KotlinDebug\n*F\n+ 1 DeveloperBleAddressSetStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperBleAddressSetStartActivity$mScanner$2$2\n*L\n126#1:383,2\n*E\n"})
        /* loaded from: classes11.dex */
        public static final class II0xO0 implements XOxIOxOx.oxoX {

            /* renamed from: oIX0oI, reason: collision with root package name */
            public final /* synthetic */ DeveloperBleAddressSetStartActivity f23156oIX0oI;

            @kotlin.jvm.internal.XX({"SMAP\nComparisons.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Comparisons.kt\nkotlin/comparisons/ComparisonsKt__ComparisonsKt$compareBy$2\n+ 2 DeveloperBleAddressSetStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperBleAddressSetStartActivity$mScanner$2$2\n*L\n1#1,328:1\n126#2:329\n*E\n"})
            /* loaded from: classes11.dex */
            ...
            public II0xO0(DeveloperBleAddressSetStartActivity developerBleAddressSetStartActivity) {
                this.f23156oIX0oI = developerBleAddressSetStartActivity;
            }
            ...
            public void II0xO0(@OXOo.OOXIXo BleDevice device) {
                ...
                mList = this.f23156oIX0oI.getMList();
                if (!mList.contains(device)) {
                    mList2 = this.f23156oIX0oI.getMList();
                    mList2.add(device);
                    mList3 = this.f23156oIX0oI.getMList();
                    if (mList3.size() > 1) {
                        kotlin.collections.o00.OO0x0xX(mList3, new oIX0oI());
                    }
                    tvSearchNumber = this.f23156oIX0oI.getTvSearchNumber();
                    DeveloperBleAddressSetStartActivity developerBleAddressSetStartActivity = this.f23156oIX0oI;
                    mList4 = developerBleAddressSetStartActivity.getMList();
                    tvSearchNumber.setText(developerBleAddressSetStartActivity.getString(R.string.device_found, Integer.valueOf(mList4.size())));
                    mListAdapter = this.f23156oIX0oI.getMListAdapter();
            ...
            public void oIX0oI(boolean z) {
                ...
                if (z) {
                    btStartSet3 = this.f23156oIX0oI.getBtStartSet();
                    btStartSet3.setVisibility(8);
                    return;
                }
                z2 = this.f23156oIX0oI.isAutoSet;
                if (z2) {
                    btStartSet2 = this.f23156oIX0oI.getBtStartSet();
                    btStartSet2.setVisibility(8);
                    mList = this.f23156oIX0oI.getMList();
                    if (mList.isEmpty()) {
                        Handler handler = new Handler();
                        final DeveloperBleAddressSetStartActivity developerBleAddressSetStartActivity = this.f23156oIX0oI;
                        handler.postDelayed(
                        /*  JADX ERROR: Method code generation error
                            jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0039: INVOKE 
                              (r5v11 'handler' android.os.Handler)
                              (wrap:java.lang.Runnable:0x0034: CONSTRUCTOR (r0v3 'developerBleAddressSetStartActivity' com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity A[DONT_INLINE]) A[MD:(com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity):void (m), WRAPPED] (LINE:53) call: com.sma.smartv3.ui.me.oOXoIIIo.<init>(com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity):void type: CONSTRUCTOR)
                              (wrap:long:SGET  A[WRAPPED] com.google.android.exoplayer2.ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS long)
                             VIRTUAL call: android.os.Handler.postDelayed(java.lang.Runnable, long):boolean A[MD:(java.lang.Runnable, long):boolean (c)] (LINE:58) in method: com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity$mScanner$2.II0xO0.oIX0oI(boolean):void, file: classes11.dex
                            ...
                            Caused by: jadx.core.utils.exceptions.JadxRuntimeException: Expected class to be processed at this point, class: com.sma.smartv3.ui.me.oOXoIIIo, state: NOT_LOADED
                        ...
                        /*
                            ...
                            r0 = 8
                            if (r5 == 0) goto Le
                            com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity r5 = r4.f23156oIX0oI
                            androidx.appcompat.widget.AppCompatButton r5 = com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity.access$getBtStartSet(r5)
                            r5.setVisibility(r0)
                            goto L56
                        Le:
                            com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity r5 = r4.f23156oIX0oI
                            boolean r5 = com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity.access$isAutoSet$p(r5)
                            if (r5 == 0) goto L4c
                            com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity r5 = r4.f23156oIX0oI
                            androidx.appcompat.widget.AppCompatButton r5 = com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity.access$getBtStartSet(r5)
                            r5.setVisibility(r0)
                            com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity r5 = r4.f23156oIX0oI
                            java.util.List r5 = com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity.access$getMList(r5)
                            boolean r5 = r5.isEmpty()
                            if (r5 == 0) goto L3d
                            android.os.Handler r5 = new android.os.Handler
                            r5.<init>()
                            com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity r0 = r4.f23156oIX0oI
                            com.sma.smartv3.ui.me.oOXoIIIo r1 = new com.sma.smartv3.ui.me.oOXoIIIo
                            r1.<init>(r0)
                        ...
                        L3d:
                            com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity r5 = r4.f23156oIX0oI
                            android.widget.EditText r0 = com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity.access$getEtOldBleName(r5)
                        ...
                        L56:
                            return
                        */
                        throw new UnsupportedOperationException("Method not decompiled: com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity$mScanner$2.II0xO0.oIX0oI(boolean):void");
                    }
                }

                @kotlin.jvm.internal.XX({"SMAP\nDeveloperBleAddressSetStartActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperBleAddressSetStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperBleAddressSetStartActivity$mScanner$2$1\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,382:1\n1#2:383\n*E\n"})
                /* loaded from: classes11.dex */
                public static final class oIX0oI implements XOxIOxOx.X0o0xo {

                    /* renamed from: oIX0oI, reason: collision with root package name */
                    public final /* synthetic */ DeveloperBleAddressSetStartActivity f23157oIX0oI;

                    public oIX0oI(DeveloperBleAddressSetStartActivity developerBleAddressSetStartActivity) {
                        this.f23157oIX0oI = developerBleAddressSetStartActivity;
                    }
                    ...
                    public boolean oIX0oI(@OXOo.OOXIXo BleDevice device) {
                        ...
                        if (string.length() == 0) {
                            ...
                            Object obj = this.f23157oIX0oI.mConnectedFailMap.get(this.f23157oIX0oI.deviceAddress);
                            if (obj == null) {
                                obj = 0;
                            }
                ...
                public final XOxIOxOx.II0xO0 invoke() {
                    return XOxIOxOx.oO.II0xO0(XOxIOxOx.oO.f3971oIX0oI, null, ScanMode.LOW_LATENCY, 1, null).Oo(10).IXxxXO(new oIX0oI(DeveloperBleAddressSetStartActivity.this)).ooOOo0oXI(new II0xO0(DeveloperBleAddressSetStartActivity.this));
                }
            });
            ...
            @kotlin.jvm.internal.XX({"SMAP\nDeveloperBleAddressSetStartActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperBleAddressSetStartActivity.kt\ncom/sma/smartv3/ui/me/DeveloperBleAddressSetStartActivity$mBleHandleCallback$1\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,382:1\n1#2:383\n*E\n"})
            /* loaded from: classes11.dex */
            public static final class oIX0oI implements BleHandleCallback {
                public oIX0oI() {
                }

                public static final void II0xO0(DeveloperBleAddressSetStartActivity this$0, BluetoothDevice device) {
                    kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
                    kotlin.jvm.internal.IIX0o.x0xO0oo(device, "$device");
                    ...
                    this$0.macOtaToolsFind(str, kotlin.text.OxI.IIOIX(address, ":", "", false, 4, null));
                }
                ...
                public void onDeviceConnected(@OXOo.OOXIXo final BluetoothDevice device) {
                    kotlin.jvm.internal.IIX0o.x0xO0oo(device, "device");
                    DeveloperBleAddressSetStartActivity.this.getBtStopSet().setVisibility(0);
                    OI0.oIX0oI.f1507oIX0oI.oIX0oI(DeveloperBleAddressSetStartActivity.this.TAG + " onDeviceConnected -> " + device);
                    Handler handler = new Handler();
                    final DeveloperBleAddressSetStartActivity developerBleAddressSetStartActivity = DeveloperBleAddressSetStartActivity.this;
                    handler.postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.IoOoX
                        @Override // java.lang.Runnable
                        public final void run() {
                            DeveloperBleAddressSetStartActivity.oIX0oI.II0xO0(DeveloperBleAddressSetStartActivity.this, device);
                        }
                    }, 3000L);
                }
                ...
                public void onSessionStateChange(boolean z) {
                    if (!z) {
                        try {
                            HashMap hashMap = DeveloperBleAddressSetStartActivity.this.mConnectedFailMap;
                            String str = DeveloperBleAddressSetStartActivity.this.deviceAddress;
                            Object obj = DeveloperBleAddressSetStartActivity.this.mConnectedFailMap.get(DeveloperBleAddressSetStartActivity.this.deviceAddress);
                            if (obj == null) {
                                obj = 0;
                            }
            ...
            private final void dismissLoadPopup() {
                runOnUiThread(new Runnable() { // from class: com.sma.smartv3.ui.me.xI
                    @Override // java.lang.Runnable
                    public final void run() {
                        DeveloperBleAddressSetStartActivity.dismissLoadPopup$lambda$2(DeveloperBleAddressSetStartActivity.this);
                    }
                });
            }

            /* JADX INFO: Access modifiers changed from: private */
            public static final void dismissLoadPopup$lambda$2(DeveloperBleAddressSetStartActivity this$0) {
                kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
            ...
            public final CheckBox getCbAlipay() {
                return (CheckBox) this.cbAlipay$delegate.getValue();
            }
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public static final void initView$lambda$1(DeveloperBleAddressSetStartActivity this$0, AdapterView adapterView, View view, int i, long j) {
                kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public final void macOtaToolsFind(String str, String str2) {
                NetWorkUtils netWorkUtils = NetWorkUtils.INSTANCE;
                HashMap hashMap = new HashMap();
                hashMap.put(o0Oo.f23548I0Io, DeviceUtils.getUniqueDeviceId());
                hashMap.put("bleName", str);
                hashMap.put("macAddress", str2);
                hashMap.put("flag", "1");
                hashMap.put("state", "0");
                final DeveloperBleAddressSetStartActivity$macOtaToolsFind$2 developerBleAddressSetStartActivity$macOtaToolsFind$2 = new DeveloperBleAddressSetStartActivity$macOtaToolsFind$2(this, str2);
                final Activity activity = null;
                final com.sma.smartv3.pop.I0X0x0oIo loadPopup = netWorkUtils.loadPopup(null, null);
                String convertBaseUrl = netWorkUtils.convertBaseUrl(Api.INSTANCE.getBASE_URL(), o0Oo.f23549II0xO0);
                netWorkUtils.printParam(convertBaseUrl + o0Oo.f23549II0xO0, hashMap);
                NetWork netWork = NetWork.f19682oIX0oI;
                String str3 = convertBaseUrl + o0Oo.f23549II0xO0;
                final xxxI.II0xO0<Response<XxXX>> iI0xO0 = new xxxI.II0xO0<Response<XxXX>>() { // from class: com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity$macOtaToolsFind$$inlined$post$default$1
                    @Override // xxxI.II0xO0
                    public void handleError(@OXOo.OOXIXo String error) {
                        kotlin.jvm.internal.IIX0o.x0xO0oo(error, "error");
                        NetWorkUtils.INSTANCE.errorData(error, developerBleAddressSetStartActivity$macOtaToolsFind$2, loadPopup);
                    }

                    @Override // xxxI.II0xO0
                    /* renamed from: oIX0oI, reason: merged with bridge method [inline-methods] */
                    public void handleResponse(@OXOo.oOoXoXO Response<XxXX> response) {
                        NetWorkUtils netWorkUtils2 = NetWorkUtils.INSTANCE;
                        Activity activity2 = activity;
                        xxxI.II0xO0 iI0xO02 = developerBleAddressSetStartActivity$macOtaToolsFind$2;
                ...
                AndroidNetworking.post(str3).addBodyParameter((Map<String, String>) hashMap).setTag((Object) str3).setPriority(Priority.HIGH).build().getAsParsed(TypeToken.getParameterized(Response.class, XxXX.class), new ParsedRequestListener<Response<XxXX>>() { // from class: com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity$macOtaToolsFind$$inlined$post$default$2
                    @Override // com.androidnetworking.interfaces.ParsedRequestListener
                    /* renamed from: oIX0oI, reason: merged with bridge method [inline-methods] */
                    public void onResponse(@OXOo.OOXIXo Response<XxXX> response) {
            ...
            private final void permissionBackgroundLocationRemind() {
                if (getMPermissionBackgroundPopup() == null) {
                    ...
                    xoI0Ixx0.x0o(R.string.settings, new Oox.oIX0oI<Boolean>() { // from class: com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity$permissionBackgroundLocationRemind$1$1
                        {
                            super(0);
                        }
                        ...
                        public final Boolean invoke() {
                            Activity mContext;
                            mContext = DeveloperBleAddressSetStartActivity.this.getMContext();
            ...
            public final void requestLocationPermission() {
                ...
                oOXoIIIo.X0o0xo.I0Io(permission, null, null, new Oox.oOoXoXO<PermissionStatus, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.me.DeveloperBleAddressSetStartActivity$requestLocationPermission$1

                    /* loaded from: classes11.dex */
                    public /* synthetic */ class oIX0oI {

                        /* renamed from: oIX0oI, reason: collision with root package name */
                        public static final /* synthetic */ int[] f23161oIX0oI;
                    ...
                    public final void invoke2(@OXOo.OOXIXo PermissionStatus it) {
                        ...
                        int i = oIX0oI.f23161oIX0oI[it.ordinal()];
                        if (i != 1) {
                            if (i == 2) {
                                DeveloperBleAddressSetStartActivity.this.requestLocationPermission();
                                return;
                            } else {
                                DeveloperBleAddressSetStartActivity.this.permissionRemind();
                                return;
                            }
                        }
                        DeveloperBleAddressSetStartActivity developerBleAddressSetStartActivity = DeveloperBleAddressSetStartActivity.this;
                        etOldBleName = developerBleAddressSetStartActivity.getEtOldBleName();
                        kotlin.jvm.internal.IIX0o.oO(etOldBleName, "access$getEtOldBleName(...)");
                        developerBleAddressSetStartActivity.startSearch(etOldBleName);
                    }
                }, 3, null);
            }
            ...
            public void initView() {
                ...
                getMListView().setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: com.sma.smartv3.ui.me.oo0xXOI0I
                    @Override // android.widget.AdapterView.OnItemClickListener
                    public final void onItemClick(AdapterView adapterView, View view, int i, long j) {
                        DeveloperBleAddressSetStartActivity.initView$lambda$1(DeveloperBleAddressSetStartActivity.this, adapterView, view, i, j);
                    }
                });
            }
            ...
            @Override // com.bestmafen.androidbase.base.oIX0oI
            public int layoutId() {
                return R.layout.activity_developer_test_ble_address_set_start;
            }
