...
import com.sma.smartv3.ui.device.AddDeviceActivity;
...
@kotlin.jvm.internal.XX({"SMAP\nDeveloperBacCalibrationSearchActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperBacCalibrationSearchActivity.kt\ncom/sma/smartv3/ui/me/DeveloperBacCalibrationSearchActivity\n+ 2 Activity.kt\ncom/bestmafen/androidbase/extension/ActivityKt\n+ 3 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,185:1\n69#2,3:186\n72#2,5:190\n140#2,5:195\n145#2,5:201\n87#2,7:206\n94#2,3:214\n70#2,7:217\n97#2:224\n1#3:189\n1#3:200\n1#3:213\n*S KotlinDebug\n*F\n+ 1 DeveloperBacCalibrationSearchActivity.kt\ncom/sma/smartv3/ui/me/DeveloperBacCalibrationSearchActivity\n*L\n99#1:186,3\n99#1:190,5\n124#1:195,5\n124#1:201,5\n135#1:206,7\n135#1:214,3\n135#1:217,7\n135#1:224\n99#1:189\n124#1:200\n135#1:213\n*E\n"})
/* loaded from: classes11.dex */
public final class DeveloperBacCalibrationSearchActivity extends BaseActivity {
    ...
    @OXOo.OOXIXo
    private final kotlin.X0IIOO rootView$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<RelativeLayout>() { // from class: com.sma.smartv3.ui.me.DeveloperBacCalibrationSearchActivity$rootView$2
        {
            super(0);
        }
        ...
        public final RelativeLayout invoke() {
            return (RelativeLayout) DeveloperBacCalibrationSearchActivity.this.findViewById(R.id.root_view);
        }
    });
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public void onIdentityCreate(boolean z, @OXOo.oOoXoXO BleDeviceInfo bleDeviceInfo) {
            if (DeveloperBacCalibrationSearchActivity.this.isScanQrcode()) {
                if (z) {
                    com.sma.smartv3.ble.II0xO0.f20317oIX0oI.XIxXXX0x0();
                    return;
                }
                DeveloperBacCalibrationSearchActivity.this.setScanQrcode(false);
                com.sma.smartv3.pop.x0xO x0xo = DeveloperBacCalibrationSearchActivity.this.mConfirmPopup;
                if (x0xo != null) {
                    x0xo.dismiss();
                }
        ...
        public void onReadFirmwareVersion(@OXOo.OOXIXo String version) {
            ...
            if (DeveloperBacCalibrationSearchActivity.this.isScanQrcode()) {
                ...
                DeveloperBacCalibrationSearchActivity.this.onCodePairChange(new Object());
            }
        }
        ...
        public void onSessionStateChange(boolean z) {
            if (DeveloperBacCalibrationSearchActivity.this.isScanQrcode() && !z) {
                DeveloperBacCalibrationSearchActivity.this.setScanQrcode(false);
                com.sma.smartv3.pop.x0xO x0xo = DeveloperBacCalibrationSearchActivity.this.mConfirmPopup;
                if (x0xo != null) {
                    x0xo.dismiss();
    ...
    private final void conntectDevice(String str, String str2) {
        ...
        x0xo.xXxxox0I(new Oox.oIX0oI<kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.me.DeveloperBacCalibrationSearchActivity$conntectDevice$1$1

            @kotlin.jvm.internal.XX({"SMAP\nTimer.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Timer.kt\nkotlin/concurrent/TimersKt$timerTask$1\n+ 2 DeveloperBacCalibrationSearchActivity.kt\ncom/sma/smartv3/ui/me/DeveloperBacCalibrationSearchActivity$conntectDevice$1$1\n*L\n1#1,148:1\n145#2,2:149\n*E\n"})
            /* loaded from: classes11.dex */
    ...
    public static final void onActivityResult$lambda$1(DeveloperBacCalibrationSearchActivity this$0) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        this$0.updatePairState(false);
    }

    private final void toAddDevice(String str, String str2) {
        if (TextUtils.isEmpty(str) && TextUtils.isEmpty(str2)) {
            ...
            conntectDevice(str, str2);
        }
    }

    public static /* synthetic */ void updatePairState$default(DeveloperBacCalibrationSearchActivity developerBacCalibrationSearchActivity, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
            z = true;
        }
        developerBacCalibrationSearchActivity.updatePairState(z);
    }
    ...
    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_developer_test_bac_calibration_search;
    }
    ...
    public void onActivityResult(int i, int i2, @OXOo.oOoXoXO Intent intent) {
        ...
        if (i2 == -1) {
            if (i != 1) {
                if (i == 2 || i == 3) {
                    new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.ooXIXxIX
                        @Override // java.lang.Runnable
                        public final void run() {
                            DeveloperBacCalibrationSearchActivity.onActivityResult$lambda$1(DeveloperBacCalibrationSearchActivity.this);
                        }
                    }, 200L);
                    return;
                }
    ...
    public final void onCodePairChange(@OXOo.OOXIXo Object data) {
        ...
        LogUtils.d("onCodePairChange isScanQrcode=" + this.isScanQrcode);
        this.isScanQrcode = false;
        RequestCommonMethod.INSTANCE.updateDeviceInfo(new xxxI.II0xO0<String>() { // from class: com.sma.smartv3.ui.me.DeveloperBacCalibrationSearchActivity$onCodePairChange$1
        ...
        startActivity(new Intent(this, (Class<?>) DeveloperBacCalibrationActivity.class));
    }
    ...
    public final void updatePairState(boolean z) {
        LogUtils.d("updatePairState " + z);
        if (z) {
            com.sma.smartv3.util.x0xO0oo.II0xO0(com.sma.smartv3.util.x0xO0oo.f24572IO, null, 2, null);
        }
    }
}
