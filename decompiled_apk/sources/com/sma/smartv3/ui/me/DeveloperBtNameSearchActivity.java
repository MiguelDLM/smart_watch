...
@kotlin.jvm.internal.XX({"SMAP\nDeveloperBtNameSearchActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperBtNameSearchActivity.kt\ncom/sma/smartv3/ui/me/DeveloperBtNameSearchActivity\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n*L\n1#1,402:1\n19#2:403\n15#2:404\n*S KotlinDebug\n*F\n+ 1 DeveloperBtNameSearchActivity.kt\ncom/sma/smartv3/ui/me/DeveloperBtNameSearchActivity\n*L\n190#1:403\n190#1:404\n*E\n"})
/* loaded from: classes11.dex */
public final class DeveloperBtNameSearchActivity extends BaseListFunctionActivity<BleDevice> {

    @OXOo.OOXIXo
    private final kotlin.X0IIOO etOldBleName$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<EditText>() { // from class: com.sma.smartv3.ui.me.DeveloperBtNameSearchActivity$etOldBleName$2
        {
            super(0);
        }
        ...
        public final EditText invoke() {
            return (EditText) DeveloperBtNameSearchActivity.this.findViewById(R.id.et_old_ble_name);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO btStartBtName$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<AppCompatButton>() { // from class: com.sma.smartv3.ui.me.DeveloperBtNameSearchActivity$btStartBtName$2
        {
            super(0);
        }
        ...
        public final AppCompatButton invoke() {
            return (AppCompatButton) DeveloperBtNameSearchActivity.this.findViewById(R.id.bt_start_bt_name);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO etSignal$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<EditText>() { // from class: com.sma.smartv3.ui.me.DeveloperBtNameSearchActivity$etSignal$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final EditText invoke() {
            return (EditText) DeveloperBtNameSearchActivity.this.findViewById(R.id.et_signal);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvSearchNumber$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.me.DeveloperBtNameSearchActivity$tvSearchNumber$2
        {
            super(0);
        }
        ...
        public final TextView invoke() {
            return (TextView) DeveloperBtNameSearchActivity.this.findViewById(R.id.tv_search_number);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvAlreadyBtName$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.me.DeveloperBtNameSearchActivity$tvAlreadyBtName$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final TextView invoke() {
            return (TextView) DeveloperBtNameSearchActivity.this.findViewById(R.id.tv_already_bt_name);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO mScanner$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<XOxIOxOx.II0xO0>() { // from class: com.sma.smartv3.ui.me.DeveloperBtNameSearchActivity$mScanner$2

        @kotlin.jvm.internal.XX({"SMAP\nDeveloperBtNameSearchActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperBtNameSearchActivity.kt\ncom/sma/smartv3/ui/me/DeveloperBtNameSearchActivity$mScanner$2$2\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,402:1\n1002#2,2:403\n*S KotlinDebug\n*F\n+ 1 DeveloperBtNameSearchActivity.kt\ncom/sma/smartv3/ui/me/DeveloperBtNameSearchActivity$mScanner$2$2\n*L\n113#1:403,2\n*E\n"})
        /* loaded from: classes11.dex */
        public static final class II0xO0 implements XOxIOxOx.oxoX {

            /* renamed from: oIX0oI, reason: collision with root package name */
            public final /* synthetic */ DeveloperBtNameSearchActivity f23162oIX0oI;

            @kotlin.jvm.internal.XX({"SMAP\nComparisons.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Comparisons.kt\nkotlin/comparisons/ComparisonsKt__ComparisonsKt$compareBy$2\n+ 2 DeveloperBtNameSearchActivity.kt\ncom/sma/smartv3/ui/me/DeveloperBtNameSearchActivity$mScanner$2$2\n*L\n1#1,328:1\n113#2:329\n*E\n"})
            /* loaded from: classes11.dex */
            ...
            public II0xO0(DeveloperBtNameSearchActivity developerBtNameSearchActivity) {
                this.f23162oIX0oI = developerBtNameSearchActivity;
            }
            ...
            public void II0xO0(@OXOo.OOXIXo BleDevice device) {
                ...
                List mList6;
                EditText etOldBleName3;
                kotlin.jvm.internal.IIX0o.x0xO0oo(device, "device");
                mList = this.f23162oIX0oI.getMList();
                if (!mList.contains(device)) {
                    etOldBleName = this.f23162oIX0oI.getEtOldBleName();
                    if (etOldBleName.getText().toString().length() != 0) {
                        String mName = device.getMName();
                        etOldBleName3 = this.f23162oIX0oI.getEtOldBleName();
                        if (!kotlin.jvm.internal.IIX0o.Oxx0IOOO(mName, StringsKt__StringsKt.oIoIXxIO(etOldBleName3.getText().toString()).toString())) {
                            return;
                        }
                    }
                    mList2 = this.f23162oIX0oI.getMList();
                    if (mList2.size() < 2000) {
                        mList5 = this.f23162oIX0oI.getMList();
                        mList5.add(device);
                        tvSearchNumber = this.f23162oIX0oI.getTvSearchNumber();
                        DeveloperBtNameSearchActivity developerBtNameSearchActivity = this.f23162oIX0oI;
                        mList6 = developerBtNameSearchActivity.getMList();
                        tvSearchNumber.setText(developerBtNameSearchActivity.getString(R.string.device_found, Integer.valueOf(mList6.size())));
                    }
                    etOldBleName2 = this.f23162oIX0oI.getEtOldBleName();
                    if (etOldBleName2.getText().toString().length() != 0) {
                        mList4 = this.f23162oIX0oI.getMList();
                        if (mList4.size() >= 100) {
                            return;
                        }
                    }
                    mList3 = this.f23162oIX0oI.getMList();
                    if (mList3.size() > 1) {
                        kotlin.collections.o00.OO0x0xX(mList3, new oIX0oI());
                    }
                    mListAdapter = this.f23162oIX0oI.getMListAdapter();
        ...
        public final XOxIOxOx.II0xO0 invoke() {
            return XOxIOxOx.oO.II0xO0(XOxIOxOx.oO.f3971oIX0oI, null, ScanMode.LOW_LATENCY, 1, null).Oo(30).IXxxXO(new oIX0oI()).ooOOo0oXI(new II0xO0(DeveloperBtNameSearchActivity.this));
        }
    });
    ...
    private final void createExcel(String str, String str2, String[] strArr, String str3) {
        try {
            oIXoXx0.X0IIOO oO2 = xIoXXXIXo.OxI.oO(new FileOutputStream(str + File.separator + str2));
            kotlin.jvm.internal.IIX0o.oO(oO2, "createWorkbook(...)");
            oIXoXx0.O0xOxO oO3 = oO2.oO(str3, 0);
            kotlin.jvm.internal.IIX0o.oO(oO3, "createSheet(...)");
            oIXoXx0.IIXOooo iIXOooo = new oIXoXx0.IIXOooo();
            iIXOooo.xX0IIXIx0(oI0X0.oIX0oI.f31458XO);
            iIXOooo.XIXIX(oI0X0.I0Io.f31366I0Io, oI0X0.oxoX.f31579X0o0xo, oI0X0.XO.f31413XO);
            int length = strArr.length;
            for (int i = 0; i < length; i++) {
                oO3.o00(new oIXoXx0.ooOOo0oXI(i, 0, strArr[i], setHeader()));
            }
            int size = getMList().size();
            int i2 = 0;
            while (i2 < size) {
                int i3 = i2 + 1;
                oO3.o00(new oIXoXx0.ooOOo0oXI(0, i3, getMList().get(i2).getMName(), iIXOooo));
                oO3.o00(new oIXoXx0.ooOOo0oXI(1, i3, kotlin.text.OxI.IIOIX(getMList().get(i2).getMAddress(), ":", "", false, 4, null), iIXOooo));
                oO3.o00(new oIXoXx0.ooOOo0oXI(2, i3, String.valueOf(getMList().get(i2).getMRssi()), iIXOooo));
                oO3.Xo0(0, getMList().get(i2).getMName().length() + 8);
                oO3.Xo0(1, getMList().get(i2).getMAddress().length() + 8);
                i2 = i3;
            }
            oO2.xXxxox0I();
            oO2.OOXIXo();
            ...
            intent.putExtra("android.intent.extra.STREAM", oix0oi.oxoX(oix0oi.oIX0oI(Location.EXTERNAL, X00IoxXI.II0xO0.f3231II0xO0.X0o0xo().II0xO0("share"), str2)));
            intent.setType("*/*");
            try {
    ...
    private final AppCompatButton getBtStartBtName() {
        return (AppCompatButton) this.btStartBtName$delegate.getValue();
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final TextView getTvAlreadyBtName() {
        return (TextView) this.tvAlreadyBtName$delegate.getValue();
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$0(DeveloperBtNameSearchActivity this$0, AdapterView adapterView, View view, int i, long j) {
        ...
        this$0.getBtStartBtName().setVisibility(0);
    }
    ...
    private final void permissionBackgroundLocationRemind() {
        if (getMPermissionBackgroundPopup() == null) {
            ...
            xoI0Ixx0.x0o(R.string.settings, new Oox.oIX0oI<Boolean>() { // from class: com.sma.smartv3.ui.me.DeveloperBtNameSearchActivity$permissionBackgroundLocationRemind$1$1
                {
                    super(0);
                }
                ...
                public final Boolean invoke() {
                    Activity mContext;
                    mContext = DeveloperBtNameSearchActivity.this.getMContext();
    ...
    public final void requestLocationPermission() {
        ...
        oOXoIIIo.X0o0xo.I0Io(permission, null, null, new Oox.oOoXoXO<PermissionStatus, kotlin.oXIO0o0XI>() { // from class: com.sma.smartv3.ui.me.DeveloperBtNameSearchActivity$requestLocationPermission$1

            /* loaded from: classes11.dex */
            public /* synthetic */ class oIX0oI {

                /* renamed from: oIX0oI, reason: collision with root package name */
                public static final /* synthetic */ int[] f23163oIX0oI;
            ...
            public final void invoke2(@OXOo.OOXIXo PermissionStatus it) {
                TextView tvAlreadyBtName;
                kotlin.jvm.internal.IIX0o.x0xO0oo(it, "it");
                int i = oIX0oI.f23163oIX0oI[it.ordinal()];
                if (i != 1) {
                    if (i == 2) {
                        DeveloperBtNameSearchActivity.this.requestLocationPermission();
                        return;
                    } else {
                        DeveloperBtNameSearchActivity.this.permissionRemind();
                        return;
                    }
                }
                DeveloperBtNameSearchActivity developerBtNameSearchActivity = DeveloperBtNameSearchActivity.this;
                tvAlreadyBtName = developerBtNameSearchActivity.getTvAlreadyBtName();
                kotlin.jvm.internal.IIX0o.oO(tvAlreadyBtName, "access$getTvAlreadyBtName(...)");
                developerBtNameSearchActivity.startSearch(tvAlreadyBtName);
            }
        }, 3, null);
    }
    ...
    public void initView() {
        super.initView();
        getBtStartBtName().setVisibility(8);
        getMListView().setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: com.sma.smartv3.ui.me.IO
            @Override // android.widget.AdapterView.OnItemClickListener
            public final void onItemClick(AdapterView adapterView, View view, int i, long j) {
                DeveloperBtNameSearchActivity.initView$lambda$0(DeveloperBtNameSearchActivity.this, adapterView, view, i, j);
            }
        });
        TextView tvAlreadyBtName = getTvAlreadyBtName();
        SPUtils XO2 = com.sma.smartv3.util.Xo0.f24349oIX0oI.XO();
        Object xo2 = new XO(null, 1, null);
        Object fromJson = new Gson().fromJson(XO2.getString(XO.class.getName()), (Class<Object>) XO.class);
        if (fromJson != null) {
            xo2 = fromJson;
        }
        tvAlreadyBtName.setText(String.valueOf(((XO) xo2).oxoX().size()));
    }
    ...
    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_developer_test_bt_name_search;
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        getMScanner().oOoXoXO(false);
    }

    @OXOo.oOoXoXO
    public final oIXoXx0.IIXOooo setHeader() {
        oIXoXx0.xoXoI xoxoi = new oIXoXx0.xoXoI(oIXoXx0.xoXoI.f31717OxxIIOOXO, 10, oIXoXx0.xoXoI.f31716OxI);
        try {
            xoxoi.O00XxXI(oI0X0.XO.f31413XO);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            iIXOooo.xX0IIXIx0(oI0X0.oIX0oI.f31458XO);
            iIXOooo.xOoOIoI(oI0X0.IXxxXO.f31379X0o0xo);
            iIXOooo.XIXIX(oI0X0.I0Io.f31366I0Io, oI0X0.oxoX.f31579X0o0xo, oI0X0.XO.f31413XO);
        } catch (Exception e2) {
            e2.printStackTrace();
        }
    ...
    public final void startBtNameLog(@OXOo.OOXIXo View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(view, "view");
        LogUtils.d("startTemperatureValue ");
        String obj = StringsKt__StringsKt.oIoIXxIO(getEtOldBleName().getText().toString()).toString();
        if (getMList() != null && getMList().size() != 0) {
            getMScanner().oOoXoXO(false);
            String absolutePath = com.sma.smartv3.initializer.IXxxXO.oX(X00IoxXI.oIX0oI.f3233oIX0oI).getAbsolutePath();
            kotlin.jvm.internal.IIX0o.oO(absolutePath, "getAbsolutePath(...)");
            createExcel(absolutePath, obj + System.currentTimeMillis() + ".xls", new String[]{"蓝牙名", "蓝牙地址", "信号值"}, "工作表1");
            return;
        }
    ...
    public final void startSearch(@OXOo.OOXIXo View view) {
        ...
        ToastUtils.showLong("搜索中...,请耐心等候搜索完毕", new Object[0]);
