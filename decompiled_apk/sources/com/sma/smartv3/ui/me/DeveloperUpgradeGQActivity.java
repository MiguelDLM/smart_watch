...
@kotlin.jvm.internal.XX({"SMAP\nDeveloperUpgradeGQActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperUpgradeGQActivity.kt\ncom/sma/smartv3/ui/me/DeveloperUpgradeGQActivity\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n*L\n1#1,229:1\n19#2:230\n15#2:231\n15#2:232\n11#2,2:233\n*S KotlinDebug\n*F\n+ 1 DeveloperUpgradeGQActivity.kt\ncom/sma/smartv3/ui/me/DeveloperUpgradeGQActivity\n*L\n38#1:230\n38#1:231\n79#1:232\n169#1:233,2\n*E\n"})
...
public final class DeveloperUpgradeGQActivity extends BaseFirmwareUpgradeActivity implements Observer<Object>, FastDfuProgressCallback {
    ...
    public static final class II0xO0 implements BleHandleCallback {
        ...
        public void onOTA(boolean z) {
            ...
            ProgressButton.X0o0xo(DeveloperUpgradeGQActivity.this.getProgressButton(), R.string.firmware_upgrading_failed, false, 2, null);
            LogUtils.d("发送指令后未进入OTA流程导致升级失败 Mac地址为： " + com.sma.smartv3.util.Xo0.f24349oIX0oI.II0xO0().getString(com.sma.smartv3.util.XoI0Ixx0.f24456oo));
        ...
        public void onSessionStateChange(boolean z) {
            if (!z && !DeveloperUpgradeGQActivity.this.getMStarted()) {
                DeveloperUpgradeGQActivity.this.upgrade();
            }
        }
    ...
    public /* synthetic */ class oIX0oI {
        ...
        public static final /* synthetic */ int[] f23263oIX0oI;
    ...
    public DeveloperUpgradeGQActivity() {
        ...
        this.mDevice$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<BluetoothDevice>() { // from class: com.sma.smartv3.ui.me.DeveloperUpgradeGQActivity$mDevice$2
            {
                super(0);
            }
            ...
            public final BluetoothDevice invoke() {
                if (DeveloperUpgradeGQActivity.this.getMArg0() != null && kotlin.jvm.internal.IIX0o.Oxx0IOOO(DeveloperUpgradeGQActivity.this.getMArg0(), "Goodix_Fast_DFU")) {
                ...
                String string = xo02.II0xO0().getString(com.sma.smartv3.util.XoI0Ixx0.f24456oo);
                kotlin.jvm.internal.IIX0o.ooOOo0oXI(string);
                if (kotlin.text.OxI.XO0o(string, "FF", false, 2, null)) {
                    ...
                    sb.append(substring);
                    sb.append("00");
                    return BluetoothAdapter.getDefaultAdapter().getRemoteDevice(sb.toString());
                }
                kotlin.jvm.internal.IIX0o.ooOOo0oXI(string);
                long parseLong = Long.parseLong(kotlin.text.OxI.IIOIX(string, ":", "", false, 4, null), kotlin.text.II0xO0.oIX0oI(16)) + 1;
                ...
                LogUtils.d("原始Mac地址为： " + xo02.II0xO0().getString(com.sma.smartv3.util.XoI0Ixx0.f24456oo) + "  最终升级的 Mac 地址为：" + CollectionsKt___CollectionsKt.OoIXo(StringsKt___StringsKt.X0OXI(format, 2), ":", null, null, 0, null, null, 62, null));
                return BluetoothAdapter.getDefaultAdapter().getRemoteDevice(CollectionsKt___CollectionsKt.OoIXo(StringsKt___StringsKt.X0OXI(format, 2), ":", null, null, 0, null, null, 62, null));
            }
        });
    ...
    public final void upgrade() {
        ...
        setMStarted(true);
        getProgressButton().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.me.X0xxXX0
            @Override // java.lang.Runnable
            public final void run() {
                DeveloperUpgradeGQActivity.upgrade$lambda$0(DeveloperUpgradeGQActivity.this);
            }
        }, 4000L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void upgrade$lambda$0(DeveloperUpgradeGQActivity this$0) {
    ...
    public final void onBottomClick(@OXOo.OOXIXo View view) {
        ...
        kotlin.jvm.internal.IIX0o.ooOOo0oXI(firmwareVersion);
        netWorkUtils.download(firmwareVersion.getFileUrl(), com.sma.smartv3.initializer.IXxxXO.ooOOo0oXI(X00IoxXI.oIX0oI.f3233oIX0oI), this.mLatest.getFileName(), new HttpProgressCallback<String>() { // from class: com.sma.smartv3.ui.me.DeveloperUpgradeGQActivity$onBottomClick$1
    ...
    public void onChanged(@OXOo.OOXIXo Object connState) {
        ...
        if (connState instanceof DfuConnection.ConnState) {
            int i = oIX0oI.f23263oIX0oI[((DfuConnection.ConnState) connState).ordinal()];
            if (i != 1) {
                if (i != 2) {
    ...
    public void onDfuErase(int i) {
        ProgressButton.X0o0xo(getProgressButton(), R.string.cache_cleaning, false, 2, null);
    }
    ...
    public void onDfuError(int i, @OXOo.oOoXoXO String str, @OXOo.oOoXoXO Error error) {
        setMStarted(false);
        ProgressButton.X0o0xo(getProgressButton(), R.string.firmware_upgrading_failed, false, 2, null);
        LogUtils.d("官方SDK内部升级失败 Mac地址为： " + com.sma.smartv3.util.Xo0.f24349oIX0oI.II0xO0().getString(com.sma.smartv3.util.XoI0Ixx0.f24456oo));
        finish();
    }
