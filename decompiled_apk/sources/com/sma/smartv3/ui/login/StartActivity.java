...
@XX({"SMAP\nStartActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 StartActivity.kt\ncom/sma/smartv3/ui/login/StartActivity\n+ 2 NetWorkUtils.kt\ncom/sma/smartv3/network/NetWorkUtils\n+ 3 NetWork.kt\ncom/sma/androidnetworklib/method/NetWork\n*L\n1#1,179:1\n158#2,4:180\n171#2:192\n208#3,7:184\n226#3:191\n*S KotlinDebug\n*F\n+ 1 StartActivity.kt\ncom/sma/smartv3/ui/login/StartActivity\n*L\n127#1:180,4\n127#1:192\n127#1:184,7\n127#1:191\n*E\n"})
/* loaded from: classes12.dex */
public final class StartActivity extends BaseActivity {

    @OXOo.OOXIXo
    private final X0IIOO rv$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<NestedScrollView>() { // from class: com.sma.smartv3.ui.login.StartActivity$rv$2
        {
            super(0);
        }
    ...
    @OXOo.OOXIXo
    private final X0IIOO weChatRl$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<RelativeLayout>() { // from class: com.sma.smartv3.ui.login.StartActivity$weChatRl$2
        {
            super(0);
        }
    ...
    @OXOo.OOXIXo
    private final X0IIOO QQRl$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<RelativeLayout>() { // from class: com.sma.smartv3.ui.login.StartActivity$QQRl$2
        {
            super(0);
        }
    ...
    @OXOo.OOXIXo
    private final X0IIOO weiBoRl$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<RelativeLayout>() { // from class: com.sma.smartv3.ui.login.StartActivity$weiBoRl$2
        {
            super(0);
        }
    ...
    @OXOo.OOXIXo
    private final X0IIOO faceBookRl$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<RelativeLayout>() { // from class: com.sma.smartv3.ui.login.StartActivity$faceBookRl$2
        {
            super(0);
        }
    ...
    @OXOo.OOXIXo
    private final X0IIOO twitterRl$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<RelativeLayout>() { // from class: com.sma.smartv3.ui.login.StartActivity$twitterRl$2
        {
            super(0);
        }
    ...
    @OXOo.OOXIXo
    private final X0IIOO googleRl$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<RelativeLayout>() { // from class: com.sma.smartv3.ui.login.StartActivity$googleRl$2
        {
            super(0);
        }
    ...
    public static final class oIX0oI implements O00.II0xO0 {
        ...
        public void II0xO0(@OXOo.oOoXoXO LoginResponse loginResponse) {
            if (loginResponse != null) {
                StartActivity.this.thirdPartyLogin(loginResponse);
            } else {
    ...
    public final void thirdPartyLogin(LoginResponse loginResponse) {
        ...
        HashMap<String, String> thirdPartyBody = RequestBodyKt.getThirdPartyBody(loginResponse.oxoX(), loginResponse.I0Io(), loginResponse.oIX0oI(), loginResponse.II0xO0());
        final xxxI.II0xO0<AppUser> iI0xO0 = new xxxI.II0xO0<AppUser>() { // from class: com.sma.smartv3.ui.login.StartActivity$thirdPartyLogin$1
            ...
            public void handleResponse(@OXOo.oOoXoXO AppUser appUser) {
                ...
                projectManager.x0oxIIIX(StartActivity.this);
        ...
        netWorkUtils.printParam(convertBaseUrl + ThirdPartyLogin.URL, thirdPartyBody);
        NetWork netWork = NetWork.f19682oIX0oI;
        String str = convertBaseUrl + ThirdPartyLogin.URL;
        final xxxI.II0xO0<Response<AppUser>> iI0xO02 = new xxxI.II0xO0<Response<AppUser>>() { // from class: com.sma.smartv3.ui.login.StartActivity$thirdPartyLogin$$inlined$post$1
            @Override // xxxI.II0xO0
            public void handleError(@OXOo.OOXIXo String error) {
                IIX0o.x0xO0oo(error, "error");
    ...
    public final void startVisitor(@OXOo.OOXIXo View View) {
        IIX0o.x0xO0oo(View, "View");
        Xo0.f24349oIX0oI.XO().put(XoI0Ixx0.f24363IO, false);
