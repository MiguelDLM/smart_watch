...
public abstract class BaseRecyclerRecordsFragment<T> extends BaseDetailsFragment<T> {
    ...
    public BaseRecyclerRecordsFragment() {
    ...
    public static final void initBaseLayout$lambda$3$lambda$2(BaseRecyclerRecordsFragment this$0) {
    ...
    public void initBaseLayout(int i, int i2) {
        ...
        if (recyclerView != null) {
            ...
            recyclerView.setLayoutManager(new LinearLayoutManager(context) { // from class: com.sma.smartv3.ui.status.base.BaseRecyclerRecordsFragment$initBaseLayout$1$1
        ...
        if (i2 != 0 && (swipeRefreshLayout = (SwipeRefreshLayout) getDslViewHolder().v(i2)) != null) {
            ...
            swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() { // from class: com.sma.smartv3.ui.status.base.oIX0oI
                @Override // androidx.swiperefreshlayout.widget.SwipeRefreshLayout.OnRefreshListener
                public final void onRefresh() {
                    BaseRecyclerRecordsFragment.initBaseLayout$lambda$3$lambda$2(BaseRecyclerRecordsFragment.this);
                }
            });
        }
    }
