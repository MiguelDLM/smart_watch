...
public final class BloodGlucoseDayFragment extends BaseDetailDaysFragment<BloodGlucose> {
    public LineDataSet setValue;

    @OXOo.OOXIXo
    private final X0IIOO lineChart$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<LineChart>() { // from class: com.sma.smartv3.ui.status.fragment.BloodGlucoseDayFragment$lineChart$2
        {
            super(0);
        }
        ...
        public final LineChart invoke() {
            View mView;
            mView = BloodGlucoseDayFragment.this.getMView();
            return (LineChart) mView.findViewById(R.id.lineChart);
        }
    });

    @OXOo.OOXIXo
    private final X0IIOO minValue$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<DINCondBold>() { // from class: com.sma.smartv3.ui.status.fragment.BloodGlucoseDayFragment$minValue$2
        {
            super(0);
        }
    ...
    @OXOo.OOXIXo
    private final X0IIOO maxValue$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<DINCondBold>() { // from class: com.sma.smartv3.ui.status.fragment.BloodGlucoseDayFragment$maxValue$2
        {
            super(0);
        }
    ...
    @OXOo.OOXIXo
    private final X0IIOO avValue$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<DINCondBold>() { // from class: com.sma.smartv3.ui.status.fragment.BloodGlucoseDayFragment$avValue$2
        {
            super(0);
        }
    ...
    public static final class oIX0oI implements ooOx.oIX0oI {
        ...
        public final /* synthetic */ SimpleDateFormat f24059II0xO0;

        public oIX0oI(SimpleDateFormat simpleDateFormat) {
            this.f24059II0xO0 = simpleDateFormat;
        }
        ...
        public void oIX0oI(@OXOo.OOXIXo Entry e, @OXOo.OOXIXo XI0oooXX.oxoX h) {
            IIX0o.x0xO0oo(e, "e");
            IIX0o.x0xO0oo(h, "h");
            BloodGlucoseDayFragment.this.updateItemData(e);
            int xxIXOIIO2 = (int) e.xxIXOIIO();
            int i = xxIXOIIO2 / 60;
            BloodGlucoseDayFragment.this.getMCalendar().set(11, i);
            BloodGlucoseDayFragment.this.getMCalendar().set(12, xxIXOIIO2 - (i * 60));
            BloodGlucoseDayFragment.this.getNowTimeDetails().setText(TimeUtils.millis2String(BloodGlucoseDayFragment.this.getMCalendar().getTimeInMillis(), this.f24059II0xO0));
        }
    }

    @SuppressLint({"DefaultLocale"})
    private final void filterData(List<BloodGlucose> list) {
        this.values.clear();
        BloodGlucoseDayData filterMinuteData = BloodGlucoseDataParse.INSTANCE.filterMinuteData(getRange(), list, this.values);
        getMinValue().setText(UtilsKt.xoIox(filterMinuteData.getMin()));
        getMaxValue().setText(UtilsKt.xoIox(filterMinuteData.getMax()));
        getAvValue().setText(UtilsKt.xoIox(filterMinuteData.getAvg()));
        getNowValue().setText(UtilsKt.xoIox(filterMinuteData.getAvg()));
    ...
    public int layoutId() {
        return R.layout.fragment_status_blood_glucose_day;
    }
    ...
    public List<BloodGlucose> onTimePeriodChange(@OXOo.OOXIXo Calendar calendar, int i, @OXOo.OOXIXo TimePeriod timePeriod) {
        ...
        return this.mBloodGlucoseDao.getListDesc(getRange()[0], getRange()[1]);
    }

    @OXOo.OOXIXo
    public final String setDataLabel() {
        return "BloodGlucose day Data";
    }
    ...
    public final void updateItemData(@OXOo.OOXIXo Entry e) {
        IIX0o.x0xO0oo(e, "e");
        getNowValue().setText(UtilsKt.II0XooXoX(e.I0Io()));
    }
}
