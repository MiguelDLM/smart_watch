...
public final class HrvWeekFragment extends BaseDetailsWeekFragment<Hrv> {
    public LineDataSet setValue;

    @OXOo.OOXIXo
    private final X0IIOO lineChart$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<LineChart>() { // from class: com.sma.smartv3.ui.status.fragment.HrvWeekFragment$lineChart$2
        {
            super(0);
        }
        ...
        public final LineChart invoke() {
            View mView;
            mView = HrvWeekFragment.this.getMView();
            return (LineChart) mView.findViewById(R.id.lineChart);
        }
    });

    @OXOo.OOXIXo
    private final X0IIOO minValue$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<DINCondBold>() { // from class: com.sma.smartv3.ui.status.fragment.HrvWeekFragment$minValue$2
        {
            super(0);
        }
    ...
    @OXOo.OOXIXo
    private final X0IIOO maxValue$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<DINCondBold>() { // from class: com.sma.smartv3.ui.status.fragment.HrvWeekFragment$maxValue$2
        {
            super(0);
        }
    ...
    @OXOo.OOXIXo
    private final LinkedHashMap<Long, ArrayList<Hrv>> weekData = new LinkedHashMap<>();
    ...
    public static final class oIX0oI implements ooOx.oIX0oI {
        ...
        public void oIX0oI(@OXOo.OOXIXo Entry e, @OXOo.OOXIXo XI0oooXX.oxoX h) {
            IIX0o.x0xO0oo(e, "e");
            IIX0o.x0xO0oo(h, "h");
            HrvWeekFragment.this.updateItemData(e);
            O00XxXI o00XxXI = HrvWeekFragment.this.getWeekDay().get((int) e.xxIXOIIO());
            List<String> o02 = com.sma.smartv3.util.xoIox.o0(o00XxXI.X0o0xo());
            HrvWeekFragment.this.getNowTimeDetails().setText(o02.get(0) + IOUtils.DIR_SEPARATOR_UNIX + o02.get(1) + TokenParser.SP + o00XxXI.XO());
        }
    }
    ...
    public final void filterData(@OXOo.OOXIXo List<Hrv> hrvs) {
        IIX0o.x0xO0oo(hrvs, "hrvs");
        this.values.clear();
        HRVDataParse.INSTANCE.filterDayData(getMActivity(), hrvs, this.weekData, this.hrvDayDataList, this.values);
