...
@XX({"SMAP\nStepWeekV2Fragment.kt\nKotlin\n*S Kotlin\n*F\n+ 1 StepWeekV2Fragment.kt\ncom/sma/smartv3/ui/status/fragment/v2/StepWeekV2Fragment\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n*L\n1#1,158:1\n19#2:159\n15#2:160\n*S KotlinDebug\n*F\n+ 1 StepWeekV2Fragment.kt\ncom/sma/smartv3/ui/status/fragment/v2/StepWeekV2Fragment\n*L\n34#1:159\n34#1:160\n*E\n"})
/* loaded from: classes12.dex */
public final class StepWeekV2Fragment extends StatusBaseWeekFragment<Activity> {
    ...
    @OOXIXo
    private final X0IIOO caloriesValue$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<DINCondBold>() { // from class: com.sma.smartv3.ui.status.fragment.v2.StepWeekV2Fragment$caloriesValue$2
        {
            super(0);
        }
        ...
        public final DINCondBold invoke() {
            View mView;
            mView = StepWeekV2Fragment.this.getMView();
            return (DINCondBold) mView.findViewById(R.id.step_v2_calories_value);
        }
    });

    @OOXIXo
    private final X0IIOO distanceValue$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<DINCondBold>() { // from class: com.sma.smartv3.ui.status.fragment.v2.StepWeekV2Fragment$distanceValue$2
        {
            super(0);
        }
    ...
    public int layoutId() {
        return R.layout.fragment_status_week_v2;
    }
    ...
    public List<Activity> onTimePeriodChange(@OOXIXo Calendar calendar, int i, @OOXIXo TimePeriod timePeriod) {
        ...
        setWeekDay(xoIox.XI0IXoo(o002[0]));
        clearCache(o002[0]);
