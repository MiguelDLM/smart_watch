...
public final class BloodGlucoseMonthFragment extends BaseDetailsMonthFragment<BloodGlucose> {
    private List<String> monthDays;
    public LineDataSet setValue;

    @OXOo.OOXIXo
    private final X0IIOO lineChart$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<LineChart>() { // from class: com.sma.smartv3.ui.status.fragment.BloodGlucoseMonthFragment$lineChart$2
        {
            super(0);
        }
        ...
        public final LineChart invoke() {
            View mView;
            mView = BloodGlucoseMonthFragment.this.getMView();
            return (LineChart) mView.findViewById(R.id.lineChart);
        }
    });

    @OXOo.OOXIXo
    private final X0IIOO minValue$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<DINCondBold>() { // from class: com.sma.smartv3.ui.status.fragment.BloodGlucoseMonthFragment$minValue$2
        {
            super(0);
        }
    ...
    @OXOo.OOXIXo
    private final X0IIOO maxValue$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<DINCondBold>() { // from class: com.sma.smartv3.ui.status.fragment.BloodGlucoseMonthFragment$maxValue$2
        {
            super(0);
        }
    ...
    @OXOo.OOXIXo
    private final X0IIOO avgValue$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<DINCondBold>() { // from class: com.sma.smartv3.ui.status.fragment.BloodGlucoseMonthFragment$avgValue$2
        {
            super(0);
        }
    ...
    @OXOo.OOXIXo
    private final X0IIOO monitorRetVal$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<DINCondBold>() { // from class: com.sma.smartv3.ui.status.fragment.BloodGlucoseMonthFragment$monitorRetVal$2
        {
            super(0);
        }
    ...
    @OXOo.OOXIXo
    private final LinkedHashMap<Long, ArrayList<BloodGlucose>> monthData = new LinkedHashMap<>();
    ...
    public static final class oIX0oI implements ooOx.oIX0oI {
        ...
        public void oIX0oI(@OXOo.OOXIXo Entry e, @OXOo.OOXIXo XI0oooXX.oxoX h) {
            IIX0o.x0xO0oo(e, "e");
            IIX0o.x0xO0oo(h, "h");
            BloodGlucoseMonthFragment.this.updateItemData(e);
            List list = BloodGlucoseMonthFragment.this.monthDays;
            if (list == null) {
                IIX0o.XOxIOxOx("monthDays");
                list = null;
            }
            List<String> o02 = com.sma.smartv3.util.xoIox.o0((String) list.get((int) e.xxIXOIIO()));
            BloodGlucoseMonthFragment.this.getNowTimeDetails().setText(o02.get(0) + IOUtils.DIR_SEPARATOR_UNIX + o02.get(1));
        }
    }

    private final void filterData(List<BloodGlucose> list) {
        this.values.clear();
        BloodGlucoseDataParse.INSTANCE.filterDayData(getMActivity(), list, this.monthData, this.bloodGlucoseDayDataList, this.values);
    ...
    public int layoutId() {
        return R.layout.fragment_status_blood_glucose_month;
    }
