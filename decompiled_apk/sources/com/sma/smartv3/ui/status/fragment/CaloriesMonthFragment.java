...
public final class CaloriesMonthFragment extends StatusBaseMonthFragment<Activity> {
    ...
    public void filterData(@OXOo.OOXIXo List<? extends Activity> data) {
        ...
        for (Activity activity : data) {
            getValues().add(new BarEntry(i2, activity.getMCalorie()));
            i += activity.getMCalorie();
            i2++;
        }
    ...
    public void initView() {
        ...
        getOneUnit().setText(R.string.kcal);
        getTwoTV().setText(R.string.average_calories);
    ...
    public List<Activity> onTimePeriodChange(@OXOo.OOXIXo Calendar calendar, int i, @OXOo.OOXIXo TimePeriod timePeriod) {
        ...
        while (it2.hasNext()) {
            ...
            if (value2.isEmpty()) {
                ...
                arrayList.add(new Activity(0, 0L, null, 0, 0, 0, i3, 0, 0, 0, 959, null));
            }
        }
        return arrayList;
    }
