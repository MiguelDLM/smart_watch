...
public final class RealTimeMeasurementActivity extends BaseActivity {
    ...
    private final long MAX_TIME_OUT;
    private final long MEASUREMENT_COMPLETE_TIME;
    ...
    @OXOo.OOXIXo
    private final BloodOxygenDao mBloodOxygenDao;

    @OXOo.OOXIXo
    private final BloodPressureDao mBloodPressureDao;
    private int mCurMeasureType;
    ...
    private int mLastBpm;

    @OXOo.oOoXoXO
    private XoI0Ixx0 mMeasurementCompletePopup;

    @OXOo.OOXIXo
    private final I0Io mMeasurementCompleteRunnable;
    private long mStartTime;

    @OXOo.OOXIXo
    private final Runnable mTimeoutDetectRunnable;

    @OXOo.OOXIXo
    private final X0IIOO rootView$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<View>() { // from class: com.sma.smartv3.ui.status.RealTimeMeasurementActivity$rootView$2
        {
            super(0);
        }
        ...
        public final View invoke() {
            return RealTimeMeasurementActivity.this.findViewById(R.id.root_view);
        }
    });

    @OXOo.OOXIXo
    private final X0IIOO llMeasurement$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<ViewGroup>() { // from class: com.sma.smartv3.ui.status.RealTimeMeasurementActivity$llMeasurement$2
        {
            super(0);
        }
        ...
        public final ViewGroup invoke() {
            return (ViewGroup) RealTimeMeasurementActivity.this.findViewById(R.id.ll_measurement);
        }
    });

    @OXOo.OOXIXo
    private final X0IIOO ivIcMeasurement$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<ImageView>() { // from class: com.sma.smartv3.ui.status.RealTimeMeasurementActivity$ivIcMeasurement$2
        {
            super(0);
        }
        ...
        public final ImageView invoke() {
            return (ImageView) RealTimeMeasurementActivity.this.findViewById(R.id.iv_ic_measurement);
        }
    });

    @OXOo.OOXIXo
    private final X0IIOO tvValue$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<PFMedium>() { // from class: com.sma.smartv3.ui.status.RealTimeMeasurementActivity$tvValue$2
        {
            super(0);
        }
        ...
        public final PFMedium invoke() {
            return (PFMedium) RealTimeMeasurementActivity.this.findViewById(R.id.tv_value);
        }
    });

    @OXOo.OOXIXo
    private final X0IIOO tvUnit$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.status.RealTimeMeasurementActivity$tvUnit$2
        {
            super(0);
        }
        ...
        public final TextView invoke() {
            return (TextView) RealTimeMeasurementActivity.this.findViewById(R.id.tv_unit);
        }
    });

    @OXOo.OOXIXo
    private final X0IIOO tvInfo$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.ui.status.RealTimeMeasurementActivity$tvInfo$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final TextView invoke() {
            return (TextView) RealTimeMeasurementActivity.this.findViewById(R.id.tv_info);
        }
    });

    @OXOo.OOXIXo
    private final X0IIOO btnBottom$delegate = XIxXXX0x0.oIX0oI(new Oox.oIX0oI<View>() { // from class: com.sma.smartv3.ui.status.RealTimeMeasurementActivity$btnBottom$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final View invoke() {
            return RealTimeMeasurementActivity.this.findViewById(R.id.btn_bottom);
        }
    });
    ...
    public static final class I0Io implements Runnable {
        ...
        public void run() {
            OI0.oIX0oI.f1507oIX0oI.oIX0oI("measure MeasurementComplete");
            RealTimeMeasurementActivity.this.onMeasurementComplete();
        }
    }
    ...
    public static final class II0xO0 implements BleHandleCallback {
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onRealTimeMeasurement(@OXOo.OOXIXo BleRealTimeMeasurement realTimeMeasurement) {
            IIX0o.x0xO0oo(realTimeMeasurement, "realTimeMeasurement");
            OI0.oIX0oI oix0oi = OI0.oIX0oI.f1507oIX0oI;
            oix0oi.XO("measurement mState" + realTimeMeasurement.getMState());
            if (realTimeMeasurement.getMState() == 1) {
                if (System.currentTimeMillis() - RealTimeMeasurementActivity.this.mStartTime < 1000) {
                    return;
                }
                oix0oi.XO("measurement failed");
                if (RealTimeMeasurementActivity.this.isShowPopup) {
                    RealTimeMeasurementActivity.this.showMessureFailedPopup();
                    return;
                }
                return;
            }
            if (realTimeMeasurement.getMState() == 0) {
                if (realTimeMeasurement.getMHRSwitch() == 1) {
                    BleConnector.sendData$default(BleConnector.INSTANCE, BleKey.HEART_RATE, BleKeyFlag.READ, null, false, false, 28, null);
                } else if (realTimeMeasurement.getMBPSwitch() == 1) {
                    BleConnector.sendData$default(BleConnector.INSTANCE, BleKey.BLOOD_PRESSURE, BleKeyFlag.READ, null, false, false, 28, null);
                } else if (realTimeMeasurement.getMBOSwitch() == 1) {
        ...
        public void onUpdateHeartRate(@OXOo.OOXIXo BleHeartRate heartRate) {
            ...
            if (RealTimeMeasurementActivity.this.mCurMeasureType == 0) {
                RealTimeMeasurementActivity.this.mLastBpm = heartRate.getMBpm();
                RealTimeMeasurementActivity.this.getTvValue().setText(String.valueOf(RealTimeMeasurementActivity.this.mLastBpm));
                RealTimeMeasurementActivity.this.mHandler.removeCallbacks(RealTimeMeasurementActivity.this.mTimeoutDetectRunnable);
                RealTimeMeasurementActivity.this.mHandler.postDelayed(RealTimeMeasurementActivity.this.mTimeoutDetectRunnable, RealTimeMeasurementActivity.this.MAX_TIME_OUT);
                RealTimeMeasurementActivity.this.getBtnBottom().setVisibility(0);
                com.sma.smartv3.util.x0xO0oo.II0xO0(com.sma.smartv3.util.x0xO0oo.f24567II0xO0, null, 2, null);
                if (RealTimeMeasurementActivity.this.flag && ProductManager.f20544oIX0oI.xIx()) {
                    RealTimeMeasurementActivity.this.flag = false;
                    RealTimeMeasurementActivity.this.mHandler.postDelayed(RealTimeMeasurementActivity.this.mMeasurementCompleteRunnable, RealTimeMeasurementActivity.this.MEASUREMENT_COMPLETE_TIME);
                }
            }
        }
    ...
    public RealTimeMeasurementActivity() {
        long j;
        MyDb myDb = MyDb.INSTANCE;
        this.mHeartRateDao = myDb.getMDatabase().heartRateDao();
        this.mBloodPressureDao = myDb.getMDatabase().bloodPressureDao();
        this.mBloodOxygenDao = myDb.getMDatabase().bloodOxygenDao();
        this.flag = true;
        ...
        this.MAX_TIME_OUT = j;
        this.MEASUREMENT_COMPLETE_TIME = 40000L;
        this.mHandler = new Handler();
        this.mTimeoutDetectRunnable = new Runnable() { // from class: com.sma.smartv3.ui.status.xxIXOIIO
            @Override // java.lang.Runnable
            public final void run() {
                RealTimeMeasurementActivity.mTimeoutDetectRunnable$lambda$0(RealTimeMeasurementActivity.this);
            }
        };
        this.mMeasurementCompleteRunnable = new I0Io();
        this.mBleHandleCallback = new II0xO0();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final View getBtnBottom() {
        return (View) this.btnBottom$delegate.getValue();
    }

    private final ImageView getIvIcMeasurement() {
        return (ImageView) this.ivIcMeasurement$delegate.getValue();
    }

    private final ViewGroup getLlMeasurement() {
        return (ViewGroup) this.llMeasurement$delegate.getValue();
    }
    ...
    public final PFMedium getTvValue() {
        return (PFMedium) this.tvValue$delegate.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$6(RealTimeMeasurementActivity this$0) {
        IIX0o.x0xO0oo(this$0, "this$0");
        this$0.measurementStart();
    }

    private final boolean isMeasuring() {
        return IIX0o.Oxx0IOOO(getTvInfo().getText().toString(), getString(R.string.measuring));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void mTimeoutDetectRunnable$lambda$0(RealTimeMeasurementActivity this$0) {
        IIX0o.x0xO0oo(this$0, "this$0");
        if (this$0.isMeasuring()) {
            OI0.oIX0oI.f1507oIX0oI.oIX0oI("measure timeout detect");
            this$0.showMessureFailedPopup();
        }
    }

    private final void measurementEnd() {
        Drawable drawable = getIvIcMeasurement().getDrawable();
        if (drawable instanceof GifDrawable) {
            ((GifDrawable) drawable).stop();
        }
        getBtnBottom().setVisibility(0);
        this.mHandler.removeCallbacks(this.mTimeoutDetectRunnable);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void measurementStart() {
        BleRealTimeMeasurement bleRealTimeMeasurement;
        this.mLastBpm = 0;
        Drawable drawable = getIvIcMeasurement().getDrawable();
        if (drawable instanceof GifDrawable) {
            ((GifDrawable) drawable).start();
        }
        this.mHandler.removeCallbacks(this.mMeasurementCompleteRunnable);
        this.flag = true;
        getTvInfo().setText(R.string.measuring);
        getTvValue().setText(R.string.data_none);
        int i = this.mCurMeasureType;
        if (i != 0) {
            if (i != 1) {
                if (i != 2) {
                    bleRealTimeMeasurement = new BleRealTimeMeasurement(0, 0, 0, 0, 0, 31, null);
                } else {
                    bleRealTimeMeasurement = new BleRealTimeMeasurement(0, 1, 0, 0, 2, 13, null);
                }
            } else {
                bleRealTimeMeasurement = new BleRealTimeMeasurement(0, 0, 1, 0, 2, 11, null);
            }
        } else {
            bleRealTimeMeasurement = new BleRealTimeMeasurement(1, 0, 0, 0, 2, 14, null);
        }
        BleRealTimeMeasurement bleRealTimeMeasurement2 = bleRealTimeMeasurement;
        this.mStartTime = System.currentTimeMillis();
        BleConnector.sendObject$default(BleConnector.INSTANCE, BleKey.REALTIME_MEASUREMENT, BleKeyFlag.UPDATE, bleRealTimeMeasurement2, false, false, 24, null);
        getBtnBottom().setVisibility(4);
        this.mHandler.postDelayed(this.mTimeoutDetectRunnable, this.MAX_TIME_OUT);
    }

    private final void onFinish() {
        if (isMeasuring() && this.mLastBpm == 0) {
            showMeasureHintPopup();
        } else {
            sendHeartRate();
            finish();
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void onMeasurementComplete() {
        getTvInfo().setText(R.string.measured);
        getBtnBottom().setVisibility(0);
        ...
        sendHeartRate();
        showMeasurementCompletePopup();
    }

    private final void sendHeartRate() {
        ProductManager productManager = ProductManager.f20544oIX0oI;
        if (productManager.xIx() || productManager.xxxI()) {
            BleConnector.sendObject$default(BleConnector.INSTANCE, BleKey.REALTIME_MEASUREMENT, BleKeyFlag.UPDATE, new BleRealTimeMeasurement(1, 0, 0, 0, 1, 14, null), false, false, 24, null);
            kotlinx.coroutines.xoIox.XO(LifecycleOwnerKt.getLifecycleScope(this), null, null, new RealTimeMeasurementActivity$sendHeartRate$1(null), 3, null);
        }
    }

    private final void showMeasureHintPopup() {
        getTvInfo().setText(R.string.measure_hint);
        XoI0Ixx0 xoI0Ixx0 = new XoI0Ixx0(this, 0, 2, null);
        xoI0Ixx0.IoOoX(R.string.measure_hint);
        xoI0Ixx0.xI(Integer.valueOf(R.string.in_measurement));
        xoI0Ixx0.x0xO0oo(false);
        xoI0Ixx0.X00IoxXI(Integer.valueOf(R.string.leave), new Oox.oIX0oI<Boolean>() { // from class: com.sma.smartv3.ui.status.RealTimeMeasurementActivity$showMeasureHintPopup$1$1
            {
                super(0);
            }
        ...
        xoI0Ixx0.x0o(R.string.continue_text, new Oox.oIX0oI<Boolean>() { // from class: com.sma.smartv3.ui.status.RealTimeMeasurementActivity$showMeasureHintPopup$1$2
            {
                super(0);
            }
            ...
            @OXOo.OOXIXo
            public final Boolean invoke() {
                RealTimeMeasurementActivity.this.measurementStart();
                return Boolean.TRUE;
            }
        });
        xoI0Ixx0.IIXOooo();
    ...
    private final void showMeasurementCompletePopup() {
        if (this.mMeasurementCompletePopup == null) {
            XoI0Ixx0 xoI0Ixx0 = new XoI0Ixx0(getMContext(), R.layout.pop_measurement_complete);
            String string = getString(R.string.measured);
            IIX0o.oO(string, "getString(...)");
            xoI0Ixx0.Xx000oIo(string);
            XoI0Ixx0.IO(xoI0Ixx0, null, null, 2, null);
            xoI0Ixx0.ooXIXxIX().setVisibility(8);
            xoI0Ixx0.x0o(R.string.confirm, new Oox.oIX0oI<Boolean>() { // from class: com.sma.smartv3.ui.status.RealTimeMeasurementActivity$showMeasurementCompletePopup$1$1
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // Oox.oIX0oI
                @OXOo.OOXIXo
                public final Boolean invoke() {
            ...
            this.mMeasurementCompletePopup = xoI0Ixx0;
            View rootView = getRootView();
            IIX0o.oO(rootView, "<get-rootView>(...)");
            xoI0Ixx0.xoXoI(rootView);
        }
        kotlinx.coroutines.xoIox.XO(LifecycleOwnerKt.getLifecycleScope(this), null, null, new RealTimeMeasurementActivity$showMeasurementCompletePopup$2(this, null), 3, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void showMessureFailedPopup() {
        getTvInfo().setText(R.string.measure_failed);
        XoI0Ixx0 xoI0Ixx0 = new XoI0Ixx0(this, 0, 2, null);
        xoI0Ixx0.IoOoX(R.string.measure_failed);
        xoI0Ixx0.xI(Integer.valueOf(R.string.measurement_tip));
        xoI0Ixx0.x0xO0oo(false);
        xoI0Ixx0.X00IoxXI(Integer.valueOf(R.string.cancel), new Oox.oIX0oI<Boolean>() { // from class: com.sma.smartv3.ui.status.RealTimeMeasurementActivity$showMessureFailedPopup$1$1
            {
                super(0);
            }
        ...
        xoI0Ixx0.x0o(R.string.measure_retry, new Oox.oIX0oI<Boolean>() { // from class: com.sma.smartv3.ui.status.RealTimeMeasurementActivity$showMessureFailedPopup$1$2
            {
                super(0);
            }
    ...
    public void initView() {
        ...
        if (i != 0) {
            if (i != 1) {
                if (i == 2) {
                    ((TextView) findViewById(R.id.abh_title_center)).setText(R.string.measure_bog);
                    getLlMeasurement().setBackgroundResource(R.drawable.bg_measurement_bog);
                    getTvValue().setTextColor(oIxOXo.oxoX.I0Io(getMContext(), R.color.measurement_text_color_bog));
                    getTvUnit().setText(R.string.percent);
                    Glide.with((FragmentActivity) this).load(Integer.valueOf(R.raw.icon_measurement_bog)).skipMemoryCache(true).diskCacheStrategy(DiskCacheStrategy.NONE).into(getIvIcMeasurement());
                }
            } else {
                ((TextView) findViewById(R.id.abh_title_center)).setText(R.string.measure_bp);
                getLlMeasurement().setBackgroundResource(R.drawable.bg_measurement_bp);
                getIvIcMeasurement().setImageResource(R.drawable.icon_measurement_bp);
                getTvValue().setTextColor(oIxOXo.oxoX.I0Io(getMContext(), R.color.measurement_text_color_bp));
                getTvUnit().setText(R.string.mmhg);
            }
        } else {
            ((TextView) findViewById(R.id.abh_title_center)).setText(R.string.measure_hr);
            getLlMeasurement().setBackgroundResource(R.drawable.bg_measurement_hr);
            getTvValue().setTextColor(oIxOXo.oxoX.I0Io(getMContext(), R.color.measurement_text_color_hr));
            getTvUnit().setText(R.string.bpm);
            Glide.with((FragmentActivity) this).load(Integer.valueOf(R.raw.icon_measurement_hr)).skipMemoryCache(true).diskCacheStrategy(DiskCacheStrategy.NONE).into(getIvIcMeasurement());
        }
        this.mStartTime = System.currentTimeMillis();
        new Handler().postDelayed(new Runnable() { // from class: com.sma.smartv3.ui.status.II0XooXoX
            @Override // java.lang.Runnable
            public final void run() {
                RealTimeMeasurementActivity.initView$lambda$6(RealTimeMeasurementActivity.this);
            }
        }, 500L);
    }
    ...
    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_realtime_measurement;
    }
    ...
    public final void onBloodOxygenChanged(@OXOo.OOXIXo Object data) {
        ...
        getTvInfo().setText(R.string.measured);
        showMeasurementCompletePopup();
        BloodOxygen lastBloodOxygen = this.mBloodOxygenDao.getLastBloodOxygen();
        if (lastBloodOxygen != null) {
            getTvValue().setText(String.valueOf(lastBloodOxygen.getMValue()));
        }
    }
    ...
    public final void onBloodPressureChanged(@OXOo.OOXIXo Object data) {
        ...
        getTvInfo().setText(R.string.measured);
        showMeasurementCompletePopup();
        BloodPressure lastBloodPressure = this.mBloodPressureDao.getLastBloodPressure();
        if (lastBloodPressure != null) {
            PFMedium tvValue = getTvValue();
            StringBuilder sb = new StringBuilder();
            sb.append(lastBloodPressure.getMSystolic());
            sb.append(IOUtils.DIR_SEPARATOR_UNIX);
            sb.append(lastBloodPressure.getMDiastolic());
        ...
        if (i != 0) {
            if (i != 1) {
                if (i != 2) {
                    ...
                    bleRealTimeMeasurement = new BleRealTimeMeasurement(0, 1, 0, 0, 1, 13, null);
                }
            } else {
                bleRealTimeMeasurement = new BleRealTimeMeasurement(0, 0, 1, 0, 1, 11, null);
            }
        } else {
            bleRealTimeMeasurement = new BleRealTimeMeasurement(1, 0, 0, 0, 1, 14, null);
        }
        BleConnector.sendObject$default(bleConnector, BleKey.REALTIME_MEASUREMENT, BleKeyFlag.UPDATE, bleRealTimeMeasurement, false, false, 24, null);
    }
    ...
    public final void onHeartRateChanged(@OXOo.OOXIXo Object data) {
        ...
        if (!productManager.xIx() && !productManager.xxxI()) {
            ...
            getTvInfo().setText(R.string.measured);
            showMeasurementCompletePopup();
            HeartRate lastHeartRate = this.mHeartRateDao.getLastHeartRate();
            if (lastHeartRate != null) {
                this.mLastBpm = lastHeartRate.getMBpm();
                getTvValue().setText(String.valueOf(this.mLastBpm));
            }
        }
    }
