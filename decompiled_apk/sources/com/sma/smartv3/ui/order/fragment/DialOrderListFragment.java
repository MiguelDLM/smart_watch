...
@XX({"SMAP\nDialOrderListFragment.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DialOrderListFragment.kt\ncom/sma/smartv3/ui/order/fragment/DialOrderListFragment\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,161:1\n1855#2,2:162\n*S KotlinDebug\n*F\n+ 1 DialOrderListFragment.kt\ncom/sma/smartv3/ui/order/fragment/DialOrderListFragment\n*L\n116#1:162,2\n*E\n"})
/* loaded from: classes11.dex */
public final class DialOrderListFragment extends BaseOrderListFragment {

    @OOXIXo
    private String itemOrderNum;

    public DialOrderListFragment() {
        setOrderType("WatchFace");
        this.itemOrderNum = "";
    }
    ...
    public final void findData(@OOXIXo final DslAdapter dslAdapter, @OOXIXo List<OrderContentData> mData) {
        ...
        for (final OrderContentData orderContentData : mData) {
            DslAdapterExKt.oO(dslAdapter, R.layout.item_order_integral, new oOoXoXO<DslAdapterItem, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.order.fragment.DialOrderListFragment$findData$1$1

                /* renamed from: com.sma.smartv3.ui.order.fragment.DialOrderListFragment$findData$1$1$1, reason: invalid class name */
                /* loaded from: classes11.dex */
                public static final class AnonymousClass1 extends Lambda implements Oxx0xo<DslViewHolder, Integer, DslAdapterItem, List<? extends Object>, oXIO0o0XI> {
                    ...
                    final /* synthetic */ DialOrderListFragment this$0;

                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    public AnonymousClass1(DialOrderListFragment dialOrderListFragment, OrderContentData orderContentData, DslAdapterItem dslAdapterItem, DslAdapter dslAdapter) {
                        super(4);
                        this.this$0 = dialOrderListFragment;
                    ...
                    public static final void invoke$lambda$0(DialOrderListFragment this$0, int i, DslAdapterItem this_dslItem, DslViewHolder itemHolder, DslAdapter this_findData, View view) {
                    ...
                    public final void invoke(@OOXIXo final DslViewHolder itemHolder, final int i, @OOXIXo DslAdapterItem dslAdapterItem, @OOXIXo List<? extends Object> list) {
                        ...
                        final DialOrderListFragment dialOrderListFragment = this.this$0;
                        ...
                        /*  JADX ERROR: Method code generation error
                            jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0032: INVOKE 
                              ...
                              (r1v0 'dialOrderListFragment' com.sma.smartv3.ui.order.fragment.DialOrderListFragment A[DONT_INLINE])
                             ...
                             A[MD:(com.sma.smartv3.ui.order.fragment.DialOrderListFragment, int, com.angcyo.dsladapter.DslAdapterItem, com.angcyo.dsladapter.DslViewHolder, com.angcyo.dsladapter.DslAdapter):void (m), WRAPPED] call: com.sma.smartv3.ui.order.fragment.oIX0oI.<init>(com.sma.smartv3.ui.order.fragment.DialOrderListFragment, int, com.angcyo.dsladapter.DslAdapterItem, com.angcyo.dsladapter.DslViewHolder, com.angcyo.dsladapter.DslAdapter):void type: CONSTRUCTOR)
                             VIRTUAL call: com.angcyo.dsladapter.DslViewHolder.click(int, android.view.View$OnClickListener):void A[MD:(int, android.view.View$OnClickListener):void (m)] in method: com.sma.smartv3.ui.order.fragment.DialOrderListFragment$findData$1$1.1.invoke(com.angcyo.dsladapter.DslViewHolder, int, com.angcyo.dsladapter.DslAdapterItem, java.util.List<? extends java.lang.Object>):void, file: classes11.dex
                            ...
                            Caused by: jadx.core.utils.exceptions.JadxRuntimeException: Expected class to be processed at this point, class: com.sma.smartv3.ui.order.fragment.oIX0oI, state: NOT_LOADED
                        ...
                        /*
                            ...
                            com.sma.smartv3.ui.order.fragment.DialOrderListFragment r9 = r6.this$0
                            ...
                            com.sma.smartv3.ui.order.fragment.DialOrderListFragment r1 = r6.this$0
                            com.angcyo.dsladapter.DslAdapterItem r3 = r6.$this_dslItem
                            com.angcyo.dsladapter.DslAdapter r5 = r6.$this_findData
                            com.sma.smartv3.ui.order.fragment.oIX0oI r9 = new com.sma.smartv3.ui.order.fragment.oIX0oI
                            r0 = r9
                            r2 = r8
                            r4 = r7
                            ...
                            if (r8 == 0) goto L46
                            com.sma.smartv3.ui.order.fragment.II0xO0 r9 = new com.sma.smartv3.ui.order.fragment.II0xO0
                            r9.<init>(r7)
                            r8.setOnTouchListener(r9)
                        L46:
                            return
                        */
                        throw new UnsupportedOperationException("Method not decompiled: com.sma.smartv3.ui.order.fragment.DialOrderListFragment$findData$1$1.AnonymousClass1.invoke(com.angcyo.dsladapter.DslViewHolder, int, com.angcyo.dsladapter.DslAdapterItem, java.util.List):void");
                    }
                }
                ...
                public final void invoke2(@OOXIXo final DslAdapterItem dslItem) {
                    ...
                    dslItem.setItemBindOverride(new AnonymousClass1(DialOrderListFragment.this, orderContentData, dslItem, dslAdapter));
                    final OrderContentData orderContentData2 = orderContentData;
                    final DialOrderListFragment dialOrderListFragment = DialOrderListFragment.this;
                    dslItem.setItemClick(new oOoXoXO<View, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.order.fragment.DialOrderListFragment$findData$1$1.2
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
                        ...
                        public final void invoke2(@OOXIXo View view) {
                            ...
                            if (!com.sma.smartv3.ui.device.dialpay.oIX0oI.oxoX(OrderContentData.this.getPayStatus())) {
                                dialOrderListFragment.showConfirm(OrderContentData.this.getOrderNum());
                            }
    ...
    public void getOrderList() {
        OrderManager.f20130oIX0oI.xxIXOIIO(getOrderType(), getPageNum(), new oOoXoXO<AccountOrderData, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.order.fragment.DialOrderListFragment$getOrderList$1
            {
                super(1);
            }
            ...
            public final void invoke2(@OXOo.oOoXoXO AccountOrderData accountOrderData) {
                if (accountOrderData != null) {
                    DialOrderListFragment.this.getMList().clear();
                    DialOrderListFragment.this.getMList().addAll(CollectionsKt___CollectionsKt.o0Xo0XII(accountOrderData.getContent()));
                }
                DialOrderListFragment.this.setAdapter();
            }
        });
    }
    ...
    public final void initItem(@OOXIXo DslViewHolder holder, @OOXIXo OrderContentData item, int i) {
        ...
        ImageView imageView = (ImageView) holder.v(R.id.order_integral_img);
        if (imageView != null) {
            imageView.setVisibility(0);
        }
        if (imageView != null) {
            Glide.with(requireActivity()).load(item.getElePath()).into(imageView);
        }
        TextView textView = (TextView) holder.v(R.id.order_integral_amount);
        TextView textView2 = (TextView) holder.v(R.id.order_integral_orderNum);
        TextView textView3 = (TextView) holder.v(R.id.order_integral_time);
        TextView textView4 = (TextView) holder.v(R.id.order_integral_orderNum_title);
        if (textView4 != null) {
            textView4.setText(getString(R.string.order_orderNum) + ':');
        }
        if (textView != null) {
        ...
        if (textView2 != null) {
            textView2.setText(item.getOrderNum());
        }
        if (textView3 != null) {
            textView3.setText(item.getCreatedAt());
        }
        TextView textView5 = (TextView) holder.v(R.id.order_integral_pay_status);
        if (textView5 != null) {
            if (com.sma.smartv3.ui.device.dialpay.oIX0oI.oxoX(item.getPayStatus())) {
                textView5.setText(getString(R.string.order_pay_status_payed));
                I0Io2 = oIxOXo.oxoX.I0Io(textView5.getContext(), R.color.text_color);
            } else {
                textView5.setText(getString(R.string.order_pay_status_created));
                I0Io2 = oIxOXo.oxoX.I0Io(textView5.getContext(), R.color.order_text_orange);
            }
            textView5.setTextColor(I0Io2);
        }
    }

    @Override // com.sma.smartv3.ui.order.fragment.BaseOrderListFragment
    public void setAdapter() {
        renderAdapter(new oOoXoXO<DslAdapter, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.order.fragment.DialOrderListFragment$setAdapter$1
            {
                super(1);
            }
            ...
            public final void invoke2(@OOXIXo DslAdapter renderAdapter) {
                ...
                DslViewHolder dslViewHolder = DialOrderListFragment.this.getDslViewHolder();
                final DialOrderListFragment dialOrderListFragment = DialOrderListFragment.this;
                dslViewHolder.postDelay(300L, new Oox.oIX0oI<oXIO0o0XI>() { // from class: com.sma.smartv3.ui.order.fragment.DialOrderListFragment$setAdapter$1.1
                    {
                        super(0);
                    }
                    ...
                    public final void invoke2() {
                        final DialOrderListFragment dialOrderListFragment2 = DialOrderListFragment.this;
                        dialOrderListFragment2.renderAdapter(new oOoXoXO<DslAdapter, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.order.fragment.DialOrderListFragment.setAdapter.1.1.1
                            {
                                super(1);
                            }
                            ...
                            public final void invoke2(@OOXIXo DslAdapter renderAdapter2) {
                                ...
                                if (DialOrderListFragment.this.getMList().isEmpty()) {
                                    DslAdapter.setAdapterStatus$default(DialOrderListFragment.this.getDslAdapter(), 1, null, 2, null);
                                    return;
                                }
                                renderAdapter2.clearAllItems();
                                DialOrderListFragment dialOrderListFragment3 = DialOrderListFragment.this;
                                dialOrderListFragment3.findData(renderAdapter2, dialOrderListFragment3.getMList());
                ...
                final DialOrderListFragment dialOrderListFragment2 = DialOrderListFragment.this;
                dslLoadMoreItem.setOnLoadMore(new oOoXoXO<DslViewHolder, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.order.fragment.DialOrderListFragment$setAdapter$1.2
                    {
                        super(1);
                    }
                    ...
                    public final void invoke2(@OOXIXo DslViewHolder it) {
                        IIX0o.x0xO0oo(it, "it");
                        final DialOrderListFragment dialOrderListFragment3 = DialOrderListFragment.this;
                        dialOrderListFragment3.renderAdapter(new oOoXoXO<DslAdapter, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.order.fragment.DialOrderListFragment.setAdapter.1.2.1
                            {
                                super(1);
                            }
                            ...
                            public final void invoke2(@OOXIXo final DslAdapter renderAdapter2) {
                                IIX0o.x0xO0oo(renderAdapter2, "$this$renderAdapter");
                                DialOrderListFragment dialOrderListFragment4 = DialOrderListFragment.this;
                                dialOrderListFragment4.setPageNum(dialOrderListFragment4.getPageNum() + 1);
                                OrderManager orderManager = OrderManager.f20130oIX0oI;
                                String orderType = DialOrderListFragment.this.getOrderType();
                                int pageNum = DialOrderListFragment.this.getPageNum();
                                final DialOrderListFragment dialOrderListFragment5 = DialOrderListFragment.this;
                                orderManager.xxIXOIIO(orderType, pageNum, new oOoXoXO<AccountOrderData, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.order.fragment.DialOrderListFragment.setAdapter.1.2.1.1
                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                    {
                                        super(1);
                                    }
                                    ...
                                    public final void invoke2(@OXOo.oOoXoXO AccountOrderData accountOrderData) {
                                        if (accountOrderData != null && accountOrderData.getContent() != null && !accountOrderData.getContent().isEmpty()) {
                                            DialOrderListFragment.this.findData(renderAdapter2, accountOrderData.getContent());
                ...
                DslAdapter.render$default(renderAdapter, false, null, new oOoXoXO<DslAdapter, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.order.fragment.DialOrderListFragment$setAdapter$1.3
                    @Override // Oox.oOoXoXO
                    public /* bridge */ /* synthetic */ oXIO0o0XI invoke(DslAdapter dslAdapter) {
                        invoke2(dslAdapter);
                        return oXIO0o0XI.f29392oIX0oI;
