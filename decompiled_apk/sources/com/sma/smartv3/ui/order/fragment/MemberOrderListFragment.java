...
@XX({"SMAP\nMemberOrderListFragment.kt\nKotlin\n*S Kotlin\n*F\n+ 1 MemberOrderListFragment.kt\ncom/sma/smartv3/ui/order/fragment/MemberOrderListFragment\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,155:1\n1855#2,2:156\n*S KotlinDebug\n*F\n+ 1 MemberOrderListFragment.kt\ncom/sma/smartv3/ui/order/fragment/MemberOrderListFragment\n*L\n111#1:156,2\n*E\n"})
/* loaded from: classes11.dex */
public final class MemberOrderListFragment extends BaseOrderListFragment {

    @OOXIXo
    private String itemOrderNum;

    public MemberOrderListFragment() {
        setOrderType("Member");
        this.itemOrderNum = "";
    }
    ...
    public final void findData(@OOXIXo final DslAdapter dslAdapter, @OOXIXo List<OrderContentData> mData) {
        ...
        for (final OrderContentData orderContentData : mData) {
            DslAdapterExKt.oO(dslAdapter, R.layout.item_order_integral, new oOoXoXO<DslAdapterItem, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.order.fragment.MemberOrderListFragment$findData$1$1

                /* renamed from: com.sma.smartv3.ui.order.fragment.MemberOrderListFragment$findData$1$1$1, reason: invalid class name */
                /* loaded from: classes11.dex */
                public static final class AnonymousClass1 extends Lambda implements Oxx0xo<DslViewHolder, Integer, DslAdapterItem, List<? extends Object>, oXIO0o0XI> {
                    ...
                    final /* synthetic */ MemberOrderListFragment this$0;

                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    public AnonymousClass1(MemberOrderListFragment memberOrderListFragment, OrderContentData orderContentData, DslAdapterItem dslAdapterItem, DslAdapter dslAdapter) {
                        super(4);
                        this.this$0 = memberOrderListFragment;
                    ...
                    public static final void invoke$lambda$0(MemberOrderListFragment this$0, int i, DslAdapterItem this_dslItem, DslViewHolder itemHolder, DslAdapter this_findData, View view) {
                    ...
                    public final void invoke(@OOXIXo final DslViewHolder itemHolder, final int i, @OOXIXo DslAdapterItem dslAdapterItem, @OOXIXo List<? extends Object> list) {
                        ...
                        final MemberOrderListFragment memberOrderListFragment = this.this$0;
                        ...
                        /*  JADX ERROR: Method code generation error
                            jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0032: INVOKE 
                              ...
                              (r1v0 'memberOrderListFragment' com.sma.smartv3.ui.order.fragment.MemberOrderListFragment A[DONT_INLINE])
                            ...
                            Caused by: jadx.core.utils.exceptions.JadxRuntimeException: Expected class to be processed at this point, class: com.sma.smartv3.ui.order.fragment.Oxx0IOOO, state: NOT_LOADED
                        ...
                        /*
                            ...
                            com.sma.smartv3.ui.order.fragment.MemberOrderListFragment r9 = r6.this$0
                            ...
                            com.sma.smartv3.ui.order.fragment.MemberOrderListFragment r1 = r6.this$0
                            com.angcyo.dsladapter.DslAdapterItem r3 = r6.$this_dslItem
                            com.angcyo.dsladapter.DslAdapter r5 = r6.$this_findData
                            com.sma.smartv3.ui.order.fragment.Oxx0IOOO r9 = new com.sma.smartv3.ui.order.fragment.Oxx0IOOO
                            r0 = r9
                            r2 = r8
                            r4 = r7
                            ...
                            if (r8 == 0) goto L46
                            com.sma.smartv3.ui.order.fragment.II0XooXoX r9 = new com.sma.smartv3.ui.order.fragment.II0XooXoX
                            r9.<init>(r7)
                            r8.setOnTouchListener(r9)
                        L46:
                            return
                        */
                        throw new UnsupportedOperationException("Method not decompiled: com.sma.smartv3.ui.order.fragment.MemberOrderListFragment$findData$1$1.AnonymousClass1.invoke(com.angcyo.dsladapter.DslViewHolder, int, com.angcyo.dsladapter.DslAdapterItem, java.util.List):void");
                    }
                }
                ...
                public final void invoke2(@OOXIXo final DslAdapterItem dslItem) {
                    ...
                    dslItem.setItemBindOverride(new AnonymousClass1(MemberOrderListFragment.this, orderContentData, dslItem, dslAdapter));
                    ...
                    dslItem.setItemClick(new oOoXoXO<View, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.order.fragment.MemberOrderListFragment$findData$1$1.2
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
                        ...
                        public final void invoke2(@OOXIXo View view) {
                            ...
                            MemberOrderListFragment.this.setItemOrderNum(orderContentData2.getOrderNum());
                            if (!com.sma.smartv3.ui.device.dialpay.oIX0oI.oxoX(orderContentData2.getPayStatus())) {
                                LogUtils.d("OrderList itemClick itemClick itemOrderNum = " + MemberOrderListFragment.this.getItemOrderNum() + " orderNum = " + orderContentData2.getOrderNum());
                                MemberOrderListFragment.this.showConfirm(orderContentData2.getOrderNum());
                            }
    ...
    public void getOrderList() {
        OrderManager.f20130oIX0oI.xxIXOIIO(getOrderType(), getPageNum(), new oOoXoXO<AccountOrderData, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.order.fragment.MemberOrderListFragment$getOrderList$1
            {
                super(1);
            }
            ...
            public final void invoke2(@OXOo.oOoXoXO AccountOrderData accountOrderData) {
                if (accountOrderData != null) {
                    MemberOrderListFragment.this.getMList().clear();
                    MemberOrderListFragment.this.getMList().addAll(CollectionsKt___CollectionsKt.o0Xo0XII(accountOrderData.getContent()));
                }
                MemberOrderListFragment.this.setAdapter();
            }
        });
    }
    ...
    public void setAdapter() {
        renderAdapter(new oOoXoXO<DslAdapter, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.order.fragment.MemberOrderListFragment$setAdapter$1
            {
                super(1);
            }
            ...
            public final void invoke2(@OOXIXo DslAdapter renderAdapter) {
                ...
                DslViewHolder dslViewHolder = MemberOrderListFragment.this.getDslViewHolder();
                final MemberOrderListFragment memberOrderListFragment = MemberOrderListFragment.this;
                dslViewHolder.postDelay(300L, new Oox.oIX0oI<oXIO0o0XI>() { // from class: com.sma.smartv3.ui.order.fragment.MemberOrderListFragment$setAdapter$1.1
                    {
                        super(0);
                    }
                    ...
                    public final void invoke2() {
                        final MemberOrderListFragment memberOrderListFragment2 = MemberOrderListFragment.this;
                        memberOrderListFragment2.renderAdapter(new oOoXoXO<DslAdapter, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.order.fragment.MemberOrderListFragment.setAdapter.1.1.1
                            {
                                super(1);
                            }
                            ...
                            public final void invoke2(@OOXIXo DslAdapter renderAdapter2) {
                                ...
                                if (MemberOrderListFragment.this.getMList().isEmpty()) {
                                    DslAdapter.setAdapterStatus$default(MemberOrderListFragment.this.getDslAdapter(), 1, null, 2, null);
                                    return;
                                }
                                renderAdapter2.clearAllItems();
                                MemberOrderListFragment memberOrderListFragment3 = MemberOrderListFragment.this;
                                memberOrderListFragment3.findData(renderAdapter2, memberOrderListFragment3.getMList());
                ...
                final MemberOrderListFragment memberOrderListFragment2 = MemberOrderListFragment.this;
                dslLoadMoreItem.setOnLoadMore(new oOoXoXO<DslViewHolder, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.order.fragment.MemberOrderListFragment$setAdapter$1.2
                    {
                        super(1);
                    }
                    ...
                    public final void invoke2(@OOXIXo DslViewHolder it) {
                        IIX0o.x0xO0oo(it, "it");
                        final MemberOrderListFragment memberOrderListFragment3 = MemberOrderListFragment.this;
                        memberOrderListFragment3.renderAdapter(new oOoXoXO<DslAdapter, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.order.fragment.MemberOrderListFragment.setAdapter.1.2.1
                            {
                                super(1);
                            }
                            ...
                            public final void invoke2(@OOXIXo final DslAdapter renderAdapter2) {
                                IIX0o.x0xO0oo(renderAdapter2, "$this$renderAdapter");
                                MemberOrderListFragment memberOrderListFragment4 = MemberOrderListFragment.this;
                                memberOrderListFragment4.setPageNum(memberOrderListFragment4.getPageNum() + 1);
                                OrderManager orderManager = OrderManager.f20130oIX0oI;
                                String orderType = MemberOrderListFragment.this.getOrderType();
                                int pageNum = MemberOrderListFragment.this.getPageNum();
                                final MemberOrderListFragment memberOrderListFragment5 = MemberOrderListFragment.this;
                                orderManager.xxIXOIIO(orderType, pageNum, new oOoXoXO<AccountOrderData, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.order.fragment.MemberOrderListFragment.setAdapter.1.2.1.1
                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                    {
                                        super(1);
                                    }
                                    ...
                                    public final void invoke2(@OXOo.oOoXoXO AccountOrderData accountOrderData) {
                                        if (accountOrderData != null && accountOrderData.getContent() != null && !accountOrderData.getContent().isEmpty()) {
                                            MemberOrderListFragment.this.findData(renderAdapter2, accountOrderData.getContent());
                ...
                DslAdapter.render$default(renderAdapter, false, null, new oOoXoXO<DslAdapter, oXIO0o0XI>() { // from class: com.sma.smartv3.ui.order.fragment.MemberOrderListFragment$setAdapter$1.3
                    @Override // Oox.oOoXoXO
                    public /* bridge */ /* synthetic */ oXIO0o0XI invoke(DslAdapter dslAdapter) {
                        invoke2(dslAdapter);
                        return oXIO0o0XI.f29392oIX0oI;
