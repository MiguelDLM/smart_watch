...
public final class HRDayData {
    ...
    public HRDayData(int i, int i2, int i3, @OOXIXo String status) {
    ...
    public /* synthetic */ HRDayData(int i, int i2, int i3, String str, int i4, IIXOooo iIXOooo) {
