...
public final class HRVDayData {
    ...
    public HRVDayData(int i, int i2, int i3, @OOXIXo String status) {
    ...
    public /* synthetic */ HRVDayData(int i, int i2, int i3, String str, int i4, IIXOooo iIXOooo) {
