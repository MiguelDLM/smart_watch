...
public final class ECGDayData {
    ...
    public ECGDayData(int i, int i2, int i3, @OOXIXo String status) {
    ...
    public /* synthetic */ ECGDayData(int i, int i2, int i3, String str, int i4, IIXOooo iIXOooo) {
