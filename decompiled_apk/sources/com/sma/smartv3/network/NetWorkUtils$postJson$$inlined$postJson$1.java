...
@XX({"SMAP\nNetWork.kt\nKotlin\n*S Kotlin\n*F\n+ 1 NetWork.kt\ncom/sma/androidnetworklib/method/NetWork$postJson$1\n*L\n1#1,359:1\n*E\n"})
/* loaded from: classes12.dex */
public final class NetWorkUtils$postJson$$inlined$postJson$1<T> implements ParsedRequestListener<Response<T>> {
    final /* synthetic */ II0xO0 $callback;

    public NetWorkUtils$postJson$$inlined$postJson$1(II0xO0 iI0xO0) {
