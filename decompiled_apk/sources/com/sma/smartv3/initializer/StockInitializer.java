...
@XX({"SMAP\nStockInitializer.kt\nKotlin\n*S Kotlin\n*F\n+ 1 StockInitializer.kt\ncom/sma/smartv3/initializer/StockInitializer\n+ 2 SPUtils.kt\ncom/bestmafen/androidbase/extension/SPUtilsKt\n+ 3 NetWorkUtils.kt\ncom/sma/smartv3/network/NetWorkUtils\n+ 4 NetWork.kt\ncom/sma/androidnetworklib/method/NetWork\n+ 5 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,153:1\n19#2:154\n15#2:155\n151#3,11:156\n171#3:175\n208#4,7:167\n226#4:174\n1855#5,2:176\n*S KotlinDebug\n*F\n+ 1 StockInitializer.kt\ncom/sma/smartv3/initializer/StockInitializer\n*L\n90#1:154\n90#1:155\n98#1:156,11\n98#1:175\n98#1:167,7\n98#1:174\n123#1:176,2\n*E\n"})
/* loaded from: classes12.dex */
public final class StockInitializer implements com.bestmafen.androidbase.base.II0xO0 {

    /* renamed from: IXxxXO, reason: collision with root package name */
    public static final int f20892IXxxXO = 12;

    /* renamed from: Oo, reason: collision with root package name */
    @OXOo.OOXIXo
    public static final String f20893Oo = "Stock";

    /* renamed from: XO, reason: collision with root package name */
    @OXOo.OOXIXo
    public static final StockInitializer f20895XO = new StockInitializer();

    /* renamed from: Oxx0xo, reason: collision with root package name */
    public static boolean f20894Oxx0xo = true;

    /* renamed from: oI0IIXIo, reason: collision with root package name */
    @OXOo.OOXIXo
    public static final oIX0oI f20896oI0IIXIo = new oIX0oI();
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public void onCommandSendTimeout(@OXOo.OOXIXo BleKey bleKey, @OXOo.OOXIXo BleKeyFlag bleKeyFlag) {
            ...
            if (bleKey == BleKey.STOCK) {
                StockInitializer.f20895XO.X0o0xo(true);
            }
        }
    ...
    public final void Oxx0IOOO() {
        if (!ProductManager.f20544oIX0oI.OX00o0X()) {
            LogUtils.v("Stock syncStock -> Device does not support sync stock");
            return;
        }
        if (!f20894Oxx0xo) {
            LogUtils.v("Stock syncStock -> The last Sync is not done, please wait");
            return;
        }
        if (!BleConnector.INSTANCE.isAvailable()) {
            LogUtils.v("Stock syncStock -> BleConnector is not available");
            return;
        }
        if (!oxoX()) {
            LogUtils.v("Stock syncStock -> Not time to sync stock");
            return;
        }
        if (BleInitializer.f20700XO.OOXIxO0()) {
            LogUtils.v("Stock firmware update.....");
            return;
        }
        ...
        if (appUser2.getIdentity().length() == 0) {
            LogUtils.v("Stock please login");
            return;
        }
        f20894Oxx0xo = false;
        NetWorkUtils netWorkUtils = NetWorkUtils.INSTANCE;
        HashMap<String, String> stockListBody = RequestBodyKt.getStockListBody(appUser2.getIdentity());
        final xxxI.II0xO0<Stock[]> iI0xO0 = new xxxI.II0xO0<Stock[]>() { // from class: com.sma.smartv3.initializer.StockInitializer$syncStock$1
            @Override // xxxI.II0xO0
            public void handleError(@OXOo.OOXIXo String error) {
                IIX0o.x0xO0oo(error, "error");
                StockInitializer.f20895XO.X0o0xo(true);
                OI0.oIX0oI.f1507oIX0oI.oIX0oI("Stock -> get stock list error: " + error);
            }
            ...
            public void handleResponse(@OXOo.oOoXoXO Stock[] stockArr) {
                ...
                sb.append("Stock -> get stock result : ");
                String arrays = Arrays.toString(stockArr);
                IIX0o.oO(arrays, "toString(...)");
                sb.append(arrays);
                oix0oi.oIX0oI(sb.toString());
                StockInitializer stockInitializer = StockInitializer.f20895XO;
                stockInitializer.X0o0xo(true);
                if (stockArr != null) {
                    Xo0.f24349oIX0oI.XO().put(Stock.class.getName() + oOXoIIIo.XO.f32008oIX0oI, new Gson().toJson(ArraysKt___ArraysKt.X0XOOO(stockArr)));
                    stockInitializer.XO(ArraysKt___ArraysKt.X0XOOO(stockArr));
                }
            }
        };
        ...
        final xxxI.II0xO0<Response<Stock[]>> iI0xO02 = new xxxI.II0xO0<Response<Stock[]>>() { // from class: com.sma.smartv3.initializer.StockInitializer$syncStock$$inlined$post$default$1
            @Override // xxxI.II0xO0
            public void handleError(@OXOo.OOXIXo String error) {
                IIX0o.x0xO0oo(error, "error");
    ...
    public final void XO(List<Stock> list) {
        ArrayList arrayList = new ArrayList();
        for (Stock stock : CollectionsKt___CollectionsKt.O0o000XOX(list, ProductManager.f20544oIX0oI.xxIO())) {
            arrayList.add(new BleStock(Xo0.f24349oIX0oI.oIX0oI().getInt(XoI0Ixx0.f24490xoIxX), stock.getCode(), stock.getRealTimeClose(), stock.getRealTimeChange(), stock.getRealTimeChangePercentage(), 0.0f, 32, null));
        }
        Xo0.f24349oIX0oI.II0xO0().put(XoI0Ixx0.f24385OI0, System.currentTimeMillis());
    ...
    public void oIX0oI(@OXOo.OOXIXo Application app) {
        ...
        com.sma.smartv3.util.oIX0oI.f24510oIX0oI.oIX0oI(app, new BroadcastReceiver() { // from class: com.sma.smartv3.initializer.StockInitializer$init$1

            /* renamed from: II0xO0, reason: collision with root package name */
            public int f20901II0xO0 = X0.IIXOooo.xXoOI00O(new X0.oOoXoXO(15, 120), Random.Default) * 60000;

            /* renamed from: oIX0oI, reason: collision with root package name */
            public long f20902oIX0oI;
            ...
            public void onReceive(@OXOo.OOXIXo Context context, @OXOo.OOXIXo Intent intent) {
                ...
                if (action != null && action.hashCode() == -1513032534 && action.equals("android.intent.action.TIME_TICK") && System.currentTimeMillis() - this.f20902oIX0oI > this.f20901II0xO0) {
                    LogUtils.d("Stock onReceive ACTION_TIME_TICK -> syncStock() " + this.f20901II0xO0);
                    StockInitializer.f20895XO.Oxx0IOOO();
                    this.f20902oIX0oI = System.currentTimeMillis();
                }
            }
        }, new IntentFilter("android.intent.action.TIME_TICK"), 2);
        BleConnector.INSTANCE.addHandleCallback(f20896oI0IIXIo);
    }

    public final boolean oxoX() {
        if (System.currentTimeMillis() - Xo0.f24349oIX0oI.II0xO0().getLong(XoI0Ixx0.f24385OI0) >= 43200000) {
            return true;
        }
        return false;
    }
