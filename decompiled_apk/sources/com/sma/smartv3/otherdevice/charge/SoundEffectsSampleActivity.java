...
public final class SoundEffectsSampleActivity extends BaseChargeActivity {

    @OXOo.OOXIXo
    private final kotlin.X0IIOO cbNormal$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<CheckBox>() { // from class: com.sma.smartv3.otherdevice.charge.SoundEffectsSampleActivity$cbNormal$2
        {
            super(0);
        }
        ...
        public final CheckBox invoke() {
            return (CheckBox) SoundEffectsSampleActivity.this.findViewById(R.id.cb_eq_normal);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO cbRock$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<CheckBox>() { // from class: com.sma.smartv3.otherdevice.charge.SoundEffectsSampleActivity$cbRock$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final CheckBox invoke() {
            return (CheckBox) SoundEffectsSampleActivity.this.findViewById(R.id.cb_eq_rock);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO cbPop$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<CheckBox>() { // from class: com.sma.smartv3.otherdevice.charge.SoundEffectsSampleActivity$cbPop$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final CheckBox invoke() {
            return (CheckBox) SoundEffectsSampleActivity.this.findViewById(R.id.cb_eq_pop);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO cbClassical$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<CheckBox>() { // from class: com.sma.smartv3.otherdevice.charge.SoundEffectsSampleActivity$cbClassical$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final CheckBox invoke() {
            return (CheckBox) SoundEffectsSampleActivity.this.findViewById(R.id.cb_eq_classical);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO cbJazz$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<CheckBox>() { // from class: com.sma.smartv3.otherdevice.charge.SoundEffectsSampleActivity$cbJazz$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final CheckBox invoke() {
            return (CheckBox) SoundEffectsSampleActivity.this.findViewById(R.id.cb_eq_jazz);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO cbCountry$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<CheckBox>() { // from class: com.sma.smartv3.otherdevice.charge.SoundEffectsSampleActivity$cbCountry$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final CheckBox invoke() {
            return (CheckBox) SoundEffectsSampleActivity.this.findViewById(R.id.cb_eq_country);
        }
    });

    @OXOo.OOXIXo
    private BleEarphoneSoundEffectsSettings mEarphoneSoundEffectsSettings = (BleEarphoneSoundEffectsSettings) BleCache.getObjectNotNull$default(BleCache.INSTANCE, BleKey.EARPHONE_SOUND_EFFECTS_SET, BleEarphoneSoundEffectsSettings.class, null, null, 12, null);
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        public void onEarphoneSoundEffectsSettingsUpdate(@OXOo.OOXIXo BleEarphoneSoundEffectsSettings earphoneSoundEffectsSettings) {
            ...
            SoundEffectsSampleActivity.this.mEarphoneSoundEffectsSettings = earphoneSoundEffectsSettings;
            SoundEffectsSampleActivity.this.updateUI();
        }
    ...
    private final CheckBox getCbClassical() {
        return (CheckBox) this.cbClassical$delegate.getValue();
    }

    private final CheckBox getCbCountry() {
        return (CheckBox) this.cbCountry$delegate.getValue();
    }

    private final CheckBox getCbJazz() {
        return (CheckBox) this.cbJazz$delegate.getValue();
    }

    private final CheckBox getCbNormal() {
        return (CheckBox) this.cbNormal$delegate.getValue();
    }

    private final CheckBox getCbPop() {
        return (CheckBox) this.cbPop$delegate.getValue();
    }

    private final CheckBox getCbRock() {
        return (CheckBox) this.cbRock$delegate.getValue();
    }

    private final boolean isModeCheck(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void updateUI() {
        getCbNormal().setChecked(isModeCheck(0, this.mEarphoneSoundEffectsSettings.getMMode()));
        getCbRock().setChecked(isModeCheck(1, this.mEarphoneSoundEffectsSettings.getMMode()));
        getCbPop().setChecked(isModeCheck(2, this.mEarphoneSoundEffectsSettings.getMMode()));
        getCbClassical().setChecked(isModeCheck(3, this.mEarphoneSoundEffectsSettings.getMMode()));
        getCbJazz().setChecked(isModeCheck(4, this.mEarphoneSoundEffectsSettings.getMMode()));
        getCbCountry().setChecked(isModeCheck(5, this.mEarphoneSoundEffectsSettings.getMMode()));
    }
    ...
    public void initView() {
        ((TextView) findViewById(R.id.abh_title_center)).setText(R.string.equalizer);
        ((TextView) findViewById(R.id.abh_sub_title)).setText("");
    ...
    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_sound_effects_sample;
    }
    ...
    public final void onModeClick(@OXOo.OOXIXo View view) {
        int i;
        kotlin.jvm.internal.IIX0o.x0xO0oo(view, "view");
        switch (view.getId()) {
            case R.id.ll_eq_classical /* 2131365887 */:
                i = 3;
                break;
            case R.id.ll_eq_country /* 2131365888 */:
                i = 5;
                break;
            case R.id.ll_eq_jazz /* 2131365889 */:
                i = 4;
                break;
            case R.id.ll_eq_normal /* 2131365890 */:
            default:
                i = 0;
                break;
            case R.id.ll_eq_pop /* 2131365891 */:
                i = 2;
                break;
            case R.id.ll_eq_rock /* 2131365892 */:
                i = 1;
                break;
        }
        if (i != this.mEarphoneSoundEffectsSettings.getMMode()) {
            this.mEarphoneSoundEffectsSettings.setMMode(i);
            BleConnector.sendObject$default(BleConnector.INSTANCE, BleKey.EARPHONE_SOUND_EFFECTS_SET, BleKeyFlag.UPDATE, this.mEarphoneSoundEffectsSettings, false, false, 24, null);
            updateUI();
        }
    }
