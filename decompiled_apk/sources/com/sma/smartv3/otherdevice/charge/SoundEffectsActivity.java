...
import com.sma.smartv3.otherdevice.jl.view.EqWaveView;
...
public final class SoundEffectsActivity extends BaseChargeActivity {
    ...
    @OXOo.OOXIXo
    private final kotlin.X0IIOO wvFreq$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<EqWaveView>() { // from class: com.sma.smartv3.otherdevice.charge.SoundEffectsActivity$wvFreq$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final EqWaveView invoke() {
            return (EqWaveView) SoundEffectsActivity.this.findViewById(R.id.wv_freq);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO tvEqModeSelectName$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<TextView>() { // from class: com.sma.smartv3.otherdevice.charge.SoundEffectsActivity$tvEqModeSelectName$2
        {
            super(0);
        }
        ...
        public final TextView invoke() {
            return (TextView) SoundEffectsActivity.this.findViewById(R.id.tv_eq_mode_select_name);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO btnEqReset$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<Button>() { // from class: com.sma.smartv3.otherdevice.charge.SoundEffectsActivity$btnEqReset$2
        {
            super(0);
        }
        ...
        public final Button invoke() {
            return (Button) SoundEffectsActivity.this.findViewById(R.id.btn_eq_reset);
        }
    });

    @OXOo.OOXIXo
    private final kotlin.X0IIOO btnEqMode$delegate = kotlin.XIxXXX0x0.oIX0oI(new Oox.oIX0oI<Button>() { // from class: com.sma.smartv3.otherdevice.charge.SoundEffectsActivity$btnEqMode$2
        {
            super(0);
        }
        ...
        @Override // Oox.oIX0oI
        public final Button invoke() {
            return (Button) SoundEffectsActivity.this.findViewById(R.id.btn_eq_mode);
        }
    });
    ...
    public static final class oIX0oI implements BleHandleCallback {
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onEarphoneSoundEffectsSettingsUpdate(@OXOo.OOXIXo BleEarphoneSoundEffectsSettings earphoneSoundEffectsSettings) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(earphoneSoundEffectsSettings, "earphoneSoundEffectsSettings");
            SoundEffectsActivity soundEffectsActivity = SoundEffectsActivity.this;
            soundEffectsActivity.mEqInfo = soundEffectsActivity.toEqInfo(earphoneSoundEffectsSettings);
            SoundEffectsActivity soundEffectsActivity2 = SoundEffectsActivity.this;
            soundEffectsActivity2.updateEqInfo(soundEffectsActivity2.mEqInfo);
        }
        ...
        @Override // com.szabh.smable3.component.BleHandleCallback
        public void onReadEarphoneSoundEffectsSettings(@OXOo.OOXIXo BleEarphoneSoundEffectsSettings earphoneSoundEffectsSettings) {
            kotlin.jvm.internal.IIX0o.x0xO0oo(earphoneSoundEffectsSettings, "earphoneSoundEffectsSettings");
            SoundEffectsActivity soundEffectsActivity = SoundEffectsActivity.this;
            soundEffectsActivity.mEqInfo = soundEffectsActivity.toEqInfo(earphoneSoundEffectsSettings);
            SoundEffectsActivity soundEffectsActivity2 = SoundEffectsActivity.this;
    ...
    public SoundEffectsActivity() {
        ...
        kotlin.jvm.internal.IIX0o.oO(Oxx0IOOO2, "getCurrentCacheEqInfo(...)");
        this.mEqInfo = Oxx0IOOO2;
        this.mBleHandleCallback = new oIX0oI();
        this.mOnClickListener = new View.OnClickListener() { // from class: com.sma.smartv3.otherdevice.charge.xOoOIoI
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SoundEffectsActivity.mOnClickListener$lambda$2(SoundEffectsActivity.this, view);
            }
        };
    }

    private final int[] bytes2ints(byte[] bArr, int i) {
        int[] iArr = new int[i];
    ...
    private final Button getBtnEqMode() {
        return (Button) this.btnEqMode$delegate.getValue();
    }

    private final Button getBtnEqReset() {
        return (Button) this.btnEqReset$delegate.getValue();
    }

    private final TextView getTvEqModeSelectName() {
        return (TextView) this.tvEqModeSelectName$delegate.getValue();
    }

    private final EqWaveView getWvFreq() {
        return (EqWaveView) this.wvFreq$delegate.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$0(SoundEffectsActivity this$0, int i, EqInfo eqInfo, boolean z) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        this$0.getWvFreq().XO(i, eqInfo.getValue()[i]);
        if (z) {
            eqInfo.setMode(6);
            kotlin.jvm.internal.IIX0o.ooOOo0oXI(eqInfo);
            this$0.setEqInfo(eqInfo);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void mOnClickListener$lambda$2(final SoundEffectsActivity this$0, View view) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        if (kotlin.jvm.internal.IIX0o.Oxx0IOOO(view, this$0.getBtnEqMode())) {
            EqModeDialog.newInstance(new EqModeDialog.II0xO0() { // from class: com.sma.smartv3.otherdevice.charge.O0X
                @Override // com.sma.smartv3.otherdevice.jl.ui.EqModeDialog.II0xO0
                public final void oIX0oI(EqInfo eqInfo) {
                    SoundEffectsActivity.mOnClickListener$lambda$2$lambda$1(SoundEffectsActivity.this, eqInfo);
                }
            }).show(this$0.getSupportFragmentManager(), EqModeDialog.class.getCanonicalName());
            return;
        }
        if (kotlin.jvm.internal.IIX0o.Oxx0IOOO(view, this$0.getBtnEqReset())) {
            EqInfo copy = oo00.oIX0oI.OOXIXo().getEqInfos().get(0).copy();
            copy.setMode(6);
            copy.setValue(new byte[copy.getValue().length]);
            kotlin.jvm.internal.IIX0o.ooOOo0oXI(copy);
            this$0.setEqInfo(copy);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void mOnClickListener$lambda$2$lambda$1(SoundEffectsActivity this$0, EqInfo eqInfo) {
        kotlin.jvm.internal.IIX0o.x0xO0oo(this$0, "this$0");
        kotlin.jvm.internal.IIX0o.ooOOo0oXI(eqInfo);
        this$0.setEqInfo(eqInfo);
    }

    private final void requestEqInfo() {
        BleConnector.sendData$default(BleConnector.INSTANCE, BleKey.EARPHONE_SOUND_EFFECTS_SET, BleKeyFlag.READ, null, false, false, 28, null);
    }

    private final void setEqInfo(EqInfo eqInfo) {
        BleConnector bleConnector = BleConnector.INSTANCE;
        BleKey bleKey = BleKey.EARPHONE_SOUND_EFFECTS_SET;
        BleKeyFlag bleKeyFlag = BleKeyFlag.UPDATE;
        int mode = eqInfo.getMode();
        int I0Io2 = oOXoIIIo.I0Io.I0Io(eqInfo.isDynamic());
        byte[] value = eqInfo.getValue();
        kotlin.jvm.internal.IIX0o.oO(value, "getValue(...)");
        int[] freqs = eqInfo.getFreqs();
        kotlin.jvm.internal.IIX0o.oO(freqs, "getFreqs(...)");
        BleConnector.sendObject$default(bleConnector, bleKey, bleKeyFlag, new BleEarphoneSoundEffectsSettings(mode, I0Io2, value, freqs, eqInfo.getCount()), false, false, 24, null);
        if (eqInfo.getMode() == 6) {
            EqPresetInfo OOXIXo2 = oo00.oIX0oI.OOXIXo();
            OOXIXo2.getEqInfos().get(6).setValue(eqInfo.getValue());
            oo00.oIX0oI.x0XOIxOo(OOXIXo2);
        }
        oo00.oIX0oI.ooOOo0oXI(eqInfo);
        updateEqInfo(eqInfo);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final EqInfo toEqInfo(BleEarphoneSoundEffectsSettings bleEarphoneSoundEffectsSettings) {
        EqInfo eqInfo = new EqInfo();
        eqInfo.setMode(bleEarphoneSoundEffectsSettings.getMMode());
        eqInfo.setValue(bleEarphoneSoundEffectsSettings.getMValue());
        eqInfo.setFreqs(bleEarphoneSoundEffectsSettings.getMFreqs());
        eqInfo.setDynamic(oOXoIIIo.I0Io.II0xO0(bleEarphoneSoundEffectsSettings.getMDynamic()));
        return eqInfo;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void updateEqInfo(EqInfo eqInfo) {
        boolean z;
        OI0.oIX0oI.f1507oIX0oI.oIX0oI("updateEqInfo -> " + eqInfo);
        this.mEqInfo = eqInfo;
        TextView tvEqModeSelectName = getTvEqModeSelectName();
        kotlin.jvm.internal.IIX0o.ooOOo0oXI(tvEqModeSelectName);
        tvEqModeSelectName.setText(getResources().getStringArray(R.array.eq_mode_list)[this.mEqInfo.getMode()]);
        EqWaveView wvFreq = getWvFreq();
        kotlin.jvm.internal.IIX0o.ooOOo0oXI(wvFreq);
        byte[] value = eqInfo.getValue();
        kotlin.jvm.internal.IIX0o.oO(value, "getValue(...)");
        wvFreq.setData(bytes2ints(value, eqInfo.getValue().length));
        EqWaveView wvFreq2 = getWvFreq();
        kotlin.jvm.internal.IIX0o.ooOOo0oXI(wvFreq2);
        wvFreq2.setFreqs(eqInfo.getFreqs());
        EqSeekBarAdapter eqSeekBarAdapter = this.mEqSeekBarAdapter;
        kotlin.jvm.internal.IIX0o.ooOOo0oXI(eqSeekBarAdapter);
        eqSeekBarAdapter.updateSeekBar(eqInfo.copy());
        boolean z2 = false;
        if (this.mEqInfo.getMode() == 6) {
            z = true;
        } else {
            z = false;
        }
        if (z) {
            byte[] value2 = eqInfo.getValue();
            kotlin.jvm.internal.IIX0o.oO(value2, "getValue(...)");
        ...
        Button btnEqReset = getBtnEqReset();
        kotlin.jvm.internal.IIX0o.ooOOo0oXI(btnEqReset);
        btnEqReset.setSelected(z);
        Button btnEqReset2 = getBtnEqReset();
        kotlin.jvm.internal.IIX0o.ooOOo0oXI(btnEqReset2);
        btnEqReset2.setClickable(z);
    }
    ...
    public void initView() {
        ((TextView) findViewById(R.id.abh_title_center)).setText(R.string.sound_effects);
        ((TextView) findViewById(R.id.abh_sub_title)).setText(R.string.sound_effects_sub);
        this.mEqSeekBarAdapter = new EqSeekBarAdapter(this, new ArrayList(), new EqSeekBarAdapter.oIX0oI() { // from class: com.sma.smartv3.otherdevice.charge.IIX0
            @Override // com.sma.smartv3.otherdevice.jl.adapter.EqSeekBarAdapter.oIX0oI
            public final void oIX0oI(int i, EqInfo eqInfo, boolean z) {
                SoundEffectsActivity.initView$lambda$0(SoundEffectsActivity.this, i, eqInfo, z);
            }
        });
        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.rv_vsbs);
        recyclerView.setAdapter(this.mEqSeekBarAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(this, 0, false));
        updateEqInfo(this.mEqInfo);
        requestEqInfo();
        getBtnEqMode().setOnClickListener(this.mOnClickListener);
        getBtnEqReset().setOnClickListener(this.mOnClickListener);
    }

    @Override // com.bestmafen.androidbase.base.oIX0oI
    public int layoutId() {
        return R.layout.activity_sound_effects;
    }
