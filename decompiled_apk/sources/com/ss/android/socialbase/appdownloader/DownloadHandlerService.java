...
public class DownloadHandlerService extends Service {
    ...
    private static final String f26145a = "DownloadHandlerService";
    ...
    private boolean a(Intent intent) {
        ...
        if (action.equals("android.ss.intent.action.DOWNLOAD_CLICK_CONTENT")) {
            ...
            a(this, downloadInfo, b, downloadNotificationEventListener);
            if (downloadInfo.isDownloadOverStatus() && com.ss.android.socialbase.downloader.g.a.a(intExtra).a("no_hide_notification", 0) == 0 && (com.ss.android.socialbase.downloader.g.a.a(intExtra).b("enable_notification_ui") < 2 || downloadInfo.getStatus() != -1)) {
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        if (com.ss.android.socialbase.downloader.c.a.a()) {
            com.ss.android.socialbase.downloader.c.a.b(f26145a, "onStartCommand");
        }
        a(intent);
        stopSelf();
        return 2;
        ...
        com.ss.android.socialbase.downloader.downloader.c.l().execute(new Runnable() { // from class: com.ss.android.socialbase.appdownloader.DownloadHandlerService.2
            ...
            public void run() {
                ...
                try {
                    ...
                    if (file.exists()) {
                        try {
                            if (com.ss.android.socialbase.downloader.downloader.c.O() == null || (a2 = c.a(DownloadInfo.this, file)) == null) {
                                str = "";
                            } else {
                                str = a2.packageName;
                            }
