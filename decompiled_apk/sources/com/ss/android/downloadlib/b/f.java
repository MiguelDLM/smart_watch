...
public class f {
    ...
    private static Handler f26075a = new Handler(Looper.getMainLooper());
    ...
    public static boolean c(com.ss.android.downloadad.api.a.b bVar) {
        if (com.ss.android.downloadlib.g.e.a((com.ss.android.downloadad.api.a.a) bVar).b("app_link_opt_invoke_switch") == 1) {
            return true;
        }
        return false;
    }
    ...
    public static boolean d(com.ss.android.downloadad.api.a.b bVar) {
        if (com.ss.android.downloadlib.g.e.a((com.ss.android.downloadad.api.a.a) bVar).b("app_link_opt_dialog_switch") == 1) {
            return true;
        }
        return false;
    }
    ...
    public static void a(final com.ss.android.downloadad.api.a.b bVar, @NonNull final h hVar) {
        ...
        com.ss.android.socialbase.downloader.a.a.a().a(new a.InterfaceC1053a() { // from class: com.ss.android.downloadlib.b.f.1
            ...
            public void b() {
                ...
                com.ss.android.downloadlib.d.a().a(new Runnable() { // from class: com.ss.android.downloadlib.b.f.1.1
                    @Override // java.lang.Runnable
                    public void run() {
                        boolean c = m.c(com.ss.android.downloadad.api.a.b.this.e());
