...
public class b {
    ...
    private SoftReference<Activity> f25998a;

    /* loaded from: classes11.dex */
    public static class a {

        /* renamed from: a, reason: collision with root package name */
        private static b f26002a = new b();
    }

    public void b(long j) {
        com.ss.android.downloadlib.addownload.e a2 = com.ss.android.downloadlib.g.a().a(com.ss.android.downloadlib.addownload.b.f.a().e(j).b.getDownloadUrl());
        if (a2 != null) {
            a2.a(true, true);
        } else {
            g.a(11, j);
    ...
    public Activity b() {
        Activity activity = this.f25998a.get();
        this.f25998a = null;
        return activity;
    }
    ...
    public boolean a(long j, long j2, String str) {
        try {
            ...
            if (optJSONObject != null && optJSONObject.length() != 0) {
                ...
                bVar.c = optJSONObject.optString(bb.G);
    ...
    public void a(Activity activity) {
        this.f25998a = new SoftReference<>(activity);
    }
}
