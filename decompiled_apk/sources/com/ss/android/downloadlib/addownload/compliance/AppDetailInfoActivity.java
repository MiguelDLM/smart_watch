...
public class AppDetailInfoActivity extends Activity {
    ...
    private void b() {
        this.f25984a = (ImageView) findViewById(R.id.iv_detail_back);
        ...
        this.f25984a.setOnClickListener(new View.OnClickListener() { // from class: com.ss.android.downloadlib.addownload.compliance.AppDetailInfoActivity.1
