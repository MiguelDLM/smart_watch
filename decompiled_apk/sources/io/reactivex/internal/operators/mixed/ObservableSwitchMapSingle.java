...
public final class ObservableSwitchMapSingle<T, R> extends Observable<R> {
    ...
    public static final class SwitchMapSingleMainObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public void drain() {
            ...
            while (!this.cancelled) {
                ...
                if (!z && switchMapSingleObserver.item != null) {
                    Oxx0IOOO.oIX0oI(atomicReference, switchMapSingleObserver, null);
        ...
        public void innerError(SwitchMapSingleObserver<R> switchMapSingleObserver, Throwable th) {
            if (Oxx0IOOO.oIX0oI(this.inner, switchMapSingleObserver, null) && this.errors.addThrowable(th)) {
                if (!this.delayErrors) {
                    this.upstream.dispose();
                    disposeInner();
                }
        ...
        public void onNext(T t) {
            ...
            try {
                ...
                } while (!Oxx0IOOO.oIX0oI(this.inner, switchMapSingleObserver, switchMapSingleObserver3));
