...
public abstract class BaseTestConsumer<T, U extends BaseTestConsumer<T, U>> implements Disposable {
    ...
    public static String valueAndClass(Object obj) {
        if (obj != null) {
            return obj + " (class: " + obj.getClass().getSimpleName() + oIX0oI.I0Io.f4095I0Io;
        }
        return "null";
    }
    ...
    public final U assertValueSequence(Iterable<? extends T> iterable) {
        ...
        if (!hasNext2) {
            ...
            throw fail("Fewer values received than expected (" + i + oIX0oI.I0Io.f4095I0Io);
        }
        throw fail("More values received than expected (" + i + oIX0oI.I0Io.f4095I0Io);
    }
