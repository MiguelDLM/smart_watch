...
public class MultilineRecursiveToStringStyle extends RecursiveToStringStyle {
    ...
    private void resetIndent() {
        ...
        setArrayEnd(System.lineSeparator() + ((Object) spacer(this.spaces + (-2))) + org.apache.commons.text.ooOOo0oXI.f33074oOoXoXO);
    ...
    public void appendDetail(StringBuffer stringBuffer, String str, Object obj) {
        if (!ClassUtils.o0(obj.getClass()) && !String.class.equals(obj.getClass()) && accept(obj.getClass())) {
            this.spaces += 2;
            resetIndent();
            stringBuffer.append(ooOOo0oXI.IIxOXoOo0(obj, this));
            this.spaces -= 2;
            resetIndent();
            return;
        }
