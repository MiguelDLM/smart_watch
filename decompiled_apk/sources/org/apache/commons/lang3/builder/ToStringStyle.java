...
import org.apache.commons.lang3.xo0x;
...
public abstract class ToStringStyle implements Serializable {
    ...
    private String arrayEnd = org.apache.commons.text.ooOOo0oXI.f33074oOoXoXO;
    ...
    public static final class JsonToStringStyle extends ToStringStyle {
        ...
        public JsonToStringStyle() {
            ...
            setContentStart("{");
            setContentEnd(org.apache.commons.text.ooOOo0oXI.f33074oOoXoXO);
            setArrayStart("[");
            setArrayEnd("]");
            setFieldSeparator(",");
        ...
        private void appendValueAsString(StringBuffer stringBuffer, String str) {
            stringBuffer.append('\"');
            stringBuffer.append(xo0x.XO(str));
            stringBuffer.append('\"');
        }

        private boolean isJsonArray(String str) {
            if (str.startsWith(getArrayStart()) && str.endsWith(getArrayEnd())) {
                return true;
            }
            return false;
        }
        ...
        public void appendFieldStart(StringBuffer stringBuffer, String str) {
            if (str != null) {
                super.appendFieldStart(stringBuffer, FIELD_NAME_QUOTE + xo0x.XO(str) + FIELD_NAME_QUOTE);
                return;
            }
            throw new UnsupportedOperationException("Field names are mandatory when using JsonToStringStyle");
        }
    ...
    public void appendCyclicObject(StringBuffer stringBuffer, String str, Object obj) {
        ObjectUtils.XIxXXX0x0(stringBuffer, obj);
    }
    ...
    public void appendIdentityHashCode(StringBuffer stringBuffer, Object obj) {
        if (isUseIdentityHashCode() && obj != null) {
            register(obj);
            stringBuffer.append(ObjectUtils.f32506oIX0oI);
    ...
    public void removeLastFieldSeparator(StringBuffer stringBuffer) {
        if (xXOx.Xx000oIo(stringBuffer, this.fieldSeparator)) {
