...
public class StrBuilder implements CharSequence, Appendable, Serializable, org.apache.commons.lang3.builder.oIX0oI<String> {
    ...
    public class II0xO0 extends XO {
        ...
        @Override // org.apache.commons.lang3.text.XO
    ...
    public <T> StrBuilder appendAll(T... tArr) {
        if (org.apache.commons.lang3.oxoX.o0IXXIx(tArr)) {
            for (T t : tArr) {
                append(t);
            }
        }
    ...
    public class oIX0oI extends Reader {
        ...
        public boolean ready() {
            if (this.f32781XO < StrBuilder.this.size()) {
                return true;
            }
            return false;
        }
        ...
        @Override // java.io.Reader
        public void reset() {
            this.f32781XO = this.f32780Oo;
        }

        @Override // java.io.Reader
        public long skip(long j) {
            if (this.f32781XO + j > StrBuilder.this.size()) {
                j = StrBuilder.this.size() - this.f32781XO;
            }
            if (j < 0) {
                return 0L;
            }
            this.f32781XO = (int) (this.f32781XO + j);
            return j;
        }
        ...
        public int read(char[] cArr, int i, int i2) {
            ...
            if (this.f32781XO + i2 > StrBuilder.this.size()) {
                i2 = StrBuilder.this.size() - this.f32781XO;
            }
            StrBuilder strBuilder = StrBuilder.this;
            int i4 = this.f32781XO;
    ...
    public StrBuilder replace(oxoX oxox, String str, int i, int i2, int i3) {
        return replaceImpl(oxox, str, i, validateRange(i, i2), i3);
    }
    ...
    public boolean contains(oxoX oxox) {
        return indexOf(oxox, 0) >= 0;
    }
    ...
    */
    ...
    private StrBuilder replaceImpl(oxoX oxox, String str, int i, int i2, int i3) {
        if (oxox != null && this.size != 0) {
            int length = str == null ? 0 : str.length();
            int i4 = i;
            while (i4 < i2 && i3 != 0) {
                int Oxx0IOOO2 = oxox.Oxx0IOOO(this.buffer, i4, i, i2);
                if (Oxx0IOOO2 > 0) {
    ...
    public StrBuilder deleteFirst(oxoX oxox) {
        return replace(oxox, null, 0, this.size, 1);
    }
    ...
    */
    ...
    public StrBuilder replaceFirst(oxoX oxox, String str) {
        return replace(oxox, str, 0, this.size, 1);
    }
    ...
    public StrBuilder replaceAll(oxoX oxox, String str) {
        return replace(oxox, str, 0, this.size, -1);
    }
    ...
    public StrBuilder deleteAll(oxoX oxox) {
        return replace(oxox, null, 0, this.size, -1);
    }

    public int lastIndexOf(oxoX oxox) {
        return lastIndexOf(oxox, this.size);
    }
    ...
    public int lastIndexOf(oxoX oxox, int i) {
        int i2 = this.size;
        if (i >= i2) {
            i = i2 - 1;
        }
        if (oxox != null && i >= 0) {
            ...
            int i3 = i + 1;
            while (i >= 0) {
                if (oxox.Oxx0IOOO(cArr, i, 0, i3) > 0) {
                    return i;
                }
                i--;
            }
    ...
    public int indexOf(oxoX oxox) {
        return indexOf(oxox, 0);
    }
    ...
    public int indexOf(oxoX oxox, int i) {
        int i2;
        int max = Math.max(i, 0);
        if (oxox != null && max < (i2 = this.size)) {
            char[] cArr = this.buffer;
            for (int i3 = max; i3 < i2; i3++) {
                if (oxox.Oxx0IOOO(cArr, i3, max, i2) > 0) {
                    return i3;
                }
            }
        }
