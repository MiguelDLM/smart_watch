...
public class NumericEntityUnescaper extends II0xO0 {
    ...
    public final EnumSet<OPTION> f32816II0xO0;
    ...
    public NumericEntityUnescaper(OPTION... optionArr) {
        if (optionArr.length > 0) {
            this.f32816II0xO0 = EnumSet.copyOf((Collection) Arrays.asList(optionArr));
        } else {
            this.f32816II0xO0 = EnumSet.copyOf((Collection) Collections.singletonList(OPTION.semiColonRequired));
        }
    }
    ...
    */
    public int II0xO0(java.lang.CharSequence r8, int r9, java.io.Writer r10) throws java.io.IOException {
        ...
        Lce:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: org.apache.commons.lang3.text.translate.NumericEntityUnescaper.II0xO0(java.lang.CharSequence, int, java.io.Writer):int");
    }

    public boolean XO(OPTION option) {
        EnumSet<OPTION> enumSet = this.f32816II0xO0;
