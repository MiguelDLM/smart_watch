...
public class ExtendedMessageFormat extends MessageFormat {
    ...
    private final Map<String, ? extends oIX0oI> registry;
    ...
    private Format getFormat(String str) {
        ...
        if (this.registry != null) {
            ...
            oIX0oI oix0oi = this.registry.get(str);
            if (oix0oi != null) {
                return oix0oi.oIX0oI(str, str2, getLocale());
            }
        }
        return null;
    }
    ...
    private void seekNonWs(String str, ParsePosition parsePosition) {
        char[] charArray = str.toCharArray();
        do {
            int XO2 = oxoX.oOoXoXO().XO(charArray, parsePosition.getIndex());
            parsePosition.setIndex(parsePosition.getIndex() + XO2);
            if (XO2 <= 0) {
                return;
            }
        } while (parsePosition.getIndex() < str.length());
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || !super.equals(obj) || ObjectUtils.oOXoIIIo(getClass(), obj.getClass())) {
            return false;
        }
        if (ObjectUtils.oOXoIIIo(this.toPattern, ((ExtendedMessageFormat) obj).toPattern)) {
            return false;
        }
        return !ObjectUtils.oOXoIIIo(this.registry, r5.registry);
    }
    ...
    public ExtendedMessageFormat(String str, Map<String, ? extends oIX0oI> map) {
        this(str, Locale.getDefault(), map);
    }

    public ExtendedMessageFormat(String str, Locale locale, Map<String, ? extends oIX0oI> map) {
        super("");
        setLocale(locale);
        this.registry = map;
        applyPattern(str);
