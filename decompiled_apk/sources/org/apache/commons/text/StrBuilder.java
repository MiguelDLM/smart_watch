...
public class StrBuilder implements CharSequence, Appendable, Serializable, org.apache.commons.text.II0xO0<String> {
    ...
    public class II0xO0 extends OOXIXo {
        ...
        @Override // org.apache.commons.text.OOXIXo
        public List<String> xII(char[] cArr, int i, int i2) {
            if (cArr == null) {
                StrBuilder strBuilder = StrBuilder.this;
                return super.xII(strBuilder.buffer, 0, strBuilder.size());
            }
    ...
    public char[] toCharArray() {
        int i = this.size;
        if (i == 0) {
            return org.apache.commons.lang3.oxoX.f32759X0o0xo;
        }
    ...
    public class oIX0oI extends Reader {
        ...
        public boolean ready() {
            if (this.f33041XO < StrBuilder.this.size()) {
                return true;
            }
            return false;
        }
        ...
        @Override // java.io.Reader
        public void reset() {
            this.f33041XO = this.f33040Oo;
        }

        @Override // java.io.Reader
        public long skip(long j) {
            if (this.f33041XO + j > StrBuilder.this.size()) {
                j = StrBuilder.this.size() - this.f33041XO;
            }
            if (j < 0) {
                return 0L;
            }
            this.f33041XO = (int) (this.f33041XO + j);
            return j;
        }
        ...
        public int read(char[] cArr, int i, int i2) {
            ...
            if (this.f33041XO + i2 > StrBuilder.this.size()) {
                i2 = StrBuilder.this.size() - this.f33041XO;
            }
            StrBuilder strBuilder = StrBuilder.this;
            int i4 = this.f33041XO;
    ...
    public StrBuilder replace(xxIXOIIO xxixoiio, String str, int i, int i2, int i3) {
        return replaceImpl(xxixoiio, str, i, validateRange(i, i2), i3);
    }
    ...
    public boolean contains(xxIXOIIO xxixoiio) {
        return indexOf(xxixoiio, 0) >= 0;
    }
    ...
    */
    ...
    private StrBuilder replaceImpl(xxIXOIIO xxixoiio, String str, int i, int i2, int i3) {
        if (xxixoiio != null && this.size != 0) {
            int length = str == null ? 0 : str.length();
            int i4 = i;
            while (i4 < i2 && i3 != 0) {
                int Oxx0IOOO2 = xxixoiio.Oxx0IOOO(this.buffer, i4, i, i2);
                if (Oxx0IOOO2 > 0) {
                    replaceImpl(i4, i4 + Oxx0IOOO2, Oxx0IOOO2, str, length);
                    i2 = (i2 - Oxx0IOOO2) + length;
                    i4 = (i4 + length) - 1;
                    if (i3 > 0) {
                        i3--;
                    }
    ...
    public StrBuilder deleteFirst(xxIXOIIO xxixoiio) {
        return replace(xxixoiio, null, 0, this.size, 1);
    }
    ...
    */
    ...
    public StrBuilder replaceFirst(xxIXOIIO xxixoiio, String str) {
        return replace(xxixoiio, str, 0, this.size, 1);
    }
    ...
    public StrBuilder replaceAll(xxIXOIIO xxixoiio, String str) {
        return replace(xxixoiio, str, 0, this.size, -1);
    }
    ...
    public StrBuilder deleteAll(xxIXOIIO xxixoiio) {
        return replace(xxixoiio, null, 0, this.size, -1);
    }

    public int lastIndexOf(xxIXOIIO xxixoiio) {
        return lastIndexOf(xxixoiio, this.size);
    }
    ...
    public int lastIndexOf(xxIXOIIO xxixoiio, int i) {
        int i2 = this.size;
        if (i >= i2) {
            i = i2 - 1;
        }
        if (xxixoiio != null && i >= 0) {
            char[] cArr = this.buffer;
            int i3 = i + 1;
            while (i >= 0) {
                if (xxixoiio.Oxx0IOOO(cArr, i, 0, i3) > 0) {
                    return i;
                }
                i--;
            }
    ...
    public int indexOf(xxIXOIIO xxixoiio) {
        return indexOf(xxixoiio, 0);
    }
    ...
    public int indexOf(xxIXOIIO xxixoiio, int i) {
        int i2;
        if (i < 0) {
            i = 0;
        }
        if (xxixoiio != null && i < (i2 = this.size)) {
            char[] cArr = this.buffer;
            for (int i3 = i; i3 < i2; i3++) {
                if (xxixoiio.Oxx0IOOO(cArr, i3, i, i2) > 0) {
                    return i3;
                }
            }
        }
