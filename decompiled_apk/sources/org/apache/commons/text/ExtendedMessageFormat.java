...
public class ExtendedMessageFormat extends MessageFormat {
    ...
    private final Map<String, ? extends X0o0xo> registry;
    ...
    */
    public ExtendedMessageFormat(java.lang.String r2) {
        /*
            r1 = this;
            java.util.Locale$Category r0 = com.google.android.material.badge.oIX0oI.oIX0oI()
            java.util.Locale r0 = com.google.android.exoplayer2.util.xoIox.oIX0oI(r0)
            r1.<init>(r2, r0)
            return
        */
    ...
    private Format getFormat(String str) {
        ...
        if (this.registry != null) {
            ...
            X0o0xo x0o0xo = this.registry.get(str);
            if (x0o0xo != null) {
                return x0o0xo.oIX0oI(str, str2, getLocale());
            }
        }
        return null;
    }
    ...
    private void seekNonWs(String str, ParsePosition parsePosition) {
        char[] charArray = str.toCharArray();
        do {
            int I0Io2 = xOx.II0XooXoX.f34478I0Io.OOXIXo().I0Io(charArray, parsePosition.getIndex(), 0, charArray.length);
            parsePosition.setIndex(parsePosition.getIndex() + I0Io2);
            if (I0Io2 <= 0) {
                return;
            }
        } while (parsePosition.getIndex() < str.length());
                ...
                if (c == '{') {
                    ...
                    if (arrayList.size() == i2) {
                        if (arrayList2.size() == i2) {
                            ...
                            throw new IllegalArgumentException(xoIxX.f32991Oxx0IOOO);
                        }
                    } else {
                        throw new IllegalArgumentException(xoIxX.f32991Oxx0IOOO);
                    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public ExtendedMessageFormat(java.lang.String r2, java.util.Map<java.lang.String, ? extends org.apache.commons.text.X0o0xo> r3) {
        /*
            r1 = this;
            java.util.Locale$Category r0 = com.google.android.material.badge.oIX0oI.oIX0oI()
            java.util.Locale r0 = com.google.android.exoplayer2.util.xoIox.oIX0oI(r0)
    ...
    public ExtendedMessageFormat(String str, Locale locale, Map<String, ? extends X0o0xo> map) {
        super("");
        setLocale(locale);
        this.registry = map;
        applyPattern(str);
