...
public class XO implements Bridge {

    /* renamed from: Oo, reason: collision with root package name */
    public Bridge f1839Oo;

    /* renamed from: XO, reason: collision with root package name */
    public NativeUnifiedADData f1841XO;

    /* renamed from: IXxxXO, reason: collision with root package name */
    public volatile boolean f1838IXxxXO = false;

    /* renamed from: Oxx0xo, reason: collision with root package name */
    public NativeADMediaListener f1840Oxx0xo = new oIX0oI();

    public XO(NativeUnifiedADData nativeUnifiedADData) {
        this.f1841XO = nativeUnifiedADData;
    }

    private void II0xO0(int i) {
        NativeUnifiedADData nativeUnifiedADData = this.f1841XO;
    ...
    private void X0o0xo(Map<String, Object> map) {
        if (map != null && this.f1841XO != null) {
            Object obj = map.get(MediationConstant.BIDDING_LOSE_REASON);
            if (obj instanceof MediationConstant.BiddingLossReason) {
                this.f1841XO.sendLossNotification(0, xxIXOIIO.oIX0oI.oIX0oI((MediationConstant.BiddingLossReason) obj), null);
            }
        }
    }
    ...
    private void oO() {
        this.f1841XO.setNativeAdEventListener(new II0xO0());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void oOoXoXO() {
        Bridge bridge = this.f1839Oo;
        if (bridge != null) {
    ...
    public <T> T call(int i, ValueSet valueSet, Class<T> cls) {
        ...
        if (i == 40048) {
            NativeUnifiedADData nativeUnifiedADData2 = this.f1841XO;
        ...
        if (i == 40049) {
            NativeUnifiedADData nativeUnifiedADData3 = this.f1841XO;
        ...
        if (i == 40050) {
            NativeUnifiedADData nativeUnifiedADData4 = this.f1841XO;
        ...
        if (i == 40051) {
            NativeUnifiedADData nativeUnifiedADData5 = this.f1841XO;
        ...
        if (i == 40052) {
            NativeUnifiedADData nativeUnifiedADData6 = this.f1841XO;
        ...
        if (i == 40003) {
            NativeUnifiedADData nativeUnifiedADData7 = this.f1841XO;
        ...
        if (i == 40010) {
            NativeUnifiedADData nativeUnifiedADData10 = this.f1841XO;
        ...
        if (i == 40056) {
            ...
            NativeUnifiedADData nativeUnifiedADData11 = this.f1841XO;
        ...
        if (i == 40058) {
            ...
            if (!(viewGroup2 instanceof MediaView) || (nativeUnifiedADData = this.f1841XO) == null) {
                return null;
            }
            nativeUnifiedADData.bindMediaView((MediaView) viewGroup2, build, this.f1840Oxx0xo);
            return null;
        }
        if (i == 40059) {
            List<View> list3 = (List) valueSet.objectValue(50021, List.class);
            OxxIIOOXO.oIX0oI("bindCtaViews  ctaViews  = " + list3);
            NativeUnifiedADData nativeUnifiedADData12 = this.f1841XO;
        ...
        if (i == 40009) {
            this.f1839Oo = (Bridge) valueSet.objectValue(MsgField.MSG_HIDE_UI_BTN, Bridge.class);
            return null;
        }
        if (i == 40021) {
            NativeUnifiedADData nativeUnifiedADData13 = this.f1841XO;
        ...
        if (i == 40061) {
            ...
            NativeUnifiedADData nativeUnifiedADData14 = this.f1841XO;
        ...
        if (i == 40062) {
            ...
            NativeUnifiedADData nativeUnifiedADData15 = this.f1841XO;
        ...
        if (i == 40012) {
            T t5 = (T) Boolean.valueOf(this.f1838IXxxXO);
            OxxIIOOXO.oIX0oI("hasDestroy  flag  = " + t5);
            return t5;
        }
        if (i == 40063) {
            OxxIIOOXO.oIX0oI("pauseAppDownload");
            NativeUnifiedADData nativeUnifiedADData16 = this.f1841XO;
        ...
        if (i == 40064) {
            ...
            NativeUnifiedADData nativeUnifiedADData17 = this.f1841XO;
        ...
        NativeUnifiedADData nativeUnifiedADData18 = this.f1841XO;
    ...
    public void oxoX(AdError adError) {
        if (this.f1839Oo != null) {
            MediationValueSetBuilder create = MediationValueSetBuilder.create();
            create.add(50006, new II0XooXoX(adError));
            this.f1839Oo.call(60010, create.build(), Void.class);
        }
    }
