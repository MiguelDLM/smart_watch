...
public final class ScatterMapKt {
    ...
    public static final long group(@OOXIXo long[] metadata, int i) {
    ...
    public static final boolean isDeleted(@OOXIXo long[] metadata, int i) {
        IIX0o.x0xO0oo(metadata, "metadata");
    ...
    public static final boolean isEmpty(@OOXIXo long[] metadata, int i) {
        IIX0o.x0xO0oo(metadata, "metadata");
    ...
    @o0
    public static final long readRawMetadata(@OOXIXo long[] data, int i) {
    ...
    public static final void writeRawMetadata(@OOXIXo long[] data, int i, long j) {
        IIX0o.x0xO0oo(data, "data");
        int i2 = i >> 3;
        int i3 = (i & 7) << 3;
    ...
    public static final boolean isFull(@OOXIXo long[] metadata, int i) {
        IIX0o.x0xO0oo(metadata, "metadata");
        return ((metadata[i >> 3] >> ((i & 7) << 3)) & 255) < 128;
    }

    @OOXIXo
    public static final <K, V> MutableScatterMap<K, V> mutableScatterMapOf(@OOXIXo Pair<? extends K, ? extends V>... pairs) {
