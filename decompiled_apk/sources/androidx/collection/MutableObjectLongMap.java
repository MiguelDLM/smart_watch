...
public final class MutableObjectLongMap<K> extends ObjectLongMap<K> {
    ...
    public final long getOrPut(K k, @OOXIXo Oox.oIX0oI<Long> defaultValue) {
    ...
    public final void plusAssign(@OOXIXo ObjectLongMap<K> from) {
    ...
    public final void putAll(@OOXIXo ObjectLongMap<K> from) {
        IIX0o.x0xO0oo(from, "from");
    ...
    public final void removeIf(@OOXIXo x0xO0oo<? super K, ? super Long, Boolean> predicate) {
