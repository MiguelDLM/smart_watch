...
public final class MutableLongSet extends LongSet {
    ...
    */
    ...
    public final boolean addAll(@OOXIXo LongSet elements) {
        IIX0o.x0xO0oo(elements, "elements");
        int i = this._size;
        plusAssign(elements);
        return i != this._size;
    ...
    public final boolean removeAll(@OOXIXo LongSet elements) {
        IIX0o.x0xO0oo(elements, "elements");
        int i = this._size;
        minusAssign(elements);
        return i != this._size;
    ...
    public final void plusAssign(@OOXIXo LongSet elements) {
        IIX0o.x0xO0oo(elements, "elements");
    ...
    public final void minusAssign(@OOXIXo LongSet elements) {
        IIX0o.x0xO0oo(elements, "elements");
        long[] jArr = elements.elements;
        long[] jArr2 = elements.metadata;
        int length = jArr2.length - 2;
