...
public final class MutableIntIntMap extends IntIntMap {
    ...
    public final int getOrPut(int i, @OOXIXo Oox.oIX0oI<Integer> defaultValue) {
    ...
    public final void plusAssign(@OOXIXo IntIntMap from) {
    ...
    public final void putAll(@OOXIXo IntIntMap from) {
        IIX0o.x0xO0oo(from, "from");
        int[] iArr = from.keys;
    ...
    public final void removeIf(@OOXIXo x0xO0oo<? super Integer, ? super Integer, Boolean> predicate) {
