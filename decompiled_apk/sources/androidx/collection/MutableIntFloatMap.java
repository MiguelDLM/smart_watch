...
public final class MutableIntFloatMap extends IntFloatMap {
    ...
    public final float getOrPut(int i, @OOXIXo Oox.oIX0oI<Float> defaultValue) {
    ...
    public final void plusAssign(@OOXIXo IntFloatMap from) {
    ...
    public final void putAll(@OOXIXo IntFloatMap from) {
        IIX0o.x0xO0oo(from, "from");
        int[] iArr = from.keys;
    ...
    public final void removeIf(@OOXIXo x0xO0oo<? super Integer, ? super Float, Boolean> predicate) {
