...
public final class MutableLongObjectMap<V> extends LongObjectMap<V> {
    ...
    public final V getOrPut(long j, @OOXIXo Oox.oIX0oI<? extends V> defaultValue) {
    ...
    public final void plusAssign(@OOXIXo LongObjectMap<V> from) {
    ...
    public final void putAll(@OOXIXo LongObjectMap<V> from) {
        IIX0o.x0xO0oo(from, "from");
        long[] jArr = from.keys;
    ...
    */
    ...
    public final void removeIf(@OOXIXo x0xO0oo<? super Long, ? super V, Boolean> predicate) {
