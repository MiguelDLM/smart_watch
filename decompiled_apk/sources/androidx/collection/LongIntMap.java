...
public abstract class LongIntMap {
    ...
    public /* synthetic */ LongIntMap(IIXOooo iIXOooo) {
        this();
    }
    ...
    public final boolean all(@OOXIXo x0xO0oo<? super Long, ? super Integer, Boolean> predicate) {
    ...
    public final void forEach(@OOXIXo x0xO0oo<? super Long, ? super Integer, oXIO0o0XI> block) {
    ...
    public final void forEachKey(@OOXIXo Oox.oOoXoXO<? super Long, oXIO0o0XI> block) {
        IIX0o.x0xO0oo(block, "block");
        long[] jArr = this.keys;
        long[] jArr2 = this.metadata;
        int length = jArr2.length - 2;
    ...
    public final void forEachValue(@OOXIXo Oox.oOoXoXO<? super Integer, oXIO0o0XI> block) {
        IIX0o.x0xO0oo(block, "block");
        int[] iArr = this.values;
        long[] jArr = this.metadata;
        int length = jArr.length - 2;
    ...
    public final int getOrElse(long j, @OOXIXo Oox.oIX0oI<Integer> defaultValue) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i5 = 0; i5 < i4; i5++) {
                        if ((255 & j) < 128) {
                            int i6 = (i2 << 3) + i5;
                            i3 += iArr[i6] ^ oIX0oI.oIX0oI(jArr[i6]);
                        }
                        j >>= 8;
                    }
                    if (i4 != 8) {
    ...
    public final boolean any(@OOXIXo x0xO0oo<? super Long, ? super Integer, Boolean> predicate) {
        IIX0o.x0xO0oo(predicate, "predicate");
        long[] jArr = this.keys;
        int[] iArr = this.values;
        long[] jArr2 = this.metadata;
    ...
    public final int count(@OOXIXo x0xO0oo<? super Long, ? super Integer, Boolean> predicate) {
        IIX0o.x0xO0oo(predicate, "predicate");
        long[] jArr = this.keys;
        int[] iArr = this.values;
        long[] jArr2 = this.metadata;
    ...
    public static /* synthetic */ String joinToString$default(LongIntMap longIntMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, x0xO0oo transform, int i2, Object obj) {
        long[] jArr;
        long[] jArr2;
        if (obj == null) {
                    ...
                    if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i8 < i7) {
                            if ((j & 255) < 128) {
                                ...
                                jArr2 = jArr4;
                                sb.append((CharSequence) transform.invoke(valueOf, Integer.valueOf(i10)));
                                i5++;
                            } else {
                                jArr2 = jArr4;
                            }
    ...
    @OOXIXo
    @xoIox
    public final String joinToString(@OOXIXo CharSequence charSequence, @OOXIXo CharSequence prefix, @OOXIXo CharSequence postfix, int i, @OOXIXo CharSequence truncated, @OOXIXo x0xO0oo<? super Long, ? super Integer, ? extends CharSequence> transform) {
    ...
    @OOXIXo
    @xoIox
    public final String joinToString(@OOXIXo CharSequence charSequence, @OOXIXo CharSequence prefix, @OOXIXo CharSequence postfix, int i, @OOXIXo x0xO0oo<? super Long, ? super Integer, ? extends CharSequence> transform) {
        CharSequence separator = charSequence;
        IIX0o.x0xO0oo(separator, "separator");
        IIX0o.x0xO0oo(prefix, "prefix");
        IIX0o.x0xO0oo(postfix, "postfix");
    ...
    @OOXIXo
    @xoIox
    public final String joinToString(@OOXIXo CharSequence separator, @OOXIXo CharSequence prefix, @OOXIXo CharSequence postfix, @OOXIXo x0xO0oo<? super Long, ? super Integer, ? extends CharSequence> transform) {
        IIX0o.x0xO0oo(separator, "separator");
        IIX0o.x0xO0oo(prefix, "prefix");
        IIX0o.x0xO0oo(postfix, "postfix");
        IIX0o.x0xO0oo(transform, "transform");
    ...
    @OOXIXo
    @xoIox
    public final String joinToString(@OOXIXo CharSequence separator, @OOXIXo CharSequence prefix, @OOXIXo x0xO0oo<? super Long, ? super Integer, ? extends CharSequence> transform) {
        IIX0o.x0xO0oo(separator, "separator");
        IIX0o.x0xO0oo(prefix, "prefix");
        IIX0o.x0xO0oo(transform, "transform");
        StringBuilder sb = new StringBuilder();
    ...
    @OOXIXo
    @xoIox
    public final String joinToString(@OOXIXo CharSequence separator, @OOXIXo x0xO0oo<? super Long, ? super Integer, ? extends CharSequence> transform) {
        IIX0o.x0xO0oo(separator, "separator");
        IIX0o.x0xO0oo(transform, "transform");
        StringBuilder sb = new StringBuilder();
        sb.append((CharSequence) "");
    ...
    @OOXIXo
    @xoIox
    public final String joinToString(@OOXIXo x0xO0oo<? super Long, ? super Integer, ? extends CharSequence> transform) {
        IIX0o.x0xO0oo(transform, "transform");
        StringBuilder sb = new StringBuilder();
        sb.append((CharSequence) "");
        long[] jArr = this.keys;
