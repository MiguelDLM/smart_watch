...
public final class MutableFloatIntMap extends FloatIntMap {
    ...
    public final int getOrPut(float f, @OOXIXo Oox.oIX0oI<Integer> defaultValue) {
    ...
    public final void plusAssign(@OOXIXo FloatIntMap from) {
    ...
    public final void putAll(@OOXIXo FloatIntMap from) {
        IIX0o.x0xO0oo(from, "from");
    ...
    public final void removeIf(@OOXIXo x0xO0oo<? super Float, ? super Integer, Boolean> predicate) {
