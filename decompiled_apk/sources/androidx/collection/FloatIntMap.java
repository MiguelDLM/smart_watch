...
public abstract class FloatIntMap {
    ...
    public final boolean all(@OOXIXo x0xO0oo<? super Float, ? super Integer, Boolean> predicate) {
    ...
    public final void forEach(@OOXIXo x0xO0oo<? super Float, ? super Integer, oXIO0o0XI> block) {
    ...
    public final void forEachKey(@OOXIXo Oox.oOoXoXO<? super Float, oXIO0o0XI> block) {
        IIX0o.x0xO0oo(block, "block");
        float[] fArr = this.keys;
        long[] jArr = this.metadata;
        int length = jArr.length - 2;
    ...
    public final int getOrElse(float f, @OOXIXo Oox.oIX0oI<Integer> defaultValue) {
    ...
    public final boolean any(@OOXIXo x0xO0oo<? super Float, ? super Integer, Boolean> predicate) {
        IIX0o.x0xO0oo(predicate, "predicate");
        float[] fArr = this.keys;
        int[] iArr = this.values;
        long[] jArr = this.metadata;
    ...
    public final int count(@OOXIXo x0xO0oo<? super Float, ? super Integer, Boolean> predicate) {
        IIX0o.x0xO0oo(predicate, "predicate");
        float[] fArr = this.keys;
        int[] iArr = this.values;
        long[] jArr = this.metadata;
    ...
    public static /* synthetic */ String joinToString$default(FloatIntMap floatIntMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, x0xO0oo transform, int i2, Object obj) {
        long[] jArr;
        long[] jArr2;
        if (obj == null) {
    ...
    @OOXIXo
    @xoIox
    public final String joinToString(@OOXIXo CharSequence charSequence, @OOXIXo CharSequence prefix, @OOXIXo CharSequence postfix, int i, @OOXIXo CharSequence truncated, @OOXIXo x0xO0oo<? super Float, ? super Integer, ? extends CharSequence> transform) {
    ...
    @OOXIXo
    @xoIox
    public final String joinToString(@OOXIXo CharSequence charSequence, @OOXIXo CharSequence prefix, @OOXIXo CharSequence postfix, int i, @OOXIXo x0xO0oo<? super Float, ? super Integer, ? extends CharSequence> transform) {
        CharSequence separator = charSequence;
        IIX0o.x0xO0oo(separator, "separator");
        IIX0o.x0xO0oo(prefix, "prefix");
        IIX0o.x0xO0oo(postfix, "postfix");
    ...
    @OOXIXo
    @xoIox
    public final String joinToString(@OOXIXo CharSequence separator, @OOXIXo CharSequence prefix, @OOXIXo CharSequence postfix, @OOXIXo x0xO0oo<? super Float, ? super Integer, ? extends CharSequence> transform) {
        IIX0o.x0xO0oo(separator, "separator");
        IIX0o.x0xO0oo(prefix, "prefix");
        IIX0o.x0xO0oo(postfix, "postfix");
        IIX0o.x0xO0oo(transform, "transform");
    ...
    @OOXIXo
    @xoIox
    public final String joinToString(@OOXIXo CharSequence separator, @OOXIXo CharSequence prefix, @OOXIXo x0xO0oo<? super Float, ? super Integer, ? extends CharSequence> transform) {
        IIX0o.x0xO0oo(separator, "separator");
        IIX0o.x0xO0oo(prefix, "prefix");
        IIX0o.x0xO0oo(transform, "transform");
        StringBuilder sb = new StringBuilder();
    ...
    @OOXIXo
    @xoIox
    public final String joinToString(@OOXIXo CharSequence separator, @OOXIXo x0xO0oo<? super Float, ? super Integer, ? extends CharSequence> transform) {
        IIX0o.x0xO0oo(separator, "separator");
        IIX0o.x0xO0oo(transform, "transform");
        StringBuilder sb = new StringBuilder();
        sb.append((CharSequence) "");
    ...
    @OOXIXo
    @xoIox
    public final String joinToString(@OOXIXo x0xO0oo<? super Float, ? super Integer, ? extends CharSequence> transform) {
        IIX0o.x0xO0oo(transform, "transform");
        StringBuilder sb = new StringBuilder();
        sb.append((CharSequence) "");
        float[] fArr = this.keys;
