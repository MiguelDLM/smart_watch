...
public abstract class LongObjectMap<V> {
    ...
    public final boolean all(@OOXIXo x0xO0oo<? super Long, ? super V, Boolean> predicate) {
    ...
    */
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i5 < i4) {
                        if ((255 & j) < 128) {
                            ...
                            } else if (!IIX0o.Oxx0IOOO(obj2, longObjectMap.get(j2))) {
                                return false;
                            }
                            i3 = 8;
                        } else {
    ...
    public final void forEach(@OOXIXo x0xO0oo<? super Long, ? super V, oXIO0o0XI> block) {
    ...
    */
    ...
    public final V getOrElse(long j, @OOXIXo Oox.oIX0oI<? extends V> defaultValue) {
    ...
    public final boolean any(@OOXIXo x0xO0oo<? super Long, ? super V, Boolean> predicate) {
        IIX0o.x0xO0oo(predicate, "predicate");
        long[] jArr = this.keys;
        Object[] objArr = this.values;
        long[] jArr2 = this.metadata;
    ...
    public final int count(@OOXIXo x0xO0oo<? super Long, ? super V, Boolean> predicate) {
        IIX0o.x0xO0oo(predicate, "predicate");
        long[] jArr = this.keys;
        Object[] objArr = this.values;
        long[] jArr2 = this.metadata;
    ...
    public static /* synthetic */ String joinToString$default(LongObjectMap longObjectMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, x0xO0oo transform, int i2, Object obj) {
        long[] jArr;
        long[] jArr2;
        if (obj == null) {
    ...
    @OOXIXo
    @xoIox
    public final String joinToString(@OOXIXo CharSequence charSequence, @OOXIXo CharSequence prefix, @OOXIXo CharSequence postfix, int i, @OOXIXo CharSequence truncated, @OOXIXo x0xO0oo<? super Long, ? super V, ? extends CharSequence> transform) {
        long[] jArr;
        long[] jArr2;
    ...
    @OOXIXo
    @xoIox
    public final String joinToString(@OOXIXo CharSequence separator, @OOXIXo CharSequence prefix, @OOXIXo CharSequence postfix, int i, @OOXIXo x0xO0oo<? super Long, ? super V, ? extends CharSequence> transform) {
        IIX0o.x0xO0oo(separator, "separator");
        IIX0o.x0xO0oo(prefix, "prefix");
        IIX0o.x0xO0oo(postfix, "postfix");
        IIX0o.x0xO0oo(transform, "transform");
    ...
    @OOXIXo
    @xoIox
    public final String joinToString(@OOXIXo CharSequence separator, @OOXIXo CharSequence prefix, @OOXIXo CharSequence postfix, @OOXIXo x0xO0oo<? super Long, ? super V, ? extends CharSequence> transform) {
        IIX0o.x0xO0oo(separator, "separator");
        IIX0o.x0xO0oo(prefix, "prefix");
        IIX0o.x0xO0oo(postfix, "postfix");
        IIX0o.x0xO0oo(transform, "transform");
    ...
    @OOXIXo
    @xoIox
    public final String joinToString(@OOXIXo CharSequence separator, @OOXIXo CharSequence prefix, @OOXIXo x0xO0oo<? super Long, ? super V, ? extends CharSequence> transform) {
        IIX0o.x0xO0oo(separator, "separator");
        IIX0o.x0xO0oo(prefix, "prefix");
        IIX0o.x0xO0oo(transform, "transform");
        StringBuilder sb = new StringBuilder();
    ...
    @OOXIXo
    @xoIox
    public final String joinToString(@OOXIXo CharSequence separator, @OOXIXo x0xO0oo<? super Long, ? super V, ? extends CharSequence> transform) {
        IIX0o.x0xO0oo(separator, "separator");
        IIX0o.x0xO0oo(transform, "transform");
        StringBuilder sb = new StringBuilder();
        sb.append((CharSequence) "");
    ...
    @OOXIXo
    @xoIox
    public final String joinToString(@OOXIXo x0xO0oo<? super Long, ? super V, ? extends CharSequence> transform) {
        IIX0o.x0xO0oo(transform, "transform");
        StringBuilder sb = new StringBuilder();
        sb.append((CharSequence) "");
        long[] jArr = this.keys;
