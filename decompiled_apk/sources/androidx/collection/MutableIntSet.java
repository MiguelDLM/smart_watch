...
public final class MutableIntSet extends IntSet {
    ...
    */
    ...
    public final boolean addAll(@OOXIXo IntSet elements) {
        IIX0o.x0xO0oo(elements, "elements");
        int i = this._size;
        plusAssign(elements);
        return i != this._size;
    ...
    public final boolean removeAll(@OOXIXo IntSet elements) {
        IIX0o.x0xO0oo(elements, "elements");
        int i = this._size;
        minusAssign(elements);
        return i != this._size;
    ...
    public final void plusAssign(@OOXIXo IntSet elements) {
        IIX0o.x0xO0oo(elements, "elements");
    ...
    public final void minusAssign(@OOXIXo IntSet elements) {
        IIX0o.x0xO0oo(elements, "elements");
        int[] iArr = elements.elements;
        long[] jArr = elements.metadata;
        int length = jArr.length - 2;
