...
public final class MutableLongLongMap extends LongLongMap {
    ...
    public final long getOrPut(long j, @OOXIXo Oox.oIX0oI<Long> defaultValue) {
    ...
    public final void plusAssign(@OOXIXo LongLongMap from) {
    ...
    public final void putAll(@OOXIXo LongLongMap from) {
        IIX0o.x0xO0oo(from, "from");
        long[] jArr = from.keys;
    ...
    public final void removeIf(@OOXIXo x0xO0oo<? super Long, ? super Long, Boolean> predicate) {
