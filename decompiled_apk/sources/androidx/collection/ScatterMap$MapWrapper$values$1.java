...
public final class ScatterMap$MapWrapper$values$1<V> implements Collection<V>, OI0IXox.oIX0oI {
    ...
    public Iterator<V> iterator() {
        return IXxxXO.oIX0oI(new ScatterMap$MapWrapper$values$1$iterator$1(this.this$0, null));
    }
