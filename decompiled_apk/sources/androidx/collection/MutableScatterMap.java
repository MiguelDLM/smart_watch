...
public final class MutableScatterMap<K, V> extends ScatterMap<K, V> {
    ...
    /* loaded from: classes.dex */
    public final class MutableMapWrapper extends ScatterMap<K, V>.MapWrapper implements Map<K, V>, Oxx0IOOO {
    ...
    public final void clear() {
        ...
        ooOOo0oXI.xX(this.values, null, 0, this._capacity);
        ooOOo0oXI.xX(this.keys, null, 0, this._capacity);
        initializeGrowth();
    }

    public final V compute(K k, @OOXIXo x0xO0oo<? super K, ? super V, ? extends V> computeBlock) {
        boolean z;
        Object obj;
        IIX0o.x0xO0oo(computeBlock, "computeBlock");
        ...
        V invoke = computeBlock.invoke(k, obj);
        if (z) {
    ...
    public final V getOrPut(K k, @OOXIXo Oox.oIX0oI<? extends V> defaultValue) {
    ...
    public final void plusAssign(@OOXIXo Pair<? extends K, ? extends V> pair) {
    ...
    public final void putAll(@OOXIXo Pair<? extends K, ? extends V>[] pairs) {
    ...
    */
    ...
    public final void removeIf(@OOXIXo x0xO0oo<? super K, ? super V, Boolean> predicate) {
    ...
    public /* synthetic */ MutableScatterMap(int i, int i2, IIXOooo iIXOooo) {
        this((i2 & 1) != 0 ? 6 : i);
    }

    public final void minusAssign(@OOXIXo K[] keys) {
    ...
    public final void plusAssign(@OOXIXo Pair<? extends K, ? extends V>[] pairs) {
        IIX0o.x0xO0oo(pairs, "pairs");
        putAll(pairs);
    }
    ...
    public final void plusAssign(@OOXIXo Iterable<? extends Pair<? extends K, ? extends V>> pairs) {
        IIX0o.x0xO0oo(pairs, "pairs");
        putAll(pairs);
    }

    public final void putAll(@OOXIXo Iterable<? extends Pair<? extends K, ? extends V>> pairs) {
        IIX0o.x0xO0oo(pairs, "pairs");
        for (Pair<? extends K, ? extends V> pair : pairs) {
            set(pair.component1(), pair.component2());
        }
    ...
    public final void minusAssign(@OOXIXo Iterable<? extends K> keys) {
        IIX0o.x0xO0oo(keys, "keys");
    ...
    public final void plusAssign(@OOXIXo kotlin.sequences.ooOOo0oXI<? extends Pair<? extends K, ? extends V>> pairs) {
        IIX0o.x0xO0oo(pairs, "pairs");
        putAll(pairs);
    }

    public final void plusAssign(@OOXIXo Map<K, ? extends V> from) {
        IIX0o.x0xO0oo(from, "from");
        putAll(from);
    }

    public final void putAll(@OOXIXo kotlin.sequences.ooOOo0oXI<? extends Pair<? extends K, ? extends V>> pairs) {
        IIX0o.x0xO0oo(pairs, "pairs");
        for (Pair<? extends K, ? extends V> pair : pairs) {
            set(pair.component1(), pair.component2());
        }
    ...
    public final void minusAssign(@OOXIXo kotlin.sequences.ooOOo0oXI<? extends K> keys) {
        IIX0o.x0xO0oo(keys, "keys");
        Iterator<? extends K> it = keys.iterator();
        while (it.hasNext()) {
            remove(it.next());
    ...
    public final void plusAssign(@OOXIXo ScatterMap<K, V> from) {
        IIX0o.x0xO0oo(from, "from");
        putAll(from);
    }

    public final void putAll(@OOXIXo Map<K, ? extends V> from) {
        IIX0o.x0xO0oo(from, "from");
    ...
    public final void minusAssign(@OOXIXo ScatterSet<K> keys) {
        IIX0o.x0xO0oo(keys, "keys");
    ...
    */
    public final boolean remove(K r18, V r19) {
        ...
        L73:
            ...
            r1 = r1[r11]
            r7 = r19
            boolean r1 = kotlin.jvm.internal.IIX0o.Oxx0IOOO(r1, r7)
            if (r1 == 0) goto L85
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public final void putAll(@OOXIXo ScatterMap<K, V> from) {
        IIX0o.x0xO0oo(from, "from");
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public final void minusAssign(@OOXIXo ObjectList<K> keys) {
        IIX0o.x0xO0oo(keys, "keys");
