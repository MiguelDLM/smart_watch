...
public final class MutableLongIntMap extends LongIntMap {
    ...
    public final int getOrPut(long j, @OOXIXo Oox.oIX0oI<Integer> defaultValue) {
    ...
    public final void plusAssign(@OOXIXo LongIntMap from) {
    ...
    public final void putAll(@OOXIXo LongIntMap from) {
        IIX0o.x0xO0oo(from, "from");
        long[] jArr = from.keys;
    ...
    public final void removeIf(@OOXIXo x0xO0oo<? super Long, ? super Integer, Boolean> predicate) {
