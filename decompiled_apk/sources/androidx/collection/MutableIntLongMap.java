...
public final class MutableIntLongMap extends IntLongMap {
    ...
    public final long getOrPut(int i, @OOXIXo Oox.oIX0oI<Long> defaultValue) {
    ...
    public final void plusAssign(@OOXIXo IntLongMap from) {
    ...
    public final void putAll(@OOXIXo IntLongMap from) {
        IIX0o.x0xO0oo(from, "from");
        int[] iArr = from.keys;
    ...
    public final void removeIf(@OOXIXo x0xO0oo<? super Integer, ? super Long, Boolean> predicate) {
