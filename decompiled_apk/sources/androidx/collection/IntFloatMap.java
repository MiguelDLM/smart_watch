...
public abstract class IntFloatMap {
    ...
    public final boolean all(@OOXIXo x0xO0oo<? super Integer, ? super Float, Boolean> predicate) {
    ...
    public final void forEach(@OOXIXo x0xO0oo<? super Integer, ? super Float, oXIO0o0XI> block) {
    ...
    public final float getOrElse(int i, @OOXIXo Oox.oIX0oI<Float> defaultValue) {
    ...
    public final boolean any(@OOXIXo x0xO0oo<? super Integer, ? super Float, Boolean> predicate) {
        IIX0o.x0xO0oo(predicate, "predicate");
        int[] iArr = this.keys;
        float[] fArr = this.values;
        long[] jArr = this.metadata;
    ...
    public final int count(@OOXIXo x0xO0oo<? super Integer, ? super Float, Boolean> predicate) {
        IIX0o.x0xO0oo(predicate, "predicate");
        int[] iArr = this.keys;
        float[] fArr = this.values;
        long[] jArr = this.metadata;
    ...
    public static /* synthetic */ String joinToString$default(IntFloatMap intFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, x0xO0oo transform, int i2, Object obj) {
        long[] jArr;
        long[] jArr2;
        if (obj == null) {
    ...
    @OOXIXo
    @xoIox
    public final String joinToString(@OOXIXo CharSequence charSequence, @OOXIXo CharSequence prefix, @OOXIXo CharSequence postfix, int i, @OOXIXo CharSequence truncated, @OOXIXo x0xO0oo<? super Integer, ? super Float, ? extends CharSequence> transform) {
    ...
    @OOXIXo
    @xoIox
    public final String joinToString(@OOXIXo CharSequence charSequence, @OOXIXo CharSequence prefix, @OOXIXo CharSequence postfix, int i, @OOXIXo x0xO0oo<? super Integer, ? super Float, ? extends CharSequence> transform) {
        CharSequence separator = charSequence;
        IIX0o.x0xO0oo(separator, "separator");
        IIX0o.x0xO0oo(prefix, "prefix");
        IIX0o.x0xO0oo(postfix, "postfix");
    ...
    @OOXIXo
    @xoIox
    public final String joinToString(@OOXIXo CharSequence separator, @OOXIXo CharSequence prefix, @OOXIXo CharSequence postfix, @OOXIXo x0xO0oo<? super Integer, ? super Float, ? extends CharSequence> transform) {
        IIX0o.x0xO0oo(separator, "separator");
        IIX0o.x0xO0oo(prefix, "prefix");
        IIX0o.x0xO0oo(postfix, "postfix");
        IIX0o.x0xO0oo(transform, "transform");
    ...
    @OOXIXo
    @xoIox
    public final String joinToString(@OOXIXo CharSequence separator, @OOXIXo CharSequence prefix, @OOXIXo x0xO0oo<? super Integer, ? super Float, ? extends CharSequence> transform) {
        IIX0o.x0xO0oo(separator, "separator");
        IIX0o.x0xO0oo(prefix, "prefix");
        IIX0o.x0xO0oo(transform, "transform");
        StringBuilder sb = new StringBuilder();
    ...
    @OOXIXo
    @xoIox
    public final String joinToString(@OOXIXo CharSequence separator, @OOXIXo x0xO0oo<? super Integer, ? super Float, ? extends CharSequence> transform) {
        IIX0o.x0xO0oo(separator, "separator");
        IIX0o.x0xO0oo(transform, "transform");
        StringBuilder sb = new StringBuilder();
        sb.append((CharSequence) "");
    ...
    @OOXIXo
    @xoIox
    public final String joinToString(@OOXIXo x0xO0oo<? super Integer, ? super Float, ? extends CharSequence> transform) {
        IIX0o.x0xO0oo(transform, "transform");
        StringBuilder sb = new StringBuilder();
        sb.append((CharSequence) "");
        int[] iArr = this.keys;
