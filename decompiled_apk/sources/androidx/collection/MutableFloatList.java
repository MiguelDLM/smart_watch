...
public final class MutableFloatList extends FloatList {
    ...
    public final boolean addAll(@IntRange(from = 0) int i, @OOXIXo float[] elements) {
        int i2;
        ...
        if (i >= 0 && i <= (i2 = this._size)) {
            ...
            int i3 = this._size;
            if (i != i3) {
                ooOOo0oXI.OOXIxO0(fArr, fArr, elements.length + i, i, i3);
            }
            ooOOo0oXI.oXIO0o0XI(elements, fArr, i, 0, 0, 12, null);
    ...
    public final void plusAssign(@OOXIXo FloatList elements) {
        IIX0o.x0xO0oo(elements, "elements");
    ...
    public final boolean removeAll(@OOXIXo float[] elements) {
        IIX0o.x0xO0oo(elements, "elements");
        int i = this._size;
    ...
    public final boolean retainAll(@OOXIXo float[] elements) {
        IIX0o.x0xO0oo(elements, "elements");
        int i = this._size;
        float[] fArr = this.content;
        int i2 = i - 1;
    ...
    public final void minusAssign(@OOXIXo float[] elements) {
        IIX0o.x0xO0oo(elements, "elements");
        for (float f : elements) {
            remove(f);
        }
    ...
    public final void plusAssign(@OOXIXo float[] elements) {
        IIX0o.x0xO0oo(elements, "elements");
        addAll(this._size, elements);
    }
    ...
    public final void minusAssign(@OOXIXo FloatList elements) {
        IIX0o.x0xO0oo(elements, "elements");
    ...
    public final boolean removeAll(@OOXIXo FloatList elements) {
        IIX0o.x0xO0oo(elements, "elements");
        int i = this._size;
    ...
    public final boolean retainAll(@OOXIXo FloatList elements) {
        IIX0o.x0xO0oo(elements, "elements");
        int i = this._size;
        float[] fArr = this.content;
    ...
    public final boolean addAll(@IntRange(from = 0) int i, @OOXIXo FloatList elements) {
        IIX0o.x0xO0oo(elements, "elements");
        if (i >= 0 && i <= this._size) {
            if (elements.isEmpty()) {
                return false;
            ...
            int i2 = this._size;
            if (i != i2) {
                ooOOo0oXI.OOXIxO0(fArr, fArr, elements._size + i, i, i2);
            }
            ooOOo0oXI.OOXIxO0(elements.content, fArr, i, 0, elements._size);
    ...
    public final boolean addAll(@OOXIXo FloatList elements) {
        IIX0o.x0xO0oo(elements, "elements");
        return addAll(this._size, elements);
    }

    public final boolean addAll(@OOXIXo float[] elements) {
        IIX0o.x0xO0oo(elements, "elements");
        return addAll(this._size, elements);
    }
}
