...
public final class ScatterMap$MapWrapper$values$1$iterator$1<V> extends RestrictedSuspendLambda implements x0xO0oo<oO<? super V>, I0Io<? super oXIO0o0XI>, Object> {
    int I$0;
    int I$1;
    int I$2;
    int I$3;
    ...
    */
    ...
    public final Object invoke(@OOXIXo oO<? super V> oOVar, @oOoXoXO I0Io<? super oXIO0o0XI> i0Io) {
        return ((ScatterMap$MapWrapper$values$1$iterator$1) create(oOVar, i0Io)).invokeSuspend(oXIO0o0XI.f29392oIX0oI);
    }
}
