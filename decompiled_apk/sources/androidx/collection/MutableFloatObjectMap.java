...
public final class MutableFloatObjectMap<V> extends FloatObjectMap<V> {
    ...
    public final V getOrPut(float f, @OOXIXo Oox.oIX0oI<? extends V> defaultValue) {
    ...
    public final void plusAssign(@OOXIXo FloatObjectMap<V> from) {
    ...
    public final void putAll(@OOXIXo FloatObjectMap<V> from) {
        IIX0o.x0xO0oo(from, "from");
    ...
    */
    ...
    public final void removeIf(@OOXIXo x0xO0oo<? super Float, ? super V, Boolean> predicate) {
