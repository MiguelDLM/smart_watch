...
public final class MutableObjectFloatMap<K> extends ObjectFloatMap<K> {
    ...
    public final float getOrPut(K k, @OOXIXo Oox.oIX0oI<Float> defaultValue) {
    ...
    public final void plusAssign(@OOXIXo ObjectFloatMap<K> from) {
    ...
    public final void putAll(@OOXIXo ObjectFloatMap<K> from) {
        IIX0o.x0xO0oo(from, "from");
    ...
    public final void removeIf(@OOXIXo x0xO0oo<? super K, ? super Float, Boolean> predicate) {
