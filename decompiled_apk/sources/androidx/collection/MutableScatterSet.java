...
public final class MutableScatterSet<E> extends ScatterSet<E> {
    ...
    /* loaded from: classes.dex */
    public final class MutableSetWrapper extends ScatterSet<E>.SetWrapper implements Set<E>, II0XooXoX {
    ...
    public final void clear() {
        ...
        ooOOo0oXI.xX(this.elements, null, 0, this._capacity);
        initializeGrowth();
    }
    ...
    */
    ...
    public final void removeIf(@OOXIXo oOoXoXO<? super E, Boolean> predicate) {
    ...
    public /* synthetic */ MutableScatterSet(int i, int i2, IIXOooo iIXOooo) {
        this((i2 & 1) != 0 ? 6 : i);
    }
