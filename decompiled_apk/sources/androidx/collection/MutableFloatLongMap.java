...
public final class MutableFloatLongMap extends FloatLongMap {
    ...
    public final long getOrPut(float f, @OOXIXo Oox.oIX0oI<Long> defaultValue) {
    ...
    public final void plusAssign(@OOXIXo FloatLongMap from) {
    ...
    public final void putAll(@OOXIXo FloatLongMap from) {
        IIX0o.x0xO0oo(from, "from");
    ...
    public final void removeIf(@OOXIXo x0xO0oo<? super Float, ? super Long, Boolean> predicate) {
