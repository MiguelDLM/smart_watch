...
public final class MutableFloatSet extends FloatSet {
    ...
    */
    ...
    public /* synthetic */ MutableFloatSet(int i, int i2, IIXOooo iIXOooo) {
        this((i2 & 1) != 0 ? 6 : i);
    }
    ...
    public final boolean addAll(@OOXIXo FloatSet elements) {
        IIX0o.x0xO0oo(elements, "elements");
        int i = this._size;
        plusAssign(elements);
        return i != this._size;
    ...
    public final boolean removeAll(@OOXIXo FloatSet elements) {
        IIX0o.x0xO0oo(elements, "elements");
        int i = this._size;
        minusAssign(elements);
        return i != this._size;
    ...
    public final void plusAssign(@OOXIXo FloatSet elements) {
        IIX0o.x0xO0oo(elements, "elements");
    ...
    public final void minusAssign(@OOXIXo FloatSet elements) {
        IIX0o.x0xO0oo(elements, "elements");
        float[] fArr = elements.elements;
        long[] jArr = elements.metadata;
        int length = jArr.length - 2;
