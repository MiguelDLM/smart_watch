...
public final class MutableScatterMap$MutableMapWrapper$keys$1<K> implements Set<K>, II0XooXoX {
    ...
    @Override // java.util.Set, java.util.Collection
    public boolean addAll(@OOXIXo Collection<? extends K> elements) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (CollectionsKt___CollectionsKt.X00xOoXI(elements, mutableScatterMap.keys[i4])) {
