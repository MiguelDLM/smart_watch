...
public final class MutableObjectIntMap<K> extends ObjectIntMap<K> {
    ...
    public final int getOrPut(K k, @OOXIXo Oox.oIX0oI<Integer> defaultValue) {
    ...
    public final void plusAssign(@OOXIXo ObjectIntMap<K> from) {
    ...
    public final void putAll(@OOXIXo ObjectIntMap<K> from) {
        IIX0o.x0xO0oo(from, "from");
    ...
    public final void removeIf(@OOXIXo x0xO0oo<? super K, ? super Integer, Boolean> predicate) {
    ...
    public /* synthetic */ MutableObjectIntMap(int i, int i2, IIXOooo iIXOooo) {
        this((i2 & 1) != 0 ? 6 : i);
    }
