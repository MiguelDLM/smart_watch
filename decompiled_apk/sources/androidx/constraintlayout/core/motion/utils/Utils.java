...
public class Utils {
    ...
    public static void log(String str) {
        ...
        String str2 = ".(" + stackTraceElement.getFileName() + ":" + stackTraceElement.getLineNumber() + oIX0oI.I0Io.f4095I0Io + OOXIXo.f1567xI.substring(Integer.toString(stackTraceElement.getLineNumber()).length()) + substring;
