...
import androidx.constraintlayout.core.motion.utils.XO;
...
public class MotionKeyPosition extends MotionKey {
    ...
    public boolean intersects(int i, int i2, FloatRect floatRect, FloatRect floatRect2, float f, float f2) {
        ...
        if (Math.abs(f - this.mCalculatedPositionX) < SELECTION_SLOPE && Math.abs(f2 - this.mCalculatedPositionY) < SELECTION_SLOPE) {
            return true;
        }
        return false;
    }
