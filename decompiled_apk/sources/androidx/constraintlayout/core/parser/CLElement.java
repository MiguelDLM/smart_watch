...
public class CLElement implements Cloneable {
    ...
    public String getDebugName() {
        if (CLParser.sDebug) {
            return getStrClass() + oIX0oI.f33048oxoX;
        }
        return "";
    }
    ...
    public void setEnd(long j) {
        ...
        this.mEnd = j;
        if (CLParser.sDebug) {
            System.out.println("closing " + hashCode() + oIX0oI.f33048oxoX + this);
        }
        CLContainer cLContainer = this.mContainer;
        if (cLContainer != null) {
    ...
    public String toString() {
        ...
        return getClass() + " (INVALID, " + this.mStart + HelpFormatter.DEFAULT_OPT_PREFIX + this.mEnd + oIX0oI.I0Io.f4095I0Io;
    }
