...
public class Transition implements TypedValues {
    ...
    public static class OnSwipe {
        ...
        public static final String[] DIRECTIONS = {"up", ScrollClickView.f19358IIX0o, "left", "right", "start", "end", "clockwise", "anticlockwise"};
    ...
    public static Interpolator getInterpolator(int i, final String str) {
        switch (i) {
            case -1:
                return new Interpolator() { // from class: androidx.constraintlayout.core.state.oIX0oI
            ...
            case 0:
                return new Interpolator() { // from class: androidx.constraintlayout.core.state.II0xO0
                    @Override // androidx.constraintlayout.core.state.Interpolator
                    public final float getInterpolation(float f) {
            ...
            case 1:
                return new Interpolator() { // from class: androidx.constraintlayout.core.state.I0Io
                    @Override // androidx.constraintlayout.core.state.Interpolator
                    public final float getInterpolation(float f) {
            ...
            case 2:
                return new Interpolator() { // from class: androidx.constraintlayout.core.state.oxoX
                    @Override // androidx.constraintlayout.core.state.Interpolator
                    public final float getInterpolation(float f) {
            ...
            case 3:
                return new Interpolator() { // from class: androidx.constraintlayout.core.state.X0o0xo
                    @Override // androidx.constraintlayout.core.state.Interpolator
                    public final float getInterpolation(float f) {
            ...
            case 4:
                return new Interpolator() { // from class: androidx.constraintlayout.core.state.II0XooXoX
                    @Override // androidx.constraintlayout.core.state.Interpolator
                    public final float getInterpolation(float f) {
            ...
            case 5:
                return new Interpolator() { // from class: androidx.constraintlayout.core.state.Oxx0IOOO
                    @Override // androidx.constraintlayout.core.state.Interpolator
                    public final float getInterpolation(float f) {
            ...
            case 6:
                return new Interpolator() { // from class: androidx.constraintlayout.core.state.XO
                    @Override // androidx.constraintlayout.core.state.Interpolator
                    public final float getInterpolation(float f) {
