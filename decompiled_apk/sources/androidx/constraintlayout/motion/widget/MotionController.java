    ...
    public void buildPath(float[] fArr, int i) {
        ...
        while (i3 < i2) {
            ...
            if (viewOscillator != null) {
                ...
                fArr[i4] = fArr[i4] + viewSpline.get(f3);
            }
            if (viewOscillator2 != null) {
                int i5 = i4 + 1;
                fArr[i5] = fArr[i5] + viewOscillator2.get(f3);
            } else if (viewSpline2 != null) {
                int i6 = i4 + 1;
                fArr[i6] = fArr[i6] + viewSpline2.get(f3);
            }
            i3++;
            i2 = i;
            f = 1.0f;
            ...
            while (i21 < i7) {
                if (motionPathsArr[i21].hasCustomData(str8)) {
                    if (dArr5 == null) {
                        ...
                        iArr3[c] = motionPathsArr[i21].getCustomDataCount(str8);
                        iArr3[0] = i7;
                    ...
                    motionPaths.getCustomData(str8, dArr5[i22], 0);
                    i22++;
                } else {
                    dArr = dArr2;
                }
