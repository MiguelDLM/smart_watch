                ...
                if (eventType != 1) {
                    if (eventType == 2) {
                        ...
                        switch (c) {
                            ...
                            case 2:
                                if (transition == null) {
                                    Log.v(TypedValues.MotionScene.NAME, " OnSwipe (" + context.getResources().getResourceEntryName(i) + ".xml:" + xml.getLineNumber() + oIX0oI.I0Io.f4095I0Io);
                                }
                                if (transition == null) {
                                    break;
                                } else {
        ...
        if (i != -1) {
            ...
            if (action != 0) {
                if (action == 2 && !this.mIgnoreTouch) {
                    ...
                    if ((rawX == OOXIXo.f3760XO && rawY == OOXIXo.f3760XO) || (motionEvent2 = this.mLastTouchDown) == null) {
                        return;
                    }
    ...
    */
    ...
    public static class Transition {
        ...
        private void fill(MotionScene motionScene, Context context, TypedArray typedArray) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == R.styleable.Transition_constraintSetEnd) {
                    ...
                    } else if (XIxXXX0x0.f31179xoXoI.equals(resourceTypeName)) {
                    ...
                    } else if (XIxXXX0x0.f31179xoXoI.equals(resourceTypeName2)) {
        ...
        public String debugString(Context context) {
            ...
            return resourceEntryName + org.apache.commons.text.oIX0oI.f33048oxoX + context.getResources().getResourceEntryName(this.mConstraintSetEnd);
        }
