...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static abstract class ViewHolder {
        ...
        public String toString() {
            ...
            if (!isRecyclable()) {
                sb.append(" not recyclable(" + this.mIsRecyclableCount + oIX0oI.I0Io.f4095I0Io);
            }
            ...
            if (actionMasked != 1) {
                if (actionMasked != 2) {
                    ...
                    if (this.mScrollState != 1) {
                        ...
                        if (canScrollHorizontally != 0 && Math.abs(i) > this.mTouchSlop) {
                            this.mLastTouchX = x2;
                            z = true;
                        } else {
                            z = false;
