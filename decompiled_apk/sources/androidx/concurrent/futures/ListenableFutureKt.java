...
public final class ListenableFutureKt {
    @oOoXoXO
    public static final <T> Object await(@OOXIXo final ListenableFuture<T> listenableFuture, @OOXIXo I0Io<? super T> i0Io) {
        try {
            ...
            x0xo0oo.ooXIXxIX(new Oox.oOoXoXO<Throwable, oXIO0o0XI>() { // from class: androidx.concurrent.futures.ListenableFutureKt$await$$inlined$suspendCancellableCoroutine$lambda$1
                {
                    super(1);
                }
