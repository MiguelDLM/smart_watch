    ...
    public static class FontRequestMetadataLoader implements EmojiCompat.MetadataRepoLoader {
        ...
        private FontsContractCompat.FontInfo retrieveFontInfo() {
            try {
                ...
                throw new RuntimeException("fetchFonts failed (" + fetchFonts.getStatusCode() + oIX0oI.I0Io.f4095I0Io);
            ...
            synchronized (this.mLock) {
                try {
                    ...
                    if (this.mMainHandlerLoadCallback == null) {
                        this.mMainHandlerLoadCallback = new Runnable() { // from class: androidx.emoji2.text.XO
            ...
            synchronized (this.mLock) {
                try {
                    ...
                    try {
                        ...
                        throw new RuntimeException("fetchFonts result is not OK. (" + resultCode + oIX0oI.I0Io.f4095I0Io);
                    } catch (Throwable th2) {
                        synchronized (this.mLock) {
                            try {
        ...
        public void loadInternal() {
            synchronized (this.mLock) {
                try {
                    ...
                    this.mExecutor.execute(new Runnable() { // from class: androidx.emoji2.text.X0o0xo
                        @Override // java.lang.Runnable
                        public final void run() {
