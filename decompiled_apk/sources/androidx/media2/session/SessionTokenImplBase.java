...
public final class SessionTokenImplBase implements SessionToken.SessionTokenImpl {
    ...
    public String toString() {
        return "SessionToken {pkg=" + this.mPackageName + " type=" + this.mType + " service=" + this.mServiceName + " IMediaSession=" + this.mISession + " extras=" + this.mExtras + ooOOo0oXI.f33074oOoXoXO;
    }
