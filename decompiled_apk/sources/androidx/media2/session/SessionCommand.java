...
public final class SessionCommand implements VersionedParcelable {
    ...
    static {
        ...
        sparseArray2.put(1, Arrays.asList(10005, 10006, 10007, 10008, Integer.valueOf(COMMAND_CODE_PLAYER_SKIP_TO_NEXT_PLAYLIST_ITEM), Integer.valueOf(COMMAND_CODE_PLAYER_SET_SHUFFLE_MODE), Integer.valueOf(COMMAND_CODE_PLAYER_SET_REPEAT_MODE), Integer.valueOf(COMMAND_CODE_PLAYER_GET_PLAYLIST_METADATA), Integer.valueOf(COMMAND_CODE_PLAYER_ADD_PLAYLIST_ITEM), 10014, Integer.valueOf(COMMAND_CODE_PLAYER_REPLACE_PLAYLIST_ITEM), Integer.valueOf(COMMAND_CODE_PLAYER_GET_CURRENT_MEDIA_ITEM), Integer.valueOf(COMMAND_CODE_PLAYER_UPDATE_LIST_METADATA), Integer.valueOf(COMMAND_CODE_PLAYER_SET_MEDIA_ITEM)));
        ...
        sparseArray4.put(1, Arrays.asList(40000, 40001, 40002, Integer.valueOf(COMMAND_CODE_SESSION_SKIP_BACKWARD), Integer.valueOf(COMMAND_CODE_SESSION_SET_RATING)));
        ...
        sparseArray5.put(1, Arrays.asList(50000, 50001, 50002, 50003, Integer.valueOf(COMMAND_CODE_LIBRARY_GET_ITEM), 50005, 50006));
    }
