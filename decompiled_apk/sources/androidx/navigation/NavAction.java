...
public final class NavAction {
    ...
    public final void setNavOptions(@oOoXoXO NavOptions navOptions) {
    ...
    @xoIox
    public NavAction(@IdRes int i, @oOoXoXO NavOptions navOptions) {
        this(i, navOptions, null, 4, null);
    }

    @xoIox
    public NavAction(@IdRes int i, @oOoXoXO NavOptions navOptions, @oOoXoXO Bundle bundle) {
        this.destinationId = i;
        this.navOptions = navOptions;
        this.defaultArguments = bundle;
    }

    public /* synthetic */ NavAction(int i, NavOptions navOptions, Bundle bundle, int i2, IIXOooo iIXOooo) {
