...
public class NavDeepLinkRequest {
    ...
    public static final class Builder {
        ...
        @x0XOIxOo
        @OOXIXo
        public static final Builder fromUri(@OOXIXo Uri uri) {
        ...
        @OOXIXo
        public final Builder setUri(@OOXIXo Uri uri) {
            IIX0o.x0xO0oo(uri, "uri");
            this.uri = uri;
            return this;
        }
    ...
    public NavDeepLinkRequest(@oOoXoXO Uri uri, @oOoXoXO String str, @oOoXoXO String str2) {
        this.uri = uri;
        this.action = str;
        this.mimeType = str2;
    }
