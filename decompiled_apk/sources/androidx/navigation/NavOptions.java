...
public final class NavOptions {
    ...
    public static final class Builder {
        ...
        @OOXIXo
        @xoIox
        public final <T> Builder setPopUpTo(@OOXIXo T route, boolean z) {
        ...
        public static /* synthetic */ Builder setPopUpTo$default(Builder builder, boolean z, boolean z2, int i, Object obj) {
            ...
            builder.setPopUpTo(IO.oxoX(Object.class), z, z2);
            return builder;
        }
        ...
        public final /* synthetic */ <T> Builder setPopUpTo(boolean z, boolean z2) {
            IIX0o.OxI(4, ExifInterface.GPS_DIRECTION_TRUE);
            setPopUpTo(IO.oxoX(Object.class), z, z2);
            return this;
        }

        @OOXIXo
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public final Builder setPopUpTo(@OOXIXo oxoX<?> klass, boolean z, boolean z2) {
        ...
        @OOXIXo
        @xoIox
        public final <T> Builder setPopUpTo(@OOXIXo T route, boolean z, boolean z2) {
            IIX0o.x0xO0oo(route, "route");
            this.popUpToRouteObject = route;
            setPopUpTo(RouteSerializerKt.generateHashCode(OxxIIOOXO.Oxx0IOOO(IO.oxoX(route.getClass()))), z, z2);
            return this;
        }
        ...
        public final /* synthetic */ <T> Builder setPopUpTo(boolean z) {
            IIX0o.OxI(4, ExifInterface.GPS_DIRECTION_TRUE);
            setPopUpTo(IO.oxoX(Object.class), z, false);
            return this;
        }
    }
    ...
    public int hashCode() {
        int i;
        int i2;
        int i3 = (((((shouldLaunchSingleTop() ? 1 : 0) * 31) + (shouldRestoreState() ? 1 : 0)) * 31) + this.popUpToId) * 31;
        String str = this.popUpToRoute;
        int i4 = 0;
        if (str != null) {
            i = str.hashCode();
    ...
    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public NavOptions(boolean z, boolean z2, @OOXIXo Object popUpToRouteObject, boolean z3, boolean z4, int i, int i2, int i3, int i4) {
        this(z, z2, RouteSerializerKt.generateHashCode(OxxIIOOXO.Oxx0IOOO(IO.oxoX(popUpToRouteObject.getClass()))), z3, z4, i, i2, i3, i4);
        IIX0o.x0xO0oo(popUpToRouteObject, "popUpToRouteObject");
