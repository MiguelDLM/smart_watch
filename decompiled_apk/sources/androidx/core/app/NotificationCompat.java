...
public class NotificationCompat {
    ...
    public static class BigPictureStyle extends Style {
        ...
        private static IconCompat asIconCompat(@Nullable Parcelable parcelable) {
            if (parcelable != null) {
                if (Build.VERSION.SDK_INT >= 23 && OOXIXo.oIX0oI(parcelable)) {
                    return IconCompat.createFromIcon(oOoXoXO.oIX0oI(parcelable));
                }
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context, @NonNull Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    addPerson(Person.fromAndroidPerson(xoIox.oIX0oI(it2.next())));
                }
            }
            int i = Build.VERSION.SDK_INT;
    ...
    public static class CallStyle extends Style {
        ...
        public void restoreFromCompatExtras(@NonNull Bundle bundle) {
            ...
            if (i >= 28 && bundle.containsKey(NotificationCompat.EXTRA_CALL_PERSON)) {
                this.mPerson = Person.fromAndroidPerson(xoIox.oIX0oI(bundle.getParcelable(NotificationCompat.EXTRA_CALL_PERSON)));
            ...
            if (i >= 23 && bundle.containsKey(NotificationCompat.EXTRA_VERIFICATION_ICON)) {
                this.mVerificationIcon = IconCompat.createFromIcon(oOoXoXO.oIX0oI(bundle.getParcelable(NotificationCompat.EXTRA_VERIFICATION_ICON)));
    ...
    public static abstract class Style {
        ...
        private static Style constructCompatStyleByPlatformName(@Nullable String str) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                if (str.equals(oO.oIX0oI().getName())) {
                    return new MessagingStyle();
                }
                if (str.equals(x0xO0oo.oIX0oI().getName())) {
                    return new DecoratedCustomViewStyle();
                }
            }
            return null;
    ...
    public static final class WearableExtender implements Extender {
        ...
        private static Notification.Action getActionFromActionCompat(Action action) {
            ...
            if (i2 >= 23) {
                ...
                createBuilder = Api20Impl.createBuilder(i, action.getTitle(), action.getActionIntent());
            }
    ...
    public static Action getActionCompatFromAction(@NonNull Notification.Action action) {
        ...
        if (i5 >= 23) {
            if (Api23Impl.getIcon(action) == null && (i3 = action.icon) != 0) {
                return new Action(i3, action.title, action.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z4, i6, z5, z2, z3);
            }
            if (Api23Impl.getIcon(action) != null) {
                iconCompat = IconCompat.createFromIconOrNullIfZeroResId(Api23Impl.getIcon(action));
            }
            return new Action(iconCompat, action.title, action.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z4, i6, z5, z2, z3);
        }
        return new Action(action.icon, action.title, action.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z4, i6, z5, z2, z3);
    }
    ...
    public static List<Person> getPeople(@NonNull Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(Person.fromAndroidPerson(xoIox.oIX0oI(it.next())));
                }
            }
        } else {
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (i >= 24) {
                ...
                while (it.hasNext()) {
                    Api24Impl.addMessage(x0XOIxOo.oIX0oI(createMessagingStyle), it.next().toAndroidMessage());
                }
                if (Build.VERSION.SDK_INT >= 26) {
                    Iterator<Message> it2 = this.mHistoricMessages.iterator();
                    while (it2.hasNext()) {
                        Api26Impl.addHistoricMessage(x0XOIxOo.oIX0oI(createMessagingStyle), it2.next().toAndroidMessage());
                    }
                }
                if (this.mIsGroupConversation.booleanValue() || Build.VERSION.SDK_INT >= 28) {
                    Api24Impl.setConversationTitle(x0XOIxOo.oIX0oI(createMessagingStyle), this.mConversationTitle);
                }
                if (Build.VERSION.SDK_INT >= 28) {
                    Api28Impl.setGroupConversation(x0XOIxOo.oIX0oI(createMessagingStyle), this.mIsGroupConversation.booleanValue());
                }
                ...
                try {
                    if (bundle.containsKey("text") && bundle.containsKey(KEY_TIMESTAMP)) {
                        if (bundle.containsKey(KEY_PERSON)) {
                            ...
                            person = Person.fromAndroidPerson(xoIox.oIX0oI(bundle.getParcelable(KEY_NOTIFICATION_PERSON)));
