...
public final class NotificationManagerCompat {
    ...
    public void deleteUnlistedNotificationChannels(@NonNull Collection<String> collection) {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannel oIX0oI2 = xxIXOIIO.oIX0oI(it.next());
                if (!collection.contains(Api26Impl.getId(oIX0oI2)) && (Build.VERSION.SDK_INT < 30 || !collection.contains(Api30Impl.getParentChannelId(oIX0oI2)))) {
                    Api26Impl.deleteNotificationChannel(this.mNotificationManager, Api26Impl.getId(oIX0oI2));
                }
            }
        }
    }
    ...
    public NotificationChannelGroup getNotificationChannelGroup(@NonNull String str) {
        ...
        if (i >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannelGroup oIX0oI2 = Oxx0xo.oIX0oI(it.next());
                if (Api26Impl.getId(oIX0oI2).equals(str)) {
                    return oIX0oI2;
                }
            }
        }
            ...
            if (!notificationChannelGroups.isEmpty()) {
                ...
                while (it.hasNext()) {
                    ...
                    if (Build.VERSION.SDK_INT >= 28) {
                        arrayList.add(new NotificationChannelGroupCompat(oIX0oI2));
                    } else {
                        arrayList.add(new NotificationChannelGroupCompat(oIX0oI2, notificationChannels));
                    }
                }
                return arrayList;
            }
    ...
    public List<NotificationChannelCompat> getNotificationChannelsCompat() {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannels.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(new NotificationChannelCompat(xxIXOIIO.oIX0oI(it.next())));
                }
                return arrayList;
            }
        }
