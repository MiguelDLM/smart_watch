    ...
    public static class Impl30 extends Impl {
        ...
        */
        public Impl30(@androidx.annotation.NonNull android.view.Window r2, @androidx.annotation.NonNull androidx.core.view.WindowInsetsControllerCompat r3, @androidx.annotation.NonNull androidx.core.view.SoftwareKeyboardControllerCompat r4) {
            /*
                r1 = this;
                android.view.WindowInsetsController r0 = androidx.core.view.XXoOx0.oIX0oI(r2)
                r1.<init>(r0, r3, r4)
                r1.mWindow = r2
                return
            */
        ...
        public void addOnControllableInsetsChangedListener(@NonNull final OnControllableInsetsChangedListener onControllableInsetsChangedListener) {
            ...
            WindowInsetsController.OnControllableInsetsChangedListener onControllableInsetsChangedListener2 = new WindowInsetsController.OnControllableInsetsChangedListener() { // from class: androidx.core.view.Ix00oIoI
        ...
        @Override // androidx.core.view.WindowInsetsControllerCompat.Impl
        public void removeOnControllableInsetsChangedListener(@NonNull OnControllableInsetsChangedListener onControllableInsetsChangedListener) {
            WindowInsetsController.OnControllableInsetsChangedListener oIX0oI2 = IXO.oIX0oI(this.mListeners.remove(onControllableInsetsChangedListener));
            if (oIX0oI2 != null) {
                this.mInsetsController.removeOnControllableInsetsChangedListener(oIX0oI2);
            }
        }
