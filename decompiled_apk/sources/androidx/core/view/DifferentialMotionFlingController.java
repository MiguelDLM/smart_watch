...
public class DifferentialMotionFlingController {
    ...
    public DifferentialMotionFlingController(@NonNull Context context, @NonNull DifferentialMotionFlingTarget differentialMotionFlingTarget) {
        this(context, differentialMotionFlingTarget, new FlingVelocityThresholdCalculator() { // from class: androidx.core.view.IXxxXO
        ...
        }, new DifferentialVelocityProvider() { // from class: androidx.core.view.Oxx0xo
