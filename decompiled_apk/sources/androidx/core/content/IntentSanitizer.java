...
public class IntentSanitizer {
    ...
    public static final class Builder {
        ...
        private boolean mAllowSourceBounds;
        private int mAllowedFlags;
        private Predicate<String> mAllowedActions = new Predicate() { // from class: androidx.core.content.x0XOIxOo
        ...
        private Predicate<Uri> mAllowedData = new Predicate() { // from class: androidx.core.content.oO
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return androidx.core.util.OOXIXo.oIX0oI(this, predicate);
            }
        ...
        private Predicate<String> mAllowedTypes = new Predicate() { // from class: androidx.core.content.x0xO0oo
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return androidx.core.util.OOXIXo.oIX0oI(this, predicate);
            }
        ...
        private Predicate<String> mAllowedCategories = new Predicate() { // from class: androidx.core.content.IXxxXO
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return androidx.core.util.OOXIXo.oIX0oI(this, predicate);
            }
        ...
        private Predicate<String> mAllowedPackages = new Predicate() { // from class: androidx.core.content.Oxx0xo
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return androidx.core.util.OOXIXo.oIX0oI(this, predicate);
            }
        ...
        private Predicate<ComponentName> mAllowedComponents = new Predicate() { // from class: androidx.core.content.oI0IIXIo
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return androidx.core.util.OOXIXo.oIX0oI(this, predicate);
            }
        ...
        private Predicate<Uri> mAllowedClipDataUri = new Predicate() { // from class: androidx.core.content.OxxIIOOXO
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return androidx.core.util.OOXIXo.oIX0oI(this, predicate);
            }
        ...
        private Predicate<ClipData> mAllowedClipData = new Predicate() { // from class: androidx.core.content.IIXOooo
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return androidx.core.util.OOXIXo.oIX0oI(this, predicate);
            }
        ...
        public Builder allowAnyComponent() {
            ...
            this.mAllowedComponents = new Predicate() { // from class: androidx.core.content.xoIox
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return androidx.core.util.OOXIXo.oIX0oI(this, predicate);
                }
        ...
        public Builder allowCategory(@NonNull String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowCategory(new X0o0xo(str));
        }
        ...
        public Builder allowClipDataUriWithAuthority(@NonNull final String str) {
            Preconditions.checkNotNull(str);
            return allowClipDataUri(new Predicate() { // from class: androidx.core.content.OOXIXo
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return androidx.core.util.OOXIXo.oIX0oI(this, predicate);
                }
        ...
        public Builder allowComponent(@NonNull final ComponentName componentName) {
            ...
            return allowComponent(new Predicate() { // from class: androidx.core.content.xxIXOIIO
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return androidx.core.util.OOXIXo.oIX0oI(this, predicate);
                }
        ...
        public Builder allowComponentWithPackage(@NonNull final String str) {
            Preconditions.checkNotNull(str);
            return allowComponent(new Predicate() { // from class: androidx.core.content.XO
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return androidx.core.util.OOXIXo.oIX0oI(this, predicate);
                }
        ...
        public Builder allowDataWithAuthority(@NonNull final String str) {
            Preconditions.checkNotNull(str);
            allowData(new Predicate() { // from class: androidx.core.content.Oxx0IOOO
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return androidx.core.util.OOXIXo.oIX0oI(this, predicate);
                }
        ...
        public Builder allowExtra(@NonNull String str, @NonNull Class<?> cls) {
            return allowExtra(str, cls, new Predicate() { // from class: androidx.core.content.xoXoI
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return androidx.core.util.OOXIXo.oIX0oI(this, predicate);
                }
        ...
        public Builder allowExtraOutput(@NonNull final String str) {
            allowExtra("output", Uri.class, new Predicate() { // from class: androidx.core.content.oxoX
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return androidx.core.util.OOXIXo.oIX0oI(this, predicate);
                }
        ...
        public Builder allowExtraStreamUriWithAuthority(@NonNull final String str) {
            Preconditions.checkNotNull(str);
            allowExtra("android.intent.extra.STREAM", Uri.class, new Predicate() { // from class: androidx.core.content.ooOOo0oXI
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return androidx.core.util.OOXIXo.oIX0oI(this, predicate);
                }
        ...
        public Builder allowPackage(@NonNull String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowPackage(new X0o0xo(str));
        }
        ...
        public Builder allowType(@NonNull String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowType(new X0o0xo(str));
        }
        ...
        public <T> Builder allowExtra(@NonNull String str, @NonNull final Class<T> cls, @NonNull final Predicate<T> predicate) {
            ...
            Preconditions.checkNotNull(predicate);
            return allowExtra(str, new Predicate() { // from class: androidx.core.content.II0XooXoX
                @Override // androidx.core.util.Predicate
        ...
        public Builder allowExtra(@NonNull String str, @NonNull Predicate<Object> predicate) {
            ...
            if (predicate2 == null) {
                predicate2 = new Predicate() { // from class: androidx.core.content.oOoXoXO
                    @Override // androidx.core.util.Predicate
                    public /* synthetic */ Predicate and(Predicate predicate3) {
                        return androidx.core.util.OOXIXo.oIX0oI(this, predicate3);
                    }
                    ...
                    public /* synthetic */ Predicate or(Predicate predicate3) {
                        return androidx.core.util.OOXIXo.I0Io(this, predicate3);
                    }
    ...
    */
    ...
    public Intent sanitizeByFiltering(@NonNull Intent intent) {
        return sanitize(intent, new Consumer() { // from class: androidx.core.content.I0Io
    ...
    public Intent sanitizeByThrowing(@NonNull Intent intent) {
        return sanitize(intent, new Consumer() { // from class: androidx.core.content.II0xO0
            @Override // androidx.core.util.Consumer
            public final void accept(Object obj) {
