...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            return "HorizontalScrollView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " scrollPosition=" + this.scrollPosition + ooOOo0oXI.f33074oOoXoXO;
        }
    ...
    */
    ...
    private int scrollBy(int i, int i2, int i3, boolean z) {
        ...
        if (overScrollByCompat(0, i4, 0, scrollY, 0, scrollRange, 0, 0, true) && !hasNestedScrollingParent(i3)) {
            z3 = true;
        } else {
            z3 = false;
        }
