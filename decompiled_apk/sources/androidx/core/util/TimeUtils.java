...
public final class TimeUtils {
    ...
    private static int formatDurationLocked(long j, int i) {
        ...
        if (i != 0) {
            ...
            i6 = 0;
            for (int accumField5 = accumField4 + accumField(i13, 2, true, i11) + 1; accumField5 < i; accumField5++) {
        ...
        if (z && printField4 != i15) {
            i10 = 3;
        } else {
            i10 = 0;
        }
        int printField5 = printField(cArr, i13, 'm', printField4, true, i10);
        cArr[printField5] = 's';
