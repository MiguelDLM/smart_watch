...
public final class WorkProgressDao_Impl implements WorkProgressDao {
    ...
    public WorkProgressDao_Impl(@NonNull final RoomDatabase __db) {
        this.__db = __db;
        this.__insertionAdapterOfWorkProgress = new EntityInsertionAdapter<WorkProgress>(__db) { // from class: androidx.work.impl.model.WorkProgressDao_Impl.1
            ...
            public void bind(@NonNull final SupportSQLiteStatement statement, @NonNull final WorkProgress entity) {
