...
public final class NetworkState {
    ...
    public int hashCode() {
        return (((((oIX0oI.oIX0oI(this.isConnected) * 31) + oIX0oI.oIX0oI(this.isValidated)) * 31) + oIX0oI.oIX0oI(this.isMetered)) * 31) + oIX0oI.oIX0oI(this.isNotRoaming);
    }
    ...
    public String toString() {
        return "NetworkState(isConnected=" + this.isConnected + ", isValidated=" + this.isValidated + ", isMetered=" + this.isMetered + ", isNotRoaming=" + this.isNotRoaming + HexStringBuilder.COMMENT_END_CHAR;
    }
}
