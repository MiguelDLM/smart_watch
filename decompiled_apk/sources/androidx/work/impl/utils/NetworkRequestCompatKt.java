...
public final class NetworkRequestCompatKt {
    @OXOo.OOXIXo
    @RequiresApi(28)
    public static final int[] getCapabilitiesCompat(@OXOo.OOXIXo NetworkRequest networkRequest) {
    ...
    @OXOo.OOXIXo
    @RequiresApi(28)
    public static final int[] getTransportTypesCompat(@OXOo.OOXIXo NetworkRequest networkRequest) {
        IIX0o.x0xO0oo(networkRequest, "<this>");
        if (Build.VERSION.SDK_INT >= 31) {
