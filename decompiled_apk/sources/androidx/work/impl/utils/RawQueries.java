...
@XO0OX.xxIXOIIO(name = "RawQueries")
...
public final class RawQueries {
    private static final void bindings(StringBuilder sb, int i) {
        ...
        sb.append(CollectionsKt___CollectionsKt.OoIXo(arrayList, ",", null, null, 0, null, null, 62, null));
    }

    @OXOo.OOXIXo
    public static final SupportSQLiteQuery toRawQuery(@OXOo.OOXIXo WorkQuery workQuery) {
        ...
        if (!workQuery.getStates().isEmpty()) {
            ...
            ArrayList arrayList2 = new ArrayList(kotlin.collections.OxxIIOOXO.xo0x(states, 10));
        ...
        if (!workQuery.getIds().isEmpty()) {
            ...
            ArrayList arrayList3 = new ArrayList(kotlin.collections.OxxIIOOXO.xo0x(ids, 10));
