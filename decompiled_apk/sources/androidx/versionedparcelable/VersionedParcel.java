...
public abstract class VersionedParcel {
    ...
    public Serializable readSerializable() {
        ...
        try {
            ...
            throw new RuntimeException("VersionedParcelable encountered IOException reading a Serializable object (name = " + readString + oIX0oI.I0Io.f4095I0Io, e);
        } catch (ClassNotFoundException e2) {
            throw new RuntimeException("VersionedParcelable encountered ClassNotFoundException reading a Serializable object (name = " + readString + oIX0oI.I0Io.f4095I0Io, e2);
        }
    }
    ...
    private void writeSerializable(Serializable serializable) {
        ...
        try {
            ...
            throw new RuntimeException("VersionedParcelable encountered IOException writing serializable object (name = " + name + oIX0oI.I0Io.f4095I0Io, e);
        }
    }
