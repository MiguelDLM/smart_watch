...
BLOCK_TYPE_NAMES = {
    ...
    0x02: ("bgimg", "Background image"),
    0x03: ("armh", "Arm hour"),
    0x04: ("armm", "Arm minute"),
    0x05: ("arms", "Arm second"),
    0x06: ("year", "Year"),
    0x07: ("month", "Month"),
    0x08: ("day", "Day"),
    0x09: ("hour", "Hours"),
    ...
    0x11: ("dist", "Distance"),
    0x12: ("battn", "Battery"),
    0x13: ("conn", "Connection"),
    0x16: ("berry", "Decoration"),
    0x17: ("anim", "Animation"),
    0x18: ("batts", "Battery strip"),
    0x19: ("weat", "Weather"),
    0x1A: ("temp", "Temperature"),
    0x1E: ("prog2", "Progress bar 2"),
    0x20: ("prog1", "Progress bar 1"),
    0x25: ("label", "Label"),
    0x27: ("hourl", "Hours low digit"),
    0x28: ("hourh", "Hours high digit"),
    0x29: ("minh", "Minutes high digit"),
    0x2A: ("minl", "Minutes low digit"),
}
