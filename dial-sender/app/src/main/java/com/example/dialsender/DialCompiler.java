...
public class DialCompiler {
    ...
    public static String blockTypeToString(int type) {
        switch (type) {
            ...
            case TYPE_ARM_HOUR:     return "BLK_ARMH";
            case TYPE_ARM_MIN:      return "BLK_ARMM";
            case TYPE_ARM_SEC:      return "BLK_ARMS";
            case TYPE_YEAR:         return "BLK_YEAR";
            case TYPE_MONTH:        return "BLK_MONTH";
            case TYPE_DAY:          return "BLK_DAY";
            case TYPE_DIGITAL_HOUR: return "BLK_HOUR";
            case TYPE_DIGITAL_MIN:  return "BLK_MIN";
            case TYPE_SECONDS:      return "BLK_SEC";
            case TYPE_AMPM:         return "BLK_AMPM";
            case TYPE_WEEKDAY:      return "BLK_WEEKD";
            case TYPE_STEPS:        return "BLK_STEPS";
            case TYPE_HEART:        return "BLK_PULSE";
            case TYPE_CALORIE:      return "BLK_CALOR";
            case TYPE_DISTANCE:     return "BLK_DIST";
            case TYPE_BATTERY:      return "BLK_BATTN";
            case TYPE_CONNECT:      return "BLK_CONN";
            case TYPE_BERRY:        return "BLK_BERRY";
            case TYPE_ANIM:         return "BLK_ANIM";
            case TYPE_BATT_STRIP:   return "BLK_BATTS";
            case TYPE_WEATHER:      return "BLK_WEAT";
            case TYPE_TEMP:         return "BLK_TEMP";
            case TYPE_PROGRESS2:    return "BLK_PROG2";
            case TYPE_PROGRESS1:    return "BLK_PROG1";
            case TYPE_LABEL:        return "BLK_LABEL";
            case TYPE_HOUR_LO:      return "BLK_HOURL";
            case TYPE_HOUR_HI:      return "BLK_HOURH";
            case TYPE_MIN_HI:       return "BLK_MINH";
            case TYPE_MIN_LO:       return "BLK_MINL";
            default:                return "BLK_UNKNOWN";
        }
    }
    ...
    public static String blockTypeLabel(int type) {
        switch (type) {
            case TYPE_PREVIEW:      return "Vista previa";
            case TYPE_BACKGROUND:   return "Fondo";
            case TYPE_ARM_HOUR:     return "Manecilla Hora";
            case TYPE_ARM_MIN:      return "Manecilla Minuto";
            case TYPE_ARM_SEC:      return "Manecilla Segundo";
            case TYPE_YEAR:         return "Año";
            case TYPE_MONTH:        return "Mes";
            case TYPE_DAY:          return "Día";
            case TYPE_DIGITAL_HOUR: return "Hora (digital)";
            case TYPE_DIGITAL_MIN:  return "Minuto (digital)";
            case TYPE_SECONDS:      return "Segundos";
            case TYPE_AMPM:         return "AM/PM";
            case TYPE_WEEKDAY:      return "Día de semana";
            case TYPE_STEPS:        return "Pasos";
            case TYPE_HEART:        return "Pulso";
            case TYPE_CALORIE:      return "Calorías";
            case TYPE_DISTANCE:     return "Distancia";
            case TYPE_BATTERY:      return "Batería (número)";
            case TYPE_CONNECT:      return "Conexión";
            case TYPE_BERRY:        return "Decoración";
            case TYPE_ANIM:         return "Animación";
            case TYPE_BATT_STRIP:   return "Batería (barra)";
            case TYPE_WEATHER:      return "Clima";
            case TYPE_TEMP:         return "Temperatura";
            case TYPE_PROGRESS2:    return "Barra progreso 2";
            case TYPE_PROGRESS1:    return "Barra progreso 1";
            case TYPE_LABEL:        return "Etiqueta";
            case TYPE_HOUR_LO:      return "Hora dígito bajo";
            case TYPE_HOUR_HI:      return "Hora dígito alto";
            case TYPE_MIN_HI:       return "Minuto dígito alto";
            case TYPE_MIN_LO:       return "Minuto dígito bajo";
    ...
    public static int blockTypeLabelRes(int type) {
        switch (type) {
            case TYPE_PREVIEW:      return R.string.blk_preview;
            case TYPE_BACKGROUND:   return R.string.blk_background;
            case TYPE_ARM_HOUR:     return R.string.blk_arm_hour;
            case TYPE_ARM_MIN:      return R.string.blk_arm_min;
            case TYPE_ARM_SEC:      return R.string.blk_arm_sec;
            case TYPE_YEAR:         return R.string.blk_year;
            case TYPE_MONTH:        return R.string.blk_month;
            case TYPE_DAY:          return R.string.blk_day;
            case TYPE_DIGITAL_HOUR: return R.string.blk_hour;
            case TYPE_DIGITAL_MIN:  return R.string.blk_min;
            case TYPE_SECONDS:      return R.string.blk_sec;
            case TYPE_AMPM:         return R.string.blk_ampm;
            case TYPE_WEEKDAY:      return R.string.blk_weekday;
            case TYPE_STEPS:        return R.string.blk_steps;
            case TYPE_HEART:        return R.string.blk_heart;
            case TYPE_CALORIE:      return R.string.blk_calorie;
            case TYPE_DISTANCE:     return R.string.blk_distance;
            case TYPE_BATTERY:      return R.string.blk_battery;
            case TYPE_CONNECT:      return R.string.blk_connect;
            case TYPE_BERRY:        return R.string.blk_berry;
            case TYPE_ANIM:         return R.string.blk_anim;
            case TYPE_BATT_STRIP:   return R.string.blk_batt_strip;
            case TYPE_WEATHER:      return R.string.blk_weather;
            case TYPE_TEMP:         return R.string.blk_temp;
            case TYPE_PROGRESS2:    return R.string.blk_prog2;
            case TYPE_PROGRESS1:    return R.string.blk_prog1;
            case TYPE_LABEL:        return R.string.blk_label;
            case TYPE_HOUR_LO:      return R.string.blk_hour_lo;
            case TYPE_HOUR_HI:      return R.string.blk_hour_hi;
            case TYPE_MIN_HI:       return R.string.blk_min_hi;
            case TYPE_MIN_LO:       return R.string.blk_min_lo;
            default:                return R.string.blk_unknown;
        }
    }
